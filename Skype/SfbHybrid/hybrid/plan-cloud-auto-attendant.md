...
- Если вы уже используете единую систему обмена сообщениями Exchange Online или локальную среду и хотите выполнить обновление до Skype для бизнеса 2019, вам потребуется записать структуру автосекретарей и повторно создать их в облаке с помощью облачных автосекретарей. Дополнительную информацию можно узнать [в статье перемещение автосекретаря единой системы обмена сообщениями Exchange или очереди звонков в телефонную систему](configure-onprem-ra.md#moving-an-exchange-um-auto-attendant-or-call-queue-to-phone-system).
...
- Единая система обмена сообщениями Exchange находится в режиме выбытия
