...
2.  Установите сертификат локально на каждом пограничном сервере и назначьте его службе пограничной службы Skype для каждой пограничной службы.  Подробное описание действий приведено в разделе "сертификаты внешнего интерфейса пограничной [службы" в службе развертывания пограничной службы в Skype для бизнеса Server 2015](https://technet.microsoft.com/en-us/library/dn951368.aspx).
