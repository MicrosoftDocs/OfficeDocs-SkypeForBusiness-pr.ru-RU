...
- Пользователю должна быть назначена лицензия для Teams и Skype для бизнеса Online (план 2). Даже после выхода на пенсию Skype для бизнеса Online, Skype для бизнеса онлайн licese по-прежнему требуется.  Кроме того:
...
- В Teams пользователь, исполняющий перемещение, должен соответствовать одному из следующих критериев:
  ...
  - Пользователь является участником ролей администратора Teams администратора и пользователя.
