...
## <a name="create-an-office-365-organization"></a>Создание организации Office 365

После этого потребуется подготовить организацию Office 365 для использования в развертывании. Дополнительные сведения см. в разделе [подписки, лицензии, учетные записи и клиенты для облачных услуг Майкрософт](https://docs.microsoft.com/office365/enterprise/subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings). 
