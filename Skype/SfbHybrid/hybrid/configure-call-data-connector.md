...
| Идентификация | Определяет уровень области для команды: глобальная или site.   | глобального  |
...
Для получения дополнительных сведений о командлетах можно использовать команду Get-Help в командной консоли Skype для бизнеса Server. Например:
