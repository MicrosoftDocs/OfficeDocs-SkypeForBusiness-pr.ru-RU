...
Лицензии на надстройки — это лицензии на конкретные функции Skype для бизнеса. Некоторые компании хотят гибко приобрести только определенные функции по выгодным тарифам. Чтобы добавить компонент, закажите одну лицензию для каждого пользователя, который будет ее использовать.

Лицензирование Skype для бизнеса обеспечивает максимальную гибкость. Например, после использования основных функций Skype для бизнеса вы можете приобрести лицензии на надстройки, когда вы будете готовы использовать дополнительные функции, такие как голосовые конференции или телефонная система в Office 365.
...
В зависимости от того, какой план уже есть, вы можете приобрести лицензии на надстройки для следующих функций Skype для бизнеса:

|||
|:-----|:-----|
|**Функция** <br/> |**Описание** <br/> |
|**Аудиоконференции** <br/> |Иногда пользователи в вашей организации должны использовать телефон для звонка на собрание Skype для бизнеса, а не с компьютера. Воспользуйтесь функцией голосовой конференции в этой ситуации.<br/> Чтобы узнать, доступна ли функция Аудиоконцеренции в вашей стране или регионе, перейдите в раздел [Страны и регионы, доступные для Аудиоконференций и Тарифные планы](/microsoftteams/country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans). <br/> Для получения сведений о стоимости, перейдите в раздел [Требования для Аудиоконференций](https://products.office.com/skype-for-business/audio-conferencing#requirements).  <br/> |
...
|**Комнаты Microsoft Teams** <br/> |Это не надстройка, но функция, с помощью которой можно обмениваться видео, аудио-и видеоматериалами в конференц-залах. Просмотр [комнат Microsoft Teams](../skype-for-business-and-microsoft-teams-add-on-licensing/license-options-based-on-your-plan/skype-room-systems-v2.md).<br/> |
...
- [Microsoft 365 Business Стандартный](../skype-for-business-and-microsoft-teams-add-on-licensing/license-options-based-on-your-plan/office-365-business-premium-plan.md)
- [Office 365 Premium, Microsoft 365 для предприятий или Skype для бизнеса Online (план 2)](../skype-for-business-and-microsoft-teams-add-on-licensing/license-options-based-on-your-plan/office-365-premium-pro-plus-or-business-online-plan.md)
...
- [Комнаты Microsoft Teams](../skype-for-business-and-microsoft-teams-add-on-licensing/license-options-based-on-your-plan/skype-room-systems-v2.md)
...
Подробный список функций и сравнений для каждого плана Skype для бизнеса можно найти в [описании службы Skype для бизнеса Online](https://go.microsoft.com/fwlink/?LinkId=730729).

## <a name="how-to-see-prices-and-buy-add-on-licenses"></a>Как узнать цены и приобрести лицензии на надстройки
<a name="bkmk_how"> </a>

 **После покупки плана Office 365 можно просматривать цены и покупать надстройки в центре администрирования Microsoft 365**.
...
Чтобы использовать существующий план звонков, приобретите надстройку **телефонной системы** и используйте ее с бесплатным компонентом **[Cloud connector](https://technet.microsoft.com/library/mt605227.aspx)**.
...
Подробную документацию по планированию развертывания, включая телефонную систему с использованием локальной сети PSTN, можно найти [в разделе Планирование телефонной системы в Office 365 (облачная УАТС)](https://technet.microsoft.com/library/mt612869.aspx).
...
- [Настройка облачного соединителя](https://technet.microsoft.com/library/mt605228.aspx) и [скачивание облачного соединителя](https://aka.ms/CloudConnectorInstaller)
