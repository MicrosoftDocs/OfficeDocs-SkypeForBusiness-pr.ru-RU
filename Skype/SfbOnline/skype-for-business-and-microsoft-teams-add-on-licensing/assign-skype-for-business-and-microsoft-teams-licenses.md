...
Что нужно знать перед назначением лицензий на аудиоконференцию, телефонную систему и план звонков
...
Действия те же, что и при назначении лицензии на Microsoft 365 или Office 365. См. ["Назначение и удаление лицензий для Microsoft 365 для бизнеса".](https://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc)
...
|План внутренних звонков (планы: 3000 мин США/1200 мин ЕС)  <br/> |MCOPSTN1  <br/> |
|План внутренних звонков (план звонков: 120 мин)  <br/> |MCOPSTN5  <br/> |
|План внутренних звонков (план звонков: 240 мин)  <br/> |MCOPSTN6  <br/> |
...
- Дальнейшие действия. После  назначения лицензий на аудиоконференцию необходимо назначить поставщика услуг аудиоконференции. См. [Назначение Майкрософт в качестве поставщика услуг аудиоконференций].
...
2. Загрузите и установите **модуль Windows Azure Active Directory**. Инструкции по установке и синтаксис командлетов см. в разделе [Управление службой Azure AD с помощью Windows PowerShell](/previous-versions/azure/jj151815(v=azure.100)).
    ...
    Названия лицензий и наименования продуктов в сценарии указаны в тексте, который содержится в виде шрифта. Полный перечень названий продуктов см. в разделе [Названия продуктов и номера SKU для аудиоконференций, использующихся для сценариев](assign-skype-for-business-and-microsoft-teams-licenses.md#sku).
