...
В этой статье приводятся советы по назначению пользователям лицензий на аудиоконференции, телефонную систему и тарифные планы. Здесь также представлены сценарии для массового назначения лицензий.
...
## <a name="phone-system-and-calling-plans-tips-and-scripts-for-assigning-licenses"></a>Телефонные системы и тарифные планы. Советы и сценарии по назначению лицензий

Что нужно знать перед назначением лицензий на аудиоконференции, телефонную систему и тарифный план
...
- **Дальнейшие действия**. После того, как вы назначили своим пользователям лицензии на тарифные планы, вам потребуется получить номера телефонов для вашей организации, а затем назначить эти номера сотрудникам. Пошаговые инструкции см. в статье [Настройка планов звонков](/microsoftteams/set-up-calling-plans).
    
### <a name="how-to-assign-a-phone-system-and-calling-plan-license-to-one-user"></a>Назначение лицензии на телефонную систему и тарифный план одному пользователю
...
### <a name="how-to-assign-phone-system-and-calling-plan-licenses-in-bulk"></a>Массовое назначение лицензий на телефонную систему и тарифный план
...
3. После установки модулей назначьте пользователям лицензии в командной строке Windows PowerShell, используя следующий синтаксис.
...
- Дальнейшие действия. После назначения лицензий на **аудиоконференции** необходимо назначить поставщика услуг аудиоконференций. См. [Назначение Майкрософт в качестве поставщика услуг аудиоконференций].
...
### <a name="audio-conferencing-product-names-or-skus-used-for-scripting"></a>Названия продуктов и номера SKU для аудиоконференций, использующиеся для сценариев
<a name="sku"> </a>
...
- **Дальнейшие действия**. После назначения этих лицензий вам потребуется получить номера телефонов для организации, а затем назначить их сотрудникам. Пошаговые инструкции см. в статье [Настройка планов звонков](/microsoftteams/set-up-calling-plans).
...
Действия такие же, как и при назначении лицензии на Office 365. См. статью [Управление лицензиями Office 365 для бизнеса](https://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc).
...
[Настройка тарифных планов](/microsoftteams/set-up-calling-plans)
