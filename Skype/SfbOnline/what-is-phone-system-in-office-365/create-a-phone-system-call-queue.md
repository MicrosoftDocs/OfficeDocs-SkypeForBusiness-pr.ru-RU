...
В **центре администрирования Skype для бизнеса** выберите опцию **Маршрутизация вызовов** > **Очереди вызовов**, а затем нажмите кнопку **Добавить новую**.
...
***
![Номер 1](../images/sfbcallout1.png)<br/>**Приветствие** является необязательным полем. Это приветствие, которое воспроизводится для абонентов, звонящих по номеру очереди вызовов. <br/> Для использования этой функции можно загрузить звуковой файл (в формате .wav, .mp3 или .wma).
***
...
*    **Переадресовать вызов к**. При выборе этой опции возможны следующие варианты.
     *    **Сотрудники компании**. Пользователи, подключенные к сети, обладающие лицензией на **телефонную систему**  и имеющие доступ к корпоративной голосовой связи, либо имеющие тарифный план. Ее можно настроить так, что звонки вызывающего абонента будут отправляться в голосовую почту. Для этой цели выберите опцию **Сотрудник компании** и установите для этого абонента режим переадресации, позволяющий перенаправлять звонки непосредственно на голосовую почту. </br><br/>  Для получения дополнительных сведений о лицензиях, необходимых для использования голосовой почты, см. [Настройка голосовой почты телефонной системы](/microsoftteams/set-up-phone-system-voicemail). 
...
- Windows PowerShell используется для управления пользователями и их правами. С помощью Windows PowerShell вы можете управлять Office 365 и Skype для бизнеса online, используя единый центр администрирования, который упростит выполнение ваших повседневных задач. Чтобы начать работу с Windows PowerShell, ознакомьтесь с приведенными ниже разделами.
  ...
  - [Причины использовать PowerShell для управления Office 365](https://go.microsoft.com/fwlink/?LinkId=525041)
