...
Дополнительные сведения о текущих сертифицированных версиях микропрограмм можно найти в разделе [IP-телефоны Skype для бизнеса](https://docs.microsoft.com/skypeforbusiness/certification/devices-ip-phones#conference-phones).
...
## <a name="skype-for-business-online-connected-phones-feature-set"></a>Настройка функции "подключенные телефоны" в Skype для бизнеса Online
...
|Вход через веб-интерфейс  <br/>  <br/> **Примечание.** Проверьте таблицу поддержки в руководстве по развертыванию.           |Да   <br/> |Да   <br/> |Да  <br/> |Нет  <br/> |
...
|Загрузка журнала  <br/> <br/> **Примечание.** В настоящее время все журналы загружаются только в группу поддержки Майкрософт; доступ клиента к журналам звонков пока недоступен.           |Да   <br/> |Да   <br/> |Да   <br/> |Да   <br/> |
...
|Интеграция с календарем Exchange *  <br/> |Да   <br/> |Да   <br/> |Да   <br/> |Да   <br/> <br/> **Примечание.** Требуется модем для ПК           |
