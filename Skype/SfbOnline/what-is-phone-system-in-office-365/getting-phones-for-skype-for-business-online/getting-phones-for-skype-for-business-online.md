...
## <a name="skype-for-business-online-connected-phones-feature-set"></a>Функциональные возможности подключенных телефонов в Skype для бизнеса Online
...
|Вход через веб-интерфейс  <br/>  <br/> **Примечание.** Проверьте таблицу сведений о поддержке в руководстве по развертыванию.           |Да  <br/> |Да  <br/> |Да  <br/> |Нет  <br/> |
...
|Загрузка журнала  <br/> <br/> **Примечание.** На данный момент все журналы загружаются только в службу технической поддержки Майкрософт. Доступ клиентов к журналам звонков пока не реализован.           |Да  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |
