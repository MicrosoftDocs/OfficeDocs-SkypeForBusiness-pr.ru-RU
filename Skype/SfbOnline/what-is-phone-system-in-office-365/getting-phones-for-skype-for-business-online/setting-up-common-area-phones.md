...
1. В Центре администрирования перейдите к выставлению **счета**  >  **Приобретение служб** и добавьте Другие **планы**.
...
![Значок с логотипом Skype для бизнеса Назначить номер телефона пользователю с помощью центра ](../../images/sfb-logo-30x30.png) **Skype для бизнеса администрирования**
