...
> [!NOTE]
> Если почтовый ящик заполнен или администратору клиента настроил MaxSendSize быть меньше 30 МБ, загруженный файл данных не должны сохраняться вообще. По умолчанию MaxSendSize 150 МБ, но клиент администраторы могут настраивать MaxSendSize быть как 1 МБ. 
