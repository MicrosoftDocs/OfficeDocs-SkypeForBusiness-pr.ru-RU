...
1. Перейдите в Центр администрирования Skype для бизнеса Online и > **организации >.**
    
2. В **режиме конфиденциальности присутствия** выберите параметр и нажмите кнопку **"Сохранить".**
...
|**Отображение сведений о присутствии только для контактов пользователя** <br/> |Любой пользователь из списка контактов, не  в который входит группа конфиденциальности "Внешние" или **"Заблокированные".** <br/> Пользователь может изменить этот параметр в диалоговом окне "Параметры Skype **для** бизнеса". <br/> |
