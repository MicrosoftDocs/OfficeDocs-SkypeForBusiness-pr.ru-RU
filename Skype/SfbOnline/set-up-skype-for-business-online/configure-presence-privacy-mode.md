...
|**Отображение сведений о присутствии только для контактов пользователя** <br/> |Любой пользователь из списка контактов пользователя,  не вошел в группу конфиденциальности "Внешние" или **"Заблокированные".** <br/> Отдельные пользователи могут изменить этот параметр в диалоговом Skype для бизнеса **Параметры.** <br/> |
