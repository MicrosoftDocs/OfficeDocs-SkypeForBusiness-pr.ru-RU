...
|`Grant-CsClientPolicy -PolicyName ClientPolicyDisableSkypeUI`|Пользователь продолжит пользоваться интерфейсом Skype для бизнеса (Lync).  <br/> |Пользователю будет предложено переключиться на пользовательский интерфейс клиента Skype для бизнеса (Lync).  <br/> |
|Политика не установлена.  <br/> |Пользователи не будут видеть пользовательский интерфейс клиента Skype для бизнеса (Lync), если эта политика не задана. Пользователь будет работать только в пользовательском интерфейсе клиента Skype для бизнеса.  <br/> |Пользователь по-прежнему будет использовать пользовательский интерфейс клиента Skype для бизнеса.  <br/> |
