...
Благодаря Skype для бизнеса пользователи могут искать и мгновенные мгновенные данные для всех, Skype бесплатное приложение! В этой статье объясняется, что необходимо сделать, чтобы они могли Skype контактов. 
...
5. Выберите **Вариант Разрешите пользователям использовать Skype для бизнеса общаться с Skype пользователями за пределами организации.** 
...
Skype контактов, которые въехали с помощью учетной записи Майкрософт (прежнее Windows Live ID), могут получить некоторые (но не все) функции при Skype для бизнеса пользователями.
  
|**Доступно для Skype контактов**|**Недоступны для контактов Skype контактов**|
|:-----|:-----|
