...
- Setup
- LIL_Placement
description: 'Узнайте, как позволить пользователям, использующим Skype для бизнеса, связаться с Skype для бизнеса пользователями из-за пределов организации и добавить их в свой список контактов. '
ms.openlocfilehash: 77fb8098e7adeebd4267aed7f21153b20abd661b
ms.sourcegitcommit: 556fffc96729150efcc04cd5d6069c402012421e
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/26/2021
ms.locfileid: "58594843"
---
...
4. По умолчанию пользователи могут общаться с другими пользователями в Skype для бизнеса (предполагается, что ваш брандмауэр разрешил это). 
    ...
    ![Выберите вариант Позволить людям использовать Skype для бизнеса общаться с другими Skype.](../images/333789f8-2ea6-4bbd-805b-18130f427999.png)
...
5. Выберите Вариант Разрешите пользователям использовать Skype для бизнеса, чтобы общаться **Skype пользователями за пределами организации.** 
    
6.  Если вы используете брандмауэр Windows, Skype для бизнеса автоматически открывает необходимые порты.
    
    Если в вашей организации используется другое решение для ограничения подключения компьютеров в сети к Интернету, [](https://support.office.com/article/8548a211-3fe7-47cb-abb1-355ea5aa88a2) убедитесь, что клиентские компьютеры имеют доступ ко всем IP-адресам и URL-адресам для подключения Skype подключения и поиска Skype каталогов. Для этого может потребоваться добавить их в список исходящие разрешение в конфигурации брандмауэра или инфраструктуры прокси-сервера.
...
Чтобы проверить настройку, вам нужен контакт Skype, который не работает в брандмауэре вашей компании. Для этого можно ввести учетную запись Skype Gmail, Outlook.com или учетную запись электронной почты другого типа.
...
2. Вы можете выйти из Skype для бизнеса и снова войти, чтобы увидеть параметр поиска в Skype каталоге. 
    ...
    ![При Skype каталоге можно искать людей, у которых есть Skype учетные записи.](../images/76ee9fab-1ac3-4f4a-9569-f5f2606dbb7a.png)
...
4. Еще один способ проверить, есть ли проблема в брандмауэре, — перейти в расположение Wi-Fi, не расположенное за брандмауэром, например в кафе, и использовать Skype для бизнеса, чтобы отправить контакту Skype чат. 
   ...
   - Теперь, если сообщение проходит через кафе, но не на работе, то вы знаете, что проблема заключается в брандмауэре. 
...
- Если поиск по каталогу включен, вы можете искать и находить Skype и Skype для бизнеса пользователей. Если по какой-либо причине вам не получается найти их в каталоге, вы можете отправить им запрос на контакт, а затем попросить его войти в Skype и принять его, чтобы вы могли отправлять им мгновенные сообщение. 
...
Skype контактов, которые въехали с помощью своей учетной записи Майкрософт (прежнее Windows Live ID), могут получить некоторые(но не все) функции при разговоре с Skype для бизнеса пользователями.
  
|**Доступно для контактов Skype контактов**|**Недоступны для контактов Skype контактов**|
|:-----|:-----|
