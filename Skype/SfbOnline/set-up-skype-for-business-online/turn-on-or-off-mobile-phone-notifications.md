...
В ОС Windows Phone, Скайп для бизнес-уведомлений и Android открывать в режиме реального времени. Для Windows Phone, iPhone и iPad устройств тем не менее, push-уведомлений используется для отображения оповещения каждый раз, когда вы используете активно не Скайп для бизнеса на телефоне или планшетном ПК.
...
4. В области **уведомлений мобильный телефон**снимите флажок рядом с пунктом службы уведомлений, которые необходимо отключить и нажмите кнопку **Сохранить**.
    
Помните: 
  
- При выключении push-уведомлений пользователи по-прежнему получать все оповещения при запуске копирование Скайп для бизнеса еще раз на мобильных устройствах.
    
- Push-уведомления включены по умолчанию. Отдельные пользователи могут быть отключены, выбрав соответствующий Скайп для параметра бизнеса на мобильных устройствах.
    
- При выключении push-уведомлений пользователи не могут включить их снова.
