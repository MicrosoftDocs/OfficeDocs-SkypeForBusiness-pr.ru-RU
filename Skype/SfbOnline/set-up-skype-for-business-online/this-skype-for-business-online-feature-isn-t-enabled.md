...
К сожалению он выглядел, как пользователь не будет лицензии на этот компонент.
  
|**Возможные причины**|**Предполагаемое действие**|
|:-----|:-----|
|У вас есть доступных лицензий, но еще не включена функция для этого пользователя.  <br/> |Перейдите в **Центр администрирования Office 365** > **активных пользователей** , чтобы лицензировать этого пользователя. <br/> |
