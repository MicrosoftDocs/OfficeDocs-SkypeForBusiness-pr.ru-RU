...
1. Чтобы выбрать первых 1000 пользователей (или всех пользователей, возвращенных фильтром  или поиском), выберите поле Рядом с полем Отображаемого имени в верхней части списка.
