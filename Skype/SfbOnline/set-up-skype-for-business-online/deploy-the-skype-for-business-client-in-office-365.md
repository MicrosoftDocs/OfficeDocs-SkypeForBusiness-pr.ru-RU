...
Если вы разворачиваете приложение Skype для бизнеса в рамках развертывания Office 365 ProPlus, ознакомьтесь с разметкой [Управление office 365 профессиональный плюс с помощью Configuration Manager](https://docs.microsoft.com/configmgr/sum/deploy-use/manage-office-365-proplus-updates).
...
- [Общие сведения об обновлении Office 365 профессиональный плюс](https://technet.microsoft.com/library/dn761709.aspx)
    
- [Выбор способа управления обновлениями в Office 365 профессиональный плюс](https://technet.microsoft.com/library/dn761707.aspx)
    
- [Настройка параметров обновлений для Office 365 профессиональный плюс](https://technet.microsoft.com/library/dn761708.aspx)
