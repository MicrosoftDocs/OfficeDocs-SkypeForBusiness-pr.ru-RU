...
Чтобы получить более четкое представление о звуке и видео для пользователя, внести изменения в настройки используемого устройства и настроить его параметры можно с помощью Skype для бизнеса **App Tools** Options Audio Device или  >    >   **Video Device.** Вы также можете проверить качество звука звонка, нажав кнопку **Проверить качество звонка.** If they click **Check Call Quality**, they can then report the quality and issues found with the test call.
