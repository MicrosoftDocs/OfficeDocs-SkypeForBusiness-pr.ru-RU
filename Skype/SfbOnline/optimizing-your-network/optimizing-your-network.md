...
Работая с партнером [Майкрософт,](https://partnercenter.microsoft.com/pcv/search)вы можете подключать к сети множество приложений Microsoft 365 или Office 365, включая Skype для бизнеса Online в облаке, а для голосовой и видеосвязи в режиме реального времени для Skype для бизнеса требуется, чтобы сетевые службы были специально настроены для поддержки этих рабочих нагрузок Microsoft 365 и Office 365 в режиме реального времени. К ним относится сеть с достаточной пропускной способностью для выполнения необходимого объема трафика и поддержки качества обслуживания (QoS) для обслуживания пользователей бизнес-класса.
...
- [Планирование сети и миграции Microsoft 365 или Office 365](https://support.office.com/article/f5ee6c33-bcd7-4b0b-b0f8-dc1d9fb8d132)
...
Для обеспечения максимально высокого качества звука и видео необходимо реализовать решение, запрещающее передачу мультимедийного трафика Skype для бизнеса (аудио и видео) через VPN-туннель. Весь трафик Skype для бизнеса шифруется с помощью протокола TLS, а рабочие нагрузки мультимедиа  с помощью протокола SRTP. Сигнальный трафик шифруется с помощью TLS, а рабочие нагрузки мультимедиа  с помощью SRTP. Отправка этого трафика через VPN-канал добавляет дополнительный уровень шифрования и дополнительные сетевые переходы между клиентом и клиентом Microsoft 365 или Office 365, что может привести к ухудшению качества сеанса, так как оно увеличивает дрожание, потерю пакетов и задержку.
