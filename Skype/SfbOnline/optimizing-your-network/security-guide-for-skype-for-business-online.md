...
Skype для бизнеса Online (SfBO), в составе служб Microsoft 365 и Office 365, соблюдает все советы и процедуры по обеспечению безопасности на уровне службы посредством более глубокого управления безопасностью, контроля клиентов в службе, ужесточить безопасность и оперативные методики. Подробные сведения см. в центре управления доверием https://microsoft.com/trustcenter) (.
...
SfBO использует общие TLS (MTLS) для взаимодействия между серверами Microsoft 365 или Office 365 и TLS из клиентов в службу, из-за чего этой атаки очень трудно было достичь невозможно в течение периода времени, в течение которого могла быть совершена атака на данную беседу. TLS проверяет подлинность всех участников и шифрует весь трафик. Это не защищает от прослушивания, однако злоумышленнику не удастся прочитать передаваемые данные, если только он не взломает систему шифрования.
