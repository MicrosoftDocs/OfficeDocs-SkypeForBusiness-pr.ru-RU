...
Skype для бизнеса Online (SfBO), как часть служб Microsoft 365 и Office 365, придерживается всех методов и процедур безопасности, таких как безопасность на уровне службы, глубокое управление безопасностью, контроль клиентов в службе, ужесточить безопасность и оперативные методики. Подробные сведения см. в центре управления доверием https://microsoft.com/trustcenter) (.
...
Сетевая связь в Skype для бизнеса Online зашифровывается по умолчанию. Так как все серверы должны использовать сертификаты и использовать OAUTH, TLS, SRTP Real-Time Secure Real-Time и другие отраслевые методы шифрования, включая 256-битное шифрование AES, все данные Skype для бизнеса Online будут защищены в сети.
