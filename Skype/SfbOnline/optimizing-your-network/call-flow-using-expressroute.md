...
Если вы развертываете Skype для бизнеса Online в составе Microsoft 365, Office 365, Skype для бизнеса Server Hybrid или Skype для бизнеса Cloud Connector Edition, необходимо понимать взаимодействие между клиентом и серверами Skype для бизнеса и поток зова, чтобы эффективно планировать, развертывать, использовать и устранять неполадки веб-служб Skype для бизнеса.
 ...
 **ExpressRoute** Это сетевой сегмент, который является частью вашей общей сети и обеспечивает выделенное, частное подключение к сети Майкрософт. Этот вариант рекомендуется использовать для подключения сети к сети Майкрософт (Microsoft 365 или центрам обработки данных Office 365) для всех рабочих нагрузок, зависящих от скорости и производительности сети, например для связи Skype для бизнеса Online в режиме реального времени. Подключения ExpressRoute между вашей сетью и сетью Майкрософт используют поставщики подключения [ExpressRoute](/azure/expressroute/expressroute-locations) для обеспечения закрытой и управляемой сети, обеспечивая 99,9 % простоя и поддержку качества обслуживания (QoS), что может повысить производительность мультимедиа в режиме реального времени в периоды перегрузки сети.

 **Сеть Майкрософт** Это сетевой сегмент, который является частью общей сети, которая Microsoft 365 и Office 365 службы. Это включает все связи между серверами Online для Microsoft 365 или Office 365. Сюда может входить трафик, который проходит через магистраль сети Майкрософт и передается между географическими регионами.
...
Центр обработки данных для конференций Online будет центром обработки данных в облаке Microsoft 365 или Office 365, но центр обработки данных может быть расположен в другом географическом регионе, чем у пользователей, которые присоединяются к конференции. Это может произойти по одной из двух причин:
 ...
 **Звонок через ПС ТЕЛЕФОННАЯ СИСТЕМА в Microsoft 365 или Office 365 и Cloud Connector**
...
|Вызов ТСОП  <br/> |Клиент в Интернете и телефонная система серверы в облаке  <br/> |Интернет  <br/> |Интернет  <br/> |Неприменимо  <br/> |Мультимедиа и сигнальный сигнал будут поступать в Microsoft 365 или Office 365 центра обработки данных. Так как конечная точка клиента находится в Интернете, все данные будут поступать в центр обработки данных Майкрософт через Интернет (даже если для подключения требуется edge-сервер Online).  <br/> |
...
Гибридные потоки зовов применяются при развертывании Skype для бизнеса, включаемом по крайней мере некоторых пользователей, размещенных на локальной основе. Потоки звонков в этом разделе включают как конференции на локальной основе, так и одноранговую или ЗВОНКОВ по СТП, включив по крайней мере одного локального пользователя.
...
|Вызов между одноранговыми клиентами  <br/> |Два клиента, подключающихся из клиентской сети. Одна из них находится в Интернете, а другая — локально.  <br/> |Пользователь Online: ExpressRoute  <br/> Локальный пользователь: локальный  <br/> |локальный  <br/> |[Одноранговой звонок для Microsoft 365 или Office 365 из клиентской сети](call-flow-using-expressroute.md#bk_Figure2) <br/> |Только пользователь, который является домашним пользователем Online, отправляет сигнальный трафик в облако.  <br/> |
...
|Вызов ТСОП  <br/> |Пользователь Online, использующий Интернет с помощью Cloud Connector Edition.  <br/> |Интернет  <br/> |Интернет  <br/> |Сочетание [локального edge-сервера](call-flow-using-expressroute.md#bk_Figure5) с Microsoft 365 или Office 365 конференций и [звонками по ОКП](call-flow-using-expressroute.md#bk_Figure6)с помощью Skype для бизнеса Cloud Connector Edition.  <br/> |Пользователи Интернета подключаются через edge-сервер, который входит в cloud Connector, а Облачный соединител подключается к сети STN.  <br/> |
