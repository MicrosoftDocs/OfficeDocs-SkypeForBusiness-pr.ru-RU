...
|Вызов между одноранговыми клиентами  <br/> |Два клиента, размещенные в одной сети.  <br/> |ExpressRoute  <br/> |локальный  <br/> |[Одноранговые вызовы для пользователей Office 365 в клиентской сети](call-flow-using-expressroute.md#bk_Figure2) <br/> ||
...
|:-----|:-----|:-----|:-----|:-----|:-----|
|**Сценарий использования** <br/> |**Конечные точки** <br/> |**Путь сигнального трафика** <br/> |**Маршрут мультимедиа** <br/> |**Пример потока** <br/> |**Примечания** <br/> |
|Вызов между одноранговыми клиентами  <br/> |Два клиента, расположенные в клиентской сети и размещенные на локальных ресурсах  <br/> |Локальный  <br/> |локальный  <br/> |[Одноранговые вызовы для пользователей Office 365 в клиентской сети](call-flow-using-expressroute.md#bk_Figure2) <br/> |Так как пользователи размещены на локальных ресурсах, сигнальный трафик передается локально в собственный центр обработки данных вместо облака Office 365.  <br/> |
