...
|:-----|:-----|:-----|
|Средний коэффициент снижения звука|> 1,0|Средняя экспертная оценка снижения разборчивости речи потока в сети. Указывает, насколько дрожание и потери в сети повлияли на качество принимаемого звука.|
...
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|1|Средний процент потери локальных видеокадров|> 50|Плохой|Хороший|Перейти к шагу 2|Средний процент потери видеокадров, отображаемый пользователю. Сюда входят кадры, восстановленные после потерь в сети.|
...
|3|Video Post FECPLR|> 0,15|Плохой|Хороший|Unclassified|Коэффициент потерь пакетов после применения FEC вычислен во всех видеопотоках и кодеках.|
...
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|1|Средний процент потери видеокадров|> 50|Плохой|Хороший|Перейти к шагу 2|Средний процент потери видеокадров, отображаемый пользователю. Сюда входят кадры, восстановленные после потерь в сети.|
|2|Средний коэффициент частоты кадров|< 2|Плохой|Хороший|Перейти к шагу 3|Среднее число кадров в секунду, принимаемых для видеопотока, вычисленное за период сеанса.|
|3|Video Post FECPLR|> 0,15|Poor|Good|Неклассифицированный|Неклассифицированный|Коэффициент потерь пакетов после применения FEC вычислен во всех видеопотоках и кодеках.|
