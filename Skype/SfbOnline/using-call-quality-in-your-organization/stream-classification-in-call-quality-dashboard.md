...
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|1|Средний коэффициент локальной потери кадров|> 50% |Плохой|Хороший|Перейти к шагу 2|Средний процент потери видеокадров, отображаемый пользователю. Сюда входят кадры, восстановленные после потерь в сети.|
...
|AppSharing Relative OneWay Average|> 1,75|Средняя относительная односторонняя задержка между конечными точками в секундах для потоков совместного использования приложений.|
