 ...
 **Способ 1: использование центра администрирования Office 365**

1. Перейдите в **центр администрирования Office 365** , а затем на панели навигации слева щелкните надстройки**службы &amp; ** **параметров** > и выберите **Skype для бизнеса**.
