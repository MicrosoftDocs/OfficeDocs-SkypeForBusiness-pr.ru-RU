...
- **Включить Skype трансляцию собрания** Включает Skype трансляцию собрания. После того как Skype трансляцию собрания, необходимо настроить сеть для [Skype трансляции собрания](set-up-your-network-for-skype-meeting-broadcast.md). Сделайте это, если вы хотите проводить вебинары и другие трансляции для людей за пределами вашей компании. 
...
- **Разрешение записи трансляции собраний** Это позволяет записывать все собрания, которые должны быть записаны в ходе собрания.
    
- **URL-адрес службы поддержки службы технической поддержки для участников** Введите ссылку для участников трансляции собрания, если им требуется помощь в подключении к трансляции собрания или его посещении.
