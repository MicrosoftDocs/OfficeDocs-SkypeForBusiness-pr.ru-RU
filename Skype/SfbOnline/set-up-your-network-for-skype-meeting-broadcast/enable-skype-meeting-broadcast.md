...
Чтобы люди в вашей организации могли Skype трансляцию собраний, необходимо включить ее. Для этого необходимо знать, как использовать Windows PowerShell. Если вы не знаете, Windows PowerShell, возможно, [](https://go.microsoft.com/fwlink/?linkid=391089) вы нанимаете партнера Майкрософт, который сделает это за вас.
