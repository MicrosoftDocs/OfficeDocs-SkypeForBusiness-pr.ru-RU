...
3. В Центре **администрирования Teams перейдите** на портал устаревших порталов, на которых транслируются собрания, а затем выберите "Включить   >    >   **трансляцию собраний Skype".**
    
## <a name="enable-skype-meeting-broadcast-using-powershell"></a>Включить трансляцию собрания Skype с помощью PowerShell
...
8. Подтвердите текущую конфигурацию трансляции собраний Skype, выверив:
