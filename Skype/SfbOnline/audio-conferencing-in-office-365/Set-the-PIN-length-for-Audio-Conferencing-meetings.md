...
2. В разделе **Безопасность** > **Длина ПИН-кода** выберите количество цифр, которое необходимо использовать для ПИН-кода, затем нажмите **Сохранить**.
...
- ПИН-код может включать от 4 до 12 цифр; по умолчанию он составляет 5 цифр. При создании ПИН-кода используются только цифры. Буквы и специальные символы не используются.
