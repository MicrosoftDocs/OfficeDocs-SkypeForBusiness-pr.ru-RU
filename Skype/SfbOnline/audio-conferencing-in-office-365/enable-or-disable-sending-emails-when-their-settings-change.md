...
---
# <a name="enable-or-disable-sending-emails-when-audio-conferencing-settings-change-in-skype-for-business-online"></a>Включение и отключение отправки по электронной почте при изменении параметров звука конференц-связи в Скайп для бизнеса в Интернет

> [!Note]
> Если требуется включить или отключить отправку сообщения электронной почты в группах Microsoft видеть [Включение и отключение отправки сообщения электронной почты при изменении параметров звука конференц-связи в группах Майкрософт](/MicrosoftTeams/enable-or-disable-sending-emails-when-their-settings-change-in-teams).

Пользователи автоматически уведомления по электронной почте, включенный для аудиоконференции. Возможны ситуации, тем не менее, чтобы сократить количество сообщений, отправленных в Скайп для коммерческих пользователей. В таких случаях можно отключить отправку электронной почты.
