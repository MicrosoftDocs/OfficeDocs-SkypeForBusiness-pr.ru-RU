...
3. Нажмите кнопку **Сохранить**.
    ...
    > [!TIP]
    > Можно также отправить сообщение электронной почты с параметрами аудиоконференции пользователю, выбрав **Аудиоконференции** > **Пользователи**, выбрав пользователя и нажав **Отправить сведения о конференции по электронной почте**.  В этом случае будет отправлено сообщение электронной почты, которое содержит только код конференции и номер телефона конференции, но не ПИН-код.  Дополнительные [сведения см.](send-an-email-to-a-user-with-their-dial-in-information.md) в статьи Отправка электронной почты пользователю со сведениями об аудиоконференциях.
