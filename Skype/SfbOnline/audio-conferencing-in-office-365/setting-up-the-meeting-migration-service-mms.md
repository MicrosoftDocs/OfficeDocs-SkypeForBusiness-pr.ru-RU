...
- `MoveToTeams` Если указан параметр in `Move-CsUser` in, собрания переносятся непосредственно в Teams, и пользователь переходит в режим TeamsOnly. Для использования этого переключателя требуется Skype для бизнеса Server 2015 с обновления HF1 или более поздней версии. Эти пользователи по-прежнему могут присоединиться к собранию Skype для бизнеса, на которое они могут быть приглашены, с помощью клиента Skype для бизнеса или из приложения "собрания Skype".
...
- Если `TargetMeetingType Current` вы указываете, что собрания Skype для бизнеса останутся на собраниях Skype для бизнеса, а собрания Teams остались на собраниях Teams. Однако возможно изменение координат голосовой конференции и перенос локальных собраний Skype для бизнеса в Skype для бизнеса Online. Это значение по умолчанию для TargetMeetingType.
