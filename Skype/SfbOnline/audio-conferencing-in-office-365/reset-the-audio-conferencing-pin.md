...
## <a name="sfb-logo-30x30pngimagessfb-logo-30x30png-reset-a-users-pin"></a>![sfb логотип 30x30.png](../images/sfb-logo-30x30.png) Сброс ПИН-код пользователя
...
## <a name="sfb-logo-30x30pngimagessfb-logo-30x30png-have-a-user-reset-his-or-her-own-pin"></a>![sfb логотип 30x30.png](../images/sfb-logo-30x30.png) У пользователя сбросить свой ПИН-кода

Пользователь может сбросить ПИН-код с помощью параметра **Сбросить ПИН-код** на странице **телефонных конференций** . Страница Thsi может осуществляться одним из трех следующих способов:
