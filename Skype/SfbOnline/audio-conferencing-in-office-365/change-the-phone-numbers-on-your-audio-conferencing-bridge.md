...
В дополнение к телефонных номеров, назначенной конференц-канал, можно [получить дополнительные службы номеров](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md) (международную и обслуживание бесплатных номеров, используемый для аудиоконференций) из других расположениях и затем присвоить им для конференц-связи мост так, чтобы Разверните узел покрытия для пользователей.
...
4. На странице **Назначение** щелкните **Сохранить**.
    ...
    > [!NOTE]
    > Новый номер телефона был назначен, даже в том случае, если номер стала новый номер по умолчанию, не изменить номер по умолчанию для существующих пользователей. Для установки международную по умолчанию или телефоны, который добавляется приглашает организатора собрания, содержатся в разделе [Задание телефона, номера, находящимся на приглашает](set-the-phone-numbers-included-on-invites.md). 
...
Номера телефонов по умолчанию для пользователя, из них, включенных в свои собрания приглашает при составлении приглашения на собрание. [Телефона, номера, находящимся на приглашает](set-the-phone-numbers-included-on-invites.md)для получения дополнительных сведений см.
...
```
 > [!IMPORTANT] 
 >Можно также изменить счета по умолчанию или бесплатная числа пользователей в Скайп по центру администрирования бизнес. Тем не менее это не будет изменить расписание автоматически свои собрания. 
 
 [Телефона, номера, находящимся на приглашает](set-the-phone-numbers-included-on-invites.md)для получения дополнительных сведений см.
...
### <a name="save-time-or-automate"></a>Экономия времени благодаря автоматизации
