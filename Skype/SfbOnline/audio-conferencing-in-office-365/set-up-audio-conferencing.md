...
- **Используйте центр администрирования Skype для бизнеса**. В некоторых странах и регионах вы можете получать номера служб для мостов конференц-связи с помощью центра администрирования Skype для бизнеса. Смотрите раздел Знакомство с [телефонными номерами служб](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).
