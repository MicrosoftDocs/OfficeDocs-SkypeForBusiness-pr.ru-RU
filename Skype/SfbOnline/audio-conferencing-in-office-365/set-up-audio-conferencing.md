---
title: Настройка аудиоконференций в Skype для бизнеса
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.reviewer: oscarr
...
---
# <a name="set-up-audio-conferencing-for-skype-for-business"></a>Настройка аудиоконференций в Skype для бизнеса

Иногда людям в вашей организации требуется воспользоваться телефоном, чтобы позвонить на собрание. Именно для таких ситуаций в Skype для бизнеса есть функция аудиоконференций! Пользователи могут звонить на собрания Skype для бизнеса с помощью телефона, а не с помощью приложения Skype для бизнеса на мобильном устройстве или компьютере. 
...
1. Для аудиоконференции необходима лицензия для каждого пользователя, который будет настроить собрания с телефонным телефонным вехой. Чтобы узнать, какие лицензии необходимо приобрести для аудиоконференции и сколько они будут стоить, см. лицензирование надстройки [Skype для бизнеса.](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md)

    >[!NOTE] 
    > Аудиоконференция включена в лицензии Office 365 корпоративный E5 и в качестве надстройки.
        
2. После того, как вы приобретете лицензии с аудиоконференцией, вам необходимо назначить их тем сотрудникам в вашей организации, которые планируют или проводят собрания. См. список назначения и удаления лицензий для приложений [Microsoft 365](https://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc) для бизнеса, приобретенных для людей в организации, планируют или ведут собрания.
...
- **Используйте Центр администрирования Skype для бизнеса.** В некоторых странах и регионах номера служб для моста услуг можно получить с помощью Центра администрирования Skype для бизнеса. См. [Получение номеров телефонов служб](/microsoftteams/getting-service-phone-numbers)
    
- **Перенос существующих номеров служб**. Для переноса существующих номеров от текущего поставщика услуг или оператора связи в Microsoft 365 или Office 365. Для получения дополнительных сведений о том, как это сделать, см. статью [Передача телефонных номеров в Teams](/microsoftteams/phone-number-calling-plans/transfer-phone-numbers-to-teams) или [Управление номерами телефонов организации](/microsoftteams/manage-phone-numbers-for-your-organization).  
  
- **Использование формы запроса для новых номеров**. Иногда (в зависимости от страны или региона) вам не удастся получить новые номера служб с помощью Центра администрирования Skype для бизнеса, или вам нужны конкретные номера телефонов или коды областей. В таком случае необходимо скачать форму и отправить ее нам. Для получения дополнительных сведений см. статью [Управление номерами телефонов организации](/microsoftteams/manage-phone-numbers-for-your-organization). 
...
Затем вам нужно [](../audio-conferencing-in-office-365/set-auto-attendant-languages-for-audio-conferencing.md) настроить языки автозавершенного персонала для аудиоконференций, которые автофиденциатор использует для приветствующих пользователей при телефонном подзвучив номере для аудиоконференции. 
...
1. Перейдите в Центр администрирования > **центры администрирования**  >  **Teams**  >  **устаревший портал.**
2. Выберите **мост Аудиоконференции**  >  **Майкрософт.** 
3. Выберите номер телефона моста для связи, выберите **"Выбрать** языки", а затем выберите язык по умолчанию.
...
1. Перейдите в **Центр администрирования Microsoft 365** > **Центры администрирования** > **Teams** > **Портал прежней версии**.
2. Выберите **параметры моста аудиоконференции**  >  **Майкрософт.** Откроется страница **Параметры моста Microsoft**. 
...
1. Перейдите на устаревший портал Teams в Центре администрирования **Microsoft 365.**  >    >  
