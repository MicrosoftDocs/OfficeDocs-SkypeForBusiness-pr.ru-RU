...
- **Используйте центр Skype для бизнеса администрирования**. В некоторых странах и регионах вы можете получить номера служб для моста услуг с помощью центра Skype для бизнеса администрирования. См. [Получение номеров телефонов служб](/microsoftteams/getting-service-phone-numbers)
...
Затем вы хотите [](../audio-conferencing-in-office-365/set-auto-attendant-languages-for-audio-conferencing.md) настроить языки автоответчиков для аудиоконференций, которые автоконференциатор аудиоконференции использует для приветения вызывающего звонка на номер телефона для аудиоконференции. 
