...
3. На странице свойств пользователя в области Параметры собрания **выберите** или отзовите параметр Разрешить неавтериентным звонителям быть первыми пользователями **на собрании. Если нет, пользователь** будет ждать в "ожидании" до тех пор, пока пользователь, который пройдет проверку подлинности, не присоединится к нему.
