...
1. В Центре **администрирования Skype** для бизнеса на левой навигации перейдите к пользователям аудиоконференции.   >   
    
2. Выберите пользователя в списке и на области действий нажмите кнопку **"Изменить".** 
...
- Если вы хотите сбросить [](reset-the-audio-conferencing-pin.md)ПИН-код, см. его.
