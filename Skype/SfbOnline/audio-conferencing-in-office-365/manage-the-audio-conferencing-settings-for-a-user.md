...
---
# <a name="manage-the-audio-conferencing-settings-for-a-user-in-skype-for-business-online"></a>Управление параметрами звука конференц-связи для пользователя в Скайп для бизнеса в Интернет

> [!Note]
> Для управления параметрами пользователей в группах Microsoft статье [Управление параметрами звука конференц-связи для пользователя в группах Майкрософт](/MicrosoftTeams/manage-the-audio-conferencing-settings-for-a-user-in-teams).
