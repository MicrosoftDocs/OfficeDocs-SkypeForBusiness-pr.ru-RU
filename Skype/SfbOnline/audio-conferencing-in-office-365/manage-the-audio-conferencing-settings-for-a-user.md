...
4. Выберите пользователя, параметры которого вы хотите изменить, а затем в области действий щелкните Изменить Показывает значок ![ "Правка". ](../images/4d8bea48-be68-4e0e-a54c-73decf7ea4ec.png)
...
![Страница свойств аудиоконференции для пользователя.](../images/228550f7-92be-416d-9ab1-7c2ef54dd4e6.png)
