...
3. В центре Skype для бизнеса выберите **Пользователи**.
...
|**Параметр**|**Описание**|
|:-----|:-----|
|**Имя поставщика** <br/> |Выберите в списке своего поставщика.  <br/><br/> **Примечание:** остальные параметры в этой таблице применяются только в том случае, если выбрать Microsoft в качестве поставщика аудиоконференций.           |
