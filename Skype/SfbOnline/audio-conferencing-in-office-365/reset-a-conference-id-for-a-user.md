...
> [!NOTE]
> Если у вашего поставщика услуг конференц-связи есть Microsoft, идентификаторы конференций пользователей задаются как динамические. Изменить его нельзя. Идентификаторы конференций автоматически задаются только для пользователей Skype для бизнеса, для которых разрешена Голосовая конференция. 
