...
> [!NOTE]
> Если ваш поставщик услуг конференц-связи — Майкрософт, для ваших пользователей будут назначены только динамические ИД конференций. Эта настройка не может быть изменена. ИД конференции автоматически устанавливаются только для пользователей Skype для бизнеса для аудиоконференции. 
