---
title: Номера телефонов для аудиоконференции в Скайп для бизнеса в Интернет
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.reviewer: oscarr
...
ms.locfileid: "22490499"
---
# <a name="phone-numbers-for-audio-conferencing-in-skype-for-business-online"></a>Номера телефонов для аудиоконференции в Скайп для бизнеса в Интернет

> [!NOTE]
> Сведения о телефонных номеров в группами Майкрософт просмотрите [номера телефонов для аудиоконференции в группах Microsoft](/MicrosoftTeams/phone-numbers-for-audio-conferencing-in-teams).
