...
- **Пин-код аудиоконференции пользователя сбрасывается.**
    ...
    Вот пример такого сообщения:
     ...
     ![Изменен ПИН-код для телефонной телефонии.](../images/audio-conferencing-pin-has-changed.png)
  
- **Лицензия пользователя удаляется либо поставщик аудиоконференций изменяется с Майкрософт на другого поставщика или нет.**
    
    Это происходит  при удалении лицензии пользователя на аудиоконференцию или при смене поставщика услуг аудиоконференций с Майкрософт на стороного поставщика аудиоконференций или при установке для него параметра **Нет.** Это сообщение электронной почты содержит инструкции и сведения о том, как с помощью средства обновления собраний по сети Skype для бизнеса удалить определенные сведения об аудиоконференции, например телефонный номер конференции по умолчанию или номер конференции.
