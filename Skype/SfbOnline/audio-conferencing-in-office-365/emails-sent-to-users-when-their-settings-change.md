...
> [!Note]
> Сведения об автоматических сообщениях электронной почты в Microsoft Teams см. в этой [Microsoft Teams.](/MicrosoftTeams/emails-sent-to-users-when-their-settings-change-in-teams)
...
- **Им назначена лицензия на аудиоконференцию или при смене поставщика аудиоконференций на Майкрософт.**
    ...
    > [!NOTE]
    > Если в вашей организации включены динамические ИД конференции, все собрания пользователя, которые он запланет, будут иметь уникальные ИД конференции. Вы можете настроить [динамические](./reset-a-conference-id-for-a-user.md)ИД аудиоконференции в своей организации. 
...
- **Лицензия пользователя удаляется либо поставщик аудиоконферент изменяется с Майкрософт на другого поставщика или нет.**
    ...
    Это происходит  при удалении лицензии пользователя на аудиоконференцию или при смене поставщика услуг аудиоконференции с Майкрософт на стороного поставщика аудиоконференций или при установке для него параметра **Нет.** Это сообщение электронной почты содержит инструкции и сведения о том, как использовать средство обновления Skype для бизнеса по сети для удаления определенных сведений об аудиоконференции, таких как телефонный номер конференции по умолчанию или номер конференции.
...
Вы можете внести изменения в электронные письма, отправленные пользователям, например адрес электронной почты, с которого было отправлено сообщение, и отображаемую его имя, вы можете:
...
![Значок с логотипом Skype для бизнеса ](../images/sfb-logo-30x30.png) **с помощью Skype для бизнеса центра администрирования**  
...
2. На странице **параметров моста Microsoft** выберите или отключайте параметр Автоматически отправлять электронные письма пользователям в случае изменения параметров аудиоконференции.  
