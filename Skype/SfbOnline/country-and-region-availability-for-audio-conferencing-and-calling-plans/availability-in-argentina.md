...
Вот служб Office 365 для Скайп для бизнеса и группами Майкрософт для Аргентина.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li>Буэнос-Айрес</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
## <a name="toll-and-toll-free-numbers-for-services"></a>Звонки на платные телефоны и бесплатные номера для служб

|**Функция**|**Сведения**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?   | <ul><li>Буэнос-Айрес <li>Кордоба <li>Ла-Плата <li>Мар-Дель-Плата <li>Мендоcа <br/>  <li>Сан-Мигель-де-Тукуман <br/> |
|Доступны ли платные номера?  <br/> |Да  <br/> |
|Доступны ли бесплатные номера?  <br/> |Да  <br/> |
   
 Если вы хотите получить номер телефона и номер телефона бесплатные номера телефонов для аудиоконференции, автосекретари и вызвать очередей, видеть [Приступая к службе номера телефонов для Скайп для бизнеса и группами Майкрософт](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).
