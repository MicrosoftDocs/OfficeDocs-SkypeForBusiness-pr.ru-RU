...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для: <br/><ul><li> Лондон</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|Можно выполнять исходящие вызовы на номера premium? <br/> | Частично поддерживаемая: поддерживаются вызовы для общих затрат номеров (приставок 44843, 44844, 44845, 44870, 44871, 44872).  Звонки с префиксами 449XX не поддерживаются. <br/> |
