...
---
# <a name="availability-in-israel"></a>Доступность в Израиля
...
Вот служб Office 365 для Скайп для бизнеса и группами Майкрософт для Израиля.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Тель-Авив</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Функция**|**Сведения**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> | <ul><li>Хайфа <li>  Иерусалим <li>  Тель-Авив </ul> |
