...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для Сантьяго (доступно только для организаций в рамках Чили). Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Функция**|**Сведения**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> |Сантьяго  <br/> > [!NOTE]> Доступно только для организаций в Чили.           |
|Доступны ли платные номера?  <br/> |Да  <br/> > [!NOTE]> Доступно только для организаций в Чили.           |
