...
Вот служб Office 365 для Скайп для бизнеса и группами Майкрософт для Чили.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Сантьяго (доступно только для организаций в рамках Чили)</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Функция**|**Сведения**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> |Сантьяго  <br/> **Примечание:** Доступно только для организаций в рамках Чили.           |
|Доступны ли платные номера?  <br/> |Да  <br/> **Примечание:** Доступно только для организаций в рамках Чили.           |
