...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Нет. [Пожалуйста свяжитесь с нами](mailto:ptnapac@microsoft.com). <br/> |
...
> [!IMPORTANT]
> В настоящее время доступен только для просмотра и раннее внедрение в Австралии. Для получения дополнительных сведений см. [Telstra вызов для Office 365](https://aka.ms/TelstraVoicePlan).
