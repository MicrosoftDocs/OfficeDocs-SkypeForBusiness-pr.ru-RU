...
*    **Это план лицензии и служб, используемый для вызова.** Планы лицензии и служб, которые могут отображаться в данном отчете, относятся:
     ...
     * MCOPSTN2 - Россия & International вызов планирование, откуда будут видеть внутреннего пула (3000-минутный США и Канада/цена, 1200-минутный стран) и международных пула (600 минут). Минуты Болты достигнуто при каждом внутреннем Болты international - или связаться с вами в календарном месяце. 
