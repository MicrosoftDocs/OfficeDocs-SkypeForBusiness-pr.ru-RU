...
Этот отчет, а также другие Скайп для бизнес-отчеты подробные сведения по деятельности, включая вызов использования в организации. Эти сведения используются при вы исследование, планирование и выполнение других business принятии решений для вашей организации, а также для настройки [связи кредитов](../skype-for-business-and-microsoft-teams-add-on-licensing/what-are-communications-credits.md)
