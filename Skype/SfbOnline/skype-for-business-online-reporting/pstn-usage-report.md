...
*    **Тип звонка**  сведения о том, выполнен ли входящий или исходящий звонок по ТСОП, а также информация о типе звонка (например, звонок выполнен пользователем или по аудиоконференции). Могут отображаться следующие типы звонка: 
     ...
     *    **ucap_in** (входящий звонок в приложение объединенных коммуникаций, такое как автосекретарь или очередь звонков). 
     *    **ucap_out** (исходящий звонок из приложения объединенных коммуникаций, такого как автосекретарь или очередь звонков).
*     
