...
***
![Номер 5](../images/sfbcallout5.png)<br/>Использовать данные интерактивной диаграммы на диаграмме **минут** понять динамики использования и просмотра количество минут, применяемыми пользователями, когда они организации конференции с помощью аудио и видео и -связь и подключение по телефонной линии - Microsoft в качестве их аудиоконференций Поставщик. Здесь отображается общая продолжительность участия пользователей в конференциях с типом **Аудио/видео**.
***
