...
|||UNTRANSLATED_CONTENT_START|||When you are setting up users in your organization to make and receive phone calls, you must use the **Skype for Business admin center** and first get phone numbers that can be assigned to users.|||UNTRANSLATED_CONTENT_END|||  Назначаемый пользователю номер телефона будет номером, который выбран вами для организации. Он будет внесен в раскрывающийся список при редактировании свойств пользователя и нажатии кнопки **Назначить**.
