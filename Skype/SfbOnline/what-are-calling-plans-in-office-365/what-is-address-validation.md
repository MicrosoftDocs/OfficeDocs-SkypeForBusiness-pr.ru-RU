...
ms.locfileid: "58604248"
---
# <a name="what-is-address-validation"></a>Что такое проверка адреса?

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]?

При назначении планов звонков каждому пользователю необходимо назначить номер телефона и адрес для экстренного вызова.
  
Нужно обязательно подтвердить, что физический адрес указан верно и в правильном формате. Возможно, проверка может пройти по частично правильному адресу для экстренного устранения проблемы, такому как неправильно введенное название города. При проверке анализируются все части адреса и определяется, достаточно ли в нем сведений для направления вызова в подходящий центр экстренных служб. В этом случае адрес будет считаться проверенным и вы сможете назначить его номеру телефона.
