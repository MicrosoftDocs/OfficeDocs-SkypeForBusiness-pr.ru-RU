...
Нужно обязательно подтвердить, что физический адрес указан верно и в правильном формате. Возможно, проверка может пройти по частично правильному адресу для экстренного устранения проблем, такому как неправильно введенное название города. При проверке анализируются все части адреса и определяется, достаточно ли в нем сведений для направления вызова в подходящий центр экстренных служб. В этом случае адрес будет считаться проверенным и вы сможете назначить его номеру телефона.
