...
ms.locfileid: "32229608"
---
# <a name="what-should-i-put-in-for-the-account-number"></a>Какой номер учетной записи следует указывать?

Как правило номер счета можно найти на любой ведомости или создания счетов-фактур у поставщика услуг или поставщика может войти на веб-сайт своего оператора. Если вы по-прежнему не знаете код, можно обратитесь к поставщику услуг или поставщика для получения его.
  
> [!CAUTION]
>  Важно, что вы убедитесь, что при вводе номер службы поставщика или поставщика учетная запись не используется пробелы, тире или дефисы.
