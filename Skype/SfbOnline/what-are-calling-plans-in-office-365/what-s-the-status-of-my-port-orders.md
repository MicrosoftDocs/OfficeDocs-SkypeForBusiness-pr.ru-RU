...
|:-----|:-----|:-----|:-----|:-----|:-----|
|**Обработка** <br/> |Да  <br/> |Нет  <br/> |Да  <br/> |Нет  <br/> |Администратор создает порядок и принимается корпорацией Майкрософт.  <br/> |
|**Общаться с поставщика** <br/> |Да  <br/> |Нет  <br/> |Да  <br/> |Нет  <br/> |Порядок получения и утвержденных корпорацией Майкрософт и мы работают с ним проигравшей его утвержденных.  <br/> |
|**Передача утверждено** <br/> |Да  <br/> |Утверждение заказа Commitment(FOC)  <br/> |Да  <br/> |Нет  <br/> |Порядок принято проигравшей передающую и Дата FOC имеет значение.  <br/> |
|**Ожидание передачи** <br/> |Да  <br/> |Нет  <br/> |Нет  <br/> |Нет  <br/> |Перенос является менее 24 часов, больше не порядок можно изменить или отменена.  <br/> |
|**Ошибка** <br/> |Нет  <br/> |Да  <br/> |Да  <br/> |Да (в настоящее время невозможно удалить номеру порта Если возникает ошибка. Порядок порта необходимо повторно создать или вам требуется [обращение в службу поддержки продуктов бизнес - Admin справки](http://technet.microsoft.com/library/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b%28Office.14%29.aspx).  <br/> |Оператор проигравшей отклонил порядке.  <br/> |
