...
|Почтовый индекс аудио- и ZIP-код:||
|Номер телефона:||
|Адрес электронной почты Office 365:||
|||

> [!NOTE]
> Адрес электронной почты выше будет получать сообщения влево для вас, если вы не online при получении звонка для вас через ретрансляции IP-адресов. 

После (в течение 24 часов работы) учетной записи будет готов, мы уведомим вас обратно с имя пользователя и пароль. 


Рассмотрим процедуру в разделе [Ретрансляции IP-адресов в Канада — руководство](ip-relay-canada-user-guide.md) для начала работы. 
