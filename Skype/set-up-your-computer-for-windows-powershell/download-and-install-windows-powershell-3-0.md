...
> [!IMPORTANT]
> Данная статья переведена с помощью машинного перевода, см. [Отказ от ответственности](d739cd71-3c18-42ea-879f-b408bf53b1f4.md#MT_Footer). Используйте английский вариант этой статьи, который находится [здесь](https://support.office.com/en-us/article/d739cd71-3c18-42ea-879f-b408bf53b1f4), в качестве справочного материала. 
