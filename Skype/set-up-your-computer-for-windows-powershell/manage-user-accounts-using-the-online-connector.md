...
> [!IMPORTANT]
> Данная статья переведена с помощью машинного перевода, см. [Отказ от ответственности](a226b0d4-6359-42b8-808d-4b8ab3736d3b.md#MT_Footer). Используйте английский вариант этой статьи, который находится [здесь](https://support.office.com/en-us/article/a226b0d4-6359-42b8-808d-4b8ab3736d3b), в качестве справочного материала. 
