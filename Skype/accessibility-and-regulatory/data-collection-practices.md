---
title: "Рекомендации по сбору данных для Skype для бизнеса и Microsoft Teams"
ms.author: tonysmit
author: tonysmit
ms.date: 5/31/2017
ms.audience: Admin
...
|Идентификатор устройства  <br/> |5E872200-F546-4CCD-8F23-AF5F507AA2DD  <br/> |Идентификатор устройства  это глобальный уникальный идентификатор, который единожды генерируется на устройстве случайным образом и отправляется в службу телеметрии.  <br/> |
...
|Партнер федерации  <br/> |Microsoft.com  <br/> |Это имя организации, зарегистрированное в Office 365 и переданное в открытом видео, т. е. без затенения.  <br/> |
...
|Идентификатор пользователя  <br/> ||Идентификатор отправляется в открытом виде, который хэшируется службой телеметрии перед сохранением  <br/> |
