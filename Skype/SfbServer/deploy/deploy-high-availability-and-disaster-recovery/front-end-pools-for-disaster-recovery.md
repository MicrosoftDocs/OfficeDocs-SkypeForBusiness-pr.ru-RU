...
9. После того как Bootstrapper завершит установку необходимых компонентов для сопряжения резервных копий на каждом сервере переднего сервера в обоих пулах, обязательно повторно применив все существующие накопительные обновления, которые ранее применялись на этих серверах переднего сервера в обоих пулах, а затем продолжите выполнение следующего шага.

10. В командной командной командной области Skype для бизнеса Server запустите следующую команду: 
