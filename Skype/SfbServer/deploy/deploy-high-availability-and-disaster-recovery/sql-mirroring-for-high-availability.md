...
> [!IMPORTANT]
> При внесении изменений в отношения зеркального отображения внутренних баз данных необходимо перезагрузить все серверы переднего плана в пуле.  _Гт_ изменения в зеркальном отображении (например, изменение расположения зеркала) для выполнения этих трех действий необходимо использовать Topology Builder.
