...
1. Нажмите **кнопку** Начните, нажмите кнопку Все **программы,** **нажмите кнопку Skype для бизнеса Server 2015**, а затем нажмите кнопку **Skype для бизнеса Server Топология Builder**.
...
4. В Topology Builder **Skype для бизнеса Server**, расширим имя сайта, содержащего пул переднего конца, а затем нажмите кнопку выпуск Enterprise **пулы переднего конца**.
...
1. Нажмите **кнопку** Начните, нажмите кнопку Все **программы,** нажмите кнопку Skype для бизнеса Server **2015**, а затем нажмите кнопку **Skype для бизнеса Server мастер развертывания**.
...
4. В мастере Skype для бизнеса Server настройки на странице **Установки Skype для бизнеса Server** компоненты нажмите **кнопку Далее**.
