...
**Сводка:** Сведения о настройке регистрации Вызовов и качества взаимодействия в Скайп для Business Server 2015.
  
Настройка регистрации Вызовов и качества взаимодействия, мониторинга с помощью отчетов служб отчетов SQL Server для Скайп для Business Server 2015.
...
Когда вы устанавливаете Скайп для Business Server 2015, можно установить предварительно заданных коллекцию глобальных параметров конфигурации для регистрации Вызовов и качества взаимодействия. В следующей таблице приведены значения по умолчанию для некоторых из наиболее часто используемых CDR параметров.
