...
Skype для бизнеса Server может использовать SQL Server Reporting Services (SSRS) для просмотра отчетов и мониторинга. Для использования этой функции необходимо установить и настроить службы отчетности.
