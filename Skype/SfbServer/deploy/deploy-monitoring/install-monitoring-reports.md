...
- **Новые отчеты о качестве голосовой связи**. These new reports include the [Media Quality Comparison Report in Skype for Business Server](../../manage/health-and-monitoring/comparison.md), which compares quality between different types of calls (for example, between wired calls and wireless calls); и отчет о времени присоединиться к конференции в Skype для бизнеса [Server,](../../manage/health-and-monitoring/join-time-report.md)который содержит сведения о времени, необходимом пользователям для join a conference. 
