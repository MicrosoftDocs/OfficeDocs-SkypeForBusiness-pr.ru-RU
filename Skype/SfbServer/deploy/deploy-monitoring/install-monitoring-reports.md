...
Существует два способа установки отчетов Skype для бизнеса Server мониторинга: вы можете использовать мастер развертывания Skype для бизнеса Server или сценарий Windows PowerShell, включенный в Skype для бизнеса Server файлов установки. Независимо от выбранного способа установки этих отчетов сначала необходимо убедиться в следующем.
