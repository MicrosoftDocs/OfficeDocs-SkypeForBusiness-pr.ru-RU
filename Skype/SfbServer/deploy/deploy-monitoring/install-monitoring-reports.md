...
Отчеты мониторинга не устанавливаются автоматически при установке Skype для бизнеса Server; вместо этого необходимо установить отчеты мониторинга отдельно и только после установки Skype для бизнеса Server на компьютере.
...
Skype для бизнеса Server отчеты мониторинга включают более 30 отчетов, предназначенных для предоставления подробных сведений о конференциях, одноранговых сеансах мгновенных сообщений, регистрации пользователей, приложении группы реагирования и многое другое. В версии 2013 Skype для бизнеса Server отчеты по мониторингу включают ряд улучшений:
  
- **Новые отчеты о качестве голосовой связи**. Эти новые отчеты включают отчет о сравнении качества мультимедиа в [Skype для бизнеса Server](../../manage/health-and-monitoring/comparison.md), который сравнивает качество между различными типами вызовов (например, между проводными вызовами и беспроводными вызовами); и отчетом о времени звонков на конференции в [Skype для бизнеса Server](../../manage/health-and-monitoring/join-time-report.md) , которая предоставляет сведения о времени, требуемом для пользователей, чтобы присоединиться к конференции. 
    
- **Улучшенные отчеты для анализа и диагностики видео связи и сеансов совместного использования приложений.** [Сводный](../../manage/health-and-monitoring/summary.md) отчет о качестве мультимедиа в Skype для бизнеса Server позволяет анализировать вызовы для обмена видео и приложений, в то время как отчет о [](../../manage/health-and-monitoring/server-performance.md) производительности сервера в Skype для бизнеса Server содержит сведения о производительности серверов, генерирующих эти вызовы. Метрики совместного доступа к видео и приложениям теперь также сообщаются в отчете о подробностях одноранговых сеансов в Skype для бизнеса Server и отчете о подробностях [конференции в Skype для бизнеса Server](../../manage/health-and-monitoring/detail-report.md).[](../../manage/health-and-monitoring/peer-to-peer-session-detail-report.md)
...
Существует два способа установки отчетов Skype для бизнеса Server мониторинга: вы можете использовать мастер развертывания Skype для бизнеса Server или сценарий Windows PowerShell, включенный в Skype для бизнеса Server файлы установки. Независимо от выбранного способа установки этих отчетов сначала необходимо убедиться в следующем.
...
1. Нажмите **кнопку** Начните, нажмите кнопку Все **программы,** **нажмите Skype для бизнеса Server** и нажмите кнопку **Skype для бизнеса Server мастер развертывания**.
...
Отчеты мониторинга также можно установить из Skype для бизнеса Server-оболочки управления с помощью DeployReports.ps1; \<install location\>этот Windows PowerShell скрипт можно найти в папке \Skype для бизнеса Server 2015\Deployment\Setup. Чтобы установить отчеты мониторинга с помощью скрипта DeployReports.ps1, в командной консоли введите команду, аналогичную следующей:
