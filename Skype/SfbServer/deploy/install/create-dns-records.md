...
|**Description**|**Record Type (Тип записи)**|**Название**|**Во что разрешается**|**Тип балансировки нагрузки**|
|:-----|:-----|:-----|:-----|:-----|
...
|Skype для бизнеса Автооткрывка  <br/> |A  <br/> |lyncdiscoverinternal.contoso.local  <br/> |VIP для внутренних веб-служб  <br/> |Поддерживаемые программное обеспечение и оборудование  <br/> |
...
|Legacy Discovery  <br/> |SRV  <br/> |_sipinternaltls._tcp.contoso.local  <br/> |FQDN пула (порт 5061)  <br/> |Н/Д  <br/> |
...
3. В дереве консоли для домена SIP раздвигайте зоны forward **lookup** и затем расширяйте домен SIP, в котором Skype для бизнеса Server будут установлены.
