...
1. Если будет использоваться Скайп для панели управления Business Server на этом сервере необходимо также установить Silverlight. Об установке Silverlight см. раздел [Microsoft Silverlight](https://www.microsoft.com/silverlight/).
