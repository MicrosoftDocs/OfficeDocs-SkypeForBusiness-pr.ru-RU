...
1. **Запустите Windows обновления**, чтобы проверить, есть ли какие-либо обновления ролей и служб, которые были установлены.
