...
2. Щелкните правой кнопкой мыши папку, которая планируется поделиться, и выберите **Свойства**.
    
3. Выберите **вкладку "Общий** доступ" и нажмите **кнопку Расширенный общий доступ**.
    
4. **Щелкните Делиться этой папкой**.
    
5. Выберите пункт **Разрешения**.
    
6. Добавьте **локализованную** группу администраторов сервера, на который размещена файлообменная группа, дайте разрешение: полный контроль **,** изменение и чтение прав, а затем нажмите **кнопку ОК**.
