...
---
# <a name="install-skype-for-business-server-2015-on-servers-in-the-topology"></a>Установка Skype для бизнеса Server 2015 на серверах в топологии
 
**Сводка:** Узнайте, как установить Скайп компонентов системы, Business Server 2015 на каждом сервере в топологии. Загрузите бесплатную пробную версию программы Скайп для Business Server 2015 [Центр оценки Microsoft](https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server).
...
1. Вставка Скайп для Business Server 2015 установочного носителя. Если установка не началась автоматически, дважды нажмите **Setup**.
