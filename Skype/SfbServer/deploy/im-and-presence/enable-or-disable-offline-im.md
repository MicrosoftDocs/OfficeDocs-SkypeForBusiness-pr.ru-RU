...
### <a name="to-enable-or-disable-offline-im-in-skype-for-business-server"></a>To enable or disable Offline IM in Skype for Business Server
...
Существует двухминутный период времени, с того времени, когда автономное сообщение отправляется, когда оно было обработано и обработано. Если автономные сообщения не могут быть обработаны, они будут отображаться в следующем каталоге: 
