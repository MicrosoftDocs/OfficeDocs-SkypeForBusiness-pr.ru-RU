...
4. Щелкните имя соответствующей конфигурации — глобальной, сайта или пула — в списке конфигураций архивирования, затем щелкните **Правка**, щелкните **Показать подробности** и выполните следующие действия:
   ...
   - Чтобы включить интеграцию с Exchange хранилищем, выберите контрольный **Exchange Microsoft**.
...
Если вы используете Exchange Microsoft Microsoft Exchange Server и не развертывается в том же лесу, что и Skype для бизнеса Server, необходимо убедиться, что следующие атрибуты Exchange Active Directory синхронизируются с лесом, где Skype для бизнеса Server развертывается:
