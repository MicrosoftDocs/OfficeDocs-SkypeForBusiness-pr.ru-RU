...
> [!NOTE]
> Если для развертывания включена интеграция с Microsoft Exchange, политики удержания Exchange In-Place контролируют, включена ли архивация для пользователей, которые размещены в Exchange и наложены ли их почтовые ящики на In-Place удержание. 
...
3. В левой панели навигации щелкните **"Мониторинг и** архивации" и выберите "Политика **архивации".**
    ...
    Подробные сведения о том, как работают политики архива, включая иерархию глобальных политик, политик сайтов и пользователей, см. в плане архива в [Skype для бизнеса Server.](../../plan-your-deployment/archiving/archiving.md)
