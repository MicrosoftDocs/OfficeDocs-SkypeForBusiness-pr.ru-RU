...
---
# <a name="configure-archiving-policies-for-skype-for-business-server"></a>Настройка политик архивации для Скайп для Business Server
 
**Сводка:** Прочтите этот раздел, чтобы узнать, как Настройка начальной политик архивации для Скайп для пользователей Business Server.
...
Для получения дополнительных сведений о том, как архивации политики работы, включая иерархии для глобальной, сайта и политики пользователей, см. [Планирование архивации в Скайп для Business Server](../../plan-your-deployment/archiving/archiving.md). Для получения дополнительных сведений об управлении политики после развертывания, см. [Управление политик архивации в Скайп для Business Server](../../manage/archiving/policies.md).
...
3. На левой панели навигации щелкните **Мониторинг и архивация**, а затем щелкните **Политика архивации**.
    ...
    Для получения дополнительных сведений о том, как архивации политики работы, включая иерархии для глобальной, сайта и политики пользователей, см. [Планирование архивации в Скайп для Business Server](../../plan-your-deployment/archiving/archiving.md).
