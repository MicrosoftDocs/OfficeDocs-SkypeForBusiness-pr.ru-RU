...
Подробные сведения о том, как реализуются конфигурации архивации, включая параметры, которые можно указать, и иерархию конфигураций архивации см. в материале [Plan for archiving in Skype для бизнеса Server](../../plan-your-deployment/archiving/archiving.md). Сведения об управлении конфигурациями после развертывания с помощью панели управления или с помощью Windows PowerShell см. в [Skype для бизнеса Server.](../../manage/archiving/options.md)
