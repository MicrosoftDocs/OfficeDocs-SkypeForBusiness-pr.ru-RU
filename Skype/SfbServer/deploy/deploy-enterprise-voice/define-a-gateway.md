...
---
# <a name="define-a-gateway-in-topology-builder-in-skype-for-business-server-2015"></a>Определение шлюза в построителе топологий в Skype для бизнеса Server 2015
 
**Сводка:** Узнайте, как определить шлюз ТСОП в построителе топологий в Скайп для Business Server 2015.
...
5. Указать корневую магистраль для шлюза ТСОП. Магистраль — это логическое соединение между сервером-посредником и шлюзом, уникально определяется следующим кортежем.
