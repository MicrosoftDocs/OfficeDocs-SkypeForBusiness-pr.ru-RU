...
9. В разделе **Метод маршрутизации** выберите метод маршрутизации вызовов для агентов, входящих в группу, следующим образом:
   ...
   - Чтобы сначала предложить новый вызов агенту, который больше всего простаивает  (имеет наличие доступных или неактивных в Skype для бизнеса самом длинном), нажмите кнопку **Longest idle**.  
   ...
   - Чтобы предложить новый вызов всем агентам, которые подписаны в Skype для бизнеса и приложении группы ответа в то же время, независимо от их текущего присутствия, щелкните **Attendant**. Пользователи, настроенные в качестве агентов, могут видеть все вызовы, ожидающих и отвечающих на вызовы ожидания в любом порядке. Вызов отправляется первому агенту, который принимает его, после чего другие агенты больше не видят вызов.
