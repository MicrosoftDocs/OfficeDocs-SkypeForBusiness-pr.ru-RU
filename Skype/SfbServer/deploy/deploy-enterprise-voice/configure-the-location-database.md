...
|**Subnet** <br/> |\<Подсети\>,\<описание\>,\<расположение\>,\<CompanyName\>,\<HouseNumber\>,\<HouseNumberSuffix\>,\<PreDirectional\>,...  <br/> ... \<StreetName\>,\<StreetSuffix\>,\<PostDirectional\>,\<Город\>,\<состояние\>,\<PostalCode\>,\<страны\>  <br/> |
