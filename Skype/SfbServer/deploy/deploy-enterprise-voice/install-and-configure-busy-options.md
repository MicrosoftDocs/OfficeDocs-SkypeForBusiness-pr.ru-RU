...
Прочитайте о том, как установить и настроить параметры «занят» в Скайп для Business Server 2015.
...
Чтобы настроить параметры «занят», используйте командлет [Set-CsBusyOptions](http://technet.microsoft.com/library/8ffbb832-3e55-4d6c-9a7c-5ce2df22de2e.aspx) .
...
Параметры «занят» можно удалить с помощью командлета [Remove-CsBusyOptions](http://technet.microsoft.com/library/159e5931-10f1-4226-bcc4-38548f88f0d4.aspx) . Следующая команда удаляет параметры занятости для пользователя "Ken Myer":
