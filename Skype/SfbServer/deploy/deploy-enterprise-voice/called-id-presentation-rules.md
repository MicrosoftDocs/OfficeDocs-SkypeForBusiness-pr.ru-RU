...
5. В разделе **Build a Translation Rule** (Создание правила преобразования) введите следующие значения:
   ...
   - **Длина:** укажите количество цифр в шаблоне совпадения и выберите, должен ли шаблон точно соответствовать номерам, которые имеют эту длину, по крайней мере эту длину или любую длину. Например, введите 11 и selectAt least в выпадаемом списке для совпадения номеров длиной не менее 11 цифр.

   - **Цифры для удаления**: (Необязательно) Укажите количество начальных цифр, которые необходимо удалить. Например, введите 1, чтобы вывести +из начала номера.
