...
Если приложение SNMP установлено и службе сведений о расположении не удается найти соответствие в базе данных расположений, служба сведений о расположении автоматически запрашивает приложение с помощью MAC-адреса, предоставленного клиентом. Затем служба сведений о расположении использует порт и сведения о коммутаторе, возвращенные приложением SNMP, для повторного запроса базы данных расположений.
