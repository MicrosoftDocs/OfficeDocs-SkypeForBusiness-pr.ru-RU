...
|Настройка базы данных расположения  <br/> |1. Заполнять базу данных сопоставлением сетевых элементов с расположениями.  <br/> 2. Для шлюзов ELIN добавьте в столбец \<CompanyName\> ИАИ.  <br/> 3. Настройка подключения к поставщику услуг E9-1-1 для проверки адресов.  <br/> 4. Проверка адресов с поставщиком услуг E9-1-1.  <br/> 5. Публикация обновленной базы данных.  <br/> 6. Для шлюзов ELIN загрузите ELIN в базу данных автоматической идентификации местоположения (ALI) оператора ПСП.  <br/> |CSVoiceAdmin  <br/> CSLocationAdmin  <br/> |[Настройка базы данных расположения в Skype для бизнеса Server](configure-the-location-database.md) <br/> |
