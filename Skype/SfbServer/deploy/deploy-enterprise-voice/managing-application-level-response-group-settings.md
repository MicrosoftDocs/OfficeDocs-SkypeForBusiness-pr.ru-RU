...
Параметры уровня приложения для приложения группы ответа включают конфигурацию музыки при удержании по умолчанию, аудиофайл музыки при удержании по умолчанию, льготный период переключения агента и конфигурацию контекста вызова. Для каждого пула вы можете определить только один набор параметров уровня приложения. Чтобы просмотреть эти параметры, используйте командлет **Get-CsRgsConfiguration**. Чтобы изменить их, используйте командлет **Set-CsRgsConfiguration**.
