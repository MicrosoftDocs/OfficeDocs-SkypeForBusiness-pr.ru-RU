...
---
# <a name="create-network-region-links-in-skype-for-business-server-2015"></a>Создание связей между сетевыми областями в Skype для бизнеса Server 2015
...
Регионы в сети связываются с помощью физического подключения глобальной сети. Связь между областями сети создается связь между двумя областями, которые настроены для вызова контроля допуска (CAC) и задает ограничения пропускной способности для трафика аудио- и видеоконференций между этими областями.
