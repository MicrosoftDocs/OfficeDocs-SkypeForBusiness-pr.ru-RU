...
Включить обход сервера-посредника для обхода сервера-посредника в Skype для бизнеса Server Корпоративная голосовая связь. 
 ...
 Если вы используете действия, которые вы используете в этом разделе для настройки глобальных параметров для обхода мультимедиа, предположим, что у вас есть хорошая связь между конечными точками Skype для бизнеса и любым одноранговой точкой, для которой вы настроили обход мультимедиа в магистрали.
