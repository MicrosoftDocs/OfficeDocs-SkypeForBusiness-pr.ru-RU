...
### <a name="to-create-network-interregional-routes-by-using-skype-for-business-server-management-shell"></a>Создание межрегиональных сетевых маршрутов с помощью оболочки управления Skype для бизнеса Server
