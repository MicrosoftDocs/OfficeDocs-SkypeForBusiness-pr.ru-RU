...
Расширенные функции Корпоративная голосовая связь [контроля](../../plan-your-deployment/enterprise-voice-solution/call-admission-control.md)допуска вызовов, [обхода](../../plan-your-deployment/enterprise-voice-solution/media-bypass.md) [мультимедиа,](../../plan-your-deployment/enterprise-voice-solution/location-based-routing.md)маршруты на основе расположения и [E9-1-1](../../plan-your-deployment/enterprise-voice-solution/emergency-services.md). Все эти функции требуют создания областей сети, сетевых сайтов и подсетей. Например, для всех этих функций необходимо, чтобы каждая подсеть в топологии была связана с определенным сетевым сайтом, а каждый сетевой узел — с областью сети. Дополнительные сведения об этих условиях см. в параметрах сети для расширенных функций Корпоративная голосовая связь [Skype для бизнеса Server.](../../plan-your-deployment/enterprise-voice-solution/network-settings-for-advanced-features.md)
...
Если вы уже создали области сети для одной из этих функций, вам не нужно создавать новые области сети; Другие расширенные Корпоративная голосовая связь будут использовать те же области сети.
...
2. Чтобы создать области сети, используйте командлет New-CsNetworkRegion.
   ...
   ```
    ...
    В этом примере создается область сети NorthAmerica, связанная с центральным сайтом с ИД CHICAGO.
...
6. На странице **"Изменение области"** измените значения параметров области сети соответствующим образом.
...
Все настроенные общедоступные IP-адреса аудио- и видеоконферентов в развертывании должны быть добавлены в параметры конфигурации сети. Эти IP-адреса добавляются в качестве подсетей с маской 32. Связанный сетевой сайт должен соответствовать соответствующему настроенного сетевому сайту. Например, общедоступным IP-адресом, соответствующим службе A/V Edge на центральном сайте Чикаго, будет NetworkSiteID Chicago.
