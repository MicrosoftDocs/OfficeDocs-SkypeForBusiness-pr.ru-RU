...
- Для использования функции контроля допуска звонков необходимо указать профиль политики пропускной способности для каждого сайта, на который распространяются ограничения полосы пропускания WAN. Если вы планируете развернуть управление приемом вызовов, необходимо создать профили политики пропускной способности [в Skype для бизнеса Server,](create-bandwidth-policy-profiles.md) прежде чем настроить сетевые сайты.

- Для использования E9-1-1 необходимо указать политику расположения для каждого сайта. Если планируется развертывание E9-1-1, перед настройкой сетевых сайтов необходимо создать политики расположения в [Skype для бизнеса Server.](create-location-policies.md)
...
### <a name="to-create-a-network-region-using-skype-for-business-server-management-shell"></a>Создание сетевого региона с помощью оболочки управления Skype для бизнес-серверов
...
### <a name="to-create-a-network-region-using-skype-for-business-server-control-panel"></a>Создание сетевого региона с помощью панели управления Skype для бизнес-серверов
...
### <a name="to-modify-a-network-region-using-skype-for-business-server-management-shell"></a>Изменение сетевого региона с помощью оболочки управления Skype для бизнес-серверов
...
### <a name="to-modify-a-network-region-using-skype-for-business-server-control-panel"></a>Изменение сетевого региона с помощью панели управления Skype для бизнес-серверов
...
### <a name="to-create-a-network-site-by-using-skype-for-business-server-management-shell"></a>Создание сетевого сайта с помощью оболочки управления Skype для бизнес-серверов
...
### <a name="to-create-a-network-site-by-using-skype-for-business-server-control-panel"></a>Создание сетевого сайта с помощью панели управления Skype для бизнес-серверов
...
### <a name="to-modify-a-network-site-by-using-skype-for-business-server-management-shell"></a>Изменение сетевого сайта с помощью оболочки управления Skype для бизнес-серверов
...
### <a name="to-modify-a-network-site-by-using-skype-for-business-server-control-panel"></a>Изменение сетевого сайта с помощью панели управления Skype для бизнес-серверов
...
### <a name="to-associate-a-subnet-with-a-network-site-by-using-skype-for-business-server-management-shell"></a>Связывать подсети с сетевым сайтом с помощью оболочки управления Skype для бизнес-серверов
...
### <a name="to-associate-a-subnet-with-a-network-site-by-using-skype-for-business-server-control-panel"></a>Связывать подсети с сетевым сайтом с помощью панели управления Skype для бизнес-серверов
