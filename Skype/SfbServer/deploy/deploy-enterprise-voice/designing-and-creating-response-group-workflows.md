...
### <a name="to-use-response-group-configuration-tool-to-create-or-modify-a-hunt-group-workflow"></a>Использование средства настройки группы ответа для создания или изменения рабочего процесса группы поиска
...
6. Выполните одно из указанных ниже действий.
   ...
   - В **области "Создать рабочий процесс" рядом** с **"Hunt Group"**(Создать) нажмите кнопку **"Создать" (Создать).**
...
Приложение группы ответа предлагает функции распознавания речи и текста в речь на 26 языках. Вы можете ввести вопросы IVR с помощью функции синтеза речи или WAV- или WMA-файла. Вызывающие абоненты могут ответить, используя голос или команды тонального набора (DTMF).
...
![Проектирование потоков вызовов с помощью интерактивного реплицы голосовой почты](../../media/Ops_OCS_RGS_IVRLevel1.jpg)
...
![Проектирование потоков вызовов с помощью интерактивного реплицы голосовой почты](../../media/Ops_OCS_RGS_IVRLevel2.jpg)
...
14. (Необязательно) В **описании** введите описание рабочего процесса, который должен отображаться на карточке контакта в Skype для бизнеса.
