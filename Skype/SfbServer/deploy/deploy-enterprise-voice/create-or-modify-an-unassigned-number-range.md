...
7. Если на предыдущем шаге выбран вариант **Оповещение**, выполните следующие действия.
    ...
    a) В разделе **полное доменное имя конечного сервера**щелкните **выбрать**, идентификатор службы службы приложения, на котором выполняется приложение оповещения, который будет обрабатывать входящие звонки для этого диапазона неназначенных номеров и нажмите кнопку **ОК**.
