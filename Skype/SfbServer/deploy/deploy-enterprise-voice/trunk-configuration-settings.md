...
description: Сводка. Узнайте, как создать новую коллекцию параметров конфигурации магистрали с помощью панели управления Skype для бизнес-серверов.
ms.openlocfilehash: e11a372573655bb2a381b81352c20e05fd54db08
ms.sourcegitcommit: 01087be29daa3abce7d3b03a55ba5ef8db4ca161
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/23/2021
ms.locfileid: "51103325"
---
...
**Сводка:** Узнайте, как создать новую коллекцию параметров конфигурации магистрали с помощью панели управления Skype для бизнес-серверов.
...
При создании параметров конфигурации магистрали SIP с помощью панели управления Skype для бизнес-серверов доступны следующие параметры.
...
> [!NOTE]
> Комлеты Skype для бизнеса Server CsTrunkConfiguration поддерживают дополнительные свойства, не показанные в панели управления Skype для бизнес-серверов. Дополнительные сведения см. в разделе Справка для [комлета New-CsTrunkConfiguration.](/powershell/module/skype/new-cstrunkconfiguration?view=skype-ps)
  
### <a name="to-create-new-trunk-configuration-settings-by-using-skype-for-business-server-control-panel"></a>Создание новых параметров конфигурации магистрали с помощью панели управления Skype для бизнес-серверов
...
7. В **диалоговом окне Панель** управления Skype для бизнес-сервера нажмите **кнопку ОК**.
