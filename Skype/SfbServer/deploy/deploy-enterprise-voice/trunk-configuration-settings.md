...
description: 'Сводка: сведения о создании новой коллекции параметров конфигурации канала с помощью панели управления "Skype для бизнеса Server".'
ms.openlocfilehash: 9e208355f02d97802b2e1de2457e542fc0bb12c3
ms.sourcegitcommit: dd3a3ab4ddbdcfe772f30fb01ba3b97c45c43dd4
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/04/2020
ms.locfileid: "41766953"
---
...
**Сводка:** Сведения о том, как создать коллекцию параметров настройки магистрали с помощью панели управления "Skype для бизнеса Server".
...
При создании параметров конфигурации магистральной магистрали SIP с помощью панели управления Skype для бизнеса Server доступны следующие параметры.
...
### <a name="to-create-new-trunk-configuration-settings-by-using-skype-for-business-server-control-panel"></a>Создание новых параметров конфигурации канала с помощью панели управления Skype для бизнеса Server
...
7. В диалоговом окне " **Панель управления" в Skype для бизнеса Server** нажмите кнопку " **ОК**".
