...
> [!NOTE]
> В Skype для бизнеса Server CsTrunkConfiguration поддерживаются дополнительные свойства, не показанные Skype для бизнеса Server панели управления. Дополнительные сведения см. в разделе Справка для [комлета New-CsTrunkConfiguration.](/powershell/module/skype/new-cstrunkconfiguration?view=skype-ps)
