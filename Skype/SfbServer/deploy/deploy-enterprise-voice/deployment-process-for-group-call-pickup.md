...
|Назначить пользователям номер вызова и включить групповую группу вызова для пользователей  <br/> |Используйте параметр /enablegrouppickup в средстве набора ресурсов SEFAUtil, чтобы включить групповой вызов и назначить номер вызова для пользователей.  <br/> |-  <br/> |[Включить групповую подбираемую группу для пользователей и назначить номер группы в Skype для бизнеса](enable-group-call-pickup-for-users-and-assign-a-group-number.md) <br/> |
