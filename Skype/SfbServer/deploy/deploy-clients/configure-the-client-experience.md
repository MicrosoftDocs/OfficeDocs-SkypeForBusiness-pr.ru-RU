...
|:-----|:-----|:-----|:-----|
|Skype для бизнеса Server |Верно  <br/> |Пользователь попросят перейти на Skype для бизнеса  <br/> |Skype для бизнеса  <br/> |
|Skype для бизнеса Server |False  <br/> |Режим Lync  <br/> |Пользователь запросят перейти в режим Lync  <br/> |
|Lync Server 2010 или Lync Server 2013 (с правильными исправлениями)  <br/> |Верно  <br/> |Пользователь попросят перейти на Skype для бизнеса  <br/> |Skype для бизнеса  <br/> |
