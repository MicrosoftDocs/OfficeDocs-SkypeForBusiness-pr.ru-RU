...
В данном разделе приведены сведения о способах развертывания комнат группами Майкрософт в гибридной среде с Exchange при локальном и Скайп для бизнеса в Интернет.
...
Перед развертыванием комнат группами Майкрософт с сервером Exchange при локальном убедитесь, что удовлетворены требования. Для получения дополнительных сведений в разделе [requirements комнат группами Майкрософт](../../plan-your-deployment/clients-and-devices/requirements.md).
...
### <a name="assign-a-skype-for-business-license-to-your-microsoft-teams-rooms-account"></a>Назначение Скайп для корпоративную лицензию свою учетную запись Microsoft группами комнат
