...
|internalAutoDiscoveryURL    |Строка    |URL-адрес службы полного автообнаружения    |URL-адрес службы внутреннего автообнаружения    |
|externalAutoDiscoveryURL    |Строка    |URL-адрес службы полного автообнаружения    |URL-адрес службы внешнего автообнаружения    |
