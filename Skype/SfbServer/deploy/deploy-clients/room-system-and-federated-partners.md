...
После включения формата TNEF для удаленной организации все сообщения, отправленные в организацию через Интернет, отправляются в виде вложения в формате TNEF. Если TNEF включен, то при отправлении запроса на собрание Skype для бизнеса федератированному партнеру Skype для бизнеса система комнат Skype сможет отрисовки собрания перейти к собранию Skype для бизнеса, а удаленные пользователи смогут присоединяться к собраниям Skype для бизнеса. 
