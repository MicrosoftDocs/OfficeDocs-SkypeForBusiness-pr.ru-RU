...
- Запустите следующие средства:
  ...
  - Skype для бизнеса Анализатор лучших практик     
  - Skype для бизнеса Средство анализа состояния здоровья (Excel)    
  - Skype для бизнеса Анализатор подключения 32-bit или 64-Bit
    
- Просмотрите полезные новые средства устранения [неполадок](/archive/blogs/educloud/useful-new-troubleshooting-and-analysis-tools-for-office-365)и анализа для Office 365 . Подтвердим, что Skype для бизнеса пул и сервер Office веб-приложений и можете PowerPoint колоду с Skype для бизнеса клиентом.
...
## <a name="skype-room-system-security"></a>Skype Безопасность системы номеров

Skype Система room system — это встроенная система, которая может быть полностью интегрирована в развертывание Windows, используя Skype для бизнеса, управление правами и средства управления, такие как SCOM. Поддерживаются перечисленные ниже возможности. 
...
Skype Room System выполняет Skype для бизнеса настольного клиента в фоновом режиме. Если Skype является членом домена, она обнаружит вашу KMS. (и если у него есть ключ KMS тома, он активируется автоматически). Лицензирование тома также предоставляет MAK, который вы вводите, когда он отображает xxxxx-xxxxx-xxxxx-xxxxx. (Вам нужен доступ в Интернет, чтобы активировать с помощью MAK, но не KMS). Дополнительные сведения см. в Office тома 2013 г.
