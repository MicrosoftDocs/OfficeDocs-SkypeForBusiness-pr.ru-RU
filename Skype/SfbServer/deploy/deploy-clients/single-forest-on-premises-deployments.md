...
3. Настройте учетную запись для автоматического разрешения конфликтов, принимая собрания или отклоняет их. Skype Учетные записи конференц-залов, оборудованных системой комнат в Exchange, могут управляться отдельными лицами, но обратите внимание, что до тех пор, пока человек не примет собрание, оно не будет отображаться в календаре домашнего экрана Skype системы номеров.
