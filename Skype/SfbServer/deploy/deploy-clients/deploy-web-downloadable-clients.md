...
> [!NOTE]
> В Скайп для развертываний пограничного сервера Business Server 2015 HTTPS обратного прокси-сервер в сети периметра необходим для Скайп для бизнес-приложение Web клиентского доступа. Помимо этого, необходимо опубликовать простые URL-адреса. Дополнительные сведения см [Параметр копирование обратного прокси-серверы](http://technet.microsoft.com/library/00bc138a-243f-4389-bfa5-9c62fcc95132.aspx) и [требования к DNS для простых URL-адресов в Скайп для Business Server](../../plan-your-deployment/network-requirements/simple-urls.md). 
