...
> [!NOTE]
> Сведения об установке Skype для бизнеса, которые Microsoft 365 и Office 365, см. в Skype для бизнеса клиенте Microsoft 365 [или Office 365.](https://support.office.com/article/8c563b81-22c9-4024-9efe-9fe28c7bbc96) 
...
- [Используйте средство Office настройки (OCT)](use-the-office-customization-tool-oct.md) в Skype для бизнеса Server настройки параметров и функций для Skype для бизнеса и других Office программ.
...
- [Используйте параметры командной](use-setup-command-line-options.md) строки установки в Skype для бизнеса Server, чтобы указать Config.xml, который можно использовать во время установки.
