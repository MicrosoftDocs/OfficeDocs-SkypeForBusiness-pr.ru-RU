...
---
# <a name="skype-room-systems-v2-scripts"></a>Сценарии v2 систем Скайп комнаты
 
Скопируйте разделах в этой статье в текстовый файл с именем в заголовок раздела. Эти файлы используются в развертывании версии 2 Скайп комнаты систем: 
* [CreateSrsMedia.ps1](#createsrsmediaps1) — это сценарий Powershell, используемые для создания образа программного обеспечения для устройства консоли.  
* [SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) — это Powershell, будет использовать сценарий, используемый для настройки Скайп для учетных записей Exchange и бизнес-устройства.  
* [SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) используется при настройке управление системами комнаты Скайп версии 2 с помощью OMS.
