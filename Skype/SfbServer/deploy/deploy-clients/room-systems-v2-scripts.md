---
title: Сценарии Скайп комнаты систем версии 2
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 5/10/2018
...
description: Используйте этот раздел для получения сценарии, используемые с системами комнаты Скайп версии 2.
...
---
# <a name="skype-room-systems-v2-scripts"></a><span data-ttu-id="19cc9-103">Сценарии v2 систем Скайп комнаты</span><span class="sxs-lookup"><span data-stu-id="19cc9-103">Skype Room Systems v2 Scripts</span></span>
 
<span data-ttu-id="19cc9-104">Скопируйте разделах в этой статье в текстовый файл с именем в заголовок раздела.</span><span class="sxs-lookup"><span data-stu-id="19cc9-104">Copy each of the sections in this article into a text file named in the section heading.</span></span> <span data-ttu-id="19cc9-105">Эти файлы используются в развертывании версии 2 Скайп комнаты систем:</span><span class="sxs-lookup"><span data-stu-id="19cc9-105">These files are used in deploying Skype Room Systems v2:</span></span> 
* <span data-ttu-id="19cc9-106">[CreateSrsMedia.ps1](#createsrsmediaps1) — это сценарий Powershell, используемые для создания образа программного обеспечения для устройства консоли.</span><span class="sxs-lookup"><span data-stu-id="19cc9-106">[CreateSrsMedia.ps1](#createsrsmediaps1) is a Powershell script used to create a software image for the console device.</span></span>  
* <span data-ttu-id="19cc9-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) — это Powershell, будет использовать сценарий, используемый для настройки Скайп для учетных записей Exchange и бизнес-устройства.</span><span class="sxs-lookup"><span data-stu-id="19cc9-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) is a Powershell script used to set up Skype for Business and Exchange accounts the devices will use.</span></span>  
* <span data-ttu-id="19cc9-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) используется при настройке управление системами комнаты Скайп версии 2 с помощью OMS.</span><span class="sxs-lookup"><span data-stu-id="19cc9-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview)  is used when setting up management of Skype Room Systems v2 using OMS.</span></span>
  
<a name="CreateSrs"></a>
## <a name="createsrsmediaps1"></a><span data-ttu-id="19cc9-109">CreateSrsMedia.ps1</span><span class="sxs-lookup"><span data-stu-id="19cc9-109">CreateSrsMedia.ps1</span></span>
...
<a name="CreateRoom"></a>
## <a name="skyperoomprovisioningscriptps1"></a><span data-ttu-id="19cc9-110">SkypeRoomProvisioningScript.ps1</span><span class="sxs-lookup"><span data-stu-id="19cc9-110">SkypeRoomProvisioningScript.ps1</span></span>
...
```
<a name="OMSVIEW"></a>
## <a name="skyperoomsystemsv2omsview"></a><span data-ttu-id="19cc9-111">SkypeRoomSystems_v2.omsview</span><span class="sxs-lookup"><span data-stu-id="19cc9-111">SkypeRoomSystems_v2.omsview</span></span>
...
## <a name="see-also"></a><span data-ttu-id="19cc9-112">См. также</span><span class="sxs-lookup"><span data-stu-id="19cc9-112">See also</span></span>

#### 

[<span data-ttu-id="19cc9-113">Планирование для помещения Скайп систем версии 2</span><span class="sxs-lookup"><span data-stu-id="19cc9-113">Plan for Skype Room Systems v2</span></span>](../../plan-your-deployment/clients-and-devices/skype-room-systems-v2-0.md)
  
[<span data-ttu-id="19cc9-114">Настройка консоли систем комнаты Скайп версии 2</span><span class="sxs-lookup"><span data-stu-id="19cc9-114">Configure a Skype Room Systems v2 console</span></span>](console.md)
  
[<span data-ttu-id="19cc9-115">Управление Скайп комнаты систем версии 2</span><span class="sxs-lookup"><span data-stu-id="19cc9-115">Manage Skype Room Systems v2</span></span>](../../manage/skype-room-systems-v2/skype-room-systems-v2.md)
