...
1. Просмотрите [Windows Phone 8 центра](https://www.windowsphone.com/en-us/how-to/wp8/update-central) обновления, чтобы обновить телефон до Windows Phone 8.1.
...
2. Нажмите и удерживайте Skype для бизнеса на Windows Phone приложение, а затем выберите **Удалить**.
