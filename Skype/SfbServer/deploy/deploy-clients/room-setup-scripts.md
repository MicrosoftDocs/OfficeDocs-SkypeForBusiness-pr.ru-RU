...
---
# <a name="skype-room-system-room-setup-scripts"></a><span data-ttu-id="47cc6-103">Сценарии для настройки системы комнат Skype</span><span class="sxs-lookup"><span data-stu-id="47cc6-103">Skype Room System room setup scripts</span></span>
 
<span data-ttu-id="47cc6-104">В этом разделе описывается поиск примеров сценариев предоставления учетных записей Системы комнат Skype.</span><span class="sxs-lookup"><span data-stu-id="47cc6-104">Read this topic to find sample scripts for provisioning Skype Room System accounts.</span></span>
  
<span data-ttu-id="47cc6-105">В данном разделе приводятся примеры сценариев, которые можно использовать для подготовки Скайп комнаты системных учетных записей.</span><span class="sxs-lookup"><span data-stu-id="47cc6-105">This section illustrates sample scripts that can be used to provision Skype Room System accounts.</span></span> <span data-ttu-id="47cc6-106">These scripts are for illustrative purposes only and should be used only after consulting with your IT expert or domain administrator.</span><span class="sxs-lookup"><span data-stu-id="47cc6-106">These scripts are for illustrative purposes only and should be used only after consulting with your IT expert or domain administrator.</span></span>
  
## <a name="example-setup-script-skype-for-business-and-exchange-server-on-premises"></a><span data-ttu-id="47cc6-107">Пример сценария настройки: Скайп для бизнеса и Exchange Server (локально)</span><span class="sxs-lookup"><span data-stu-id="47cc6-107">Example Setup Script: Skype for Business and Exchange Server (On Premises)</span></span>
...
## <a name="example-setup-script-skype-for-business-and-exchange-server-online"></a><span data-ttu-id="47cc6-108">Пример сценария настройки: Скайп для бизнеса и Интернет-версия Exchange Server</span><span class="sxs-lookup"><span data-stu-id="47cc6-108">Example Setup Script: Skype for Business and Exchange Server Online</span></span>

<span data-ttu-id="47cc6-109">Перед запуском сценария обязательно ознакомьтесь со следующими предварительными требованиями.</span><span class="sxs-lookup"><span data-stu-id="47cc6-109">Make sure you've reviewed the following prerequisites before running the script:</span></span>
  
- <span data-ttu-id="47cc6-110">Помощник по входу в Microsoft Online Services для ИТ-специалистов, версия BETA</span><span class="sxs-lookup"><span data-stu-id="47cc6-110">Microsoft Online Services Sign-In Assistant for IT Professionals BETA</span></span>
    
- <span data-ttu-id="47cc6-111">Модуль Windows Azure Active Directory для Windows PowerShell (64-разрядная версия) или (32-разрядная версия)</span><span class="sxs-lookup"><span data-stu-id="47cc6-111">Windows Azure Active Directory Module for Windows PowerShell (64-bit version) or (32-bit version)</span></span>
    
- <span data-ttu-id="47cc6-112">Использование модуля Windows PowerShell для Lync Online</span><span class="sxs-lookup"><span data-stu-id="47cc6-112">Windows PowerShell Module for Lync Online</span></span>
    
- <span data-ttu-id="47cc6-113">Перезагрузка при необходимости</span><span class="sxs-lookup"><span data-stu-id="47cc6-113">Reboot if needed</span></span>
