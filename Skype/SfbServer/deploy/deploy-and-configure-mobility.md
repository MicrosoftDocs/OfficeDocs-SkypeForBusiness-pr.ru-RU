...
Рассмотрев статью Plan [for Mobility for Skype для бизнеса Server,](../plan-your-deployment/mobility.md) вы должны быть готовы приступить к шагам ниже, чтобы развернуть Mobility в Skype для бизнеса Server среду. Действия следующие (и мы включаем в эту таблицу список разрешений):
...
2. Нажмите кнопку Начните, выберите  административные средства **(вам** может потребоваться его поиск, если это не вариант с меню ), а затем нажмите **DNS,** чтобы открыть администратора DNS-привязку.
    
3. В левом окне консоли необходимо перейти к домену, в который Skype для бизнеса Server серверы переднего Skype для бизнеса Server, и расширить  зоны передовой смотровой зоны.
...
Если у вас есть вопросы по планированию вокруг сертификатов, мы задокументировали это в нашей статье [Plan for Mobility for Skype для бизнеса Server.](../plan-your-deployment/mobility.md) После того, как вы рассмотрите этот вопрос, мы пройдите по следующим ниже.
...
2. Запустите **Skype для бизнеса Server управления** (вы можете ввести имя в поиске или перейти во **все** программы и выбрать его).
