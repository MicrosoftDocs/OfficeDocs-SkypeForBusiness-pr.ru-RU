...
> [!NOTE]
>  Перед обновлением установите все новые необходимые компоненты, необходимые для использования Skype для бизнеса Server 2015, который содержит: > не менее 32 ГБ свободного места перед обновлением. Кроме того, убедитесь, что диск является фиксированным локальным диском, а не подключен USB или FireWire, отформатирован с помощью файловой системы NTFS, не сжимается и не содержит файла подкачки. > PowerShell версии 6.2.9200.0 или более поздней. > новейшее приложение Lync Server 2013 Накопительное обновление установлено. > SQL Server 2012 с пакетом обновления 1 (SP1). >, что в этой статье установлено приложение (установленное автоматически при использовании Microsoft Update): > Windows Server 2008 R2-[KB2533623](https://support.microsoft.com/kb/2533623)> windows Server 2012-[KB2858668](https://support.microsoft.com/kb/2858668)> Windows Сервер 2012 R2-[KB2982006](https://support.microsoft.com/kb/2982006)
