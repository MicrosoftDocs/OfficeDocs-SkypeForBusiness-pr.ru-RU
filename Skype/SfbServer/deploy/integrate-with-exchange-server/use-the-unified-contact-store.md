...
> [!NOTE]
> Технически контактные данные хранятся в паре папок, найденных в почтовом ящике Exchange пользователя. Сами контакты хранятся в папке "Контакты Skype для бизнеса", которая видна конечным пользователям; метаданные о контактах хранятся во в подкамере, которая не видна конечным пользователям. 
