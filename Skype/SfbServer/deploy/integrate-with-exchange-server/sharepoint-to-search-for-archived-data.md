...
**Сводка:** Настройка SharePoint Server для поиска данных архивации с Exchange Server 2016 или Exchange Server 2013 и Скайп для Business Server 2015.
  
Одним из главных преимуществ для хранения обмен мгновенными сообщениями и конференц-связи Web расшифровки в Exchange Server 2016 или Exchange Server 2013 вместо Скайп для Business Server 2015 является, хранение данных в одном месте позволяет администраторам использовать единый инструмент для Поиск архивных данных Exchange и/или Скайп архивных данных Business Server. Так как все, что данные хранятся в одном поместить (Exchange) любое средство, которое можно найти архивированных данных Exchange можно выполнять поиск архивных Скайп для данных Business Server.
...
2. В окне командной строки используйте команду компакт-диска для изменения текущего каталога в папку, где был сохранен файл файл EWSManagedAPI.msi. Например если вы сохранили файл C:\Downloads введите следующую команду в командной строке и нажмите клавишу ВВОД:
