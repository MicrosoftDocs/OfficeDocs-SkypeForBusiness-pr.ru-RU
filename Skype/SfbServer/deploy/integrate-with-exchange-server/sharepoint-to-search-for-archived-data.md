...
Затем запустите команду, аналогичную следующей, которая предоставляет указанному пользователю (в этом примере kenmyer) право на обнаружение в Exchange:
...
После готовности нового сайта необходимо настроить Exchange Server в качестве источника результатов для SharePoint. Это можно сделать, выполив следующую процедуру на странице центра администрирования SharePoint:
