...
1. Откройте топологию Builder на переднем сервере. Слева от топологического конструктора щелкните правой кнопкой мыши пулы серверов Video **Interop Server и** выберите **пул серверов New Video Interop Server**. 
    
2. Это откроет мастер **создания нового мастера пула межопераментных серверов** . Предопослужите FQDN пула для нового сервера video Interop Server и выберите, имеется ли у этого пула один сервер, или этот пул имеет несколько серверов в зависимости от вашего требования, затем нажмите **кнопку Далее**. 
   ...
   - На следующей странице в статье **Определение** компьютеров в этом элементе пула введите компьютер **FQDN** каждого сервера в пуле в текстовое поле и нажмите **кнопку Добавить**. Повторите этот шаг, чтобы добавить в пул еще один сервер видеосвязи. Если вы определили все компьютеры в пуле, нажмите **кнопку Далее**.
...
3. Выберите следующий пул хмеля/FE из отпадаемого списка и нажмите **кнопку Далее**.
...
6. Добавление шлюза видео. Чтобы сделать это, разойдитесь по общим компонентам, нажмите правой кнопкой мыши **на видео шлюзы** и выберите **Новый шлюз видео**.
