...
20. Выберите и запустите первую половину запроса (см. шаг 18) до строки: -- \* \* \* \* \* \* End: Script to be run at Primary: \* \* \* \* \* \* .
    ...
    > [!IMPORTANT]
    > Ручной запуск этого сценария необходим, поскольку SQL Server Management Studio не поддерживает несколько основных баз данных в конфигурации SQL Server доставки журналов. 
