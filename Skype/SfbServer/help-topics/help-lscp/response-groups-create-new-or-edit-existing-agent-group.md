...
- **Агенты** Выберите пользователей, которые должны быть агентами для группы ответов, одним из следующих способов:
  ...
  - Выберите **Использование существующего списка рассылки электронной** почты для использования Exchange рассылки. Введите адрес электронной почты списка рассылки в поле **Адрес списка рассылки**.
