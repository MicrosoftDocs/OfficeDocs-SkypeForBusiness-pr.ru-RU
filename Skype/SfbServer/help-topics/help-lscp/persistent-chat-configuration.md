...
> [!NOTE]
> Несмотря на то, что многие возможности управления комнат чатов доступны на компьютерах, использующих сохраняемый чат для пользователя, пользователи постоянного чата (в роли **ксперсистентчатадминистратор** ) должны использовать либо панель управления, либо управляющую оболочку. Командлеты для создания категорий и управления ими.
