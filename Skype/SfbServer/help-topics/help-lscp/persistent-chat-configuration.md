...
Менеджеры комнат сохраняемого чата, которые могут управлять одной или более комнатами чата, могут использовать клиент для запуска веб-приложения управления комнатами для создания комнат и управления ими (или клиенты могут создавать настраиваемые решения и рабочие процессы для вызова). Сохраняемый чат
  
Администраторы сохраняемой беседы также могут использовать панель управления или Windows PowerShell для создания комнат и управления ими.
...
6. В окне **Создание конфигурации сохраняемого чата** выполните следующие действия.
   ...
   - (Необязательно) В поле **URL-адрес управления комнатой** выберите URL-адрес управления комнатой. Это адрес для веб-развертывания управления комнатами. Если вам не нужно настраивать управление комнатами и вы просто используете параметр по умолчанию, оставьте этот параметр пустым.
