...
- **Действие** Вы можете указать действие, выполняемые при выполнении критериев, которые были выполнены на предыдущих шагах. Доступны следующие действия:
  ...
  - **Разрешение и обновление** Позволяет клиенту входить в систему и получать обновления из службы Обновления Windows Server или Microsoft Update. Это действие доступно, только если выбрано приложение **OC** агента пользователя.
