...
Чтобы создать надстройки для постоянных чатов, см. в рубке [Configure add-ins for Persistent Chat rooms in Skype для бизнеса Server 2015 г](../../manage/persistent-chat/configure-add-ins.md). Если вы постоянный администратор чата, вы можете создавать надстройки с помощью панели управления или Windows PowerShell.
