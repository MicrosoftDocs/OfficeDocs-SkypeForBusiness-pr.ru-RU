...
С помощью этого клиента можно запускать веб-приложение для управления комнатой для создания и управления помещениями (а также для создания настраиваемых решений и рабочих процессов), которые могут управлять ими. 
