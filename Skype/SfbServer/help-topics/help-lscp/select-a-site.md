...
ms.locfileid: "60748175"
---
# <a name="select-a-site"></a>Выбор сайта

Чтобы найти **сайты,** доступные в среде, используйте диалоговое окно Select a Site. Чтобы использовать существующий сайт, щелкните сайт в списке, а затем нажмите кнопку **ОК**.
