...
ms.locfileid: "60838691"
---
# <a name="voice-route"></a>Маршрут голосовых данных

Что нужно сделать Щелкните ссылку на задачу, которую необходимо выполнить.

- [Создание или изменение голосового маршрута в Skype для бизнеса 2015 г.](../../deploy/deploy-enterprise-voice/create-or-modify-a-voice-route.md)
