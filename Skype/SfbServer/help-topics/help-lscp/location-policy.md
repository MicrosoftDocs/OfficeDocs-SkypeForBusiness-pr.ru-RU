...
- **Область действия** Определяет область действия политики расположения: глобальная, на сайте или на уровне пользователя.

- **E9-1-1** Проверяется, включены ли для пользователей, которые назначены этой политике расположения, E9-1-1.

- **Расположение** Указывает, будет ли пользователям предложено ввести сведения о расположении при регистрации их клиента в Skype для бизнеса Server в новом расположении, а также будет ли отклоняться запрос без ввода сведений о расположении.
