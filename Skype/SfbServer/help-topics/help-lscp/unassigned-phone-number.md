...
- **Вверх** Перемещает выбранный диапазон ненаписаных номеров вверх по списку, чтобы Skype для бизнеса Server быстрее находит его и применяет указанное действие, прежде чем применять действия, указанные для других диапазонов в списке.
