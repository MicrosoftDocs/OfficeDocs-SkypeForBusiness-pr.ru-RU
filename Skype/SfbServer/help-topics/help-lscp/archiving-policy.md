...
> [!NOTE]
> Политики архива применяются только к пользователям Skype для бизнеса Server. Если для хранения архивных данных в Microsoft Exchange используется интеграция Exchange, политики Exchange 2013 контролируют архивацию для пользователей, которые хранятся в Exchange 2013. Чтобы включить архив для этих пользователей, почтовый ящик пользователя должен быть помещен на In-Place удержания. 
