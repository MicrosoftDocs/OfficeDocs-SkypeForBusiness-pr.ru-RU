...
10. Чтобы контролировать загрузку файлов в комнатах чата этой категории, установите или снимите флажок **Разрешить загрузку файлов**. Если этот флажок установлен, комнаты этой категории могут включать или отключать загрузку файлов. Если он снят, загрузка файлов для этой категории отключена.
     ...
     > [!IMPORTANT]
     > Этот параметр применяется на сервере, так как пользовательские приложения или предыдущей Group Chat клиентов, использующих Office Communications Server 2007 R2 сервер Group Chat Server или Lync Server 2010, Group Chat отправки файлов в комнате. Клиент Lync 2013 не поддерживает возможность отправки и загрузки файлов, поэтому при наличии чисто развертывания Lync 2013 или клиент Lync 2013 не возможно для размещения файлов в комнату чата Persistent Chat Server. 
