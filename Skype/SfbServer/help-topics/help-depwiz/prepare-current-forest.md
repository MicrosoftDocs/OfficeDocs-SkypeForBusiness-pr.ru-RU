...
Чтобы подготовить лес служб домена Active Directory, необходимо успешно расширить схему, как описано в разделе Подготовка схемы [, и](/previous-versions/office/lync-server-2013/lync-server-2013-preparing-the-active-directory-schema) убедиться, что схема реплицирована.
...
2. На странице **Подготовка леса** нажмите кнопку **Далее**.
    ...
    > [!NOTE]
    > Подготовка к лесу позволяет выбрать, где разместить универсальные группы для Skype для бизнеса Server 2015. Выбирайте место в соответствии с требованиями вашей организации.
...
4. В столбце **Действие** в журнале разйдитесь по лесной подготовке **,****\<Success\>** ищи результат выполнения в конце каждой задачи, чтобы убедиться, что подготовка леса успешно завершена, закрой журнал и нажмите кнопку **Готово**.
