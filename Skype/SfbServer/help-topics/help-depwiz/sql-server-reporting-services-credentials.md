...
> [!NOTE]
> Подробные сведения см. в под теме "Указание учетных данных и сведений о подключениях для источников данных отчетов (SSRS)" по ссылке [https://go.microsoft.com/fwlink/p/?LinkId=263431](https://go.microsoft.com/fwlink/p/?LinkId=263431) . 
  
Дополнительные сведения о развертывании отчетов Службы Reporting Services для сервера мониторинга см. в сведениях об установке отчетов мониторинга [в Skype для бизнеса Server 2015.](../../deploy/deploy-monitoring/install-monitoring-reports.md)
