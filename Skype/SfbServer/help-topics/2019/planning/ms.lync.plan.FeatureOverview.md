...
- **Интеграция архивации Exchange**
    ...
    Если у вас есть пользователи, которые находятся в Exchange, а их почтовые ящики были поставлены на удержание In-Place, можно выбрать вариант интеграции хранилища Skype для бизнеса Server с хранилищем Exchange.
