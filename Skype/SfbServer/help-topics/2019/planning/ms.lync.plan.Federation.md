...
Edge Servers можно настроить, чтобы позволить внутренним и внешним пользователям получать доступ к контактам в партнерских организациях или службах.
 ...
 Federation работает в Skype для бизнеса Server, как и для Microsoft Lync 2013. Дополнительные сведения о подготовке среды для Федерации см. в следующих темах:
