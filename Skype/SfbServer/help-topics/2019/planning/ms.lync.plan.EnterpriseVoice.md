...
Дополнительные сведения о планировании для корпоративной голосовой связи в разделе [Планирование корпоративной голосовой связи в Скайп для Business Server](../../../plan-your-deployment/enterprise-voice-solution/enterprise-voice.md). Для получения дополнительных сведений о развертывании автономный сервер-посредник видеть [Развертывание сервера-посредника в построителе топологий в Скайп для Business Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md).
