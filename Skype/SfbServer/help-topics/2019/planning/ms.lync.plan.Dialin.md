...
ms.locfileid: "32221062"
---
# <a name="dial-in-conferencing-planning-tool"></a>Dial-in Conferencing (Planning Tool)
 
Скайп для Business Server телефонных конференций позволяет пользователям присоединяться к звуковой части Скайп для Business Server конференции с использованием телефонной сети (общего пользования PSTN) телефона без поставщика аудиоконференций сторонних производителей.
