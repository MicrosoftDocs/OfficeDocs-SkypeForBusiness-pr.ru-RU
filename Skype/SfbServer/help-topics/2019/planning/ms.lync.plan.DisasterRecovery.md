...
description: Skype для бизнеса Server включает меры аварийного восстановления путем сопряжения пулов переднего сервера, расположенных в двух центрах обработки данных.
