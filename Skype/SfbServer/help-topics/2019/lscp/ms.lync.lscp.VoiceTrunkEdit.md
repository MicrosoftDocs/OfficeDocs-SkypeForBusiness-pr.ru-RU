...
- [Создание или изменение правила трансляции для вызываемого удостоверения презентация в Skype для бизнеса Server](../../../deploy/deploy-enterprise-voice/called-id-presentation-rules.md)
