...
- [Добавление нового пользователя](/previous-versions/office/lync-server-2013/lync-server-2013-add-and-enable-user-account-for-lync-server)
...
- [Назначение политики ПИН-кода для каждого пользователя в Skype для бизнеса Server](../../../manage/authentication/assign-a-per-user-pin-policy.md)
