...
- **Безопасность SIP** Можно настроить требования к транспортировке и проверке подлинности для устройств Skype для бизнеса Телефон Edition. Вы можете выбрать из следующих параметров:
