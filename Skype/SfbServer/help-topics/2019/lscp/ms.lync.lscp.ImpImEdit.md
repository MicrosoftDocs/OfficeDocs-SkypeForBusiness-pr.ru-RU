...
---
# <a name="url-filter-create-new-or-edit-existing"></a>Фильтр URL-адресов: Создание новой или редактирование существующей
 
Что требуется сделать? Щелкните ссылку на задачу, которую нужно выполнить.
  
- [Изменение фильтра URL-адрес по умолчанию](http://technet.microsoft.com/library/80a472b3-054e-45a6-80fc-9ee2bda28ee6.aspx)
