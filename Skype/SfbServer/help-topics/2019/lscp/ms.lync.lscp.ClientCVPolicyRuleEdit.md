...
- **Агент пользователя** В списке можно выбрать тип клиента. В следующей таблице определяются коды агентов пользователя. Этот список включает устаревшие типы клиентов, некоторые из которых больше не поддерживаются.
