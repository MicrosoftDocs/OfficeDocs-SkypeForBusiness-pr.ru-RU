...
ms.locfileid: "33891497"
---
# <a name="hybrid-wizard-move-user"></a>Мастер гибридной среды: перемещение пользователя

Используйте мастер переместить пользователей для перемещения учетных записей пользователей, размещенных на пул локальной размещен в Скайп для бизнеса в Интернет. Дополнительные сведения см. в разделе [Use the Hybrid Manageability wizard](https://technet.microsoft.com/library/d777f79b-a740-4aba-a9e2-c91f0315b6f8.aspx).
