...
ms.locfileid: "30885507"
---
# <a name="select-a-region-link"></a>Выбор связи между областями
 
Используйте диалоговое окно **Связь между областями** для поиска связей между областями, которые доступны в вашей среде. Чтобы использовать существующую связь между областями, выберите связь в списке, затем нажмите кнопку **ОК**.
