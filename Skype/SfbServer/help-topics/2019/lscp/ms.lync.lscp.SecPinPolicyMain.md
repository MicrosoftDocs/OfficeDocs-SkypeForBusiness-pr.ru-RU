...
- [Удаление политики ПИН-кода в Skype для бизнеса Server](../../../manage/authentication/delete-a-pin-policy.md)

  **Работа с политикой PIN-кода для телефонных конференций** Эта политика ПИН-кода позволяет пользователям, у которых в организации есть учетные данные служб домена Active Directory, присоединяться к конференциям с проверкой подлинности в качестве пользователей с проверкой подлинности путем ввода ПИН-кода.
