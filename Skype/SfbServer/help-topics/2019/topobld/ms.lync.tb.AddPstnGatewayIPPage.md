...
Если выбран параметр **использовать все настроенные IP-адреса**, будет использоваться всеми адресами, настроенными на шлюз. При необходимости выберите **ограничьте использование службы для выбранных IP-адресов**, которое позволяет запись **IP-адрес ТСОП** . Введите адрес IPv4 или IPv6, назначенную для этот шлюз.

## <a name="see-also"></a>См. также

[Связи с телефонным требования к конференц-связи](https://technet.microsoft.com/library/9aff949e-3dac-481a-be46-a180c72e8066.aspx)
