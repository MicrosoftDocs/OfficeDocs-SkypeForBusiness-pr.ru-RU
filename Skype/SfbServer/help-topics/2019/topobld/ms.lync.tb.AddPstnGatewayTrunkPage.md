...
Определение корневую магистраль для IP-адрес или телефонной сети общего пользования (PSTN), настроив следующее:
  
- **Имя линии связи**: определить полное доменное имя, связанное с магистралью
    
- **Порт прослушивания для шлюза IP/ТСОП**: выберите порт, который прослушивает эта магистраль
    
- **Транспортный протокол SIP**: выберите в списке **TCP** или **TLS**, на основе требований к магистрали
    
- **Связанный сервер-посредник**: выберите из списка доступных серверов-посредников в развертывании
    
- **Порт связанного сервера-посредника**: выберите порт, который прослушивает выбранный сервер-посредник
