...
Сведения о развертывании EDGE можно найти [в разделе Развертывание пограничного сервера в Skype для бизнеса Server](../../../deploy/deploy-edge-server/deploy-edge-server.md)
