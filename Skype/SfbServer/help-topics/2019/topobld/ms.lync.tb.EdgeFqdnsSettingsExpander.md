...
Чтобы изменить  или указать внешние параметры для edge Servers, сначала необходимо определить, будут ли вы использовать отдельные IP-адреса для доступа к протоколу инициации сеансов, службе веб-конференции Edge и службе аудио- и видеоконференции.
