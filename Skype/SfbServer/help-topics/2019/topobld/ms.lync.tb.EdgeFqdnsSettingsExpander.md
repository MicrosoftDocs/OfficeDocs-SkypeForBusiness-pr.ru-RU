...
Для получения дополнительных сведений об определении и настройке параметров для службы пограничного сервера просмотрите [Определение пограничных серверов](http://technet.microsoft.com/library/787b23f1-8fa0-4c37-abf2-c516c5dd66f0.aspx).
