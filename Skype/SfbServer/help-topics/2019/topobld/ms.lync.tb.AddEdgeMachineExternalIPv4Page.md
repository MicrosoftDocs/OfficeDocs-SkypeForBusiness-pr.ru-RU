...
ms.locfileid: "30875399"
---
# <a name="add-edge-machine-external-ipv4"></a><span data-ttu-id="3a13f-103">Добавление внешнего IPv4-адреса пограничного компьютера</span><span class="sxs-lookup"><span data-stu-id="3a13f-103">Add Edge Machine External IPv4</span></span>
 
<span data-ttu-id="3a13f-104">В **Внешнего адреса IPv4**введите внешний IP-адрес, указывающий на служба пограничного сервера доступа, служба пограничного сервера конференц-связи Web и A / V Edge службы.</span><span class="sxs-lookup"><span data-stu-id="3a13f-104">In **External IPv4**, enter the external IP address that points to the Access Edge service, Web Conferencing Edge service, and A/V Edge service.</span></span>
