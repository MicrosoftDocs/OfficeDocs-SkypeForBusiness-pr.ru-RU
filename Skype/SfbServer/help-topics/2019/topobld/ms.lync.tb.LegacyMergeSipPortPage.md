...
Если в устаревшем развертывании настроен автоматический вход клиента, выберите автоматическое обнаружение **конфигурации порта SIP** для каждого пула и нажмите кнопку "Далее", чтобы продолжить. 
