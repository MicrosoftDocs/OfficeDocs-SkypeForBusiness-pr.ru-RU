...
ms.locfileid: "30893457"
---
# <a name="add-edge-server-external-ipv6"></a><span data-ttu-id="169e1-103">Добавление внешнего адреса IPv6 пограничного сервера</span><span class="sxs-lookup"><span data-stu-id="169e1-103">Add Edge Server External IPv6</span></span>
 
<span data-ttu-id="169e1-104">В поле **внешний адрес IPv6**введите внешний IP-адрес, указывающий на служба пограничного сервера доступа, служба пограничного сервера конференц-связи Web и A / V Edge службы.</span><span class="sxs-lookup"><span data-stu-id="169e1-104">In **External IPv6 address**, enter the external IP address that points to the Access Edge service, Web Conferencing Edge service, and A/V Edge service.</span></span>
