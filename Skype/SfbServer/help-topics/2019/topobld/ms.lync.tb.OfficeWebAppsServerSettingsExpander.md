...
Вы редактируете свойства настроенного сервера Office Web Apps. Для редактирования доступны следующие свойства.
 ...
 Полное доменное имя сервера **Office Web Apps:** это свойство определяет полное доменное имя сервера Office Web Apps и должно соответствовать записи сервера доменных имен (DNS) A или AAAA (если используется IPv6).
