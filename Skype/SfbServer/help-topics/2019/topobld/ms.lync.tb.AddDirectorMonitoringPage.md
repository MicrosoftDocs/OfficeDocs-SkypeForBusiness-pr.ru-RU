...
- Если вы выбрали **"Включить зеркальное SQL Server** хранения", при желании выберите "Использовать свидетель зеркального SQL Server", чтобы включить автоматическую отключку, чтобы выбрать в списке SQL Server зеркального зеркального хранения. 
