...
Установите для этого пула **(порт 5061)** федеративную федерацию, если вы настроили федерацию с сервером Skype для бизнеса Server 2015.
...
Чтобы настроить или изменить пул **следующего** прыжка, который будет применяться для связи между серверами и внутренней инфраструктурой, выберите в списке директор, пул директоров, сервер переднего сервера или пул серверов переднего сервера. Для выбора будут отображаться только директоры или руководители, настроенные в построитель топологий.
