...
ms.locfileid: "41798006"
---
# <a name="add-site-name"></a>Добавление имени сайта
 
Чтобы определить первый сайт в развертывании, укажите имя первого сайта. При необходимости вы можете указать описание первого сайта.
