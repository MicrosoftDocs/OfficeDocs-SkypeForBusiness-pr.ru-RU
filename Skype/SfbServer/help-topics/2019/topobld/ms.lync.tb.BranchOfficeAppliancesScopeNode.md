...
- **Создать устройство для обеспечения связи в филиалах**. Запускает мастер **определения нового устройства для** устройств для связи в филиалах, который используется для добавления нового устройства для связи в филиалах на этот сайт.
    
В дополнение к параметру устройства для устройства для survivable Branch Appliance можно выполнять следующие общие задачи:
