...
Дополнительные сведения о параметрах пула посреднических серверов или сервера-посредника см. в материале Deploy [a Mediation Server in Topology Builder Skype для бизнеса Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) документации развертывания.
