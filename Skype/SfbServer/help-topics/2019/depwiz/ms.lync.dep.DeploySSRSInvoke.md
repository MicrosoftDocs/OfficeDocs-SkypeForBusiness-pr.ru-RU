...
После представления необходимых сведений о развертывании отчетов сервера мониторинга в службы отчетов Microsoft SQL Server на странице "Выполнение команд" отображается сводка команд, которые выданы для установки отчетов в службы SQL Server Reporting Services.
