...
- **CsViewOnlyAdministrator:** Участники могут просматривать развертывание и конфигурацию сведений о сервере. Это членство позволяет участнику отслеживать состояние серверов Skype для бизнеса Server.
