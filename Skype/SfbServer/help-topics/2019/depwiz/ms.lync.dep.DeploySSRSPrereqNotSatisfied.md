...
Подробности можно найти [в разделе Установка отчетов мониторинга в Skype для бизнеса Server](../../../deploy/deploy-monitoring/install-monitoring-reports.md) и [развертывание мониторинга](https://technet.microsoft.com/library/117f4a3e-0670-4388-a553-b9854921145f.aspx).
