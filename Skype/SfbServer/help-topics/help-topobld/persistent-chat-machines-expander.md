...
Чтобы настроить развернутый сервер сохраняемой беседы или пул серверов сохраняемой беседы в неактивное время, выберите сервер или пул в списке и нажмите кнопку **«Сделать неактивным».** По крайней мере один сервер должен быть активен.
