...
Настраиваются хранилища SQL Server соответствия требованиям, которые будут предоставлять базы данных для функции соответствия для сервера сохраняемой беседы или сервера сохраняемой беседы.
...
Выберите в списке зеркальное **SQL Server** сохранить SQL Server и необязательный экземпляр для выполнения SQL Server для соответствия требованиям Persistent Chat SQL Server.
...
Нажмите **кнопку** "Новое", чтобы определить новый SQL Server,при желании экземпляр для свидетеля соответствия SQL Server сохраняемой беседы.
