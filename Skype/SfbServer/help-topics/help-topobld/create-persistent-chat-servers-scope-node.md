...
Щелкните правой кнопкой мыши пул **сохраняемой беседы** в построитель топологий, чтобы выполнить следующие работы:
  
- **Новый пул сохраняемой беседы:** запускает мастер определения нового пула сохраняемой беседы, используемый для определения нового сервера или пула сохраняемой беседы. 
