...
Чтобы изменить  или указать внешние параметры для внешних серверов, сначала необходимо определить, будут ли вы использовать отдельные IP-адреса для доступа по протоколу SIP, службы веб-аудио- и видеоконференции и службы аудио- и видеоконференции.
