...
Чтобы изменить или указать **внешние параметры** для пограничных серверов, необходимо сначала определить, будут ли использоваться отдельные IP-адреса для доступа по протоколу SIP, пограничной службы веб-конференций и пограничной службы аудио-и видеосвязи.
...
Дополнительные сведения об определении и настройке параметров пограничных служб см. в разделе [Определение пограничной топологии](https://technet.microsoft.com/library/787b23f1-8fa0-4c37-abf2-c516c5dd66f0.aspx).
