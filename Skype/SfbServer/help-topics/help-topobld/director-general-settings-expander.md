...
Общая папка файлов, которая будет использоваться пулом директоров. Выберите существующую общую папку, которая уже определена в построителе топологий, или нажмите кнопку **создать** , чтобы создать новое определение общего файлового ресурса.
