...
Если вы решили не устанавливать зеркальные базы данных SQL Server во время  публикации, установите их с помощью установки базы данных правой кнопкой мыши на любом узле в построителье топологий. Выберите зеркальное хранилище для установки. Щелкните пункт **Параметры** для определения расширенных параметров.
