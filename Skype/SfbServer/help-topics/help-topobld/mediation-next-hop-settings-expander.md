...
Дополнительные сведения о параметрах пула посреднических серверов или сервера-посредника см. в документации по развертыванию в [2015 г. Развертывание сервера-посредника в topology Builder Skype для бизнеса Server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) г.
