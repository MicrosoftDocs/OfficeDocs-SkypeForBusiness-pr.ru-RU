...
Подробнее о перемещении центрального хранилища управления можно узнать в статье [Move – CsManagementServer](https://docs.microsoft.com/powershell/module/skype/move-csmanagementserver?view=skype-ps) в справочнике по командлетам Windows PowerShell.
