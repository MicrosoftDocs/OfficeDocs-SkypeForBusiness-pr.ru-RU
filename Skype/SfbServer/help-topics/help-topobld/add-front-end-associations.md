...
- Пограничный сервер аудио- и видеоданных. Для получения дополнительных сведений о реализации A / V Edge Server см [конференц-связи](https://technet.microsoft.com/library/983a272a-e1b3-4d70-8f84-836b092fe526.aspx) в документации по планированию.
