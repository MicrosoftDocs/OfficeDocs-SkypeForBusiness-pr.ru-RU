...
В **SQL узла** содержится список SQL Server баз данных в топологии. Можно выполнить следующее действие.
  
- **Создать хранилище SQL**. Запускает мастер **определения SQL Store,** который используется для добавления новой SQL Server базы данных в топологию.
    
Помимо параметров SQL Server баз данных, можно выполнять следующие общие задачи:
