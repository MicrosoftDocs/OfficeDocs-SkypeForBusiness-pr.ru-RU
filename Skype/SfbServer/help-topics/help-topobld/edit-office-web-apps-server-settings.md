 ...
 **URL-адрес обнаружения сервера Office Web Apps**: URL-адрес для клиентского доступа к серверу Office Web Apps, возможно, потребуется изменить этот адрес по умолчанию, если сервер размещен в другой зоне сети, отличной от внутренней сети для развертывания.
