...
Дополнительные сведения о том, что такое хранение в центре управления, можно найти в разделе [Перемещение сервера Lync server 2010 Central Management Server на Lync server 2013](https://technet.microsoft.com/library/30cc98f2-1916-4dbe-99d0-8df5368ed3ec.aspx).
