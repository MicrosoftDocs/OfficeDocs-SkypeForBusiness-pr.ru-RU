...
Для получения дополнительных сведений о хранилища централизованного управления будет видеть [Перемещение сервера Lync Server 2010 центра управления на Lync Server 2013](http://technet.microsoft.com/library/30cc98f2-1916-4dbe-99d0-8df5368ed3ec.aspx).
