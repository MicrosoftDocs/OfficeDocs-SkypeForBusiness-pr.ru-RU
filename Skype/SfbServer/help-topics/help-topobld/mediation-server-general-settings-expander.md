...
В разделе **Связи** следует выбрать пограничный сервер или пул пограничных серверов для сопоставления с пулом серверов-посредников или с отдельным сервером-посредником. Вы выбираете границу, которую компоненты мультимедиа сервера-посредника будут использовать для внешних пользователей Корпоративная голосовая связь.
