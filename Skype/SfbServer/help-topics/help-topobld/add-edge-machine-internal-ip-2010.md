...
- Во **внутреннем IPv4-адресе** введите IP-адрес сервера, который нужно добавить в пул.

- Во **внутреннем полном доменном имени** введите полное доменное имя (FQDN) сервера, который нужно добавить в пул.
