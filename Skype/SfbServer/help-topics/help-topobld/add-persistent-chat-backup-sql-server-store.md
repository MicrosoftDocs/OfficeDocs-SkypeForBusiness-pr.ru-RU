...
**Щелкните Новое**, чтобы определить новый SQL Server и необязательный новый экземпляр для данных резервного копирования в чате.
  
Выберите контрольный **SQL Server** для настройки SQL Server базы данных и дополнительного экземпляра, который предоставит зеркальную базу данных для данных резервного копирования сохраняемой беседы.
...
**Щелкните Кнопку** New, чтобы определить новый SQL Server дополнительный экземпляр резервного копирования сохраняемой SQL Server зеркального свидетеля.
