...
Чтобы настроить **базу данных** SQL Server и необязательный экземпляр, который будет предоставлять зеркальную базу данных для данных резервного копирования сохраняемой беседы, выберите SQL Server для хранения данных зеркального хранения.
