...
|Сбой подключения к шлюза сервера-посредника  <br/> |Сервер-посредник  <br/> |25062 || 25002  <br/> |25061  <br/> |Не удалось выполнить команду PING мс (параметр) шлюза  <br/> |
|Ошибка завершения вызова сервера-посредника к шлюзу  <br/> |Сервер-посредник  <br/> |25064 || 25002  <br/> |25063  <br/> |Ошибка при попытке сделать звонок, чтобы шлюза MS  <br/> |
|Критические проблемы в сети  <br/> |Пограничный сервер  <br/> |14353 || 12288  <br/> |14624  <br/> |Не удалось запустить на локальный IP-адрес 192.168.231.14 через порт 5061 транспортный протокол TLS  <br/> |
