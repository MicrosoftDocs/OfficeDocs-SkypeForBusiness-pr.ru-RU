...
2. Выберите параметры-\>счетчики производительности\> Windows для данных и добавьте счетчики производительности для: 
   ...
   - LS: Медиатионсервер-Current (_Total) (\- с исходящими звонками) 

     Общее количество активных звонков на обход мультимедиа:

   - LS: Медиатионсервер — входящие звонки (_Total)\- активные мультимедиа обходятся 

   - LS: Медиатионсервер-исходящие вызовы (_Total\- ) звонки обходятся активными мультимедиа 
...
|:-----|:-----|:-----|:-----|
|РТКМЕДСРВ  <br/> |посредник  <br/> |25003  <br/> |25002  <br/> |
...
|:-----------------------------------------------------------|:--------------------------|:-----------------------------------|:---------------------------------|:-----------------------|
| Ошибка подключения сервера обновлений к шлюзу  <br/>    | посредник  <br/>   | 25062                              |                                  | 25002  <br/>           |
| Сбой завершения вызова сервера обновлений до шлюза  <br/> | посредник  <br/>   | 25064                              |                                  | 25002  <br/>           |
