...
## <a name="media-traffic-ip-addresses-and-port-ranges"></a>Трафика мультимедиа: IP-адреса и порта для диапазона

Трафика мультимедиа потоки с отдельной службой в облаке Майкрософт. В следующей таблице показан диапазон IP-адрес процессора мультимедиа.
