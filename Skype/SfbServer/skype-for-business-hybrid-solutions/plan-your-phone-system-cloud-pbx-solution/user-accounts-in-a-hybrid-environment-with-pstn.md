...
Если у вас есть другой среде (например, Скайп для соединителя Cloud Business Edition), гибридного не настроен или пользователи будут недоступны для вызовов PSTN, таблица поддержки будет отличаться.  
...
- **Подключения к гибридной голосовой связи:** Параметр, чтобы предоставлять доступ к ТСОП для с online Скайп для учетной записи бизнеса. Локальный Скайп для сервера-посредника Business содержит связь ТСОП. 
...
- **Сценарий 1:** Пользователь учетной записи в Скайп для бизнеса на собственных и будет использовать Скайп для клиента Business с корпоративной голосовой связи
...
|При локальном AD  |В Интернете |Skype для бизнеса | Прямая отправка  | Нет, Скайп для клиента Business не поддерживается при прямой маршрутизации  |
...
Пользователь должен быть включен для Скайп для бизнеса и корпоративной голосовой связи используются локальные Скайп для средств управления Business пользователя. Предоставление пользователям для Скайп для бизнеса online только **не поддерживается**. Обратитесь [в этой статье](enable-the-users-for-enterprise-voice-on-premises.md#special-considerations-when-enabling-users-for-enterprise-voice-on-premises) для получения дополнительных сведений о том, как включить пользователей для Скайп для бизнеса в гибридной конфигурации.