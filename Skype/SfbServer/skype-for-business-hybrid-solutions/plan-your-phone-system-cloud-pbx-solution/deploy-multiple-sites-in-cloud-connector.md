...
|Настройка  <br/> |Общая папка  <br/> |Требуется та **же общая** папка для устройств <br/> |Требуется **разная общая** папка для устройств <br/> |
...
|Настройка  <br/> |Гибридный клиент  <br/> |Настройка hybridPSTNSite  <br/> Установите peerDestination для отката  <br/> |Настройка hybridPSTNSite  <br/> Установите peerDestination для отката  <br/> |
|Настройка  <br/> |Шлюз  <br/> |Сопоставление MS GW **M:N** на этом сайте <br/> |Шлюз PSTN на каждом сайте PSTN должен подключаться только к серверу-посреднику (s) на одном сайте.  <br/> |
|Настройка  <br/> |Пользователь  <br/> |Настройка userPSTNSettings  <br/> |Настройка userPSTNSettings  <br/> |
