...
2. Записи SRV будут автоматически созданы в Office 365 и сценариях развертывания. Убедитесь, что на пограничном крае вы можете найти следующие две службы SIP: _sip и _sipfederationtls.
