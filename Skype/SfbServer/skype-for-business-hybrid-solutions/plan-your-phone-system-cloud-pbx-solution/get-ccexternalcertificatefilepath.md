...
|:-----|:-----|:-----|:-----|
|Target  <br/> |Необязательный  <br/> | System.Management.Automation.SwitchParameter <br/> |Тип запрашиваемого пути файла. Типы включают в себя:  <br/> EdgeServer (по умолчанию)  <br/> MediationServer  <br/> |
