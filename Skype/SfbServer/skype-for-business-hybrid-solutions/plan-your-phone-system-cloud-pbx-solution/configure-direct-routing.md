...
Если вы еще не сделали прочитайте [Планирование прямой маршрутизации](plan-direct-routing.md) наличие необходимых компонентов и просмотреть другие действия необходимо выполнить перед настройкой сети Microsoft телефонной системой. 

  > [!NOTE]
  > В этом документе содержится информация для ИТ-специалистов.  
...
[Планирование прямой маршрутизации](plan-direct-routing.md)
