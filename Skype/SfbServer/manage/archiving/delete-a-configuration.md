...
4. В списке конфигураций архивации щелкните конфигурацию сайта или пула, которую необходимо удалить, а затем щелкните **Edit** (Изменить) и **Delete** (Удалить).
    ...
    > [!NOTE]
    > Вы также можете щелкнуть глобальную конфигурацию, но выбрать этот параметр только в том случае, если необходимо сбросить глобальные значения конфигурации до значений по умолчанию. 
