...
4. Нажмите кнопку **Создать**, а затем выполните одно из следующих действий: 
   ...
   - Чтобы создать политику архива на уровне сайта, щелкните "Политика сайта", а затем в области "Выбор сайта" выберите **сайт,** к которому будет применяться политика.
...
### <a name="to-create-a-new-archiving-policy-that-enables-archiving-of-internal-communication-sessions"></a>Создание новой политики архива, которая включает архивы внутренних сеансов связи
