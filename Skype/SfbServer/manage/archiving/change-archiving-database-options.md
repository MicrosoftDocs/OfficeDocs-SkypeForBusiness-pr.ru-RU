...
Чтобы внести какие-либо из этих изменений, необходимо запустить Topology Builder, внести изменения и опубликовать топологию еще раз. Не **указываю** SQL Server хранения SQL Server хранения зеркальных  данных, если у вас нет Skype для бизнеса пользователей, которые не Exchange серверах.
