...
---
# <a name="call-list-report-in-skype-for-business-server-2015"></a>Отчет по списку звонков в Skype для бизнеса Server 2015
 
**Сводка:** Узнайте о Call List Report используется в Скайп для Business Server 2015.
  
Отчет по списку обзвона предоставляет параметры качества взаимодействия (QoE) для отдельных вызовов, выполненных и принятых сотрудниками организации. Обратите внимание, что действительные параметры, содержащиеся в отчете, зависят от способа доступа к отчету по списку обзвона. Например при открытии отчета из [Отчета устройства в Скайп для Business Server 2015](device-report.md), вы увидите метрики следующие показатели, также выводятся в отчете по устройству:
...
Тем не менее, если открыть Call List Report с [Отчетом в Скайп для Business Server 2015](location-report.md), не будут отображаться какие-либо из этих показателей; Вместо этого вы увидите следующие показатели:
...
- [Device Report в Скайп для Business Server 2015](device-report.md) (щелкнув громкости вызова или процента звонков низкого качества показатель)
...
В рамках Call List Report можно вызвать [Подробного отчета по вызову в Скайп для Business Server 2015](call-detail-report.md) , щелкнув метрику сведений.
...
**Метрики отчета по списку звонков**
