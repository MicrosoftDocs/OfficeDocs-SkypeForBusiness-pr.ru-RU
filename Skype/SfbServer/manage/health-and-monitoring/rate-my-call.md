...
## <a name="accessing-rate-my-call-data"></a>Доступ к данным о скорости моего звонка
...
Данные из таблиц могут быть вызваны с помощью запроса **\* select from [Table.Name]** или с помощью Microsoft SQL Server Management Studio.
