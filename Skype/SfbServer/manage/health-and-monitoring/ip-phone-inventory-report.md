...
|**Manufacturer** <br/> |Название компании, создавшей IP-телефон. Значения для данного фильтра заполняются автоматически на основе данных об IP-телефонах, хранящихся в базе данных.  <br/> |
...
|:-----|:-----|:-----|
|**Manufacturer** <br/> |Да  <br/> |Название компании, создавшей IP-телефон.  <br/> |
