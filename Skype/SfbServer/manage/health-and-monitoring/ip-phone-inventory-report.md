---
title: Отчет по IP-телефонам в Skype для бизнеса Server
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
description: Сводка. Сведения об отчете по IP-телефонам в Skype для бизнеса Server.
ms.openlocfilehash: 513b4ac54cf337a13cd95523fa3de750ce5f8c17
ms.sourcegitcommit: c528fad9db719f3fa96dc3fa99332a349cd9d317
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/12/2021
ms.locfileid: "49823459"
---
# <a name="ip-phone-inventory-report-in-skype-for-business-server"></a>Отчет по IP-телефонам в Skype для бизнеса Server
 
**Сводка:** Узнайте об отчете по IP-телефонам в Skype для бизнеса Server.
...
Следует отметить, что этот отчет имеет некоторые ограничения для случая использования данных отчета в реальном складском учете. Во-первых, в отчете по IP-телефонам перечислены все телефоны, которые вошли в Skype для бизнеса Server в течение указанного периода времени, отсортировали их по времени последнего входа. Если телефон не выполнял вход в течение указанного периода времени, он будет отсутствовать в этом отчете. Это относится также к телефонам, которые выполнили вход до начального периода создания отчета и остаются в системе в течение указанного периода времени. Например, предположим, что вы хотите искомый список телефонов за июль 2015 г. Предположим, что несколько телефонов вошли в Skype для бизнеса Server 30 июня 2015 г. и по-прежнему вошел в систему с 1 июля. Эти телефоны не будут добавлены в отчет за 1 июля 2012 г.
  
Кроме того, отчет может содержать телефоны, которые уже не используются в организации. Например, предположим, что несколько телефонов Fabrikam вошли в систему 1 июля 2015 г.; Через 5 дней ваша организация избавлялась от всех телефонов Fabrikam и заменила их более новой моделью Contoso. Телефоны Fabrikam будут отображаться в отчете, поскольку они выполнили вход в систему в течение июля.
...
|**Изготовитель** <br/> |Название компании, создавшей IP-телефон. Значения для данного фильтра заполняются автоматически на основе данных об IP-телефонах, хранящихся в базе данных.  <br/> |
|**Hardware version** (Версия оборудования) <br/> |Номер версии IP-телефона; С помощью фильтров "Изготовитель" и "Аппаратная версия" можно уникальным образом у идентификации определенного типа телефона. Значения для данного фильтра заполняются автоматически на основе данных об IP-телефонах, хранящихся в базе данных.  <br/> |
...
|:-----|:-----|:-----|
|**Изготовитель** <br/> |Да  <br/> |Название компании, создавшей IP-телефон.  <br/> |
...
|**Last logoff time** (Время последнего выхода) <br/> |Да  <br/> |Дата и время последнего выхода IP-телефона из Skype для бизнеса Server.  <br/> |
