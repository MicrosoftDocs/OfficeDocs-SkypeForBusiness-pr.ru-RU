...
---
# <a name="ip-phone-inventory-report-in-skype-for-business-server"></a>Отчет о запасах IP-телефона в Skype для бизнеса Server
 
**Сводка:** Сведения о отчете "Инвентаризация IP-телефона" в Skype для бизнеса Server.
...
|**Версия оборудования** <br/> |Номер версии IP-телефона; используя изготовитель и фильтры аппаратных версий, вы можете уникальным образом идентифицировать конкретный тип телефона. Значения для данного фильтра заполняются автоматически на основе данных об IP-телефонах, хранящихся в базе данных.  <br/> |
...
|**Последние действия за период** <br/> | Выберите одно из следующих значений: <br/>  [All] (Все) <br/>  5-10 <br/>  средняя <br/>  30 <br/> |
|**Последние выходы за период** <br/> | Выберите одно из следующих значений: <br/>  [All] (Все) <br/>  5-10 <br/>  средняя <br/>  30 <br/> |
...
|**Время последнего входа** <br/> |Да  <br/> |Дата и время последнего входа IP-телефона на сервер Skype для бизнеса Server.  <br/> |
|**Last logoff time (Время последнего выхода)** <br/> |Да  <br/> |Дата и время последнего сеанса IP-телефона сервера Skype для бизнеса Server.  <br/> |
