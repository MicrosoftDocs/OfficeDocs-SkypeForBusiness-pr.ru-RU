...
---
# <a name="location-trend-report-in-skype-for-business-server"></a>Отчет о тенденциях в расположении в Skype для бизнеса Server
 
**Сводка:** Learn about the Location Trend Report in Skype for Business Server.
