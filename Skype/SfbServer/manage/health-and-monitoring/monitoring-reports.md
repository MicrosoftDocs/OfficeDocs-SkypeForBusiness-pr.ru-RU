...
- [Использование панели мониторинга в Скайп для Business Server](monitoring-dashboard.md) Предоставляет администраторам краткий обзор о работоспособности и использовании системы.
    
- [Отчеты об использовании системы в Скайп для Business Server](system-usage-reports.md) Предоставляет сведения об использовании системы на основании данных регистрации Вызовов, собранных Скайп для Business Server.
    
- [Диагностические отчеты по вызовам (для пользователя) в Скайп для Business Server](call-diagnostic-reports-per-user.md) Предоставляет информацию о неудачных сеансов peer-to-peer и конференц-связи.
    
- [Отчеты по диагностике в Скайп для Business Server звонков](call-diagnostic-reports.md) Содержит сводную информацию и диагностические данные для неудачных peer-to-peer и сеансов конференц-связи.
    
- [Мультимедиа диагностические отчеты по качеству в Скайп для Business Server](media-quality-diagnostic-reports.md) Предоставляет информацию о качестве вызовов, а также диагностические сведения для неудачных вызовов.
