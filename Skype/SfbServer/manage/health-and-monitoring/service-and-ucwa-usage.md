...
Для большинства развертывания использование ЦП UCWA в среднем должно быть ниже 15 процентов. Использование памяти должно подпадать под ограничения, описанные в [Мониторе для](server-memory-capacity-limits.md) ограничений емкости памяти сервера в Skype для бизнеса Server.
...
Для большинства развертывания использование ЦП службы мобильности должно быть в среднем ниже 15 процентов. Использование памяти должно подпадать под ограничения, описанные в [Мониторе для](server-memory-capacity-limits.md) ограничений емкости памяти сервера в Skype для бизнеса Server.
