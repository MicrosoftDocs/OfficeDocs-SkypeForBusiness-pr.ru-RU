...
**Сводка:** Сведения о панели мониторинга в Скайп для Business Server.
  
Панель мониторинга предоставляет администраторам краткий обзор их Скайп для использования системы работоспособности и системы Business Server. Панель мониторинга предназначена для отображения сводного представления важнейших системных показателей в одном из следующих вариантов.
...
Обратите внимание на то, что можно использовать командлет [Get-CsReportingConfiguration](https://docs.microsoft.com/powershell/module/skype/get-csreportingconfiguration?view=skype-ps) возвращает URL-адрес для доступа к Скайп для отчетов мониторинга Business Server:
...
- В диалоговом окне **Надежные узлы** нажмите кнопку **Добавить** для добавления Скайп для Business Server, на котором работает Скайп для бизнес-сервера отчетов в коллекции надежных веб-сайтов.
