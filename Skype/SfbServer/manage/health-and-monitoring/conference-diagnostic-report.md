...
Доступ к  диагностическому отчету по конференциям осуществляется с домашней страницы отчетов мониторинга. Вы можете получить доступ к отчету о рассылке [Skype для бизнеса Server, щелкнув](failure-distribution-report.md) любой из следующих метрик:
