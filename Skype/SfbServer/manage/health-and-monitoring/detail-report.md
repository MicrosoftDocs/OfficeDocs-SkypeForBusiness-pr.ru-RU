...
---
# <a name="conference-detail-report-in-skype-for-business-server"></a>Подробный отчет по конференции в Skype для бизнеса Server

**Сводка:** Узнайте о подробном отчете по конференции, используемом в Skype для бизнеса Server.
...
В следующей таблице перечислены сведения, предоставляемые в разделе "Модальности конференций" подробного отчета по конференции.
