...
Доступ к отчету по устройствам обычно осуществляется с главной страницы отчетов наблюдения. Однако, если вы просматриваете отчет [](call-detail-report.md) о подробностях вызовов в Skype для бизнеса Server вы можете сверлить до отчета устройства для определенного устройства, щелкнув любой из следующих метрик:
  
- Устройства захвата
    
- Устройства обработки
    
В отчете об устройстве можно сверлить до отчета списка вызовов в Skype для бизнеса Server, [щелкнув](call-list-report-0.md) любой из следующих показателей:
