---
title: Отчет по устройствам в Skype для бизнеса Server
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
Доступ к отчету по устройствам обычно осуществляется с главной страницы отчетов наблюдения. Однако если вы просматриваете подробный отчет по звонкам в Skype для бизнеса [Server,](call-detail-report.md) вы можете просмотреть отчет по устройствам для определенного устройства, щелкнув один из следующих показателей:
...
> [!NOTE]
> Помните, что имена устройств захвата могут быть не одинаковыми, если вы работаете с локализованными версиями Skype для бизнеса Server. Устройство с именем «Aastra 6725ip Microphone (Aastra 6725ip)-V0» на английском языке (США) может называться по-другому на французском или испанском языке. 
...
|**Тип устройства** <br/> |Определяет тип устройства. Выберите один из следующих вариантов:  <br/> Пара устройств захвата и отрисовки устройства отрисовки устройства захвата |
