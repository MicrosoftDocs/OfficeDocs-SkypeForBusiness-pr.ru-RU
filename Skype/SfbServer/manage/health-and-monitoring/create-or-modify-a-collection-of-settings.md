...
|:-----|:-----|:-----|
|Имя  <br/> |Удостоверение  <br/> |Уникальный идентификатор для параметров конфигурации CDR, которые создаются. Эти параметры можно создать только на уровне сайта.  <br/> |
...
3. В **диалоговом окте** "Изменение параметра регистрации вызовов" (CDR) выберите нужные параметры и нажмите кнопку **"Зафиксировать".**
