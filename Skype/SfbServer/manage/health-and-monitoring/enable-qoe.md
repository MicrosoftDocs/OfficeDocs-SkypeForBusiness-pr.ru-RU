...
### <a name="to-enable-qoe-by-using-skype-for-business-server-control-panel"></a>Чтобы включить QoE с помощью панели управления Skype для бизнес-серверов
