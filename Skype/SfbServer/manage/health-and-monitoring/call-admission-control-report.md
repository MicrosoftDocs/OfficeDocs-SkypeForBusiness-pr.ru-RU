...
---
# <a name="call-admission-control-report-in-skype-for-business-server"></a>Отчет по контролю за допуском звонков в Skype для бизнеса Server
 
**Сводка:** Сведения об управлении допуском звонков, используемым в Skype для бизнеса Server.
...
- Подробный отчет о одноранговых сеансах: чтобы получить доступ к этому отчету, щелкните метрику подробности однорангового сеанса.
...
|:-----|:-----|:-----|
|**Подробности** <br/> |Нет  <br/> |При нажатии этой метрики появится отчет по деталям однорангового сеанса для указанного сеанса.  <br/> |
