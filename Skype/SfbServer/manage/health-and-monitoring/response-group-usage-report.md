---
title: Отчет по использованию группы ответа в Skype для бизнеса Server 2015
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 3/28/2016
...
ms.locfileid: "19569025"
---
# <a name="response-group-usage-report-in-skype-for-business-server-2015"></a>Отчет по использованию группы ответа в Skype для бизнеса Server 2015
 
**Сводка:** Сведения о приложении группы ответа в Скайп для Business Server 2015.
  
Приложение группы ответа предоставляет способ для Скайп для Business Server 2015 ответ и маршрутизации телефонных звонков на основе номер, набираемый был и, при необходимости, ответы вызывающего абонента к ряд вопросов. Обычно звонки группы ответа перенаправляются не отдельным пользователям, а группе пользователей, также называемых группой агентов. Например при поступлении вызова номер телефона для справочной службы, Скайп для Business Server 2015 можно автоматически направлять этот вызов первого агенту службы поддержки, доступные справки. Кроме того Скайп для Business Server может задать ряд вопросов («Press 1 при возникновении проблем с оборудованием. Если у вас возникли проблемы с программным обеспечением, нажмите 2. Если у вас возникли проблемы с сетью, нажмите 3") и затем перенаправить звонок определенному агенту службы поддержки с учетом ответов на вопросы.
...
Отчет об использовании группы ответа можно открыть на домашней странице отчетов мониторинга. Можно перейти в [Response Group Call List Report в Скайп для Business Server 2015](call-list-report.md) , щелкнув один из следующих показателей:
...
|:-----|:-----|:-----|
|**Ежечасно** <br/> **Ежедневно** <br/> **Еженедельно** <br/> **Ежемесячно** <br/> |Нет  <br/> |Указывает выбранный интервал времени. В применимых случаях можно щелкнуть конкретный интервал времени, чтобы просмотреть подробные сведения для этого интервала. Например, если вы используете ежедневный интервал и щелкнете дату 07.07.2012, то получите почасовую разбивку действий по регистрации пользователей на эту дату.  <br/> |
|**Полученные звонки** <br/> |Нет  <br/> |Общее количество звонков, полученных всеми экземплярами приложения группы ответа. Если щелкнуть этот элемент, в отчете будет показан отчет по списку вызовов группы ответа за выбранный период времени.  <br/> |
|**Успешные звонки** <br/> |Нет  <br/> |Общее количество звонков, полученных приложением группы ответа. Если щелкнуть этот элемент, в отчете будет показан отчет по списку вызовов группы ответа за выбранный период времени.  <br/> |
|**Предложенные звонки** <br/> |Нет  <br/> |Общее количество звонков, переадресованных агенту группы ответа. Если щелкнуть этот элемент, в отчете будет показан отчет по списку вызовов группы ответа за выбранный период времени.  <br/> |
|**Отвеченные звонки** <br/> |Нет  <br/> |Общее количество звонков, на которые фактически ответил агент группы ответа. Если щелкнуть этот элемент, в отчете будет показан отчет по списку вызовов группы ответа за выбранный период времени.  <br/> |
|**Процент отклоненных звонков** <br/> |Нет  <br/> |Общее количество вызовов, которые были получены приложением группы ответа, но на которые не ответил агент. Это значение вычисляется вычитанием числа отвеченных вызовов из количества принятых вызовов и последующим делением результата на число принятых вызовов. Например, если вы получили 10 вызовов, на 7 из которых был получен ответ, 7 вычитается из 10, что дает 3 неотвеченных вызовов. Это значение затем делится на 10, что дает процент звонков, оставшихся без ответа, равный 30%.  <br/> |
...
|**Переведенные звонки** <br/> |Нет  <br/> |Общее количество звонков, которые были переадресованы группой ответа из-за истечения времени ожидания или переполнение очереди. Если щелкнуть этот элемент, в отчете будет показан отчет по списку вызовов группы ответа за выбранный период времени.  <br/> |
