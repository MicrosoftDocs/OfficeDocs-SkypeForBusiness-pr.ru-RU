---
title: Отчет об использовании группы ответа в Skype для бизнеса Server
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
manager: serdars
...
Отчет об использовании группы ответа можно открыть на домашней странице отчетов мониторинга. Вы можете перейти к [отчету списка обзвона в Skype для бизнеса Server](call-list-report.md) , щелкнув один из следующих метрик:
