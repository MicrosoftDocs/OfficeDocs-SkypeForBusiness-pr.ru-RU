...
---
# <a name="response-group-usage-report-in-skype-for-business-server"></a>Отчет об использовании группы ответа в Скайп для Business Server
 
**Сводка:** Сведения о приложении группы ответа в Скайп для Business Server.
  
Приложение группы ответа предоставляет способ для Скайп для Business Server ответ и маршрутизации телефонных звонков на основе номер, набираемый был и, при необходимости, ответы вызывающего абонента к ряд вопросов. Обычно звонки группы ответа перенаправляются не отдельным пользователям, а группе пользователей, также называемых группой агентов. Например при поступлении вызова номер телефона для справочной службы, Скайп для Business Server можно автоматически направлять этот вызов первого агенту службы поддержки, доступные справки. Кроме того Скайп для Business Server может задать ряд вопросов («Press 1 при возникновении проблем с оборудованием. Если у вас возникли проблемы с программным обеспечением, нажмите 2. Если у вас возникли проблемы с сетью, нажмите 3") и затем перенаправить звонок определенному агенту службы поддержки с учетом ответов на вопросы.
...
Отчет об использовании группы ответа можно открыть на домашней странице отчетов мониторинга. Можно перейти к [Response Group Call List Report в Скайп для Business Server](call-list-report.md) , щелкнув один из следующих показателей:
