...
|**Название**|**Возможность сортировки по этому показателю**|**Описание**|
|:-----|:-----|:-----|
|**Тип проверки подлинности** <br/> |Нет  <br/> | Тип проверки подлинности, используемый участниками сеанса. Как правило, используются следующие значения: <br/>  Крупный бизнес <br/>  Federated <br/>  PIC <br/> |
|**Дата/время** <br/> |Нет  <br/> |Дата и время, когда состоялся сеанс.  <br/> |
|**Total** <br/> |Нет  <br/> |Общее число сеансов или сообщений.  <br/> |
