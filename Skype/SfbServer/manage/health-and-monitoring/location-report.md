...
---
# <a name="location-report-in-skype-for-business-server-2015"></a>Отчет о местоположении в Skype для бизнеса Server 2015
 
**Сводка:** Сведения об отчете о местоположениях в Скайп для Business Server 2015.
