...
ms.locfileid: "20977474"
---
# <a name="location-report-in-skype-for-business-server"></a>Расположение отчета в Скайп для Business Server
 
**Сводка:** Сведения об отчете о местоположениях в Скайп для Business Server.
