---
title: Сводный отчет по диагностике звонков в Skype для бизнеса Server 2015
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 3/28/2016
...
description: 'Сводка: Сведения о вызова сводном диагностическом отчете используется в Скайп для Business Server 2015.'
...
---
# <a name="call-diagnostic-summary-report-in-skype-for-business-server-2015"></a>Сводный отчет по диагностике звонков в Skype для бизнеса Server 2015
 
**Сводка:** Узнайте о вызова сводном диагностическом отчете используется в Скайп для Business Server 2015.
...
Получить доступ к отчету вызова диагностики Сводка с мониторинг отчетов домашней страницы. По диагностического отчета вызова Сводка может получить доступ [Peer-to-Peer Activity Diagnostic Report в Скайп для Business Server 2015](peer-to-peer-activity-diagnostic-report.md) , щелкнув метрику Частота сбоев в разделе сеанса Peer-to-Peer сводного отчета по. Можно также получить доступ к [Диагностический отчет по конференции в Скайп для Business Server 2015](conference-diagnostic-report.md) , щелкнув один из следующих показателей конференции:
...
Диагностический отчет вызова Сводка включает в себя диаграммы, сравнение сбоев для различных модальностей, используемые в Скайп для Business Server 2015. Столбцы в графиков, фактически гиперссылок; к примеру, при выборе столбце мгновенного обмена сообщениями для сеансов peer-to-peer вы будете перейти экземпляр [Peer-to-Peer Activity Diagnostic Report в Скайп для Business Server 2015](peer-to-peer-activity-diagnostic-report.md), отчет, который предоставляет дополнительные сведения обо всех сеансах обмена мгновенными сообщениями включены в сводном отчете вызова диагностики.
...
**Вызов фильтры сводного диагностического отчета**
...
|**Имя**.|**Можно отсортировать по этому элементу?**|**Описание**|
|:-----|:-----|:-----|
|**Общее количество конференций** <br/> |Нет  <br/> |Общее количество проведенных конференций.  <br/> |
