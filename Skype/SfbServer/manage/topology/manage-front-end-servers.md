...
1. Введите следующий cmdlet:
   ...
   ```
     ...
     Если этот cmdlet отображает отсутствующие реплики, перед применением исправлений запустите следующий для восстановления пула.
