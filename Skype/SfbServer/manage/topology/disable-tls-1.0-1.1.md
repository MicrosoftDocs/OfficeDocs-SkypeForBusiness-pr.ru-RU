...
- Скайп для бизнеса, 2016 нажмите кнопку Запуск, требуют обновления [2018 апреля](https://docs.microsoft.com/en-us/officeupdates/release-notes-office365-proplus) : 
...
#### <a name="call-quality-dashboard"></a>* Вызова панели мониторинга качества
...
Мы хотим следуйте обычным порядке операций «внутри выход» для обновления Скайп для серверов организаций. Рассматривать пулов, Pchat и сопоставленных пулов директоров в точно так же, как обычно. Порядок и методов обновления рассматривается [здесь](topology.md) и [здесь](https://support.microsoft.com/en-us/help/3061064/updates-for-skype-for-business-server-2015).
