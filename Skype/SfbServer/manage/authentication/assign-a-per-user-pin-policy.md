...
- Следующая команда назначает политику ПИН-код пользователя RedmondUsersPinPolicy для всех пользователей, работающих в города Редмонд. Для получения дополнительных сведений о параметр LdapFilter, используемые в этой команде видеть [Get-CsUser](https://docs.microsoft.com/powershell/module/skype/get-csuser?view=skype-ps).
...
Дополнительные сведения см [Grant-CsPinPolicy](https://docs.microsoft.com/powershell/module/skype/grant-cspinpolicy?view=skype-ps).
