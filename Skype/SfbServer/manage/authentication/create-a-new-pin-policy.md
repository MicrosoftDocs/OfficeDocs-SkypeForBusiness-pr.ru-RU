...
12. Чтобы разрешить распространенные шаблоны цифр в ПИН-коде, такие как "1234"  и "8888", выберите "Разрешить общие шаблоны". Если этот флажок не установлен, то разрешены только сложные шаблоны цифр. По умолчанию разрешены только сложные шаблоны.
