...
Клиентам настоятельно рекомендуется развертывать двух факторов проверку подлинности с помощью выделенных Skype для бизнеса Server с edge, Director и User Pools. Чтобы включить пассивную проверку подлинности для пользователей, другие методы проверки подлинности должны быть отключены для других ролей и служб, включая следующие:
...
|Прокси  <br/> |EdgeServer  <br/> |Microsoft Edge  <br/> |Kerberos и NTLM  <br/> |
|Прокси  <br/> |Регистратор  <br/> |Сервер переднего плана  <br/> |Kerberos и NTLM  <br/> |
...
Клиенты, которые развернули двух факторов проверки подлинности для Microsoft Exchange могут обнаружить, что некоторые функции в клиенте недоступны. В настоящее время это происходит по проекту, так как клиент Skype для бизнеса не поддерживает двух факторов проверку подлинности для функций, зависящих от Exchange интеграции.
