...
ms.locfileid: "60012323"
---
# <a name="set-a-users-dial-in-conferencing-pin-in-skype-for-business-server"></a>Установите ПИН-код телефонных разговоров пользователя в Skype для бизнеса Server
 
**Сводка:** Установите пин-код телефонных разговоров пользователя для Skype для бизнеса Server.
  
Чтобы присоединиться к телефонной конференции в качестве пользователя с проверкой подлинности, пользователю Skype для бизнеса Server с учетными данными Active Directory Domain Services (AD DS) требуется личный идентификационный номер (PIN). Если пользователь забывает ПИН-код телефонных разговоров или не установил ПИН-код с помощью Skype для бизнеса Server, вы можете настроить ПИН-код пользователя из панели управления Skype для бизнес-серверов. Вы можете автоматически создать ПИН-код или установить его вручную.
...
7. В диалоговом окне **Установить ПИН-код** выполните одно из следующих действий:
   ...
   - Чтобы разрешить Skype для бизнес-сервера создавать ПИН-код пользователя, выберите автоматически создать **допустимый ПИН-код** (по умолчанию).
