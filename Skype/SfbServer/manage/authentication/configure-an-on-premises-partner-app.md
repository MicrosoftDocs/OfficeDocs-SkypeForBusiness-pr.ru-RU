...
После внесения этих изменений можно выполнить сценарий и настроить Exchange 2013 и SharePoint как партнерские приложения, заверив файл скрипта в оболочке управления Skype для бизнеса Server. Например:
  
```PowerShell
C:\Scripts\ServerToServerAuth.ps1
```

Обратите внимание, что этот сценарий можно запустить даже в том случае, если не установлены Exchange 2013 и SharePoint Server: проблемы не возникнут, если вы, скажем, настроите SharePoint Server в качестве партнерского приложения, даже если sharePoint Server не установлен.
