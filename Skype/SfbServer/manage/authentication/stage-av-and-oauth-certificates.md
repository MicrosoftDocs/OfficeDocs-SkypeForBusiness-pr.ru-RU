...
Аудио- и видеосвязь является ключевым компонентом Skype для бизнеса Server. Такие функции, как совместное использование приложений и аудио- и видеоконференций, зависят от сертификатов, присвоенных службе A/V Edge, в частности службе проверки подлинности A/V.
