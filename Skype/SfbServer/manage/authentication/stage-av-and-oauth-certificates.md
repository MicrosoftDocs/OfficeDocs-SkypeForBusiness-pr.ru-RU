...
|4  <br/> |Конец: 7/22/2015 14:00:01  <br/> Срок действия старого сертификата истек, и новый сертификат был переохачен. Старый сертификат можно безопасно удалить с помощью Remove-CsCertificate -Type-Previous \<certificate usage type\>  <br/> |
