...
Если необходимые разрешения не задаются, Test-CsOUPermission возвращает значение False. Возможно, вам придется найти это значение в течение времени. Как правило, он внедряется в несколько сопутствующих предупреждений. Пример:
