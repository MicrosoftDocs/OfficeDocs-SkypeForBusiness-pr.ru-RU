...
7.  Нажмите **Далее**. В окне сводки будут показаны действия по мере их выполнения. После развертывания выберите view **Log** для просмотра доступных файлов журнала. Выберите **Готово** для завершения развертывания.
...
2.  Если вы хотите отойтки Skype для бизнеса Server федерации, чтобы использовать восстановленный edge Server, сделайте следующее:
      ...
      - Нажмите **Далее**. В окне сводки будут показаны действия по мере их выполнения. После развертывания выберите view **Log** для просмотра доступных файлов журнала. Выберите **Готово** для завершения развертывания.
