...
**Просмотр сведений о конфигурации edge доступа с помощью Windows PowerShell управления**
  ...
  - Сведения о конфигурации edge доступа можно просмотреть с помощью Windows PowerShell и с помощью Windows PowerShell **Get-CsAccessEdgeConfiguration.** Этот cmdlet можно запустить либо из оболочки управления Skype для бизнеса Server, либо из удаленного сеанса Windows PowerShell. 
