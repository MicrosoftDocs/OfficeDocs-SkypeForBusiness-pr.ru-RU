...
6.  На странице **Изменить федеративного поставщика SIP** можно указать или изменить следующие параметры.
      ...
      - **Служба доступа (FQDN):**   Обязательное свойство, введите полное доменное имя службы по краям доступа настраиваемого поставщика. Эти сведения предоставляются в качестве элемента по умолчанию и должны изменяться только в том случае, если общедоступный поставщик внося изменения в FQDN службы по границе доступа у поставщика.
