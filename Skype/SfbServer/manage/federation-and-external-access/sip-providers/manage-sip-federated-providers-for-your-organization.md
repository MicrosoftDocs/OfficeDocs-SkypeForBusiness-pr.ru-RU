...
Skype для бизнеса Server имеет конфигурации общедоступных поставщиков для обмена мгновенными сообщениями. Каждый общедоступный поставщик настраивается на edge-сервер поставщика с полностью квалифицированным доменным именем, а уровень проверки по умолчанию позволяет пользователям общаться только с людьми из списка **Контактов**, которые используют этого поставщика.
