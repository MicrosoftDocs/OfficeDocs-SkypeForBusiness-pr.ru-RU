...
> [!Note]
> Дополнительные сведения о развертывании расширенных Корпоративная голосовая связь, таких как E9-1-1 и служба информации о расположении, см. в Корпоративная голосовая связь [расширенных функций](../deploy/deploy-enterprise-voice/deploy-advanced-enterprise-voice-features.md).
...
5.  Заполните остальные поля следующим образом:
      ...
      - **Расположение**   Укажите одно из следующих значений:
          ...
          - **Отказ от ответственности**   Этот параметр является таким же, как **и необходимый** , за исключением того, что пользователь не может отклонять запрос без ввода сведений о расположении. Пользователь по-прежнему может выполнить экстренный вызов, но никакие другие вызовы не могут быть выполнены без ввода информации. Кроме того, пользователю показывается текст отказа, который может предупреждать о последствиях отказа от ввода информации о местонахождении. Чтобы установить текст об отказе, необходимо использовать Skype для бизнеса Server Management Shell для запуска команды **Set-CsLocationPolicy** или команды **new-CsLocationPolicy** с параметром EnhancedEmergencyServiceDisclaimer. Подробные сведения см [. в материале Set-CsLocationPolicy](/powershell/module/skype/Set-CsLocationPolicy) или [New-CsLocationPolicy](/powershell/module/skype/New-CsLocationPolicy).
