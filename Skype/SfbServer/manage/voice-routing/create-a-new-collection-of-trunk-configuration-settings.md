...
> [!Note]
> Комлеты Skype для бизнеса Server CsTrunkConfiguration поддерживают дополнительные свойства, не показанные в панели управления Skype для бизнес-серверов. Дополнительные сведения см. в разделе Справка для [комлета New-CsTrunkConfiguration.](/powershell/module/skype/New-CsTrunkConfiguration) 

**Создание новых параметров конфигурации магистрали с помощью панели управления Skype для бизнес-серверов**
