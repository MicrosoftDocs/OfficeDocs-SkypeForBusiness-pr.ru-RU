...
При установке Skype для бизнеса Server создается глобальная коллекция параметров конфигурации магистрали SIP. Кроме того, администраторы могут создать настраиваемые коллекции параметров в области узла или службы (только для службы шлюза ТСОП). Позже любую из этих коллекций можно изменить с помощью панели управления Skype для бизнеса Server или Windows PowerShell.
...
> [!Note]
> The Skype for Business Server CsTrunkConfiguration cmdlets support additional properties not shown in the Skype for Business Server Control Panel. Дополнительные сведения см. в разделе справки по [cmdlet Set-CsTrunkConfiguration.](https://docs.microsoft.com/powershell/module/skype/Set-CsTrunkConfiguration) 
...
3. В **диалоговом окне** "Изменение конфигурации магистрали" выберите нужные настройки и нажмите кнопку **"ОК".**
4. Свойство Состояние для коллекции будет обновлено до Незафиксированные. Чтобы зафиксировать изменения и удалить коллекцию, щелкните **"Зафиксировать"** и "Зафиксировать **все".**
5. В диалоговом окне **"Незафиксировать** параметры конфигурации голосовой почты" нажмите кнопку **"ОК".**
