---
title: Skype для бизнеса Конфигурация магистрали ServerModify SIP
ms.reviewer: ''
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
---
# <a name="skype-for-business-servermodify-sip-trunk-configuration-settings"></a>Skype для бизнеса Конфигурация магистрали ServerModify SIP
...
3. В **диалоговом окне Изменить конфигурацию** магистрали сделайте соответствующие выборы и нажмите **кнопку ОК**.
4. Свойство Состояние для коллекции будет обновлено до Незафиксированные. Чтобы зафиксировать изменения и удалить коллекцию, нажмите **Кнопку Фиксация**, а затем нажмите **Кнопку Фиксация Все**.
5. В **диалоговом окне Параметры** настройки голосовой системы нажмите **кнопку ОК**.
