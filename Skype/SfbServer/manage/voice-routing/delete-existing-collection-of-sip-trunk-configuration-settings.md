...
6. Если вы измените свое решение и решите не удалять коллекцию, нажмите кнопку Коммит **, а** затем нажмите кнопку **Отмена всех неотвеченных изменений**. Когда **появится диалоговое окно Skype для бизнеса Server панели** управления, нажмите **кнопку ОК**.
