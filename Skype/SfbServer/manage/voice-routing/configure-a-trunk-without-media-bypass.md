...
7. Установите флажок **мультимедиа централизованная обработка** при наличии известных мультимедиа точка завершения (например, телефонной сети (общего пользования PSTN) шлюз которых завершение мультимедиа имеет же IP-адрес как сигналы завершение). Сбросьте данный флажок, если у магистрали нет такой точки.
