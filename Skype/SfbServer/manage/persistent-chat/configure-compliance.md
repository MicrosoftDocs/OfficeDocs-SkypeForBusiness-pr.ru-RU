...
|**Атрибут**|**Описание**|**Необязательный/необходимый**|
|:-----|:-----|:-----|
|Username  <br/> |Имя отправителя.  <br/> |Необязательна  <br/> |
|ID  <br/> |Уникальный ID отправитель.  <br/> |Обязательна  <br/> |
...
|Uri  <br/> |SIP URI пользователя.  <br/> |Обязательна  <br/> |
