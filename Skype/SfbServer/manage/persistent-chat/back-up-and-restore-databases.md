...
Данные, созданные с помощью SQL Server резервного копирования, требуют значительно большего пространства диска , возможно, в 20 раз больше, чем созданные в **cmdlet Export-CsPersistentChatData**, но SQL Server резервное копирование, скорее всего, будет процедурой, с которой вы знакомы.
