...
Для управления ключами, используемыми для команд DTMF, используйте командлеты управления Skype для бизнеса Server с командлетами **Get-CsDialinConferencingDtmfConfiguration**, **Set-CsDialinConferencingDtmfConfiguration** и **New-CsDialinConferencingDtmfConfiguration**.
