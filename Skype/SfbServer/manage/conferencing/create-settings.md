...
---
# <a name="create-meeting-configuration-settings-in-skype-for-business-server-2015"></a>Создание параметров конфигурации собраний в Skype для бизнеса Server 2015
 
**Сводка:** Сведения о создании параметров конфигурации собрания в Скайп для Business Server 2015.
