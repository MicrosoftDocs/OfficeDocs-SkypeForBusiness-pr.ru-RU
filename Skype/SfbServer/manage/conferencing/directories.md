...
Каталоги конференций поддерживают сопоставление между букво-цифровой и цифровой ИД собрания, который участник использует для join a conference when using Skype for Business, и числового ИД конференции, который участник конференции с телефонной связью использует, чтобы присоединиться к конференции. 
