...
**SmtpServer** По умолчанию сценарий использует значение переменной среды зарезервированные **$PSEmailServer** для этого параметра. Если переменной **$PSEmailServer** не назначено значение, необходимо задать этот параметр вручную.
