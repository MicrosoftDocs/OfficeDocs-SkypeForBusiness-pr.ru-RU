...
---
# <a name="manage-dial-in-conferencing-access-numbers-in-skype-for-business-server"></a>Manage dial-in conferencing access numbers in Skype for Business Server
...
## <a name="view-dial-in-conferencing-access-numbers"></a>Просмотр номеров доступа кконференции с телефонным присоединением
...
### <a name="view-dial-in-access-numbers-by-using-skype-for-business-server-control-panel"></a>Просмотр телефонных номеров доступа с помощью панели управления Skype для бизнеса Server
...
8. В **SIP URI** сделайте следующее:
   ...
   В поле выпадающего списка щелкните домен приложения помощника по конференцию, которое поддерживает этот номер доступа к телефонной связи.
