...
При планировании обязательно учитывайте требования к обработке мультимедиа для вызовов PSTN и A/V-конференций, которые не поддерживают обход мультимедиа, а также обработку, необходимую для обработки сигнальных взаимодействий для количества звонков в часы занятости, которые необходимо поддерживать. Если У вас недостаточно ЦП, необходимо развернуть автономный пул серверов-посредников. Кроме того, шлюзы ТСТС, IP-УАТС и SBC необходимо разделить на подмостки, которые контролируются совмещенными серверами-посредниками в одном пуле и автономными серверами-посредниками в одном или более автономных пулах.
  
Если развернуты шлюзы ТСТС, IP-УАТС или пограничные контроллеры сеансов (SCS), которые не могут взаимодействовать с пулом серверов-посредников, их необходимо сопостерять с автономным пулом, состоящим из одного сервера-посредника. Некоторые из необходимых для шлюзов STN, IP-PBXs или SBCs:
