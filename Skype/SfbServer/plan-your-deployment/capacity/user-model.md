...
|:-----|:-----|
|ЦП  <br/> |64-bit dual processor, hex-core, 2.26 gigahertz (GHz) or higher.  <br/> Процессоры Intel Itanium не поддерживаются для Skype для бизнеса Server ролей сервера.  <br/> |
