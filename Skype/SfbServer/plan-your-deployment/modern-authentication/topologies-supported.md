...
|:-----|:-----|:-----|:-----|
|Только в облаке  <br/> |![Поддерживается SFB с топологией MA, только облако.](../../media/4d19b47f-8257-4a6f-9dab-0755206f7c52.PNG)Пользователи/почтовые ящики находятся: в Интернете   <br/> |Современная проверка подлинности включена для EXO и SFBO.  <br/> Сервер авторизации — Azure AD.  <br/> |Многофакторная проверка подлинности (многофакторной проверкой Подлинности), проверка подлинности (CBA) условного доступа (ЦС) на основе сертификата клиента и приложения управления Mobile (MAM) с Intune. \*  <br/> |
...
|Смешанная топология 2  <br/> |![Поддерживается MA с комбинированной топологией S4B 2, SFBO и MA, работающая с локальной версией EXCH.](../../media/247a985d-39cd-4c16-a19e-b8b65207d82e.PNG)           <br/> Пользователи/почтовые ящики находятся: EXCH и SFBO  <br/> |Агент Управления — на SFBO только. Сервер авторизации — Azure AD для пользователей, размещенных в SFBO, но AD для EXCH локальных.  <br/> |Многофакторной проверкой Подлинности, CBA, ЦС/MAM с Intune.\*  <br/> |
