...
- Маршрутизация потери кворума уровень группировки, возникающие при недостаточно серверов реплики для конкретной группы маршрутизации. Группа маршрутизации — это группа пользователей, размещенных в пуле. Каждая группа маршрутизации имеет три реплики в пуле: одна главная и две дополнительные.
    
- Пул уровня кворума потери, запустив недостаточно начальное число серверов в пуле. 
