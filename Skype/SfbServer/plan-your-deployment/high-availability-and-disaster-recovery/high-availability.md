...
В Skype для бизнес-сервера архитектура пулов интерфейсного интерфейса использует модель распределенных систем, при этом данные каждого пользователя хранятся в пуле до трех интерфейсных серверов. Рекомендуется, чтобы все пулы переднего конца enterprise Edition включали по крайней мере три передних конечных сервера.
...
> [!IMPORTANT]
> Максимальное число серверов переднего ряда увеличено до 16 в [Skype для бизнеса Server 2019](../../../SfBServer2019/plan/user-model-2019.md)
> 
