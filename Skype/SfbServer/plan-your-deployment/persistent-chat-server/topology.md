...
Кроме того можно совместно сервера сохраняемого чата внутреннего сервера и базы данных соответствия Persistent Chat (Если эта возможность включена) на локальном внутреннего сервера SQL Server Express. You can also choose to use a separate SQL Server with a dedicated instance. 
...
Можно совместно расположить сервера сохраняемого чата внутреннего сервера и базы данных соответствия Persistent Chat (Если эта возможность включена) на локальном внутреннего сервера SQL Server Express. You can also choose to use a separate SQL Server with a dedicated instance. 
