...
-  выпуск Standard сервер с стойким сервером чата, расположенным на переднем сервере
    
-  выпуск Standard сервер с стойким сервером чата на отдельном сервере
...
В следующих разделах описаны более подробные топологии, включая сценарии коллокации и параметры серверов базы данных. Подробные сведения о коллокациях всех ролей и баз данных сервера см. в материале [Topology Basics для Skype для бизнеса Server 2015 г](../../plan-your-deployment/topology-basics/topology-basics.md).
  
### <a name="standard-edition-server-with-persistent-chat-server-collocated-on-the-front-end-server"></a>выпуск Standard сервер с стойким сервером чата, расположенным на переднем сервере
