...
- Microsoft SQL Server 2016 и вам необходимо запустить с Скайп для Business Server накопительный пакет обновления 7 или более поздних версий. Рекомендуется под управлением SQL Server 2016 с последним пакетом обновления. Для получения дополнительных сведений об установке Microsoft SQL Server 2016 видеть [Установка 2016 SQL Server](https://docs.microsoft.com/pt-pt/sql/database-engine/install-windows/install-sql-server?view=sql-server-2016).
