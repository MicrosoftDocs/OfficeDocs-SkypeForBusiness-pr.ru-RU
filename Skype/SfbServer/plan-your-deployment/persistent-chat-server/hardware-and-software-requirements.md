...
- Microsoft SQL Server 2012. Для получения дополнительных сведений об установке Microsoft SQL Server 2012 видеть [установки SQL Server 2012](https://go.microsoft.com/fwlink/p/?LinkID=248559).
    
- Microsoft SQL Server 2008 R2. Для получения дополнительных сведений об установке Microsoft SQL Server 2008 R2 видеть [Установки SQL Server (SQL Server 2008 R2)](https://go.microsoft.com/fwlink/p/?LinkId=275702).
...
- [Экологические требования к Скайп для Business Server 2015](../../plan-your-deployment/requirements-for-your-environment/environmental-requirements.md)
