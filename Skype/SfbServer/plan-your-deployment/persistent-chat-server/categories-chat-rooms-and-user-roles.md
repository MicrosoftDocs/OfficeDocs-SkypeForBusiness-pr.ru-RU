...
> [!IMPORTANT]
> Разрешенные и отказано участники в категории не являются одинаковыми с ролью  Участника, которая применяется к стойким чатам.> Поиск отображает все открытые и закрытые комнаты чата, для которых пользователь, выполняемый поиск, входит в список разрешенных и отклоненных участников. Секретные комнаты не отображаются, если пользователь, выполняющий поиск, не является участником секретной комнаты. Пользователь может выполнять поиск только комнат, участником которых он или она уже является или может запросить участие. 
