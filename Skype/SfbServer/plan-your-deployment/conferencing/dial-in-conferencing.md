...
Дополнительные сведения о требованиях к серверу-посреднику и шлюзу PSTN см. в Skype для бизнеса Server, развертывание [сервера-посредника](../../plan-your-deployment/enterprise-voice-solution/mediation-server.md) в [topology Builder в Skype для бизнеса Server](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) и определение шлюза в [Topology Builder в Skype для бизнеса Server](../../deploy/deploy-enterprise-voice/define-a-gateway.md).
...
Дополнительные сведения о создании набора номеров см. [](../../deploy/deploy-enterprise-voice/dial-plans.md) в дополнительных сведениях о создании или изменении набора набора в Skype для бизнеса Server и создании или изменении [правила нормализации в Skype для бизнеса](../../deploy/deploy-enterprise-voice/normalization-rules.md). 
...
- Ссылка на страницу dial-in Conferencing Параметры, которая содержит полный список номеров доступа со связанными с ними языками; место для создания, сброса или разблокирования личных идентификационных номеров (PINs); и других сведений, таких как элементы управления многочастотными двумя тонами (DTMF).
    
Дополнительные сведения о политиках conferencing см. [](../../deploy/deploy-conferencing/dial-in-conferencing.md) в дополнительных сведениях о настройке телефонных Skype для бизнеса Server и управлении политиками [Skype для бизнеса Server](../../manage/conferencing/conferencing-policies.md).  
