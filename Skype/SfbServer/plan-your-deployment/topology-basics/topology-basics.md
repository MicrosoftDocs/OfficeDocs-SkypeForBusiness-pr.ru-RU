...
Вы также можете увидеть некоторые примеры топологий в [справочниках для Skype для бизнеса Server](reference-topologies.md).
...
- выпуск Enterprise включает в себя:
...
- Office веб-приложений Server, который Office веб-приложениями в Skype для бизнеса Server для обмена и отрисовки PowerPoint презентаций.
