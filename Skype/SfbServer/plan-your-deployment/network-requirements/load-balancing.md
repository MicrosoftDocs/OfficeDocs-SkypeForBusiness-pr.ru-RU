...
> [!CAUTION]
> Подробные сведения о сторонних поставщиках аппаратных балансировщиков нагрузки см. в статье [Инфраструктура Skype для бизнеса](https://docs.microsoft.com/SkypeForBusiness/certification/infra-gateways).  
