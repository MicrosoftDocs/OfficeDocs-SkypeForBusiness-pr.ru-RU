...
Подробные сведения о конфигурации брандмауэра для краеугольных компонентов см. в материале [Edge Server scenarios in Skype для бизнеса Server 2015 г.](../../plan-your-deployment/edge-server-deployments/scenarios.md) 
...
|Все внутренние серверы  |Разное  |49152-57500  |TCP/UDP  |Диапазон портов, используемых для аудиоконференций на всех внутренних серверах. Используется на всех серверах, завершающих аудиозапись: front End Servers (для Skype для бизнеса Server помощник по конференц-связи службы, Skype для бизнеса Server оповещение для конференц-связи службы и службы аудио- и видеоконференция Skype для бизнеса Server и сервера-посредника.  |
