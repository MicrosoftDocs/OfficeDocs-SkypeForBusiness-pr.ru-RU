...
Доменное имя SIP организации обычно совпадает с адресами электронной почты, переданными пользователям. Если у пользователя в организации будет такой электронный адрес, как Brown@contoso.com, \<sip-domain\> предпочтительным для организации с contoso.com доменным именем просто contoso.com.
