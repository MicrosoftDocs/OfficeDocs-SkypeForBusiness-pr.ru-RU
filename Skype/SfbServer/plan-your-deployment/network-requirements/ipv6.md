...
В следующей таблице показана матрица поддержки между пулом серверов переднего сервера и внутренним пулом.
...
- Пул Skype для бизнеса Server в режиме только IPv6, если пул только IPv6 разроясен.
