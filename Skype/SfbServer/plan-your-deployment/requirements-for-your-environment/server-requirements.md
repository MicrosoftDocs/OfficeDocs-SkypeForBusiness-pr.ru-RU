...
> [!NOTE]
> Вы могли заметить, что Windows Server 2008 R2 отсутствует в списке. Вот так, как мы рекомендуем Windows Server 2012 R2 для всех новых серверов, которое будет использоваться для SFB. Вы должны только использовать Windows Server 2008 R2 при наличии существующих серверов с Lync Server 2013 уже установлены и в случае сервера, чтобы выполнить обновление на месте из них. Windows Server 2008 R2 на 1/13/2015 достигнут конец основной поддержки жизненного цикла. 
