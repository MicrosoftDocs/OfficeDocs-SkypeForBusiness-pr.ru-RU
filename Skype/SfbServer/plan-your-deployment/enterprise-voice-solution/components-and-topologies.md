...
2. Создайте межсайтовую ссылку для магистрали SIP с использованием соответствующих значений параметров для сайта, созданного на шаге 1. Например, используйте имя сетевого сайта в вашем предприятии в качестве значения параметра NetworkSiteID1, а сетевого сайта ITSP как значение параметра NetworkSiteID2. Дополнительные сведения см. в материале Create network [intersite policies in Skype for Business Server](../../deploy/deploy-enterprise-voice/create-network-intersite-policies.md) в документации по развертыванию и [New-CsNetworkInterSitePolicy.](/powershell/module/skype/new-csnetworkintersitepolicy?view=skype-ps)
