...
Решения, необходимые для политики расположения для развертывания E9-1-1 в Skype для бизнеса Server Корпоративная голосовая связь, включая пользователей, которые необходимо включить и как поддерживать перемещающихся пользователей.
