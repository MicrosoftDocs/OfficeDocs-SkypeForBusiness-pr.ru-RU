...
С помощью снятия сервера-посредника с обработки мультимедиа обход мультимедиа также может уменьшить количество серверов-посредников, Корпоративная голосовая связь инфраструктуры. Общая рекомендация состоит в том, чтобы включать обход сервера-посредника везде, где это возможно.
...
После Корпоративная голосовая связь структуры планирование обхода мультимедиа является простым.
...
- Одноранговой сервер-посредник должен принимать трафик мультимедиа непосредственно из конечных точек Skype для бизнеса. Многие ИТП позволяют своим SBC получать трафик только с сервера-посредника. Обратитесь в службу ITSP, чтобы определить, принимает ли его SBC трафик мультимедиа непосредственно из конечных точек Skype для бизнеса.

- Клиенты Skype для бизнеса и одноранговой сервер-посредник должны быть хорошо подключены, что означает, что они находятся либо в одном сетевом регионе, либо на сетевых сайтах, подключающихся к региону через WAN-ссылки, не связанные с пропускной способностью.