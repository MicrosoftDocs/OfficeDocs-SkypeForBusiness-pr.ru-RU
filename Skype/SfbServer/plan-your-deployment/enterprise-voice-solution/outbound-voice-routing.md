...
- **Переадресация звонков и одновременные звонки** по коммутируемой сети позволяют администраторам указывать одинаковое использование PSTN в качестве политики голосовой связи для переадресации звонков и одновременного звонка, ограничивать переадресацию звонков и одновременную связь с внутренней программой Skype для Только для бизнес-пользователей или указать специальную стандартную PSTN, которая отличается от использования КТСОП голосовой политики. По умолчанию в ТСОП применяется режим переадресации вызовов и одновременного приема вызовов, указанный в политике голосовой связи.
