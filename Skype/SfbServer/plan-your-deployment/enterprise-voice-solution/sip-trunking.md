...
С другой стороны, прямые подключения SIP — это подключения, которые не пересекают границы локальной сети (т.е. они подключаются к шлюзу ТСОП или УАТС во внутренней сети). Сведения об использовании прямых подключений SIP с Skype для бизнеса Server см. в материале [Direct SIP connections in Skype для бизнеса Server](direct-sip.md).
...
Сведения о серверах-посредниках см[. в Skype для бизнеса Server](mediation-server.md).
...
> [!NOTE]
> Сведения о распределенной магистрали SIP см. в материале [Магистраль SIP сайта Branch в Skype для бизнеса Server](branch-site.md).
