...
> [!NOTE]
> Не все общедоступные ЦС соответствуют требованиям Skype для бизнеса Server сертификатов. Рекомендуется обратиться к списку сертифицированных поставщиков общедоступных сертификатов для государственных сертификатов. Подробные сведения см. [в материале Unified Communications Certificate Partners.](https://go.microsoft.com/fwlink/p/?LinkId=140898) 
