...
- Один из следующих параметров закрепления станции для обеспечения безопасности на планшете к собранию комнаты в таблице. 
  ...
  - [Polycom MSR серии](http://www.polycom.com/hd-video-conferencing/microsoft-video/msr-series.mdl)
...
|**Большой** <br/> 15' x 20'  <br/> |12-16  <br/> |Logitech PTZ специалистов  <br/> Polycom MSR  <br/> Polycom CX5100   <br/> ||
