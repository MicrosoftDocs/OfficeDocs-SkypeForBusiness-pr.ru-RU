...
> [!NOTE]
> Этот список является предварительным, и некоторые устройства могут иметь право на Lync, но не поддерживаются в Skype для бизнеса на Mac. Требования к системе [для минимальных](https://products.office.com/office-system-requirements) требований к оборудованию.
...
Клиент предъявляет те же требования, что и клиенты мобильности, так как в поддерживаемой конфигурации необходимо развернуть сервер доступа и обратный прокси-сервер. 
