...
Клиент Skype для бизнеса на Mac требует Mac OS X El Capitan и выше и использует не менее 100 МБ дискового пространства. Мы поддерживаем использование всех встроенных аудио- и видео устройств. Внешние устройства должны быть в [каталоге бизнес-решений Skype.](https://partnersolutions.skypeforbusiness.com/solutionscatalog) 
