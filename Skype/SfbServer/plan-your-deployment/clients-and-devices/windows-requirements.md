...
В этом разделе описывается программное обеспечение, необходимое для поддержки клиентов Skype для бизнеса Windows. Эти клиенты устанавливаются при установке Microsoft 365 или Office 365, а также доступны на странице [Загрузка Skype для бизнеса для всех устройств](https://products.office.com/skype-for-business/download-app?tab=tabs-3).
...
Ознакомьтесь с [требованиями к системе](https://products.office.com/office-system-requirements) Microsoft 365 и Office для оборудования, необходимого для запуска клиента Skype для бизнеса.
...
[Требования Microsoft 365 и Office к системе](https://products.office.com/office-system-requirements)
