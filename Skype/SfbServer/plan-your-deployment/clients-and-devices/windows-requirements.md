...
|Браузер  <br/> |Microsoft Edge  <br/> Internet Explorer 11 Internet Browser  <br/>  Internet Explorer 10 Браузер <br/> Браузер Internet Explorer 9  <br/> Internet Explorer 8 Браузер  <br/> Браузер Internet Explorer 7  <br/> Веб-браузер Mozilla Firefox  <br/>  Веб-браузер Google Chrome  <br/>**Примечание.** Если вы используете Skype для бизнеса с Microsoft Exchange Online и в вашей организации развернут http-прокси для проверки подлинности, Internet Explorer 8 или более поздней.           |
