...
|:-----|:-----|
|RTCHSUniversalServices  <br/> |Включает учетные записи служб, используемые для запуска серверов переднего сервера и серверов Standard Edition. Эта группа позволяет серверам считывать и записывать доступ к глобальным настройкам Skype для бизнеса Server и объектам пользователей Active Directory.  <br/> |
...
|RTCSBAUniversalServices  <br/> |Предоставляет доступ только для чтения к настройкам Skype для бизнеса Server, но позволяет настраивать конфигурацию для установки сервера для survivable branch server и развертывания устройства для survivable branch appliance.  <br/> |
...
|:------------------------------------------------------------------------|:------------------------------------|
| Чтение системного контейнера корневого домена (не наследуется) **\\**\* <br/>        | X  <br/>                            |
