...
Для получения дополнительных сведений о ролях RBAC и разрешенные для каждой задачи содержатся в документации по планированию [управления доступом на основе ролей](http://technet.microsoft.com/library/41204ba3-ce5b-41a8-a6c3-b444468fa328.aspx) .
...
> [!NOTE]
> **\***Записи ACE, которые не наследуются предоставляет доступ к дочерним объектам в разделе этих контейнеров. Записи ACE, наследуемые предоставить доступ к дочерним объектам в разделе этих контейнеров. 
