...
|**UAType** <br/> |smallint  <br/> | <br/> |1 — сервер-посредник.  <br/> 2 — сервер A/V Conferencing Server.  <br/> 4 — Skype для бизнеса.  <br/> 8 — IP-телефон.  <br/> 16 — консоль Live Meeting.  <br/> 32 — это средство проверки развертывания (DVT).  <br/> 64 — Skype для бизнеса Server на компьютерах Macintosh.  <br/> 128 — помощник skype для бизнеса Server.  <br/> 256 — служба объявлений для видеоконференций.  <br/> 512 — это автосекретарь.  <br/> 1024 — приложение группы ответа.  <br/> 2048 — это внешний голосовой контроль.  <br/> |
