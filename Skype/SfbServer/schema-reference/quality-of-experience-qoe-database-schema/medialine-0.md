...
|**CallerCaptureDev** <br/> |int  <br/> |Foreign  <br/> |Захват устройства, используемой вызываемой. Ссылки из [таблицы Устройства](device.md).  <br/> |
|**CallerRenderDev** <br/> |int  <br/> |Foreign  <br/> |Отрисовка устройства, используемой вызываемой. Ссылки из [таблицы Устройства](device.md).  <br/> |
|**CallerCaptureDevDriver** <br/> |int  <br/> |Foreign  <br/> |Драйвер для устройства захвата вызываемого, ссылаясь на [таблицу DeviceDriver.](devicedriver.md)  <br/> |
...
|**CalleeCaptureDev** <br/> |int  <br/> |иностранные  <br/> |Захват устройства, используемой приемником вызовов. Ссылки из [таблицы Устройства](device.md).  <br/> |
|**CalleeRenderDev** <br/> |int  <br/> |Foreign  <br/> |Отрисовка устройства, используемой приемником вызовов. Ссылки из [таблицы Устройства](device.md).  <br/> |
