...
ms.locfileid: "21016546"
---
# <a name="qoe-table-details"></a>Данные таблицы качества взаимодействия
 
В этих разделах описываются столбцы таблиц схемы базы данных качества взаимодействия (QoE).
...
- [Таблица AudioSignal](audiosignal.md)
...
- [Таблица MediaLine](medialine-0.md)
    
- [Таблица MonitoredRegionLink](monitoredregionlink.md)
...
- [Таблица PurgeSettings (качество взаимодействия)](purgesettings-qoe.md)
