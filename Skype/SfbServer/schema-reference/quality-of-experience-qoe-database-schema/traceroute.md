...
|**MediaLineLabel** <br/> |tinyint  <br/> |Основной, внешний  <br/> |Представляет тип видеоканала, используемого для звонка. Допускаются следующие значения:  <br/> 0 — звук  <br/> 1 — видео  <br/> 2 — панорамное видео  <br/> 3 . Общий доступ к приложениям и рабочим столам  <br/> |
