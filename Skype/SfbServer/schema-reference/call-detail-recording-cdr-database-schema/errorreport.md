...
|**FromUserId** <br/> |int  <br/> |Внешняя  <br/> |Пользователь, который вызвал запрос, вызваввший ошибку. Дополнительные [сведения см. в](users.md) таблице "Пользователи". <br/> |
|**ToUserId** <br/> |int  <br/> |Внешняя  <br/> |Пользователь назначения для запроса, который вызвал ошибку. Дополнительные [сведения см. в](users.md) таблице "Пользователи". <br/> |
...
|**IsCapturedByServer** <br/> |bit  <br/> ||Отчет об ошибках, который захватывает агент CDR, работающий на сервере переднего сервера, или отправляется клиентом.  <br/> |
