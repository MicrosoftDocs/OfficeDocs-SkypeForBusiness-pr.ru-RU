...
Таблица DeRegisterType — это статическая таблица, в которую хранится список возможных типов регистрации пользователей, таких как "инициирован клиент", "срок действия регистрации истек" или "клиент перестал отвечать".
