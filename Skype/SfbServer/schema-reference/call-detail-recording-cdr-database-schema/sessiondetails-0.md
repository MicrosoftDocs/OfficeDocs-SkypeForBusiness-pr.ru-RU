...
В представлении SessionDetails хранится информация об одноранговых сеансах, которые могут быть телефонным VoIP-VoIP, двухстолбным сеансом im или другим типом сеанса. Это представление впервые было введено в Microsoft Lync Server 2013.
...
|**FromTenant** <br/> |nvarchar(450)  <br/> |Клиент пользователя, запустившего сеанс. Дополнительные [сведения см.](tenants.md) в таблице Tenants. <br/> |
|**ToTenant** <br/> |nvarchar(256)  <br/> |Клиент пользователя, который присоединился к сеансу. Дополнительные [сведения см.](tenants.md) в таблице Tenants. <br/> |
...
|**ReferredByTenant** <br/> |nvarchar(256)  <br/> |Клиент пользователя, который указал ссылку на сеанс. Дополнительные [сведения см.](tenants.md) в таблице Tenants. <br/> |
