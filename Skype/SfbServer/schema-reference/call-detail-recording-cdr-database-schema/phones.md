...
Таблица Phones является вспомогательной. В каждой записи таблицы хранится информация об одном телефонном номере, который участвует в вызовах VoIP, в базе данных которых есть записи.
