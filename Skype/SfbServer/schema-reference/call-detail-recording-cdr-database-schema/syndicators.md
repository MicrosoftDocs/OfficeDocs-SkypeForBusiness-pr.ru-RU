...
---
# <a name="syndicators-table"></a>Таблица синдикаторов
 
Таблица SyndicatorsTable предназначена для внутреннего использования. Эта таблица была представлена в Microsoft Lync Server 2013.
