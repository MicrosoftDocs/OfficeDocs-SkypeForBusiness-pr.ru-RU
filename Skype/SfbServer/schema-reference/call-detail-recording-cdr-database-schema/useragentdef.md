...
Таблица useragentdef привязка идентификаторов агента пользователя к описательным именам агента. Агенты пользователей — это программное обеспечение клиентов, которые используются для подключения к Скайп для Business Server 2015. Эта таблица была введена в Microsoft Lync Server 2013.
...
|256  <br/> |Conferencing_Announcement_Service_1.0  <br/> |СЕРВЕР КЛИЕНТСКОГО ДОСТУПА  <br/> |
...
|1040  <br/> |Response_Group_Service Announcement_Service  <br/> |КАК  <br/> |
|2048  <br/> |Microsoft.Rtc.Applications.Ccs  <br/> |CCS  <br/> |
|16386  <br/> |Como вместе  <br/> |Como вместе  <br/> |
