---
title: Схема базы данных регистрации вызовов (CDR) в Skype для бизнеса Server 2015
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
description: В этом документе документироваться схема базы данных регистрации вызовов (CDR) в Skype для бизнеса Server 2015.
