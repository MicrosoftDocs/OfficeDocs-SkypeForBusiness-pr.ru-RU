...
#### [Требования к аппаратным и программным средствам](../plan-your-deployment/archiving/hardware-and-software-requirements.md)
...
#### [Развертывание системы комнат Skype](../deploy/deploy-clients/deploy-skype-room-system.md)
...
###### [Развертывание одного локального леса](../deploy/deploy-clients/single-forest-on-premises-deployments.md)
###### [Развертывание нескольких локальных лесов](../deploy/deploy-clients/multiple-forest-on-premises-deployments.md)
...
##### [Рекомендации по перемещению](../deploy/deploy-clients/migration-considerations.md)
##### [Рекомендации по присоединению к домену](../deploy/deploy-clients/domain-joining-considerations.md)
##### [Лицензия на использование программного обеспечения Skype для бизнеса](../deploy/deploy-clients/skype-for-business-software-liicense.md)
##### [Возможности управления и инструменты.](../deploy/deploy-clients/manageability-and-tools.md)
##### [Сценарии для настройки комнат](../deploy/deploy-clients/room-setup-scripts.md)
