...
##### [Развертывание одного сайта в Cloud Connector](../skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/deploy-a-single-site-in-cloud-connector.md)
...
#### [Установка обязательных компонентов](../deploy/install/install-prerequisites.md)
...
#### [Применение исправления или обновления к серверам переднего плана](../manage/topology/patch-or-update-front-end-servers.md)
#### [Добавление или удаление сервера переднего плана](../manage/topology/add-or-remove-a-front-end-server.md)
...
###### [Отчет по активности пользователей](../manage/health-and-monitoring/user-activity-report.md)
...
###### [Отчет о местоположении](../manage/health-and-monitoring/location-report.md)
...
##### [Таблица tblSystemRevision](../schema-reference/persistent-chat-database-schema/tblsystemrevision.md)
