---
title: Запуск или остановка захвата журнала CLS в Skype для бизнеса Server 2015
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
description: Сводка. Узнайте, как запустить или остановить сеанс захвата журнала службы ведения журнала в Skype для бизнеса Server 2015.
ms.openlocfilehash: 773b93f62690b01d33f84bc5eb68b135280842ea
ms.sourcegitcommit: 01087be29daa3abce7d3b03a55ba5ef8db4ca161
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/23/2021
ms.locfileid: "51098825"
---
# <a name="start-or-stop-cls-log-capture-in-skype-for-business-server-2015"></a>Запуск или остановка захвата журнала CLS в Skype для бизнеса Server 2015
 
**Сводка:** Узнайте, как запустить или остановить сеанс захвата журнала службы централизованного ведения журнала в Skype для бизнеса Server 2015.
  
Чтобы захватить журналы трассировки с помощью централизированной службы ведения журнала, вы выдает команду начать ведение журнала на одном или более компьютерах и пулах. Также вы выдают параметры, определяющие, какие компьютеры или пулы, какие сценарии запускать (например, AlwaysOn, другой заданный сценарий или созданный сценарий), какие компоненты Skype для бизнеса Server (например, S4, SipStack) отслеживать.
...
Централизованная служба ведения журнала предоставляет два способа выдачи команд. Целый ряд тем был посвящен использованию Windows PowerShell через оболочку управления Skype для бизнес-серверов. Возможность использования ряда сложных конфигураций и команд Windows PowerShell для централизированной службы ведения журнала. Поскольку Windows PowerShell skype для бизнеса Server Management Shell практически вездесущ для всех функций в Skype для бизнеса Server, обсуждаются только Windows PowerShell команды. 
