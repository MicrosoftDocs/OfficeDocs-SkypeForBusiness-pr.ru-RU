...
В [2015](centralized-logging-service.md)г. в службе централизованного ведения журнала Skype для бизнеса 2015 г. основными элементами определения поставщика для использования в сценарии являются:
