...
4. При использовании команд поиска пулами может быть любой пул в развертывании, например пулы переднего сервера, пулы edge, пулы серверов сохраняемой беседы или другие пулы, определенные как пулы в развертывании.
