...
-  **Кодлеты CsClsRegion:** [Get-CsClsRegion](/powershell/module/skype/get-csclsregion?view=skype-ps) , [Set-CsClsRegion](/powershell/module/skype/set-csclsregion?view=skype-ps), [New-CsClsRegion](/powershell/module/skype/new-csclsregion?view=skype-ps) и [Remove-CsClsRegion](/powershell/module/skype/remove-csclsregion?view=skype-ps).
...
Области сайта и Глобальной области определяются в комлетах **New-**, **Set-and** **Remove-Centralized** Logging Service. В следующих примерах показано, как задать область сайта и глобальную область.
