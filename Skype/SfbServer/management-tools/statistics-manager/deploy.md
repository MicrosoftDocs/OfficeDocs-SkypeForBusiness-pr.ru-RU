...
1. Откройте браузер и перейдите к https://localhost: \<порт службы\>/healthcheck/
...
Чтобы просмотреть сведения только о работоспособности, откройте браузер и перейдите к: http://localhost: \<webport\>/технологий /.
