...
Установка веб-сайт, на главном компьютере, выполнив StatsManWebSite.msi, (входит в состав [Скайп для Business Server, диспетчер статистику в режиме реального времени (64-разрядная версия)](https://www.microsoft.com/en-in/download/details.aspx?id=57518)), указав следующие:
