...
> [!NOTE]
> При обновлении предыдущей версии диспетчера статистики см. в [Skype для бизнеса Server.](upgrade.md) 
...
Вы можете найти диспетчер статистики, загружаемый по ссылке [https://aka.ms/StatsManDownload](https://aka.ms/StatsManDownload). 
...
2. На следующей странице укажите следующие сведения:
   ...
   - **Служба URI:** Это URI, в котором находится слушатель. Он должен использовать формат https://name:port .
...
- Зарегистрирован ли агент в диспетчере статистики?
    ...
    1. Убедитесь, что вы следовали инструкциям по импорту топологии. См [. в этой ленте Импорт топологии](deploy.md#BKMK_ImportTopology).
...
3. Перейдите к **Personal**, а затем откройте **сертификаты**.
    
4. Правой кнопкой мыши **на statsManListener-All\> Tasks-Manage\> Private Keys...**
