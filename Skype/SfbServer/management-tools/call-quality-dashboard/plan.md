...
Поддерживаемые операционные системы для портала CQD: Windows 8.1, Windows 8, Windows Server 2012 R2, Windows Server 2012 и Windows Server 2016 (Skype для бизнеса Server 2019 CQD) только).
...
|Для CQD 2015 |&nbsp;  |
|:-----|:-----|
|Поддерживаемые операционные системы    |Windows Сервер 2008 R2, Windows Server 2012, Windows Server 2012 R2   |
