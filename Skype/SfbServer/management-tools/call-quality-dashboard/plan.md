---
title: Планирование панели мониторинга качества вызовов для Skype для бизнеса Server
ms.reviewer: ''
ms.author: v-cichur
author: cichur
manager: serdars
...
ms.locfileid: "58728858"
---
# <a name="plan-for-call-quality-dashboard-for-skype-for-business-server"></a>Планирование панели мониторинга качества вызовов для Skype для бизнеса Server 
...
Во время установки пользователю, который выполняет установку, просто необходимо предоставить экземпляры Microsoft SQL Server и Microsoft SQL Server analysis Services, которые ранее были настроены на компьютере, на котором должен быть установлен CQD. Дополнительные сведения можно получить [в панели](deploy-0.md) мониторинга качества Skype для бизнеса Server вызовов.
...
|:-----|:-----|
|Для CQD 2015 <br/> |  <br/> |
|Поддерживаемые операционные системы   <br/> |Windows Сервер 2008 R2, Windows Server 2012, Windows Server 2012 R2  <br/> |
...
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|Виртуальная машина  <br/> |900 МБ  <br/> |Один  <br/> |VHD (переменный размер)  <br/> |0,5 м  <br/> |30 м  <br/> |2 м  <br/> |30 s  <br/> |1 м  <br/> |
|Виртуальная машина  <br/> |9 ГБ  <br/> |Один  <br/> |VHD (переменный размер)  <br/> |5 M  <br/> |4 ч  <br/> |15 м  <br/> |1 м  <br/> |5 м  <br/> |
|Виртуальная машина  <br/> |9 ГБ  <br/> |Один  <br/> |VHD (фиксированный размер)  <br/> |5 M  <br/> |2 ч  <br/> |5 м  <br/> |1 м  <br/> |5 м  <br/> |
|Виртуальная машина  <br/> |30+ ГБ  <br/> |Один  <br/> |VHD (фиксированный размер)  <br/> |10 M  <br/> |15 ч  <br/> |20 м  <br/> |2 м  <br/> |45 м  <br/> |
|8 ядра  <br/> |9 ГБ  <br/> |Один  <br/> |Несколько дисков  <br/> |5 M  <br/> |2 ч  <br/> |5 м  <br/> |25 s  <br/> |5 м  <br/> |
|8 ядра  <br/> |9 ГБ  <br/> |Несколько  <br/> |Несколько дисков  <br/> |5 M  <br/> |2 ч  <br/> |15 м  <br/> |35 s  <br/> |2 м  <br/> |
|8 ядра  <br/> |30+ ГБ  <br/> |Один  <br/> |Несколько дисков  <br/> |20 M  <br/> |9 ч  <br/> |20 м  <br/> |1 м  <br/> |20 м  <br/> |
|8 ядра  <br/> |30+ ГБ  <br/> |Несколько  <br/> |Несколько дисков  <br/> |20 M  <br/> |9 ч  <br/> |30 м  <br/> |2 м  <br/> |2 м  <br/> |
|4 ядра  <br/> |200 ГБ  <br/> |Один  <br/> |Несколько дисков  <br/> |125 M  <br/> |6+ дней  <br/> |7 ч  <br/> |2 м  <br/> |6 ч  <br/> |
...
- Windows Сервер 2008 R2 с IIS 7.5
...
- Windows Server 2019 (Skype для бизнеса Server только CQD 2019)
