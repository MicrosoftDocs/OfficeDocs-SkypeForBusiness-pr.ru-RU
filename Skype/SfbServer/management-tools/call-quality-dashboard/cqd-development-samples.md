...
1. Службы данных, доступном для прошедших проверку подлинности пользователей с помощью [Data API для вызова качества панели мониторинга (CQD) в Скайп для Business Server 2015](data-api.md).

2. Репозиторий служба доступна для прошедших проверку подлинности пользователей с помощью [API репозитория для вызова качества панели мониторинга (CQD) в Скайп для Business Server 2015](repository-api.md).
