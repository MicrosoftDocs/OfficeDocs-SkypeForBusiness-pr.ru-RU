 ...
 *subItemIds*  — ИД подученых элементов, если таково. Это кратковременная операция Get Sub-Items для сохранения вызова. Приложения также могут получить те же сведения с помощью операции Get Sub-Items.
