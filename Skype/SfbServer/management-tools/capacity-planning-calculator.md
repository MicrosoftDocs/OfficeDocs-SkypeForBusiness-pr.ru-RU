...
- **Общее серверов переднего плана**: число физических серверов требуется основаны на выделенных серверах под управлением Скайп для Business Server с Двухъядерный процессор, шестиядерный, с помощью 2,260 число циклов.
