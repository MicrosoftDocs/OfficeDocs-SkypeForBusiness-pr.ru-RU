...
1. **Дата начала** Это дата начала временной шкалы, отчет для; Например, 1 августа 2010 г.
    
2. **Дата окончания** Дата окончания временной шкалы, отчет для; Например, 30 сентября 2010 г.
 ...
 **Данные конфигурации топологии сети CAC представления:** Скайп для администраторов Business Server 2015 можно просмотреть данные конфигурации сети, связанных с ними рабочих областей сети, сети, профили пропускной способности и сайта подсети IP-адресов в текстовый формат с помощью параметра данные конфигурации сети представления, как показано ниже. 
...
1. Средство SEFAUTil может выполняться только на компьютере, который является частью пула доверенных приложений. При необходимости добавления в пул в качестве нового пула доверенных приложений можно выполнить с помощью Скайп для консоли Business Server с помощью следующего командлета:
...
2. Доверенное приложение должен быть определен в топологии для средства SEFAUtil. Определение SEFAUtil в качестве нового доверенного приложения, используйте Скайп для Business Server Командная консоль и выполните следующий командлет: 
...
3. Изменения топологии необходимо включить. Включение изменения топологии можно выполнить с помощью Скайп для консоли Business Server, выполнив следующий командлет: 
...
|**Необходимые компоненты**|**Расположение**|
|:-----|:-----|
|Microsoft .Net Framework 4.5  <br/> |http://go.microsoft.com/?linkid=9816306  <br/> |
|Microsoft SQL Server 2008 R2, экспресс-выпуск  <br/> |http://www.microsoft.com/en-us/download/details.aspx?id=23650  <br/> |
|Windows PowerShell 3.0  <br/> |http://www.microsoft.com/en-us/download/details.aspx?id=34595  <br/> |
|Распространяемый пакет Visual C++ 2010  <br/> |http://www.microsoft.com/en-us/download/details.aspx?id=5555  <br/> |
|Обновления для сервера IIS  <br/> |http://www.microsoft.com/en-us/download/details.aspx?id=34869  <br/> |
