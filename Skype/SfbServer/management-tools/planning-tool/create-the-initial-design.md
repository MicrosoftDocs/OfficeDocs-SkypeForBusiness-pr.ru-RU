...
1. Начните Skype для бизнеса Server 2015 г.: нажмите кнопку **Начните, нажмите** кнопку Все **программы, нажмите** кнопку Skype для бизнеса Server **2015** г., а затем нажмите кнопку **Средство планирования**.
...
8. В **веб-сайте Homed Users** введите ожидаемое число пользователей, которые будут иметь место на этом центральном сайте.
...
13. Последний вопрос задает, хотите ли вы создать другой центральный сайт. Если выбрать **да**, средство планирования возвращается на страницу Центральные сайты. Если **выбрано нет**, нажмите **кнопку Далее**, а затем щелкните **Draw** , чтобы отобразить представление глобальной топологии высокого уровня.

14. Чтобы просмотреть существующую топологию, щелкните **Дисплей**.
