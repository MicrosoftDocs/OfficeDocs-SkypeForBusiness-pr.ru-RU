...
- Windows Server 2008 R2 с помощью WOW
...
4. На странице Welcome в **Skype для бизнеса Server 2015 выберите** мастер установки инструментов **планирования**.

5. Просмотрите **соглашение** о лицензии конечного пользователя, выберите я принимаю условия Лицензионного соглашения, если вы решите принять условия использования в лицензионных соглашениях, а затем нажмите **кнопку Далее**.
