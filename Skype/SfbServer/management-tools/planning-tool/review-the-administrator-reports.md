...
Отчет администратора Skype для бизнеса — это первый из четырех ценных отчетов, подробно документировать дизайн. Сведения из этого отчета и трех других связанных отчетов полезны для групп информационных технологий:
