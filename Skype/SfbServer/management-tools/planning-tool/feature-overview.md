...
- **Пользователи, которые были в облаке** Введите количество пользователей, которые находятся на центральном сайте в Skype для бизнеса Online.
...
Оставшиеся элементы были либо заполнены ответами на вопросы, представленные в мастере начала работы, либо, если мастер пропущен, автоматически заполняются средством планирования. 
...
- **Сохраняемый чат**
    ...
    Сохраняемая беседа позволяет нескольким пользователям участвовать в беседах, в которых они могут размещать и получать доступ к содержимому по определенным темам, включая текст, ссылки и файлы. Хотя пользователи в течение сеанса могут взаимодействовать в режиме реального времени, контент каждого сеанса является постоянным, и доступен после окончания сеанса.
 ...
 **Голосовая** голосовая почта содержит следующие параметры:
...
- **Аварийное восстановление**
    ...
    Меры аварийного восстановления позволяют соедать пулы переднего входа, расположенные в двух центрах обработки данных.
...
- **IPv4**
    ...
    Адреса IPv4 — 32-разрядные адреса, которые позволяют компьютеру осуществлять взаимодействие через Интернет. Из-за роста числа устройств по всему миру доступные IPv4-адреса стали недоступны. По этой причине многие новые устройства переходят на использование IPv6-адресов.
