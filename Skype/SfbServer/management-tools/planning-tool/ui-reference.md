...
---
# <a name="planning-tool-ui-reference"></a>Справочник по пользовательскому интерфейсу планировщика
 
## <a name="in-this-section"></a>Содержание

В этих разделах документа интерфейс для средства планирования доступны из [Центра загрузки Майкрософт](https://go.microsoft.com/fwlink/p/?LinkID=282725). 
