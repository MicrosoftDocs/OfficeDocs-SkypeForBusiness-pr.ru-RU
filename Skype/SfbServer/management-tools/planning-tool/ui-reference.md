...
ms.locfileid: "34288959"
---
# <a name="planning-tool-ui-reference"></a>Справочник по пользовательскому интерфейсу планировщика
 
## <a name="in-this-section"></a>Содержание

В этих разделах описывается интерфейс средства планирования, доступного в [центре загрузки Майкрософт](https://go.microsoft.com/fwlink/p/?LinkID=282725). 
