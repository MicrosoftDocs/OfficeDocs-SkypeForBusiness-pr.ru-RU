...
ms.locfileid: "41707334"
---
# <a name="web-conferencing-planning-tool"></a>Web Conferencing (Planning Tool)
 
Веб-конференции в Skype для бизнеса Server 2015 включают в себя совместную работу с документами, общий доступ к приложениям и демонстрацию рабочего стола.
