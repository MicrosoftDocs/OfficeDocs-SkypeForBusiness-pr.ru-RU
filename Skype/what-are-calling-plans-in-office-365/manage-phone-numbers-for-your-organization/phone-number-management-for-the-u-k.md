...
- Calling Plans
- Strat_SB_PSTN
description: "В этой таблице представлены сведения о получении и использовании номеров телефонов Skype для бизнеса Online в Соединенном Королевстве."
...
В этой таблице представлены сведения о получении и использованиив Соединенном Королевстве номеров телефонов Skype для бизнеса  Online и управлении имив Соединенном Королевстве. 
...
|:-----|:-----|
|Необходимо получить номера пользователей, которые не перечислены в цЦентре администрирования Skype для бизнеса.  <br/> |Скачайте форму [Запрос на получение новых номеров телефонов для Соединенного Королевства, географические номера, версия 3.0 на английском (США)](../../downloads/new-number-request-forms/new-phone-number-request-for-the-u.k.-(geographic-numbers)-(v.3.0)-(en.us).pdf), заполните ее и [отправьте нам](mailto:ptneu@microsoft.com).  <br/> |
|Необходимо получить номера телефонов, переданные нам.  <br/> |Скачайте одну из следующих форм: <br/> [Доверенность для Соединенного Королевства, географические номера, версия 2.0 на английском (США)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-the-u.k.-(geographic-numbers)-(v.2.0)-(en.us).pdf) <br/> [Доверенность для Соединенного Королевства, негеографические номера, версия 2.1 на английском (США)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-the-u.k.-(non-geographic-numbers)-(v.2.1)-(en.us).pdf) <br/>  Заполните ее и [отправьте его нам](mailto:ptneu@microsoft.com).  <br/> |
