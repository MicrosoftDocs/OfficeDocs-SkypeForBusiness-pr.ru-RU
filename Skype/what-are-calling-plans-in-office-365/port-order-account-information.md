...
- Название компании
    ...
    > [!NOTE]
    > Это принимает только 25 символов, включая пробелы. Если имя компании не более 25 символов, будет отправлена первые 25 символов имени и номеру порта по-прежнему будут обрабатываться. 
  
- Имя уполномоченного представителя (доверителя)
    
    > [!NOTE]
    > Это принимает только 15 символов, включая пробелы. Если имя авторизованного пользователя содержит более 15 символов, будет отправлена первых 15 символов имени и номеру порта по-прежнему будут обрабатываться. 
