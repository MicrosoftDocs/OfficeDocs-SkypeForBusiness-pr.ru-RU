...
- Назначение лицензии **Аудиоконференции** для пользователя перед запуском `Move-CSUser` используется для миграции пользователя. Это так, как MMS также обновляет собрания при изменении параметров звука конференц-связи для пользователя. Если вы не назначить лицензию, всех собраний MMS будут обновлены еще раз при назначении лицензии.
