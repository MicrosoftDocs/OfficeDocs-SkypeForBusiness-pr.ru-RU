...
После удаления сервера мониторинга можно удалить базы данных SQL Server, в которых размещены данные сервера. Используйте следующие процедуры для удаления определений из построителя топологий, а затем удалите базу данных и файлы журналов с сервера базы данных.
...
3. Введите в командной строке следующую команду:
   ...
   ```
    ...
    Здесь _\<FQDN\>_ — полное доменное имя сервера базы данных, а _\<instance\>_ также необязательный именованный экземпляр базы данных. 
