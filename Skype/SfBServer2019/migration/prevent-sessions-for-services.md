...
Вы можете использовать устаревшую панель управления для предотвращения новых сеансов для всех устаревших служб, запущенных на определенном компьютере, или для предотвращения новых сеансов для определенной устаревшей службы.
  
## <a name="to-prevent-new-sessions-for-services-on-a-computer"></a>Предотвращение новых сеансов для служб на компьютере

1. С помощью учетной записи пользователя, которая является членом группы RTCUniversalServerAdmins (или имеет эквивалентные права пользователя) или назначенной роли CsServerAdministrator или CsAdministrator, войдите на любой компьютер, на котором развернут Skype для бизнеса Server 2019.
...
1. Из учетной записи пользователя, которая является членом группы RTCUniversalServerAdmins (или имеет эквивалентные права пользователя) или которой назначена роль CsServerAdministrator или CsAdministrator, войдите на любой компьютер в сети, в которой развернут Skype для бизнеса Server 2019.
