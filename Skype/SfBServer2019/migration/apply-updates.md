...
ms.locfileid: "30894686"
---
# <a name="apply-updates"></a>Применение обновлений

Перед миграцией обновления должны применяться к вашей среде. Для получения последних сведений см **Скайп Business для загрузки и обновления** в [https://go.microsoft.com/fwlink/p/?linkid=232630](https://go.microsoft.com/fwlink/p/?linkid=232630).
