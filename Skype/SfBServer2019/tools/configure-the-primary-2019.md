...
Чтобы в полной мере воспользоваться новыми возможностями мониторинга состояния, включенными в Skype для бизнеса Server 2019, необходимо сначала назначить компьютер для работы в качестве основного сервера управления. Затем на этом компьютере необходимо установить System Center Operations Manager 2012 с sp1 или R2 или System Center Operations Manager 2007 R2. Кроме того, сначала необходимо установить поддерживаемую версию SQL Server, чтобы она функционировала как тыловая база данных Operations Manager.
...
1. Скачайте SkypeForBusiness2019ManagementPacks.msi веб-загрузки Майкрософт и установите MSI.
