...
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="fa99b-103">Сценарий проверки подлинности панели управления Skype для бизнеса Server 2019</span><span class="sxs-lookup"><span data-stu-id="fa99b-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="fa99b-104">Ниже приводится скрипты помощника по проверке подлинности для современной панели управления администратором (MACP).</span><span class="sxs-lookup"><span data-stu-id="fa99b-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="fa99b-105">Настройка проверки подлинности MACP с помощью Microsoft 365 или Office 365</span><span class="sxs-lookup"><span data-stu-id="fa99b-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="fa99b-106">Этот сценарий следует запустить после установки Накопительного обновления Skype для бизнеса Server 2019 1 или более поздней версии в рамках установки для новой панели управления.</span><span class="sxs-lookup"><span data-stu-id="fa99b-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="fa99b-107">Настройка приложения MACP в ферме ADFS</span><span class="sxs-lookup"><span data-stu-id="fa99b-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="fa99b-108">Этот скрипт следует запустить после установки Skype для бизнес-сервера 2019 последнего накопительного обновления в рамках установки для новой панели управления.</span><span class="sxs-lookup"><span data-stu-id="fa99b-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="fa99b-109">Настройка OAuth для MACP</span><span class="sxs-lookup"><span data-stu-id="fa99b-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="fa99b-110">Этот скрипт следует запустить после установки Skype для бизнес-сервера 2019 последнего накопительного обновления в рамках установки для новой панели управления.</span><span class="sxs-lookup"><span data-stu-id="fa99b-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
