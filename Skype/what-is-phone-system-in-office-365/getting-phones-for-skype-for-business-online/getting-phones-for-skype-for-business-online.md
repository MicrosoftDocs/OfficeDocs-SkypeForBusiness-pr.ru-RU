...
# Телефоны, поддерживаемые в Skype для бизнеса Online
...
Последние обновления и актуальные сведения о поддерживаемых устройствах см. в статье [Каталог устройств Skype для бизнеса](http://partnersolutions.skypeforbusiness.com/solutionscatalog).
...
При заказе новых телефонов для работы со Skype для бизнеса важно проверить  *код продукта*  . Выбирая телефоны с нужным кодом, вы получаете устройства с заранее установленной соответствующей версией Skype для бизнеса Online.
...
Дополнительные сведения о телефонах Polycom см. в разделе [Решения голосовой связи для Майкрософт](http://www.polycom.com/voice-conferencing-solutions/microsoft-phones.mdl).
  
Дополнительные сведения о телефонах Yealink см. в разделе [IP-телефоны для Skype для бизнеса](http://www.yealink.com/solution_7.mdl)
  
Дополнительные сведения о телефонах AudioCodes см. в разделе [IP-телефоны для Skype для бизнеса](http://www.audiocodes.com/products/skype-for-business-compatible-ip-phone).
...
## Функциональные возможности подключенных телефонов для Skype для бизнеса Online
...
|Вход через веб-интерфейс  <br/> > [!NOTE]> Проверьте таблицу сведений о поддержке в руководстве по развертыванию.           |Да  <br/> |Да  <br/> |Да  <br/> |Нет  <br/> |
...
|Загрузка журнала  <br/> > [!NOTE]> На данный момент все журналы загружаются только для службы поддержки Майкрософт. Доступ клиента к журналам телефона пока не реализован.           |Да  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |
...
|Интеграция с календарем Exchange *  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |Да  <br/> > [!NOTE]> Требуется привязка компьютера           |
