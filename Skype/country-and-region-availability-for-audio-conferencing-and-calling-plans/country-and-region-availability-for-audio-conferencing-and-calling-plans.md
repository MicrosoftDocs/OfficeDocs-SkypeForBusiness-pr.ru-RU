...
Наряду с телефонной системой планы звонков позволяют пользователям совершать и принимать телефонные звонки. Сначала необходимо получить номер телефона пользователя (подписчика), но не номер службы, чтобы назначить его пользователю, а затем можно назначить план звонков. Доступны два типа планов звонков. **Внутренний** и **Внутренний и международный**. Для получения дополнительных сведений см. статью [Что такое планы звонков?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md)
