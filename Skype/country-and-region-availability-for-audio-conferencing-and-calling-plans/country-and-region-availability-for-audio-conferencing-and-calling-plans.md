...
Можно выбрать страну или регион, чтобы узнать о доступности для них аудиоконференций, телефонной системы, планов звонков и кредитов на связь.

> [!Note]
> Если вам необходимы данные обо всех странах и регионах, скачайте и сохраните [электронную таблицу по всем странам и регионам](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Skype/downloads/country-region-availabilty/country-and-region-availability-(v.01242018)-(en.us).xlsx?raw=true).

## <a name="select-your-country-or-region-to-see-whats-available-for-you"></a>Выберите страну или регион, чтобы просмотреть доступные для них возможности.
...
## <a name="want-to-learn-more-about-these-services"></a>Необходима подробная информация об этих службах?


### <a name="audio-conferencing"></a>Аудиоконференции

В некоторых случаях пользователям в организации требуется телефон, чтобы присоединиться к собранию. Специально для таких ситуаций в Skype для бизнеса и Microsoft Team предусмотрена функция аудиоконференции. Пользователи могут присоединиться к собранию с помощью телефона, а не через приложения Skype для бизнеса и Microsoft Teams на мобильном устройстве или ПК. Решив применять аудиоконференцию в своей организации, вам следует приобрести одну лицензию **аудиоконференций** для каждого сотрудника, который должен иметь возможность планировать и проводить аудиособрание.
...
Дополнительные сведения об аудиоконференциях см. в статье [Audio Conferencing common questions (Общие вопросы по аудиоконференциям)](../audio-conferencing-in-office-365/audio-conferencing-common-questions.md)
...
Помимо номеров телефонов для отдельных пользователей в Office 365 можно также найти и получить платные или бесплатные номера телефонов для таких служб, как аудиоконференции (для мостов конференций), автосекретари или очереди звонков. Такие номера называют номерами служб. Для получения номеров телефонов см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md). Своим пользователям после назначения плана звонков можно назначить номера телефонов, чтобы они могли совершать и принимать телефонные звонки. Эти номера телефонов можно найти [здесь](../what-are-calling-plans-in-office-365/getting-phone-numbers-for-your-users.md). См. также статью [Назначение, изменение или удаление номера телефона пользователя](../what-are-calling-plans-in-office-365/assign-change-or-remove-a-phone-number-for-a-user.md). 
...
Наряду с телефонной системой планы звонков позволяют пользователям совершать и принимать телефонные звонки. Сначала необходимо получить номер телефона пользователя (подписчика), но не номер службы, чтобы назначить его пользователю, а затем можно назначить план звонков. Доступны два типа планов звонков: **внутренние звонки** и **внутренние и международные звонки**. Для получения дополнительных сведений см. статью [Что такое планы звонков?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md)

Для получения сведений о лицензировании см. также статью [Phone System and Calling Plans licensing (Лицензирование телефонной системы и планов звонков)](../skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing.md).
...
Помимо номеров телефонов для отдельных пользователей в Office 365 можно также найти и получить платные или бесплатные номера телефонов для таких служб, как аудиоконференции (для мостов конференций), автосекретари или очереди звонков. Такие номера называют номерами служб.
...
Если необходимо получить платные и бесплатные номера служб, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md). Если у вас уже есть платные и бесплатные номера служб и вам необходимо передать их от другого поставщика, см. статью [Manage phone numbers for your organization (Управление номерами телефонов организации)](../what-are-calling-plans-in-office-365/manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md).
...
Если не настроить кредиты на связь и не назначить своим пользователям лицензию, то, когда у организации закончатся оплаченные минуты (количество которых зависит от плана звонков и плана аудиоконференции в конкретной стране или регионе), пользователи не смогут совершать звонки или присоединяться обратным звонком к собранию. Дополнительную информацию о рекомендуемых суммах оплаты см. в статье [Что такое кредиты на связь?](../skype-for-business-and-microsoft-teams-add-on-licensing/what-are-communications-credits.md)
