...
При регистрации, вы получаете определенное количество минут, в зависимости от страны или региона. Можно просмотреть число минут, вы получите поиска для страны или региона [здесь]. (.. / country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)). После использования этих минут звонки будут отключены. Чтобы предотвратить это, необходимо настроить связь кредитов.
...
При настройке кредитов Communications необходимо получение сведений об использовании звонка для вашей организации, чтобы определить суммы, которые требуется поместить в. Вы можете получать сведения об использовании звонок, просмотрев отчет **сведений об использовании PSTN** . В этом отчете позволяет экспортировать записи данных о вызовах в Excel, чтобы экспортировать данные для хранения или создания настраиваемых отчетов. Об использовании см [Скайп для отчета об использовании PSTN бизнеса](../skype-for-business-online-reporting/pstn-usage-report.md)
...
4. На странице **лицензий на продукт** включения и отключения ** кредитов ** коммуникаций **на** для данной лицензии и нажмите кнопку **Сохранить**.
