...
В таблице показаны разбивкой всех пользователей, которые будут блокироваться выполнение вызовов. Это показывает все пользователи с телефонной системой или звук конференц-связи, назначенные им. Вы можете Добавление и удаление столбцов в таблице.
***
...
Это экспортирует данные из всех пользователей, а также позволяет выполнять простой сортировки и фильтрации для анализа. Если у вас не более 2000 пользователей, сортировки и фильтрации в таблице в самом отчете. При наличии более 2000 пользователей в порядке для фильтрации и сортировки необходимо экспортировать данные.
***
