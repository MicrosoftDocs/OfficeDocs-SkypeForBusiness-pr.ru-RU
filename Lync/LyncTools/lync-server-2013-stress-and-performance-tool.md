...
3.  [Установка](setup.md)

4.  [Настройка сценариев Lync Server 2013](configure-lync-server-2013-scenarios.md)

5.  [Создание пользователей и контактов](create-users-and-contacts.md)

6.  [Настройка профиля пользователя](configure-user-profile.md)

7.  [Запуск Линкперфтул](run-lyncperftool.md)
