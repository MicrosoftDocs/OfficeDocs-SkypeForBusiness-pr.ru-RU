...
![Средство абсконфиг. exe.] (images/JJ945604.6fb63a70-7b63-4b8b-b7d1-82fe9aa2028f(OCS.15).jpg "Средство абсконфиг. exe.")
...
2.  **Дата окончания**. Это конечная дата временной шкалы, для которой нужно создать отчет, например 30 сентября 2010 г.
    ...
    ![Даты начала и окончания в использовании пропускной способности] (images/JJ945604.2c597cfc-3372-4d41-816b-26202f607ad8(OCS.15).jpg "Даты начала и окончания в использовании пропускной способности")  
...
![Каталоги файлов в анал использования пропускной способности] (images/JJ945604.d66daeac-1669-45e3-932d-3f6782840c2a(OCS.15).jpg "Каталоги файлов в анал использования пропускной способности")
...
![Сбор данных в анали использования пропускной способности] (images/JJ945604.0019cb2c-7c01-4dc9-ac90-ac47c47d1bfd(OCS.15).jpg "Сбор данных в анали использования пропускной способности")

Если проверка входных данных прошла успешно, выводится показанное ниже сообщение.

![Регистрация собранных уведомлений в утили пропускной способности] (images/JJ945604.eda91da8-3285-4eab-8ccb-c6d89c8cc221(OCS.15).jpg "Регистрация собранных уведомлений в утили пропускной способности")
...
1.  Когда таблица BandwidthUtilizationAnalyzer.xlsm автоматически откроется, нажмите кнопку **Refresh** (Обновить), как показано ниже.
    ...
    ![Бандвидсутилизатионанализер. xlsm] (images/JJ945604.c4e675b9-1671-400e-a712-6db82d731b39(OCS.15).jpg "Бандвидсутилизатионанализер. xlsm")
...
2.  Когда откроется папка с файлами, выберите файл consolidated.csv в папке, указанной в окне сообщения, как показано ниже. Оно также показывает место в формате **C:\\Temp**.
    ...
    ![Открытие папки в бандвидсутилизатионанализер.] (images/JJ945604.601cc572-cee9-45fb-9ed1-c4b96a2fa21e(OCS.15).jpg "Открытие папки в бандвидсутилизатионанализер.")
...
![Фильтрация по имени в бандвидсутилизатионанализер.] (images/JJ945604.002b7c8e-f0da-48ce-9e1a-5c34d2cab063(OCS.15).jpg "Фильтрация по имени в бандвидсутилизатионанализер.")

Примените фильтр **Exceeded limit**. Установите флажок **True**, чтобы применить фильтр.

![Фильтрация по превышению предела.] (images/JJ945604.5946c95e-76ce-46ca-8f3e-a79be1e5c527(OCS.15).jpg "Фильтрация по превышению предела.")
...
![Фильтрация по] заданному принципу. (images/JJ945604.95a2bf01-5aba-4927-af47-1ad3c459d791(OCS.15).jpg "Фильтрация по") заданному принципу.

Примените фильтр **Link Type**. Выберите один или несколько типов каналов, которые нужно показать.

![Фильтрация по типу связи.] (images/JJ945604.08757949-06bd-4cf3-809f-d81fd23a6639(OCS.15).jpg "Фильтрация по типу связи.")
...
![Диапазоны на орбите в вызове паркометер.] (images/JJ945604.9ede64cb-29d9-4782-a34b-b76c42fbdcad(OCS.15).jpg "Диапазоны на орбите в вызове паркометер.")
...
![В настоящее время звонки в Паркометер вызываются в звонках.] (images/JJ945604.07a7eec4-7999-4c92-93f0-95525b244b4c(OCS.15).jpg "В настоящее время звонки в Паркометер вызываются в звонках.")

Число свободных орбит: параметр –f выводит текущее число свободных орбит в пуле, как показано ниже.

![Бесплатные орбиты в вызове паркометер.] (images/JJ945604.ecc1d621-0ca0-4ecf-a579-08b41c6f08ed(OCS.15).jpg "Бесплатные орбиты в вызове паркометер.")

Недавно припаркованные звонки: в параметре \<–\> r n указаны \<n\> -е последние звонки, как показано ниже.

![Недавно припаркованные звонки в вызове паркометер.] (images/JJ945604.1c5eb27d-faa1-491b-b4aa-b484255c3353(OCS.15).jpg "Недавно припаркованные звонки в вызове паркометер.")

Проверка резервирования на орбите: параметр \<–\> t n проверяет, как показано на странице базы данных.

![Проверка резервирования на орбите в вызове паркометер.] (images/JJ945604.84c9b69e-7af0-4224-8711-a43a28f08691(OCS.15).jpg "Проверка резервирования на орбите в вызове паркометер.")
...
Дбанализе — это средство командной строки, позволяющее администраторам собирать отчеты анализа о базах данных Lync Server 2013. Средство DBAnalyze имеет следующие режимы: диагностика, пользовательские данные, конференция, узлы MCU и фрагментация дисков.
  ...
  - **Режим конференций с**   подробными данными о конкретной конференции, включая сведения о времени расписания для Конференции, список "пригласить", список типов мультимедиа, разрешенных для Конференции, активный мкус (единицы управления MultiPoint), активный Список участников и состояние сигналов каждого участника.
...
![Параметры командной строки для дбанализе. exe.] (images/JJ945604.22bf3432-af6d-495b-8f48-d94c5d259523(OCS.15).jpg "Параметры командной строки для дбанализе. exe.")
...
![Таблица разрешений для дбанализе. exe.] (images/JJ945604.b8931e9e-834e-4dec-8a84-2fc47d1613e9(OCS.15).jpg "Таблица разрешений для дбанализе. exe.")
...
![Пример событий в журнале событий сервера хранилища.] (images/JJ945604.3a903ef7-ea8a-4606-8229-a3e32f13af3a(OCS.15).jpg "Пример событий в журнале событий сервера хранилища.")
...
Средство Мстурнпинг позволяет администратору коммуникационного программного обеспечения Microsoft Lync Server 2013 проверять состояние серверов, на которых работают службы голосовой и видеосвязи, а также серверы, на которых работает политика пропускной способности. Службы в топологии.

<div>

## <a name="description"></a>Описание

Средство Мстурнпинг позволяет администратору коммуникационного программного обеспечения Lync Server 2013 проверять состояние серверов, использующих голосовые и видеозвонки, службы проверки подлинности аудио-и видеосвязи, а также серверы, на которых работают службы политики пропускной способности. Topology.
...
![Открытие файла журнала политики пропускной способности сервера.] (images/JJ945604.3e503e92-aacb-4921-a8d2-23f860fe2df6(OCS.15).jpg "Открытие файла журнала политики пропускной способности сервера.")
...
Сохранение и сохранение схемы топологии сети CAC в формате JPG или BMP: Lync Server 2013 администраторы могут сохранять конфигурацию топологии сети CAC в графическом формате (форматы файлов JPG и BMP) с помощью команды " **сохранить схему настройки сети как рисунок** ". параметр, как показано ниже.

![Сохранение конфигурации сети в виде изображения.] (images/JJ945604.145a6fb9-58b1-46b1-bbd5-a661ceba07b4(OCS.15).jpg "Сохранение конфигурации сети в виде изображения.")
...
![Просмотр данных конфигурации сети в представлении в виде дерева.] (images/JJ945604.4d924ac9-fd96-430f-b211-ee35b7ef9a23(OCS.15).jpg "Просмотр данных конфигурации сети в представлении в виде дерева.")
...
![Средство агента группы ответа в реальном времени.] (images/JJ945604.63cb0374-a6ef-4a59-b60e-bec86a880d09(OCS.15).jpg "Средство агента группы ответа в реальном времени.")
...
![Диалоговое окно "Параметры" агента группы ответа "живые".] (images/JJ945604.3cc15e29-8699-45ab-90c3-e1565fa6ebf6(OCS.15).jpg "Диалоговое окно \"Параметры\" агента группы ответа \"живые\".")
...
![Совершение звонков и отправка мгновенных сообщений.] (images/JJ945604.009cebe0-5a93-4745-89c3-8a16c7c13009(OCS.15).jpg "Совершение звонков и отправка мгновенных сообщений.")
...
Сценарий переноса оповещений о неназначенных номерах можно использовать в следующих трех сценариях.
  ...
  - **Перенос параметров конфигурации в новую версию Lync Server.** Компания Contoso находится в процессе перехода на Lync Server 2013 и в процессе миграции администратор сервера Lync Server хотел бы переместить неназначенные номера, настроенные приложением из развертывания Lync Server 2010 на новое развертывание Lync Server 2013. Для перемещения параметров конфигурации администратор сервера Lync использует средство миграции "неназначенные номера объявлений".
...
![Параметры перемещения и ксаннаунцементконфигуратион.] (images/JJ945604.7ab66ad3-d0db-4d77-8b93-ebccf0cb0663(OCS.15).jpg "Параметры перемещения и ксаннаунцементконфигуратион.")
...
![Параметры средства для данных Web CONF.] (images/JJ945604.a733c1c6-5dfc-4874-a74f-bfdee81c1401(OCS.15).jpg "Параметры средства для данных Web CONF.")
