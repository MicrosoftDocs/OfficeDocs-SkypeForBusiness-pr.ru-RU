...
С помощью средства нагрузки и производительности Lync Server 2013 (называемого также Линкперфтул) можно смоделировать нагрузку на следующие типы:
...
<td><p>Средство "стресс и производительность" Lync Server 2013. Линкперфтул — это инструмент, который имитирует пользовательскую нагрузку.</p></td>
</tr>
<tr class="even">
<td><p>Default. тмкс</p></td>
<td><p>Значение Default. тмкс является обязательным для использования средства ведения журнала в Lync Server 2013.</p></td>
</tr>
<tr class="odd">
