...
Вы развертываете типы IP-адресов с помощью параметров топологии, которые вы настроили в построителе топологий. В этом разделе описывается, как развертывать типы IP-адресов на серверах переднего плана, серверах-посредниках и пограничных серверах.
