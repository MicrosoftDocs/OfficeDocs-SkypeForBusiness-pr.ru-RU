...
# <a name="components-and-topologies-for-cac-in-lync-server-2013"></a>Компоненты и топологии для CAC в Lync Server 2013
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Контроль допуска звонков на магистральной линии SIP в Lync Server 2013](lync-server-2013-call-admission-control-on-a-sip-trunk.md)

  - [Контроль допуска звонков в Lync Server 2013 со сторонним шлюзом PSTN или УАТС](lync-server-2013-call-admission-control-with-a-third-party-pstn-gateway-or-pbx.md)
