...
Lync Server включает веб-службу обновления устройств, которая автоматически устанавливается в составе роли веб-служб. Эта служба позволяет скачивать обновления от Майкрософт, тестировать их, а затем развертывать обновления на IP-телефонах в Организации. Вы также можете использовать веб-службу обновления устройств для отката устройств к предыдущим версиям программного обеспечения.
