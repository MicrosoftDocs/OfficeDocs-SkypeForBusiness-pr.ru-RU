...
<span data-ttu-id="63c89-124">Или, чтобы помочь точно определить, о чем мы говорим:</span><span class="sxs-lookup"><span data-stu-id="63c89-124">Or, to help you pinpoint exactly what we are talking about:</span></span>
