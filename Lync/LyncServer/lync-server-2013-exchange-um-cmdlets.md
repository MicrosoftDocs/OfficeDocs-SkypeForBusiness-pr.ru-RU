...
# <a name="exchange-um-cmdlets-in-lync-server-2013"></a>Командлеты единой системы обмена сообщениями Exchange в Lync Server 2013
...
Microsoft Lync Server 2013 работает вместе с единой системой обмена сообщениями Exchange для реализации автосекретаря и абонентского доступа для размещенной голосовой почты. Управление этими возможностями осуществляется с помощью командлетов в командной консоли Lync Server.

<div>

## <a name="exchange-um-cmdlets"></a>Командлеты единой системы обмена сообщениями Exchange

Для управления единой системой обмена сообщениями Exchange можно использовать следующие командлеты.
