...
7.  Выберите один из следующих вариантов.
      ...
      - **Всегда обходить**     Выберите этот параметр, чтобы попытаться обходить мультимедиа по всем вызовам. Этот параметр будет недоступен, если включен контроль допуска звонков (CAC). Если параметр CAC не включен, выберите этот параметр в следующих ситуациях:
