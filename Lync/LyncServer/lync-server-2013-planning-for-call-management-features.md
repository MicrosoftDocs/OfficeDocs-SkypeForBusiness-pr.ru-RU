...
Функции управления вызовами в корпоративной голосовой связи управляют тем, каким образом происходит маршрутизация входящих вызовов и ответ на них. Lync Server 2013 предоставляет следующие функции управления звонками:
  ...
  - **Подбор групп**: позволяет пользователям голосовых вызовов получать звонки, которые обзвонают для других пользователей голосовой связи, назначенных группам ответа на звонки.
    
    <div>
    

    > [!NOTE]  
    > Подбор групп — это новая поддержка накопительных обновлений для Lync Server 2013:2013 февраля.
