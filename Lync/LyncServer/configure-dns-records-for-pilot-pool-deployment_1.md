...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ688072(v=OCS.15)
ms:contentKeyID: 49888011
ms.date: 05/19/2016
...
Prior to deploying the Lync Server 2013 pilot pool, you must update the DNS Host A entries for the pilot pool. Для успешного завершения этой процедуры необходимо выполнить вход на сервер или домен, по меньшей мере, в качестве участника группы администраторов домена или группы DnsAdmins.
