...
Сведения о том, как настроить компьютер на использование Windows PowerShell для управления с помощью Lync Online, можно найти в разделе справки, [использующем Windows PowerShell, для управления Lync Online](https://technet.microsoft.com/en-us/library/Dn362831(v=OCS.15)).
