...
---
# <a name="system-requirements-for-external-user-access-components-for-lync-server-2013"></a>Требования к системе для компонентов доступа внешних пользователей для Lync Server 2013
...
_**Последнее изменение темы:** 2013-01-17_

Требования к системе для пограничных компонентов включают требования к оборудованию, программному обеспечению и размещению для пограничных серверов, обратным прокси-серверам и дополнительным директорам, которые вы планируете развернуть.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Требования к конфигурации для обратного прокси-сервера в Lync Server 2013](lync-server-2013-configuration-requirements-for-reverse-proxy.md)
