...
Развертывание пограничных компонентов для Microsoft Lync Server 2013 позволяет внешним пользователям, не вошедшим в внутреннюю сеть Организации, включая прошедшие проверку и анонимные удаленные пользователи, Федеративные партнеры (включая партнеров XMPP), мобильные клиенты и пользователей общедоступных служб обмена мгновенными сообщениями для общения с другими пользователями в Организации с помощью Lync Server. Процессы развертывания и настройки для Lync Server 2013 значительно отличаются от Lync Server 2010. Средства для установки и администрирования практически не отличаются от установки Lync Server 2010.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Руководство по подготовке к Lync-Skype подключениям в Lync Server 2013](lync-server-2013-provisioning-guide-for-lync-skype-connectivity.md)
