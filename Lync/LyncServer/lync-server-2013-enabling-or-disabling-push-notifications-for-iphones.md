...
## <a name="to-enable-push-notifications-for-iphone"></a>Включение push-уведомлений для iPhone
  ...
  - Чтобы включить push-уведомления для iPhone, задайте для свойства Енаблеапплепушнотификатионсервице значение true ($True). Пример:
...
## <a name="to-disable-push-notifications-for-iphone"></a>Отключение push-уведомлений для iPhone
  ...
  - Чтобы отключить push-уведомления для iPhone, присвойте свойству Енаблеапплепушнотификатионсервице значение false ($False). Пример:
