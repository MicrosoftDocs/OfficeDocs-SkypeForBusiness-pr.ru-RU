...
Доступ к параметрам можно получить в GPedit.dll, доступном в консоли "пользователи и компьютеры Active Directory" и в консоли управления групповыми политиками.
