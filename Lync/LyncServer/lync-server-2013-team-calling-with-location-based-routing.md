...
# <a name="team-calling-with-location-based-routing-in-lync-server-2013"></a>Групповые звонки с маршрутизацией на основе расположения в Lync Server 2013
...
Lync Server 2013 поддерживает вызов групп с маршрутизацией на основе местоположения.
