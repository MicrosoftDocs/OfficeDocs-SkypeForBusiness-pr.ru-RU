...
Если у вас возникнут проблемы с сертификатом, вам может потребоваться просмотреть Алтернативенамес, настроенный для сертификата. На первый взгляд кажется, что проблема. По умолчанию в зависимости от размера окна консоли Get-CsCertificate могут не отображать все имена:
