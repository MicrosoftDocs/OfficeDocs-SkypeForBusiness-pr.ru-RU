...
Сведения о развертывании [клиентов и устройств в Lync Server 2013](lync-server-2013-deploying-clients-and-devices.md) содержатся в документации по развертыванию.
