...
# <a name="reviewing-the-summary-report-in-lync-server-2013"></a>Просмотр сводного отчета в Lync Server 2013
...
Отчет администратора Lync Server — это первый из четырех полезных отчетов, подробно задокументированных в проекте. Сведения в этом отчете и другие три связанных отчета — отличная документация для команд информационных технологий.
