...
Корпоративная голосовая связь поддерживает исходящие и входящие звонки через ТСОП без ущерба для качества обслуживания (QoS). Эти параметры можно настроить с помощью командлетов, доступных в командной консоли Lync Server.

<div>

## <a name="pstn-connectivity-cmdlets"></a>Командлеты для связи с ТСОП

Для настройки различных аспектов связи с ТСОП можно использовать следующие командлеты.

**[Командлеты шлюзов PSTN в Lync Server 2013](lync-server-2013-pstn-gateways-cmdlets.md)**
...
**[Командлеты настройки магистрали в Lync Server 2013](lync-server-2013-trunking-configuration-cmdlets.md)**
