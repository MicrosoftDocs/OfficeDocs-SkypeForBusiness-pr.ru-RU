...
В коммуникационном программном обеспечении Microsoft Lync Server 2013 можно запустить средство планирования Microsoft Lync Server 2013, не заставляя существующие и предложенные IP-адреса и полные доменные имена пограничных серверов, но это значительно затрудняется, не вызывая ошибок конфигурации. Например, если в течение определенного периода времени требуется сосуществование, то распространенной ошибкой является повторное использование FQDN из существующего пограничного развертывания для развертывания Lync Server 2013 Edge. Записав текущие и предлагаемые IP-адреса и полные доменные имена в электронную таблицу, обычную таблицу или другую визуальную форму, вы можете избежать ошибок во время установки.
