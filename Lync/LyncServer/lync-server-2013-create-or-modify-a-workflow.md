...
Lync Server 2013 поддерживает два типа рабочих процессов: Сервисная группа и интерактивный голосовой ответ (IVR). При создании рабочего процесса с помощью средства настройки группы ответа можно указать используемую очередь и другие параметры, такие как приветственное сообщение, музыка на удержании, рабочие часы и вопросы, которые приложение группы ответа запрашивает у вызывающего абонента.
