...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ688139(v=OCS.15)
ms:contentKeyID: 49888094
ms.date: 05/19/2016
...
В этом разделе описывается, каким образом можно обновить записи службы доменных имен (DNS) после выполнения миграции в Lync Server 2013. После завершения переноса всех пользователей в Lync Server 2013 (но до того, как устаревший пул Lync Server 2010 или Директор будет списан, необходимо обновить записи SRV службы DNS во внутренней DNS для каждого домена SIP. В этой процедуре подразумевается, что во внутренней DNS имеются зоны для доменов пользователей SIP.
