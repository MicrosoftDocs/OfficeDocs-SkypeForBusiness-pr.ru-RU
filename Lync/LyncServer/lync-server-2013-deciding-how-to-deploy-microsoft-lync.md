...
Развертывание с помощью локального сервера Lync Server наилучшим образом подходит для следующих сценариев:
  ...
  - **** Если у вас есть центры обработки данных в нескольких странах или регионах и вам нужны серверы для развертывания и управления на региональном уровне, лучше использовать локальное развертывание, так как это обеспечивает этот тип.    из региональных возможностей управления.
