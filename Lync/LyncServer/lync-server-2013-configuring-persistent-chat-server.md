...
---
# <a name="configuring-persistent-chat-server-in-lync-server-2013"></a>Настройка сервера сохраняемого чата в Lync Server 2013
...
_**Последнее изменение темы:** 2012-04-12_
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Настройка комнат в Lync Server 2013](lync-server-2013-configure-rooms.md)

  - [Настройка надстроек для комнат в Lync Server 2013](lync-server-2013-configure-add-ins-for-rooms.md)
