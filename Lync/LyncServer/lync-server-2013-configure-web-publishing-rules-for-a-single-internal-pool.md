...
1.  Привяжите сертификат, который будет использоваться для обратного прокси-сервера, к протоколу HTTPS. Нажмите кнопку **Пуск**, выберите пункт **программы**, **Администрирование**, а затем щелкните **Диспетчер служб IIS**.
    ...
    > [!NOTE]  
    > Дополнительная справка, снимки экрана и рекомендации по развертыванию и настройке службы IIS ARR можно найти в статье NextHop <A href="http://go.microsoft.com/fwlink/?linkid=293391">с использованием IIS arr в качестве обратного прокси-сервера для Lync Server 2013</A>.
