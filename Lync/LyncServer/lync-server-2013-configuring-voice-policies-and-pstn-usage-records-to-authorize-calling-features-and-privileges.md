...
# <a name="configuring-voice-policies-and-pstn-usage-records-to-authorize-calling-features-and-privileges-in-lync-server-2013"></a>Настройка политики голосовой связи и записей использования PSTN для авторизации функций звонков и привилегий в Lync Server 2013
...
> [!NOTE]  
> Подробнее о <A href="lync-server-2013-voice-policies.md">политиках голосовой связи в Lync Server 2013</A> можно найти в документации по планированию.
