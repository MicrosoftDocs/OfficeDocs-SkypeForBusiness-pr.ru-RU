...
---
# <a name="application-endpoints-cmdlets-in-lync-server-2013"></a>Командлеты конечных точек приложений в Lync Server 2013
...
Конечные точки приложений — это объекты контактов в доменных службах Active Directory. С помощью командлетов в командной консоли Lync Server вы можете управлять этими контактами для Microsoft Lync Server 2013.

<div>

## <a name="application-endpoints-cmdlets"></a>Командлеты для конечных точек приложений
