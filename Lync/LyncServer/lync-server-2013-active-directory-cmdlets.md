...
Командлеты Active Directory обычно используются программой установки и редко вызываются напрямую администратором. Однако администраторы могут использовать эти командлеты для подготовки (или отслеживания) домена или леса для Microsoft Lync Server 2013, а также для установки требуемых файлов схемы Active Directory.

<div>

## <a name="active-directory-cmdlets"></a>Командлеты Active Directory

Ниже приведен список командлетов, которые относятся непосредственно к управлению параметрами Active Directory Lync Server 2013:
