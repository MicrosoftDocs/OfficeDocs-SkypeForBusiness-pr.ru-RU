...
# <a name="linking-network-regions-in-lync-server-2013"></a>Связывание областей сети в Lync Server 2013
...
Вы можете настроить канал между двумя областями сети как часть контроля допуска звонков (CAC).

<div>

## <a name="in-this-section"></a>Содержание

  - [Просмотр сведений о связи между областями сети в Lync Server 2013](lync-server-2013-viewing-network-region-link-information.md)
