...
7.  В диалоговом окне **Ввод регулярных выражений** введите следующее.
    ...
    Например, если ввести ** ^ \\ + ( \\ d {9} \\ d +) $** в поле **сопоставить этот шаблон** и **011 $1** в **правиле преобразования**, то правило будет переводиться + 441235551010 на 011441235551010.
