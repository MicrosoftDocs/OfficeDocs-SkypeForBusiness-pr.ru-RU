...
На этом шаге вы можете выполнить поиск в указанном почтовом ящике (kenmyer) и/или включить In-Place хранения аналогично любому другому контенту или источнику результатов SharePoint.
