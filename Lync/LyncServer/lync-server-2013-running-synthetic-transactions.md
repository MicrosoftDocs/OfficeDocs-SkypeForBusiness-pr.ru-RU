...
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dn720911(v=OCS.15)
ms:contentKeyID: 62246660
ms.date: 05/19/2016
...
[Настройка тестовых пользователей узла-наблюдателя и параметров конфигурации](lync-server-2013-configuring-watcher-node-test-users-and-configuration-settings.md)  
[Специальные инструкции по установке для искусственных транзакций](lync-server-2013-special-setup-instructions-for-synthetic-transactions.md)
