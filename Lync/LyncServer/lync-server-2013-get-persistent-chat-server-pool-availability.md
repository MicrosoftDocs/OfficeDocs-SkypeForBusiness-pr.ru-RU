...
---
# <a name="get-persistent-chat-server-pool-availability-in-lync-server-2013"></a>Получение доступности пула сервера сохраняемого чата в Lync Server 2013
...
Получение доступности пула сервера сохраняемого чата
