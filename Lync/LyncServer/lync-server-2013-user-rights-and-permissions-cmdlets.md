...
---
# <a name="user-rights-and-permissions-cmdlets-in-lync-server-2013"></a>Командлеты прав и разрешений пользователей в Lync Server 2013
...
Командлеты разрешений пользователя в основном используются для управления доступом на основе ролей (RBAC), новой технологией для делегирования административного управления Microsoft Lync Server 2013.
