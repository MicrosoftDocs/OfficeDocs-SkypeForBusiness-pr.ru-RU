...
Голосовые приложения выполняются в службе приложений на сервере переднего плана. Эти приложения помогают управлять входящими и исходящими телефонными звонками, позволяя приостанавливать вызовы, работать с неназначенными числами, координировать их с помощью единой системы обмена сообщениями Exchange и запускать приложение группы ответа.

<div>

## <a name="voice-application-cmdlets"></a>Командлеты голосовых приложений

Ниже приведен список командлетов, которые относятся к голосовым приложениям:

**[Командлеты приложения парковки вызовов в Lync Server 2013](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Командлеты единой системы обмена сообщениями Exchange в Lync Server 2013](lync-server-2013-exchange-um-cmdlets.md)**
...
<!-- end list -->
  ...
  - <span></span>  
    [New — Ксргскуестион](https://technet.microsoft.com/library/Gg398186(v=OCS.15))
...
**[Командлеты неназначенных номеров в Lync Server 2013](lync-server-2013-unassigned-number-cmdlets.md)**
