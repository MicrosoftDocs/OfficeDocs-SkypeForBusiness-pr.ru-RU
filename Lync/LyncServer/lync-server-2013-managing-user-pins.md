...
# <a name="managing-user-pins-in-lync-server-2013"></a>Управление контактами пользователей в Lync Server 2013
...
Используйте описанные ниже процедуры для управления контактами конференц-связи с телефонным подключением пользователей из раздела " **Пользователи** " панели управления Lync Server 2013.
