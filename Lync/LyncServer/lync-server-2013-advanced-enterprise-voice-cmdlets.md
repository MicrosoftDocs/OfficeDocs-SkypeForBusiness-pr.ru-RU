...
В следующем списке представлены командлеты, которые позволяют управлять расширенными функциональными возможностями развертывания корпоративной голосовой связи:
