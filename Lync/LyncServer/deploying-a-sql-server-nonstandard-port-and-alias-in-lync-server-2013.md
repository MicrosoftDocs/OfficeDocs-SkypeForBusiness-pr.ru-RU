...
Важно поддерживать Lync Server 2013 в актуальном состоянии. Чтобы проверить наличие последних обновлений и сведения о том, как их применять, ознакомьтесь с [Разобновлением для Lync Server 2013](http://support.microsoft.com/kb/2809243).
...
2.  В области навигации щелкните, чтобы развернуть **экземпляр SQL Server**, затем разверните узел **Сетевая конфигурация SQL**Server и выберите **протоколы для \<имени\>экземпляра**, как показано на следующем рисунке.
...
9.  Перезапустите экземпляр SQL Server, выбрав **службы SQL Server** на левой панели диспетчера КОНФИГУРАЦИй SQL Server. Затем щелкните правой кнопкой мыши **имя \<\> экземпляра SQL Server** на правой панели и выберите **перезапустить**, как показано на следующем рисунке.
...
2.  В левой области выберите пункт **экземпляр SQL Server**, затем разверните узел SQL Server ** \<Native Client\> Configuration**, а затем выберите **псевдонимы**, как показано на следующем рисунке.
