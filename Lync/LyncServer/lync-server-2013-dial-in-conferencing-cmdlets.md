...
# <a name="dial-in-conferencing-cmdlets-in-lync-server-2013"></a>Командлеты конференц-связи с телефонным подключением в Lync Server 2013
...
Конференц-связь с телефонным подключением — это способ присоединиться к звуковой части конференции с помощью обычного телефонного телефона (то есть устройства в телефонной сети, подключенного к общественной коммутируемой связи).

<div>

## <a name="dial-in-conferencing-cmdlets"></a>Командлеты конференц-связи с телефонным подключением

Если вы не хотите разрешать Конференц-связь с телефонным подключением, вы можете отключить эту возможность с помощью командлета Set-КсконференЦингполици и задать для свойства ЕнабледиалинконференЦинг значение false. По умолчанию всем пользователям разрешено размещать собрания, которые включают конференц-связь с телефонным подключением.
