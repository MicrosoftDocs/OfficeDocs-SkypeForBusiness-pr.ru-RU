...
Следующие клиенты могут использовать парковки вызовов для парковки вызовов:
...
> [!NOTE]  
> Мобильные телефоны не могут использовать парковки вызовов для парковки вызовов.
...
Следующие клиенты могут получать вызовы, приостановленные на парковки вызовов:
  ...
  - Телефоны, не поддерживающие IP, которые подключены к инфраструктуре Lync Server 2013, включая телефонные телефоны и УАТС.
