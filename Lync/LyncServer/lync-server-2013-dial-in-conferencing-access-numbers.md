...
---
# <a name="dial-in-conferencing-access-numbers-in-lync-server-2013"></a>Номера доступа к конференц-связи с телефонным подключением в Lync Server 2013
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Удаление номера доступа к конференц-связи с телефонным подключением в Lync Server 2013](lync-server-2013-delete-a-dial-in-conferencing-access-number.md)
