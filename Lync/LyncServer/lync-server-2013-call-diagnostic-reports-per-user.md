...
# <a name="call-diagnostic-reports-per-user-in-lync-server-2013"></a>Диагностические отчеты по вызовам (на пользователя) в Lync Server 2013
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Отчет об активности пользователей в Lync Server 2013](lync-server-2013-user-activity-report.md)   предоставляет сведения об одноранговых действиях и конференциях для каждого пользователя.
