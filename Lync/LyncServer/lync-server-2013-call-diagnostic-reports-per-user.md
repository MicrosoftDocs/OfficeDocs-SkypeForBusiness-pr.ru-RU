...
## <a name="in-this-section"></a>Содержание
  ...
  - [Отчет о действиях пользователей в Lync Server 2013](lync-server-2013-user-activity-report.md)   предоставляет сведения о одноранговых событиях и действиях конференций для каждого из пользователей.
