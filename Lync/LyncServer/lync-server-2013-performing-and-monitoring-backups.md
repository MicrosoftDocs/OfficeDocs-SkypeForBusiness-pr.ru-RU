...
Все резервные базы данных SQL Server 2012 должны быть резервными копиями в соответствии с рекомендациями [SQL](http://go.microsoft.com/fwlink/p/?linkid=290716).
