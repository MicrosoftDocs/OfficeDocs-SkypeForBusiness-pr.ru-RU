...
---
# <a name="public-instant-messaging-support-in-lync-server-2013"></a>Общедоступная поддержка обмена мгновенными сообщениями в Lync Server 2013
...
Lync Server 2013 поддерживает использование лицензированных поставщиков подключений общедоступной службы обмена мгновенными сообщениями, а также использование протокола XMPP для реализации специального типа Федерации, который позволяет серверу Lync получать доступ к настроенным партнерам домена XMPP с помощью клиента Lync 2013.

<div>

## <a name="public-im-connectivity-provider-support"></a>Поддержка поставщиком возможности подключения к общедоступным службам обмена мгновенными сообщениями
...
Для связи с пользователями Windows Live Lync Server 2013 поддерживает одноранговые обмен мгновенными сообщениями, а также вызовы аудио и видео. Для обмена данными с AOL и Yahoo \! Lync Server 2013 поддерживает одноранговые мгновенные сообщения. Может потребоваться отдельная лицензия.
