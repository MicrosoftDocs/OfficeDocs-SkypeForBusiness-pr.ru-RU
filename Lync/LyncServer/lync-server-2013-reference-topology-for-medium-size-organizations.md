...
![Топология ссылок для одной схемы центра обработки данных] (images/Gg425939.12b574fd-0b14-4563-a88c-3c8b0809bb90(OCS.15).jpg "Топология ссылок для одной схемы центра обработки данных")
