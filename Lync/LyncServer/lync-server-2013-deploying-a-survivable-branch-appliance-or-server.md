...
Для малых и средних сайтов филиалов (сайты филиалов с 25 до 1 000 пользователей) рекомендуется развернуть устройство для обеспечения связи в филиалах, которое будет завершать вызовы по телефонной сети общего пользования с помощью встроенного шлюза PSTN или магистрали SIP поставщику услуг телефонной связи. Устройство для обеспечения связи в филиалах — это стороннее устройство, включающее в себя блейд-сервер, на котором работает операционная система Windows Server 2008 R2, регистратор Lync Server 2013, программное обеспечение сервера-посредника и шлюз PSTN, все в корпусах с одним устройством.
