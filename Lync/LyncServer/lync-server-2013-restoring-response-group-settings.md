...
Если вы развернули приложение группы ответа и хотите восстановить фоновый сервер или сервер Standard Edition, также потребуется восстановить параметры конфигурации группы ответа.
