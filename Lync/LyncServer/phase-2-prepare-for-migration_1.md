...
_**Тема последнего изменения:** 2012-08-24_

Прежде чем приступить к переходу на Lync Server 2013 из Office Communications Server 2007 R2, выполните действия, описанные в этом разделе.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Выполнение анализатора соответствия рекомендациям](run-best-practices-analyzer_1.md)

  - [Резервное копирование систем и данных](back-up-systems-and-data_1.md)
