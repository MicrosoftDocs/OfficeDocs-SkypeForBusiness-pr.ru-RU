...
# <a name="verify-user-replication-has-completed"></a>Проверка того, что репликация пользователя завершена
...
6.  Во ** \<всех идентификаторах\> событий** введите **30024** , а затем нажмите кнопку **ОК**.
