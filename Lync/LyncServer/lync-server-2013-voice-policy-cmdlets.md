...
# <a name="voice-policy-cmdlets-in-lync-server-2013"></a>Командлеты политики голосовой связи в Lync Server 2013
...
## <a name="voice-policy-cmdlets"></a>Командлеты политик голосовой связи
