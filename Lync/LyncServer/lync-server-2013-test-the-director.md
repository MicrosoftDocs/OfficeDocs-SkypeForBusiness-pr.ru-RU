...
3.  В области навигации щелкните топология ****, а затем в столбце **состояние** подтвердите, что у вас есть зеленый сервер со стрелкой (то есть с зеленым значком сервера ![стрелок](images/Gg398767.2263cdb7-7e60-457a-a528-a3a082bd051b(OCS.15).jpg "с зеленой стрелкой")) для своего директора или режиссера.
...
5.  На одном из клиентских компьютеров откройте меню **Параметры** , выберите пункт Группа **личных** параметров, нажмите **Дополнительно**, выберите **Настройка вручную**, а затем укажите полное **имя сервера или IP-адрес** . доменное имя (FQDN) нового режиссера или режиссера.
