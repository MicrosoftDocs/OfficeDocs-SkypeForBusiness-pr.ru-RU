...
После добавления функции архивации в топологию и публикации новой топологии необходимо настроить параметры первоначальной реализации функции архивации в развертывании, а затем настроить одну или несколько политик архивации, чтобы включить функцию архивации для развертывания и (при необходимости) для определенных узлов и пользователей. Это можно сделать с помощью панели управления Lync Server 2013.

<div>


> [!NOTE]  
> После развертывания вы можете изменить параметры архивации, чтобы включить или отключить архивацию. Сведения о том, как реализовать поддержку архивации для повседневного управления или для удовлетворения новых требований в Организации после развертывания, можно найти в статье <A href="lync-server-2013-managing-archiving.md">Управление процессом архивации Lync Server 2013</A> в документации по операциям.
