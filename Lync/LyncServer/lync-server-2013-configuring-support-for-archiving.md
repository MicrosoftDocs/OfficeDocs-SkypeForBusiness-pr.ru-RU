...
После добавления архивации в топологию и публикации новой топологии необходимо настроить параметры первоначальной реализации архивации в развертывании, а затем настроить одну или несколько политик архивации, чтобы включить архивацию для развертывания и При необходимости — для определенных сайтов и пользователей. Это можно сделать с помощью панели управления Lync Server 2013.
