...
description: Настройка локального развертывания для гибридной среды с Lync Online.
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Настройка Федерации Lync Server 2013 с помощью Lync Online](lync-server-2013-configure-federation-with-lync-online.md)

  - [Настройка Федерации для поставщика голосовой конференц-связи в Lync Server 2013](lync-server-2013-configure-federation-for-an-audio-conferencing-provider.md)
