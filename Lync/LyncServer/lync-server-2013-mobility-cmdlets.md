...
ms.locfileid: "48565915"
---
# <a name="mobility-cmdlets-in-lync-server-2013"></a>Командлеты мобильной связи в Lync Server 2013
...
Добавлены командлеты для управления мобильными функциями, добавленные в накопительный пакет обновления для Lync Server 2010: Ноябрь 2011. Используйте эти командлеты для управления параметрами функций мобильности, таких как конфигурация службы Mobility Service и политики пользователей.

<div>

## <a name="mobility-cmdlets"></a>Командлеты мобильности

Командлеты, которые настраивают функции мобильности, позволяют выполнять команды из командной консоли Lync Server или создавать скрипты для настройки и тестирования различных параметров мобильности.
