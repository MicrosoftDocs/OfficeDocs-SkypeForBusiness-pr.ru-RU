...
Чтобы упростить процесс резервного копирования и восстановления, применяйте следующие рекомендации при резервном копировании или восстановлении данных.
  ...
  - Если вы используете командлеты и панель управления Lync Server для изменения конфигурации, используйте командлет **Export-ксконфигуратион** , чтобы сделать резервную копию файла конфигурации топологии (XDS. mdf) после внесения изменений, чтобы не потерять изменения, если Вам необходимо восстановить базы данных. Обратите внимание, что эта конфигурация заархивирована в формате XML и сжата как ZIP-файл.
