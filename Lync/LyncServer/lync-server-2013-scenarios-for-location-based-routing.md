...
---
# <a name="scenarios-for-location-based-routing-in-lync-server-2013"></a>Сценарии для маршрутизации Location-Based в Lync Server 2013
...
Маршрутизация Location-Based применяет следующие общие правила при маршрутизации вызовов в следующих сценариях.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Вызов групп с маршрутизацией Location-Based в Lync Server 2013](lync-server-2013-team-calling-with-location-based-routing.md)
