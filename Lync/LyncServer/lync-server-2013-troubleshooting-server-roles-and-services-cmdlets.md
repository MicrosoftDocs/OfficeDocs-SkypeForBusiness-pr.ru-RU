...
Командлеты по устранению неполадок предоставляют различные способы проверки правильности работы Microsoft Lync Server 2013. Например, командлеты Кшеалсмониторингконфигуратион позволяют настроить учетные записи для пулов регистраторов и директоров. В свою очередь, вы можете использовать эти тестовые учетные записи, чтобы убедиться в том, что пользователи могут успешно выполнять типичные задачи, такие как вход в систему, Обмен мгновенными сообщениями и звонки на телефоны, находящиеся в коммутируемой телефонной сети с открытым коммутируемым подключением (КТСОП).

<div>


> [!NOTE]
> Дополнительные сведения о командлетах можно найти в блоге Lync&nbsp;Server Windows PowerShell по <A href="http://go.microsoft.com/fwlink/p/?linkid=263432">http://go.microsoft.com/fwlink/p/?linkId=263432</A>адресу. Содержимое всех блогов и их URL-адреса могут быть изменены без уведомления.
