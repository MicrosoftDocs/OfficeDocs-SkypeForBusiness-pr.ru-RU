...
2.  После установки средств отладки Lync Server (Линкдебугтулс. msi) измените каталог на расположение Snooper. exe с помощью проводника Windows или из командной строки. По умолчанию инструменты отладки расположены в C:\\Program Files\\Microsoft Lync Server 2013\\Tools. Дважды щелкните или запустите Snooper. exe.
