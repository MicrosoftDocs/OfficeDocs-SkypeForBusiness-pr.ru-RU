...
<tr class="odd">
<td><p>CNAME</p></td>
<td><p>линкдисковеринтернал. &lt;сипдомаин&gt;</p></td>
...
<td><p>Для поддержки службы push-уведомлений и службы push-уведомлений Apple вы создаете одну запись SRV для каждого домена SIP, у которого есть мобильные клиенты Microsoft Lync.</p>
<div>
