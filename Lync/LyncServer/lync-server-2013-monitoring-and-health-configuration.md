...
В подразделах этого раздела приводятся пошаговые процедуры для мониторинга и настройки работоспособности, которые можно выполнить в панели управления Lync Server 2013 и консоли управления Lync Server 2013.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Качество взаимодействия (QoE) в Lync Server 2013](lync-server-2013-quality-of-experience-qoe.md)
