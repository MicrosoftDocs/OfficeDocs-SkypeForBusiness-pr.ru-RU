...
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a><span data-ttu-id="f9164-102">Проверка сервера сохраняемого чата с помощью искусственной транзакции</span><span class="sxs-lookup"><span data-stu-id="f9164-102">Test Persistent Chat Server with a synthetic transaction</span></span>
...
<span data-ttu-id="f9164-103">_**Последнее изменение темы:** 2012-09-21_</span><span class="sxs-lookup"><span data-stu-id="f9164-103">_**Topic Last Modified:** 2012-09-21_</span></span>

<span data-ttu-id="f9164-104">Тестирование сервера сохраняемого чата для отправки и получения сообщений в комнате чата между двумя пользователями</span><span class="sxs-lookup"><span data-stu-id="f9164-104">To test Persistent Chat Server for sending and receiving messages in a chat room between two users</span></span>
...
<span data-ttu-id="f9164-105">или</span><span class="sxs-lookup"><span data-stu-id="f9164-105">or</span></span>
...
<span data-ttu-id="f9164-106">или</span><span class="sxs-lookup"><span data-stu-id="f9164-106">or</span></span>
