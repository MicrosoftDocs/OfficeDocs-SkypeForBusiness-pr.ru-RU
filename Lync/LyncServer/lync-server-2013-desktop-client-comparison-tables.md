...
_**Последнее изменение темы:** 2018-01-23_

В следующих таблицах сравниваются функции и возможности клиентов Lync 2013 в следующих категориях:
...
В этих таблицах указываются функции, доступные пользователям Lync в локальном развертывании Lync Server 2013. Те же функции доступны в Skype для бизнеса Online и Office 365 для пользователей, если не указано иное.

<div>


> [!IMPORTANT]  
> В <A href="lync-server-2013-mobile-client-comparison-tables.md">таблицах сравнения мобильных клиентов для Lync Server 2013</A> вы найдете подробные сведения о доступности функций в мобильных клиентах Lync 2013.
...
<th>Lync 2013</th>
<th>Приложение Lync для Магазина Windows</th>
...
<tr class="even">
<td><p>Состояние публикации</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="even">
<td><p>Использование фотографии с любого общедоступного сайта для моего изображения</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td></td>
...
<tr class="odd">
<td><p>Развертывание групп рассылки и групп Office 365</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="even">
<td><p>Сортировка контактов по группам, связям или новым (пользователям, которые были добавлены в список контактов)</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td><p>Сортировка по группам</p></td>
<td><p>●</p></td>
<td></td>
<td> </td>
<td><p>● 1</p></td>
...
<tr class="odd">
<td><p>Сортировка контактов по состоянию (доступность)</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td></td>
...
1 для пользователей Skype для бизнеса Online и/или Office 365, помощник по Lync 2010 не поддерживается.

2 для пользователей Skype для бизнеса Online и/или Office 365 эта функция недоступна.
...
<tbody>
<tr class="odd">
<td><p>Инициация обмена мгновенными сообщениями или электронной почты для контакта</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="even">
<td><p>Переход между несколькими беседами обмена мгновенными сообщениями и отслеживание нескольких бесед в отдельном окне с вкладками</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="even">
<td><p>Поиск по навыкам (интеграция с SharePoint Server)</p></td>
<td><p>● 2</p></td>
<td> </td>
<td><p>● 2</p></td>
<td><p>● 2</p></td>
...
<tr class="even">
<td><p>Эскалация комнаты сохраняемого чата на собрании Lync с одним щелчком мыши</p></td>
<td><p>● 3</p></td>
<td> </td>
<td><p>● 3</p></td>
<td></td>
...
<tr class="odd">
<td><p>Встроенные изображения отправителя и получателя в окне мгновенных сообщений</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="even">
<td><p>Настройка высокой важности МГНОВЕНных сообщений</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td> </td>
...
3 для пользователей Skype для бизнеса Online и/или Office 365, сохраняемый чат недоступен.
...
<tr class="even">
<td><p>Использование звуковых собраний с телефонным подключением</p></td>
<td><p>● 3</p></td>
<td><p>●</p></td>
<td><p>● 3</p></td>
<td><p>● 3</p></td>
...
<tr class="even">
<td><p>Добавление и предоставление файлов Microsoft PowerPoint</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td><p>Только на данный момент</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td></td>
<td></td>
<td></td>
<td><p>Только просмотр, заметки не недоступно4</p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p>Добавление и изменение заметок о собраниях OneNote</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td></td>
<td></td>
<td><p>Только редактирование (не добавлять)</p></td>
<td> </td>
<td></td>
<td></td>
<td></td>
...
<tr class="odd">
<td><p>Отправка файлов для совместного использования с другими пользователями</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td></td>
...
<td><p>Веб-планировщик Outlook или Lync</p></td>
...
<tr class="even">
<td><p>Создание общедоступных собраний со статическими кодами собрания в Outlook</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td></td>
...
<tr class="odd">
<td><p>Отключить мгновенные сообщения для собраний</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="odd">
<td><p>Сделать всех участников участниками</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="even">
<td><p>Представитель может запланировать собрание от имени представителя</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td> </td>
...
<tr class="odd">
<td><p>Предоставление и получение управления общим экраном</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td> </td>
...
3 для пользователей Skype для бизнеса Online и/или Office 365 эта функция требует наличия у поставщика аудио-конференций.
...
<td><p>● 3</p></td>
<td><p>●</p>
<p>Требуется Lync Server 2013 8 HF1 или более поздней версии</p></td>
<td><p>● 3</p></td>
<td></td>
<td><p>● 3</p></td>
<td></td>
...
<tr class="odd">
<td><p>Уведомление о мгновенных сообщениях для URI SIP для вызова E-911</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td> </td>
...
<tr class="even">
<td><p>Уведомление для обмена мгновенными сообщениями по списку рассылки для вызова E – 911</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td> </td>
...
<tr class="odd">
<td><p>Подключение к голосовой почте, Настройка или изменение приветствия</p></td>
<td><p>● 3</p></td>
<td><p>●</p></td>
<td><p>● 3</p></td>
<td><p>●</p></td>
...
<tr class="even">
<td><p>Уведомление о пропущенном звонке</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
<td><p>●</p></td>
...
<tr class="odd">
<td><p>Ответ на вызов в группе</p></td>
<td><p>● 3</p></td>
<td> </td>
<td><p>● 3</p></td>
<td></td>
...
2 для пользователей Skype для бизнеса Online и/или Office 365 эта функция доступна только для звонков с компьютера на компьютер.
...
<tbody>
<tr class="odd">
<td><p>Запись звука, видео, общий доступ к приложениям, общий доступ к рабочему столу и отправка контента на стороне клиента</p></td>
<td><p>● 1</p></td>
<td> </td>
<td><p>● 1</p></td>
<td></td>
...
<tr class="even">
<td><p>Запись передачи файлов, общих страниц OneNote и примечаний PowerPoint на стороне клиента</p></td>
<td><p>● 2</p></td>
<td> </td>
<td><p>● 2</p></td>
<td></td>
...
<tr class="odd">
<td><p>Выбор предпочтительного разрешения записи</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td></td>
...
1 для пользователей Skype для бизнеса Online и/или Office 365 запись недоступна в некоторых автономных планах Skype для бизнеса Online. Для записи требуются полные права клиента Lync 2013. Дополнительные сведения см. в описании службы Skype для бизнеса Online [https://go.microsoft.com/fwlink/?LinkID=282430](https://go.microsoft.com/fwlink/?linkid=282430)по адресу.

2 для пользователей Skype для бизнеса Online и/или Office 365 запись о передаче файлов, общих страницах OneNote и примечаниях PowerPoint недоступна.
...
<tr class="even">
<td><p>Архивация звука, видео, общий доступ к приложениям, общий доступ к рабочему столу и отправка контента на стороне клиента</p></td>
<td><p>● 2</p></td>
<td> </td>
<td><p>● 2</p></td>
<td></td>
...
<tr class="odd">
<td><p>Архивация передачи файлов, общих страниц OneNote и примечаний PowerPoint на стороне клиента</p></td>
<td><p>● 3</p></td>
<td> </td>
<td><p>● 3</p></td>
<td></td>
...
<tr class="even">
<td><p>Доступ к журналам входа с помощью значка Lync на панели задач</p></td>
<td><p>●</p></td>
<td> </td>
<td><p>●</p></td>
<td></td>
...
2 для пользователей Skype для бизнеса Online и/или Office 365 эта функция требует Exchange Online и управляется атрибутом хранения на месте почтового ящика Exchange пользователя.

3 для пользователей Skype для бизнеса Online и/или Office 365, архивация передачи файлов, общих страниц OneNote и примечаний PowerPoint недоступна.
...
Учетные записи пользователей могут существовать в Интернете или локальной среде и влияют на возможности, доступные для этого пользователя. Пользователи, у которых есть учетные записи в Skype для бизнеса Online, не смогут получить доступ к следующим функциям, даже при использовании полного клиента:
  ...
  - Поддержка обмена мгновенными сообщениями: расширение комнаты сохраняемого чата на собрание одним щелчком мыши
