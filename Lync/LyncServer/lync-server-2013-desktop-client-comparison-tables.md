...
description: 'Lync Server 2013: таблицы сравнения клиентов для настольных ПК.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
В этих таблицах указываются функции, доступные пользователям Lync в локальном развертывании Lync Server 2013. Те же функции доступны в Skype для бизнеса Online и Microsoft 365 или Office 365 для пользователей, если не указано иное.
