...
В этом разделе описывается процесс предоставления пользователей в локальной среде Lync Server 2013 с голосовой почтой в размещенной службе единой системы обмена сообщениями Exchange.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Предоставление пользователям размещенной голосовой почты в Lync Server 2013](lync-server-2013-enable-users-for-hosted-voice-mail.md)
