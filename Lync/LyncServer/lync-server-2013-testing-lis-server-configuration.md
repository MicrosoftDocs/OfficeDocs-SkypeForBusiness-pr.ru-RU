...
Если включен параметр Verbose, командлет Test-CsLisConfiguration возвращает пошаговые учетные записи каждого выполняемого действия при проверке возможности указанного пользователя выполнить вход на сервер Lync Server. Пример:
