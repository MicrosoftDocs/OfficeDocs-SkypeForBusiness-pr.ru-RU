...
После запуска этого командлета все пользователи, являющиеся участниками группы, `Site01 Server Administrators` будут иметь права администратора сервера для серверов в Site01. Кроме того, все пользователи, которые позже добавляются в эту универсальную группу безопасности, также получают права этой роли. Обратите внимание на то, что и сама роль, и универсальная группа безопасности, которой она назначена, называются `Site01 Server Administrators` .
