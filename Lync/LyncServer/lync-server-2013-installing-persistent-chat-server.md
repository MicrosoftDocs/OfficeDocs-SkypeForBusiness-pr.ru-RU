...
Установка сервера сохраняемого чата встроена в программу установки Lync Server 2013 и использует тот же загрузчик, который Lync Server 2013 использует для установки. Инструкции по установке см. в разделе [Deploying Lync Server 2013](lync-server-2013-deploying-lync-server.md) документации по развертыванию.
