...
# <a name="testing-and-reporting-the-status-and-assignment-of-kerberos-authentication-in-lync-server-2013"></a>Тестирование и отчет о состоянии и назначении проверки подлинности Kerberos в Lync Server 2013
...
Если необходимо протестировать задания Kerberos или определить состояние проверки подлинности Kerberos, вы можете использовать командлеты Windows PowerShell.
