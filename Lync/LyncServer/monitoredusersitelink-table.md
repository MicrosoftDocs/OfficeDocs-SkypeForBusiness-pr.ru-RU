...
description: Таблица Таблица monitoredusersitelink.
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
f1.keywords:
...
ms.locfileid: "48555095"
---
# <a name="monitoredusersitelink-table"></a>Таблица Таблица monitoredusersitelink
...
<td><p>Ссылка из <a href="lync-server-2013-usersite-table.md">таблицы таблица usersite в Lync Server 2013</a>.</p></td>
</tr>
<tr class="even">
<td><p><strong>UserSite2Key</strong></p></td>
<td><p>int</p></td>
<td><p>Основной, Внешний</p></td>
<td><p>Справочные материалы из <a href="lync-server-2013-usersite-table.md">таблицы таблица usersite в Lync Server 2013</a>.</p></td>
</tr>
</tbody>
</table>
