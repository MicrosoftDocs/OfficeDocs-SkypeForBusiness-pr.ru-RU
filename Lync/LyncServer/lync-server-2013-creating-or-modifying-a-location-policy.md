...
5.  Заполните остальные поля следующим образом:
      ...
      - **Включение расширенных служб**     аварийного реагирования Установите этот флажок, чтобы разрешить пользователям, связанным с этой политикой, разрешение E9 – 1 – 1. Когда службы аварийного восстановления включены, клиенты Lync Server будут получать сведения о расположении при регистрации и включать эти сведения при экстренном вызове.
    
      - **Location (расположение**     ) Укажите одно из следующих значений:
        
          - **Required (обязательный**     ) Пользователю будет предложено ввести сведения о расположении, когда клиент регистрируется в новом расположении. Пользователь может отвергнуть приглашение, не вводя никаких сведений. Если сведения введены, на экстренный вызов сначала ответит поставщик экстренных служб, чтобы проверить расположение, прежде чем звонок будет направлен оператору пункта общественной безопасности (PSAP) (то есть, оператору службы 911).
      ...
      - **Универсальный код ресурса (URI) Конференции**     Универсальный код ресурса (URI) SIP, в данном случае телефонный номер третьей стороны, который будет использоваться в любых совершенных экстренных вызовах. Например, служба охраны компании могла бы получать вызов, когда выполняется вызов экстренных служб, и прослушивать или участвовать в этом вызове (в зависимости от значения, указываемого в поле **Режим конференц-связи**). Строка должна иметь длину от 1 до 256 знаков и должна начинаться с префикса "sip:". Пример набираемой строки отображается в поле до тех пор, пока не щелкнут внутри данного поля.
    
      - **Режим конференции**     Если указать значение в поле " **URI конференции** ", **режим конференции** определяет, может ли третья сторона участвовать в вызове или может только прослушиваться. Укажите один из следующих вариантов:
        
          - **Односторонняя**     Третья сторона может прослушивать беседу только между вызывающим абонентом и оператором PSAP.
        
          - **Двусторонний**     Третья сторона может прослушивать и принимать участие в вызове между вызывающим абонентом и оператором PSAP.
