...
6.  В разделе **Построение правила нормализации** введите значения в следующих полях.
      ...
      - **Длина**   укажите количество цифр в соответствующем шаблоне и укажите, должны ли шаблоны соответствовать этой длине точно, совпадать с набранными номерами, по крайней мере с этой длиной, или с набираемыми номерами любой длины.
