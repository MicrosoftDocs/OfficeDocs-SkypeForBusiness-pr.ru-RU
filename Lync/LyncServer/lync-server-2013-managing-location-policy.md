...
С помощью процедур, описанных в этом разделе, можно управлять политикой расположения Lync Server 2013 из группы **конфигурации сети** в панели управления Lync Server.
