...
Lync Server 2013 поддерживает зеркальное отображение внутренних серверов для обеспечения высокой доступности. Вы можете использовать построитель топологий для настройки зеркального отображения, в том числе для настройки следящего сервера.
