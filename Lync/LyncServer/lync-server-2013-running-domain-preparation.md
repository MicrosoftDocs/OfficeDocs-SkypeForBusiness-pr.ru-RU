...
2.  В папке или на носителе установки Lync Server 2013 запустите Setup.exe, чтобы запустить мастер развертывания Lync Server.
...
7.  В столбце **действие** разверните узел **Подготовка домена**, найдите **\<Success\>** результат выполнения в конце каждой задачи, чтобы убедиться, что подготовка домена успешно завершена, закройте журнал и нажмите кнопку **Готово**.
...
5.  Убедитесь, что подготовка домена завершилась успешно. Выполните следующую команду.
    ...
    Этот командлет возвращает значение домаинсеттингс, которое было ** \_ \_ \_ Готово** , если подготовка домена выполнена успешно.
