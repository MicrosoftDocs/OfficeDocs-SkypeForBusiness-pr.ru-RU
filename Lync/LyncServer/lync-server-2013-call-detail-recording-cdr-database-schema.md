...
В этом документе приведена схема базы данных регистрации вызовов (CDR) в Microsoft Lync Server 2013.

<div>

## <a name="in-this-section"></a>Содержание

  - [Список таблиц CDR в Lync Server 2013](lync-server-2013-list-of-cdr-tables.md)

  - [Сведения о таблице CDR в Lync Server 2013](lync-server-2013-cdr-table-details.md)
