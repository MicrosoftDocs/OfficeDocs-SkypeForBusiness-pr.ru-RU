...
Общий объем памяти, используемой службой Mobility МККС (MB) = 164 + (400 + 134)/ \* 1024 **число сеансов в текущий момент, с активными подписками на присутствие** + 400/1024 \* (**текущее активное число сеансов** — текущее активное число сеансов **с активными подписками на присутствие**)
