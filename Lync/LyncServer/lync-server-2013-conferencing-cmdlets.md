...
Командлеты **ксдиалинконференЦинг** используются для настройки свойств конференц-связи с телефонным подключением, в том числе для задания всех абонентов, которые пользователи могут звонить, чтобы присоединиться к Конференции с помощью клавиш, доступных для них после присоединения к (например, нажмите клавишу 6, чтобы отключить или включить микрофон). Большинство других функций Конференции (например, может зафиксировать Конференц-связь, пользователи могут совместно использовать приложения на Конференции и т. д.) управляются с помощью командлетов **ксконференЦингполици** .
