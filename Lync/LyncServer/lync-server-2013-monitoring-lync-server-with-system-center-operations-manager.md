...
Пакет управления Lync Server 2013 и сопутствующую документацию можно найти по адресу [https://go.microsoft.com/fwlink/p/?LinkId=400468](https://go.microsoft.com/fwlink/p/?linkid=400468). Это рекомендуется при работе с System Center Operations Manager 2012.
