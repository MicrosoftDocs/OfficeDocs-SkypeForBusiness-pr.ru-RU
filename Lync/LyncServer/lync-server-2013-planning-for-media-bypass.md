...
Когда сайт филиала без сервера-посредника подключается к центральному сайту с помощью одной или нескольких каналов глобальной сети с ограниченной пропускной способностью, обход сервера-посредника снижает требования к пропускной способности, позволяя мультимедиа от клиента на сайте филиала напрямую переключаться к локальному шлюзу без необходимости переключаться между ГЛОБАЛЬным шлюзом и сервером-посредником.
