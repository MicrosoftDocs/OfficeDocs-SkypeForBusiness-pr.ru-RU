...
Вы можете включить компонент Enterprise Voice на уровне пользователя. Используйте процедуры, описанные в этом разделе, для управления корпоративной голосовой связью с помощью панели управления Lync Server 2013 и командной консоли Lync Server 2013.
