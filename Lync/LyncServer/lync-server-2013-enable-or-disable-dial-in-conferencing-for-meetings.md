...
# <a name="enable-or-disable-dial-in-conferencing-for-meetings-in-lync-server-2013"></a>Включение и отключение конференц-связи с телефонным подключением для собраний в Lync Server 2013
...
Ниже описано, как разрешить пользователю присоединиться к собранию с помощью телефонного подключения.

<div>

## <a name="to-enable-or-disable-dial-in-conferencing"></a>Включение и отключение конференц-связи с телефонным подключением
