...
---
# <a name="enable-or-disable-dial-in-conferencing-for-meetings-in-lync-server-2013"></a>Включение или отключение конференц-связи с телефонным подключением для собраний в Lync Server 2013
...
## <a name="to-enable-or-disable-dial-in-conferencing"></a>Включение или отключение конференц-связи с телефонным подключением
