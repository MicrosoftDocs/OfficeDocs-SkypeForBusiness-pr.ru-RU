...
1.  В командной строке командной консоли Lync Server создайте новую конфигурацию прокси-сервера для каждого сервера Lync Server 2013 с накопительными пакетами обновления: пограничный пул 2013 июля, корпоративный пул и сервер Standard Edition, для которых будет включена пассивная проверка подлинности с помощью команды следующие команды:
