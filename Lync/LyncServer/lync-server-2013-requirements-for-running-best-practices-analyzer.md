...
Вы можете использовать Lync Server 2013, анализатор соответствия рекомендациям для сканирования среды Lync Server 2013. Этот анализатор нельзя использовать для сканирования любых предыдущих сред, однако можно использовать предыдущие версии средства для сканирования сред предыдущих версий. Для получения дополнительных сведений о загрузке и использовании анализатора соответствия рекомендациям для Lync Server 2010 и Office Communications Server 2007 R2, ознакомьтесь со статьей "Lync Server 2010, анализатор соответствия рекомендациям" на странице "рекомендации [https://go.microsoft.com/fwlink/p/?linkId=210536](https://go.microsoft.com/fwlink/p/?linkid=256358) по работе с Office Communications server 2007 и Office Communications server 2007 R2" [https://go.microsoft.com/fwlink/p/?linkId=256358](https://go.microsoft.com/fwlink/p/?linkid=210651) .
