...
В этом разделе обсуждаются требования к системе для развертывания Lync Server 2013 и всех связанных компонентов.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Требования к системе для SQL Server в Lync Server 2013](lync-server-2013-system-requirements-for-sql-server.md)
  ...
  - [Требования к DNS для Lync Server 2013](lync-server-2013-dns-requirements.md)
