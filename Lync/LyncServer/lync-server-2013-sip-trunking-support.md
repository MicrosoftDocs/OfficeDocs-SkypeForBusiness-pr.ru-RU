...
> [!NOTE]  
> Сведения о том, почему и как можно использовать распределенную магистральную сеть SIP, можно найти в разделе Планирование магистральных каналов <A href="lync-server-2013-branch-site-sip-trunking.md">SIP на сайте Lync Server 2013</A> в документации по планированию.
