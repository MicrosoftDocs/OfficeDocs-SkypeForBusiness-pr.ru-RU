...
В подразделах этого раздела приводятся пошаговые процедуры для задач, которые можно выполнить с помощью группы **мгновенных сообщений и сведений о присутствии** в панели управления Lync Server 2013.
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Назначение политик присутствия для отдельных пользователей в Lync Server 2013](lync-server-2013-assigning-per-user-presence-policies.md)
