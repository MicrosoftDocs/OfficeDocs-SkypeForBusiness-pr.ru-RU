...
# <a name="phase-6-move-from-pilot-deployment-into-production"></a>Этап 6: переход от пилотного развертывания к рабочей среде
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Настройка шлюза XMPP в Lync Server 2013](configure-xmpp-gateway-on-lync-server-2013.md)
