...
Таблица Region — это вспомогательная таблица. Каждая запись представляет одну страну или регион, определенные в параметрах конфигурации сети.
...
<tr class="even">
<td><p><strong>регионнаме</strong></p></td>
