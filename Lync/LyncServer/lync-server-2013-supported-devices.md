...
Подробные сведения о всех устройствах, оптимизированных для работы с Lync, приведены в <http://go.microsoft.com/fwlink/p/?linkid=208938>разделе "телефоны и устройства, сертифицированные для Microsoft Lync". Таблицы сравнения по телефону на этом веб-сайте содержат сведения о ценах и технические спецификации.
...
<tbody>
<tr class="odd">
<td><p>общего пользования Aastra 6721ip</p></td>
<td><p>X</p></td>
...
<tr class="odd">
<td><p>HP 4110 (телефон общего пользования)</p></td>
<td><p>X</p></td>
...
<tr class="even">
<td><p>HP 4120 (стационарный телефон)</p></td>
<td><p>X</p></td>
...
<tr class="odd">
<td><p>для IP-конференций Polycom CX3000</p></td>
<td><p>X</p></td>
...
> [!NOTE]  
> Также предоставляется поддержка для аналоговых устройств. Подробности можно найти <A href="http://go.microsoft.com/fwlink/p/?linkid=257502">в разделе Планирование развертывания аналоговых устройств</A> в библиотеке TechNet для Lync Server 2010. (Lync Phone Edition действует так же, как и в Lync Server 2013 и Lync Server 2010).
