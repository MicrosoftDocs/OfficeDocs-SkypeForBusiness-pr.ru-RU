...
# <a name="conferencing-policies-in-lync-server-2013"></a>Политики конференц-связи в Lync Server 2013
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Просмотр сведений о политике конференц-связи в Lync Server 2013](lync-server-2013-view-conferencing-policy-information.md)
  ...
  - [Удаление существующей политики конференц-связи в Lync Server 2013](lync-server-2013-delete-an-existing-conferencing-policy.md)
