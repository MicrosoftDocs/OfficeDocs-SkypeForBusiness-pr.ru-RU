...
# <a name="test-sip-trunk-configuration-settings-in-lync-server-2013"></a>Проверка параметров конфигурации магистрали SIP в Lync Server 2013
