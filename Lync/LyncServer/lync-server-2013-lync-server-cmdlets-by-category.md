...
Предыдущая команда извлечет все справочные материалы, доступные для командлета **New-ксвоицеполици** . Замените ссылку на **New-ксвоицеполици** именем командлета, для которого требуется получить справку.
