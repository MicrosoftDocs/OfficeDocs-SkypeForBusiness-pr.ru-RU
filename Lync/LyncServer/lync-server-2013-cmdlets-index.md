...
Более подробную информацию об использовании командной консоли Lync Server можно узнать в блоге Lync Server Windows PowerShell [https://go.microsoft.com/fwlink/p/?linkId=203150](https://go.microsoft.com/fwlink/p/?linkid=203150)по адресу.
...
Ниже приведен список командлетов, которые поставляются с Lync Server 2013:
  ...
  - [Granting — CsUserServicesPolicy](https://technet.microsoft.com/library/JJ205388(v=OCS.15))
