...
7.  В столбце **действие** разверните узел **Подготовка леса**, найдите ** \<\> результат выполнения в** конце каждой задачи, чтобы убедиться, что подготовка леса выполнена успешно, закройте журнал и нажмите кнопку **Готово**.
...
6.  Убедитесь, что подготовка леса завершилась успешно. Выполните следующую команду.
    ...
    Этот командлет возвращает значение **\_форестсеттингс\_\_** , которое было готово, если подготовка леса выполнена успешно.
