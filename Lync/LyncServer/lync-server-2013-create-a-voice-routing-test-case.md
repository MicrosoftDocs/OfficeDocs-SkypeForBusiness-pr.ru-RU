...
14. Нажмите кнопку **Зафиксировать**, а затем нажмите кнопку **Зафиксировать все**.
    ...
    Если абонентская абонентская абонентская Абонентская служба, используемая в тесте, нормализует номера телефонов, начинающиеся со знака плюса (например, + 12065551219), этот план может привести к сбою проверки маршрутизации голосовых вызовов. (Абонентская план и маршрут голосовых вызовов будут работать, а на самом деле Test-CsDialPlan будет успешным. Однако проверка маршрутизации голосовых вызовов может закончиться с ошибками.) При тестировании маршрутов голосовой связи следует учитывать следующее.
