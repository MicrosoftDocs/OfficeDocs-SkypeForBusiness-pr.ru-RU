...
| ------------------------------------------------ | ------------ | --------------------------------------------------------- | ----------------------------------------------------------- | ---------------------------- |
| Запись доступна для участников | выбрано     | Доступен DVR, актив Службы мультимедиа Azure AMS хранится в течение 180 дней | Участники могут получить доступ к событию и посмотреть его                     |                              |
