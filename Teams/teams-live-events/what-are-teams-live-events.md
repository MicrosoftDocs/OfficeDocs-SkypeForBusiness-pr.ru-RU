...
![События группы] (../media/teams-live-events-quick-start.png "Снимок экрана: live события, которое создается с помощью панели быстрого запуска метод производства")
