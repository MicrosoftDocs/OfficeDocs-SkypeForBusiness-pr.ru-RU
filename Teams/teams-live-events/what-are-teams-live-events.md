...
Событий в реальном времени считаются со следующей версией Скайп вещания собрания и со временем будут замените возможности, представленные в Скайп собрания вещания. На этом этапе Microsoft будет поддерживать вещания собрания Скайп для пользователей, использующих Скайп для бизнеса в своей организации, без разрыва в службе для новых или последующих событий. Тем не менее мы рекомендуем вам попробовать группами live события использовать все новые и интересные функции, включая совместное использование рабочего стола и поддержку кодировщики внешнего аппаратного и программного обеспечения. 
...
### <a name="event-group-roles"></a>События группы ролей
Live события в группах дает несколько ролей (Организатор, производитель, выступающих и attendee) для успешного распространения и принимать участие в событии. Для получения дополнительных сведений см [события группы ролей](https://support.office.com/article/get-started-with-microsoft-teams-live-events-d077fec2-a058-483e-9ab5-1494afda578a?ui=en-US&rs=en-US&ad=US#bkmk_roles).
...
Видео ввода является основой Live событий и он может отличаться от одного веб-камеры профессионального видео производство несколькими камеры. Live событий в Microsoft 365 поддерживает спектра сценариев производства, включить краткое событий, с помощью web cams или событие в внешнего устройства или приложения. Можно выбрать эти параметры в зависимости от их project требований и бюджета. Существует два способа для создания событий:

- **Группами Майкрософт**: этот метод рабочей позволяет пользователям создавать их live события в группами Майкрософт, с помощью своих веб-камеры или A / V вводимых пользователем данных из группы комнаты систем. Этот параметр, лучше всего подходит и быстрый вариант, если вы хотите использовать устройства аудио- и видеоконференций, подключенных к ПК или приглашаются удаленного выступающие за участие в событии. Этот параметр позволяет пользователям легко использовать их cams web и совместно использовать свой экран в качестве входных данных в событие. 
...
Интерфейса участников является самой важной частью событий в реальном времени и очень важно, что участники могут принимать участие в режиме реального времени события без необходимости найденные проблемы. Интерфейса участников с помощью Azure проигрывателем Windows Media (события, создаваемый в группах Майкрософт) и работающий проигрыватель потока (о событиях, создаваемый в внешних enccoder) для настольных систем, браузеров и mobile (операций ввода-вывода, Android). Office 365 предоставляет Yammer и рабочих групп как два концентраторов совместной работы и live attendee качества интегрирована в эти средства совместной работы. 
