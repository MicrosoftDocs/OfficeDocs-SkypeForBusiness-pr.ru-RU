...
В Teams размещены события, и пользователи в вашей организации могут транслировать видео и содержимое собраний широкой аудитории в Интернете.
...
Teams обеспечивает совместную работу в чате, звонки, собрания и трансляции, поэтому вы можете расширить аудиторию ваших собраний. Трансляции Teams — это расширение собраний Teams, которые позволяют пользователям транслировать видео и содержимое собрания для большой аудитории в Интернете. Трансляции предназначены для общения "один-ко-многим", когда организатор трансляции обеспечивает взаимодействие, а участие аудитории в первую очередь заключается в просмотре содержимого, которым делится организатор. Участники могут посмотреть трансляцию или записанное событие в Yammer, Teams или Stream и взаимодействовать с ними с помощью модерировать вопросы и & A или беседу Yammer.

Трансляции Teams считаются следующей версией Трансляции собраний Skype и в конечном итоге заменят возможности, предоставляемые в рамках Трансляции собраний Skype. На этом этапе Microsoft продолжит осуществлять поддержку Трансляции собраний Skype для пользователей, использующих Skype для бизнеса в своих организациях, без прерывания работы службы для новых или будущих событий. Однако мы рекомендуем опробовать трансляции Teams, чтобы использовать все новые и интересные функции, в том числе общий доступ к экрану и поддержку внешних кодеров оборудования и программного обеспечения.

Итак, приступим. Сначала обратите внимание на следующую схему, на которой показаны компоненты высокого уровня, использующиеся в трансляциях Microsoft 365, и способы их подключения.

![Ключевые компоненты трансляций](../media/live-event-flow-diagram.png  "Ключевые компоненты трансляций, планирование, производство, платформа Stream, сертифицированные сторонние поставщики eCDN")

> [!Note]
> Мы хотели бы подчеркнуть, что трансляции Teams Live Events, учитывая характер технологии трансляций, часто превышают обычные (внутренние) собрания.
>
> Как и в случае с другими крупными службами, которые используют службы вещательного вещания, мы полагаться на сети доставки содержимого для трансляции. Это содержимое защищено методами шифрования и подлежит авторизации с помощью маркеров доступа, которые выданы получателям только в зависимости от конфигурации собрания трансляции.
>
> Дополнительные меры необходимо уплатить тому, чтобы содержимое собрания подходит для такой большой аудитории или чтобы слушатели не захотели использовать конфиденциальную информацию.  
>
> Как это часто происходит в отрасли, компрометации других элементов вашей безопасности, таких как персонал или инфраструктура, могут повлиять на безопасность трансляций. Организациям следует учитывать при планировании безопасности и упражнениях трансляции и другие службы широковещательного мероприятия.

### <a name="event-group-roles"></a>Роли группы событий

Трансляции в Teams по возможности представить нескольким ролям (организатору, организатору, организатору, организатору и участнику) для успешного широковещательного и участия в мероприятии. Дополнительные сведения см. в разделе [Роли группы событий](https://support.office.com/article/get-started-with-microsoft-teams-live-events-d077fec2-a058-483e-9ab5-1494afda578a?ui=en-US&rs=en-US&ad=US#bkmk_roles).
