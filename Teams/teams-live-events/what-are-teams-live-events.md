...
! [Событий группы в реальном времени] (.. /Media/teams-Live-Events-Quick-Start.PNG «снимок экрана: live события, создаваемого с помощью панели быстрого запуска метод производства] (.. /Media/teams-Live-Events-Quick-Start.PNG «Снимок экрана с отображением live события, создаваемого с помощью метода рабочей quick start»)
...
![Снимок экрана, отражающая live события, произведенной с помощью метода рабочей внешних кодировщика] (../media/teams-live-events-external-encoder.png "Снимок экрана, отражающая live события, произведенной с помощью метода рабочей внешних кодировщика")
...
![События группы] (../media/teams-live-events-attendee.png "Снимок экрана: attendee событий в реальном времени взаимодействия")
