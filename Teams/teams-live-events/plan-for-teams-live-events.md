...
|Презентация PowerPoint (общий доступ к PPT) |&#x2714; |&#x274C; (снижено с помощью демонстрации экрана) |Недоступно |
...
<sup>1</sup> установленные лимиты могут быть изменены. Проверка [ограничений и спецификаций для Teams](../limits-specifications-teams.md).<br/>
