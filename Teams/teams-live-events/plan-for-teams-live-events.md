...
> [!IMPORTANT]
> Регион для мероприятия выбирается автоматически в зависимости от организатора и Microsoft 365 или Office 365.
...
- Расположение данных в Канаде, Индии, Австралии, Японии, Великобритании
