...
| Возможность | События, организованные в Teams | События, организованные во внешнем приложении или на устройстве |
|---------|---------|---------|
|Максимальный размер аудитории |10 000 участников<sup>1</sup> |10 000 участников<sup>1</sup> |
|Максимальная продолжительность живого события |4 часа |4 часа |
|Максимальное количество докладчиков и организаторов в трансляции |10 <sup>2</sup> |10 <sup>2</sup> |
|Максимальное количество одновременных трансляций на одну организацию, использующую Microsoft 365 или Office 365 | 15  | 15  |
|Создание живых событий |Teams, Yammer через Teams | Teams, Yammer через Teams, Stream |
...
|Клиент продюсер на Windows |&#x2714; (Teams) |&#x2714; (Stream, Teams через Stream Embed) |
...
|Позволяет нескольких докладчиков |&#x2714; (Teams) |Н/Д  |
|Пригласите докладчика во время встречи |&#x274C; |Н/Д |
|Присоединение докладчика в Интернете и на мобильных устройствах |&#x274C; |Н/Д |
|Докладчики и участники с внешним доступом (федерацией) и гостевым доступом |&#x2714; (Teams) |Н/Д |
...
|ECDN Майкрософт |&#x2714; |&#x2714; |
|Партнерская поддержка eCDN |&#x2714; (Kollective, Hive, Ramp, Riverbed) |&#x2714; (Hive, Kollective, Ramp, Riverbed) |
|Отчет о посещаемости после трансляции для продюсеров |&#x2714; |&#x274C; |
|Анализ настроений аудитории - Голосование в реальном времени и опросы |&#x274C; |&#x274C; |
