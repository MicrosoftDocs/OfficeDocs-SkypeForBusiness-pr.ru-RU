...
- **Для создания или показа:** лицензия Microsoft или Office 365 корпоративный E1, E3 или E5 **[либо]** лицензия Microsoft или Office 365 для образования A1, A3 или A5. В качестве исключения из этого требования гостевые пользователи могут транслировать без лицензии, если выполнены другие условия для [гостевых пользователей](plan-for-teams-live-events.md#guest-to-present).
...
>
> **Чтобы продолжить поддерживать потребности наших клиентов, временное увеличение лимитов на прямые трансляции продлевается до января 2022 года, включая**:
>
...
>
> Кроме того, с помощью программы поддержки трансляций Microsoft 365 можно запланировать трансляции с участием до 100 000 человек. Команда оценивает каждый запрос и взаимодействует с вами, чтобы определить доступные варианты. [Подробнее](https://aka.ms/Stream/Blog/LiveEventOptions). 
