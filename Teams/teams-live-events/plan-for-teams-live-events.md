...
>
> **Чтобы продолжить поддерживать потребности наших клиентов, временное увеличение лимитов на прямые трансляции продлевается до 31 января 2022 года, включая**:
>
...
|Докладчики и участники с внешним доступом (федерацией) и гостевым доступом |&#x2714;(Skype для бизнеса)  |  &#x2714; (Teams) |Недоступно |
