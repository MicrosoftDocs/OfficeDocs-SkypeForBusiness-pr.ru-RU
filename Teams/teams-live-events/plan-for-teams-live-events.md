...
- **События, созданные в Teams или с помощью кодировщика Teams Powered**  Пользователю должна быть назначена лицензия Teams.
...
| Видимость участников | Производство Teams | Производство внешнего приложения или устройства | Кодировщик Teams Powered
|------------------------------|-----------------|----------------------|----------------|
...
В следующей таблице представлены основные возможности и функции, предлагаемые в трансляциях.
