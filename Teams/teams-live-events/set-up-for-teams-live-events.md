...
1. В левой области навигации Центра администрирования Microsoft Teams перейдите на вкладку Политики управления  >    >  **политиками** собраний в live events.
...
|**Запись разговоров для участников** |Этот параметр можно использовать только для трансляций, организованных в Teams. Включение этого параметра позволяет участникам трансляции просматривать автоматические субтитры во время трансляции.         |
