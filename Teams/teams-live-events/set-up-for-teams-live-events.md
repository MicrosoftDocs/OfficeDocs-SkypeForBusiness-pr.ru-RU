...
Убедитесь, что у вас есть подходящие назначенные лицензии для тех, [кто может создавать и планировать трансляции](plan-for-teams-live-events.md#who-can-create-and-schedule-live-events), а также для тех, [кто может просматривать их](plan-for-teams-live-events.md#who-can-watch-live-events).
...
> [!NOTE]
> Пользователям вашей организации будет назначена глобальная политика, если вы не создали и не назначили настраиваемую политику. По умолчанию в глобальной политике включено планирование трансляций для пользователей Teams, отключены автоматические субтитры (транскрибирование), все пользователи организации могут присоединяться к трансляциям, а режим записи имеет значение "Всегда записывать". 
...
1. В области навигации слева выберите **Собрания** > **Политики трансляций**. 
2. Выполните одно из следующих действий.
- Если вы хотите изменить существующую политику по умолчанию, выберите **Глобальная (по умолчанию для организации)**. 
- Если вы хотите создать настраиваемую политику, выберите **Создать политику**. 
...
Если вы создали настраиваемую политику трансляций, назначьте ее пользователям для ее применения. 

![Значок с логотипом Microsoft Teams](../media/teams-logo-30x30.png) С помощью Центра администрирования Microsoft Teams

1. В области навигации слева нажмите **Пользователи** и выберите пользователя.
2. Рядом с пунктом **Назначенные политики** выберите **Изменить**. 
3. Выберите политику трансляций, которую нужно назначить, и нажмите **Сохранить**. 

Вы также можете назначить политику трансляций одному или нескольким пользователям следующим образом:

![Значок с логотипом Microsoft Teams](../media/teams-logo-30x30.png) С помощью Центра администрирования Microsoft Teams

1. Выберите **Собрания** > **Политики трансляций**.
...
Чтобы позволить пользователям планировать трансляции, организованные с помощью внешнего приложения или устройства, вы должны также выполнить следующее:

1. Включить Microsoft Stream для пользователей в организации. Stream доступен в составе соответствующих подписок на Office 365 или как отдельная служба. Stream не входит в планы бизнес базовый и бизнес премиум. Дополнительные сведения см. в статье [Общие сведения о лицензировании Stream](https://docs.microsoft.com/stream/license-overview).

      Узнайте больше о том, как можно [назначать лицензии пользователям в Office 365](https://support.office.com/article/Assign-licenses-to-users-in-Office-365-for-business-997596B5-4173-4627-B915-36ABAC6786DC), чтобы пользователи могли получать доступ к Stream. Убедитесь, что Stream не заблокирован для пользователей, как определено в [этой статье](https://docs.microsoft.com/stream/disable-user-organization).
...
**Приобретите и настройте решение за пределами Teams**. Получите экспертную помощь по масштабированию доставки видео, используя надежных партнеров Майкрософт по доставке видео. Прежде чем использовать поставщика доставки видео в Teams, вы должны приобрести и настроить решение SDN/eCDN за пределами и отдельно от Teams.
...
- **Ramp OmniCache** обеспечивает сетевое распространение следующего поколения и удобную доставку видеоконтента в глобальных сетях, помогая организаторам трансляций оптимизировать пропускную способность сети и успешно осуществлять трансляции и потоковую передачу по запросу. Поддержка Ramp OmniCache для трансляций, организуемых Teams, ожидается в ближайшее время. [Подробнее](http://www.ramp.com). 
