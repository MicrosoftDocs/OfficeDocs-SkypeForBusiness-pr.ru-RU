...
1. В левой области навигации центра администрирования Microsoft Teams перейдите  >  >  на вкладку "Политики управления политиками" "Политики собраний в режиме **реального** времени".
...
1. Включить Microsoft Stream для пользователей в организации. Stream доступен как часть соответствующих Microsoft 365 или Office 365 или как автономная служба. Stream не входит в планы бизнес базовый и бизнес премиум. Дополнительные сведения см. в статье [Общие сведения о лицензировании Stream](/stream/license-overview).
...
**Приобретите и настройте решение за пределами Teams**. Получите экспертную помощь по масштабированию доставки видео, используя надежных партнеров Майкрософт по доставке видео. Прежде чем включить поставщик доставки видео для использования с Teams, необходимо приобрести и настроить решение SDN/eCDN за пределами и отдельно от Teams.
...
- **Riverbed**, отраслевой стандарт в оптимизации сети, расширяет свои решения ускорения для Microsoft Teams и Stream.  Теперь Microsoft 365 могут уверенно ускорить трафик 365, включая Teams и Stream, а также множество других ведущих корпоративных служб SaaS, чтобы повысить производительность сотрудников из любого места. Teams и ускорение потоков можно включить с помощью легкой настройки, которая обеспечивает все гарантии поддержки мирового класса и текущих инвестиций в Riverbed.
