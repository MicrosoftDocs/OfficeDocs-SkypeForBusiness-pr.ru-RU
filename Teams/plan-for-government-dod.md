...
Дополнительные сведения о предложении Office 365 для государственных органов сша по doD для государственных органов можно найти на сайте планов [Office 365](https://products.office.com/government/compare-office-365-government-plans)для государственных органов, в том числе требования к [приемлемости.](https://products.office.com/government/compare-office-365-government-plans#EligibilityRequirements)
...
|    |     |
|-----------|------------|
| ![Значок, изображающий точку принятия решения](media/audio_conferencing_image7.png) <br/>Точка принятия решений|<ul><li>Решите, нужно ли изменить любой из стандартных параметров безопасности Office 365 для государственных учреждения — DoD, чтобы сначала понять, на что влияют изменения.</li></ul> |
