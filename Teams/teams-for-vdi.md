...
Teams виртуализированной среде поддерживает несколько конфигураций. К ним относятся VDI, выделенный, общий, сохраняемый и неохраняемый режим. Функции постоянно находятся в разработке и добавляются регулярно, а функциональность будет расширяться в ближайшие месяцы и годы.
...
В настоящее время Teams VDI с помощью функции аудио- и видеофайлов, Windows виртуальный рабочий стол, Citrix и VMWARE. Просмотрите сведения в этом разделе, чтобы убедиться, что вы соответствуете всем требованиям к необходимым функциям.
...
Исключите из Teams кэша %appdata%/Microsoft/Teams. Исключая эти элементы, вы помогаете уменьшить размер кэша пользователей, чтобы оптимизировать неохраняемую настройку.
...
Если вы выполняете переход с Skype для бизнеса VDI на Teams VDI, кроме различий между двумя приложениями, при внедрении VDI также существуют некоторые отличия. Вот некоторые возможности, которые в настоящее время не поддерживаются Teams VDI, Skype для бизнеса VDI:
