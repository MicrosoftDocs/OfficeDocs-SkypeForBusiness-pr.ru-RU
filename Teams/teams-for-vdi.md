...
Дополнительные Teams и Приложения Microsoft 365 для предприятий см. в [](/DeployOffice/teams-install#how-to-exclude-microsoft-teams-from-new-installations-of-microsoft-365-apps) Teams новых установок Приложения Microsoft 365 для предприятий и Управление установкой [ Teams](/DeployOffice/teams-install#use-group-policy-to-control-the-installation-of-microsoft-teams).
...
1. Скачайте пакет Teams MSI, который соответствует вашей операционной системе VDI VM, по одной из следующих ссылок:
    ...
    > [!NOTE]
    > Ссылки на [MSI-файлы](msi-deployment.md) см. в Microsoft Teams с помощью Microsoft Endpoint Configuration Manager для загрузки облачных систем.
...
- Зависимости: к ним относятся зависимости от инфраструктуры, рабочей нагрузки и других аспектов защиты среды, не включаемой Teams настольного приложения.
...
Teams VDI доступны в модуле Microsoft Teams VDI. Эти политики активны и применяются для не оптимизированных сред VDI.
...
Когда пользователи с параметром политики VDI -DisableAudioVideoInCallsAndMeetings $true в Teams VDI, они должны иметь возможность:
