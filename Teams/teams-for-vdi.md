...
Дополнительные Teams и Приложения Microsoft 365 для предприятий см. в Teams [](/DeployOffice/teams-install#how-to-exclude-microsoft-teams-from-new-installations-of-microsoft-365-apps) новых установок Приложения Microsoft 365 для предприятий и Управление установкой с помощью групповой [политики. Teams](/DeployOffice/teams-install#use-group-policy-to-control-the-installation-of-microsoft-teams).
...
1. Скачайте пакет Teams MSI, который соответствует вашей операционной системе VDI VM, по одной из следующих ссылок:
    ...
    > [!NOTE]
    > Ссылки на [MSI-файлы](msi-deployment.md) см. в Microsoft Teams с Microsoft Endpoint Configuration Manager с помощью Microsoft Endpoint Configuration Manager для загрузки файлов.
