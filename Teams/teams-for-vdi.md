...
- **Обновления клиента**: teams в VDI не обновляются автоматически, как в случае с клиентами групп, не поддерживающих VDI.  Вы должны обновить образ виртуальной машины установкой нового MSI-файла, как описано в разделе [Установка Teams в VDI](#install-teams-on-vdi) . Вы должны удалить текущую версию, чтобы обновить ее до новой версии.
