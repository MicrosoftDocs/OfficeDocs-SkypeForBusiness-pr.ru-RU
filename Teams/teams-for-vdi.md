...
В настоящее Teams на VDI с помощью функции аудио- и видеофайлов, которые сертифицированы с помощью виртуальных рабочих столов Azure, Citrix и VMWARE. Просмотрите сведения в этом разделе, чтобы убедиться, что вы соответствуете всем требованиям к необходимым функциям.
...
Виртуальный рабочий стол Azure обеспечивает оптимизацию av для Teams в VDI. Дополнительные узнать о требованиях и требованиях к установке см. в Teams [на виртуальном](/azure/virtual-desktop/teams-on-wvd)рабочем столе Azure.
