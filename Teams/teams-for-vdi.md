...
Для повышения производительности виртуальных рабочих столов в VDI обеспечивается оптимизированная поддержка AV для Teams. Последнюю версию VMware горизонта можно загрузить на странице [загрузки VMware](https://my.vmware.com/web/vmware/downloads/#all_products) .
