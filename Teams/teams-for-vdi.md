...
Microsoft Teams в виртуализованной среде поддерживает чат и совместную работу. Кроме того, поддерживается платформа Citrix, функции звонков и собраний.
...
В настоящее время команды в VDI с оптимизацией аудио-и видеофайлов (AV) – это сертификация Citrix. Ознакомьтесь со сведениями, приведенными в этом разделе, чтобы убедиться, что вы отвечаете требованиям Citrix и Teams для правильной работы.
