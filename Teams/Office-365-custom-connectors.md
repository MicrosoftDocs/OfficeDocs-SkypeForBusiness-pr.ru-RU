...
f1.keywords:
- NOCSH
description: Узнайте, как соединители обновляют вашу команду, часто доставлять содержимое и обновления непосредственно в канал Teams для используемых служб.
appliesto:
- Microsoft Teams
...
> [!IMPORTANT]
> Пользовательские соединители недоступны в облако сообщества для государственных организаций (GCC), GCC-High и Министерства обороны США.

Чтобы использовать соединители в команде или канале, откройте меню "Дополнительные параметры" в правом верхнем углу канала. В меню выберите " **Соединители** ", а затем найдите или найдите необходимое приложение соединителя. При необходимости настройте выбранный соединитель.
