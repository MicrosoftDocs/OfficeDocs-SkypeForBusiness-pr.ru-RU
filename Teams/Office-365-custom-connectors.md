...
> [!NOTE]
> Соединитетели по умолчанию отключены в средах Community (GCC) для государственных GCC. Чтобы включить их, задайте для параметров ConnectorsEnabled или ConnectorsEnabledForTeams $true с помощью $true SetOrganizationConfig. Необходимо подключиться к Exchange Online [PowerShell.](/powershell/exchange/connect-to-exchange-online-powershell?view=exchange-ps)
