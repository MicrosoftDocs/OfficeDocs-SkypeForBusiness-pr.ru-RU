...
## <a name="block-unsolicited-contact-with-external-unmanaged-teams-users"></a>Блокировка нежелательных контактов с внешними неуправляемыми пользователями Teams

Выполните эти действия, чтобы защитить пользователей Teams своей организации от нежелательных контактов с внешними пользователями Teams, чьи учетные записи не управляются организацией.
...
2. Выполните одно из следующих действий.
    ...
    - Чтобы запретить пользователям Teams своей организации общаться с внешними пользователями Teams, чьи учетные записи не управляются организацией, отключите параметр **Пользователи в моей организации могут общаться с пользователями Teams, учетные записи которых не управляются организацией** и снимите флажок **Внешние пользователи, учетные записи Teams которых не управляются организацией, могут связываться с пользователями в моей организации**.

    - Чтобы разрешить пользователям Teams своей организации общаться с внешними пользователями Teams, чьи учетные записи не управляются организацией, если ваши пользователи Teams инициировали контакт, включите параметр **Пользователи в моей организации могут общаться с пользователями Teams, учетные записи которых не управляются организацией** и снимите флажок **Внешние пользователи, учетные записи Teams которых не управляются организацией, могут связываться с пользователями в моей организации**.

    - Чтобы разрешить пользователям Teams своей организации общаться с внешними пользователями Teams, чьи учетные записи не управляются организацией, и получать запросы на общение с этими внешними пользователями Teams, включите параметр **Пользователи в моей организации могут общаться с пользователями Teams, учетные записи которых не управляются организацией** и установите флажок **Внешние пользователи, учетные записи Teams которых не управляются организацией, могут связываться с пользователями в моей организации**.
...
Если вы включили параметр **Пользователи в моей организации могут общаться с пользователями Teams, учетные записи которых не управляются организацией**, вы можете ограничить внешний доступ определенными пользователями с помощью PowerShell.

Ниже приведен пример скрипта: замените *PolicyName* на название политики, а *UserName* — на имя каждого пользователя, которому вы хотите предоставить внешний доступ.
