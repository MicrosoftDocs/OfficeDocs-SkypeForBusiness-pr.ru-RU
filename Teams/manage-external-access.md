...
> [!NOTE]
> Если в вашей организации отключен внешний доступ, внешние пользователи по-прежнему смогут присоединяться к собраниям анонимно. Подробнее см. в разделе [Управление настройками собраний в Teams](meeting-settings-in-teams.md).
...
## <a name="user-level-controls"></a>Элементы управления на уровне пользователя

Когда пользователи получают чаты 1:1 от пользователя за пределами организации, им предоставляется полноэкранный интерфейс, в котором они могут просмотреть **сообщение, принять** чат или заблокировать пользователя, отправляющего  чат.

Блокировка внешних пользователей доступна в нескольких местах в Teams, включая дополнительное меню (**...**) в списке чатов и дополнительное меню (**...**) в карточке людей. Пользователи также могут разблокировать внешних пользователей с помощью дополнительного меню (**...**) в списке чатов, меню "Дополнительно" (**...**) на карточке людей или  >  >  в разделе "Параметры заблокированных контактов **".** Блокировка доступна до или после отправки сообщений.

Блокировка внешних пользователей не позволяет им отправлять сообщения в чатах 1:1, добавлять пользователя в новые групповые чаты и просматривать их присутствие. Хотя приглашения в групповой чат блокируются, заблокированные пользователи могут быть в тех же чатах с пользователями, которые их блокируют, либо потому, что чат был инициирован до блокировки, либо приглашение группового чата было отправлено другим участником.
