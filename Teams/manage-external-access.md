...
> [!NOTE]
> Если в вашей организации выключен внешний доступ, внешние пользователи по-прежнему смогут присоединяться к собраниям анонимно. Дополнительные сведения см. в статье [Управление параметрами собраний в Teams](https://docs.microsoft.com/microsoftteams/meeting-settings-in-teams).
...
|**Тип вашей организации** |**Выполните следующие действия для включения федерации**  |
|:---------|:-----------------------|
...
|**Тип вашей организации** |**Включите федерацию потребителей следующим образом**  |
|:---------|:-----------------------|
