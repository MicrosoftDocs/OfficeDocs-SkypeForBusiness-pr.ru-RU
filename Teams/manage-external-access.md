---
title: Управление внешними собраниями и чатом
ms.author: mikeplum
...
description: Ваш администратор Teams или ИТ-администратор может настроить внешние собрания и чат для других доменов, чтобы позволить пользователям из этих доменов находить ваших пользователей, звонить им, общаться с ними в чате и настраивать собрания с их участием.
appliesto:
- Microsoft Teams
...
## <a name="plan-for-external-meetings-and-chat"></a>Планирование внешних собраний и чатов
...
## <a name="specify-trusted-organizations"></a>Указание доверенных организаций

Вы можете разрешить или заблокировать определенные домены, чтобы определить организации, которым ваша организация доверяет внешние собрания и чат. (Обратите внимание, что другие организации также должны разрешить домен вашей организации.)
...
> [!NOTE]
> Люди из заблокированных доменов могут по-прежнему присоединяться к собранию анонимно, если разрешен анонимный доступ.
...
|Отключить федерацию с определенными доменами|`-BlockedDomains`|Недоступно|
...
## <a name="user-level-controls"></a>Элементы управления уровня пользователя

Когда пользователи получают чаты 1:1 от пользователей за пределами организации, они получают полноэкранный интерфейс, в котором они могут **выбрать предварительный просмотр** сообщения, **принять** чат или **заблокировать** пользователя, отправляющего чат.

Блокировка внешних пользователей доступна в нескольких местах в Teams, включая дополнительное меню (**...**) в списке чатов и дополнительное меню (**...**) на карточке людей. Пользователи также могут разблокировать внешних пользователей с помощью меню "Больше" (**...**) в списке чатов, дополнительного меню (**...**) на карточке "Люди" или в разделе Параметры **Заблокированные контакты** >  Изменить **заблокированные** > **контакты**. Блокировка доступна до или после отправки сообщений.

Блокировка внешних пользователей не позволяет им отправлять сообщения в чатах 1:1, добавлять пользователя в новые групповые чаты и просматривать его присутствие. Хотя приглашения в групповой чат заблокированы, заблокированные пользователи могут находиться в том же чате с пользователями, которые заблокировали их либо потому, что чат был инициирован до блокировки, либо приглашение группового чата было отправлено другим участником.

> [!NOTE]
> Нет параметров или политик администратора Teams, которые управляют возможностью пользователя блокировать чаты с внешними людьми.
