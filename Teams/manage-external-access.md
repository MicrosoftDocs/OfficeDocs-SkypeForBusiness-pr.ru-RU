...
> [!NOTE]
> Разрешенные или заблокированные домены применимы только к собраниям, если анонимный доступ к собраниям отключен.
...
> [!NOTE]
> Если вы отключите внешний доступ в Организации, внешние пользователи по-прежнему смогут присоединяться к собраниям через анонимные соединения. Дополнительные сведения можно найти [в разделе Управление параметрами собраний в Teams](https://docs.microsoft.com/microsoftteams/meeting-settings-in-teams).
