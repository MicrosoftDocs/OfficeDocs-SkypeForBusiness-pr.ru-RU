...
> [!NOTE]
> Последняя версия плана группами для определения функций конференц-связи звука группы в области действия для развертывания, можно найти в <https://aka.ms/O365Roadmap>.
...
> [!NOTE]
> Для получения дополнительных сведений о возможностях собраний в группах, видеть [365 стратегия Майкрософт](https://aka.ms/O365Roadmap).
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Точки принятия решений|<ul><li>Решите, какие пользователя расположения или офисах по реализации службы аудио конференц-связи.</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Дальнейшие действия|<ul><li>Документирование пользователя расположения или офисов, чтобы включить для службы аудио конференц-связи.</li></ul>|
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Точки принятия решений|<ul><li>Решите, требуется ли вашей организации настраиваемого абонентских групп (бизнес-требований, требований к внедрения и т.д.).</li><li>Область абонентской группы клиента решить, если это возможно, (глобальный клиента или пользователя клиента) для поддержки требования для настраиваемого абонентских групп.</li><li>Если это возможно, Выбор клиента абонентские группы, которые будут созданы для поддержки пользователя расположения или офисов в области для реализации облачных голосовой связи.</li><li>Если это возможно, Выбор пользователей, которые требуют настраиваемого абонентской группы и абонентской клиента для назначения для каждого пользователя.</li></ul>|
