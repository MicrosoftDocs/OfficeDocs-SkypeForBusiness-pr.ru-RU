...
Гостевое взаимодействие предусматривает ограничения. Полный список возможностей и запретов для гостей в Teams см. в статье [Гостевой доступ в Microsoft Teams](guest-experience.md).
