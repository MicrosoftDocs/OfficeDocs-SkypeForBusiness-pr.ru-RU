...
Сквозные зашифрованные вызовы могут выполняться между двумя сторонами, когда: стороны используют последнюю версию классического клиента Teams для Windows или Mac, на мобильном устройстве с последним обновлением для iOS и Android или в Комнаты Teams на устройстве с Windows, использующим последнее обновление.
...
4. Чтобы включить сквозное шифрование для пользователей, для **сквозного шифрования вызовов** выберите **Не включено, но пользователи могут включить**, а затем нажмите кнопку **Сохранить**.
