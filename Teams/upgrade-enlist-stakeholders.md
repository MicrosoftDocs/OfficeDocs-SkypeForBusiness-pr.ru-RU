...
| Индикатор асинхронных совместной работы  | Несет ответственность за асинхронных создание таких как SharePoint, OneDrive и т. п.               | 
