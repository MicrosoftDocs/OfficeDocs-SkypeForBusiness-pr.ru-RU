...
---
# <a name="network-settings-for-cloud-voice-features-in-microsoft-teams"></a>Параметры сети для облачных голосовых функций в Microsoft Teams
...
Сведения из подсети используются для определения сетевого сайта, на котором находится конечная точка при иниции нового сеанса. Когда известно о расположении каждой из сторон в сеансе, облачная голосовая функция может применять эту информацию, чтобы определить, как управлять настройкой зова или маршрутизов.
