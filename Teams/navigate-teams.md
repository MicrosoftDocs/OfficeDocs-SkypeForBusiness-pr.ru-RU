...
**Вариант 1. Переключение из Kaizala группы в групповой чат в Teams**:
...
**Вариант 2. Переключение Kaizala неструктурированной группы на Teams группы**:
...
Выполните административный переход с портала Kaizala управления на центр Microsoft Teams Администратор. Центр администрирования Teams предназначен только для использования ролей администратора.
...
## <a name="kaizala-management-portal-to-teams-admin-center"></a>Портал управления Kaizala в Teams Администратор Center
...
> [!NOTE]
> Teams пользователи могут использовать Teams на настольном компьютере или мобильном устройстве для управления отдельными командами и каналами, и им не потребуется доступ к Teams Администратор центре.
