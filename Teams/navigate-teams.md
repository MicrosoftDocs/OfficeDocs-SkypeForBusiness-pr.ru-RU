...
Теперь, когда у вас есть четкое представление об уникальном пути и потребностях вашей организации, можно приступить к работе с эффективной совместной работой с Microsoft Teams. В следующем разделе описано, как перемещаться по Kaizala возможностей, которые были Teams.
...
| Совместная работа с внешними пользователями (поставщиками, поставщиками и партнерами)| [Добавление или приглашение пользователей за пределами Teams организации в чат](#collaborating-with-external-usersvendorssupplierspartners) |
...
Платформа Teams позволяет использовать существующие средства организации путем интеграции с Microsoft Teams наряду с готовыми к использованию приложениями Microsoft 365 и сторонними приложениями. В настоящее время в Microsoft Teams доступно более 800 внешних приложений.
...
**Опрос** позволяет пользователям быстро создавать и отправлять опросы в чате или канале, чтобы узнать мнение своей команды. Приложение опроса поддерживается на всех платформах Teams, браузере, iOS и Android клиентах. Он готов к развертыванию в рамках существующей Microsoft 365 подписки.

![Опрашивает шаблон приложения в Teams](media/polltemplatecompose.gif)

**Опрос** позволяет пользователям создавать опросы в чате или канале, чтобы задавать ряд вопросов и получать ценные сведения о действиях. Используйте опрос для регистраций, регистраций, отзывов, комментариев, отслеживания потенциальных клиентов, отчетов, жалоб и оценок. Приложение опроса поддерживается на всех платформах— Teams, браузере, iOS и Android клиентах. Он готов к развертыванию в рамках существующей Microsoft 365 подписки.

![Шаблон приложения опроса в Teams](media/surveytemplatecompose.gif)

**Контрольный список** позволяет совместно работать с командой, создавая общий контрольный список в чате или канале. Приложение контрольного списка поддерживается на всех платформах Teams, браузере, iOS и Android клиентах. Он готов к развертыванию в рамках существующей Microsoft 365 подписки.
...
Quiz — это пользовательское [Teams](/microsoftteams/platform/messaging-extensions/what-are-messaging-extensions) обмена сообщениями, которое позволяет создавать тесты в чате или канале для проверки знаний и мгновенных результатов. Тесты можно использовать для экзаменов в классе и автономном режиме, проверки знаний в команде и для проведения интересных тестов в команде. Приложение теста поддерживается на нескольких платформах, например на Teams, браузере, iOS и Android клиентах. Это приложение готово к развертыванию в рамках существующей Microsoft 365 подписки.
...
3. Изучите следующие подходы для частоты и сложности использования.
    ...
    - Использование собственных Microsoft Teams приложений
    ...
    - Создание [пользовательских приложений с помощью Teams платформы](/microsoftteams/platform/overview)
...
Вы можете отслеживать безопасность и соответствие организации в Microsoft 365 [с помощью Портал соответствия требованиям Microsoft Purview](/microsoft-365/compliance/microsoft-365-compliance-center) [и Центра безопасности Майкрософт](/microsoft-365/security/defender/overview-security-center).
...
Microsoft Teams безопасные решения для совместной работы с внешними сторонами, Microsoft Teams Связи мы упрощаем работу с любыми пользователями за пределами вашей организации. Teams позволяет коммерческим пользователям общаться с внешними коммерческими пользователями, то есть коммерческими пользователями в других организациях. Основываясь на этой привилегии, мы позволяем вам общаться в чате с членами команды за пределами вашей организации, даже если они используют Teams личной учетной записи. Эти учетные записи часто используются SMB, поэтому эта новая возможность помогает усилить отношения с внешними партнерами.

Как было объявлено ранее на [конференции Ignite](https://techcommunity.microsoft.com/t5/microsoft-teams-blog/microsoft-ignite-fall-2021-innovations-coming-to-microsoft-teams/ba-p/2824127), вы можете пригласить любого пользователя Teams в чат, введя полный адрес электронной почты или номер телефона, к которому вы хотите обратиться, и начать чат "один к одному" или групповой чат с любым пользователем с личной учетной записью Майкрософт без необходимости переключения клиента.
...
В зависимости от параметров администрирования вашей организации и пользователя личной учетной записи Teams вы можете начать беседы с внешними пользователями личных учетных записей Teams, а пользователи внешних Teams личных учетных записей могут начать беседы с Teams рабочими пользователями.

Teams пользователи, управляемые организацией, могут приглашать Teams личных учетных записей, с которыми они хотят общаться, введя полный адрес электронной почты или номер телефона. Teams личные пользователи могут ввести точный адрес электронной почты пользователя организации, к которому они хотят обратиться, и попытаться начать чат.

Если пользователи, с которыми вы хотите общаться, еще не Teams, они получат сообщение электронной почты или текстовое сообщение с приглашением присоединиться к беседе с помощью личной учетной записи. После регистрации и входа в свою Teams учетной записи он сможет присоединиться к чату.
...
Teams пользователей под управлением организации и Teams личных учетных записей могут отклонить внешнее приглашение. Внешний пользователь может отправлять сообщения до 10 раз перед принятием, но если после 10 сообщений принятие не будет принято, вы не сможете отправлять дополнительные сообщения этому пользователю.

Просмотрите [](https://support.microsoft.com/en-us/office/add-or-invite-people-outside-your-teams-org-to-a-chat-6897ab47-9f60-4db6-8b95-18599714fe57) страницу поддержки и прочитайте блог, чтобы узнать больше о том, как Teams позволяет легко взаимодействовать с внешними клиентами и партнерами в рамках безопасности и безопасности доверенной Teams рабочей области.[](https://techcommunity.microsoft.com/t5/microsoft-teams-blog/microsoft-teams-users-can-now-chat-with-any-teams-user-outside/ba-p/3070832)
