...
Разработчики могут загрузить неопубликованное приложение, чтобы сделать его доступным для участников определенной команды, как правило, для тестирования разрабатываемого приложения. Если загрузка неопубликованных приложений разрешена, для этого не требуется утверждение администратора. Администратор может запретить загрузку неопубликованных приложений для любого разработчика.
