...
При разработке пользовательских приложений и перед их распространением среди конечных пользователей разработчики проверяют приложения, добавляя их в Магазин Teams для тестирования. Разработчики смогут тестировать приложение самостоятельно или с определенной группой пользователей, но приложение не будет доступно другим конечным пользователям в организации. Этот метод называется загрузкой неопубликованных приложений и применяется только к пользовательским приложениям.
