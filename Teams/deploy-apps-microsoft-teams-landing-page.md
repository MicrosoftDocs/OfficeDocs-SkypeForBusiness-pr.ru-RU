...
Наш [обширный каталог](https://appsource.microsoft.com/en-US/marketplace/apps?product=office%3Bteams&page=1) проверенных и безопасных приложений в Магазине Teams предоставляет конечным пользователям доступ к средствам и службам, которые требуются вашей организации каждый день. Приложения Microsoft Teams — это веб-приложения SaaS, которые не нужно развертывать. Конечные пользователи могут использовать приложения в Teams только на основании [предоставленных вами разрешений](app-policies.md). Как администратор, вы используете корпоративные политики для разрешения или блокировки любого приложения для пользователей своей организации. Вы управляете доступностью приложений для каждого пользователя в различных контекстах, таких как собрания, чаты и каналы.
