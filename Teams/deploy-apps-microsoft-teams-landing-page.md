...
| Задайте себе вопрос | Действие |
|--------------|--------|
|Хочу ли я разрешить использование настраиваемых ботов в моей организации?|Дополнительные сведения о добавлении ботов см. в статье [Добавление ботов в личные чаты и каналы в Microsoft Teams](add-bots.md). Сведения о включении или отключении настраиваемых ботов см. в статье [Параметры администрирования для приложений в Microsoft Teams](admin-settings.md).|
|||
