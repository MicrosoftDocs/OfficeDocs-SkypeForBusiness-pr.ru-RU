...
Наш обширный каталог проверенных и безопасных приложений в Teams Store предоставляет конечным пользователям доступ к инструментам и службам, ежедневно необходимых вашей организации. Приложения Microsoft Teams — это веб-приложения SaaS, которые не нужно развертывать. Конечные пользователи могут использовать приложения в Teams только на основании [предоставленных вами разрешений](app-policies.md). Как администратор, вы используете корпоративные политики для разрешения или блокировки любого приложения для пользователей своей организации. Вы управляете доступностью приложений для каждого пользователя в различных контекстах, таких как собрания, чаты и каналы.
