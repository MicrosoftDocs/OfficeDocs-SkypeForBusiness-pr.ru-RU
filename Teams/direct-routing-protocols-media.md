...
- Как правило, конечные точки сервера отвечают напрямую с помощью 200OK. Это полные конечные точки ICE, которые обычно участвуют в сценариях голосовой почты, очереди зовов и автоответчиков.
