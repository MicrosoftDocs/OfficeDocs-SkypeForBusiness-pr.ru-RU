...
Используйте стандартные каналы для разговоров, в которые каждый член команды может внести свой вклад. Воспользуйтесь [преимуществами частных каналов](private-channels.md) , когда вам требуется специализированное пространство для совместной работы с выбранной группой участников команды. Используйте [общие каналы](shared-channels.md) , когда вам нужно сотрудничать с людьми за пределами команды.
