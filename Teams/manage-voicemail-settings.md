...
Для управления облачная голосовая почта пользователями можно использовать Центр администрирования Teams или PowerShell. Конечные пользователи также могут настроить эти параметры в клиенте Teams, перейдя к параметрам **-> Вызовы -> Настройка голосовой почты.**
...
- **Параметры приветствия** — облачная голосовая почта может воспроизводить определенное приветствие, когда пользователь находится в офисе, и когда пользователь не на месте. Оба приветствия могут быть записаны пользователем или с помощью приветствия преобразования текста в речь.
  ...
  - Перезапись приветствия **Oof** по умолчанию — указывает приветствие преобразования текста в речь, которое будет воспроизводиться в случае, если пользователь не работает и не записал приветствие об офисе.
