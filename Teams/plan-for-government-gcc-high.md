...
audience: admin
ms.reviewer: daro
description: Руководство для ИТ-специалистов по развертыванию Office 365 в организациях, которые обрабатывают данные в правительственных правилах США.
...
Дополнительные сведения о предложении Office 365 для государственных организаций – GCC для государственных Office 365 для государственных организаций США, включая требования к [правомочности.](https://products.office.com/government/compare-office-365-government-plans#EligibilityRequirements) [](https://products.office.com/government/compare-office-365-government-plans)
...
|    |     |
|-----------|------------|
| ![Значок, изображающий точку принятия решения](media/audio_conferencing_image7.png) <br/>Точка принятия решений|<ul><li>Решите, нужно ли изменить любой из стандартных параметров Office 365 для государственных организаций — GCC Высокий уровень безопасности, чтобы сначала понять, на что влияют любые изменения.</li></ul> |
...
После того как вы будете переназначен в Office 365 для государственных организаций – GCC Высокая, следуйте рекомендованным путям развертывания, описанным в [Microsoft Teams.](./deploy-overview.md) Не забудьте взаимодействовать со своей командой по внедрению и управлению изменениями и Teams руководствами.
