...
Пример использования планировщика сети для настройки плана сети и создания отчета с помощью этих шагов загрузите [планировщик сети How-To колоды PowerPoint](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/network-planner-how-to.pptx?raw=true) (только на английском языке).
