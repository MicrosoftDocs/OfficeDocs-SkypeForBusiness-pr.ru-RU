...
> [!NOTE]
> С 29 ноября 2018 г. вы больше не сможете использовать приложение Microsoft Teams для Windows 10 S (предварительная версия), доступное в Магазине Microsoft Store. Теперь вы можете скачать и установить классическое приложение Teams на устройствах, работающих в режиме Windows 10 S. Чтобы загрузить классическое приложение, перейдите на [https://teams.microsoft.com/downloads](https://go.microsoft.com/fwlink/?linkid=855754)веб –. Сборки MSI для настольного клиента Teams пока недоступны для устройств, работающих в режиме Windows 10 S.
>
> Дополнительные сведения о режиме Windows 10 S можно найти [в разделе Введение в режим s в Windows 10](https://www.microsoft.com/windows/s-mode). 
...
| | | |
|---------|---------|---------|
|![Значок, который описывает точку принятия решения](media/Get_clients_for_Microsoft_Teams_image4.png)      |Точка принятия решений         |Существуют ли ограничения, мешающие пользователям установить на своих устройствах подходящий клиент Microsoft Teams?         |
|![Значок, который описывает дальнейшие действия](media/Get_clients_for_Microsoft_Teams_image5.png)     |Дальнейшие действия         |Если ваша организация ограничивает установку программного обеспечения, убедитесь в совместимости данного механизма с Microsoft Teams. Примечание. Для установки клиента на Mac требуются права администратора, а на ПК — нет.         |

<a name="client-update-management"></a>Управление обновлениями клиентов
------------------------

Сейчас клиенты обновляются службой Microsoft Teams автоматически и без вмешательства ИТ-администратора. Если обновление доступно, клиент будет автоматически скачивать его, а когда приложение будет бездействует в течение определенного периода времени, начнется процесс обновления.
