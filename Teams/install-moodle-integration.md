...
1. Войте учетную записи администратора на сервере Moodle Server и **выберите** администрирование сайта в области навигации слева.
...
1. Выберите параметр **Upload в** области навигации слева, найдите файл, который вы скачали выше, **Upload файл**.
...
1. Затем добавьте Id и Key в подключаемый модуль Moodle. Вернись на страницу администрирования подключаемых модульов (администрирование сайта > подключаемых > Microsoft 365 Интеграция).
...
1. После обновления страницы отобразится еще один новый раздел **Согласие администратора и дополнительные сведения**.
    * Щелкните **ссылку Предоставить согласие** администратора, введите Microsoft 365 или Office 365  учетные данные глобального администратора и нажмите кнопку Принять, чтобы предоставить разрешения.
...
1. Вернись на страницу администрирования подключаемых модульов (> Подключаемый модуль > Microsoft 365 Интеграция) и **Teams Параметры.** Вам потребуется настроить некоторые параметры безопасности, чтобы включить интеграцию приложения Teams.
...
1. Вернись на страницу администрирования подключаемой модуль (> подключаемых модульов > Microsoft 365 Интеграция) и выберите вкладку **Teams Параметры.**
...
1. Нажмите кнопку **Создать новый пароль**. Скопируйте созданный пароль и  в поле Пароль приложения-бота на странице Параметры **команд.**
...
6. В Moodle откройте **страницу группы Параметры** подключаемого модульа Moodle.
