...
1. После обновления страницы отобразится еще один новый раздел **Согласие администратора и дополнительные сведения**.
    * Щелкните **ссылку Предоставить** согласие администратора, Microsoft 365 или Office 365 учетные данные глобального администратора, а затем принять,  чтобы предоставить разрешения.
...
1. Вернись на страницу администрирования подключаемых модульов (администрирование сайта > подключаемых > Microsoft 365 Integration) и **Teams Параметры** страницу. Вам потребуется настроить некоторые параметры безопасности, чтобы включить интеграцию приложения Teams.
