...
6. В Moodle откройте **страницу "Параметры команды"** своего подключаемого модульа Moodle.
...
Теперь, когда у вас есть бот, развернутый в Azure и настроенный для общения с сервером Moodle, можно развернуть приложение Microsoft Teams. Для этого загрузите файл манифеста, который вы скачали со страницы параметров группы Plugin Team Moodle на предыдущем шаге.
