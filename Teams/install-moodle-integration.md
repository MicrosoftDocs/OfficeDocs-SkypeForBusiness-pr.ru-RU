...
1. Запустите скрипт PowerShell, выполнив следующие действия:
    ...
    * Войдите в свою Microsoft 365 или Office 365 учетную запись администратора во всплывающее окно.
...
1. Нажмите кнопку **Создать новый пароль**. Скопируйте созданный пароль и  вкопируйте его в поле Пароль **приложения-бота** на странице Параметры team.
