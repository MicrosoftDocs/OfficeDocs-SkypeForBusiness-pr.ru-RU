...
**Важное примечание.** Откройте страницу конфигурации Microsoft 365 или Office 365 Moodle Plugin на отдельной вкладке браузера, так как вы будете возвращаться к этому набору страниц на протяжении всего процесса.
...
1. Запустите скрипт PowerShell, выполнив следующие действия:
    ...
    * Войдите в свою учетную запись Microsoft 365 или Office 365 во всплывающее окно.
...
1. После обновления страницы отобразится еще один новый раздел **Согласие администратора и дополнительные сведения**.
    * Щелкните **ссылку Предоставить согласие** администратора, введите свои учетные Microsoft 365  или Office 365 глобального администратора и нажмите кнопку Принять, чтобы предоставить разрешения.
...
1. Вернись на страницу администрирования подключаемых модульов (> Подключаемый модуль > Microsoft 365 Интеграция) и **Teams Параметры** страницу. Вам потребуется настроить некоторые параметры безопасности, чтобы включить интеграцию приложения Teams.
