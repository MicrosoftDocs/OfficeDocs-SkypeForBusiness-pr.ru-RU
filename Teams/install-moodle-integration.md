...
Дополнительные информацию о функциях, которые предоставляет эта интеграция, см. в установке интеграции [Moodle с Microsoft Teams.](/microsoftteams/platform/resources/moodleinstructions)
...
1. Сначала скачайте подключаемый модуль [Moodle](https://moodle.org/plugins/pluginversions.php?plugin=local_o365) и сохраните его на локальный компьютер. Необходимо использовать версию 3.5 или более позднюю.
...
1. Затем нужно добавить id и ключ в подключаемый модуль Moodle. Вернуться на страницу администрирования подключаемых модульов (администрирование сайта > подключаемых > интеграции с Microsoft 365).
...
1. Вернись на страницу администрирования подключаемых модульов (> подключаемых модульов > Интеграция с Microsoft 365) и выберите вкладку **"Параметры Teams".**
