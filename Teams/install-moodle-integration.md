...
1. Затем необходимо добавить идентификатор и ключ в подключаемый модуль Office 365 Мудле. Вернитесь на страницу администрирования подключаемого модуля (Администрирование сайта подключаемые модули > > интеграции с Microsoft Office 365).
...
1. После того как страница будет обновлена, вы увидите еще один новый раздел **согласие администратора & дополнительными сведениями**.
...
1. Вернитесь на страницу администрирования подключаемого модуля (Администрирование сайта подключаемые модули > > интеграция с Microsoft Office 365) и выберите страницу **параметры групп** . Для включения интеграции приложений Teams необходимо настроить некоторые параметры безопасности.
...
1. Вернитесь на страницу администрирования подключаемого модуля (Администрирование сайта подключаемые модули > > интеграция с Microsoft Office 365) и откройте вкладку **параметры групп** .
