...
Не знакомы с Teams? [Узнайте о том, как с помощью Teams](https://products.office.com/microsoft-teams/group-chat-software) можно объединять беседы, собрания, файлы, приложения Office и сторонние интеграции, обеспечивая единый центр для работы в Office 365.
