...
1. В области навигации слева перейдите к голосовым <a href="https://admin.teams.microsoft.com/phone-numbers" target="_blank">   >  **Телефон номерам**</a>.
...
1. Решите, следует ли отправлять пользователю приветствие электронное письмо с номером телефона. Если Вы хотите:
    - **Перенесите существующие телефонные номера** в бизнес-голосовую связь (перенос номеров телефонов), отняв для пользователя сообщения электронной почты сведения о  **номере телефона.**
