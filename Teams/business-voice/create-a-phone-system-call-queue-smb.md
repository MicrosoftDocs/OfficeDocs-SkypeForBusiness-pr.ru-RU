...
Учетной записи *ресурса Microsoft 365 телефонная система лицензию виртуального* пользователя.
...
1. В Центре администрирования Teams **Разойдите на голосовую** кнопку , **выберите** очереди зовов и нажмите кнопку **Добавить**.
