...
- **Business Voice с тарифным планом** Вы можете купить Business Voice у Microsoft, использовать мастер Getting Started для настройки Business Voice, а затем настроить или перенести существующие телефонные номера в Microsoft. В статье [Использование мастера Getting Started для настройки Business Voice](use-getting-started-wizard.md) показано, как настроить Business Voice для своего арендатора.
