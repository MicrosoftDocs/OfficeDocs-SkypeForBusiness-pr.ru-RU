...
* У пользователей, которые настроены с помощью business Voice, будут собственные телефонные номера для прямого набора номера, которые они могут использовать для телефонных звонков с любого устройства, на Teams телефонов.
...
Подготовив организацию к бизнес-голосовой настройке, выберите следующий шаг: Начало **настройки бизнес-голосовой почты**.
