...
1. В браузере перейдите по адресу https://admin.teams.microsoft.com. Выполните вход, используя учетную запись с правами глобального администратора. Учетная запись, которую вы использовали для регистрации в Office 365, имеет такие разрешения.
