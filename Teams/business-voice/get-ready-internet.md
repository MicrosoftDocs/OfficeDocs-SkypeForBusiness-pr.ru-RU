...
1. Откройте **Планирование** и выберите **Планировщик сети**.
...
1. Заполните только те поля, которые указаны на снимке экрана ниже, и нажмите кнопку **Сохранить**. Оставьте пустыми остальные поля на этом экране и не выбирайте параметр **ExpressRoute** или **Подключено к глобальной сети**.

    ![Сведения о сайте сетевого планировщика](../media/network-planner-site-info.png)
1. На вкладке **Отчет** выберите **Запуск отчета**.
1. Заполните указанные ниже сведения, а затем нажмите кнопку **Создать отчет**. В нем будут отражены требования к пропускной способности для Teams. Сведения о том, как прочитать отчет, см. в следующем разделе.
