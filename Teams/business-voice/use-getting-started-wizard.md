...
<table>
    <tr>
        <td>Помимо нового местного телефонного номера можно приобрести номер для бесплатных звонков абонентов или перенести существующий номер в Microsoft 365. Чтобы настроить номер для бесплатных звонков абонентов, необходимо приобрести тарифный план. Чтобы перенести один или несколько номеров в Microsoft 365, перейдите в <a href="https://admin.teams.microsoft.com">Центр администрирования Teams</a> после завершения работы мастера.
        </td>
