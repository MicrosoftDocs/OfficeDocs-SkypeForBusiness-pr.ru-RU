...
Политики настройки приложений позволяют настроить Teams, чтобы выделить приложения, которые наиболее важны для пользователей в организации. Приложения, задаированные в политике, закрепляются на панели приложения — на панели в Teams настольного клиента и в нижней части Teams мобильных клиентов, где пользователи могут быстро и легко получить к ним доступ.
