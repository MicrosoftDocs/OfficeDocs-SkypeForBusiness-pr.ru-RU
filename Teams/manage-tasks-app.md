...
"Задачи" доступны в виде приложения, а также в виде вкладки на канале. В приложении отображаются как отдельные задачи из Список дел, так и задачи группы из Планировщика. На вкладке отображаются только задачи группы.
...
**Мои задачи** отображают отдельные задачи пользователя. **Общие планы** показывают задачи, над которыми работает вся команда, а также любой список задач, добавленный в виде вкладки "Задачи" на канал. Обратите внимание на следующие связи между задачами в задачах, Список дел и Планировщике:
...
### <a name="pin-tasks-to-teams"></a>Закрепление задач Teams

#### <a name="use-the-tailored-frontline-app-experience-to-pin-tasks-and-other-apps-to-teams"></a>Использование специализированного интерфейсного приложения для закрепления задач и других приложений для Teams
