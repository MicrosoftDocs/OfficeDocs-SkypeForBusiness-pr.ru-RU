...
Чтобы проверить сопряжение с помощью входящих параметров SIP, используйте интерфейс управления SBC и посмотрите, что SBC отправляет ответ на сообщения OPTIONS, которые приходят из прямой маршрутии, и что код ответа составляет 200 ОК.
