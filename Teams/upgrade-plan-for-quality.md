...
![Схема, иллюстрирующая основные области, проверенные в ходе проверки качества] (media/envision-planning-for-service-management-and-quality-complete-guide-image3.png "Схема, на которой показаны ключевые области, которые проверяются во время анализа качества.")
...
Для выполнения оценки можно привлечь партнера Майкрософт либо использовать сторонние средства или [средство оценки сети (Майкрософт)](https://www.microsoft.com/download/details.aspx?id=53885). Кроме того, мы предлагаем вам больше инструкций по выполнению оценки с помощью средства оценки сети (Майкрософт) в рамках нашего [](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Downloads?SelectedIDs=4_3_0_2,4_3_0_3,4_3_0_5,4_3_0_6,4_3_0_7,4_3_0_8,4_3_0_10,4_3_0_11)руководства по готовности.
