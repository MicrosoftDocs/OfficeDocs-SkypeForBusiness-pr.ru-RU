...
1. После создания Bot перейдите к **параметрам приложения** для Bot, который вы разработали, а затем в разделе **Параметры**приложения скопируйте значение параметра **микрософтаппид** . ![Снимок экрана: страница параметров приложения для Bot с ВЫДЕЛЕНным идентификатором приложения Microsoft.](media/Add_bots_for_private_chats_and_channels_in_Microsoft_Teams_image5.png)
...
![Выберите уже созданную вами Bot.](media/Select_Existing_Bot.png)
