...
> [!IMPORTANT] 
> Пользователям не требуется лицензия Microsoft Stream, если вы хотите, чтобы пользователи загрузили только записи и загружали их. Это означает, что записи не будут храниться в потоке Microsoft, но вместо этого они будут храниться в службах мультимедиа Azure (AMS) в течение 30 дней до того, как оно будет удалено. Это не значит, что администратор может управлять возможностью их удаления или управлять ею.
