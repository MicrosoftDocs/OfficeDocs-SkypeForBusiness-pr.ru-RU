...
<sup>1</sup> пользователь должен быть лицензирован для отправки и скачивания собраний в Microsoft Stream, но им не требуется лицензия на запись собрания. Если вы хотите запретить пользователю записывать собрание Microsoft Teams, вы должны предоставить TeamsMeetingPolicy, для которого AllowCloudRecording установлено значение $False.
