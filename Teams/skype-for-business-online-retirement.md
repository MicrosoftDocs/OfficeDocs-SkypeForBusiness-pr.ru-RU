...
- Чтобы гарантировать, что все контакты из Skype для бизнеса Server будут правильно перенесены в Teams при перемещении пользователя из локальной среды в TeamsOnly, убедитесь, что перенесенные пользователи выполняют вход в Teams в течение 30 дней после переноса из локальной среды. Это временное требование, так как корпорация Майкрософт переводит Teams из устаревшей инфраструктуры Skype для бизнеса Online.
