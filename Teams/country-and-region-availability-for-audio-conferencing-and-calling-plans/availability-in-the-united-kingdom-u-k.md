...
|Может ли исходящие звонки на платные номера? <br/> | Частично поддерживается: звонки на общие затраты (в виде префиксов 44843, 44844, 44845, 44870, 44871, 44872) поддерживаются с использованием кредитов связи для оплаты за минуту.  Звонки на 449XXные префиксы не поддерживаются. <br/> |
