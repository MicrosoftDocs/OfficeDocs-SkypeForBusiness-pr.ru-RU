...
|Можно выполнять исходящие вызовы на номера premium? <br/> | Частично поддерживаемая: поддерживаются вызовы для общих затрат номеров (приставок 44843, 44844, 44845, 44870, 44871, 44872) с помощью кредитов Communications оплачены в минуту.  Звонки с префиксами 449XX не поддерживаются. <br/> |
