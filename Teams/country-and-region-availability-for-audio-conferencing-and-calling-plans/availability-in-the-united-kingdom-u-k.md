...
- Phone System
- Calling Plans
description: Ниже приведены службы Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams, доступные в Соединенном Королевстве.
ms.openlocfilehash: e22ffd5870bd28232ff4358fbb532c8a9e6b40d8
ms.sourcegitcommit: 173bdbaea41893d39a951d79d050526b897044d5
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/07/2022
ms.locfileid: "67271634"
---
...
Ниже приведены службы Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams, доступные в Соединенном Королевстве.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для: <br/><ul><li> Лондон</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../getting-service-phone-numbers.md).  <br/> |
...
|Можно ли выполнять исходящие вызовы к номерам уровня "Премиум"? <br/> | Частично поддерживается: вызовы общих номеров затрат (префиксы 44843, 44844, 44845, 44870, 44871, 44872) поддерживаются с помощью кредитов на связь для оплаты в минуту.  Вызовы префиксов 449XX не поддерживаются. <br/> |
