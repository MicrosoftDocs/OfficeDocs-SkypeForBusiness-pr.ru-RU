...
Ниже приведены службы Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams, которые доступны в Австрии.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li>Вена </ul>Если вы хотите использовать специальные номера телефонов, ознакомьтесь со сведениями о том, как [получить номера служебных телефонов](/microsoftteams/getting-service-phone-numbers).  <br/> |
...
|Может ли исходящие звонки на платные номера?  <br/> | Да <br/> |
...
|**Функция**|**Details**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> |Вена  <br/> |
