...
|**Функция**|**Сведения**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?   | По запросу[(по запросу)](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md)<br/> |
