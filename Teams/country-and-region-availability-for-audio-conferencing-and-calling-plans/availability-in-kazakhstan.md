...
ms.locfileid: "66615465"
---
# <a name="availability-in-kazakhstan"></a>Доступность в Базе данных SQL Azure
...
|**Функция**|**Сведения**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?   | [Вайетский (по запросу](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md))<br/> |
