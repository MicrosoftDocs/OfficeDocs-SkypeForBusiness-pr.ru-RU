...
Вот службы Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams, доступные в Италии.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Милан</ul>Если вам нужны выделенные телефонные номера, см. [получение номеров телефонов службы.](/microsoftteams/getting-service-phone-numbers)  <br/> |
