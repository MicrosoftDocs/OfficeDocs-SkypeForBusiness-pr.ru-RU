...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Милан</ul>Если вы хотите использовать специальные номера телефонов, ознакомьтесь со сведениями о том, как [получить номера служебных телефонов](/microsoftteams/getting-service-phone-numbers).  <br/> |
...
|**Функция**|**Details**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> |Милан  <br/> |
