...
ms.locfileid: "58584773"
---
# <a name="availability-in-italy"></a>Доступность в Италии

[Найдите другую страну или регион](country-and-region-availability-for-audio-conferencing-and-calling-plans.md) или узнайте больше о доступности стран и регионов для аудио конференций и тарифных планов.

Ниже ются Microsoft 365 и Office 365 службы для Skype для бизнеса и Microsoft Teams для Италия.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Милан</ul>Если вам нужны выделенные телефонные номера, см. [получение номеров телефонов службы.](../getting-service-phone-numbers.md)  <br/> |
