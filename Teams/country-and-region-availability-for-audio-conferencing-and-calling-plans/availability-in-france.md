...
Ниже приведены службы Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams, которые можно использовать для Франции.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Париж</ul> Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](/microsoftteams/getting-service-phone-numbers).  <br/> |
...
|Может ли исходящие звонки на французские бесплатные номера? <br/> | Да, полностью поддерживается при использовании кредитов связи для оплаты за минуту. <br/> |
...
|**Функция**|**Details**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> | <ul><li>Анже <li>  Бордо <li>  Каркасон <li>  Дижон <li>  Гренобль <li>  Гавр <li>  Лилль <li>  Лион <li>  Марсель <li>  Монпелье <li>  Нант <li>  Ницца <li>  Париж <li>  Реймс <li>  Рен <li>  Сент-Этьен <li>  Страсбург <li>  Тулон <li>  Тулуза </ul> |
