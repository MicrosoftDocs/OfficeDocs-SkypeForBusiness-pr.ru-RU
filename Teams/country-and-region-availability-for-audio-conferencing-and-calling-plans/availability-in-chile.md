...
ms.locfileid: "62191230"
---
# <a name="availability-in-chile"></a>Доступность в Чили

[Найдите другую страну или регион](country-and-region-availability-for-audio-conferencing-and-calling-plans.md) или узнайте больше о доступности стран и регионов для аудио конференций и тарифных планов.

Ниже находятся Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams для Чили.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Украина (доступна только для организаций в Чили)</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../getting-service-phone-numbers.md).  <br/> |
...
|**Функция**|**Сведения**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> |Сантьяго  <br/> **Примечание:** Только для организаций в Чили.           |
|Доступны ли платные номера?  <br/> |Да  <br/> **Примечание:** Только для организаций в Чили.           |
