...
Ниже указаны службы Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams, которые можно использовать для Чили.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Сантьяго (доступно только для организаций в пределах Чили)</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](/microsoftteams/getting-service-phone-numbers).  <br/> |
...
|**Функция**|**Details**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> |Сантьяго  <br/> **Примечание.** Доступно только для организаций, находящихся в пределах Чили.           |
|Доступны ли платные номера?  <br/> |Да  <br/> **Примечание.** Доступно только для организаций, находящихся в пределах Чили.           |
