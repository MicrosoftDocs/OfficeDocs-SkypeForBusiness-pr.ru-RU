...
Ниже 2010 г. доступны службы Microsoft 365 и Office 365 для Skype для бизнеса и Microsoft Teams, доступные в Чили.
...
|Назначаются ли номера телефонов для аудиоконференций автоматически?  <br/> |Да, для:<br/><ul><li> Сантьяго (только для организаций в Чили)</ul>Если вам нужны выделенные номера телефонов, см. статью [Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams](../getting-service-phone-numbers.md).  <br/> |
...
|**Функция**|**Details**|
|:-----|:-----|
|Для каких столиц или крупных городов можно получить платные номера?  <br/> |Сантьяго  <br/> **Примечание.** Доступно только организациям в Чили.           |
|Доступны ли платные номера?  <br/> |Да  <br/> **Примечание.** Доступно только организациям в Чили.           |
