...
Вы можете выбрать страну или регион, чтобы узнать, какие функции голоса в облаке доступны для вашей организации.
***
...
Обратный звонок с собрания в другую страну или регион, которые не указаны ниже, доступен при использовании [кредитов на связь в Office 365](../what-are-communications-credits.md). Для этих пользователей вам потребуется [настроить кредиты на связь в Организации](../set-up-communications-credits-for-your-organization.md).
...
Наряду с телефонной системой планы звонков позволяют пользователям совершать и принимать телефонные звонки. Сначала необходимо получить номер телефона пользователя (подписчика), но не номер службы, чтобы назначить его пользователю, а затем можно назначить план звонков. Доступны два типа планов звонков: **внутренние звонки** и **внутренние и международные звонки**. Для получения дополнительных сведений ознакомьтесь [с планами телефонной системы и звонков](../calling-plan-landing-page.md) .
