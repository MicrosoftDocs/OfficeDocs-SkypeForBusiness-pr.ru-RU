...
Обратный звонок с собрания в другую страну или регион, которые не указаны ниже, доступен при использовании [кредитов на связь в Office 365](../what-are-communications-credits.md). Таким пользователям потребуется [настроить коммуникационные кредиты для вашей организации.](../set-up-communications-credits-for-your-organization.md).
