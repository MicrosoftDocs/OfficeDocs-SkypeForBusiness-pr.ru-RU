...
Дела записи взаимодействия можно разделить на четыре основные категории функций записи: удобство, функциональный, организационный и юридический перехват, как показано на изображении:

![Снимок экрана: запись взаимодействия: что и почему.](media/recording-taxonomy.png "На изображении показаны категории записи.")

В каждой из категорий есть различные требования к способу начала записи, хранению записи, хранению записи, о том, кто уведомлен, кто контролирует доступ и как обрабатывается хранение.

| Тип                   | Удобство (обычная запись Teams) | Регулируемая организация (запись соответствия требованиям) |
| ---------------------- | ------------------ | --------------- |
...
Teams предоставляет различные возможности для [<span class="underline">удобной</span>](./cloud-recording.md) и функциональной записи для собраний и трансляций. Организационная запись означает, что организации могут использовать Teams для звонков и собраний в соответствии с административной политикой, когда звонки и собрания по сети должны быть автоматически записаны и записаны для последующей обработки и хранения, как требуется соответствующей корпоративной или регулятивной политикой. Пользователи, в соответствии с этой политикой, будут знать, что их цифровые взаимодействия с Teams записывают, но не смогут отключить запись и не смогут получить доступ к записи после завершения взаимодействия. Запись становится частью архива организации, доступного для обеспечения соответствия требованиям и юридического персонала при обнаружении электронных данных, удержании по юридическим и другим корпоративным средствам хранения.
...
<td><ul>
<li><p>По уведомлению во время записи.</p></li>
<li><p>Будьте в курсе того, когда ошибка политики или записи вызывает изменения в поведение при вызове.</p></li>
</ul></td>
</tr>
<tr class="even">
<td>Администратор связи</td>
<td><ul>
<li><p>В этой видео поймем, почему и как применять политики записи для пользователей и конечных точек Teams.</p></li>
...
<li><p><strong>Содержимое</strong> — транскрипция, тональность, фонетическое отношение, связанное взаимодействие</p></li>
</ul></li>
...
Требования к VM-версии Azure и Windows применяются только к компоненту бота Teams, поэтому партнер может реализовать оставшуюся платформу при условии, что он сможет соответствовать требованиям к производительности и функциональным требованиям для записи соответствия требованиям.

## <a name="compliance-recording-policy-assignment-and-provisioning"></a>Назначение и подготовка политики записи соответствия

ИТ-администраторы могут определять, каких пользователей нужно записывать и какие записи будут использоваться для каждого пользователя, создавая и назначая политики записи соответствия. Регистраторам автоматически предлагается участвовать в беседах в зависимости от конфигурации этих политик при взаимодействии с другими участниками. Политика записи соответствия требованиям управляется с помощью [<span class="underline">Microsoft PowerShell</span>](./teams-powershell-overview.md) и может применяться на уровне клиента, пользователя и группы безопасности для каждой организации. Дополнительные сведения о microsoft Docs для [<span class="underline"></span>](./teams-calling-policy.md) политик собраний, [<span class="underline"></span>](./meeting-policies-in-teams.md)политиках звонков и групповых политиках можно найти на сайте Microsoft [<span class="underline">Docs.</span>](./assign-policies.md#assign-a-policy-to-a-group)
...
|Озеро Ата |[https://thetalake.com/integrations/microsoft/](https://thetalake.com/integrations/microsoft/) |
...
Если вы — поставщик, который хочет присоединиться к программе сертификации, <a href= "mailto:Teamscategorypartner@microsoft.com">Teamscategorypartner@microsoft.com.</a>
