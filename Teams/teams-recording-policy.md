...
- Поддержка взаимодействия между пользователями Teams и конечными точками звонков (Teams, Teams Mobile, Skype для бизнеса, STN)
...
Поддержка уведомлений включена с Teams клиента. Эти функции могут быть визуальными или звуковые.
