...
Запись соответствия требованиям может быть включена в Microsoft 365 a3/A5/E3/для бизнеса премиум и Office 365 a3/A5/E3/водопользователи. 
...
| Тип                   | Благодаря        | Функция         | Org — общие      | Поднадзорные Организации | Законных перехват   |
| ---------------------- | ------------------ | ------------------ | ------------------ | --------------- | ------------------ |
...
| Владелец хранилища          | Пользователь               | ·                | RAS              | Соответствие требованиям      | LEA                |
| Требуется уведомление? | Да                | Да                | Да                | Да             | Нет                 |
| Владелец Access           | Пользователь               | ·                | RAS              | Соответствие требованиям      | LEA                |
...
Следующие партнеры получили Вам свое решение для Microsoft Teams.
...
|Для новаторства (дуб) |[https://www.oakinnovate.com/call-recording](https://www.oakinnovate.com/call-recording) |
