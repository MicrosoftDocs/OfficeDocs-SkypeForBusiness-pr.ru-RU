...
Требования к VM для Azure и Windows применяются только к компоненту бота Teams, то есть партнеры могут реализовать остальные платформы, если они смогут соответствовать соответствующим требованиям к производительности и функциональности для записи соответствия требованиям.
