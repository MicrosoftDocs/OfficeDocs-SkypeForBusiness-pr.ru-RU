...
- Телефоны SIP
- Skype для бизнеса
- Аудиоконференции (уведомление о звуке на языке по умолчанию или выбранном пользователем номере для телефонного подключения)
- Вызывающие абоненты ТСОП (уведомление о звуке на языке пользователя Teams по умолчанию)
...
|Технологии Red кэша |[https://www.contentguru.com/en-gb/solutions/needs/compliance-recording-MS-Teams/](https://www.contentguru.com/en-gb/solutions/needs/compliance-recording-MS-Teams/) |
