...
Запись на основе политики позволяет организациям, использующим политику Microsoft Teams для звонков и собраний, при использовании административной политики автоматически записывать и записывать звонки и собрания по сети для последующей обработки и хранения, как требуется соответствующей корпоративной или регулятивной политикой.
...
|Партнер|Веб-сайт решения |
|:--|:--|
|Технология Insightful |[http://www.insightfultechnology.com/what-we-do/fixed-line-voice-recording/](http://www.insightfultechnology.com/what-we-do/fixed-line-voice-recording/) |
...
Если вы хотите присоединиться к программе сертификации, отправьте письмо в [Teamscategorypartner@microsoft.com.](mailto:Teamscategorypartner@microsoft.com)
