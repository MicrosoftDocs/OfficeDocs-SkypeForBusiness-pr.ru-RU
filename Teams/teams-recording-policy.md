...
Интеграция решений для записи соответствия требованиям также была рассмотрена на веб-сайте Ignite 2019 в сеансе записи соответствия требованиям [<span class="underline">и Microsoft Teams.</span>](https://myignite.techcommunity.microsoft.com/sessions/83184?source=sessions)
...
| Тип                   | Удобство        | Функция         | Общие организации      | Организация — регулируемый | Правоохранительный перехват   |
| ---------------------- | ------------------ | ------------------ | ------------------ | --------------- | ------------------ |
| Инициатор              | Пользователь               | Приложение или решение       | Администратор (система)     | Администратор (система)  | LEA                |
| Целевой объект                 | Per-call /meeting | Per-call /meeting | Per-call /meeting | На пользователя        | Per-endpoint / DID |
| Владелец хранилища          | Пользователь               | Приложение                | Администратор              | Соответствие требованиям      | LEA                |
| Требуется уведомление? | Да                | Да                | Да                | Да             | Нет                 |
| Владелец Access           | Пользователь               | Приложение                | Администратор              | Соответствие требованиям      | LEA                |
