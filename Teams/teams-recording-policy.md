...
<li><p>Отслеживайте и устраняйте проблемы, связанные с записью, при Teams звонках и собраниях.</p></li>
...
Поддержка уведомлений включена с помощью Teams клиента. Эти функции могут быть визуальными или звукоемкими.
