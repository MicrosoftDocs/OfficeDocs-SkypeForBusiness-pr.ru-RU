...
Группами Майкрософт предоставляет наиболее аудио, видео и содержимого, общий доступ к взаимодействия вне зависимости от вашей сети. С помощью переменной кодеков мультимедиа можно согласовать в средах с ограниченной пропускной способностью с минимальное влияние. Однако если пропускной способности не относится к, каждый раз можно оптимизировать качества, в том числе копирование для разрешения видео 1080p, до 30 кадров в секунду для видео и содержимого и высоким качеством звука.

В этой статье описываются четкое версии как использования пропускной способности звука в режиме реального времени рабочих групп, видео и модальности в различные варианты использования общего доступа к рабочему столу. Команды всегда высокого уровня безопасности на использование полосы пропускания и обеспечивают качества видео высокой Четкости в разделе 1.2 МБ. Потребление фактическая пропускная способность в каждом аудио-или видеозвонка или собрания будет изменяться в зависимости от нескольких факторов, таких как видео макет, разрешение видео и видео кадров в секунду.Если доступно несколько пропускной способности для обеспечения оптимального будет увеличиваться качество и использования.
...
|1Mps/2Mbps |Группа HD видео вызов (540p видео на экране 1080p) |
...
Чтобы получить оптимальную проблем при работе с мультимедиа в режиме реального времени в рамках группами Майкрософт, должны соответствовать требования к сети для Office 365. Дополнительные сведения см в [качестве мультимедиа и производительность подключения к сети для Скайп для бизнеса в Интернет](/SkypeForBusiness/optimizing-your-network/media-quality-and-network-connectivity-performance).

Два определение сегментов сети (клиент для пограничного сервера Microsoft) и граница клиента для пограничного сервера Microsoft должен отвечать следующим требованиям.
...
После загрузки и установки средства можно найти в файлах C:\Program (x86) \Microsoft Скайп для бизнеса средство оценки производительности сети. Подробное руководство по использованию средства Usage.docx, включенные в этот каталог.

### <a name="test-for-opened-ports"></a>Проверить наличие открытых портов

Откройте окно командной строки и перейдите к каталогу средство оценки производительности сети, введя **cd C:\Program Files (x86) \Microsoft Скайп для бизнеса средство оценки производительности сети**. В командной строке запустите тест для открытых портов, введя **networkassessmenttool.exe /connectivitycheck**
