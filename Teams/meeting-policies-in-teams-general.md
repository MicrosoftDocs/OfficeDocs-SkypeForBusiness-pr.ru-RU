...
По умолчанию эта политика отключена и позволяет организаторам видеть, кто зарегистрировался и посещал собрания и вебинары, которые они настроили. Чтобы включить эту настройку в Центре администрирования Teams, перейдите в параметр Политики собраний собраний и установите для отчета о взаимодействии параметр  >   **Включено**  .
...
- Если **Кто** разрешить всем  пользователям, в том числе анонимным пользователям, регистрировать вебинары, которые настроены пользователями в вашей организации, и принять участие в них.
