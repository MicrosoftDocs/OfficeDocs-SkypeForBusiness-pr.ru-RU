...
- ["Встретиться сейчас в каналах"](#meet-now-in-channels)
- [Outlook надстройки](#outlook-add-in)
- [Планирование собраний в канале](#channel-meeting-scheduling)
- [Планирование частных собраний](#private-meeting-scheduling)
- [Собрание на частных собраниях](#meet-now-in-private-meetings)
- [Режим роли "Назначенный литерер"](#designated-presenter-role-mode)
- [Отчет о взаимодействии](#engagement-report)
- [Регистрация на собрании](#meeting-registration)
- [Кто можете зарегистрировать](#who-can-register)
- [Режим поставщика собраний для островов](#meeting-provider-for-islands-mode)

## <a name="meet-now-in-channels"></a>"Встретиться сейчас в каналах"

Это политика для пользователя, которая применяется перед началом собрания. Этот параметр управляет возможностью пользователя начать собрание в Teams канале. Если вы включили эту  возможность, пользователи могут нажать кнопку Собрание, чтобы начать собрание или запланировать собрание в канале. Значение по умолчанию — True.
...
## <a name="channel-meeting-scheduling"></a>Планирование собраний в канале
...
## <a name="private-meeting-scheduling"></a>Планирование частных собраний
...
## <a name="meet-now-in-private-meetings"></a>Собрание на частных собраниях
...
Эта политика по умолчанию установлена и позволяет организаторам видеть, кто зарегистрировался и посещал собрания и вебинары, которые они настроили. Чтобы отключить его в Центре администрирования Teams, перейдите к политике собраний собраний и установите для отчета о взаимодействии параметр  >   **Выключить**. 

Вы также можете изменить существующую политику Teams собрания с помощью [cmdlet Set-CsTeamsMeetingPolicy.](/powershell/module/skype/set-csteamsmeetingpolicy) Или создайте политику собраний Teams с помощью командлета [New-CsTeamsMeetingPolicy](/powershell/module/skype/new-csteamsmeetingpolicy) и назначьте ее пользователям.

По умолчанию параметр **AllowEngagementReport** имеет значение **Enabled** in PowerShell. Чтобы предотвратить загрузку отчета об посещении собрания организатором собрания, установите для параметра **AllowEngagementReport (РазрешитьEngagementReport)** **разрешение Отключено.**

Если эта политика включена, в области Участники отображается параметр для скачивания отчета об **посещении** собрания.

> [!NOTE]
> Как администратор вы не можете просматривать отчет об посещении собраний, которые не организовывали. Однако вы можете просмотреть сведения об участниках для данного собрания в течение 24 часов после собрания. В Центре Teams пользователей перейдите в **управление**  >  **пользователями**. Выберите отображаемую именем организатора собрания. На **вкладке Собрания & вызовов,** а затем выберите соответствующий ИД собрания или ИД звонка. Затем выберите **Сведения об участниках**.

Дополнительные сведения, в том числе об ограничениях для отчета о взаимодействии, см. в этой [Teams.](https://support.microsoft.com/office/view-and-download-meeting-attendance-reports-in-teams-ae7cf170-530c-47d3-84c1-3aedac74d310)
...
Чтобы включить регистрацию собрания, установите для **параметра MeetingRegistration (Собрание)** true **(Истина).** По умолчанию установлено **значение True.**
...
Эта политика управляет тем, какие пользователи могут регистрироваться и посещать вебинары. Эта политика имеет два параметра, которые доступны только в том случае, если **включена** регистрация на собрании.
...
- Если **Кто** разрешить регистрацию  и участие в вебинасах, установите для Кто все пользователи в организации.

По умолчанию для **Кто по** умолчанию установлено значение **Все**. Чтобы изменить эту политику в Центре администрирования Teams, перейдите в статью Политики собраний  >  **собраний.**
...
Чтобы разрешить регистрацию и участие в вебинасах только пользователям в организации, за установите для параметра **EveryoneInCompany параметр EveryoneInCompany.**
