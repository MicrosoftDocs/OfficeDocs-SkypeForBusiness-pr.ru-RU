...
- [Отчет об посещении собрания](#meeting-attendance-report)
...
## <a name="meeting-attendance-report"></a>Отчет об посещении собрания
...
Чтобы разрешить организатору собрания загружать отчет об посещении собрания, установите для **параметра AllowEngagementReport (РазрешитьEngagementReport)** параметр **Enabled (Включено).** Если этот параметр включен, опция для скачивания отчета отображается в области **Участники**. По умолчанию этот параметр включен.
