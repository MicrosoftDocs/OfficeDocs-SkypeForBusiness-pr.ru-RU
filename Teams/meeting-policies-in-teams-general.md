...
По умолчанию эта политика отключена и позволяет организаторам видеть, кто зарегистрировался и посещал собрания и вебинары, которые они настроили. Чтобы включить эту возможность в Центре администрирования Teams, перейдите к политике собраний собраний и установите для нее нужное  >   **для нее место Включено**.
