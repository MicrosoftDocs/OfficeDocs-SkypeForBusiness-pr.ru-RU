...
Если пользователям не назначены SharePoint лицензии, у них нет OneDrive хранилища Microsoft 365. Общий доступ к файлам работает в стандартных каналах, но пользователи не смогут делиться файлами в чатах без OneDrive хранения в Microsoft 365.

При хранении файлов в библиотеке SharePoint и OneDrive правила соответствия требованиям, настроенные на уровне организации, будут следовать. 
...
Обратите внимание, что для общедоступных SharePoint группы предусмотрен доступ "Все, кроме внешних пользователей". Команда не отображается в Teams для людей, которые не являются ее членами. Однако они могут получать доступ к контенту SharePoint сайта группы, используя URL-адрес SharePoint сайта группы. 
