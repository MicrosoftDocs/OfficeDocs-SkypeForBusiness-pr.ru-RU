...
ms.collection:
- M365-collaboration
description: Узнайте об истечении срока действия и продлении группы, а также об использовании политики Microsoft 365 срока действия групп для автоматической очистки неиспольз в Microsoft Teams.
f1.keywords:
- NOCSH
appliesto:
- Microsoft Teams
