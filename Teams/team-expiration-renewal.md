...
Чтобы свести в порядок количество неиспольз [](/microsoft-365/admin/create-groups/office-365-groups-expiration-policy) вами команд, администратор может использовать Microsoft 365 срока действия групп для автоматической очистки неиспольз вами команд. Так как в командах есть группы, политики срока действия групп также автоматически применяются и к командам.
