...
|Задайте себе вопрос|Действие |
|------------|-------|
|<ul><li>Нужно ли мне отключить внешний доступ для моей организации?</li><li>Если эта возможность включена, смогу ли я указать, какие домены могут подключиться к моей организации?</li></ul> |<br>Чтобы включить или отключить внешний доступ, ознакомьтесь со статьей [Планирование внешнего доступа](manage-external-access.md#plan-for-external-access).|
