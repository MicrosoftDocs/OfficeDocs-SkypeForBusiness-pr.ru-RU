...
Приложения закреплены на панели приложений, которая находится сбоку от Teams и в нижней части мобильных клиентов Teams (iOS и Android).
...
4. Включите или **отключите** закрепление пользователя в зависимости от того, хотите ли вы позволить пользователям персонализировать свои панели приложений, прикрепив приложения к ней.
...
4. Включите или **отключите Upload** приложения в зависимости от того, хотите ли вы разрешать пользователям загружать пользовательские приложения Teams.
