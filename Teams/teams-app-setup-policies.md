...
- **Закрепление приложений:** с помощью политик настройки приложений можно выбирать приложения для закрепления, устанавливать порядок их показа для пользователей и управлять возможностью закрепления собственных приложений на панели Teams приложений. Дополнительные сведения см. в теме [Закрепление приложений](#pin-apps).
...
4. Включите **или отключите** закрепление пользователей в зависимости от того, хотите ли вы позволить пользователям персонализировать свои панели приложений, прикрепив приложения к ней.
...
4. Включите или **отключите Upload настраиваемые** приложения в зависимости от того, хотите ли вы разрешать пользователям загружать пользовательские приложения Teams.
...
Помните, что в Teams приложений перечислены все Teams приложения. В **области Добавить закрепленные** приложения доступны только приложения, которые можно закрепить Teams с помощью политики.

#### <a name="im-a-teams-for-education-admin-what-do-i-need-to-know-about-app-setup-policies-in-teams-for-education"></a>Я администратор Teams для образования администратором. Что нужно знать о политиках настройки приложений в Teams для образования
...
Пользователи могут изменять порядок закрепленных приложений на Teams и мобильных клиентах, если включен параметр Закрепление  пользователя. Пользователи не могут изменить порядок закрепленных приложений в Teams клиентах.
