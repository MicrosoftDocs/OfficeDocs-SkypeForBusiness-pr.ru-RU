...
- **Установка приложений:** с помощью политик настройки приложений вы можете устанавливать приложения от имени пользователей при Teams и во время собраний. Дополнительные сведения см. в [установке приложений.](#install-apps)
...
> [!NOTE]
> Если у вас Teams для образования, важно знать, что приложение "Задания" по умолчанию закреплено в глобальной политике, хотя в настоящее время оно не указано в глобальной политике. Это будет четвертое приложение в списке закрепленных приложений в Teams клиентах.
...
В Центре администрирования Microsoft Teams создать настраиваемую политику, которая позволяет пользователям загружать пользовательские приложения в Teams.
...
Не все приложения можно закрепить на Teams с помощью политики настройки приложений. Некоторые приложения могут не поддерживать эту функцию. Чтобы найти приложения, которые можно закрепить, найдите их в области Добавление **закрепленных** приложений. Вкладки с личной областью (статическими вкладками) и ботами можно закрепить на Teams настольном клиенте, и эти приложения доступны в области Добавление **закрепленных** приложений.

Помните, что в Teams app Store перечислены все Teams приложения. В **области Добавить закрепленные** приложения доступны только приложения, которые можно закрепить Teams с помощью политики.
...
Сторонние приложения (которые можно скачать из Teams Store) должны быть утверждены, прежде чем они будут доступны на мобильном устройстве. Если администратор закрепит приложение, которое не было неохвачено корпорацией Майкрософт для мобильных устройств, оно будет отстрячено на рабочем столе Teams, но не на мобильном устройстве. Дополнительные [сведения см. в](/microsoftteams/platform/tabs/what-are-tabs#mobile-clients) мобильных клиентах.

С помощью Teams мобильных клиентов пользователи будут видеть основные Teams, такие как действия, чат и Teams, и вы можете закрепить некоторые приложения от Майкрософт, например Shifts.
...
Пользователи могут изменять порядок закрепленных приложений на Teams клиентах  для настольных компьютеров и мобильных устройств, если включен параметр Разрешить закрепление пользователей. Пользователи не могут изменять порядок закрепленных приложений в Teams веб-клиентах.
