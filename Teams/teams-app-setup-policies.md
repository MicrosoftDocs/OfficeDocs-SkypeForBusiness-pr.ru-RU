...
ms.locfileid: "66838804"
---
# <a name="manage-app-setup-policies-in-microsoft-teams"></a>Управление политиками настройки приложений в Microsoft Teams

Администраторы используют политики установки приложений для установки и закрепления приложений, а также позволяют пользователям отправлять пользовательские приложения. Закрепление помогает повысить уровень внедрения соответствующих приложений в организации.
...
* **Установка приложений:** Политики установки приложений позволяют устанавливать разрешенные приложения от имени пользователей при запуске Teams и во время собраний. Дополнительные сведения см. в разделе ["Установка приложений"](#install-apps).
...
Закрепление приложений позволяет выделять приложения, которые больше всего нужны пользователям в вашей организации. Закрепление работает для приложений, предоставляемых корпорацией Майкрософт, независимых поставщиков программного обеспечения и разработчиками в организации. Закрепление приложения с помощью политики установки приложения также устанавливает его, если приложение разрешено пользователю. С помощью политики установки приложения можно выполнить следующие задачи:
