...
Приложения закреплены на панели приложений, которая находится в Teams и в нижней части Teams (iOS и Android).
...
Дополнительные сведения о назначении политик пользователям см. в группе Назначение политик [пользователям и группам](assign-policies-users-and-groups.md).
...
Пользователи могут изменить порядок закрепленных приложений на Teams и мобильных клиентах, если включен параметр Закрепление  пользователя. Пользователи не могут изменить порядок закрепленных приложений в Teams клиентах.
