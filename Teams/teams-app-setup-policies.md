...
4. Включите или отключите разрешение закрепления пользователей **в** зависимости от того, хотите ли вы позволить пользователям персонализировать свои панели приложений, прикрепив приложения к ней.
...
Вы можете выбрать приложения, установленные по умолчанию для пользователей в личной среде Teams, установить приложения в качестве расширений для обмена сообщениями [и](/microsoftteams/platform/messaging-extensions/what-are-messaging-extensions)назначить приложения, которые будут устанавливаться на собраниях.
...
> [!NOTE]
> Пользователи по-прежнему могут устанавливать [](teams-app-permission-policies.md) приложения самостоятельно, если это разрешает назначенная им политика разрешений.
...
Не все приложения можно закрепить на Teams с помощью политики настройки приложений. Некоторые приложения могут не поддерживать эту функцию. Чтобы найти приложения, которые можно закрепить, найдите их в области Добавление **закрепленных** приложений. Вкладки, которые имеют личные области (статические вкладки) и боты можно закрепить на Teams настольном клиенте, и эти приложения доступны в области Добавление **закрепленных** приложений.

Помните, что в Teams приложениях Teams приложения. В **области Добавить закрепленные** приложения доступны только приложения, которые можно закрепить Teams с помощью политики.
...
Пользователи могут изменять порядок закрепленных приложений на Teams клиентах  для настольных компьютеров и мобильных устройств, если включен параметр Разрешить закрепление пользователей. Пользователи не могут изменить порядок закрепленных приложений в Teams клиентах.
