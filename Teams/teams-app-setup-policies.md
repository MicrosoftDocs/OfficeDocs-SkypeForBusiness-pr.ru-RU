...
1. В левой области навигации Центра [администрирования Teams](https://www.admin.teams.microsoft.com) перейдите к Teams **appsSetup** >  **policies**.

2. Нажмите **Добавить**.

3. Введите имя и описание для политики.

4. **Включит закрепление пользователей**.
...
8. На панели **приложений или** в **расширениях** сообщений расположить приложения в том порядке, в которых они должны отображаться в Teams.
