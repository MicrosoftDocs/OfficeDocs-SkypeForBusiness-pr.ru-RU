...
> [!NOTE]
> Команды должны быть включены в домашнем клиенте гостя, чтобы гости могли войти в него и использовать Teams в качестве гостя в другом (ресурсе) клиенте.
...
- Лицензии учитываются в вашей организации независимо от того, являются ли приглашенные гости из другой организации Microsoft 365 или используют свои личные адреса электронной почты.
