...
4. Если включить уведомления,  выберите имена или номера телефонов в типе объявления "Запись/выход", а затем включите "Попросить вызывающих вас записать свое имя перед присоединением к **собранию".**
