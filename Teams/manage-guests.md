...
**Гость** — это тип пользователя в Microsoft Teams, который входит в состав подписок Microsoft 365 Business Standard, Office 365 для бизнеса, Microsoft 365 Business Basic и Office 365 для образования. Дополнительная лицензия Microsoft 365 не требуется. Ознакомьтесь с дополнительными сведениями о [лицензировании гостевой доступа](#guest-access-licensing-limits) ниже.

Функция гостевого доступа Teams действует на уровне клиента и по умолчанию отключена. Подробные сведения о том, как включить гостевой доступ, можно найти [в разделе совместная работа в группе "гости](https://docs.microsoft.com/microsoft-365/solutions/collaborate-as-team)".
