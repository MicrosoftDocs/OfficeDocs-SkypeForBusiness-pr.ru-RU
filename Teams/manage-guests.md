...
Если вы планируете Попросите пользователей гостевой просмотрите собственные доступа, ознакомьтесь со сведениями о лицензирование гостевой пользователя. Для получения дополнительных сведений см. [: Лицензирование совместной работы Azure AD B2B](https://docs.microsoft.com/en-us/azure/active-directory/b2b/licensing-guidance).
