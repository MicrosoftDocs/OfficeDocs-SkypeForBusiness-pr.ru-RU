...
- Excel, PowerPoint, Word и PDF-файлы необходимо добавить на  вкладку Файлы, чтобы их можно было преобразовать в вкладки. Любой добавленный файл можно преобразовать на вкладку одним щелчком мыши, как показано ниже.
...
Кроме встроенных вкладок, вы можете разрабатывать и разрабатывать собственные вкладки для интеграции с Teams или совместной работы с другими сообществами. Дополнительные сведения см. в [документации для разработчиков](/microsoftteams/platform/tabs/what-are-tabs).
