...
- Calling Plans
- seo-marvel-apr2020
description: Узнайте, как использовать центр администрирования Microsoft Teams или Windows PowerShell для создания телефонных планов (наборных групп звонков по ЗВОНКОВ) и управления ими.
ms.openlocfilehash: e6cc5e751efa412c24eb13f182ab5967360c677e
ms.sourcegitcommit: 556fffc96729150efcc04cd5d6069c402012421e
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/26/2021
ms.locfileid: "58628381"
---
...
- [Заявление об отказе от ответственности для экстренных вызовов](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/emergency-calling/emergency-calling-label-(en-us)-(v.1.0).zip?raw=true)
