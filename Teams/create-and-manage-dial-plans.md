...
### <a name="assign-a-dial-plan-to-users"></a>Назначение абонентской группы пользователям

Абонентская группа назначается точно так же, как и политики. [!INCLUDE [assign-policy](includes/assign-policy.md)]
