...
В этой статье рассматриваются различные способы назначения политик пользователям и группам в Microsoft Teams. Перед чтением убедитесь, что вы прочитали статью Назначение политик в Teams [- начало работы](policy-assignment-overview.md).
