...
> [!NOTE]
> В настоящее время назначение политик группам, использующим Центр администрирования Microsoft Teams, доступно только для политик Teams звонков, политики парков звонков Teams, политики Teams, политики трансляций Teams Teams, политики собраний и политики Teams сообщений. Для других типов политик используйте PowerShell.
...
В этом примере группе со ранжированием 1 назначается Teams собраний с именем Политика собраний диспетчеров розничной торговли.
