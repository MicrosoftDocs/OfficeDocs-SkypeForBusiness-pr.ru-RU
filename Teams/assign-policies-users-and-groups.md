...
![Назначьте политику пользователю в Центре администрирования Teams.](media/assign-policy-user.png)
...
|Группа |Имя политики звонков Teams  |Rank (Ранг)|
|---------|---------|---|
...
![Назначьте политику группе в Центре администрирования Teams.](media/assign-policy-group.png)
...
|Вспомогательный   |Политика дочерних подразделений        |4         |
...
|Вспомогательный   |Политика дочерних подразделений        |3        |
