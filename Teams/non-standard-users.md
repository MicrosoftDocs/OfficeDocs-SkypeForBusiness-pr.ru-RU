...
ms.locfileid: "60846092"
---
# <a name="microsoft-teams-apps-behavior-for-non-standard-users"></a>Microsoft Teams для нестандартных пользователей

В этой статье описано поведение приложений в Teams, когда гостевых, внешних (федеранных) и анонимных пользователей присутствует в Teams контексте.
