...
Внешние пользователи не могут устанавливать, обновлять и удалять приложения в любом контексте, например в личном чате, канале или на собрании. У них нет доступа к Teams app store организации размещения.
...
Анонимные пользователи не могут напрямую использовать приложения на собраниях. Пользователи, которые являются ее пользователями, могут продолжать использовать приложения для собраний, если на собрании присутствуют анонимные пользователи. Если приложение отправляет в чат адаптивную карточку, с ней могут взаимодействовать анонимные пользователи. Дополнительные сведения можно найти в [документе Разрешить анонимным пользователям присоединяться к собраниям.](meeting-settings-in-teams.md#allow-anonymous-users-to-join-meetings)
