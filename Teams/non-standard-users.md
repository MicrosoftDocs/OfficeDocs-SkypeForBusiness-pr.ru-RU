...
- Пользователи из других организаций соблюдают стандартную политику разрешений пользователей и параметры для всей организации.
- Пользователи в организации размещения могут добавлять приложения в чаты собраний с пользователями из других организаций. Люди из других организаций не могут добавлять приложения в чаты собраний, но могут взаимодействовать с ботами и вкладками, добавленными в чат.
- После установки бота в чате он может заблаговременно общаться с людьми из других организаций в чате, а эти люди могут общаться с ботом.
