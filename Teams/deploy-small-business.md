...
> [!TIP]
> Чтобы узнать больше о собраниях и событиях, пройдите модуль [Управление собраниями, конференциями и событиями в Microsoft Teams](https://docs.microsoft.com/learn/modules/m365-teams-collab-manage-meetings) в Microsoft Learn.
