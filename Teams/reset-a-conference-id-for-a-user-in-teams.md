...
> [!NOTE]
> Идентификаторы конференций создаются автоматически, будут находиться в диапазоне 7-9 цифр, и они устанавливаются при включении голосовой конференции для пользователя. **Статические идентификаторы конференций не поддерживаются.** 
...
- Служба Teams создает номер конференции с 7-9 цифрами. Изменить ее длину нельзя.
