...
> [!NOTE]
> Для стандартных каналов поддерживается контроль каналов. Она недоступна для каналов общего доступа и для частных каналов.
...
В Teams для образовательных учреждений преподаватели хотят использовать канал, чтобы привлечь внимание учащихся к конкретным аудиторским материалам.
