...
По умолчанию модерирование отключено, то есть стандартные параметры канала применяются к владельцам и участникам команды. Например, вы можете запретить новые записи только участникам команды или разрешить всем, включая гостей, начинать новые записи.
