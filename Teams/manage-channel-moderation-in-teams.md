...
В Microsoft Teams владельцы команд могут включить модерирование для стандартного канала, чтобы контролировать, кто может начинать новые записи и отвечать на записи в этом канале.
...
- Укажете, могут ли участники группы отвечать на существующие сообщения канала и могут ли боты и соединители отправлять сообщения в канале.

## <a name="scenarios"></a>Scenarios

Вот несколько примеров того, как ваша организация может использовать модерирование каналов в Teams.
...
### <a name="use-a-channel-for-class-discussions-in-teams-for-education"></a>Использование канала для обсуждений класса в Teams для образовательных сфере

В Teams для образования преподаватель хочет использовать канал, чтобы привлекать учащихся к обсуждению определенных тем аудиторий.
...
Модерирование канала — это параметр для каждого канала. Настройка модерации канала на уровне клиента не существует. Если вы хотите, чтобы мы добавили параметр модерации канала на уровне клиента, задайте его на [сайте UserVoice для Teams.](https://microsoftteams.uservoice.com/)
...
В **группе Кто является модератором?** щелкните **Управление**, а затем добавьте или удалите участников группы в качестве модераторов. Владельцы и модераторы команд могут добавлять и удалять других модераторов.  
