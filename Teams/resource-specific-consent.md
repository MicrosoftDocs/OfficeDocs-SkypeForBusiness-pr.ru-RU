...
2. В **Enterprise приложений** установите для  приложений разрешение Пользователи могут соглашаться на доступ к приложениям, которые имеют доступ к данным компании от своего имени, **на "Нет"** или **"Да".**
...
Этот параметр приложения для всей организации контролирует возможность использования сторонних приложений пользователями в вашей организации. Этот параметр должен быть включиться, чтобы владельцы команды могли дать согласие. Чтобы управлять этим параметром, сделайте следующее:
