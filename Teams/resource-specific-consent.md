...
Следующие два параметра определяют, смогут ли владельцы команд предоставить согласие на приложения.
...
Этот параметр приложения для всей организации контролирует возможность использования сторонних приложений пользователями в организации. Этот параметр должен быть включиться, чтобы владельцы команд могли предоставить согласие. Чтобы управлять этим параметром, сделайте следующее:
