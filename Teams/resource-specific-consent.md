...
#### <a name="the-users-can-consent-to-apps-accessing-company-data-on-their-behalf-setting"></a>Пользователи могут дать согласие приложениям, которые имеют доступ к корпоративным данным от их имени.
...
#### <a name="the-allow-third-party-apps-option-in-org-wide-app-settings"></a>Параметр "Разрешить сторонние приложения" в параметрах приложения для всей организации
...
1. Выберите **параметры приложений для всей** организации и в разделе сторонних **приложений** отключите или включите разрешение **сторонних приложений**.
   ...
   :::image type="content" source="media/resource-specific-consent-org-wide-setting.png" alt-text="Снимок экрана: разрешение сторонних приложений в параметре Teams.":::
