...
Администраторы могут ли владельцы команд в вашей организации предоставлять согласие с помощью параметров, настроенных с помощью модуля PowerShell Azure Active Directory (Azure AD) или портал Azure и центра администрирования Microsoft Teams.  
...
1. В портал Azure перейдите **к Enterprise параметров** > **пользователя приложений**.
2. В **Enterprise приложениях** задайте для  пользователей разрешение на доступ к приложениям, которые имеют доступ к корпоративным данным от их имени, на значение **"Нет**" или "**Да"**.
...
2. В **приложениях сторонних производителей** отключите или включите разрешение **сторонних приложений**.
...
2. На странице "Управление приложениями" выберите приложение и нажмите кнопку **"** Блокировать", чтобы заблокировать его, или нажмите кнопку **"** Разрешить".
...
1. В левой области навигации центра Microsoft Teams перейдите к разделу "Пользователи **"**.
...
3. Политика, назначенная владельцу команды, указана в разделе **"Политика разрешений приложения"**.
    ...
    - Чтобы изменить параметры политики, назначенной владельцу команды, щелкните имя политики и внесите необходимые изменения.  
