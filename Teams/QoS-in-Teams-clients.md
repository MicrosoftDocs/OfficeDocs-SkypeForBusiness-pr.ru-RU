...
1. В области управления групповыми политиками найдите контейнер, в котором нужно создать новую политику. Например, если все клиентские компьютеры находятся в OU **Clients,** новая политика должна быть создана в этом клиенте.
...
1. В командной подсказке введите
...
1. В командной подсказке введите
   ...
   При этом будет создаваться отчет об примененных GGPOS и отправляться в текстовый файл *сgp.txt.*
