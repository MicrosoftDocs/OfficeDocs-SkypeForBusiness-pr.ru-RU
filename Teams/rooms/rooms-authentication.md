...
Чтобы убедиться, что проверка подлинности выполнена для локального сервера Exchange Server и/или Skype для бизнеса Server, необходимо убедиться, что учетная запись ресурса, используемая в комнатах Microsoft Teams, настроена на получение авторизации из Azure AD. Чтобы узнать больше о гибридных удостоверениях и методах, которые можно использовать в вашей организации, ознакомьтесь со следующими разделами: 
