...
1. На Комнаты Microsoft Teams перейдите к **дополнительным** (**...**).
...
В SkypeSettings.xml xML-элементе современной проверки подлинности установите для элемента **True** (Истина).
...
Прежде чем начать, убедитесь, что вы знаете, как использовать модели удостоверений Office 365 и Azure AD. Дополнительные сведения можно найти в Office 365 удостоверений и [Azure Active Directory и в](/Office365/Enterprise/about-office-365-identity) гибридных удостоверениях и синхронизации каталогов для Microsoft 365 [или Office 365](/Office365/Enterprise/plan-for-directory-synchronization).
...
Необходимые условия для современной проверки подлинности в гибридной топологии можно найти в обзоре гибридной современной проверки подлинности и необходимые условия для ее использования с Skype для бизнеса и [Exchange серверах](/office365/enterprise/hybrid-modern-auth-overview). Применяются все необходимые условия, рассмотренные в этой статье.

Однако поскольку Комнаты Microsoft Teams использует авторизацию паролей [](https://tools.ietf.org/html/rfc6749#section-1.3.3) владельцев ресурсов и API REST для современной проверки подлинности, следует помнить о следующих важных различиях, которые Комнаты Microsoft Teams.
...
Вы можете настроить учетную запись ресурса, используемую Комнаты Microsoft Teams для доступа по IP-адресу или расположению. Дополнительные действия см. в теме [Условный доступ: блокировка доступа по расположению](/azure/active-directory/conditional-access/howto-conditional-access-policy-location).
