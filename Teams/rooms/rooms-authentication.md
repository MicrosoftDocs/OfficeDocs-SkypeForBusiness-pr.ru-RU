...
Прежде чем начать, убедитесь, что вы знаете, как использовать модели удостоверений Office 365 и Azure AD. Дополнительные сведения можно найти на Office 365 и Azure Active Directory [и](/Office365/Enterprise/about-office-365-identity) в гибридных удостоверениях и синхронизации каталогов для Microsoft 365 [или Office 365.](/Office365/Enterprise/plan-for-directory-synchronization)
...
- Комнаты Microsoft Teams не поддерживает несоответствие SIP и UPN. Чтобы учетная запись Комнаты Microsoft Teams с тем же ИП и SIP, необходимо создать учетную запись.
...
Чтобы включить гибридную современную проверку подлинности с помощью Skype для бизнеса Server, см. Skype для бизнеса локальном использовании [гибридной современной проверки подлинности.](/Office365/Enterprise/configure-exchange-server-for-hybrid-modern-authentication)
