...
description: Сведения об управлении администрированием клиента для распознавания речи (голосового профиля) в комнатах для собраний Teams.
...
2. Задайте параметры устройства Teams в соответствии с микрофоном и динамиком интеллектуального динамика.
...
|-|-|-|
|enrollUserOverride|Используется для настройки записи голосового профиля или регистрации в параметрах Teams для клиента. |**Отключено**<br><ul><li> Пользователи, которые никогда не регистрируются, не могут просматривать, регистрировать или повторно регистрироваться.<li>Точка входа в поток регистрации будет скрыта.<li>Если пользователи выбирают ссылку на страницу регистрации, они видят сообщение о том, что эта функция не включена для организации.  <li>Зарегистрированные пользователи могут просматривать и удалять свой профиль голосовой связи в параметрах Teams. После удаления голосового профиля он не сможет просматривать, получать доступ к потоку регистрации или выполнять его.</li></ul><br>**Включено**<br><ul><li> Пользователи могут просматривать, получать доступ к потоку регистрации и выполнять его.<li>Точка входа будет отображаться на странице параметров Teams на **вкладке "Распознавание** ".</li></ul>|
...
|AllowTranscription|Требуется для учетных записей пользователей и комнат Teams.|**True** и **False**|
||||

В Центре администрирования Teams задайте **политику транскрибирования** . Параметры **отключены** по умолчанию.
...
**Используются ли данные голосового профиля в службах Майкрософт?**

Нет, данные голосового профиля используются только для целей, для которых пользователь предоставил согласие. Корпорация Майкрософт не будет использовать данные профиля голосовой связи, за исключением сценариев распознавания голоса Teams.
