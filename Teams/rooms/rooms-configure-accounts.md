...
Если у вас уже есть учетная запись почтового ящика ресурса, настроенная для места собрания, в котором Комнаты Microsoft Teams, вы можете сделать эту учетную запись ресурса учетной записью устройства. После этого все, что вам нужно сделать, — добавить учетную запись устройства на Комнаты Microsoft Teams устройство. Примеры настройки учетной записи устройства см. ниже.
