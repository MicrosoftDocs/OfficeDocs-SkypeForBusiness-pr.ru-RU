...
В гибридных средах для учетной записи, используемой для комнат Microsoft Teams, должна быть включена синхронизация паролей в службе Azure Active Directory (AAD), так как для проверки подлинности в комнатах Microsoft Teams требуется Microsoft 365 или 365 Office При настройке учетной записи убедитесь в том, что адрес SIP учетной записи совпадает с именем участника-пользователя (UPN) в AAD. 
