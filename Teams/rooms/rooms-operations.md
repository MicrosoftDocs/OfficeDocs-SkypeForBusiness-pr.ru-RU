...
description: Прочел эту статью, чтобы узнать об управлении комнатами Microsoft Teams, системами комнат Skype нового поколения.
...
|net accounts /maxpwage:unlimited  <br/> Эквивалентные средства отключения срока действия паролей в локальной учетной записи. Невыполнение этого действия приведет к сбою при работе учетной записи Skype, которая жалуются на просроченный пароль. Обратите внимание, что это влияет на все локальные учетные записи на компьютере, поэтому невыполнение его данной процедуры также приведет к истечении срока действия учетной записи администратора в поле.  <br/> |Позволяет учетной записи Skype всегда выполнять вход.  <br/> |
...
2. Запустите следующий сценарий, нацеленный на устройства комнат Microsoft Teams, сменив его на \<share\> устройство с учетом необходимости:
...
Консоль снова находится в обычном режиме работы. Если клавиатура еще не подключена, к устройству необходимо будет прикрепить клавиатуру. 
  
### <a name="switching-to-admin-mode-and-back-when-the-microsoft-teams-rooms-app-crashes"></a>Переход в режим администрирования и обратно при сбое приложения "Комнаты Microsoft Teams"
