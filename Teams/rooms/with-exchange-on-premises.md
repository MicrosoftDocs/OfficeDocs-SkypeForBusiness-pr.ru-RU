...
- В этой записи в Skype для бизнеса Server. Для включения учетной записи устройства в вашей среде должны выполняться указанные ниже предварительные требования.
  ...
  - Если вам Корпоративная голосовая связь телефонии (телефонии ПС) с использованием поставщиков услуг телефонии для Комнаты Microsoft Teams необходимо Skype для бизнеса Online (план 3).
...
3. В Exchange PowerShell настройте следующие параметры почтового ящика комнаты, чтобы улучшить собрание:
   ...
   В этом примере эти параметры настраиваются для почтового ящика комнаты с именем Project-Рубель-01.
...
4. Чтобы включить учетную запись Комнаты Microsoft Teams, с помощью этой команды:
   ...
   Если вы не знаете, какое значение нужно использовать для параметра RegistrarPool в своей среде, вы можете получить это значение у существующего пользователя с помощью этой команды:
