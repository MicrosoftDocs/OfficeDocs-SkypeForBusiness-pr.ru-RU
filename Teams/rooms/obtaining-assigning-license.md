...
3. Выберите соответствующую **лицензию Комнаты Teams premium** для предполагаемого использования (доступны платные и пробные лицензии). Сравнение [номеров SKU Комнаты Microsoft Teams стандартный](rooms-licensing.md) уровня "Премиум" см. в разделе "Решения лицензирования для общих устройств связи".
...
5. Введите существующие **учетные Комнаты Microsoft Teams** для назначения **Комнаты Teams premium**. Дополнительные сведения о настройке новых (или проверке существующих) Комнаты Microsoft Teams учетных записях см. в статье "Создание учетных записей ресурсов для комнат и [общих устройств Teams"](with-office-365.md).
