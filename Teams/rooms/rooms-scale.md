...
| Среда WinPE после форматирования жесткого диска                                                         | C:\\_SMSTaskSequence\\журналы\\смстслог\\смстс. log    |
| Операционная система развернута перед установкой агента Configuration Manager | c:\\_SMSTaskSequence\\журналы\\смстслог\\смстс. log    |
