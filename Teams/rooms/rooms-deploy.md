...
**Совет по Pro** – сделайте отображаемые имена для этих учетных записей понятными и понятными. Ниже указаны имена, которые пользователи увидят при поиске и добавлении систем из комнат Microsoft Teams в собрания. В некоторых организациях используется соглашение с*названием комнаты* *сайта*-(*Максимальная емкость места*)-RS, поэтому например Curie — комнатная конференция из 12 человек в Лондоне — может иметь отображаемое имя со долготой Curie (12)-RS. 
