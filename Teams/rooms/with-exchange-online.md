...
2. Для подключения к Office 365 учетной записи пользователя должна быть Microsoft Teams. При наличии лицензии вам необходимо назначить учетной записи устройства место использования, которое определяет, какие номера SKU лицензий будут доступны вашей учетной записи.
