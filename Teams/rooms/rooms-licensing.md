...
|Инициировать собрание | Комнаты Microsoft Teams Стандартные или Premium  |Клиентская лицензия Server Standard для Skype для бизнеса  <br/> Клиентская лицензия Server Enterprise для Skype для бизнеса|
