...
> [!NOTE]
> Если вам назначены существующие лицензии для систем комнат, они будут работать без каких-либо перерывов. Следует перейти к использованию SKU Конференц-зал срок действия существующих лицензий.  
