...
В Microsoft есть два специальных номера номеров sk для лицензирования собраний и звонков на основе устройства для устройств с комнатами собраний (такими как комнаты Microsoft Teams, Microsoft Surface Hub и полосы совместной работы для Microsoft Teams).
...
|Начало ненадцатного собрания | Комнаты Microsoft Teams стандартный или премиум  |Клиентская лицензия Server Standard для Skype для бизнеса  <br/> Клиентская лицензия Server Enterprise для Skype для бизнеса|
|Начало ненадцатного собрания и звонок с телефонного номера из собрания |  Комнаты Microsoft Teams стандартный или премиум |Skype для бизнеса Клиентская лицензия Standard  <br/> Клиентская лицензия Server Enterprise для Skype для бизнеса|
|Придать комнате номер телефона и сделать или принять звонок из комнаты или присоединиться к аудиоконференции с помощью телефонного номера  | Прямая маршрутизации: комнаты Microsoft Teams стандартный или премиум<br/>Без прямой маршрутки: план внутренних или международных звонков<br/>Корпоративная голосовая связь Microsoft 365  |Клиентская лицензия Server Standard для Skype для бизнеса  <br/> Skype для бизнеса Клиентская лицензия Server Plus  |
|Управление устройством комнаты с помощью Microsoft Intune |Комнаты Microsoft Teams стандартный или премиум  |Подписка Microsoft Intune с локальной службой [MDM](https://docs.microsoft.com/configmgr/mdm/plan-design/plan-on-premises-mdm) |
