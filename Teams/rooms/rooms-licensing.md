...
В Microsoft есть два специальных номера номеров sk для лицензирования собраний и звонков на уровне каждого устройства для устройств с комнатами собраний (такими как комнаты Microsoft Teams, Microsoft Surface Hub и полосы совместной работы для Microsoft Teams).

||Стандартные комнаты Microsoft Teams |Комнаты Microsoft Teams Premium |
|:--- |:---: |:---: |
|Skype для бизнеса |&#x2714;| &#x2714;|
|Microsoft Teams|  &#x2714;|  &#x2714;|
|Телефонная система|  &#x2714;|  &#x2714;|
...
&sup3; Дополнительные сведения и сведения о доступности см. в службе, управляемой [комнатами Microsoft Teams.](microsoft-teams-rooms-premium.md)
...
|:-----|:-----|:-----|
|Присоединение к запланированному собранию  | Комнаты Microsoft Teams стандартный или премиум  |Клиентская лицензия Server Standard для Skype для бизнеса  |
|Инициировать собрание | Комнаты Microsoft Teams стандартный или премиум  |Клиентская лицензия Server Standard для Skype для бизнеса  <br/> Клиентская лицензия Server Enterprise для Skype для бизнеса|
|Начало собрания и звонок из собрания на телефонные номера |  Комнаты Microsoft Teams стандартный или премиум |Skype для бизнеса Клиентская лицензия Standard  <br/> Клиентская лицензия Server Enterprise для Skype для бизнеса|
|Придать комнате номер телефона и сделать или принять звонок из комнаты или присоединиться к аудиоконференции по номеру телефона  | Прямая маршрутизации: комнаты Microsoft Teams стандартный или премиум<br/>Без прямой маршрутки: план внутренних или международных звонков<br/>Корпоративная голосовая связь Microsoft 365  |Клиентская лицензия Server Standard для Skype для бизнеса  <br/> Skype для бизнеса Клиентская лицензия Server Plus  |
|Управление устройством комнаты с помощью Microsoft Intune |Комнаты Microsoft Teams стандартный или премиум  |Подписка Microsoft Intune с локальной службой [MDM](/configmgr/mdm/plan-design/plan-on-premises-mdm) |
|Управляемые службы комнат Microsoft Teams | Комнаты Microsoft Teams Premium ||
| |||
 ...
 **Используйте под себя под себя windows 10:** для клиентов, которые хотят развернуть изображения Windows 10 на своих устройствах, см. в настройках консоли [комнат Microsoft Teams.](./console.md) Вы можете получить копию из [Volume Licensing Service Center.](https://www.microsoft.com/Licensing/servicecenter/) 
