...
|Придать комнате номер телефона и позвонить или принять звонок из комнаты или присоединиться к аудиоконференции с помощью номера телефона  | При прямой маршрутике или операторе Подключение: Комнаты Microsoft Teams стандартный или Premium<br/>Без прямой маршрутии или оператора Подключение: план внутренних или международных звонков<br/>Корпоративная голосовая связь Microsoft 365  |Клиентская лицензия Server Standard для Skype для бизнеса  <br/> Skype для бизнеса Клиентская лицензия Server Plus  |
...
> [!NOTE]
> 
> Если вам назначены пользовательские лицензии для систем комнат (например, E3 или E5), они будут работать без каких-либо перерывов. Однако для того чтобы соблюдать будущие изменения, необходимо перейти к Конференц-зал лицензии при истечении срока действия назначенной лицензии пользователя.
> 
 ...
 Сведения о [лицензировании](../set-up-common-area-phones.md) общих телефонов с Microsoft Teams области можно найти в Телефон лицензии common Area Phones.
