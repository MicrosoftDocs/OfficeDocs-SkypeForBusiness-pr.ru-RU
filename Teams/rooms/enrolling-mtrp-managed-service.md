...
Пользователи, которым назначена роль администратора управляемых служб, отвечают за повседневное управление и мониторинг портала управляемой службы Комнаты Teams premium.
