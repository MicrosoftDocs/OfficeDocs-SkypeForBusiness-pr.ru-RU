...
4.  Выберите **Импорт** и выберите файл **SkypeRoomSystems_v2.omsview.**
5.  Нажмите **Сохранить**.
...
1.  Выберите **& числовом списке** из коллекции, а затем добавьте новую плитку.
