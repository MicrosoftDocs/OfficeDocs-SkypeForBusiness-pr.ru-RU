...
Существующие устройства **могут продолжать** работать после окончания поддержки программного обеспечения Skype Room System 1. Однако если это программное обеспечение попадает в ошибку программного обеспечения, которая требует от корпорации Майкрософт исправления, оно не будет поддерживаться. SRS v1 использует TLS 1.0/1.1, который в будущем будет отсутшен корпорацией Майкрософт. Подробнее о подготовке [к отсеву TLS 1.0/1.1.](https://techcommunity.microsoft.com/t5/Skype-for-Business-Blog/Preparing-for-TLS-1-0-1-1-Deprecation-O365-Skype-for-Business/bc-p/223608) 
