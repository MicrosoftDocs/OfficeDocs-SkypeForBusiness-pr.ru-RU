...
При настройках в комнате для проведения собраний согласованного собрания необходимо сообщить устройствам комнат Teams и устройствам Surface Hub, с которыми они согласованы. Для этого добавьте в конфигурацию имя пользователя (UPN) устройств, с которые они должны координироваться. Если вы не знаете имени пользователей-пользователей для каждого из устройств, которые вы хотите настроить для согласованных собраний, вы можете найти их в Центре администрирования Microsoft 365. 
...
8. Если **на вашем** компьютере включено видео, выберите "Позволить пользователям включить при присоединении к собранию" в области `true` **"Включить камеру этого устройства".**  Этот параметр нельзя отключить,  если включена камера этого _устройства._
