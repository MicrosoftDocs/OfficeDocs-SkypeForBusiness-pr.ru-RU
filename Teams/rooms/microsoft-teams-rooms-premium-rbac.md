...
- Администратор управляемой службы через портал управляемых служб Microsoft Teams Rooms
...
|Функции |Разрешение |Администратор управляемой службы  |"Завести сайт"  |Site Tech  |
|---------|---------|---------|---------|---------|
|Помещения     |Просмотр        |&#10004;           |&#10004;           |&#10004;  |
|    |Изменить         |&#10004;           |&#10004;           |&#10004; |
|    |Сброс ключа         |&#10004;           |         ||
...
6. На странице **"Область"** в поле "Поиск комнаты или группы комнат" введите имя группы комнаты или комнаты, управление ими которого будет разрешено пользователю.  Выберите **"Далее".**
