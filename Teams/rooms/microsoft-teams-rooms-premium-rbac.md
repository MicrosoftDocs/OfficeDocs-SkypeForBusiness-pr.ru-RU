...
Чтобы увидеть роли, в левой области навигации Комнаты Microsoft Teams службы перейдите в меню Роли **,** а затем выберите любую из ролей, чтобы увидеть свойства, разрешения и назначения роли.  
