---
title: Начало работы с группами Майкрософт
description: Используйте этот рекомендации помогут вам развернуть вашей первые несколько групп, можно начать с помощью чата группами Майкрософт, групп, каналов и собрания.
layout: LandingPage
...
ms.locfileid: "26520004"
---
# <a name="get-started-with-microsoft-teams"></a>Начало работы с группами Майкрософт
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Руководство по небольших групп развертывания, чтобы узнать о группах и составьте план развертывания масштабе организации</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Создание первого групп и каналы</h3>
                        <p>Советы и рекомендации по настройке первой группы и каналы</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Встроенный первыми</h3>
                        <p>Получите первый пользователей копирование и выполнение в новых рабочих групп, которую вы только что создали</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Отслеживание использования и свои отзывы и предложения</h3>
                        <p>Просмотреть использования вашей первыми групп</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Когда вы будете готовы к развертыванию группами для всей организации, будет показано, как</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Получение справки</h3>
                        <p>Как найти помощник, необходимые при использовании групп</p>
                    </div>
                </div>
            </div>
        </div>
