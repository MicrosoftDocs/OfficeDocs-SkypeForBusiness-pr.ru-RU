...
|Полное доменное имя (FQDN) для SBC|FQDN для SBC, где доменная часть FQDN является одним из зарегистрированных доменов в вашей Microsoft 365 или Office 365 организации. Дополнительные сведения см. в списке [доменных имен SBC.](#sbc-domain-names)|
...
[Требования к программе — доверенные корневые программы Майкрософт](/security/trusted-root/program-requirements) 
