...
- Используйте практически любую туловище ОКП с телефонная система. 
...
|Microsoft 365 организации|Организация Microsoft 365 которая используется для домашнего использования Microsoft Teams пользователей, а также конфигурацию и подключение к SBC.|
...
Пользователь Teams может начать звонок "один на один" Teams-к-500 или Teams к Teams и добавить в него участника. Этот сценарий называется конференцией. Путь к звонку зависит от того, назначена ли пользователю, который передает звонок, лицензии на аудиоконференцию Майкрософт:
...
Дополнительные сведения о лицензировании телефонная система см. в Office [](https://products.office.com/compare-all-microsoft-office-products?tab=2) и "Параметры плана" и Microsoft Teams [](/office365/servicedescriptions/office-365-platform-service-description/office-365-plan-options) лицензирования [надстройок](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md). 
...
- Распространенные телефоны с зонами. См[. настройка общих телефонов с](./set-up-common-area-phones.md) Microsoft Teams. Лицензия на план звонков не требуется при настройке общей области Телефон с прямой маршрутией.
...
На отгоне между облачным процессором мультимедиа и Microsoft Teams, используется КОМАНДАМЕСЯЦА или G.722. Выбор кодека в этом отгонке основан на алгоритмах Майкрософт, которые принимают во внимание несколько параметров. 
