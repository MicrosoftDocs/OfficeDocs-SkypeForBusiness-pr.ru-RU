...
|Microsoft 365 или Office 365 организации|Организация Microsoft 365 или Office 365, используемой для домашнего использования Microsoft Teams пользователей, а также конфигурацию и подключение к SBC.|
...
|IP-адреса и порты брандмауэра для прямых маршрутов |SBC передается следующим службам в облаке:<br/><br/>Прокси-сервер SIP, обрабатывающий сигнальную обработку<br/>Процессор мультимедиа, который обрабатывает мультимедиа (за исключением того, что в этом случае есть обход мультимедиа)<br/><br/>Эти две службы имеют отдельные IP-адреса в Microsoft Cloud, как описано далее в этом документе.<br/><br/>Дополнительные сведения см. в Microsoft Teams [URL-адреса](/office365/enterprise/urls-and-ip-address-ranges#skype-for-business-online-and-microsoft-teams) [и диапазоны IP-адресов.](/office365/enterprise/urls-and-ip-address-ranges) |
...
Пользователь Teams может начать лиховую учетную Teams STN или Teams, Teams позвонить и добавить в нее участника. Этот сценарий называется конференцией. Путь к звонку зависит от того, назначена ли пользователю, который передает звонок, лицензии на аудиоконференцию Майкрософт:
