...
description: Узнайте, как Microsoft Direct Routing позволяет подключить поддерживаемый клиентом контроллер границы сеанса (SBC) к телефонная система.
...
Прямая маршрутия позволяет подключить поддерживаемый клиентский контроллер границы сеанса (SBC) к телефонная система. С помощью этой возможности вы можете настроить подключение к локальной телефонной сети общего перейти на Microsoft Teams, как показано на схеме ниже. 
...
- Используйте практически любую магистраль ОКП с телефонная система. 

- Настройка взаимодействия между телефонным оборудованием, владельцем клиента, таким как сторонний частный обмен филиалами (УАКС), аналоговые устройства и Teams.
...
|Телефонные связи, подключенные к SBC|Одна или несколько телефонных дорожек, подключенных к SBC. С одной стороны, SBC подключается к телефонная система прямой маршрутике. SBC также может подключаться к сторонним объектам телефонии, таким как УАКС, аналоговые адаптеры телефонии и т. д. Все параметры подключения через ДНР, подключенные к SBC, будут работать. (Для настройки связи через STN с SBC обратитесь к поставщикам SBC.)|
|Microsoft 365 организации|Организация Microsoft 365, используемой для дома Microsoft Teams пользователей, а также конфигурацию и подключение к SBC.|
|Регистратор пользователей|Пользователь должен быть в Microsoft 365.<br/>Если в вашей организации есть локальное Skype для бизнеса или Lync с гибридным подключением к Microsoft 365, вы не сможете включить голосовую связь в Teams для локального пользователя.<br/><br/>Чтобы проверить регистратор пользователя, используйте следующий Skype для бизнеса Online PowerShell:<br/><code>Get-CsOnlineUser -Identity \<user> \| fl HostingProvider</code> <br/><br/>В результатах этого cmdlet должно быть:<br/><code>HostingProvider : sipfed.online.lync.com</code>|
...
|Полное доменное имя (FQDN) для SBC|FQDN для SBC, где доменная часть FQDN является одним из зарегистрированных доменов Microsoft 365 или Office 365 организации. Дополнительные сведения см. в списке [Доменные имена SBC](#sbc-domain-names).|
...
|IP-адреса и порты брандмауэра для прямых маршрутов |SBC передается следующим службам в облаке:<br/><br/>Прокси-сервер SIP, обрабатывающий сигнальную обработку<br/>Процессор мультимедиа, который обрабатывает мультимедиа (за исключением того, что в этом случае есть обход мультимедиа)<br/><br/>Эти две службы имеют отдельные IP-адреса в Microsoft Cloud, как описано далее в этом документе.<br/><br/>Дополнительные сведения см. в Microsoft Teams [URL-адресов и диапазонов IP-адресов](/office365/enterprise/urls-and-ip-address-ranges).[](/office365/enterprise/urls-and-ip-address-ranges#skype-for-business-online-and-microsoft-teams) |
...
Пользователям прямой маршрутии должны быть назначены следующие лицензии в Microsoft 365: 

- Телефон (Майкрософт) Система
- Microsoft Teams + Skype для бизнеса план 2, если он включен в лицензирование
- Аудиоконференция Майкрософт (ознакомьтесь с примечаниями и абзацем ниже, чтобы получить конкретные примеры того, когда требуется эта лицензия).)
...
Пользователь Teams может начать звонок "один на один Teams-к-500" или Teams-к-Teams и добавить в нее участника. Этот сценарий называется конференцией. Путь к звонку зависит от того, назначена ли пользователю, который передает звонок, лицензии на аудиоконференцию Майкрософт:
...
Прямая маршрутия также поддерживает пользователей, у которых есть лицензия на план звонков Майкрософт. телефонная система с помощью плана звонков можно перенаправить некоторые звонки с помощью интерфейса Direct Routing. Однако номера телефонов пользователей должны быть либо приобретены через Интернет, либо переносимы в корпорацию Майкрософт.  

Смешивание плана звонков и прямого перенаправки для одного пользователя необязательны, но могут быть полезны. Например, если пользователю назначен план звонков Майкрософт, но он хочет перена маршрутировать некоторые звонки с помощью SBC. Один из наиболее распространенных сценариев — звонки на сторонние УАКС.  При использовании сторонних УАКС все звонки, за исключением телефонов, подключенных к этой УАЦ, перенапрасковываются с помощью плана звонков Майкрософт, но звонки на телефоны, подключенные к сторонним УАКС, перенаправ в SBC, поэтому остаются в корпоративной сети, а не через ОКП. 

Дополнительные сведения о лицензировании телефонная система см. в Office и [](https://products.office.com/compare-all-microsoft-office-products?tab=2) "Параметры плана" и Microsoft Teams лицензирования [](/office365/servicedescriptions/office-365-platform-service-description/office-365-plan-options) [надстройки](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md). 
...
- Распространенные телефоны с зонами. См[. настройка общих телефонов с Microsoft Teams](./set-up-common-area-phones.md). Лицензия на план звонков не требуется при настройке общей области Телефон с прямой маршрутией.
...
На отгоне между процессором Cloud Media Процессором и Microsoft Teams, используется КОМАНДАМЕСЯЦА или G.722. Выбор кодека в этом отгонке основан на алгоритмах Майкрософт, которые принимают во внимание несколько параметров. 
...
Дополнительные сведения о поддерживаемых SBCs см. в теме [Контроллеры границ сеанса, удостоверенные для прямой маршрутики](direct-routing-border-controllers.md).
