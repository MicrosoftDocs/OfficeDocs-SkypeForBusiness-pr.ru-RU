...
Если вы хотите использовать новое доменное имя. К примеру клиент имеет contoso.com как имя domin, зарегистрированные в клиент. Необходимо использовать sbc1.sip.contoso.com. Прежде чем вы можете обеспечить SBC с именем sbc1.sip.contoso.com необходимо зарегистрировать sip.contoso.com имя домена в «Домены» в вашего клиента. Если вы попытаетесь связывания sbc1.sip.contoso.com SBC появится сообщение об ошибке «Могут не используйте домен «sbc1.sip.contoso.com» как он не был настроен для клиента».
После добавления доменное имя необходимо также создать пользователя с помощью имени участника-пользователя user@sip.contoso.com и assing lisence «Группы». Может потребоваться до 24 часов полностью Подготовка имя домена, после добавления в «Домены» клиента, пользователя с помощью нового создан и lisence, назначенных пользователю. 
