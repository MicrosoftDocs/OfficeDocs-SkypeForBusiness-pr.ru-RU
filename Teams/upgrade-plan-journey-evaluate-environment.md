...
В этой статье дается обзор требований для правильной оценки текущей среды для Teams. Оценивая свою среду, вы определяете риски и требования, которые влияют на общее развертывание. Заранее определяя эти элементы, вы можете скорректировать свое планирование, чтобы добиться успеха.

## <a name="introduction-to-the-discovery-questionnaire"></a>Введение в анкету обнаружения

Для достижения поставленных ключевых результатов вы ранее приняли ключевые решения о обслуживании. Далее необходимо выполнить обнаружение среды, чтобы оценить все аспекты, связанные с ИТ-инфраструктурой, сетью и операциями, чтобы подтвердить готовность организации к внедрению решения. Обнаружение — один из первых ключевых этапов, которые необходимо предпринять при планировании пути к Teams. Обнаружение среды должно включать оценку готовности сети, чтобы убедиться, что ваша сеть может поддерживать обновление до Teams. Вы выполняете подробное обнаружение среды, чтобы лучше понять ее текущее состояние, а также выявить все сложности или, что еще важнее, заблокировать выполнение Teams развернутого проекта.
