...
<table>
<tr><td>![](media/audio_conferencing_image7.png) <br/>Точка принятия решений</td><td><ul><li>Кто будет отвечать за выполнение оценки среды?</li></ul></td></tr>
<tr><td>![](media/audio_conferencing_image9.png)<br/>Следующий шаг</td><td><ul><li>Документирование результатов оценки производительности среды.</li></ul></td></tr>
</table>
