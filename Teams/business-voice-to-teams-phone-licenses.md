...
| ---------------- | ------------------------ | ----------- |
| Business Voice с тарифным планом | Телефонная система Teams с тарифным планом | Предоставляет облачные телефонная система и план внутренних звонков с майкрософт в качестве поставщика ТСОП. |
| Бизнес-голосовая связь без плана звонков | Телефонная система стандартная Teams | Предоставляет облачные телефонная система, которые можно сочетать с тарифным планом через стороннего поставщика ТСОП с помощью Operator Connect или [прямой маршрутизации.](pstn-connectivity.md) |
| Business Voice (любая версия) | Microsoft Team Аудиоконференции выбрать исходящий или Аудиоконференции | Предоставляет возможности для телефонного подключения и подключения участников собрания, упорядоченные лицензированным пользователем |
