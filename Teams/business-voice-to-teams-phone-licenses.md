---
title: Переход с корпоративной голосовой связи на Teams Телефон лицензий
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
description: Узнайте, как изменить лицензии корпоративной голосовой связи на Teams Телефон лицензий.
appliesto:
- Microsoft Teams
...
ms.locfileid: "66057099"
---
# <a name="move-from-business-voice-to-teams-phone-licenses"></a>Переход с корпоративной голосовой связи на Teams Телефон лицензий
...
Business Voice объединяет следующие три Teams надстройки:

- **Microsoft Teams Телефон** для облачного телефонная система в Microsoft Teams.
...
Эта статья предназначена для ИТ-администраторов, которым необходимо изменить лицензии Business Voice на Microsoft Teams Телефон и Аудиоконференции с сохранением тех же возможностей.
...
| ---------------- | ------------------------ | ----------- |
| Business Voice с тарифным планом | Teams Телефон с тарифным планом и Аудиоконференции Microsoft Teams с помощью подключения к США/CAN | Предоставляет облачные телефонная система, план внутренних звонков с майкрософт в качестве поставщика ТСОП, а также возможности телефонного подключения и исходящего подключения для участников собрания, упорядоченного лицензированным пользователем. |
| Бизнес-голосовая связь без плана звонков | Телефонная система стандартная Teams и Аудиоконференции Microsoft Teams с помощью подключения к США/CAN | Предоставляет облачные телефонная система, которые можно сочетать со сторонним планом звонков с поставщиком ТСОП с использованием [Operator Connect или](pstn-connectivity.md) прямой маршрутизации, а также функций телефонного подключения и телефонного подключения для участников собрания, упорядоченных лицензированным пользователем. |
...
1. После отмены выбора business Voice проверьте новые Teams Телефон и Аудиоконференции лицензии.
...
1. Получите идентификаторы новых Teams Телефон и Аудиоконференции клиента.
...
1. Обновите конфигурацию лицензий пользователей с Teams Телефон и Аудиоконференции планов.
...
1. Подключение клиенту Microsoft 365 и укажите учетные данные администратора клиента.
...
1. Используйте следующую таблицу, чтобы определить новые Teams Телефон и Аудиоконференции номеров SKU лицензии.
...
1. Создайте переменные PowerShell для хранения уникальных кодов Teams Телефон Аудиоконференции номеров SKU.
...
1. Прежде чем перейти к следующему, проверьте, включены ли в исходный номер SKU (Business Voice) и целевые номера SKU (Teams Телефон и Аудиоконференции) одинаковые планы обслуживания.
...
1. Теперь, используя новый список пользователей, выполните действие обновления, чтобы удалить лицензии Business Voice и добавить лицензии Teams Телефон и Аудиоконференции``$LicensesToUpdate``, используя созданный ранее объект.
...
> [!NOTE]
> Если у вас недостаточно доступных лицензий Teams Телефон и (или) Аудиоконференции для замены Корпоративной голосовой связи, вы получите сообщение об ошибке Subscription с **идентификатором guid SKU**, которое не имеет доступной лицензии во время назначения пользователя, как только пул лицензий будет исчерпан.
...
1. Перейдите **Azure Active Directory** и в меню слева выберите "**Лицензии"**.
...
Если всем целевым пользователям назначены правильные лицензии, вы завершили обновление лицензий Корпоративной голосовой связи для Teams Телефон и Аудиоконференции лицензий.
