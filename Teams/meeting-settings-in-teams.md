...
> [!IMPORTANT]
> Если вы включаете QoS или изменяете параметры в Центре администрирования Microsoft [](QoS-in-Teams-clients.md) Teams для службы Teams, вам также необходимо применить параметры совпадения для всех пользовательских устройств и всех внутренних сетевых устройств, чтобы полностью внедрить изменения QoS в Teams.
...
3. В разделе **Сеть** выполните указанные ниже действия.
    ...
    - Чтобы указать диапазоны портов, выберите **Выбрать диапазон портов для каждого типа медиа трафика в реальном времени**, выберите **Указать диапазоны портов**, а затем введите начальный и конечный порты для совместного использования звука, видео и экрана. Выбор этой опции необходим для реализации QoS. 
        > [!Note]
        > Если **маркер качества обслуживания (QoS)** для трафика мультимедиа в режиме реального времени имеет место, вам необходимо управлять настройками порта. Управление ими не происходит автоматически.
