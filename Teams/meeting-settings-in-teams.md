...
Если для приоритета сетевого трафика используется качество обслуживания (QoS), вы можете включить маркеры QoS и настроить диапазоны портов для каждого типа трафика мультимедиа. Установка диапазонов портов для разных типов трафика - это только один шаг в обработке медиа в реальном времени; см. [Качество обслуживания (QoS) в Teams](qos-in-teams.md) для более подробной информации.
