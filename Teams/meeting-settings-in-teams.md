...
С ноября 2021 г. администраторы также могут управлять возможностью конкретных пользователей или групп пользователей разрешать анонимным пользователям присоединяться к собраниям, которые они организуют. Эта политика для организатора является более строгой и переопределяет указанные ниже параметры анонимных пользователей на уровне организации, настраиваемые администраторами в Центре администрирования Teams.
