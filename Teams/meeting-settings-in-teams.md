...
2. В разделе **Участники**включите анонимные пользователи, чтобы присоединиться к **собранию**.
    ...
    ![Снимок экрана с параметрами участников собрания в центре администрирования] (media/meeting-settings-participants.png "Снимок экрана с параметрами участников собрания Teams в центре администрирования Microsoft Teams")
...
2. В разделе **приглашение по электронной почте**выполните указанные ниже действия.
    ...
    ![Снимок экрана с параметрами приглашения на собрание, которые можно настроить] (media/meeting-settings-invitation.png "Снимок экрана с параметрами приглашения на собрание, которые можно настроить для собраний Teams")
...
2. В разделе **сеть**выполните указанные ниже действия.
    ...
    ![Снимок экрана с параметрами сети для собраний в центре администрирования] (media/meeting-settings-network.png "Снимок экрана с параметрами сети для собраний Teams в центре администрирования Microsoft Teams")
