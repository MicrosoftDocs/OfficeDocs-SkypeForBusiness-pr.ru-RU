...
## <a name="v301-published-on-october-26-2022"></a>Версия 3.0.1 опубликована 26 октября 2022 г.
...
1. Скачайте и сохраните файл [журналов отчетов об очереди вызовов & Teams V3.0.1.zip](https://www.microsoft.com/download/details.aspx?id=104623) на компьютере.

1. Откройте ZIP-файл.

1. `Teams Auto Attendant & Call Queue Historical Reports V3.0.0.pbit` Откройте файл шаблона. Power BI Desktop должно запуститься.
...
> [!NOTE]
> Если вы используете версию 1.63 или более раннюю версию, при попытке v3.0.0 получить данные из VAAC может возникнуть ошибка.  Чтобы устранить эту ошибку, необходимо удалить все предыдущие учетные данные из Power BI.
> 
> 1. Откройте шаблон версии 3.0.0, чтобы удалить ошибку. 
...
|:--------|:------------------|:------------------------------------------------------------------|:---------------------------------------------------|
|3.0.1    |26 октября 2022 г.   |Автосекретарь Teams & отчеты об истории очереди вызовов версии 3.0.0        |Удалена запись источника данных тестирования                   |
