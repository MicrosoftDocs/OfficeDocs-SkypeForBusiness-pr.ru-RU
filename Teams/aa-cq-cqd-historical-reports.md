...
|Результат вызова                         |fCallQueueAnalytics -> количество вызовов<br>fCallQueueAnalytics -> результат вызова в очереди вызовов | Нет |
...
- На панели мониторинга доступен только 28-й день истории, так как данные очереди вызовов и автоотетаря считаются личными данными и подстраховываются под политики хранения данных.
