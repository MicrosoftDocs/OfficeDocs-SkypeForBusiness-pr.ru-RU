...
>
> Клиенты GCCH/DOD должны продолжать использовать версию 1.63.
...
1. `Teams Auto Attendant & Call Queue Historical Reports V3.0.4.pbit` Откройте файл шаблона. Power BI Desktop должно запуститься.
