...
ms.locfileid: "58732738"
---
# <a name="auto-attendant--call-queue-historical-report"></a>Auto Attendant & Call Queue Historical Report

В шаблоне CQD Teams auto Attendant & истории Power BI очереди вызовов есть три отчета:
...
|AATransferAction                        |Текст                     |Целевой тип перена передачи вызовов: возможные значения:<br><br>***§ приложение — сущность приложения голосового** приложения _<br> § <br> external_pstn_§ hunt_group - Queue *_entity_* _<br>_ * _§ orgaa - Organizational Auto Attendant entity_**<br>§ shared_voicemail<br>§ неизвестно<br>§ пользователь |
