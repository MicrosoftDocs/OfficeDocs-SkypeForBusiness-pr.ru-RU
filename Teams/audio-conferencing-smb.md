...
Существует два типа чисел, которые можно использовать для моста конференц-связи. Вы можете использовать как **Общие** , так и **выделенные** номера (как в разделе [Настройка голосовой конференции](#set-up-audio-conferencing) ). Дополнительные сведения о каждом из них.
...
2. Нажмите кнопку **изменить** рядом с пунктом " **звуковые конференции** ", а затем в области " **телеконференции** " **выберите номер в** списке **платный** или бесплатный номер, а затем нажмите кнопку **Применить**.
