...
Приложение Благодарность в Microsoft Teams помогает пользователям оценить вашу организацию или класс. Эмблемы в Благодарность помогают распознавать трудоемкие трудовую деятельности, Teams пользователей— от преподавателей до сотрудников, работающих на переднем телефоне. Дополнительные информацию можно найти в [Благодарность отправки.](https://support.microsoft.com/office/send-praise-to-people-50f26b47-565f-40fe-8642-5ca2a5ed261e)
...
> [!NOTE]
> Приложение Благодарность доступно для облачной среды GCC, но не для GCC Высокая или DoD.
