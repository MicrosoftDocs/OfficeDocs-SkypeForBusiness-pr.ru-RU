...
> [!NOTE]
> Для доступа к этой функции администраторам необходимо иметь лицензию на Teams. При попытке доступа к этой функции без лицензии на Teams вы получите сообщение об ошибке.

Приложение "Благодарность" в Microsoft Teams помогает пользователям продемонстрировать признательность сотрудникам своей организации или класса. С помощью этой команды вы можете выбрать набор эмблем и создать собственные эмблемы. С помощью этой команды вы можете легко понять, за что работают пользователи Teams — от преподавателей до сотрудников без компьютеров. Для получения дополнительных информации, ознакомьтесь с [отправкой praise to people.](https://support.microsoft.com/office/send-praise-to-people-50f26b47-565f-40fe-8642-5ca2a5ed261e)
