...
> [!NOTE]
> Для доступа к этой Teams администраторам должна быть лицензия на доступ к этой функции. При попытке получить доступ к этой функции без Teams лицензии вы получите сообщение об ошибке.
