...
![Снимок экрана: Параметры вкладка приложения Благодарность](media/manage-praise-app-settings.png)
...
Например, значение hex красного цвета #FF0000, так как красный имеет максимальное возможное значение, FF, а зеленый и синий — по наименьшему возможному значению — 00.
