...
### <a name="assign-users-to-teams"></a>Назначать пользователей в команды
...
> [!NOTE]
> Если управление персоналом Firstline осуществляется через вашу группу управления идентификацией и доступом, вам нужно будет следовать их процессу для предоставления сотруднику его учетных данных.
