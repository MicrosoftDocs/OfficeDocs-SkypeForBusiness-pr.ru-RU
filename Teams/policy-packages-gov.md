...
Каждой отдельной политике присваивается имя пакета политики, чтобы легко определять политики, связанные с пакетом. Например, при назначении пакета политики "Сотрудник по обеспечению безопасности" пользователям в организации для каждой политики в пакете создается PublicSafety_Officer политика с именем "Сотрудник по безопасности".
