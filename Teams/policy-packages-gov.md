...
Teams настоящее время включены следующие пакеты политик для государственных органов.
...
Каждой отдельной политике присваивается имя пакета политики, чтобы легко определять политики, связанные с пакетом. Например, при назначении пакета политики "Сотрудник по обеспечению безопасности" пользователям в вашей организации для каждой политики в пакете создается PublicSafety_Officer политика с именем "Политика безопасности".
