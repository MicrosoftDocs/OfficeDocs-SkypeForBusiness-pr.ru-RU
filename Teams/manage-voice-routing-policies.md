...
Политика голосовой маршрутистики — это контейнер для записей использования ОКП. Чтобы создать политики маршрутинга голосовой маршрутики и управлять ими, переходить к политикам маршрутинга голосовой голосовой почты в центре администрирования Microsoft Teams или с помощью   >   Windows PowerShell.
...
1. В левой области навигации Центра администрирования Microsoft Teams перейдите к политике маршрутации голосовой голосовой почты  >  и нажмите кнопку **Добавить**.<br>
    ![Снимок экрана: страница "Добавление политики перенастройки голосовой маршрутии" в Центре Microsoft Teams администрирования](media/manage-voice-routing-policies.png) 
