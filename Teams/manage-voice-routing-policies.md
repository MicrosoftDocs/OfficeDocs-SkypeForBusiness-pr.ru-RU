...
1. В левой области навигации центра администрирования Microsoft Teams перейдите в раздел политики маршрутизации **голосовой** > **голосовой связи**и нажмите кнопку **Добавить**.<br>
