...
Для обеспечения конфиденциальности внутренние участники полностью отображают телефонные номера участников, которые используют Teams аудиоконференцию. Эти числа маскироваться от участников за пределами вашей организации. Этот параметр по умолчанию для всех организаций. Маскировка отображается, как показано на рисунке ниже.
...
- Телефон всех на собрании, кроме организатора, в масках.
...
Чтобы изменить параметр маскровки телефонной сети общего перейти на другой телефон (ОКП), задате один из доступных параметров для параметра **`MaskPstnNumbersType`** [Set-CsOnlineDialInConferencingTenantSettings.](/powershell/module/skype/set-csonlinedialinconferencingtenantsettings?view=skype-ps)
