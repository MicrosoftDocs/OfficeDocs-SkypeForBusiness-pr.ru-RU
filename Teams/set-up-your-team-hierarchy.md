...
> [!NOTE]
> В оставшейся части этой статьи обсуждается настройка иерархии группы в контексте публикации задач в командах получателей. Обзор [приложения "Задачи",](./manage-tasks-app.md) в котором при включенной функции Teams задач, можно найти в Teams в приложении "Задачи".
...
> [!NOTE] 
> Для выполнения этого шага необходимо установить и использовать общедоступный модуль Teams PowerShell из коллекции PowerShell. Действия по установке модуля см. в Teams PowerShell.
...
Убедитесь, что файл TeamId в CSV-файле схемы совпадает с ИД группы, который отображается Microsoft Teams центре администрирования.
