...
При навигации по иерархиям важно использовать следующие термины: Teams будет называться **узлами.**
...
> [!NOTE]
> облако сообщества для государственных организаций (GCC) клиенты должны использовать предварительную версию [cmdlet версии 2.4.0](https://www.powershellgallery.com/packages/MicrosoftTeams/2.4.0-preview) или более поздней, чтобы обеспечить маршрутию данных в среду GCC, а не в облачную среду общего пользования.
...
> [!IMPORTANT]
> Для выполнения этого шага необходимо установить и использовать общедоступный модуль предварительного просмотра Teams PowerShell из [коллекции PowerShell.](https://www.powershellgallery.com/packages/MicrosoftTeams/) Дополнительные действия по установке модуля см. в Teams [PowerShell.](teams-powershell-install.md)
