...
> [!NOTE]
> В оставшейся части этой статьи обсуждается настройка иерархии группы в контексте публикации задач в командах получателей. Обзор [](./manage-tasks-app.md) приложения "Задачи", в котором публикация задач отображается при включенной функции, обратитесь к приложению "Управление задачами" для вашей организации в Teams.
