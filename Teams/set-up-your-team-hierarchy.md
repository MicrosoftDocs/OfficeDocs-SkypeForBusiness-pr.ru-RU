...
Вы также можете определить сегменты **,** которые являются категориями, которые команда публикации может использовать для организации контента, отправленного в группы получателей, чтобы упростить для них просмотр, сортировку и фокус на релевантном контенте.
...
Проверьте, правильно ли вы используете TeamId для команды в CSV-файле схемы. Он должен быть таким же, как и Microsoft 365 группы, которая является ее частью. Вы можете найти ИД группы в центре Microsoft Teams администрирования.

1. В левой области навигации центра [администрирования](https://admin.teams.microsoft.com/)Microsoft Teams перейдите в **Teams**  >  **Управление командами.**
