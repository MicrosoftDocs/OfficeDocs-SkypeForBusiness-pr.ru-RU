...
Требуется ли вашему учебному заую или университету включить Microsoft Teams дистанционного обучения? Быстро привяжите к работе с помощью [one-pager Getting Started](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/teams-for-education-getting-started-1-pager.pdf?raw=true) (Начало работы) и любого из ниже материалов по внедрению!

## <a name="adoption-content"></a>Материалы по внедрению

С помощью писем, плакатов, раздаток и других ресурсов учебного заведения вы будете рады работать с Microsoft Teams и другими ресурсами, которые вы можете использовать сейчас. Вы также можете связаться с учащимися через Интернет и в разных учебных заведениях с помощью нового цифрового инструмента, который заполняется баннерами, GIF-ссылками и видео. Начало работы уже сегодня!
