...
Обязательно ознакомьтесь с руководством по цифровому [набор средств,](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/digital-toolkit-guidance.zip?raw=true) чтобы развернуть свой запуск Teams! 
...
- Посетите [страницу Teams для образовательных](https://www.microsoft.com/en-us/education/products/teams/default.aspx) образования, чтобы обучающие курсы, видео и интерактивные демонстрации
- Включить Teams в Центре администрирования [Microsoft 365](https://portal.office.com/adminportal/home#/Settings/ServicesAndAddIns) (вход как администратор Office 365)
...
- [План развития Teams](https://aka.ms/teamsroadmap)
