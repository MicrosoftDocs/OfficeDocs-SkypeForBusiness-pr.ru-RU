...
По умолчанию, когда Teams звонит на номер телефона ЗВОНКОВ, Teams номер телефона пользователя. Точно так же, когда звоня Teams ЗВОНКОВ через ПСПС, номер телефона этого звоня будет виден.
