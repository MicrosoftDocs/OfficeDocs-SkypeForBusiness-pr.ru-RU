...
По умолчанию, когда Teams звонит на телефон ПСС, отображается номер Teams этого пользователя. Точно так же, когда звоня Teams через ПСПС, этот номер телефона отображается.
...
4. В этом окте выберите нужные параметры:
    ...
    - **Блокировать ИД** входящих звонков: включите этот параметр, чтобы не отображать ИД входящих звонков.
