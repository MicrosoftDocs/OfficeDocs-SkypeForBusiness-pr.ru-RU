...
description: Используйте учебные ресурсы в Интернете, чтобы привлечь сотрудников службы поддержки к эксперименту на этапе Teams внедрения.
f1.keywords:
- CSH
ms.custom:
- Adopt
