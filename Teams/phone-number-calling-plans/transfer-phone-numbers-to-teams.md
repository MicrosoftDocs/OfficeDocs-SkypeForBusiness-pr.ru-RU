...
1. В левой области навигации Центра администрирования Microsoft Teams перейдите к голосовой Телефон  >  **номера.** Щелкните **Номера** и выберите **Порт,** чтобы запустить мастер переноса.
