...
Перед началом рекомендуется просмотреть сведения [](port-order-overview.md) в заказе на перенос. Если у вас есть номера служб для моста телефонной связи, автослужб и другие номера служб, бесплатные номера телефонов или более 999 номеров [](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) пользователей (абонентов), которые необходимо перенести в Teams, см. управление телефонными номерами для организации, чтобы скачать правильные формы и отправить их нам.
...
> [!NOTE]
> **В настоящее время с помощью этого мастера** можно получить номера телефонов для Великобритании, США и Канады. Чтобы получить номера телефонов для других стран и регионов, вы можете вручную отправить [заказ на перенос номеров.](manually-submit-port-order.md) Чтобы получить форму для отправки заказа на перенос номеров вручную, выберите свою страну или регион в списке в списке Управление номерами телефонов [для организации.](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md)

1. В левой области навигации Центра администрирования Microsoft Teams перейдите в голосовую Телефон  >  **голосовой Телефон.** Щелкните **Номера** и выберите **Порт,** чтобы запустить мастер переноса.
...
4. На странице **Добавление сведений об** учетной записи выполните следующее и нажмите кнопку **Далее.**
    ...
    - **Сведения о заказе:** 
        ...
        - **Уведомления: адреса** электронной почты для получения уведомлений о заказе. Если вы введите несколько адресов электронной почты, разделять их с помощью 10-й 10-й 10-й 10-й 10-й 1
        - **Дата переноса:** дата переноса, выданная текущим поставщиком услуг.
    - **Телефон сведения о номере**
        - **Тип порта:** при полном переносе номеров или частичном переносе для переноса некоторых номеров.
...
6. На странице **Завершить заказ**  щелкните Upload подписанное досье, чтобы отправить отсканированную копию подписанного досье.
    ...
    2. Напечатайте досье.
    3. Убедитесь, что док-запись подписана лицом, уполномоченным на внесение изменений в учетную запись.
...
Чтобы просмотреть состояние заказа на перенос, в левой области навигации Центра администрирования Microsoft Teams перейдите в > **голосового** порта и щелкните История  >   **заказов**. Каждый статус заказа на перенос указан в **столбце Состояние.** Дополнительные узнать см. в области Каков статус [заказов на перенос.](port-order-status.md)
