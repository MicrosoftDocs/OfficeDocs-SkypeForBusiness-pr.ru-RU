...
> [!NOTE]
> Если ваша страна или регион отсутствует в списке мастера переноса в центре администрирования Microsoft Teams, вы можете [Отправить заказ на перенос вручную](manually-submit-port-order.md).
...
Получив заказ на перенос, вы получите сообщение электронной почты, проверяющее ваш запрос. Ваши запросы проверяются и обновляются ежедневно, и вы будете уведомлены о его ходе и состоянии по электронной почте. Если ваш запрос отклоняется, вам будет предложено открыть билет поддержки.
