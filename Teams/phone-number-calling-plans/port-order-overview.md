...
Если у вас есть поставщик услуг или оператор телефонной связи и у вас уже есть номера телефонов для ваших пользователей или служб, необходимо *создать "заказ* на перенос номеров", чтобы перенести их в Microsoft Teams. При переносе номеров вы можете назначить эти номера своим пользователям и службам, таким как аудиоконференции (для моста конференц-связи), автослужб и очереди звонков.
...
Чтобы определить ПИН-код переноса, в левой области навигации Центра администрирования Microsoft Teams  >  перейдите к номеру Голосовая **Телефон, в** правом верхнем углу страницы выберите Управление ПИН-кодом переноса **, а** затем введите 10-значный ПИН-код.

Когда ваш новый оператор связи свядется с нами с запросом на перенос, мы попросим его ввести определенный ВАМИ ПИН-код.

Если вам нужно дополнительное assitance для настройки ПИН-кода, обратитесь в [службу обслуживания телефонных номеров.](../manage-phone-numbers-for-your-organization/contact-tns-service-desk.md)
