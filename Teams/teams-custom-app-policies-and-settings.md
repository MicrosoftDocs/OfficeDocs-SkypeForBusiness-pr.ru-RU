...
Три параметра определяют, может ли пользователь отправить пользовательское приложение в команду. Он предоставляет администраторам детальный контроль над тем, кто может добавлять настраиваемые приложения в команду и в какие команды можно добавлять настраиваемые приложения.
