...
Платформа Microsoft Power Platform предоставляет множество возможностей интеграции с Teams, где вы можете вставлять отчеты **Power BI** в рабочей области Teams, вставлять приложения, созданные с помощью **Power Apps** как вкладку или личное приложение, запускать поток **Power Automate** сообщений или использовать адаптивные карточки, а также добавлять бота, созданного с помощью **Power Virtual Agents,** в Teams для взаимодействия с другими участниками организации.
...
- Создавайте автоматизированные рабочие процессы между приложениями и службами для синхронизации файлов, получения уведомлений, сбора данных и многогоного с **помощью Power Automate.**
