...
Помните, Teams пользователи автоматически получают глобальную политику (по умолчанию в организации) для типа политики Teams, если не создать и не назначить настраиваемую политику. Так как среди учащихся часто самый большой набор пользователей и они часто получают самые строгие параметры, рекомендуем сделать следующее:
...
Имейте в виду, что глобальная политика будет применяться к всем пользователям в вашем учебном засфере, пока вы не создайте настраиваемую политику и не назначите ее сотрудникам и преподавателям.
...
Перед началом работы важно разобраться [](policy-assignment-overview.md#which-policy-takes-precedence) в правилах приоритета и ранжирования [заданий групп.](assign-policies-users-and-groups.md#group-assignment-ranking) **Убедитесь, что вы читаете [](assign-policies-users-and-groups.md#what-you-need-to-know-about-policy-assignment-to-groups)** и понимаете понятия, которые необходимо знать о назначении политик группам.
