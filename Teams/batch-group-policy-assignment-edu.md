...
Подробнее см. в Подключение [с помощью Azure Active Directory PowerShell для Graph PowerShell.](/office365/enterprise/powershell/connect-to-office-365-powershell#connect-with-the-azure-active-directory-powershell-for-graph-module)
