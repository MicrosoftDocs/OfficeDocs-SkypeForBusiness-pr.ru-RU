...
Пользователи с локальными почтовыми ящиками должны синхронизироваться с Azure Active Directory. Они могут использовать все функции, описанные выше, но Кроме того, они также могут изменить аватар (если это разрешено с помощью Outlook в политике веб-почтового ящика) и управлять собраниями, предоставляя Exchange Server 2016 (Накопительное обновление 3) или более поздней версии, на локальном компьютере.
...
|**Локальная Exchange** (требуется синхронизация с Azure AD)|Да, <sup>2</sup>| Да <sup>, 2, 3</sup> |Да <sup>, 4|Да|Да (Exchange 2016 CU3 +)|Да,<sup>8</sup> (Exchange 2016 CU3 +)|Да |Да|Нет|Да <sup>, 5|Да <sup>, 6|Да |Да |
