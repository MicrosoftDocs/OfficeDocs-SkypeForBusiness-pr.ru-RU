...
- **ИД исходячего звоня** Вы можете заменить пользовательский номер телефона, который по умолчанию является номером телефона пользователя, другим номером телефона. Например, можно изменить номер телефона пользователя с номера телефона на основной для вашей компании или на основной номер телефона юридического отдела. Кроме того, вы можете установить для номера звонков любой номер службы в Интернете (платный или бесплатный) или на номер локального телефона, который назначен учетной записи ресурса, используемой автозаправщиком или очередью звонков.
...
Дополнительные информацию об этих параметрах и их [](how-can-caller-id-be-used-in-your-organization.md)использовании см. в этой статьи.
...
6. Чтобы создать новую политику , которая задает для ИД звонящая номер указанной учетной записи ресурса и задает для вызываемой стороны имя Contoso:
