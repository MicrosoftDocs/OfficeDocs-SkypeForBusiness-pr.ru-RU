...
- **ИД исходячего звоня** Вы можете заменить пользовательский номер телефона, который по умолчанию является его номером телефона, другим номером телефона. Например, можно изменить номер телефона пользователя с номера телефона на основной номер телефона для вашей компании или на основной номер телефона юридического отдела. Кроме того, вы можете установить для ИД звонков любой номер службы в Интернете (платный или бесплатный) или на номер локального телефона, который назначен учетной записи ресурса, используемой автослужавой или очередью звонков.
