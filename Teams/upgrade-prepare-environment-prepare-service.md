...
<table>
<tr><td><img src="media/audio_conferencing_image7.png" alt="An icon depicting a decision point"/> <br/>Точка принятия решений</td><td><ul><li>Кто будет ответственен за проявление контрольных списков интегрированной платы?</li></ul></td></tr>
...
По завершении этого контрольного списка переходите к следующему шагу: [проведение пилотной задачи пользователя](pilot-essentials.md)
