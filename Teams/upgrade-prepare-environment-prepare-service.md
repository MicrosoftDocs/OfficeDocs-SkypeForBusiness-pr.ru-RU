...
Задачи и действия в этих контрольных списках являются основными задачами, которые применяются ко всем возможностям совместной работы и голосовой связи с Teams. Контрольные списки можно настроить, включив в них действия и задачи, которые относятся к вашему пути в Teams.
...
>[!NOTE]
>Большинство настроек конфигурации часто используется в Teams и Skype для бизнеса Online. Для настройки этих параметров используется Центр администрирования Microsoft Teams.
...
Завершив работу с этим контрольным списком, переперейти к следующему шагу : [проведение пилотного проекта для пользователя](pilot-essentials.md)
