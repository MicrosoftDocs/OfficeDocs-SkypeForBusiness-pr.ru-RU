...
## <a name="onboarding-checklists-and-landing-pages-for-microsoft-teams-rollout"></a>Контрольные списки и 9-ю страницы для Microsoft Teams в 2016 г.
...
Задачи и действия в этих контрольных списках являются основными задачами, которые применяются ко всем возможностям совместной работы и голосовой связи с Teams. Вы можете настроить контрольные списки, чтобы включить в них действия и задачи, которые относятся к вашему Teams пути.
