...
- **Поэтапный подход. (Рекомендуется).**  Создайте новую магистраль для того же SBC (с другим портом), протестйте ее и измените политику маршрутинга голосовой связи в Сети, чтобы пользователи навести указатель на новую. 
