...
---
# <a name="set-up-cloud-voicemail"></a>Настройка голосовой почты в облаке
...
> [!NOTE]
> Голосовая почта облачных поддерживает depositing сообщения голосовой почты только в почтовый ящик Exchange и не поддерживает все системы электронной почты сторонних производителей. Как резервный механизм голосовой почты в облаке могут повторной отправки сообщений с помощью SMTP, то есть пользователи с почтовым ящиком в системе электронной почты сторонних производителей будет получают сообщения голосовой почты с время работы не гарантируется службы или другие функции голосовой почты, например, изменение их приветствия и другие параметры.
...
3. Следуйте инструкциям в разделе **Включить пользователей для службы телефонной системы голосовой связи и голосовая почта** [Настройка Скайп Edition соединитель Business Cloud руководство по](https://technet.microsoft.com/library/mt605228.aspx).
