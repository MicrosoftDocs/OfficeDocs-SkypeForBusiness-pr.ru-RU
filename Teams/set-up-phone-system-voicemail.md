...
## <a name="cloud-only-environments-set-up-cloud-voicemail-for-phone-system-users"></a>Облачные среды: Настройка облачной голосовой почты для пользователей телефонной системы
...
6. В разделе **выполнить следующие действия**установите флажок **применить шифрование сообщений Office 365 и защиту прав на сообщение** , а затем нажмите **кнопку выбрать один из них**. В разделе **шаблон RMS**выберите пункт не **пересылать**. Нажмите кнопку **ОК** , а затем — **сохранить**.
    > [!NOTE]
    > Если список **шаблонов RMS** пуст, необходимо настроить шифрование сообщений в Office 365. Дополнительные сведения о настройке шифрования сообщений в Office 365 можно найти в следующих статьях:
    > - [Настройка новых возможностей шифрования сообщений в Office 365](https://docs.microsoft.com/microsoft-365/compliance/set-up-new-message-encryption-capabilities?view=o365-worldwide)
