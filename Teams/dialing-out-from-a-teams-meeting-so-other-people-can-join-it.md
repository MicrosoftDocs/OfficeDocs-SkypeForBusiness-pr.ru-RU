...
- Звонить можно только в том случае, если вы присоединились к собранию с помощью Teams.
- Организатор собрания, устроив аудиоконференцию ИЛИ, в случае, если лицензия на аудиоконференцию не назначена, может звонить в обную телефонную сеть с помощью сетевых планов звонков или прямой маршрутизации.
- Организатору собрания [предоставлена политика](/powershell/module/skype/grant-csdialoutpolicy?view=skype-ps) телефонного набора по сети, которая позволяет звонить из конференции
...
Dial-out is only available to some countries/regions. Полный список см. в списке Доступность страны и региона для аудиоконференций [и планов звонков.](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)

## <a name="allow-users-to-dial-in"></a>Разрешить пользователям вбирать номера
