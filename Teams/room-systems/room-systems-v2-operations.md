...
> [!NOTE]
> Если вы хотите, чтобы на передней панели отображалось автоматическое переключение на активный источник видео (например, на консоль МТР) при пробуждении из режима ожидания, должны выполняться определенные условия. Эта функция необязательная, но поддерживается программным обеспечением Microsoft Teams, если в вашем оборудовании поддерживается соответствующая функция. Для потребительских ТЕЛЕВИЗОРов, используемых в качестве передней части комнаты, должно поддерживаться функция управления бытовой электроники (ЦЕК) в HDMI.  В зависимости от выбранной Dock или консоли (которая может не поддерживать ЦЕК, обратитесь к документации по службе поддержки производителя), например, контроллером, таким как [HD-RX-201-C-E](https://www.crestron.com/en-US/Products/Video/HDMI-Solutions/HDMI-Extenders/HD-RX-201-C-E) из Крестрон или [екстрон HD CTL 100](https://www.extron.com/article/hdctl100ad) от екстрон, может потребоваться для обеспечения необходимой расширения. 
