...
> [!NOTE]
> Если вы используете E1, E3, E4, а также номера SKU в Skype для бизнеса с автономным планом 1 или Skype для бизнеса 2 или Skype для бизнеса с помощью голосовой конференции или Office365 телефонной системы и плана звонков, они будут продолжать работать. Тем не менее, вы можете перейти к более простой модели лицензирования в таблице выше по истечении срока действия текущих лицензий.  
