...
Этот раздел содержит обзор действий, необходимых для подготовки среды, можно использовать все возможности комнат группами Майкрософт.
  
1. Подготовка учетной записи устройства для каждого консоли комнат группами Майкрософт. В разделе [Развертывание комнат группами Майкрософт](room-systems-v2.md) для получения дополнительных сведений.
...
*Устройства учетная запись* является учетной записи, клиент комнат группами Майкрософт использует для доступа к функции из Exchange, например календаря и для включения Скайп для бизнеса. В разделе [Развертывание комнат группами Майкрософт](room-systems-v2.md) для получения дополнительных сведений.
...
Подготовки пакеты будут использовать для проверки подлинности в Exchange Server или Office 365.
