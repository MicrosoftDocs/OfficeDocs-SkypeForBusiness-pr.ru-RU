...
1. Подготовьте учетную запись устройства для каждой консоли Microsoft Teams комнаты. Подробности смотрите в разделе [развертывание комнат Microsoft Teams](room-systems-v2.md) .
...
*Учетная запись устройства* — это учетная запись, которую использует клиент комнаты Microsoft Teams для доступа к функциям из Exchange, например "Календарь", и для включения Skype для бизнеса. Подробности смотрите в разделе [развертывание комнат Microsoft Teams](room-systems-v2.md) .
...
8. Откройте клавишу Skype и перейдите к параметрам Хкэй_усерс\скипе\софтваре\микрософт\виндовс\куррентверсион\интернет и убедитесь в том, что эти параметры введены. 
