...
Посмотрите видео о том [, как вы в одном приложении, в помещениях Microsoft Teams, в которых](https://www.youtube.com/watch?v=1XvgH2rNpmk) показан пример функций для работы с камерой содержимого.
