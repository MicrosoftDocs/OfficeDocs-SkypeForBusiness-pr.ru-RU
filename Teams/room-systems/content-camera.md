...
Посмотрите видео о том [, как вы в одном приложении, в помещениях Microsoft Teams](https://youtu.be/1XvgH2rNpmk?t=350) для примера функций для работы с камерой содержимого.
