...
**Совет по Pro** : Если вы планируете использовать прокси-серверы для предоставления доступа к Microsoft Teams или Skype для бизнеса Online, сначала [Ознакомьтесь с этой статьей](https://docs.microsoft.com/skypeforbusiness/optimizing-your-network/proxy-servers-for-skype-for-business-online). Обратите внимание на то, что когда речь идет о трафике в Skype для бизнеса через прокси-серверы, мы рекомендуем вообще обойти прокси-серверы. Трафик Skype для бизнеса уже зашифрован, поэтому прокси-серверы не обеспечивают безопасность. В рамках вашего обширного развертывания мы рекомендуем следовать рекомендациям в статье [Оценка](https://docs.microsoft.com/MicrosoftTeams/3-envision-evaluate-my-environment#network-readiness) пропускной способности для планирования и оценки соответствия требованиям сети для трафика в реальном времени. Для всех планов пропускной способности используйте [планировщик сети мядвисор](https://myadvisor.fasttrack.microsoft.com/CloudVoice/NetworkPlanner). (Мы рекомендуем создавать пользователей комнат Microsoft Teams в соответствии с предполагаемой использованием комнат в Microsoft Teams [видео, демонстрация экрана, звук] и назначать количество пользователей, которые соответствуют количеству размещений комнат Microsoft Teams для развертывания на каждом сайте.) 
...
**Совет по Pro** С точки зрения планирования на уровне сайта вы можете найти следующие ресурсы. Они охватывают больше, чем просто только комнаты Microsoft Teams, и их можно использовать для полного развертывания Skype для бизнеса Online:

-   [Руководство по планированию выпуска и миграции сайта](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Downloads?SelectedIDs=5_1_0_24)

-   [Планирование развертывания и миграции сайтов — Плайбук](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Downloads?SelectedIDs=5_1_0_16)

    > [!NOTE]
    > В плайбук выполните задачи, описанные в разделе 4,3 "4-конечные конференции", для каждого сайта, на котором вы планируете развертывать устройства Microsoft Teams. Это позволит вам использовать сценарий подготовки массовой учетной записи позже в процессе. 
...
**Совет по Pro** : [Матрица тестирования](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Downloads?SelectedIDs=5_1_0_21) , доступная из [мядвисор](https://myadvisor.fasttrack.microsoft.com/) , включает в себя вкладку с количеством тестов Microsoft Teams, которые необходимо проверить с помощью в рамках тестирования. 
