...
<sup>1</sup>Если в чате участвует больше 20 пользователей, будут отключены следующие функции чата: автоматические ответы Outlook и сообщения о состоянии Teams, индикатор ввода, голосовые и видеозвонки, уведомления о прочтении. Кнопка "Задать параметры доставки" (!) также удаляется, когда чаты в частной группе содержат более 20 участников.
...
|Функция     | Максимальный предел |
|------------|---------------|
|Количество людей на встрече (могут общаться и звонить)  |300. Режим **только просмотр** позволяет 20 000 участников подключиться в режиме прослушивания к собранию, у организатора которого есть лицензия на надстройку "Расширенные коммуникации" SKU.<sup>1</sup> [!INCLUDE [template](includes/preview-feature.md)] <br><br>**Примечание.** В Teams для государственных организаций (GCC, GCC High, DoD) лимит остается прежним — 250. Эта статья будет обновлена, когда лимит облака для государственных организаций повысится с 250 до 300 и будет поддерживать переполнение собраний.   |
...
<sup>1</sup> Режим "только просмотр" включен по умолчанию. Чтобы отключить переполнение собрания, можно использовать Windows PowerShell. 
```powershell
Set-CsTeamsMeetingPolicy -Identity Global -StreamingAttendeeMode Disabled
Set-CsTeamsMeetingPolicy -Identity Global -StreamingAttendeeMode Enabled
```
Участники не смогут подключиться к собранию в режиме "только просмотр", если в собрании полностью исчерпана пропускная способность для подключений "только просмотр" или если участник не имеет разрешения на обход "зала ожидания"согласно установленным политикам или настройкам "зала ожидания". Участники, подключенные в режиме "только просмотр", не смогут просматривать нативные файлы в формате PPT.
...
>
> Чтобы пользователи могли удовлетворять быстро меняющиеся потребности коммуникаций, служба трансляций Microsoft 365 временно повышает стандартные предельные значения до 1 октября 2020 г. для трансляций, проводимых в Teams. Следующие повышения разворачиваются:
>
