...
description: Узнайте, как Microsoft Teams данные из журнала аудита в Портал соответствия требованиям Microsoft Purview.
appliesto:
- Microsoft Teams
...
Изменения членства в Teams (например, добавленных или удаленных пользователей), внесенные через Azure Active Directory (Azure AD), портал администрирования Microsoft 365 или Группы Microsoft 365 API Graph будут отображаться в Teams  аудит сообщений и в канале "Общие" с атрибутом существующего владельца команды, а не фактического инициатора действия. В этих сценариях просмотрите Azure AD или [Microsoft 365](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance) журналы аудита группы, чтобы просмотреть соответствующую информацию.
