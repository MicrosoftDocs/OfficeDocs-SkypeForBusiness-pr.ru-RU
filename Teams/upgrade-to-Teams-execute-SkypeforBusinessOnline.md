...
audience: admin
ms.reviewer: landerl
description: Узнайте, как обновить организацию, чтобы Microsoft Teams из развертывания Skype для бизнеса Online.
...
В Центре Microsoft Teams вы можете настроить TeamsUpgradePolicy одновременно для 20 пользователей:
