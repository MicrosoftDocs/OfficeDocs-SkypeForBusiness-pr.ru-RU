...
- **Настраиваемые фоны собраний для организаций** . Вы можете создавать и определять настраиваемые фоны собраний, которые затем будут доступны конечным пользователям с лицензией Teams Premium.

- **Настраиваемые сцены совместного режима для организаций** . Вы можете создавать, настраивать или принимать настраиваемые сцены совместного режима для собраний, которые затем становятся доступными для конечных пользователей с лицензией Teams Premium.
