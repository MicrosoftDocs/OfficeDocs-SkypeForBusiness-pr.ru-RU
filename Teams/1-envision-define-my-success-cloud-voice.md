...
В этой статье дается обзор требований для определения успешности развертывания конференц-связи звук или телефонной системы с помощью вызова планы для вашей организации. Определив должным образом цель, можно оценить результаты в ходе работы через развертывания и убедитесь, что результаты, которые можно достичь те, которые вы хотите, чтобы.
...
**Система телефон с вызова планы** позволяет организациям на совершенствование их работы, позволяя пользователям связанной с бизнесом телефонные звонки от своих компьютеров и мобильных устройств. Рабочее место модернизации может быть частью любое количество сценариев — рабочее реализацию на основе активности основных office перемещение масштабированием размеру обновления office, закончится устаревшие решение УАТС, заключение контракт поставщика службы ТСОП и т. д.

<!--ENDOFSECTION-->

## <a name="define-business-use-cases-for-audio-conferencing-or-phone-system-with-calling-plans"></a>Определение использования экономического обоснования для конференц-связи звук или телефонной системы с помощью вызова планы

Начинается с основных заинтересованных лиц проекта необходимо определить экономического обоснования использования, которые поддерживают реализации аудиоконференции или телефонной системы с помощью вызова планов.
...
> [!TIP]
> Ниже приведен пример использования завершенных экономического обоснования телефонной системы с помощью вызова планов:
>|         |
>|---------|
...
-   **Организационной области:** Реализация аудиоконференции или телефонной системы с помощью вызова планы может включать всей организации или только определенных бизнес-подразделениям.
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Точки принятия решений|<ul><li>Что такое все варианты использования предприятию для аудиоконференции можно определить в вашей организации?</li><li>Что такое все варианты использования предприятию для телефонной системы с помощью вызова планы могут определять в вашей организации?</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Дальнейшие действия|<ul><li>Документировать все варианты использования business для аудиоконференции для вашей организации.</li><li>Документировать все варианты использования бизнес для телефонной системы с помощью вызова планы для вашей организации.</li></ul>|

<!--ENDOFSECTION-->

## <a name="identify-key-stakeholders"></a>Определение ключевых заинтересованных лиц

Деловых целях определен на предыдущем шаге организационной областью для конференц-связи звук или телефонной системой с реализацией вызов планы, а также на основе этого можно выполнить полный заинтересованные лица для включения нужных людей для включает в себя в проекте.
...
>|Владелец службы|<ul><li>Все элементы быть отвечает за операции аудиоконференции или телефонной системы со службой вызов планы.</li><li>Владельцем аудиоконференции или телефонной системы со службой вызов планов.</li></ul>|Подлежит добавлению|
