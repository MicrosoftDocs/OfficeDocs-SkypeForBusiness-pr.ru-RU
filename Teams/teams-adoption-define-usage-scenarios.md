...
После того как вы поговорите с одним или несколькою заинтересованными лицами, вы можете определить приоритеты сценариев на основе влияния и сложностей. (Ваши сценарии могут быть добавлены в дополнение к предложенным выше сценариям.) Подходящие кандидаты на этап эксперимента должны иметь большее влияние и низкую или среднюю сложность. Это гарантирует, что на проект не будут повлиять масштабы работ и технические сложности, прежде чем вы сможете показать значение своей работы. Ниже показан пример диаграммы.
