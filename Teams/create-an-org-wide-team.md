...
> [!NOTE]
> - Если при создании команды  вы не видите параметр для всей организации и вы глобальный администратор, возможно, достигнуто ограничение в пять групп в организации или ваша организация может иметь более 5000 участников. В будущем максимальное количество пользователей планируется увеличить. Команды для всей организации пока недоступны для Teams для образовательных учреждений.
