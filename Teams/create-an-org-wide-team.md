...
При этом все глобальные администраторы и администраторы служб Teams добавляются в качестве владельцев команд, а все активные пользователи — в качестве участников. Нелицензированные пользователи также будут добавлены в команду. При первом вхождении пользователя без лицензии в Teams пользователю назначена лицензия "Знакомство с Microsoft Teams". Чтобы узнать больше о лицензии exploratory, ознакомьтесь с [управлением лицензией На изучение Microsoft Teams.](teams-exploratory.md) 
...
Снизьте шум в канале, разрешив только владельцам команды публиковать сообщения в общем канале. Перейдите в команду, найдите канал "Общий" и выберите команду **̇ ̇ ̇ Дополнительные параметры**  >  **управления каналом.** На **вкладке "Параметры канала"** нажмите кнопку **"Разрешения"** и выберите пункт **"Только владельцы могут отправлять сообщения".**
