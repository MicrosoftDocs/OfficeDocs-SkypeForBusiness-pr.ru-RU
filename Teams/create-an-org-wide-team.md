...
> - Мы автоматически создаем группу на уровне Организации, если ваша организация является новым для Teams и не содержит более 5 000 пользователей. Имя группы будет содержать имя клиента и будет иметь общий канал. Глобальные администраторы могут вносить изменения в эту группу, как и любую другую команду. 
