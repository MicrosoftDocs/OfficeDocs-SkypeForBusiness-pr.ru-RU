...
При этом все глобальные администраторы и администраторы служб Teams добавляются в качестве владельцев команд, а все активные пользователи — в качестве участников. Нелицензированные пользователи также будут добавлены в команду. При первом нелицензрованном пользователе для Teams лицензии пользователю назначена лицензия Microsoft Teams Exploratory. Чтобы узнать больше о лицензии Exploratory, ознакомьтесь с [управлением лицензией Microsoft Teams Exploratory.](teams-exploratory.md) 
