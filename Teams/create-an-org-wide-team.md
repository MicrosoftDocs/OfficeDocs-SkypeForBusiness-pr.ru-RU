...
При этом все глобальные администраторы и администраторы служб Teams добавляются в качестве владельцев команд, а все активные пользователи — в качестве участников. Нелицензированные пользователи также будут добавлены в команду. Когда пользователь без лицензии впервые Teams, пользователю назначена лицензия Microsoft Teams Exploratory. Чтобы узнать больше о лицензии Exploratory, ознакомьтесь со Microsoft Teams [лицензией Exploratory.](teams-exploratory.md) 
