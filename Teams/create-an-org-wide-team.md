...
> - Мы автоматически создадим команду для всей организации, если ваша организация еще не является командой Teams и имеет не более 10 000 пользователей. Имя группы отображает имя клиента и у нее есть общий канал.  Глобальные администраторы могут редактировать эту группу так же, как любую другую. 
