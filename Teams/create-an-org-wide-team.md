...
![Снимок экрана: параметр "Для всей организации" для создания команды для всей организации](media/create-org-wide-team.png "Снимок экрана: параметр \"Для всей организации\" для создания команды для всей организации")
...
Добавьте важные каналы в избранное, чтобы все в организации могли участвовать в конкретных беседах. Дополнительные сведения см. в статье [Автоматическое добавление в избранное каналов для всей команды](https://support.office.com/article/auto-favorite-channels-for-the-whole-team-a948272c-5aa5-429c-863c-4e1e1cd6b0f6).
