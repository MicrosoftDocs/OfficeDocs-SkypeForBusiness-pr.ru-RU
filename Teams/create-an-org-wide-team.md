...
Уменьшить шум на канале, добавив в канал общего канала только владельцев группы. Перейдите в группу и выберите пункт **Дополнительные параметры** > **управления командой**. На вкладке **Параметры** нажмите кнопку **разрешения для участника**, а затем выберите **только владельцев может публиковать сообщения**.

### <a name="turn-off-team-and-team-name-mentions"></a>Отключение @team и @ [название группы] упоминания

Уменьшите @mentions, чтобы они не были перезагружены всей Организацией. Перейдите в группу и выберите пункт **Дополнительные параметры** > **управления командой**. На вкладке **Параметры** нажмите кнопку <strong>@mentions</strong>, а затем отключите **параметр Показать членов, чтобы @team или @ [название группы]**.
