...
Перейдите к названию группы, щелкните **̇ ̇ ̇ Дополнительные параметры** > **изменить группу**.
