...
3. На панели навигации слева перейдите к номерам **голосовых** > **телефонов**, нажмите кнопку **Добавить новый номер** ![](media/c224fbd0-f0f5-46ce-a1a7-73adf4540ef7.png), а затем выберите пункт **новые номера пользователей**.
