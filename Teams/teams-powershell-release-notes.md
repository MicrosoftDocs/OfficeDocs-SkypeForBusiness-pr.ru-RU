...
ms.locfileid: "60536740"
---
# <a name="microsoft-teams-powershell-release-notes"></a>Microsoft Teams Заметки о выпуске PowerShell

На этой странице вы можете Teams журнал изменений PowerShell для общедоступной и общедоступной предварительной версии.
