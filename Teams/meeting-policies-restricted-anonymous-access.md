...
Чтобы получить назначения политики Teams собраний для организации, Teams выполнить следующие задачи:
