...
Новые отчеты Teams использования позволяют узнать, как (и в какой степени) пользователи используют Microsoft Teams, используя данные панели мониторинга качества Teams звонка. Эти отчеты предназначены для централизованного использования этих данных как администраторами, так и руководителями предприятий.
...
![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report1.png)
...
В левом нижнем разделе страницы вы найдете таблицу, которая предоставляет общие значения для каждого типа мультимедиа за последний год. 
    ![Снимок экрана: Teams отчетов об ](media/CQD-teams-utilization-report5.png) ![ использовании: Teams по использованию](media/CQD-teams-utilization-report6.png)   
...
В отчете Использование аудиосвязи минут общее использование минут предоставляется в нескольких различных представлениях. 

Рядом с срезами отображается 30-дневная сводка по использованию текстовых полей. Верхнее число — это итоговая 30-дневная с внутренними и внешними разбивками.

![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report9.png)
...
![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report10.png)
...
![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report11.png)
...
Отчет о ежедневном использовании позволяет администратору определять пиковые периоды потребления в течение суток. Кроме использования, мы также можем фиксировать общие отзывы и отзывы пользователей за этот день.

![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report12.png)

В отчете Ежедневное использование отображается количество звуковых, видео- и экранных ресурсов для выбранного дня с добавленной возможностью различать внутреннее и внешнее подключение. Разбивка конференций и одноранговых сборов находится справа от итога модали. В правой верхней части отчета справа от нее содержится список конференций с их связанными ИД и участниками на день. Список конференций также содержит дополнительные сведения о конференции. РИСУНОК "ЗАМЕНИТЬ"

![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report13.png)

График в центральной области позволяет пользователю определять пиковые периоды потребления в течение суток. Пользователи могут просуммировать час, представленный на графике, в котором будет представлен отчет о списке пользователей за час.
...
![Снимок экрана: Teams отчеты об использовании](media/CQD-teams-utilization-report14.png)
  ...
  1.  В таблице под диаграммой будут показаны показатели за этот час. Его можно отсортировать по любому заглавию столбца. однако мы хотели бы найти проблемные области.  
    ![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report15.png)
...
![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report24.png)

![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report25.png)
  

Мы можем видеть участников конференции, а также всю информацию в зависимости от потери пакетов и дрожания, чтобы помочь в устранении неполадок в нижней таблице.

![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report26.png)
...
В списке пользователей можно просмотреть сведения о пользователях за определенный час, выбранные пользователем, просматривая отчет. Отчет "Список пользователей" доступен с помощью drill down (Почасовая диаграмма тенденций) в отчете "Ежедневное использование". Щелкните правой кнопкой мыши час, когда потребуется дополнительная информация, и выберите развернуть и список пользователей, как показано ниже.

![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report19.png)
...
![Снимок экрана: отчеты Teams использования](media/CQD-teams-utilization-report20.png)
