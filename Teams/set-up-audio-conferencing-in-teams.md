---
title: Настройка компонента "Аудиоконференции" для Microsoft Teams
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.reviewer: oscarr
...
ms.locfileid: "30955032"
---
# <a name="set-up-audio-conferencing-for-microsoft-teams"></a>Настройка компонента "Аудиоконференции" для Microsoft Teams
...
Выполните эти stesps, чтобы назначить новый номер телефона звукового конференц-канала.
