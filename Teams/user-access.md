...
description: Узнайте, как управлять доступом пользователей к Teams, назначая или удаляя Teams пользователям в организации.
f1.keywords:
- CSH
...
По умолчанию, когда пользователю назначен план лицензирования (например, Microsoft 365 корпоративный E3 или Microsoft 365 бизнес премиум), пользователю автоматически назначена лицензия Teams, а пользователю включена Teams. Вы можете отключить или включить Teams для пользователя, удалив или назначив лицензию в любое время.
...
Вы управляете Teams лицензиями в Центр администрирования Microsoft 365 или с помощью PowerShell. Для управления лицензиями необходимо быть глобальным администратором или администратором управления пользователями.
...
Используйте Центр администрирования Microsoft 365 для управления Teams отдельными пользователями или небольшими наборами пользователей одновременно. Вы можете управлять Teams лицензиями  на странице Лицензии (одновременно до 20 пользователей) или На странице **Активные** пользователи. Выбор метода зависит от того, хотите ли вы управлять лицензиями на продукты для определенных пользователей или лицензиями пользователей для определенных продуктов.
...
|&nbsp;|&nbsp;|
|---------|---------|
|![Снимок экрана: Teams лицензия для пользователя.](media/assign-teams-licenses-1.png)    | ![Снимок экрана: 2 Teams лицензии для пользователя](media/assign-teams-licenses-2.png)        |
...
Когда вы удаляете Teams лицензию пользователя, Teams отключена для этого пользователя, и он больше не будет Teams в приложении или на домашней странице. Подробные инструкции см. в описании отзыва [лицензий у пользователей.](/microsoft-365/admin/manage/remove-licenses-from-users)
...
Запустите следующие команды, в которых указаны название вашей организации и идентификатор плана лицензирования, который вы извлекли на более \<CompanyName:License> ранней этапе. Например, ContosoSchool:ENTERPRISEPACK_STUDENT.
