...
description: Узнайте, как управлять доступом пользователей к Teams, назначая или удаляя лицензии Teams пользователям в организации.
f1.keywords:
- CSH
...
Вы управляете Teams лицензиями на Центр администрирования Microsoft 365 с помощью PowerShell. Для управления лицензиями необходимо быть глобальным администратором или администратором управления пользователями.
...
Teams управление лицензиями на уровне пользователей напрямую через Центр администрирования Microsoft 365 управления пользователями. Администратор может назначать лицензии для новых пользователей при создании их учетных записей, а также для пользователей с существующими учетными записями. 
...
Когда вы удаляете Teams лицензию пользователя, Teams отключена для этого пользователя, и он больше не будет Teams в оке запуска приложений или на домашней странице. Подробные инструкции см. в описании отзыва [лицензий у пользователей.](/microsoft-365/admin/manage/remove-licenses-from-users)
