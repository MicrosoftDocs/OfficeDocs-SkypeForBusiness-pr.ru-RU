...
После был дан ответ на звонок auto attendant или звонок очереди, пользователь может обрабатывать звонок, как и любой другой звонок & #x 2014 г.; они могут добавлять или конференции в другой пользователь или переключить звонок на другой стороны. Кроме того auto attendant будет необходимо перенаправлять неотвеченные звонки на основе конфигурации пользователя.
