...
>
> Пользователям, которые получают звонки от автосекретарей и очередей звонков, будет отображаться имя вызывающего абонента, только если оно предоставлено из ТСОП или если номер вызывающего абонента соответствует контактам клиента локальной команды целевого пользователя.
>
