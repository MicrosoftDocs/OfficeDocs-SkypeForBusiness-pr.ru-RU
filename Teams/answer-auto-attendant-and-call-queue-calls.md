...
Пользователи Teams могут принимать и отвечать на звонки от автоответов и очередей звонков в облаке прямо из клиента Teams.
...
## <a name="handling-an-auto-attendant-or-call-queue-call"></a>Обработка вызовов автостраницы или очереди вызовов
