...
Если вы хотите использовать Power BI для анализа данных CQD, прочитайте инструкции [use Power BI для анализа данных CQD для](CQD-Power-BI-query-templates.md) Teams.
...
В сводных и Location-Enhanced отчетов можно использовать раскрывающийся список "Фильтр  продуктов", чтобы отобразить все данные о продукте, только Microsoft Teams данные или только Skype для бизнеса online.

> [!div class="mx-imgBorder"]
> ![Снимок экрана: параметры элемента управления "Фильтр продукта".](media/206ad818-0f72-4c8e-b25e-3cc8fcfbef05.png)

В подробных отчетах можно использовать измерение **Is Teams**, чтобы отфильтровать данные Microsoft Teams или Skype для бизнеса online.
...
Потоки классифицируются по трем группам: "Хороший", "Плохой" и "Неклассифицированный". Существуют также вычисляемые значения *"Плохой процент*", которые дают отношение потоков, классифицированных как "плохо", к общему классифицированному счетчику потоков. Так *как poor % = Poor streams/(Poor streams+ Good streams) \* 100*, на удовлетворительный *процент* не влияет наличие нескольких неклассифицированных потоков. Сведения о том, что классифицирует поток как плохой или хороший, см. в разделе "Классификация потоков [" на панели мониторинга качества звонков](stream-classification-in-call-quality-dashboard.md).
...
При просмотре данных могут отображаться различия между данными Teams и Skype для бизнеса. По некоторым причинам:

- Различия в механизмах обеспечения производительности и надежности:
  - Teams автоматическое повторное подключение и быстрое перемещение. Skype для бизнеса нет.
  - Teams динамическое управление пропускной способностью. Skype для бизнеса нет.
- Различия в [диапазонах IP-адресов](Office-365-URLs-IP-address-ranges.md) между Teams и Skype для бизнеса. Диапазоны Teams IP-адресов являются более новыми, что может привести к проблемам с подключением в брандмауэре.
