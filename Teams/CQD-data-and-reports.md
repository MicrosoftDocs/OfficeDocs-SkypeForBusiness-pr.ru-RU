...
В сводных и Location-Enhanced отчетах можно использовать  в Microsoft Teams фильтра продуктов все данные о продукте, только Microsoft Teams или только данные Skype для бизнеса Online.
...
Если отчеты CQD по умолчанию вам не соответствуют, воспользуйтесь этими инструкциями, чтобы создать настраиваемый отчет. Или (с января 2020 г.) используйте Power BI [для отчетов CQD. ](cqd-power-bi-query-templates.md)
...
Чтобы применить URL-фильтры с несколькими значениями, разделять каждое значение по черты (| ). Например:
