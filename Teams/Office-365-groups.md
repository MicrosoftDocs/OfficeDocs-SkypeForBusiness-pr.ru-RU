...
При создании группы, на сервере, вы создаете группу Office 365 и соответствующей библиотеке документов SharePoint и записной книжки OneNote, а также связей в облаке приложения Office 365. Если автора группа владельца существующего пакета Office 365 Public или Private группы, они могут добавлять функциональные возможности групп в группу, если он имеет меньше, чем 5000 пользователей и никогда не был добавлен к группам. При этом создается один канал **Общие** по умолчанию, в какой чата находятся сообщения, документы, OneNote и другие объекты. Просмотр библиотеки документов для канала будет приводить **Общие** папки, представляющее канала рабочих групп. Что особенно важно, когда вы создаете собственную структуру папок в библиотеке документов, **она не распространяется** в Teams в виде канала. Сейчас она просто передается из Teams в SharePoint.
