...
![Снимок экрана: еженедельное развертывание состояния в плайбук] (media/deploy-my-service-image6.png "Снимок экрана: еженедельное развертывание состояния в плайбук")
