...
Со списком основных заинтересованных лиц и руководителей предприятий в организации. Для каждого человека задайте следующие вопросы:
...
1. Какой процент пользователей попадают в каждый сегмент? (*Изменение сопротивление*)
    - **Ранние приемники:** запросили решение, прежде чем оно будет доступно.
...
2. Какие именно у пользователей есть возможность изменить? (*Обучение)*
...
Объединяйте эти данные с профилями заинтересованных лиц и сотрудниками, которые хотят принять участие в программе ранних пользователей. Это позволит определить группы, которые готовы к изменениям и могут их усвоить, а также определить свои существующие обязанности. Этот способ позволяет создавать партнеров в изменении.

Чтобы решить проблему с различными типами изменений, можно использовать внутренних champions. Обратная связь — залог успеха: поощрить людей к тому, чтобы они поделились своими проблемами и потребностями. Поэкспериментируйте с детермиентами и омывателями, предоставляя таким людям или группам место за столом во время эксперимента. Этот подход поможет более плавно развертывать улучшения совместной работы.  
