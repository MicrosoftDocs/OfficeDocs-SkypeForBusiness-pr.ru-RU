...
5. Будут ли это лидеры evangelize с помощью Teams, чтобы помочь вам в переходе?
...
> [!NOTE]
> Несмотря на то, что вы можете назначить оценку для такого рода анкеты, которая бы свести к минимуму влияние на элемент человека в вашей организации, наведите на него изменения, которые будут зависеть от того, в какой степени они химию и для каких технических навыков и бизнес-Acumen. Просматривайте этот список с участниками группы, чтобы обсудить "вписать" различных лидеров в этот проект по мере выбора проектов и сотрудников для последующих этапов. 
...
Изменение — это человеческий процесс, не имеющий никаких возможностей для работы с технологиями. У нас есть психология и Neuroscience, которые продумали о естественной сопротивления, чтобы изменить его. Чтобы внести изменения в приемлемое состояние, важно предусмотреть требования ваших пользователей, понять их ситуацию и создать решения, которые улучшают эту ситуацию. Даже если вам потребуются естественные сопротивления, измените их.  
...
3. В дополнение к этому развертыванию службы, сколько еще изменений произошло? (*Адаптируемость*) <br/>К изменениям относятся обновления Office и Windows, перемещение, слияние, reorgs и т. д.
    - Нет
    - 1-3 изменения
    - Более 3 изменений
