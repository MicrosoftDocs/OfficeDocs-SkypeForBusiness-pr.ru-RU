...
2. Какие у пользователей есть возможность изменения? (*Учебный курс*)
    ...
    - **Личные учители могут получить** личную поддержку.
...
Чтобы решить проблему с различными типами изменений, можно использовать внутренние химя. Обратная связь — это ключ к успеху: поощрить людей к тому, чтобы они поделились своими проблемами и потребностями. Поэкспериментируйте с деструкционерами и мешателями, предоставляя этим людям или группам место за столом во время эксперимента. Этот подход поможет более плавно развертывать усовершенствования совместной работы.  
