...
|Истекает срок действия закрытых собраний, запланированных пользователем&nbsp;&nbsp;|**Отключите планирование частного собрания** _и_ отключите **надстройку Outlook**. &nbsp;&nbsp;|Никто не может присоединиться к закрытым собраниям, запланированным пользователем. Это предотвращает присоединение пользователей к следующим собраниям:<ul><li>Частные собрания, произошедшие в прошлом.</li><li>Частные собрания, запланированные на будущее и еще не выполненные.</li><li>Будущие экземпляры повторяющихся закрытых собраний.</li></ul><br>Как **планирование частных собраний** , так и **надстройка Outlook** должны быть отключены для истечения срока действия закрытых собраний, запланированных пользователем. Если один параметр отключен, а другой включен, ссылки на присоединение к собраниям и идентификаторы конференций существующих собраний остаются активными и срок действия не истекает.|
...
Используйте срок действия собрания, чтобы ограничить использование OneDrive или SharePoint в облачном хранилище на основе записей собраний Teams. Обычная запись собрания занимает около 400 МБ в час записи.
...
- Дата окончания срока действия рассчитывается как день  создания, а также количество дней по умолчанию, заданных администратором в политике **Teams**.
...
#### <a name="will-a-retention-andor-deletion-policy-ive-set-in-the-security--compliance-center-override-the-teams-meeting-recording-expiration-setting"></a>Будет ли политика хранения и (или) удаления, задаемая в Центре соответствия & безопасности, переопределять параметр срока действия записи собраний Teams?
...
- Если у вас есть политика удаления, в которой указано, что все записи собраний Teams будут удалены через пять дней, а срок действия записи собрания Teams истекает через 30 дней, запись будет удалена через пять дней.
