...
Для функций работы с электронной подписью "Утверждения" партнеры по подписи сторонних разработчиков по умолчанию отображаются в Teams "Утверждения". Вы можете отключить определенные поставщики электронной подписи, задав параметры приложения в Teams администрирования.
