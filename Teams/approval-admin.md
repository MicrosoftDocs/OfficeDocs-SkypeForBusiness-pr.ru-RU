...
> [!NOTE]
> Эта функция еще не выпущена для облако сообщества для государственных организаций высокого уровня и для пользователей DoD.
...
Приложение "Утверждения" доступно по умолчанию. Вы можете отключить его в Центре администрирования Teams.
  ...
  2. Перейдите в **Teams приложений Управление**  >  **приложениями**.
...
Утверждения, созданные в приложении "Утверждения", хранятся в среде CDS по умолчанию, которая в настоящее время не поддерживает резервное копирование. Подробнее на тему [Создание резервных копий и восстановление среды — Power Platform \| Документация Майкрософт](/power-platform/admin/backup-restore-environments).
...
Для использования функции подписи в приложении "Утверждения" необходима лицензия для конкретного поставщика электронной подписи, который вы хотите использовать. Чтобы получить лицензию для своей организации, необходимо перейти на сайт поставщика.
### <a name="enable-or-disable-e-signature-providers"></a>Включить или отключить поставщиков электронной подписи

С помощью центра Teams вы можете управлять тем, какие сторонние поставщики электронной подписи доступны пользователям в приложении "Утверждения". По умолчанию поставщики электронной подписи включены в приложении "Утверждения". Если отключить поставщика электронной подписи, пользователи не смогут получить к нему доступ при создании утверждений. Пользователи также не смогут просматривать запросы на электронную подпись, созданные с помощью этого поставщика.

1. В левой области навигации Центра администрирования Teams перейдите в Teams **приложения**  >  **Управление приложениями**.
2. Найди приложение "Утверждения" и выберите его.
...
Утверждения электронной подписи, созданные в приложении "Утверждения", хранятся в облачной среде выбранного поставщика. Чтобы экспортировать данные об электронных подписях, необходимо перейти на сайт поставщика. Дополнительные сведения о хранении, экспорте и хранении соглашений с электронной подписью см. в документации поставщика.
