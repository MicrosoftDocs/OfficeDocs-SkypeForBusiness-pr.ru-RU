...
Для функций работы с электронной подписью "Утверждения" партнеры сторонних подписей по умолчанию отображаются Teams "Утверждения". Вы можете отключить определенные поставщики электронной подписи, задав параметры приложения в Teams центре администрирования.
