...
> [!NOTE]
> Эта функция еще не выпущена для пользователей облако сообщества для государственных организаций высокая (GCCH) и Department of Defense (DOD).
...
1. В левой области навигации центра администрирования Teams перейдите в Teams **AppsУправляемые** >  приложениями.
