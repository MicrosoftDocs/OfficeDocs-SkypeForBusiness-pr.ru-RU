...
> | Какой метод вы используете или планируете использовать <br>подключить телефонная система (ранее Облачная УАКС) к <br>ДНР? <br/>Выберите все, что применимо. | <input type="checkbox"> Планы звонков (ранее — "Вызовы через ЗВОНКОВ по ННР") <br/> <input type="checkbox"> Локальное подключение к ДНР (с помощью существующих) <br>&nbsp;&nbsp; &nbsp; Skype для бизнеса 2015 или Lync Server 2013 <br>&nbsp;&nbsp; &nbsp; развертывание) <br/> <input type="checkbox"> Локальное подключение к STN (с помощью Cloud Connector) | |
