...
Дополнительные сведения см. в справочнике [по номерам](dial-voice-reference.md) и голосовым данным.
...
5. Выберите пункты меню "**Отключить"**, "**Перенаправление****" или "Воспроизвести"**.

6. Если вы выбрали перенаправление, выберите целевой объект маршрутизации звонка.

7. Если вы решили воспроизвести параметры меню, настройте [параметры меню](#menu-options).
...
- Для учетной записи ресурса с лицензией Microsoft Teams Телефон и политикой маршрутизации голосовой связи по сети прямой маршрутизации внешний формат номера телефона для передачи зависит от параметров пограничного контроллера сеансов [(SBC](direct-routing-connect-the-sbc.md)).
...
Windows PowerShell позволяет создавать автосекретарей и управлять ими с помощью командной строки пакетным или программным способом.
...
Языки поддержки и часовой пояс
