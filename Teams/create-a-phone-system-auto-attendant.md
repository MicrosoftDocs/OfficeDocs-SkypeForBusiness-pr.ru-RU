...
Вы можете включить или исключить конкретных пользователей, выбрав **пользовательскую группу** в разделе **включить** или **исключить** и выбрать одну или несколько групп Microsoft 365, списков рассылки и групп безопасности. Например, вы можете исключить руководителей в организации из каталога набора.
