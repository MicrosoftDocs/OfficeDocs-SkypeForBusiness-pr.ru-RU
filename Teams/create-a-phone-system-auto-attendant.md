...
- - В центре Администратор M365 включите параметр "Разрешить пользователям за пределами организации отправлять электронную почту этой команде" для определенной Microsoft 365 группы.
