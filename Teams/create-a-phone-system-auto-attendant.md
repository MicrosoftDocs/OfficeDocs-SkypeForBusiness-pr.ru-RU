...
При передаче звонков на внешний телефонный номер учетной записи ресурса, связанной с автосекретарем или очередью звонков, должен быть указан номер телефона и лицензия Microsoft 365 Phone System. Вдобавок

- Назначение лицензии на [план звонков](calling-plans-for-office-365.md) для учетной записи ресурса с номером тарифного плана.
  - Номер внешней телефонной передачи необходимо ввести в формате E. 164 (+ CC + phone_number).
...
- Для учетной записи ресурса с прямым номером маршрутизации назначьте [политику голосовой маршрутизации в сети](manage-voice-routing-policies.md).
  - Формат телефонного номера для внешних передач зависит от параметров [контроллера границ сеанса (SBC)](https://docs.microsoft.com/microsoftteams/direct-routing-connect-the-sbc) .
