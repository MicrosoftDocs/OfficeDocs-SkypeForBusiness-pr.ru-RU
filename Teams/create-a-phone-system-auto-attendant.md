...
- Для учетной записи ресурса с лицензией на план [звонков](operator-connect-plan.md) или номером Подключение оператора необходимо вводить номер внешнего переносного телефона в формате E.164 (+[код страны][код города][номер телефона]). [](calling-plans-for-office-365.md)
...
1. Выберите **Выполнить тесты** ниже, чтобы заполнить диагностику в Microsoft 365 Admin центре. 
   ...
   > [Выполнить тесты: Teams федерации](https://aka.ms/TeamsAADiag)
