...
ms.locfileid: "66124174"
---
# <a name="set-up-an-auto-attendant"></a>Настройка автосекретаря

Автосекретари позволяют людям звонить в вашу организацию и перемещаться в системе меню для связи с нужным отделом, очередью вызовов, сотрудником или оператором. Вы можете создать автосекретарей для организации с помощью Microsoft Teams центра администрирования или PowerShell.
...
- **Голосовая почта** — почтовый ящик голосовой почты, связанный с группой Microsoft 365, которую вы указали. Вы можете выбрать, требуются ли расшифровки голосовой почты и системное приглашение "Оставьте сообщение после сигнала" .
  - В центре Администратор M365 включите параметр "Разрешить пользователям за пределами организации отправлять электронное письмо этой команде" для указанной Microsoft 365 группы.
...
Действия, описанные в статье, создают автосекретарей с помощью Teams администрирования. Инструкции по созданию автосекретарей с помощью **PowerShell** см. в статье "Создание автосекретарей с помощью командлетов [PowerShell"](create-a-phone-system-auto-attendant-via-cmdlets.md).

## <a name="follow-these-steps-to-set-up-your-auto-attendant"></a>Выполните следующие действия, чтобы настроить автосекретаря

Чтобы настроить автосекретаря, в Teams центре администрирования разверните [узел "Голосовая](https://go.microsoft.com/fwlink/p/?linkid=2066851) связь **", выберите** "Автосекретари **" и** нажмите кнопку **"Добавить"**.
...
[Дополнительные сведения см. в Teams управления учетными](manage-resource-accounts.md) записями ресурсов.
...
- Для учетной записи ресурса [](calling-plans-for-office-365.md) с лицензией на [](operator-connect-plan.md) план звонков или номером Operator Connect номер телефона внешней передачи необходимо ввести в формате E.164 (+[код страны][код области][номер телефона]).
...
- Для плана звонков и Operator Connect номеров отображается исходный номер телефона вызывающего абонента.
...
1. Выберите **Выполнить тесты** ниже, чтобы заполнить диагностику в Центре администрирования Microsoft 365.
   ...
   > [Запуск тестов: Teams автосекретаря](https://aka.ms/TeamsAADiag)
...
[Вот что вы получаете с помощью Teams Телефон](./here-s-what-you-get-with-phone-system.md)
