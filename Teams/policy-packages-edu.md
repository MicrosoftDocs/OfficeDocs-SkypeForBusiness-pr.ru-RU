...
### <a name="meeting-policies-for-students"></a>Политики собраний для учащихся

#### <a name="turn-off-the-ability-to-create-and-start-meetings"></a>Отключение возможности создавать и начинать собрания

> [!NOTE]
> В настоящее время эта функция может отсутствовать в вашем клиенте. Это связано с тем, что эта функция сейчас разворачивается и будет доступна всем пользователям после развертывания во всех клиентах. Дополнительные сведения см. в разделе [Дорожная карта Teams](https://www.microsoft.com/microsoft-365/roadmap?filters=&searchterms=63355).
...
- На той же странице в разделе "Участники и гости":

  - **Разрешить начинать собрания в частных собраниях**: "Выкл"
  - **Разрешить чат в собраниях**: "Отключено"
...
Выключение параметров **Разрешить начинать собрания в каналах**, **Разрешить планирование собраний канала**, **Разрешить планирование личных собраний** и **Разрешить начинать собрания в частных собраниях** для учащихся не только блокирует для них возможность планировать собрания в качестве организаторов, но и обеспечивает следующие меры безопасности для образования:

- Если учащиеся пытаются присоединиться к собранию до преподавателя, они не смогут этого сделать в последней версии приложения Teams.

- Создание собраний доступно всем пользователям и любым лицензиям, но описанные выше меры безопасности для блокирования присоединения к собраниям применяются только к клиентам образовательных учреждений в Teams на основе типа пользовательской лицензии.

Ниже приведена таблица с описанием логики для каждой политики создания собраний:

| Политика создания собрания | Создание собрания | Начало собрания без участников | Обход "зала ожидания" при присоединении | Завершение собрания |
| --- | --- | --- | --- | --- |
| **Включено (например, преподаватель)** | Да | Да | Определяется [параметрами собрания](https://go.microsoft.com/fwlink/?linkid=2093366) | Да, как организатор
| **Отключено (например, учащийся)** | Нет | Нет\*\* | Определяется [параметрами собрания](https://go.microsoft.com/fwlink/?linkid=2093366) | Нет

> [!NOTE]
> \*\* Это относится только к пользователям с лицензией для образовательных организаций и применяется к собраниями, собраниям каналов, незапланированным собраниям и незапланированным собраниям каналов.

Когда вы применяете для политики **Разрешить чат в собраниях** значение "Отключено" и запрещаете учащимся планировать собрания, сохраняя эту политику включенной для преподавателей (для собраний, запланированных не в канале, или для мгновенных собраний в канале), учащиеся не смогут общаться в чате, пока преподаватель не присоединится к собранию, а также после собрания. Они по-прежнему смогут просматривать журнал чата до, во время и после собрания. Например, они смогут просматривать сообщения от преподавателя или ссылку записи собрания, если оно было записано.

Если политика **Разрешить чат в собраниях** отключена как для учащихся, так и для преподавателей, никто не сможет общаться в чате в окне чата собрания. Описанная выше мера безопасности, ограничивающая чат в собрании, применяется только к клиентам образовательных учреждений в Teams на основе типа пользовательской лицензии.

Ниже приведена таблица с описанием логики для разрешения чата в собраниях:

| Политика "Разрешить чат в собраниях" | Просмотр журнала чата в любое время | Публикация сообщений во время собрания | Публикация сообщений до или после собрания |
| --- | --- | --- | --- | 
| **Включено для всех** | Да | Да | Да |
| **Отключено для всех** | Недоступно | Н/Д | Недоступно |
| **Включено для преподавателей и отключено для учащихся** | Преподаватель: Да<br>Учащийся: Да | Преподаватель: Да<br>Учащийся: Да | Преподаватель: Да<br>Учащийся: Нет\*\* | 

> [!NOTE]
> \*\* Это относится только к пользователям с лицензией для образовательных организаций и применяется к собраниями и незапланированным собраниям. Это не применяется к собраниям каналов и незапланированным собраниям каналов.
...
### <a name="live-events-policies-for-students"></a>Политики прямых трансляций для учащихся
...
### <a name="calling-policies-for-students"></a>Политики совершения звонков для учащихся
...
### <a name="messaging-policies-for-students"></a>Политики обмена сообщениями для учащихся
...
### <a name="teams-policies-for-students"></a>Политики Teams для учащихся
...
### <a name="meeting-policies-for-educators"></a>Политики собраний для преподавателей
