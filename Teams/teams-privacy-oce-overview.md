...
> [!NOTE]
> Если вы являетесь администратором, ознакомьтесь со статьей [Управление средствами контроля конфиденциальности](/deployoffice/privacy/manage-privacy-controls), чтобы узнать, как предоставить пользователям возможности использования необязательных сетевых функций или ограничить их.
...
- [Обзор средств управления конфиденциальностью в Приложениях Microsoft 365 для предприятий](/deployoffice/privacy/overview-privacy-controls)
