...
На <a href="/microsoftteams/manage-apps" target="_blank">странице Управление</a> приложениями в Центре администрирования Microsoft Teams (на левой навигации перейдите в Teams **приложения** Управление приложениями ), вы можете просмотреть все Teams приложений для  >  вашей организации. **Мини-приложение Ожидается** утверждение в верхней части страницы сообщает, когда настраиваемые приложения отправлены на утверждение.
...
Дополнительные сведения об использовании API Graph для обновления приложений см. <a href="/graph/api/teamsapp-update">здесь.</a>
...
- <a href="/graph/api/resources/teamsapp" target="_blank">API Graph Microsoft для Teams приложений</a>
