...
Право использования предложения есть у пользователей, имеющих учетную запись электронной почты в управляемом домене AAD и которым в настоящее время не назначена лицензия Teams. Например, если у пользователя есть версия Office 365 бизнес (не включающая Teams), он имеет право на использование Teams Exploratory.
