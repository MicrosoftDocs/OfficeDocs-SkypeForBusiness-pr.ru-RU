...
| 5-10 | Необязательно: использование PowerShell для управления группами | Вы можете использовать командлеты PowerShell, а не центр администрирования Office 365, чтобы администрировать параметры Teams и управлять ими. | | [Microsoft Teams PowerShell](https://docs.microsoft.com/powershell/module/teams/?view=teams-ps) |
