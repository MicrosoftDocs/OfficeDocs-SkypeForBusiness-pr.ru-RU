...
| 7  | Настройка Exchange для домена SMTP Teams | Teams использует Exchange Online для отправки уведомлений участникам команды с помощью домена SMTP — email.teams.microsoft.com — после того, как они были добавлены или удалены. <br/><br/>Не забудьте добавить этот домен SMTP в список приемлемых доменов в инфраструктуре Exchange. | | [Создание списков надежных отправителей в Exchange](https://docs.microsoft.com/microsoft-365/security/office-365-security/create-safe-sender-lists-in-office-365?view=o365-worldwide) |
