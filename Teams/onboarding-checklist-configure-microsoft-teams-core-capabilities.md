...
ms.reviewer: rowille
audience: admin
description: Отслеживайте основные задачи и действия из этого контрольного списка при настройке Teams организации.
...
| 2  | Проверка Teams включена для клиента | Teams включена по умолчанию для всех организаций. Проверьте **страницу &** служб в Центр администрирования Microsoft 365, чтобы убедиться, что Teams включена для вашей организации, и при необходимости включить ее. | | [Настройка Microsoft Teams в Microsoft 365 или Office 365](office-365-set-up.md) |
| 3  | Настройка ролей и разрешений | Teams поддерживаются два типа ролей: "Участник" и "Владелец". <br/><br/>После добавления участника в команду владелец также может повысить его до роли Владелец. Рекомендуется на уровне как минимум двух владельцев, которые должны быть назначены каждой команде. <br/><br/>По умолчанию создать команду может любой человек в организации, у которого есть Exchange Online почтового ящика. Пользователю, создающим новую команду, автоматически предоставляется роль "Владелец" для этой команды. <br/><br/>При необходимости вы можете настроить параметры Microsoft 365 группы так, чтобы только определенные пользователи могли создавать новые команды. | | [Назначение ролей и разрешений в Microsoft Teams](assign-roles-permissions.md) <br/><br/>[Microsoft 365 групп и Microsoft Teams](office-365-groups.md) <br/><br/>[Управление возможностью создания Microsoft 365 групп](https://support.office.com/article/Manage-who-can-create-Office-365-Groups-4c46c8cb-17d0-44b5-9776-005fced8e618) |
