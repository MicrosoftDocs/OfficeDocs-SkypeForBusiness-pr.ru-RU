...
| 8  | Настройка доступа пользователей к Teams | Несмотря на то, что настоятельно рекомендуется разрешить доступ ко всем Teams пользователям, вы можете разрешить или отоать доступ к Teams для каждого пользователя, назначив или удалив лицензию на Teams продукта. | | [Управление доступом пользователей к Microsoft Teams](user-access.md) |
| 9  | Назначение лицензий пользователям | Назначение пользователям лицензий для таких функций, как аудиоконференция, телефонная система и планы звонков | | [Назначение Microsoft Teams надстройки](teams-add-on-licensing/assign-teams-add-on-licenses.md)|
