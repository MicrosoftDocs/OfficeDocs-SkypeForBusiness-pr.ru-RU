...
> [!NOTE]
> Настройка для хранения сообщений в закрытых каналах пока не поддерживается. Поддерживается хранение файлов, к которым предоставлен общий доступ в закрытых каналах.
...
- Очистка сообщений с истекшим сроком действия в Teams может занимать до трех дней. Политика хранения Teams удаляет сообщения чатов и каналов по истечении срока хранения. Однако очистка этих сообщений и их окончательное удаление может занимать до трех дней. Кроме того, сообщения чатов и каналов доступны для поиска средствами обнаружения электронных данных после истечения срока хранения и до безвозвратного удаления сообщений.
...
Чтобы создавать политики хранения Teams и управлять ими с помощью PowerShell, используйте следующие командлеты.
