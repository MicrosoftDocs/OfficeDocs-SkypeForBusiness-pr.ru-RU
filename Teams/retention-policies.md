...
Например, для сообщений канала можно применить политику хранения к определенным командам в организации и настроить в этой политике действие удаления через 1 год. Затем применить другую политику хранения для всех остальных команд и в этой политике настроить действие удаления через 3 года.

## <a name="create-and-manage-retention-policies-for-teams"></a>Создание политик хранения и управление ими в Teams

Чтобы создать или изменить политику хранения для чатов и сообщений каналов Teams, воспользуйтесь инструкциями из [статьи о политиках хранения для расположений Teams](/microsoft-365/compliance/create-retention-policies#retention-policy-for-teams-locations).
