...
> [!NOTE]
> [Общие каналы](shared-channels.md), которые в настоящее время находятся в предварительной версии, теперь поддерживаются политиками хранения.
...
:::image type="content" source="media/retention-policies-image1.png" alt-text="Пользователь, Teams, что сообщение чата удаляется из-за политики Teams хранения.":::
