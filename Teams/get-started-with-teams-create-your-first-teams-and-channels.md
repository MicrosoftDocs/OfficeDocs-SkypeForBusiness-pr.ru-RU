...
![Снимок экрана: параметры, доступные при нажатии кнопки "Дополнительные параметры"](media/get-started-with-teams-add-channel.png "Снимок экрана: \"Добавить канал\", \"Управление командой\" и другие параметры, доступные при нажатии кнопки \"Дополнительные параметры\" для команды") 
...
![Снимок экрана с вкладками, закрепленными в приведенном примере команды](media/get-started-with-teams-add-tabs.png "Снимок экрана с вкладками, закрепленными в приведенном примере команды \"Знакомство с Teams\".") 
