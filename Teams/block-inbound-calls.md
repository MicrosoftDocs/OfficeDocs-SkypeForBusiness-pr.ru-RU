...
В следующем примере администратор клиента хочет разрешить звонки на клиент по номерам 1 (312) 555-8882 и 1 (312) 555-8883, даже если эти два номера телефонов находятся в диапазоне, заблокированном в примере выше. Чтобы включить эту функцию, создается новый шаблон исключения для числов:
...
Параметр **PhoneNumber** является required и должен быть числовой строкой без дополнительных символов, таких как +, - или (). Итоговая **величина параметра IsNumberBlocked** возвращает значение True, если число заблокировано в клиенте. параметр возвращает false, если он не заблокирован.
