...
|Формат набора  <br/> | 800 814 XXXX <br/>  800 850 XXXX <br/> |
|Код страны или региона по ISO  <br/> |SA  <br/> |
|Охватываемая территория  <br/> |Неприменимо  <br/> |
|Неохватываемая территория  <br/> |Неприменимо  <br/> |
|Доступность проводных и наземных линий связи  <br/> |Только для абонентов STC.  <br/> |
|Доступность мобильных сетей  <br/> |Только для абонентов STC.  <br/> |
