...
|Формат набора  <br/> |00531 XX XXXX  <br/> |
|Код страны или региона по ISO  <br/> |JP  <br/> |
...
|Примечания, ограничения и проблемы с доступом  <br/> |Доступно для абонентов мобильных сетей NTT Docomo, Au (KDD) и Softbank.  <br/> |
