...
---
# <a name="toll-free-dialing-restrictions-in-honduras"></a>Ограничения набора бесплатных номеров в Гондурасе
...
|Формат набора  <br/> |800 XXXX XXXX  <br/> |
|Код страны или региона по ISO  <br/> |HN  <br/> |
|Охватываемая территория  <br/> |Неприменимо  <br/> |
|Неохватываемая территория  <br/> |Неприменимо  <br/> |
|Доступность проводных и наземных линий связи  <br/> |Только для абонентов Hondutel.  <br/> |
|Доступность мобильных сетей  <br/> | Только для абонентов Tigo. <br/> |
