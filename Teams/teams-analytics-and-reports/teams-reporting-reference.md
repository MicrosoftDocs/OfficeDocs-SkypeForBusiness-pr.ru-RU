...
|[Отчет по активности пользователей Teams](user-activity-report.md)  |  1:1 звонки, в которые участвовал пользователь<br/>Сообщения, которые пользователь опубликовал в чате группы<br/>Сообщения, опубликованные пользователем в приватном чате<br/>Дата последнего действия пользователя     |
