...
Настроив политику собраний Teams, администратор может контролировать, могут ли организаторы собраний скачивать отчеты об участии в собраниях. По умолчанию возможность скачивания отчета включена. Инструкции по отключению этой функции см. в статье [Параметры политики собраний — разрешение отчета о задействовании](../meeting-policies-in-teams-general.md#engagement-report).
