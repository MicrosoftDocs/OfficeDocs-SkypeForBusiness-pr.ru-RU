...
MS.collection:
- M365-collaboration
description: Узнайте в Teams об аналитике по группам, аналитике по группам и по каналам, которая позволяет пользователям видеть данные об использовании команд или каналов, в которых они находятся.
appliesto:
- Microsoft Teams
