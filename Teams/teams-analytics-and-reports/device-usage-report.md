...
1. Перейдите в центр администрирования Microsoft Teams, на панели навигации слева выберите пункт **аналитические отчеты _амп_**, а затем в разделе **отчет**выберите пункт **использование устройств Teams**. 
