...
Отчет об использовании устройств Teams в Центре администрирования Microsoft Teams содержит сведения о том, как пользователи подключаются к Teams. В отчете можно посмотреть, какие устройства используются в организации, в том числе узнать, сколько человек используют Teams на мобильных устройствах, когда они находятся в путь.  
...
|**2**   |У каждого отчета есть дата его выпуска. Действия обычно отражаются в отчетах с 24-часовой задержкой. |
...
Чтобы сделать данные в отчете об использовании устройств Teams анонимными, необходимо быть глобальным администратором. Это позволит скрыть в отчете зависимые сведения, такие как отображаемые имя, адрес электронной почты и ИД AAD, а также их экспорт.
