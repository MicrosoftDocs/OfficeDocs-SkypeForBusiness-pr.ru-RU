...
1. В левой области навигации центра администрирования Microsoft Teams выберите пункт **аналитики & отчеты**, а затем в разделе **отчет**выберите пункт **использование устройств Teams**.
2. Выберите диапазон в поле **Диапазон дат**, а затем нажмите кнопку **Запустить отчет**.

    ![Снимок экрана с отчетом об использовании устройств Teams в центре администрирования Teams с выносками] (../media/teams-reports-device-usage-with-callouts.png "Снимок экрана с отчетом об использовании устройств Teams в центре администрирования Teams с выносками")
