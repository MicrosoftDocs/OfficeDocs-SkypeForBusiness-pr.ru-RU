...
Ось Y на диаграмме — это число пользователей, которые для выбранной даты, наведя указатель мыши на диаграмму, считаются активными пользователями. Пользователи, которые открывают приложение хотя бы один раз, считаются активными пользователями.
