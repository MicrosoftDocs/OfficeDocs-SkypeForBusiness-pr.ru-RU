...
---
# <a name="microsoft-teams-app-usage-report"></a>Microsoft Teams отчете об использовании приложений
...
|**8**  |Отчет можно экспортировать в CSV-файл для автономного анализа. Выберите **экспорт в Excel**, а  затем на вкладке Загрузки нажмите кнопку Скачать, чтобы скачать отчет, когда он будет готов. <br>![Снимок экрана: страница "Загрузки".](media/app-usage-report7.png)  |
|**9**   |При просмотре отчета в Excel вы также увидите столбец "ИД", который представляет собой ИД приложения.  Как правило, ИД группы — это буквно-цифровая строка. Если **столбец "ИД"** имеет имя **\n****, это означает, что пользователь запросил удаление своих данных.<br>![Снимок экрана: Excel отчета.](media/app-usage-report8.png)  |
