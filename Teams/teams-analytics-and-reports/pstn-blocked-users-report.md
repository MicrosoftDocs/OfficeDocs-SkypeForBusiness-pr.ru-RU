...
MS.collection:
- M365-voice
description: Используйте отчет о заблокированных пользователях Microsoft Teams в Центре администрирования для получения общего Teams пользователей, которые не могут звонить по ЗВОНКОВ по ННП.
appliesto:
- Microsoft Teams
