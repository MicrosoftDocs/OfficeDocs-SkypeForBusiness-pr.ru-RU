...
|**2**   |Для каждого отчета указывается дата создания. Отчеты обычно представляют собой 24-часовой задержку на момент действия. |
