...
4. Нажмите **кнопку Выполнить отчет**.  
    ...
    ![Снимок экрана: отчет об использовании Teams трансляций в Центре администрирования Teams с помощью перетаксовок](../media/teams-live-event-usage-report-with-callouts.png "Снимок экрана: отчет Teams использования трансляций в Центре администрирования Teams с помощью перетаксовок")
