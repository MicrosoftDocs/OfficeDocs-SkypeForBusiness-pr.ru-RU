...
Чтобы установить модуль [powerShell Microsoft Teams PowerShell,](https://www.powershellgallery.com/packages/MicrosoftTeams) запустите следующую следующую командную установку: Установите версию 1.0.5 или более поздней.
