...
ms.locfileid: "58601204"
---
# <a name="assign-policy-packages-to-users-and-groups"></a>Назначение пакетов политики пользователям и группам

В этой статье рассматриваются различные способы назначения пакетов политики пользователям и группам Microsoft Teams. Перед чтением обязательно прочитайте статью Назначение политик в Teams [- начало работы.](policy-assignment-overview.md)
