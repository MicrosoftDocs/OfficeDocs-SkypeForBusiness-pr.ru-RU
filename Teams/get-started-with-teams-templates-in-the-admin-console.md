...
>
> - Метки конфиденциальности не поддерживаются в шаблонах групп в средах GCC. Параметр метки конфиденциальности в команде "Создать команду из потока шаблонов" не будет применен к команде.
...
Ниже приведены предварительно созданные шаблоны команд, доступные в Центре администрирования Teams. Предварительно созданные шаблоны — это шаблоны, созданные для конкретных отраслей. Чтобы просмотреть эти шаблоны, в левой области навигации Центра администрирования Teams перейдите к **шаблонам Teams** > **Team**.
...
- [Шаблоны групп розничной торговли](get-started-with-retail-teams-templates.md)
...
Чтобы просмотреть шаблоны команд, в левой области навигации Центра администрирования Teams перейдите к **шаблонам teams** > **Team**. Выберите шаблон, чтобы просмотреть дополнительные сведения, включая каналы и приложения, которые он содержит.
...
Чтобы управлять шаблонами, которые пользователи видят в Teams для создания [команд, можно](https://support.microsoft.com/office/create-a-team-with-team-templates-702a2977-e662-4038-bef5-bdf8ee47b17b) задать политики шаблонов и назначить их пользователям и группам в организации. Дополнительные сведения см. в разделе ["Управление шаблонами групп" в Центре администрирования Teams](templates-policies.md).
