...
- Strat_SB_PSTN
- seo-marvel-mar2020
description: Узнайте о наборе бесплатных номеров в стране или регионе, в том числе о доступности, доступности с использованием проводных и фиксированных номеров, а также об ограничениях для мобильных сетей.
...
---
# <a name="toll-free-dialing-limitations-and-restrictions"></a><span data-ttu-id="d96cc-103">Ограничения и запреты для бесплатных номеров</span><span class="sxs-lookup"><span data-stu-id="d96cc-103">Toll-free dialing limitations and restrictions</span></span>

<span data-ttu-id="d96cc-104">Это поможет вам узнать, как звонить на бесплатные номера в каждой стране или регионе.</span><span class="sxs-lookup"><span data-stu-id="d96cc-104">This will help you find out how to dial toll free numbers in each country or region.</span></span> <span data-ttu-id="d96cc-105">После выбора страны или региона вы будете перена границу страницы, на которой доступна бесплатная служба, включая подробные сведения, ограничения и ограничения.</span><span class="sxs-lookup"><span data-stu-id="d96cc-105">After you select the country/region, it will take you to a page that contains where toll free service is available including specific details, restrictions, and limits.</span></span> <span data-ttu-id="d96cc-106">В формате набора вы сможете использовать коды доступа, необходимые для набора бесплатных номеров в каждой стране или регионе.</span><span class="sxs-lookup"><span data-stu-id="d96cc-106">The dialing format or formats will show you the required access codes within each country/region to dial the toll-free number.</span></span>
  
<span data-ttu-id="d96cc-107">Если вы готовы, выберите страну или регион:</span><span class="sxs-lookup"><span data-stu-id="d96cc-107">If you're ready, select a country or region:</span></span>
  
## <a name="select-your-country-or-region-to-see-the-dialing-codes-limitations-and-restrictions"></a><span data-ttu-id="d96cc-108">Выберите страну или регион, чтобы увидеть коды набора, ограничения и ограничения.</span><span class="sxs-lookup"><span data-stu-id="d96cc-108">Select your country or region to see the dialing codes, limitations and restrictions.</span></span>
...
## <a name="here-are-some-important-things-for-you-to-remember-about-toll-free-numbers"></a><span data-ttu-id="d96cc-174">Вот некоторые важные моменты, которые необходимо помнить о бесплатных номерах:</span><span class="sxs-lookup"><span data-stu-id="d96cc-174">Here are some important things for you to remember about toll free numbers:</span></span>

- <span data-ttu-id="d96cc-175">**Бесплатные номера действуют только в пределах каждой страны или региона.**</span><span class="sxs-lookup"><span data-stu-id="d96cc-175">**Toll free numbers only operate within each country/region.**</span></span> <span data-ttu-id="d96cc-176">Например, пользователи не могут звонить на бесплатный номер в Австралии из других стран.</span><span class="sxs-lookup"><span data-stu-id="d96cc-176">For example, your users won't be able to call an Australian toll-free number outside of Australia.</span></span>
    
- <span data-ttu-id="d96cc-177">**Приобретение и перенос международных бесплатных номеров (UIFN) не поддерживается.**</span><span class="sxs-lookup"><span data-stu-id="d96cc-177">**Acquiring or porting Universal International Freephone Numbers (UIFN) isn't supported.**</span></span>
    
- <span data-ttu-id="d96cc-178">**Во многих странах и регионах надзорные органы или агентства телекоммуникаций требуют, чтобы каждый бесплатный номер телефона сохранялся в течение не менее 100 минут в месяц.**</span><span class="sxs-lookup"><span data-stu-id="d96cc-178">**In many countries/regions, the regulator/telecommunication agency in the country/region requires each toll free phone number to maintain at least 100 minutes of usage per month in order to retain the number.**</span></span>
    
    > [!NOTE]
    > <span data-ttu-id="d96cc-179">Если ваш бесплатный номер не будет соответствовать этим условиям, корпорация Майкрософт может отозвать у вас этот номер по требованию агентства телекоммуникаций или надзорного органа.</span><span class="sxs-lookup"><span data-stu-id="d96cc-179">In the event you get a toll free number and the usage of the number doesn't meet these minimum requirements, Microsoft may be compelled by the regulator/telecommunication agency to reclaim the number from you.</span></span> 
  
- <span data-ttu-id="d96cc-180">**Доступ к бесплатным номерам по проводным, наземным и мобильным линиям связи может быть полностью или частично ограничен.**</span><span class="sxs-lookup"><span data-stu-id="d96cc-180">**Wireline, fixed line, and mobile network access to toll-free numbers may be fully or partially restricted.**</span></span> <span data-ttu-id="d96cc-181">Формат набора описывает коды доступа, необходимые для звонков с использованием бесплатного номера в каждой стране или регионе.</span><span class="sxs-lookup"><span data-stu-id="d96cc-181">The dialing format describes the required access codes within each country/region to place calls using the toll free number.</span></span>
    
- <span data-ttu-id="d96cc-182">**Бесплатные номера телефонов по плану в Северной Америке:** Стоимость поминутных номеров для бесплатных номеров по плану в Северной Америке определяется в зависимости от страны, в которая они были велись.</span><span class="sxs-lookup"><span data-stu-id="d96cc-182">**North America Numbering Plan Toll Free Numbers:** Per-minute rates for North America Numbering Plan toll free numbers are determined by the originating country.</span></span> <span data-ttu-id="d96cc-183">Бесплатный поминутный тариф для звонков из США соединен по тарифу, определенному как "Северная Америка".</span><span class="sxs-lookup"><span data-stu-id="d96cc-183">The toll free per-minute rate for calls that originate from the United States map to the rate defined as "North America."</span></span> <span data-ttu-id="d96cc-184">Однако для звонков из других стран в Северной Америке, таких как Канада, Пуэрто-Рико и т. д., за них звонков из других стран в Северной Америке, таких как Канада, Пуэрто-Рико и т. д., звонков 2016 года 20</span><span class="sxs-lookup"><span data-stu-id="d96cc-184">However, calls that originate from other North American countries such as Canada, Puerto Rico, etc. have specific toll free rates.</span></span>

> [!NOTE]
> <span data-ttu-id="d96cc-185">Если вам нужно больше номеров, [обратитесь в службу поддержки администраторов Skype для бизнеса](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b).</span><span class="sxs-lookup"><span data-stu-id="d96cc-185">If you need to get more telephone numbers than this, please [contact support for business products - Admin Help](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)</span></span>
    
## <a name="related-topics"></a><span data-ttu-id="d96cc-186">См. также:</span><span class="sxs-lookup"><span data-stu-id="d96cc-186">Related topics</span></span>
[<span data-ttu-id="d96cc-187">Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="d96cc-187">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](/microsoftteams/getting-service-phone-numbers)
