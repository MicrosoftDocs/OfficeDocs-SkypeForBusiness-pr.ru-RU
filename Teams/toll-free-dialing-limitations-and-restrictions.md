...
ms.locfileid: "34330518"
---
# <a name="toll-free-dialing-limitations-and-restrictions"></a><span data-ttu-id="d8ed9-105">Ограничения и запреты для бесплатных номеров</span><span class="sxs-lookup"><span data-stu-id="d8ed9-105">Toll-free dialing limitations and restrictions</span></span>

<span data-ttu-id="d8ed9-106">Это поможет вам узнать, как звонить на бесплатные номера в каждой стране или регионе.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-106">This will help you find out how to dial toll free numbers in each country or region.</span></span> <span data-ttu-id="d8ed9-107">После того как вы выберете страну или регион, на ней появится страница, содержащая сведения о доступности бесплатных служб, в том числе конкретные данные, ограничения и ограничения.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-107">After you select the country/region, it will take you to a page that contains where toll free service is available including specific details, restrictions, and limits.</span></span> <span data-ttu-id="d8ed9-108">В форматах набора номера или в разных регионах отображаются необходимые коды доступа в каждой стране/регионе, чтобы набрать бесплатный номер.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-108">The dialing format or formats will show you the required access codes within each country/region to dial the toll-free number.</span></span>
  
<span data-ttu-id="d8ed9-109">Если вы готовы, выберите страну или регион:</span><span class="sxs-lookup"><span data-stu-id="d8ed9-109">If you're ready, select a country or region:</span></span>
  
## <a name="select-your-country-or-region-to-see-the-dialing-codes-limitations-and-restrictions"></a><span data-ttu-id="d8ed9-110">Выберите свою страну или регион, чтобы увидеть коды набора номера, ограничения и ограничения.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-110">Select your country or region to see the dialing codes, limitations and restrictions.</span></span>
...
## <a name="here-are-some-important-things-for-you-to-remember-about-toll-free-numbers"></a><span data-ttu-id="d8ed9-173">Ниже приведены некоторые важные моменты, которые необходимо учитывать при бесплатных звонках.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-173">Here are some important things for you to remember about toll free numbers:</span></span>

- <span data-ttu-id="d8ed9-174">**Бесплатные телефонные номера работают только в пределах каждой страны/региона.**</span><span class="sxs-lookup"><span data-stu-id="d8ed9-174">**Toll free numbers only operate within each country/region.**</span></span> <span data-ttu-id="d8ed9-175">Например, пользователи не могут звонить на бесплатный номер в Австралии из других стран.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-175">For example, your users won't be able to call an Australian toll-free number outside of Australia.</span></span>
    
- <span data-ttu-id="d8ed9-176">**Получение или перенос номеров универсальной международной Freephone (УИФН) не поддерживается.**</span><span class="sxs-lookup"><span data-stu-id="d8ed9-176">**Acquiring or porting Universal International Freephone Numbers (UIFN) isn't supported.**</span></span>
    
- <span data-ttu-id="d8ed9-177">**Во многих странах или регионах агентство по использованию стабилизатора или телекоммуникационных органов в стране/регионе требует, чтобы каждый бесплатный номер телефона в течение месяца поддерживал не менее 100 минут, чтобы можно было сохранить номер.**</span><span class="sxs-lookup"><span data-stu-id="d8ed9-177">**In many countries/regions, the regulator/telecommunication agency in the country/region requires each toll free phone number to maintain at least 100 minutes of usage per month in order to retain the number.**</span></span>
...
- <span data-ttu-id="d8ed9-179">**Доступ к бесплатным номерам по проводным, наземным и мобильным линиям связи может быть полностью или частично ограничен.**</span><span class="sxs-lookup"><span data-stu-id="d8ed9-179">**Wireline, fixed line, and mobile network access to toll-free numbers may be fully or partially restricted.**</span></span> <span data-ttu-id="d8ed9-180">Формат набора номера описывает необходимые коды доступа в каждой стране/регионе для постановки звонков с использованием бесплатного номера.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-180">The dialing format describes the required access codes within each country/region to place calls using the toll free number.</span></span>
    
- <span data-ttu-id="d8ed9-181">Бесплатный **номер тарифного плана для Северной Америки:** Поминутные тарифы на звонки в Северной Америке по тарифным номерам бесплатных номеров определяются исходной страной.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-181">**North America Numbering Plan Toll Free Numbers:** Per-minute rates for North America Numbering Plan toll free numbers are determined by the originating country.</span></span> <span data-ttu-id="d8ed9-182">Бесплатная ставка за каждый минутный тариф на звонки, которые поступают из карты Соединенных Штатов, на ставку, определенную как "Северная Америка".</span><span class="sxs-lookup"><span data-stu-id="d8ed9-182">The toll free per-minute rate for calls that originate from the United States map to the rate defined as "North America."</span></span> <span data-ttu-id="d8ed9-183">Тем не менее, звонки из других стран в Северной Америке, таких как Канада, Пуэрто-Рико и т. д., имеют определенный бесплатный тариф.</span><span class="sxs-lookup"><span data-stu-id="d8ed9-183">However, calls that originate from other North American countries such as Canada, Puerto Rico, etc. have specific toll free rates.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d8ed9-185">См. также:</span><span class="sxs-lookup"><span data-stu-id="d8ed9-185">Related topics</span></span>
[<span data-ttu-id="d8ed9-186">Получение номеров телефонов служб для Skype для бизнеса и Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="d8ed9-186">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](/microsoftteams/getting-service-phone-numbers)
