...
1.  В левой области навигации центра администрирования Teams политики голосовых > **звонков**.
...
3. Создайте политику Teams, которая ссылается на пользовательский звуковой файл, и назначьте Teams пользователю.
...
После отправки звукового файла необходимо создать ссылку на файл в политике удержания Teams, используя его id при создании или Teams удержания зова. Например:
...
- Музыка при удержании доступна, только если пользователь Teams режиме.
...
-   Музыка при удержании доступна только в том случае Teams когда пользователь, называемый пользователем, использует одну из следующих версий клиента Teams:
