...
Музыка по умолчанию, которая предоставляется в Microsoft Teams 500 000 500 000 500, не предоставляется вашей организацией.
...
Если у Teams настроена политика Teams музыки при удержании отключена, то при Teams звонок не будет музыкой.
