...
Используйте шаблоны команд для развертывания согласованных команд в организации. Шаблоны также помогают пользователям ориентироваться на эффективное использование Teams.
