...
ms.locfileid: "60081622"
---
# <a name="microsoft-teams-manage-policy-packages"></a>Microsoft Teams: управление пакетами политик
...
| Имя пакета | Описание |
|---------|---------|
|Образование (учащийся с более высоким образованием)    |Создает набор политик и параметров политики, которые применяются к учащимся более высокого уровня.|
...
|Малый и средний бизнес (без голосовой почты) |Создает политику настройки приложений, релевантную для пользователей небольших и средних Teams (голосовая почта не для бизнеса).
...
Вы можете изменить параметры политики  на странице Пакеты политики или прямо на странице политики в центре Microsoft Teams администрирования.
