...
|Малый и средний бизнес-пользователь (без деловой голосовой связи) |Этот пакет политики предназначен для создания набора политик и применения этих параметров к пользователям малых и средних предприятий без каких-либо функций голосовой связи.|
...
|Здравоохранение (сотрудник Clinical)  |Создает набор политик и параметров политики, которые предоставляют Clinical сотрудникам, таким как зарегистрированные Nurses, начисление Nurses, врача и социальных работников, полный доступ к разговору, звонку, управлению сменой и собраниям. |
|Здравоохранение (информационный сотрудник)  |Создание набора политик и параметров политики, предназначаемых сотрудникам, таким как ИТ-персонал, informatics сотрудников, финансовых сотрудников и руководителей соответствия требованиям, полного доступа к разговору, звонку и собранию.|
