...
|**Имя пакета**  |**Описание** |
|---------|---------|
|Пакет Едукатион_теачер     |Создает набор политик и параметров политики, которые применяются для преподавателей.      |
|Пакет Едукатион_примаристудент    |Создает набор политик и параметров политики, которые применяются к основным учащимся.|
|Пакет Едукатион_секондаристудент    |Создает набор политик и параметров политики, которые применяются к дополнительным учащимся.         |
|Пакет Едукатион_хигхередукатионстудент    |Создает набор политик и параметров политики, которые применяются для более производительных учебных учащихся.|
...
Например, если вы назначаете пакету политики Едукатион_теачер для преподавателей в учебном заведении, для каждой политики в пакете создается политика с именем Едукатион_теачер.
