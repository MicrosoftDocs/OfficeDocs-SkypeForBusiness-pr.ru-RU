...
|Малый и средний бизнес (голосовая почта) |Создает политику настройки приложений, которая включает приложения для работы с деловыми голосами.|
|Малый и средний бизнес (без бизнес-голосовой почты) |Создает политику настройки приложений, релевантную для пользователей небольших и средних Teams (голосовая почта не для бизнеса).
...
Например, при назначении пакета политики для образования (преподавателя) преподавателям в учебном замещаемом наборе для каждой политики в пакете создается Education_Teacher политика, которая будет Education_Teacher для каждой политики в пакете.
...
**Настраиваемые пакеты политик пока недоступны для облако сообщества для государственных организаций (GCC)**
