...
> [!NOTE]
> Одна из функций, описанных в этой статье, — [пользовательские пакеты политик](#custom-policy-packages), еще не выпущены. Скоро это будет быть закрыто для предварительного просмотра.
...
Вы можете использовать [пакеты политик, включенные в Teams](#policy-packages-included-in-teams) , или [создать собственные пакеты политик](#custom-policy-packages) (в скором времени для предварительной версии).
...
**Эта функция скоро появится в частном режиме предварительной версии**
