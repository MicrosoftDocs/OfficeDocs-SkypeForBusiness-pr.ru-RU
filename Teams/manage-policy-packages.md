...
Teams в настоящее время включены следующие пакеты политики.
...
|Малый и средний бизнес (Teams Телефон с планом звонков) |Создает политику настройки приложений, которая включает приложения для Teams Телефон с помощью плана звонков.|
|Малый и средний бизнес (без Teams Телефон с планом звонков) |Создает политику настройки приложений, соответствующую для малого и среднего бизнеса Teams пользователей (не Teams Телефон с планом звонков).
...
1. В левой области навигации центра Microsoft Teams выберите **Пакеты политики** и нажмите кнопку **Добавить**.
...
Вы можете изменить параметры политики на странице Пакеты политики  или непосредственно на странице политики в центре Microsoft Teams администрирования.
