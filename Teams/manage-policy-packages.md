...
Вы можете использовать [пакеты политик,](#policy-packages-included-in-teams) включенные в Teams, или создать [собственные настраиваемые пакеты политики](#custom-policy-packages).
...
| Имя пакета | Описание |
|---------|---------|
|Образование (учащийся с высшим образованием)    |Создает набор политик и параметров политики, которые применяются к учащимся вузов.|
...
|Малый и средний бизнес (Teams телефонная система с пакетом плана звонков) |Создает политику настройки приложений, которая включает приложения для Teams телефонная система с пакетом плана звонков.|
|Малый и средний бизнес (без Teams телефонная система с пакетом плана звонков) |Создание политики настройки приложений, релевантной для малого и среднего бизнеса Teams пользователей (не Teams телефонная система с пакетами плана звонков).
...
Например, при назначении пакета политики для образования (преподавателя) преподавателям в учебном замещаемом наборе для каждой политики создается Education_Teacher для каждой политики в пакете.
...
- **[Представление](#view-the-settings-of-a-policy-in-a-policy-package)**. Просмотр политик в пакете политики. Затем перед назначением пакета можно просмотреть параметры каждой политики в пакете. Убедитесь, что вы понимаете каждый из параметров. Решите, подходят ли готовые значения для вашей организации или нужно изменить их на более строгие или менее строгие в зависимости от потребностей организации.
...
Ниже вы можете просмотреть, назначить и настроить пакеты политики в центре Microsoft Teams администрирования.
