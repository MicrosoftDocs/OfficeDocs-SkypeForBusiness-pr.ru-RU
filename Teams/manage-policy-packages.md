...
|Малый и средний бизнес (без голосовой почты) |Создание политики настройки приложений, релевантной для пользователей небольших и средних Teams (голосовая почта для нее).
