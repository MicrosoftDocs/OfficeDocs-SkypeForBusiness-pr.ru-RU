...
|Малый и средний бизнес (без бизнес-голосовой почты) |Создает политику настройки приложений, релевантную для пользователей небольших и средних Teams (голосовая почта для нее).
