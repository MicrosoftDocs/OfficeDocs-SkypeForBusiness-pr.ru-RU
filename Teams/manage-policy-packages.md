...
Teams данный момент включает следующие пакеты политик.
...
> [!NOTE]
> Мы будем добавлять дополнительные пакеты политик в будущих выпусках Teams, поэтому проверяйте их на самые последние сведения.  

Каждой отдельной политике присваивается имя пакета политики, чтобы легко определять политики, связанные с пакетом.
Например, при назначении пакета политики для образования (преподавателя) преподавателям в учебном замещаемом наборе для каждой политики в пакете создается Education_Teacher политики.
