...
::: zone target="docs"
Администраторы могут управлять всеми устройствами, используемыми Teams в Организации, из центра администрирования Microsoft Teams _Амп_ Skype для бизнеса. Вы можете просматривать и управлять инвентаризацией устройств для вашей организации, а также выполнять такие задачи, как обновление, перезапуск и мониторинг диагностики для устройств. Вы также можете создавать профили конфигурации и назначать их устройствам и группам устройств. 
...
|---------|---------|
|Изменение сведений об устройствах   | Выберите устройство, _Гт_ **изменить**. Вы можете изменить такие сведения, как имя устройства, сведения о пользователе, тег актива и добавить заметки.     |
|Управление обновлениями программного обеспечения   |Выберите _Гт_ **Обновление**устройства. Вы можете просмотреть список обновлений программного обеспечения и микропрограмм, доступных для устройства, и выбрать обновления для установки.    |
|Перезагрузка устройства   |Выберите устройство, _Гт_ **перезапустить**.          |
|Просмотр журнала устройства  | Выберите **Журнал**_гт_ на устройстве. Вы можете просмотреть историю обновлений для устройства.     |
|Просмотреть диагностику  | Выберите устройство, _Гт_ **диагностику**.        |
...
![Значок, показывающий логотип Microsoft Teams](media/teams-logo-30x30.png) Использование центра администрирования Skype для бизнеса в Microsoft Teams _Амп_
