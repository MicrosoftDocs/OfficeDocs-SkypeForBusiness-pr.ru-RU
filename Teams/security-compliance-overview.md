...
Соответствие требованиям к обмену данными в Microsoft 365 позволяет добавлять пользователей в политики в области, которые можно настроить для проверки сообщений Microsoft Teams на оскорбительную лексику, конфиденциальную информацию и информацию, связанную с внутренними и нормативными стандартами. Сообщения чата и связанные вложения в общедоступных и частных каналах Teams, отдельных чатах и вложениях можно проверять, чтобы свести к минимуму риски связи в организации. Дополнительные сведения о том, как настроить политики, помогающие обнаруживать, записывать и принимать меры для недопустимых Teams сообщений, см. в разделе "Соответствие требованиям к обмену данными["](/microsoft-365/compliance/communication-compliance) Microsoft 365.
...
Защита от потери данных (DLP) в Microsoft Teams, а также более крупная история защиты от потери данных для Microsoft 365 или Office 365, связана с готовностью бизнеса к защите конфиденциальных документов и данных. Независимо от того, есть ли у вас проблемы с конфиденциальной информацией в сообщениях или документах, политики защиты от потери данных помогут пользователям не предоставлять доступ к этим конфиденциальным данным неправильным людям.

Сведения о защите от потери данных в Teams см[. в Microsoft Teams](/microsoft-365/compliance/dlp-microsoft-teams). Хорошей статьей для защиты от потери данных O365 является [обзор защиты от потери данных](/microsoft-365/compliance/data-loss-prevention-policies).

### <a name="customer-key"></a>Ключ клиента

Microsoft 365 предоставляет дополнительный уровень шифрования поверх шифрования службы для содержимого. Используя ключи, которые вы предоставляете, ключ клиента шифрует несколько различных типов данных в Microsoft Teams. С помощью ключа клиента на уровне приложения ключ клиента шифрует Teams, хранящиеся в SharePoint Online. Дополнительные сведения см [. в разделе "Шифрование службы с помощью ключа клиента"](/microsoft-365/compliance/customer-key-overview). 
...
Дополнительные сведения об использовании средств обнаружения электронных данных в Центр соответствия требованиям Microsoft 365 поиска Teams см. по ссылкам ниже:
...
Поиск по журналам аудита подключается непосредственно к Центр соответствия требованиям Microsoft 365 и позволяет настраивать оповещения, а также создавать отчеты о событиях аудита, разрешая экспорт определенных рабочих нагрузок или универсальных наборов событий для администрирования и исследования на неограниченной временной шкале аудита. Вы можете настроить оповещения для всех данных журнала аудита в Центр соответствия требованиям Microsoft 365, а также отфильтровать и экспортировать эти данные для дальнейшего анализа. Дополнительные сведения о поиске Microsoft Teams событий в Центр соответствия требованиям Microsoft 365 см. в разделе поиска событий в журнале аудита [Microsoft Teams.](audit-log-events.md)
...
> [!NOTE]
> Поиск контента, обнаружение основных электронных данных и Advanced eDiscovery не нужно включить в Центр соответствия требованиям Microsoft 365 для работы. Дополнительные сведения см[. в Microsoft 365 решениях для обнаружения электронных данных](/microsoft-365/compliance/ediscovery).
