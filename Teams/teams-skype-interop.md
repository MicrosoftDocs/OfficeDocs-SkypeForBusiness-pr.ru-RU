...
Пользователи Skype могут найти и начать чат с пользователем Teams с помощью адреса электронной почты. Пользователь Teams получит уведомление о том, что у вас есть новое сообщение от пользователя Skype. Прежде чем пользователи Teams смогут ответить на него, вы должны сначала согласиться с сообщением.
