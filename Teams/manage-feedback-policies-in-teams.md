...
Пользователи также могут оценить свои впечатления в Teams и отправить нам подробные сведения о оценке, которая они дают. Это всплывающее опрос постоянно отображается для пользователей в Teams. Когда пользователь нажимает **кнопку "Предоставить отзыв"** в уведомлении, для его завершения отображается опрос.
...
Чтобы отключить и включить функции, установите следующие параметры:
