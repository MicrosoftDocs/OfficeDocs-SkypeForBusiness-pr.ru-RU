...
Пользователи могут отправлять нам свои комментарии и предложения о Teams, отправив **нам** отзыв  >  **в** Teams. В соответствии  с соглашением о Microsoft 365 или Office 365 данные, относясь к отзывам с помощью предложения "Предоставить отзыв", считаются "Данными поддержки", включая сведения, которые в противном случае рассматриваются как "Данные клиента" или "Личные данные".
