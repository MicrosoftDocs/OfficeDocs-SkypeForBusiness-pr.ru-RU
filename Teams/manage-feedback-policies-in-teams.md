...
В этом примере мы создали политику обратной связи под названием "Политика  отзывов о новых наемных сотрудников" и отключаем возможность обратной связи с помощью функции "Обратная связь" и опроса.
