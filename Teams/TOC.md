...
## [Публикация каталога приложения группы клиента](tenant-apps-catalog-teams.md)
...
### [Сертифицированные для прямой маршрутизации пограничных контроллеров сеансов](direct-routing-border-controllers.md)
