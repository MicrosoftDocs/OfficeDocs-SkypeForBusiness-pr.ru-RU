...
ms.locfileid: "60536510"
---
# <a name="assign-change-or-remove-a-phone-number-for-a-user"></a>Назначение, изменение и удаление номера телефона пользователя

При настройках планов звонков или Подключение телефонных номеров назначаются пользователям. В Microsoft Teams при нажатии кнопки Звонки будет указан номер телефона, который вы **назначаете.** 
