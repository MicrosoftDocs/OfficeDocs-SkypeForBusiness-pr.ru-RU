...
6. Нажмите кнопку **Сохранить**.
    > [!NOTE]
    > Из-за задержки между Microsoft 365 или Office 365 и Teams для включения пользователей может потребоваться до 24 часов. Если телефонный номер не назначается должным образом через 24 часа, [обратитесь в службу поддержки для бизнес-продуктов — Справка для администраторов](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products). Мы с радостью ответим на ваши вопросы.
