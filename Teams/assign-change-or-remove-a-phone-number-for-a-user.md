...
При настроии планов звонков вы назначаете номера телефонов пользователям. В Microsoft Teams при нажатии кнопки Звонки будет указан номер телефона, который вы **назначаете.** Инструкции по назначению, изменению и удалению номера телефона пользователя в сценарии [](./direct-routing-enable-users.md)прямой маршрутии см. в этой ссылке.
