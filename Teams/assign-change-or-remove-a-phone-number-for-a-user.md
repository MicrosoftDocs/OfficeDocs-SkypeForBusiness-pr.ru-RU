...
ms.custom:
- Calling Plans
description: Узнайте, как назначить, изменить или удалить рабочий номер телефона для Teams, чтобы внешние организации и клиенты могли звонить.
...
При настройках планов звонков или **Подключение** вы назначаете номера телефонов пользователям. В Microsoft Teams при нажатии кнопки Звонки будет указан номер телефона, который вы **назначаете.** 

**Эта статья относится к планам звонков и операторам Подключение.** Сведения о назначении, изменении и удалении номера телефона для пользователя в [](./direct-routing-enable-users.md)сценарии прямой маршрутии см. в этой ссылке.
...
4. Чтобы назначить или изменить связанное местоположение для экстренного ситуация, в области Местоположение для экстренного **ситуация** найди и выберите нужное расположение.
   ...
   > [!NOTE]
   > **Если вы назначаете номера операторам Подключение пользователей, вы можете или не сможете назначить или изменить связанное местоположение для экстренного ситуация. Эта функция будет зависеть от оператора. За дополнительными сведениями обратитесь к оператору.**
