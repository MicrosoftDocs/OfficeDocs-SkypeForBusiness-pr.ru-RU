...
5. В зависимости от того, хотите ли вы отправлять электронную почту пользователю с данными о номере телефона, отключите или включите **пользователь электронной почты с информацией о номере телефона**. По умолчанию это включено. 
6. Нажмите кнопку **Сохранить**.
    > [!NOTE]
    > Из-за задержки между Office 365 и рабочими группами может потребоваться несколько часов для включения пользователей. Если телефонный номер не назначается должным образом через несколько часов, [обратитесь в службу поддержки для бизнес-продуктов — Справка для администраторов](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products). Мы с радостью ответим на ваши вопросы.
