...
ms.locfileid: "69379365"
---
# <a name="set-up-an-auto-attendant"></a>Настройка автосекретаря

Автосекретари позволяют людям звонить в вашу организацию и перемещаться в системе меню для связи с нужным отделом, очередью вызовов, сотрудником или оператором. Вы можете создать автосекретарей для своей организации с помощью Центра администрирования Teams Майкрософт или PowerShell.
...
- **Голосовая почта** — почтовый ящик голосовой почты, связанный с группой Microsoft 365, которую вы указали. Вы можете выбрать, требуются ли расшифровки голосовой почты и системное приглашение "Оставьте сообщение после сигнала" .
  - В центре Администратор M365 включите параметр "Разрешить пользователям за пределами организации отправлять сообщения этой команде" для указанной группы Майкрософт 365.
...
## <a name="whats-new-for-auto-attendants-in-the-past-6-months"></a>Новые возможности автосекретарей за последние 6 месяцев
 ...
 - Июль — поток звонков во время праздников теперь поддерживает **параметры меню Воспроизведения**.
...
- Рабочие часы можно задать с перерывами во времени в течение дня, и все часы, которые не заданы как рабочие часы, считаются нерабочими.
...
3. Тесты определят конфигурации клиента, политики или учетной записи ресурсов, которые не позволяют автосекретарю принимать вызовы, и предоставят шаги по устранению обнаруженных проблем.
