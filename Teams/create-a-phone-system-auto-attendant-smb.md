...
В качестве параметров набора назначьте клавиши 0–9 на клавиатуре телефона одному из целевых объектов маршрутизации звонков. \* Ключи (звездочка) \# и (решетка) зарезервированы системой и не могут быть назначены повторно. Нажатие любого из этих ключей повторит текущее меню.
