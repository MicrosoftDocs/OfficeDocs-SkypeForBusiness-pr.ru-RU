...
SBC, подключенный к службе direct Routing, сообщает о расположении SBC, исходя из Record-Route полей контактов. На основе этих полей медиатайл вычисляется с помощью прямой маршрутии.
