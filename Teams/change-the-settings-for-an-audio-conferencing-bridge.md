...
Мост для проведения собраний отвечает на звонок и выводит звоняку голосовые подсказки с помощью автозавершена, а затем (в зависимости от параметров) может получать уведомления, просить звонив записать свое имя и управлять настройками ПИН-кода. ПИН-ны даются организаторам собраний, чтобы они могли начинать собрания, если они не используют Skype для бизнеса или Microsoft Teams приложение.
  ...
  > [!IMPORTANT]
  > ПИН-код необходим только организатору собрания, Skype для бизнеса или Microsoft Teams еще не начал собрание. Если кто-то звонит на собрание, организатору собрания требуется ПИН-код, чтобы начать собрание. 
