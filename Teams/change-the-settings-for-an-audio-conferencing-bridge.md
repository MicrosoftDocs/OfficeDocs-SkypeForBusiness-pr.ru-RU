...
3. В области **Параметры моста** выберите:
   ...
   - **Тонах** Когда пользователи присоединяются к собранию по номеру телефонного звонка, при его подзвучит звуковой сигнал.
