...
|Safari 13 и выше     |Личные звонки не поддерживаются. Групповые звонки полностью поддерживают аудио.<br><br>Видео: только входящие<br><br>Общий доступ: только входящий общий доступ (исходящий не поддерживается)         |Собрания полностью поддерживают аудио.<br><br>Видео: только входящие<br><br>Общий доступ: только входящий общий доступ (исходящий не поддерживается)     |
