...
|Microsoft Edge (на Chromium) новейшей версии, а также две предыдущие версии     | Звук и общий доступ полностью поддерживаются <br><br>Входящие и исходящие видео не поддерживаются (ожидается в ближайшее время)    |Полностью поддерживается         |
|Google Chrome новейшей версии, а также две предыдущие версии       |Звук и общий доступ полностью поддерживаются <br><br>Входящие и исходящие видео не поддерживаются (ожидается в ближайшее время) |Полностью поддерживается <br> <br>Общий доступ поддерживается без использования подключаемых модулей и расширений в Chrome версии 72 или более поздних.       |
