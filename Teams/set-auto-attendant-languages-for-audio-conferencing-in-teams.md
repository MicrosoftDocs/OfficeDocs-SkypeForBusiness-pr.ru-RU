...
3. В области справа выберите нужный язык по умолчанию и другие языки. 
    ...
    > [!NOTE]
    > Будут указаны используемые по умолчанию и дополнительные языки, которые поддерживаются. Порядок выбора элементов в списках — это порядок, в котором будут выводиться языки, представляемые для вызывающих абонентов. 
