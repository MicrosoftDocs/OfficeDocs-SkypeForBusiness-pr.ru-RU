...
2. Выберите **номер телефона для** аудиоконференции Dedicated в списке и в верхней части страницы нажмите кнопку **Изменить**. Изменить можно только языки выделенных номеров аудиоконференций. Параметр **Изменить** отображается только в том случае, если выбран выделенный номер аудиоконференции.
...
## <a name="want-else-should-i-know"></a>Хотите узнать об этом еще?
