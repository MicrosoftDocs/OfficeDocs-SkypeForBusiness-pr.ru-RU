...
|CQD PSTN Direct Routing Report.pbit     |Предоставляет сведения о звонках по ДНР, которые проходят прямую маршрутику. Подробнее об этом можно узнать в отчете О прямой маршрутке [по ННР.](CQD-PSTN-report.md)         |
...
|<strong>(Новое!).</strong> CQD Teams Utilization Report.pbit     | Показывает, как пользователи в вашей организации используют Teams и в какой степени. Убедитесь, что вы загрузили данные о здании, чтобы расширить отчеты. Чтобы узнать больше, ознакомьтесь с использованием отчета [CQD Power BI для просмотра](CQD-teams-utilization-report.md)использования Microsoft Teams.        |
