...
> [!IMPORTANT]
> В течение длительного перерыва в COVID-19 мы рекомендуем пользователям присоединяться к собраниям, нажимая кнопку **присоединиться к собранию** , а не звонить, используя номера конференций PSTN или **позвоните мне по адресу**. Это помогает обеспечить качество звука во время работы с большим объемом собраний, что приводит к перегрузке в сети PSTN.
