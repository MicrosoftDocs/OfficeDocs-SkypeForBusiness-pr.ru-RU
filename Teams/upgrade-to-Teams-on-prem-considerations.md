...
- **Дополнительные соображения для организаций с локальной** учетной записью Skype для бизнеса (в этой статье)
