...
После обновления пользователя до Microsoft Teams администраторы могут использовать Центр администрирования Microsoft Teams, чтобы указать приложение, которое будет применяться для пользования собранием Skype для бизнеса.
...
3. На странице обновления Teams в списке **"Параметры** приложения" выберите приложение "Собрания **Skype"**  в списке "Предпочитаемый", чтобы пользователи присоединились к собраниям **Skype** для бизнеса.
