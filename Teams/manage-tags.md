...
- **Пометка** по сменам. С помощью этой функции людям автоматически присваиваются [](https://support.microsoft.com/office/get-started-in-shifts-5f3e30d8-1821-4904-be26-c3cd25a497d6#bkmk_openshiftsappdesktop) теги, соответствующие их расписанию и названию группы смен в приложении "Смены" в Teams. Например, тег EngineerOnCall применяется для всех инженеров, запланированных в сменах, для работы во время использования тега в чате или публикации канала. Помечая их по сменам, Teams не зная имена сотрудников в смене, пользователи могут быстро ретранслировать информацию. Кроме того, теги по сменам можно использовать в основных системах управления трудовыми ресурсами, например JDA, Kronos и AMiON, путем их интеграции со Teams. Дополнительные информацию о том, как настроить эту функцию, см. в этой [теме.](#set-up-tagging-by-shift)
...
Тег может быть добавлен вручную или автоматически назначен человеку в определенной команде. Затем его можно использовать в @mentions  в строке "To" в чате или в сообщении в любом стандартном канале команды. Вот несколько примеров использования тегов в Teams.
...
Когда тег @mentioned в беседе канала, участники группы, связанные с тегом, будут получать уведомления, как и любые другие @mention.
