...
Администратор может управлять использованием тегов в организации в Центре администрирования Microsoft Teams. В настоящее время для управления тегами нельзя использовать PowerShell.
...
Если вы включили параметр  "Разрешить владельцам команды переопределять, кто может управлять параметрами тегов в Центре администрирования Microsoft Teams", владельцы команд могут указать, могут ли участники добавлять теги на уровне команды. Для этого на вкладке **"** Параметры" для команды перейдите к разделу "Теги" и выберите, кто может добавлять теги.
