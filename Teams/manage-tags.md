...
2. В **зависимости от** потребностей организации в области Маркировка установите следующие метки:
    ...
    - **Пусть создаются настраиваемые** теги: включите этот параметр, чтобы позволить другим людям добавлять теги, не рекомендуемые по умолчанию. Если этот режим отключен, люди смогут использовать только предлагаемые теги по умолчанию. Если этот режим отключен, убедитесь, что вы добавили один или несколько тегов по умолчанию.
