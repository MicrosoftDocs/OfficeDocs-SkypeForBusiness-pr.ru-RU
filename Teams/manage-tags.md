...
- **Пометка** по сменам. С помощью этой функции в приложении "Смены" автоматически присваиваются теги, соответствующие их расписанию и Teams. [](https://support.microsoft.com/office/get-started-in-shifts-5f3e30d8-1821-4904-be26-c3cd25a497d6#bkmk_openshiftsappdesktop) Например, тег EngineerOnCall применяется для всех инженеров, запланированных в сменах, для работы во время использования тега в чате или в сообщении канала. При пометки по сменам Teams, когда пользователям нужно быстро ретранслировать информацию, необходимо знать имена сотрудников, которые работают на смене. Кроме того, теги по сменам можно использовать в основных системах управления трудовыми ресурсами, например JDA, Kronos и AMiON, путем их интеграции со Teams. Дополнительные информацию о том, как настроить эту функцию, см. в этой [теме.](#set-up-tagging-by-shift)

> [!NOTE]
> Теги пока не поддерживаются в закрытых каналах. Теги недоступны в организациях с высоким GCC или в организациях с doD. 
...
Чтобы создать и назначить настраиваемые теги, **Teams** в левой части приложения, а затем найдите свою команду в списке. Выберите **̇ ̇ ̇ дополнительные параметры**, а затем **выберите Управление тегами**. Здесь можно создавать теги и назначать их людям из вашей команды.
