...
Чтобы поместить пользователя или команду на удержание по юридическим данным:
...
2. Перейдите в eDiscovery или Advanced eDiscovery создайте дело, нажав кнопку "Создать дело". После создания дела откройте его.
