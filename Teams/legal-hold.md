...
2. Перейдите **в core eDiscovery**  >  **и** создайте дело, нажав **кнопку Создать дело**. После создания дела откройте его.
   ...
   > [!NOTE]
   > Вы также можете разместить пользователя на удержании, связанном с Advanced eDiscovery дела. Дополнительные сведения см. в [Advanced eDiscovery.](https://docs.microsoft.com/microsoft-365/compliance/managing-holds)
