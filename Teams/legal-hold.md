...
В качестве полезного руководства вы можете использовать приведенную ниже таблицу, чтобы понять, что нужно поместить на удержание по юридическим основаниям с учетом требований к данным.

|Сценарий  |Что помещается на удержание  |
|---------|---------|
|**Содержимое чата Microsoft Teams пользователем (чаты 1:1, групповые или личные чаты, беседы в приватных каналах и т. д.)**     |Почтовый ящик пользователя         |
|**Чаты канала Microsoft Teams (за исключением частных каналов)**    |Используемый командой почтовый ящик группы         |
|**Контент Microsoft Teams (например, Wiki, Файлы)**     |Используемый командой сайт SharePoint         |
|**Файлы частного канала Microsoft Teams**     |Выделенный сайт SharePoint для частного     |
|**Личный контент пользователя**     |Сайт пользователя в OneDrive для бизнеса         |
||||
...
Если вы хотите подробнее ознакомиться с этой темой для областей, не в которых есть Teams, в M365, просмотрите раздел "Управление делами [eDiscovery:](https://docs.microsoft.com/microsoft-365/compliance/ediscovery-cases#step-4-place-content-locations-on-hold)удержание местоположений контента".
