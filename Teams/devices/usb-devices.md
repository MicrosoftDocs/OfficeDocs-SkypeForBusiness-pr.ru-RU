...
Программа сертификации периферийных устройств гарантирует, что периферийные устройства USB (например, гарнитуры, динамики, веб-камеры и мониторы) обеспечивают высокое качество звука и видео. Сертифицированные устройства работают (подключаются &) без дополнительной настройки и предлагают управление звонками с Microsoft Teams и Skype для бизнеса. Эти продукты предоставляют пользователям и администраторам отличный опыт работы.
...
- **Skype для бизнеса с помощью Teams обновления** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт вместе с производителями устройств обеспечивает наилучшее Teams интеграцию без изменения исходного оборудования. Кнопка *"Подключиться"* работает как Teams во время звонка и может со временем включать дополнительные функции.  Устройства из этой категории могут Teams сертификации в маркетинговых материалах.
- **Сертифицировано для Microsoft Teams** Устройства, сертифицированные на этом уровне, указывают на новые устройства, сертифицированные для Teams работы. Эти устройства предлагают все преимущества предыдущей сертификации, а также специальную кнопку Teams с индикатором LED. В большинстве форм кнопка Teams легко найти кнопку тактиль с Teams логотипом. Корпорация Майкрософт по-прежнему работает с производителями устройств, чтобы со временем предоставлять новые возможности с помощью обновлений по программному обеспечениям.
...
- Возможность активировать Teams клиента или ответить на уведомление с помощью кнопки (например, чтобы присоединиться к собранию).
- Сертификация, предназначенная для использования extensibility (новые функции устройства и клиента, которые будут поставляться с помощью обновления программного обеспечения).

### <a name="core-certification-benefits"></a>Основные преимущества сертификации

- Автоматический выбор звукового устройства и приоритетов по умолчанию, если имеется несколько периферийных устройств.
- Устройства автоматически регистрируются в клиенте Teams и готовы к использованию.
- Аудио устройства (например, гарнитуры и динамики) предлагают:
  - Основные функции управления звонками на компьютерах и устройствах Mac. Основные элементы управления включают в себя функцию ответа или зависалки, отключить или включить звук, а также управление громкости.
  - Широкодиапный звук без эха, искажения или лишнего искажения. Отмена эха также поддерживается на разных устройствах.
- Видео устройства соответствуют требованиям для шума, цвета, детализации изображения, дрожаия, задержки, частоты кадров и поля представления.

## <a name="administrator-experience"></a>Опыт администратора

- Подготовка не требуется
- Все устройства поддерживают обновления программного обеспечения, чтобы обеспечить новые функции и улучшения производительности.
...
*Таблица обновлена в октябре 2021 г.*
...
|Поли                 |Ливер 4320 и Office Base                       |10/20/2021      |Сертифицировано для Microsoft Teams                           |
|Поли                 |Ливер 4310 и Office Base                       |10/20/2021      |Сертифицировано для Microsoft Teams                           |
|Jabra                |Гарнитура Evolve 2 75                                        |10/8/2021       |Сертифицировано для Microsoft Teams                           |
|Logitech             |Zone Wired Earbuds                                         |9/2/2021        |Сертифицировано для Microsoft Teams                           |
|AudioCodes           |RXVCam10                                                   |8/26/2021       |Сертифицировано для Microsoft Teams                           |
|Поли                 |Голев 4320                                               |8/6/2021        |Сертифицировано для Microsoft Teams                           |
|Поли                 |Гол 4310                                               |8/6/2021        |Сертифицировано для Microsoft Teams                           |
...
|Dell                 |Беспроводная гарнитура WL5022 Pro WL5022                                |4/22/2021       |Сертифицировано для Microsoft Teams                           |
...
|Jabra                |Biz 2400 II                                                |4/22/2021       |Skype для бизнеса обновление до Microsoft Teams      |
|Jabra                |Biz 2300                                                   |4/22/2021       |Skype для бизнеса обновление до Microsoft Teams      |
...
|EPOS/Sennheiser      |Адаптируем гарнитуры 200 рядов                                  |3/19/2021       |Сертифицировано для Microsoft Teams                           |
...
|Поли                 |Studio P15 Video Bar                                       |2/1/2021        |Сертифицировано для Microsoft Teams                           |
|Поли                 |Синхронизация 40 динамиков                                       |1/19/2021       |Сертифицировано для Microsoft Teams                           |
|Поли                 |Синхронизация 40+ динамиков с поли BT600 USB Dongle           |1/19/2021       |Сертифицировано для Microsoft Teams                           |
|Yealink              |Двух- и моногарнитуры в РЕЖИМЕ ДВ34                                     |12/23/2020      |Сертифицировано для Microsoft Teams                           |
|Yealink              |MP50 USB-Телефон                                             |12/23/2020      |Сертифицировано для Microsoft Teams                           |
|Yealink              |Гарнитура DECT WH67                                          |12/23/2020      |Сертифицировано для Microsoft Teams                           |
...
|EPOS/Sennheiser      |Адаптируем гарнитуры 100 рядов                                  |12/22/2020      |Сертифицировано для Microsoft Teams                           |
|Dell                 |Pro Стереогарнитура — UC350                                 |12/21/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
|Dell                 |Pro Стереогарнитура — UC150                                 |12/21/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
|Lenovo               |Pro Проводная стереогарнитура VoIP                              |12/21/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
...
|Jabra                |Гарнитура Evolve 75e                                         |12/16/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
|Jabra                |Гарнитура Evolve 65e                                         |12/16/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
...
|EPOS/Sennheiser      |Impact SC 660 with USB-ED CC 01 MS connector               |8/20/2020       |Skype для бизнеса обновление до Microsoft Teams      |
|EPOS/Sennheiser      |Impact SC 630 with USB-ED CC 01 MS connector               |8/20/2020       |Skype для бизнеса обновление до Microsoft Teams      |
|EPOS/Sennheiser      |Impact SC 260 with USB-ED CC 01 MS connector               |8/20/2020       |Skype для бизнеса обновление до Microsoft Teams      |
|Jabra                |Гарнитура Evolve 75                                          |7/31/2020       |Skype для бизнеса обновление до Microsoft Teams      |
|Jabra                |Гарнитура Evolve 65                                          |7/31/2020       |Skype для бизнеса обновление до Microsoft Teams      |
|Jabra                |Гарнитура Engage 50                                          |7/31/2020       |Skype для бизнеса обновление до Microsoft Teams      |
...
|Jabra                | Проговорка 750 динамиков с помощью USB-телефона Jabra Link 370     | 5/21/2020       | Сертифицировано для Microsoft Teams                         |
| ЭПОС                | Гарнитура Sennheiser Adapt 660                              | 5/15/2020      | Сертифицировано для Microsoft Teams                          |
| ЭПОС                | Sennheiser Adapt 560 Headset                              | 5/15/2020      | Сертифицировано для Microsoft Teams                          |
...
| Поли                | Savi 8210 Office                                          | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Savi 8210 UC                                              | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Savi 8220 Office                                          | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Savi 8220 UC                                              | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Savi 8240 Office                                          | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Savi 8240 UC                                              | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Savi 8245 Office                                          | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Savi 8245 UC                                             | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Гарнитура Blackwire 5210                                    | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
| Поли                | Гарнитура Blackwire 5220                                    | 4/20/2020      | Skype для бизнеса обновление до Microsoft Teams     |
...
| Поли                | Bluetoothr 6200 Headset                                      | 3/23/2020      | Skype для бизнеса с обновлением до Microsoft Teams     |
| Поли                | Говер 4245 Office                                       | 3/23/2020      | Сертифицировано для Microsoft Teams                          |
...
| Поли                | Вояж 4210 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
| Поли                | Окайвер 4210 UC                                           | 03/05/2020     | Skype для бизнеса с обновлением до Microsoft Teams     |
| Поли                | Климов 4220 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
| Поли                | Окайвер 4220 UC                                           | 03/05/2020     | Skype для бизнеса с обновлением до Microsoft Teams     |
...
| Polycom             | Ельара                                                     | 11/06/2019     | Сертифицировано для Microsoft Teams                          |
