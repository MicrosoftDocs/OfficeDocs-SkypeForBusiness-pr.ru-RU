...
- **Skype для бизнеса с помощью Teams обновления** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт вместе с производителями устройств обеспечивает наилучшее Teams интеграцию без изменения исходного оборудования. Кнопка *"Прикнопок"* работает как Teams во время звонка и может включать дополнительные функции со временем.  Устройства из этой категории могут Teams сертификации в маркетинговых материалах.
- **Сертифицировано для Microsoft Teams** Устройства, сертифицированные на этом уровне, указывают на новые устройства, сертифицированные для Teams работы. Эти устройства предлагают все преимущества предыдущей сертификации, а также специальную кнопку Teams с индикатором LED. В большинстве форм кнопка Teams легко найти тактиль с логотипом Teams. Корпорация Майкрософт по-прежнему работает с производителями устройств, чтобы со временем предоставлять новые возможности с помощью обновлений по программному обеспечениям.
...
- Выделенная кнопка Teams и индикатор с зажигом.
...
*Таблица обновлена в августе 2021 г.*
...
| Поли                | Вояж 5200 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
