...
Пользователям не нужно заменять ранее сертифицированные устройства при обновлении Teams из Skype для бизнеса.  Все сертифицированные устройства поддерживаются Microsoft Teams и Skype для бизнеса пользователями с несколькими различиями.  Сертификация также обеспечивает дальнейшую классификацию для определенных категорий устройств.

- **Skype для бизнеса с Teams обновления** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт вместе с производителями устройств обеспечивает наилучшее Teams интеграцию без каких-либо изменений исходного оборудования. Кнопка *"Прикнопок"* работает как кнопка Teams во время звонка и может со временем включать дополнительные функции.  Устройства в этой категории могут Teams сертификации в маркетинговых материалах.
...
- Сертификация, предназначенная для доступности (новые функции устройства и клиента, которые будут поставляться с помощью обновления по программному обеспечениям).
...
*Таблица обновлена в мае 2021 г.*
