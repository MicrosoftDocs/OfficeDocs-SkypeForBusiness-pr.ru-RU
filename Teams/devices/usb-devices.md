...
- **Skype для бизнеса с помощью Teams обновления** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт вместе с производителями устройств обеспечивает наилучшее Teams интеграцию без изменения исходного оборудования. Кнопка *"Прикнопок"* работает как Teams во время звонка и может включать дополнительные функции со временем.  Устройства в этой категории могут Teams сертификации в маркетинговых материалах.
...
- Автоматический выбор звукового устройства по умолчанию и рас приоритетов, если имеется несколько аудио периферийных устройств.
...
|Dell                 |Проводная гарнитура Pro WH3022                                   |4/22/2021       |Сертифицировано для Microsoft Teams                           |
...
|EPOS/Sennheiser      |Адаптируемая гарнитура 200 рядов                                  |3/19/2021       |Сертифицировано для Microsoft Teams                           |
