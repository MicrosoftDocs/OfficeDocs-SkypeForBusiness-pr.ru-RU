...
- **Skype для бизнеса с Teams обновления** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт вместе с производителями устройств обеспечивает наилучшее Teams интеграцию без изменения исходного оборудования. Кнопка *"Подключиться"* работает как Teams во время звонка и может со временем включать дополнительные функции.  Устройства в этой категории могут Teams сертификации в маркетинговых материалах.
- **Сертифицировано для Microsoft Teams** Устройства, сертифицированные на этом уровне, указывают на новые устройства, сертифицированные для Teams работы. Эти устройства предлагают все преимущества предыдущей сертификации, а также специальную кнопку Teams со led-индикатором. В большинстве форм кнопка Teams легко найти кнопку тактиль с Teams логотипом. Корпорация Майкрософт по-прежнему работает с производителями устройств, чтобы со временем предоставлять новые возможности с помощью обновлений по программному обеспечениям.

### <a name="special-usage-designations"></a>Специальные обозначений использования

- **Premium Микрофон для открытия Office** Все гарнитуры проверяются на четкость звука, но открытый офис и другие шумные среды представляют собой большую проблему. Гарнитуры с таким обозначением подбирают голос пользователя гарнитуры, но не передают звук его микрофона.
...
|Поли                 |Скайвер 4320                                               |8/6/2021        |Сертифицировано для Microsoft Teams                           |
|Поли                 |Скайвер 4310                                               |8/6/2021        |Сертифицировано для Microsoft Teams                           |
...
| Поли                | Говер 4220 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
