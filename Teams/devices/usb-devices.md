...
- **Skype для бизнеса с помощью Teams обновления** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт вместе с производителями устройств обеспечивает наилучшее Teams интеграцию без изменения исходного оборудования. Кнопка *"Подключиться"* работает как Teams во время звонка и со временем может включать дополнительные функции.  Устройства в этой категории могут Teams сертификации в маркетинговых материалах.
