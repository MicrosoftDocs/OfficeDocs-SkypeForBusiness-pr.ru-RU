...
- **Skype для бизнеса сертифицированы с Teams обновления** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт вместе с производителями устройств обеспечивает наилучшее Teams интеграцию без изменения исходного оборудования. Кнопка *"Подключиться"* работает как Teams во время звонка и может со временем включать дополнительные функции.  Устройства в этой категории могут Teams сертификации в маркетинговых материалах.
- **Сертифицированные для Microsoft Teams** устройства, сертифицированные на этом уровне, указывают на новые устройства, сертифицированные для Teams работы. Эти устройства предлагают все преимущества предыдущей сертификации, а также специальную кнопку Teams с индикатором LED. В большинстве форм кнопка Teams легко найти кнопку тактиль с логотипом Teams. Корпорация Майкрософт продолжает работать с производителями устройств, чтобы со временем предоставлять новые возможности с помощью обновлений по программному обеспечениям.
...
*Таблица обновлена в декабре 2021 г.*
...
|Dell                 |Pro стереогарнитуры — UC350                                 |12/21/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
|Dell                 |Pro стереогарнитуры — UC150                                 |12/21/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
|Lenovo               |Pro проводной стереогарнитуры VoIP                              |12/21/2020      |Skype для бизнеса с обновлением до Microsoft Teams      |
...
| Поли                | Гоголев 4220 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
