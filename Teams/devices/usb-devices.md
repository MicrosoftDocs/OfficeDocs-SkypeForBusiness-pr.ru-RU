...
Программа сертификации периферийных устройств гарантирует, что периферийные устройства USB (например, гарнитуры, динамики, веб-камеры и мониторы) обеспечивают высокое качество звука и видео. Сертифицированные устройства работают (подключаются & воспроизведения) без дополнительной настройки и предлагают управление звонками в Microsoft Teams и Skype для бизнеса. Эти продукты обеспечивают отличный опыт для конечных пользователей и администраторов.

Чтобы изучить устройства, протестированных и сертифицированных для Microsoft Teams, откройте [Магазин Teams.](https://products.office.com/microsoft-teams/across-devices/devices)

Дополнительные сведения о поддержке управления звонками в Teams см. в этой [теме.](https://support.office.com/article/Control-calls-using-a-headset-in-Teams-65d6e104-444d-4013-b8c2-f11317dd69a8)

> [!TIP]
> Ищете устройства, сертифицированные для Skype для бизнеса? Перенаймем [на USB-аудио- и видео устройства, сертифицированные для Skype для бизнеса.](/skypeforbusiness/certification/devices-usb-devices)
...
- **Skype для бизнеса, сертифицированный с помощью обновления Teams** Устройства, сертифицированные на этом уровне, изначально сертифицированы для Skype для бизнеса. Корпорация Майкрософт работала с производителями устройств, чтобы обеспечить наилучший интеграционный процесс Teams без каких-либо изменений исходного оборудования. Кнопка *"Подключиться"* работает как кнопка Teams, когда не выполняется звонок, и может включать дополнительные функции со временем.  Устройства этой категории могут иметь эмблему сертификации Teams в маркетинговых материалах.
- **Сертифицировано для Microsoft Teams** Устройства, сертифицированные на этом уровне, указывают последние устройства, сертифицированные для работы Teams без компрометации. Эти устройства предлагают все преимущества предыдущей сертификации, а также специальную кнопку Teams с индикатором LED. При большинстве форм кнопка Teams будет легко найти кнопку тактиль с логотипом Teams. Корпорация Майкрософт продолжает работать с производителями устройств, чтобы со временем предоставлять новые возможности с помощью обновлений по программному обеспечениям.

### <a name="special-usage-designations"></a>Специальные обозначений использования

- **Premium Microphone for Open Office** Все гарнитуры проверяются на четкость звука, но открытый офис и другие шумные среды представляют собой большую проблему. Гарнитуры с таким обозначением подбирают голос пользователя гарнитуры, но не передают звук его микрофона.
...
*Таблица обновлена в апреле 2021 г.*
...
| Поли                | Скайвер 4245 Office                                       | 3/23/2020      | Сертифицировано для Microsoft Teams                          |
...
| Поли                | Скайвер 4210 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
| Поли                | Скайвер 4210 UC                                           | 03/05/2020     | Skype для бизнеса с обновлением до Microsoft Teams     |
| Поли                | Скайвер 4220 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
| Поли                | Окайвер 4220 UC                                           | 03/05/2020     | Skype для бизнеса с обновлением до Microsoft Teams     |
| Поли                | Скайвер 5200 Office                                       | 03/05/2020     | Сертифицировано для Microsoft Teams                          |
