...
4. Назначьте политики соответствия администратору устройств.  Создайте политику соответствия администратора устройств с Android и назначьте ее группе Azure Active Directory, которая содержит пользователей, которые будут в нее войди на устройства Teams. Дополнительные сведения см. в сведениях об использовании политик соответствия требованиям для применения правил для устройств, управлением которые вы управляете [с помощью Intune.](https://docs.microsoft.com/mem/intune/protect/device-compliance-get-started)
