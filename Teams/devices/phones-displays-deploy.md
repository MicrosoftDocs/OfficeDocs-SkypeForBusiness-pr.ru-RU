...
В этой статье представлен обзор развертывания Teams телефонов и Teams с помощью Intune.
...
Teams Управление устройствами на базе Android осуществляется в Intune с помощью управления android Device Administrator (DA). Перед регистрацией устройств в Intune необходимо выполнить несколько основных действий.  Если вы уже управляете устройствами в Intune сегодня, вероятно, вы уже сделали все это.  Если нет, вот что нужно сделать:

1. Установите для Intune MDM (управление мобильными устройствами) полномочия.  Если вы никогда раньше не использовали Intune, для регистрации устройств необходимо настроить полномочия MDM. Дополнительные сведения см. в руководстве по управлению [мобильными устройствами.](/intune/fundamentals/mdm-authority-set)  Это разовые этапы, которые необходимо сделать при создании нового клиента Intune.
2. Включить регистрацию администратора устройств с Android. Устройствами администратора Teams android управляется Intune.  Регистрация администратора устройства по умолчанию отключена для новых клиентов.  Дополнительные сведения см. в [регистрации администратора устройств с Android.](/intune/enrollment/android-enroll-device-administrator)
3. Назначение лицензий пользователям. Пользователям Teams устройств, зарегистрированных в Intune, должна быть назначена действительная лицензия intune. Дополнительные сведения см. в статьи Назначение лицензий пользователям для регистрации [устройств в Intune.](/intune/fundamentals/licenses-assign)
4. Назначьте политики соответствия администраторам устройств.  Создайте политику соответствия администратора устройств Android и назначьте ее группе Azure Active Directory, которая содержит пользователей, которые будут в нее в Teams устройств. Дополнительные сведения см. в теме Настройка правил для устройств, управляемых [с помощью Intune,](/mem/intune/protect/device-compliance-get-started)с помощью политик соответствия требованиям.
