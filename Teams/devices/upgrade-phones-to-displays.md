...
В этой статье приводится обзор обновления телефонов Teams до отображаемого устройства Teams в Центре администрирования Microsoft Teams. Это позволяет сделать устройства более насыщенными и насыщенными для пользователей, так как они будут отображаться в Teams.

Дисплеи Teams — это категория всех выделенных устройств Teams с сенсорным экраном окружающего мира и без помощи Кортаны. Дисплеи Teams являются дальнейшей эволюцией телефонов Teams. Помимо функций, поддерживаемых телефонами [Teams,](phones-for-teams.md#features-supported-by-teams-phones)в Teams отображаются такие функции, как постоянное отображение, в котором все действия и возможности совместной работы Teams доступны всегда. Дополнительные информацию о уникальных для teams возможностями см. в [дисплеях Microsoft Teams.](teams-displays.md)
