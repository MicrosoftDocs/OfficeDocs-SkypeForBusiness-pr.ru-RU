...
На этом изображении учетной записи пользователя назначена общая лицензия на [Телефон области](/microsoftteams/set-up-common-area-phones). Обычные телефоны с районами в основном используются для звонков и приема звонков. Поэтому на экране отображается панель набора номера:
