...
|Раздел Teams в Центр администрирования Microsoft 365  |Имя параметра (уровень клиента)  |Microsoft Teams политики Центра администрирования   |Уровень: клиент или пользователь   |
|---------|---------|---------|---------|
