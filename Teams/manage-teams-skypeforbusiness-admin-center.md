...
<sup>1</sup> Неподготовлен для гостей. Включением и отключением гостя теперь можно управлять в Microsoft Teams администрирования. Включение и отключение Teams для бизнеса Enterprise, студентов и преподавателей Edu скоро будет отключать. Для этого следует назначить лицензии в Центр администрирования Microsoft 365. См. [управление доступом пользователей к Microsoft Teams.](user-access.md)
<br><br>
...
|Компонент  |Microsoft Teams центре администрирования                      |Skype для бизнеса администрирования (устаревшая версия)  |Центр администрирования Microsoft 365  |
|---------|:---------:|:---------:|:---------:|
...
Когда перенос этих параметров завершится, мы отключим их в центре администрирования Центр администрирования Microsoft 365 и Skype для бизнеса, и управлять ими можно будет в новом Центре администрирования Microsoft Teams администрирования.