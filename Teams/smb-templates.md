...
В настоящее время мы предлагаем три шаблона для SMB, которые можно использовать в различных ситуациях. Все шаблоны будут создавать *частные Teams.* Когда вы создаите Teams и будете готовы к распространению в своей организации, вы можете установить для конфиденциальности все организации или общедоступные *(* при необходимости).  Дополнительные сведения о шаблонах команд см. в статье [Начало работы с шаблонами Teams](get-started-with-teams-templates.md).
