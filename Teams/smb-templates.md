...
В настоящее время мы предлагаем три основного шаблона SMB, который можно использовать в различных ситуациях. Все шаблоны будут создавать *закрытые* команды. После создания Teams и готовности к развертыванию в своей организации вы можете настроить *конфиденциальность или* *общедоступное*приложение. Дополнительные сведения о шаблонах групп можно найти в разделе [Начало работы с шаблонами групп](get-started-with-teams-templates.md).
