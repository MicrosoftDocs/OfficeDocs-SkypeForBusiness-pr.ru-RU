...
Если вы не используете канал Teams для управления членством в агентах, можно непосредственно настроить для участников очереди  вызовов номер службы очереди  вызовов или соответствующий автослужб. Дополнительные сведения см. в [этой](caller-id-policies.md) Microsoft Teams.
...
Для управления пользователями, учетными записями ресурсов, лицензиями на Microsoft Teams Телефон, номерами телефонов, звуковые файлы и поддерживаемым языком, которые будут использоваться с очередями звонков, также требуются следующие дополнительные cmdlets:
