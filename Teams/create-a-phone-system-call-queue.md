...
Если вы не используете канал Teams для управления членством в агентах, можно непосредственно настроить для участников очереди параметров звонка номер службы очереди вызовов или соответствующий автослужб. Дополнительные [сведения см.](caller-id-policies.md) в Microsoft Teams управление политиками ИД звоня.
...
- **Маршруты attendant одновременно** звонят всем агентам в очереди. Звонок получит первый агент звонка.
