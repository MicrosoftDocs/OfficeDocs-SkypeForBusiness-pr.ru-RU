...
- При распределении входящие звонки из очереди вызовов телефонной системой этих клиентов поддерживаются для агентов звонка:
  ...
  - Все модели телефона IP-адресов, поддерживаемые для групп Майкрософт. В разделе [Приступая к телефоны для Скайп для бизнеса в Интернет](/skypeforbusiness/what-is-phone-system-in-office-365/getting-phones-for-skype-for-business-online/getting-phones-for-skype-for-business-online.md).
...
Если отсутствуют в списке, необходимо получить номера службы и назначить их учетная запись ресурса перед созданием очереди этот звонок, как описано выше. Для получения номера службы видеть [Приступая к службе телефонных номеров](/skypeforbusiness/what-is-phone-system-in-office-365/getting-service-phone-numbers.md). Вам потребуется создать учетную запись ресурса, как описано в [Управление учетными записями ресурсов в группах](manage-resource-accounts.md) , если требуется очереди с числом телефонных звонков.
...
- **Перенаправление** При выборе этого выберите один из следующих вариантов.
  ...
  Для получения дополнительных сведений о лицензиях, необходимых для использования голосовой почты, см. [Настройка голосовой почты телефонной системы](set-up-phone-system-voicemail.md).
...
## <a name="changing-a-users-caller-id-to-be-a-call-queues-phone-number"></a>Изменение Звонящего пользователя быть очереди вызовов номер телефона
...
Можно получить дополнительные сведения о внесении изменений в параметры идентификатор звонящего в вашей организации в статье, [как идентификатор звонящего используются в организации](/skypeforbusiness/what-are-calling-plans-in-office-365/how-can-caller-id-be-used-in-your-organization.md).
