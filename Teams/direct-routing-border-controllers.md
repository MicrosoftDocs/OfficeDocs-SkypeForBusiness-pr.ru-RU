...
- Создай совместную процедуру поддержки с поставщиками SBC.
  ...
  > [!NOTE]
  > Корпорация Майкрософт поддерживает телефонная система только в том случае, если сертифицированные устройства подключены с помощью прямой маршрутии. Корпорация Майкрософт оставляет за собой право отклонить запросы поддержки, если к нему подключено не сертифицированное устройство телефонная система прямой маршрут. Если корпорация Майкрософт определяет, что проблема с прямой маршрутией клиента имеется в SBC-устройстве поставщика, клиенту потребуется привлечь его к поддержке.
...
|  [Ribbon Communications](https://ribboncommunications.com/solutions/enterprise-solutions/microsoft-skype-business)  |      SBC 5100/5110       |     &#10004;     |   &#10004;    |       Поддерживаются 8.2 и 7.2 (рекомендуется 9.2)       | &#10004;   |     |    
|                                                                                                                     |      SBC 5200/5210       |     &#10004;     |  &#10004;    |       Поддерживаются 8.2 и 7.2 (рекомендуется 9.2)       |   &#10004; |    |    
|                                                                                                                     |      SBC 5400       |     &#10004;     |   &#10004;   |       Поддерживаются 8.2 и 7.2 (рекомендуется 9.2)       |   &#10004;  ||    
|                                                                                                                     |      SBC 7000       |     &#10004;     |   &#10004;    |       Поддерживаются 8.2 и 7.2 (рекомендуется 9.2)       |    &#10004;  |  |    
|                                                                                                                     |       SBC SWe       |     &#10004;     |   &#10004;   |       Поддерживаются 8.2 и 7.2 (рекомендуется 9.2)          |  &#10004;    |    |    
