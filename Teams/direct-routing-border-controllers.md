...
- установка технической поддержки совместно с поставщиками SBC.
  ...
  > Пример.
  >
  > - Поддерживается 6.10.258. В этом случае мы также поддерживаем версии встроенного ПО 6.10.(258 или выше).
  > - Рекомендуемая версия — 6.20.100. В этом случае также рекомендуется использовать версию встроенного ПО 6.20.(100 или выше).
