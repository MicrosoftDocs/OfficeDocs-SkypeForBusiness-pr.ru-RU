...
В рамках современной веб-службы клиент Teams обновляется примерно раз в месяц. Клиент автоматически устанавливает обновления, когда они становятся доступными для этого клиента. Так как мы ошеломляем доступность обновлений по всему миру, некоторые клиенты в вашей организации могут получать новые обновления раньше других. Так как Teams регулируется современной политикой жизненного цикла, ожидается, что пользователи будут использовать самую новую версию классического клиента. Автоматическое обновление гарантирует, что пользователям будут доступны новейшие возможности, улучшения производительности, безопасность и надежность службы.
