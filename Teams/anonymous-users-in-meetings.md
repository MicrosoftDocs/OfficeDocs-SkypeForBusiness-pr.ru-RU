...
Анонимное присоединение к собранию включено по умолчанию для организации и в глобальной политике собраний по умолчанию. Мы рекомендуем оставить параметр уровня организации включенным и использовать политики собраний, чтобы включить или отключить анонимное присоединение к собранию для разных пользователей (организаторов собраний).

Обратите внимание, что если включено анонимное присоединение к собранию, политики лобби влияют на то, как анонимные участники присоединяются к собраниям. Дополнительные сведения см [. в разделе Управление тем, кто может обойти зал собраний в Microsoft Teams](who-can-bypass-meeting-lobby.md).
...
- Параметр `-DisableAnonymousJoin` в [Set-CsTeamsMeetingConfiguration](/powershell/module/skype/set-csteamsmeetingconfiguration) для настройки параметра уровня организации. (Рекомендуется оставить для этого параметра значение False и использовать Set-CsTeamsMeetingPolicy -AllowAnonymousUsersToJoinMeeting для управления анонимным присоединением к собранию на уровне пользователя или группы.)
...
Чтобы разрешить анонимным участникам присоединяться к собраниям, необходимо настроить разрешение анонимного присоединения к собранию, задав следующие значения:
...
## <a name="block-anonymous-meeting-join-for-specific-client-types"></a>Блокировка анонимного присоединения к собранию для определенных типов клиентов
