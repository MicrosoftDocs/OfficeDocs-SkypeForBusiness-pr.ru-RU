...
|Соединенные Штаты |Соединенное Королевство|Да (зона а страна) |  Да, *после* использования пула минут клиента       |
...
- Все звонки на ненужные адреса получателям, находящимся за пределами зоны, выставляются счета за минуту с использованием кредитов связи по нашим тарифам на наши опубликованные тарифы (при условии, что клиент настроил кредиты на связь и назначил Вам лицензию на связь в организаторе собрания).
