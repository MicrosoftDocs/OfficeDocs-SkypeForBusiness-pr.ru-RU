...
ms.locfileid: "36235162"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Техническая документация по Microsoft Teams</h1>
        <P> </p>
        <ul class="pivots">
            <li>
                <a href="#home"></a>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Плакаты: архитектура Teams, решения для телефонии</h3>
                                                <P>Используйте доступные для печати иллюстрации ИТ-архитектуры и решений для телефонии Teams</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Использование Teams во всей организации</h3>
                                                <P>Находите настраиваемые решения для своей отрасли, в том числе для здравоохранения, сотрудников без компьютера, розничной торговли, государственных организаций и образовательных учреждений</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Присоединяйтесь к сообществу технических специалистов по Teams, чтобы получать ответы на свои вопросы и читать блог Teams</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Справка по Teams для конечного пользователя</h3>
                                            <p>Перейдите в раздел справки, обучения и новых возможностей для конечных пользователей</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <a href="https://docs.microsoft.com/microsoftteams/platform/overview"> <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        <div class="cardImageOuter">
                                            <div class="cardImage">
                                                <img src="https://docs.microsoft.com/ru-RU/office/media/icons/developer-teams.svg" alt="Developer" data-linktype="external">
                                            </div>
                                        </div>
                                        <div class="cardText">
