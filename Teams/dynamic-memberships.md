...
## <a name="create-a-new-team-with-your-microsoft-365-group"></a>Создание новой команды с помощью группы Microsoft 365

Теперь дождитесь вступления в силу изменений в членстве и создайте новую команду, как описано в разделе [Создание группы на основе существующей группы](https://support.microsoft.com/en-us/office/create-a-team-from-an-existing-group-24ec428e-40d7-4a1a-ab87-29be7d145865).
