...
В этом наглядном примере эффективной политикой пользователя является политика Exec Teams и HD, которая имеет наивысшее ранжирование по отношению к другим группам, участником которых является пользователь, и которым назначена политика того же типа политики.  

![Схема, показывающая приоритет политики, унаследованной от группы](media/assign-policies-example-group.png)
...
![Обновление глобальной политики в Teams администрирования](media/assign-globalpolicy.png)
