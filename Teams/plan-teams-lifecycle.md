...
| ![](media/audio_conferencing_image9.png)<br/>Следующие шаги|<ul><li>Задокументируйте полученный опыт.</li><li>При необходимости заархивируйте нужные данные.</li></ul>|
