...
При переходе со Skype для бизнеса на Teams в некоторых организациях требуется постепенное обновление, которое планируется и управляется ИТ-отделом. Статьи в этом разделе в основном касаются ИТ-администраторов крупных организаций. Эти организации обычно являются локальной, но, возможно, они также являются крупными организациями Skype для бизнеса Online. Прежде чем прочитать эти статьи, ознакомьтесь со статьями "Начало работы с обновлением [Teams"](upgrade-start-here.md) и ["Об обновлении".](upgrade-framework.md)
