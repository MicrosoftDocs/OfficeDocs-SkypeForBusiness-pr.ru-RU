...
Сначала собрания основаны на режиме сосуществования **SfBWithTeamsCollabAndMeetings** . Собрания сначала не являются продуктом или функцией — это конфигурация, которая использует возможности и функции Teams и Skype для бизнеса для обеспечения уникального соотношения сосуществования.
...
> [!Important]
> Собрания сначала лучше всего подходит для организаций, у которых нет или мало активных пользователей. Активные команды. пользователи чата не должны переключаться на собрания в первом режиме, так как они не смогут общаться в Teams и получить доступ к истории чатов. Эти пользователи должны быть grandfathered в режиме " **острова** ", а собрания — только тем пользователям, которые еще не были активны в чате в Teams.
