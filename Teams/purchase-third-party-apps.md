...
2. Найди нужное приложение. Чтобы определить приложения с платной подпиской на SaaS, посмотрите в столбце **"Лицензии".** У каждого приложения будет одно из следующих значений:
