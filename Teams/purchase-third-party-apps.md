...
3. Когда вы найдете приложение, нажмите кнопку  **"Приобрести сейчас",** чтобы перейти на вкладку "Планы и цены" на странице сведений о приложении. Просмотрите сведения о планах и ценах для предложения SaaS для приложения. Если вам нужны дополнительные  сведения, щелкните ссылку "Дополнительные сведения", чтобы перейти на страницу приложения [в AppSource.](https://appsource.microsoft.com/)  
4. Чтобы приобрести план, нажмите кнопку **"Приобрести".** Вы будете перенаправлены на покупку для предложения, связанного с приложением Teams. Здесь вы сможете завершить покупку службы или предложения SaaS.
...
Сторонние разработчики приложений могут перейти к предложению "Создать [SaaS",](/azure/marketplace/partner-center-portal/create-new-saas-offer) чтобы получить дополнительные сведения.
