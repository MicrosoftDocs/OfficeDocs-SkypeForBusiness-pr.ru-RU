...
> [!IMPORTANT]
> При включении покупки приложений также будет включена покупка в приложениях. Пользователи могут видеть предложения покупок из приложений, которые управляются независимым поставщиком программного обеспечения в рамках своего приложения. Если вы хотите заблокировать покупку приложения пользователями, необходимо заблокировать приложение. Дополнительные сведения о блокировке приложения см. в разделе [Управление политиками приложений](app-policies.md) или [сведениях о том, как блокировать приложение на уровне организации](manage-apps.md#allow-and-block-apps).
...
1. Когда найдете приложение, нажмите **Купить сейчас**, чтобы перейти на вкладку **Планы и цены** на странице сведений о приложении. Ознакомьтесь с планами и ценами предложения SaaS для приложения. Если вам нужны дополнительные сведения, щелкните **Подробнее**, чтобы перейти на страницу приложения в [AppSource](https://appsource.microsoft.com/).
   ...
   > [!NOTE]
   > Для покупки также могут указываться частные планы, включающие специальные цены, которые ваша организация ранее согласовала с независимым поставщиком программного обеспечения. Эти планы будут содержать метку **Частный план** под именем плана.
