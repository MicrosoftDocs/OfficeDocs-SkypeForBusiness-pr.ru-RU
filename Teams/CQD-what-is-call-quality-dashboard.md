...
Текущая версия CQD ( заменяет более старую https://CQD.Teams.microsoft.com) версию CQD ( https://CQD.lync.com) . Вы по-прежнему CQD.lync.com приложение (доступно в Центре администрирования Skype для бизнеса), но с 1 июля 2020 г. оно будет использовать данные из CQD. Teams.microsoft.com. Мы отключим доступ к CQD.lync.com, поэтому вам следует перейти на CQD. Teams.microsoft.com, если вы еще не сделали этого.
