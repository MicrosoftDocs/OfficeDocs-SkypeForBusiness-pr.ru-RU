...
- Интернет-версия: Войдите Центр администрирования Microsoft 365 и отправьте запрос на обслуживание, выбрав **Создать запрос на обслуживание** в разделе **Поддержка**.
