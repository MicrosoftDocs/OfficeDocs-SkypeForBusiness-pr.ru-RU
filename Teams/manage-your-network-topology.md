...
5. Чтобы назначить на сайт политики экстренных служб, сделайте следующее:
    ...
    - Если в вашей организации используются планы звонков, Подключение или прямая маршрутизации, в области Политика экстренных вызовов **выберите** политику.
    - Если в вашей организации развернута прямая маршрутизации, в области Политика маршрутизации экстренных вызовов **выберите** политику.
...
1. В левой области навигации центра администрирования Microsoft Teams в топологии **сети** расположения и перейдите на вкладку  >   **Надежные адреса.**
2. Выберите **Создать**.
