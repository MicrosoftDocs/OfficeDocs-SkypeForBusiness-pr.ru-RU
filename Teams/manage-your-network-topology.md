...
3. Чтобы связать сайт с сетевым регионом, щелкните **Добавить сетевой регион** , выберите существующий регион или нажмите кнопку **Добавить** , чтобы добавить регион, а затем нажмите кнопку **связать**.  
4. Чтобы включить Location-Basedную маршрутизацию для сайта, включите **маршрут на основе расположения**.
