...
1. В левой области навигации центра администрирования Microsoft Teams перейти в топологию **сети** местоположений , а затем перейдите  >  на **вкладку Сетевые сайты.**
...
5. Чтобы назначить на сайт политики экстренных служб, сделайте следующее:
    ...
    - Если ваша организация развернула телефонная система прямой маршрутизации, в области Политика маршрутизации экстренных вызовов **выберите** политику.
...
1. В левой области навигации центра администрирования Microsoft Teams перейти к топологии **Сети** расположения и перейти на вкладку  >   **Надежные адресатов.**
2. Выберите **Создать**.
...
Для выполнения действий, которые вы выполните в этом разделе, вам потребуется ознакомиться с помощью powerShell.) Дополнительные сведения см. в [Teams Обзор PowerShell.](teams-powershell-overview.md)
...
В этом примере мы создадим два новых сетевых сайта — "Кузьмина" и "Совка" в индийском регионе.
...
В этом примере мы создадим связь между подсетей 192.168.0.0 и сетевым сайтом "Объединение" и подсети 2001:4898:e8:25:844e:926f:85ad:dd8e и сайтом сети Facebook.
