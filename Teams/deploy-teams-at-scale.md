...
> [!NOTE]
> В настоящее время эта функция доступна в общедоступной предварительной версии. Если вы хотите принять участие, свяжитесь с нами по [адресу dscale@microsoft.com](mailto:dscale@microsoft.com).
