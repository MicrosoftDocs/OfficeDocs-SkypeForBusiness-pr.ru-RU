...
При подготовке к внедрению QoS следует помнить о следующих правилах:
...
В глобальной организации с управляемыми ссылками, охватывающими континенты, мы настоятельно рекомендуем использовать QoS, так как пропускная способность для этих связей ограничена в сравнении с локальной сетью.
