...
Хотя этот сценарий действителен, он будет работать только для клиентов, которые Windows доменами. Все устройства, которые не присоединились к Windows домена, не будут включены для маркировки DSCP. Другие клиенты, например, работающие под управлением macOS, имеют жестко закадные теги и всегда будут помечать трафик.
