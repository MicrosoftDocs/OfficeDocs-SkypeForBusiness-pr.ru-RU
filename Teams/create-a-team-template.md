...
**Проблема**. Если вы создали команду из настраиваемого шаблона, который содержал дополнительные настраиваемые вкладки, на месте пользовательских приложений вкладок могут быть пустые вкладки. Вкладки по умолчанию (такие как **Записи**, **Файлы** и **Вики**) будут отображаться как ожидалось.
...
**Проблема**. При использовании Teams в браузере некоторые веб-сайты не поддерживают Teams вкладке.
