...
Администраторы Microsoft 365 или Office 365 организации, технические пользователи и службы технической поддержки должны быть подотчетны за высокое качество работы пользователей. Это включает в себя обеспечение готовности сети к поддержке Teams, настройку Teams для пользователей, а также эффективное устранение неполадок и устранение возникающих проблем.
...
|&nbsp; |&nbsp; |
|---|---|
| ![Значок, изображающий точки принятия решений](media/audio_conferencing_image7.png) <br/>Точки принятия решений|<ul><li>Вы участвовали в развертывании и поддержке службы поддержки сотрудников, которые, вероятнее всего, участвуют в развертывании и Teams?</li><li>Вы разработали план обучения для дополнительного персонала по мере обновления?</li></ul> |
