...
5. Если вы согласны с разрешениями, заданными приложением, нажмите кнопку **"Принять",** чтобы предоставить согласие. В верхней части страницы временно появляется баннер, который сообщает о том, что запрашиваются разрешения для приложения. Теперь у приложения есть доступ к указанным ресурсам для всех пользователей в организации, и никто другой не будет получать запрос на просмотр разрешений.
