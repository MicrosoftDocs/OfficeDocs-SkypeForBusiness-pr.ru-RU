...
Чтобы предоставить разрешение для всей организации приложению, выполните следующие действия:
...
Если пользователям в вашей организации разрешено предоставлять согласие и если один или несколько пользователей предоставили согласие определенному приложению, вы также увидите то же сообщение, что и о том, что согласие предоставлено, и ссылка Azure Active Directory на страницу приложения на портале Azure AD.

> [!NOTE]
> Хотя параметр  Просмотр разрешений и согласия не доступен администраторам служб Teams и они не могут предоставлять разрешения администраторам во всей организации  для приложений, администраторы служб Teams могут просматривать содержимое на вкладке Разрешения для приложения. Например, администратор Teams службы может щелкнуть ссылку Azure Active Directory, чтобы просмотреть сведения о разрешениях приложений на портале Azure AD.  
...
Разрешения на RSC-запросы. Владельцы команд могут предоставлять приложению согласие на доступ к данным группы и их изменение. Разрешения RSC являются детализацией, Teams разрешениями, которые определяют, что приложение может делать в определенной команде. Примерами разрешений RSC являются возможность создавать и удалять каналы, получать параметры для команды, а также создавать и удалять вкладки каналов. 
...
Глобальные администраторы и Teams могут просматривать разрешения RSC для приложения  на вкладке Разрешения на странице сведений о приложении. 
...
- [Навигация по жизненному Teams](https://aka.ms/PR132) приложения (сеанс Ignite 2020)