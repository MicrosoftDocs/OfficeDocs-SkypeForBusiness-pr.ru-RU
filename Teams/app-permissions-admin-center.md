...
Разрешения на RSC-запросы. Владельцы команд могут предоставлять приложению согласие на доступ к данным группы и их изменение. Разрешения RSC являются детализацией и Teams, которые определяют, что приложение может делать в определенной команде. Примерами разрешений RSC является возможность создавать и удалять каналы, получать параметры для команды, а также создавать и удалять вкладки каналов. 
...
- [Перемещение по жизненному Teams](https://aka.ms/PR132) приложения (сеанс Ignite 2020)