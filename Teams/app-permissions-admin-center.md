...
Примеры разрешений, запрашиваемого приложениями, включают возможность чтения сведений, хранимой в группе, чтения профиля пользователя и отправки сообщения электронной почты от имени пользователей. Подробнее см. в [этой](/azure/active-directory/develop/v2-permissions-and-consent)платформа удостоверений Майкрософт. 
