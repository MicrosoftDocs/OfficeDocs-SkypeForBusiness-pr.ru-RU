...
5. Если вы согласны с разрешениями, запрашиваемой приложением, нажмите **кнопку** Принять, чтобы предоставить согласие. В верхней части страницы временно появляется баннер с запросом разрешений, предоставленных приложению. Теперь у приложения есть доступ к указанным ресурсам для всех пользователей в организации, и больше никто не будет получать запрос на просмотр разрешений.
...
> [!NOTE]
> Хотя параметр  Просмотр разрешений и согласия не доступен администраторам служб Teams и они не могут предоставлять разрешения администраторам на доступ к  приложениям для всей организации, администраторы служб Teams могут просматривать содержимое на вкладке Разрешения для приложения. Например, администратор Teams службы может щелкнуть ссылку Azure Active Directory, чтобы просмотреть сведения о разрешениях приложений на портале Azure AD.  
...
Разрешения на RSC-запросы. Владельцы команд могут предоставлять приложению согласие на доступ к данным группы и их изменение. Разрешения RSC являются детализацией и Teams, которые определяют, что приложение может делать в определенной команде. Примерами разрешений RSC являются возможность создавать и удалять каналы, получать параметры для команды, а также создавать и удалять вкладки каналов. 
...
Глобальные администраторы и Teams службы могут просматривать разрешения RSC  для приложения на вкладке Разрешения страницы сведений о приложении. 
...
3. В Graph разрешения майкрософт на доступ к ресурсам **(RSC)** просмотрите разрешения RSC, запрашиваемые приложением.
...
- [Навигация по Teams (сеанс](https://aka.ms/PR132) Ignite 2020)