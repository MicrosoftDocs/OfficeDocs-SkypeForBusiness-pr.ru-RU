...
- **Голосовая** почта: если вы телефонная система лицензию на голосовую почту пользователя, этот пользователь может получать голосовую почту, оставленную вызывателями. облачная голосовая почта автоматической настройка и подготовка пользователей после назначения им лицензии телефонная система и номера телефона. См. [облачная голосовая почта](set-up-phone-system-voicemail.md).
