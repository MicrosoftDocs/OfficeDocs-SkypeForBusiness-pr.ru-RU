...
телефонная система возможность управления звонками и УАКС в облаке с Microsoft Teams и Skype для бизнеса Online. 
...
Для звонков за пределами организации корпорация Майкрософт предоставляет несколько параметров для подключения телефонная система к телефонной сети общего звонков (STN).
...
- **Голосовая** почта: если вы телефонная система лицензию на голосовую почту для пользователя, он может получать голосовую почту, оставленную вызывателями. облачная голосовая почта автоматической настройка и подготовка для пользователей после назначения им лицензии телефонная система и номера телефона. См. [облачная голосовая почта](set-up-phone-system-voicemail.md).

Дополнительные сведения о функции [см.](here-s-what-you-get-with-phone-system.md)в этой телефонная система. Если вы готовы начать работу, см. статью Настройка телефонная система [в организации.](setting-up-your-phone-system.md)
