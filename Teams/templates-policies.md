...
1. Выберите применить.
   Подробнее о назначении политик пользователям можно узнать в Microsoft Teams [- Microsoft Teams \| Microsoft Docs.](./assign-policies.md#assign-a-policy-to-a-batch-of-users)
