...
Технология NDI® стала стандартным отраслевым решением для создания трансляций контента для потоков, и в профессиональном мире широковещательного бизнеса стала заметной информацию и стала ее внедрением.
...
На рисунке ниже показано сообщение баннера, которое пользователь видит на собрании Teams.
...
> [!NOTE]
> NDI® активируется только для каждого сеанса. При следующем входе пользователь должен активировать его перед использованием NDI®.
...
- Гостевой доступ — нет потокового доступа  
