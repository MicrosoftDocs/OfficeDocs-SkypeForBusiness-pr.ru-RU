...
- Назначьте лицензию на план звонков Майкрософт, назначьте номер телефона Operator Connect или назначьте политику маршрутизации голосовой связи через Интернет для прямой маршрутизации.
...
4. Можно задать порядок только при добавлении отдельных пользователей в стандартные очереди вызовов. При использовании списка рассылки или канала Teams порядок будет иметь алфавитный формат.
