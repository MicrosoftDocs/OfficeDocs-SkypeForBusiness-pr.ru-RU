...
* URL-адрес экземпляра соединителя должен рассматриваться как секретный или конфиденциальный: любой пользователь, у которого есть этот URL-адрес, может опубликовать его, например адрес электронной почты. Таким образом, существует определенный риск нежелательной почты или ссылок на фишинговые или вредоносные сайты. В этом случае владельцы команд могут удалить экземпляр соединителя.
