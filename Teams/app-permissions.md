...
ms.locfileid: "64556330"
---
# <a name="microsoft-teams-apps-permissions-and-considerations"></a>Разрешения и рекомендации для приложений Microsoft Teams

Microsoft Teams приложения — это способ агрегировать одну или несколько возможностей в приложения, которые можно устанавливать, обновлять и устанавливать. Доступны следующие возможности приложений:
...
Как администратор вы управляете только приложениями. Однако в этой статье рассматриваются разрешения и аспекты на уровне возможностей, так как возможности приложения влияют на необходимые разрешения и профили рисков приложения. Для использования пользователи могут получить разрешение на использование приложений и управлять им с точки зрения политики.

Например, разрешения, перечисленные ниже в закавных буквах, `RECEIVE_MESSAGE` `REPLYTO_MESSAGE` и только для иллюстрации и пояснения. Эти строки или разрешения не отображаются в документации Microsoft Teams или [](/microsoftteams/platform/overview) разрешениях для [Microsoft Graph](/graph/permissions-reference).
...
* Приложениям также могут потребоваться разрешения, кроме разрешений на согласие для конкретного ресурса. После установки приложения приложение может запросить разрешение Graph с помощью запроса на согласие. Дополнительные информации см. в [этой теме](/azure/active-directory/develop/application-consent-experience). Вы можете настроить разрешения API и согласие в портал Azure. Дополнительные информации см. [в Azure Active Directory согласия](/azure/active-directory/develop/consent-framework).
