...
- Каждый раз, когда соединителя настроена для канала, для этого экземпляра создается уникальный URL-адрес. При удалении этого экземпляра соединителя использовать URL-адрес больше нельзя.
