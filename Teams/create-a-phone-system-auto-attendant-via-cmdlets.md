...
![Схема потока вызовов автосекретаря, который создается с помощью командлетов.](media/create-a-phone-system-auto-attendant-via-cmdlets.png)

Дополнительные сведения о конфигурации:

- Автосекретарь: Contoso Main
...
### <a name="create-address-fax-and-email-information-prompt"></a>Создание адреса, факса и запроса Email сведений
...
### <a name="create-after-hours-menu-and-call-flow"></a>Создание меню "Нерабочее время" и потока вызовов
