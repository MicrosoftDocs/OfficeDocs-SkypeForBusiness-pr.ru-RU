...
|  |  |
|---------|---------|
|**Чат и вызовы**     | <UL><LI>Все звонки и чаты начаты и начаты в Teams<LI>Пользователи могут общаться (чат/звонок) с любым пользователем Skype для бизнеса<LI>Пользователи не могут общаться с пользователями Skype для потребителей<LI>При попытке войти в Skype для бизнеса пользователи перенаправляются в Teams      </UL>  |
