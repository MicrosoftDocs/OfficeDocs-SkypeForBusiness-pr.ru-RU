...
Где ЦС призвана помочь администраторам и служба технической поддержки агенты диагностировать проблемы качества звонков с вызовов, вызов качества панели мониторинга (CQD) призвана помочь Скайп для администраторов предприятия и сетевых инженеров оптимизации сети. CQD перемещает фокус из конкретных пользователей и вместо этого рассматривает статистические данные по всей Скайп для организации. 
