...
- Вам будет предложено выбрать регион конвейера обработки данных CQD. Выберите регион, в котором находится ваш клиент.
 ...
 - Регион можно увидеть с помощью ps-лета Skype для бизнеса Online (Get-CsTenant). Выход ServiceInstance. 
...
## <a name="data-latency-any-aa--cq-analytics"></a>Задержка данных В средстве аналитики CQ & AA
...
|AADirectorySearchMethod                 |строка                   |Метод поиска, используемый при вызове:<br>§ abs_search_dtmf<br>§ abs_search_extension<br>§ abs_search_name|
