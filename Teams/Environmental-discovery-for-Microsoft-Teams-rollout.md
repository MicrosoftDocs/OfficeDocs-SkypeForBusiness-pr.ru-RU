...
ms.service: msteams
ms.reviewer: landerl
description: Подробное обнаружение среды при планировании поездки от Skype для бизнеса до Microsoft Teams.
f1.keywords:
- NOCSH
...
В приведенном ниже примере анкеты приведены ответы на вопросы о том, готова ли ваша организация к успешному телефонная система аудиоконференцию и планы звонков в Teams.
...
> | Обратите внимание на тип Microsoft 365 <br/>Office 365 клиентов. Являются ли они мультитенантными <br/>или Выделенный? | <input type="checkbox"> Многопользовательского<br/> <input type="checkbox"> Выделенный | |
...
> | Если вы используете федератное удостоверение, что такое <br/>инфраструктура федерации? | <input type="checkbox">Windows 2008 R2 AD FS <br/> <input type="checkbox">Windows 2012 AD FS <br/> <input type="checkbox">Windows 2012 R2 AD FS <br/> <input type="checkbox">Windows AD FS 2016 <br/> <input type="checkbox"> Сторонная федерация <br/>&nbsp;&nbsp; &nbsp; шлюз (обратите внимание на подробные сведения <br/>&nbsp;&nbsp; &nbsp; в столбце Комментарии.) | |
...
> | Развертываются ли другие сторонние платформы <br/>и используете уже сегодня? В этом случае обратите внимание на количество пользователей <br/>эти платформы и сведения об использовании в <br/>Столбец Комментарии. | <input type="checkbox"> Cisco WebEx <br/> <input type="checkbox"> Слабину <br/> <input type="checkbox"> Other (Укажите в <br/>&nbsp;&nbsp; &nbsp; Столбец Комментарии.) | Количество пользователей: <br/>Детали:|
...
> | Какие модали и функции в настоящее время <br/>в настоящее время? | <input type="checkbox"> Обмен мгновенными сообщениями и присутствие (мгновенные сообщения/P)<br/> <input type="checkbox"> Конференций <br/> <input type="checkbox"> Федерации <br/> <input type="checkbox"> Запись собрания <br/> <input type="checkbox"> Аудиоконференция Майкрософт <br/> <input type="checkbox"> Аудиоконференция сторонних сторон (примечание)<br/>&nbsp;&nbsp; &nbsp; подробные сведения в столбце Комментарии.) <br/> <input type="checkbox"> Планы звонков (ранее — "Вызовы через ЗВОНКОВ по ЗВОНКОВ") <br/> <input type="checkbox"> Автоотправления организации <br/> <input type="checkbox"> Очереди вызовов | |
...
> | Какие модали и функции используются в настоящее время <br/>Сегодня? | <input type="checkbox"> Обмен мгновенными сообщениями и присутствие (мгновенные сообщения/P) <br/> <input type="checkbox"> Конференций <br/> <input type="checkbox"> Федерации <br/> <input type="checkbox"> Запись собрания <br/> <input type="checkbox"> Сохраняемая беседа или групповой чат <br/> <input type="checkbox"> Аудиоконференция Майкрософт <br/>&nbsp;&nbsp; &nbsp; (прежнее время — "Телефонная телефонная телефония для conferencing") на <br/>&nbsp;&nbsp; &nbsp; локального сервера Lync Server или <br/>&nbsp;&nbsp; &nbsp; Skype для бизнеса развертывания <br/> <input type="checkbox"> Аудиоконференция сторонних сторон <br/>&nbsp;&nbsp; &nbsp; (Обратите внимание на подробные сведения в примечастях. <br/>&nbsp;&nbsp; &nbsp; столбец.) <br/> <input type="checkbox">Корпоративная голосовая связь локальной <br/>&nbsp; &nbsp; &nbsp;Связь с ТСОП <br/> <input type="checkbox"> Планы звонков (ранее — "Вызовы через ЗВОНКОВ по ЗВОНКОВ по ЗВОНКОВ") через <br/>&nbsp;&nbsp; &nbsp; Гибридное гибридное Skype для бизнеса Online | |
...
> | Можно ли со структурой текущего плана поддержки для <br/>Lync Server, Skype для бизнеса Server, Microsoft 365, <br/>или Office 365? | | |
...
> | Какое из следующих лучше всего описывает этот вариант <br/>стратегию, используемую для Skype для бизнеса <br/>Развертывания? | <input type="checkbox"> Широкий круг: почтовая кампания с помощью <br/>&nbsp;&nbsp; &nbsp; ссылки на учебные курсы <br/> <input type="checkbox"> Расширенный: широкий спектр и разнообразные возможности <br/>&nbsp;&nbsp; &nbsp; информационных кампаний (плакаты, <br/>&nbsp;&nbsp; &nbsp; мероприятия, слева и слева) и обучение <br/>&nbsp;&nbsp; &nbsp; (видео, руководства пользователя, лицом к лицу) <br/> <input type="checkbox"> Индивидуальный: расширенный, а также целевой <br/>&nbsp;&nbsp; &nbsp; обмен сообщениями и обучение по persona <br/> <input type="checkbox"> Других <br/>&nbsp;&nbsp; &nbsp; (Обратите внимание на сведения в столбце Комментарии.) | |
