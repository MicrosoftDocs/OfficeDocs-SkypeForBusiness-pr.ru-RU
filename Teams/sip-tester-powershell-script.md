...
Сценарий передает тест SIP тестовом тесту, ждет результат, а затем представляет его в учитываемом для чтения формате. Этот сценарий можно использовать для проверки следующих сценариев:
