...
Skype для бизнеса Клиенты, которые запланированы на обновление Teams, получат ряд уведомлений об обновлении. Эти уведомления начнутся за 90 дней до запланированной даты обновления. Эти уведомления будут доставляться в качестве планов изменений записей в центре сообщений Microsoft 365, уведомлений на панели мониторинга в Teams центре администрирования и пометок в приложении для конечных пользователей. 
...
Способ обновления зависит от того, есть ли у вас веб-Skype для бизнеса online или Skype для бизнеса Online с гибридной средой:
...
После завершения обновления для обновленных пользователей будет установлен режим "Только Teams".  Перед обновлением рекомендуется Teams [только](teams-only-mode-considerations.md) рекомендации по режиму. В таблице ниже представлен общий обзор работы Teams только пользователями.
