...
На приведенной ниже схеме Прямая маршрутия настроена таким образом, что все звонки Teams на номера между +1425 4XX XX XX и +1425 5XX XX XX должны принимать красный маршрут (пунктирную линию), а все звонки по ДНР и из нее между +1425 4XX XX XX и любыми другими номерами, кроме диапазона номеров +1425 5XX XX XX XX, должны проходить синим (сплошная линия). 
