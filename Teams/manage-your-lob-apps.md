...
Чтобы сделать приложение доступным для пользователей в магазине App Store, загрузите приложение. Это можно сделать <a href="https://docs.microsoft.com/microsoftteams/tenant-apps-catalog-teams#go-to-the-tenant-apps-catalog" target="_blank">с помощью классического клиента Teams</a> или на странице [Управление приложениями](manage-apps.md) в центре администрирования Microsoft Teams.

На этом снимке экрана показана команда "Отправить" в классическом клиенте Teams.

![Снимок экрана: страница "приложения"](media/manage-your-lob-apps-store.png)

Снимок экрана: параметр "Отправить" на странице " **Управление приложениями** " в центре администрирования Microsoft Teams.
