...
Оставайтесь на связи с этим репозиторием [Git Hub](https://github.com/Azure/Azure-Sentinel/tree/master/Hunting%20Queries/TeamsLogs) для обновлений.
