...
Так как Teams регистрирует действия через M365, журналы аудита не собираются по умолчанию. Включите эту функцию с помощью [этих действий](/microsoft-365/compliance/turn-audit-log-search-on-or-off?view=o365-worldwide&viewFallbackFrom=o365-worldwide%c2%a0). Данные Teams собираются для аудита M365 в разделе *Audit.General*.
