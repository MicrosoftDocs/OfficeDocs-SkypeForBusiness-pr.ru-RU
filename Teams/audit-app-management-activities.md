...
ms.locfileid: "66642895"
---
# <a name="search-the-audit-logs-for-app-events"></a>Поиск событий приложения в журналах аудита
...
## <a name="audit-logs-for-app-events-in-teams"></a>Журналы аудита событий приложений в Teams
