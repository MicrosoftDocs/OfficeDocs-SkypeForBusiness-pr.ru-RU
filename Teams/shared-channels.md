...
|Выход из общего канала|Н/Д|Недоступно|Н/Д|Да, если это не последний владелец|Да|Да|
|Изменение общего канала|Нет|Недоступно|Н/Д|Да|Нет|Нет|
