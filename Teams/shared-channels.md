...
Если последний владелец общего канала покидает вашу организацию или удаляется из группы Microsoft 365, связанной с командой, участник общего канала из вашей организации автоматически повышается до владельца общего канала. Если в вашей организации нет участников для повышения уровня, общий канал останется без владельца. Администратор Teams должен вручную назначить владельца канала. Во избежание подобной ситуации целесообразно добавить несколько владельцев.

> [!NOTE]
> Внешние участники должны быть добавлены с использованием имени участника-пользователя, а не адреса электронной почты, если они не совпадают в Azure Active Directory.
