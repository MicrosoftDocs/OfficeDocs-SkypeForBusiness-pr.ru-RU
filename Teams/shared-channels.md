...
|Участники в общем канале|1000 непосредственных участников, в том числе до 50 команд. (В отношении этого ограничения каждая команда, которой предоставлен доступ к каналу, считается одним участником.)|Обновления в реальном времени доступны только для 25 000 пользователей одновременно. В списке каналов отображается только 25 000 пользователей.|
