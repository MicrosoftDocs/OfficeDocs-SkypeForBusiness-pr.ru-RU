...
- Команды на уровне организации не поддерживаются для добавления в качестве участников общего канала.
