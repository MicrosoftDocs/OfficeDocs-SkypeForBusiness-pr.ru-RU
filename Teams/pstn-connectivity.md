...
- [**Teams Phone Mobile**](#phone-system-with-teams-phone-mobile). В Телефонная система Microsoft Teams Mobile номер телефона пользователя с поддержкой SIM-карты также является номером телефона Teams. Если ваш существующий оператор участвует в программе Телефонная система Microsoft Teams Mobile, он может управлять службой для вызова ТСОП в Teams.  
...
## <a name="phone-system-with-teams-phone-mobile"></a>Телефонная система с Teams Phone Mobile

Если ваш существующий оператор участвует в программе Телефонная система Microsoft Teams Mobile, он может управлять службой для вызова ТСОП в Teams. В Teams Phone Mobile номер телефона пользователя с поддержкой SIM-карты также является номером телефона Teams.  Пользователи могут использовать один номер телефона в Microsoft Teams как в мобильных службах, так и в стационарных службах.  

Вы можете рассмотреть сочетание служб. Например, вы можете выбрать Teams Phone Mobile для организаций продаж и полей, которым требуется поддержка мобильных устройств, но другое решение для организации локального центра обработки вызовов, которое использует стационарные телефоны. 

Teams Phone Mobile может быть правильным решением для вашей организации, если:
...
Сведения о преимуществах и требованиях Teams Phone Mobile, а также ссылки на операторов, участвующих в этой программе, см. в разделе ["Планирование Teams Phone Mobile"](operator-connect-mobile-plan.md). Сведения о настройке Teams Phone Mobile см. в разделе ["Настройка Teams Phone Mobile"](operator-connect-mobile-configure.md).
...
- Сведения об управлении номерами телефонов с помощью Teams Phone Mobile см. в разделе "Настройка номеров телефонов [с помощью Teams Phone Mobile"](operator-connect-mobile-configure.md#set-up-phone-numbers).
...
- Для Operator Connect и Teams Phone Mobile большая часть маршрутизации звонков управляется оператором. Абонентские группы пользователей настраиваются для перевода номеров для авторизации звонков и маршрутизации звонков. Дополнительные сведения см. [в статье "Что такое абонентские группы?"](what-are-dial-plans.md).
...
- Для Teams Phone Mobile каждый пользователь автоматически включает экстренные вызовы. Экстренные вызовы автоматически направляются мобильному оператору Teams Phone для указанного номера. Динамические экстренные вызовы (в зависимости от расположения клиента Teams) поддерживаются. Дополнительные сведения см. [в разделе "Рекомендации по использованию Teams Phone Mobile"](what-are-emergency-locations-addresses-and-call-routing.md#considerations-for-teams-phone-mobile). 
