...
Дополнительные узнать см. в [Teams.](teams-calling-policy.md)
...
1.  С помощью [командлета Set-CsTenantNetworkSite](/powershell/module/skype/set-cstenantnetworksite?view=skype-ps) можно включить Location-Based маршрутизации и связать политики голосовой маршрутизации с сетевыми сайтами, для выполнения ограничений на маршрутизация которые требуются.
    ```PowerShell
