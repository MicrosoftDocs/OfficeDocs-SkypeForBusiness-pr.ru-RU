...
Эта статья для ИТ-администраторов, которые хотят внедрить обновление Skype для бизнеса до Teams.

Перед внедрением обновления мы рекомендуем следующие статьи, в которых описываются важные концепции и сосуществование:

- [Понимание сосуществования и совместной работы Microsoft Teams и Skype для бизнеса](teams-and-skypeforbusiness-coexistence-and-interoperability.md)
...
Если вам нужны дополнительные сведения о доступных вариантах, убедитесь, что вы уже прочитали статью "Выберите путь обновления от Skype для бизнеса [к Teams".](upgrade-and-coexistence-of-skypeforbusiness-and-teams.md)
...
- Вместо того чтобы настраивать политику для клиента на SfbWithTeamsCollab, можно настроить ее на SfbWithTeamsCollabAndMeetings. В результате все пользователи будут планировать все новые собрания в Teams.
...
1. Найдите пользователей, активных в Teams, следующим образом:
   ...
   1. В Центре администрирования Microsoft 365 на левой навигации перейдите в "Отчеты" и "Использование". 
