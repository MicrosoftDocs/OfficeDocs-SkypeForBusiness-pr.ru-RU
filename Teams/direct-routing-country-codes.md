...
Обратите внимание, что Корпорация Майкрософт рекомендует устанавливать этот параметр только в том случае, если журналы звонка четко показывают, что в назначении центра обработки данных по умолчанию для пути мультимедиа не используется путь, ближайший к центру обработки данных SBC. 
