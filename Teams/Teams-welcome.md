---
title: "Добро пожаловать в Microsoft Teams"
author: LolaJacobsen
ms.author: lolaj
manager: serdars
ms.date: 09/25/2017
ms.topic: tutorial
ms.service: msteams
description: "Здесь вы найдете актуальные практические и справочные материалы, помогающие администраторам и ИТ-специалистам оценивать и развертывать продукт Microsoft Teams, а также планировать и осуществлять его использование."
