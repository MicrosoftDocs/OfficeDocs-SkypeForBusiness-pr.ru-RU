...
- Исходящие звонки: звонки от клиента Teams (вызываемого звонка) на конечную точку ЗВОНКОВ ЗВОНКОВ (вызываемого)
...
Г-н Гюл звонит, используя десятизначный номер, не 164 E.164. Bob dials 2065550100 to reach Чтобы связаться с Данными.
В SBC используется 2065550100 в headers RequestURI и To, а 4255550100 в заглавной области От.
...
В SBC используется 0100 в загонах RequestURI и To, а 4255550100 в заглавной области От.
...
В этом случае с помощью телефонной линии номер перед отправкой переводится в интерфейс прямой маршрутии. При вводе 425 555 0100 в клиенте Teams, номер переводится в +14255550100 в телефонной плане страны. Итоги — это совокупная нормализация правил набора и правил Teams перевода. Правила Teams перевода удаляют "+1", добавленные в телефонную план.
...
Он звонит Гюлену, используя четырехзначный номер. Чтобы связаться с Юным из звонков или с помощью контакта, Юров использует 0100.
В SBC настроено использование четырехзначных номеров, не влияемых на E.164, Teams и десятизначных номеров для пользователей ДНР. В этом сценарии набор номеров не применяется.
