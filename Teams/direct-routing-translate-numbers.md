...
- Входящие звонки: звонки из конечной точки ЗВОНКОВ (вызываемого звонка) в Teams (вызываемому)
...
В этом случае будет New-CsOnlinePSTNGateway, чтобы создать следующую конфигурацию SBC:
...
Г-н Мюн звонит, используя десятизначный номер, не 164 E.164. Г-н 2065550100 звонит, чтобы связаться с Телефоном.
В SBC 2065550100 в загонах RequestURI и To, 4255550100 в заглавной области "От".
...
SBC использует 0100 в заглавных 4255550100 в заглавной области "От".
