...
# <a name="customize-apps-in-microsoft-teams"></a>Настройка приложений в Microsoft Teams
 ...
 Microsoft Teams позволяет настроить приложение для улучшения Teams приложения. Некоторые разработчики приложений позволяют администратору Teams приложение. Администратор может изменить или изменить свойства приложения в зависимости от потребностей организации, используя страницу центра администрирования Teams **Управление приложениями.** Вы можете настроить такие сведения:
...
Теперь Teams пользователи могут открыть свой клиент Teams, чтобы увидеть настроенную функцию.
