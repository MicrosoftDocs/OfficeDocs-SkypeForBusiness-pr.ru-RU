...
Подробные [сведения о полях,](https://docs.microsoft.com/microsoftteams/platform/resources/schema/manifest-schema) которые можно настроить, см. в схеме манифеста Teams.

> [!NOTE]
> В настоящее время настройка приложений не поддерживается в GCCH или Отделе защиты (DoD).
...
5. Разорите **раздел Значок.**
   ...
   а) Добавить значок. Используйте один полноцветный значок (192x192) в формате PNG.
...
Хотя администратор сразу же видит изменения в Центре администрирования Teams, пользователям может потребоваться до 24 часов.  
