...
# <a name="customize-apps-in-microsoft-teams"></a>Настройка приложений в Microsoft Teams
 ...
 Microsoft Teams позволяет настроить приложения для улучшения Teams приложения. Некоторые разработчики приложений позволяют администратору Teams приложение. Администратор может изменить или изменить свойства приложения в зависимости от потребностей организации на странице Teams Управление **приложениями.** Вы можете настроить такие сведения:
...
> [!NOTE]
> В настоящее время настройка приложений не поддерживается облако сообщества для государственных организаций (GCCH) или Department of Defense (DoD).
...
2. Разо **Teams приложениями и** выберите **Управление приложениями**.

3. Проверьте **столбец "Настраиваемый"** в списке приложений и отсортировать их по настраиваемым приложениям.
   ...
   - Выберите имя приложения, а затем в **dropdown Actions (Действия)** выберите настроить. 
...
4. Просмотр сведений о приложении, включая исходное имя приложения **Краткое имя от издателя**.
   ...
   ![Настройте имя приложения на панели значков.](media/original-app-version.png)
...
Нет, администраторам клиентов придется вручную удалить все настраиваемые приложения и опубликовать его настроенную версию. Если вы настроили приложение и опубликовали его как пользовательское, новое приложение, настроенное с помощью функции настройки приложения, не заменит текущее пользовательское приложение.  

**Будут ли в отчете об использовании приложений также демонстрироваться настроенные значения, например настроенное краткое имя?**
...
**Будут ли настроенные свойства показываться на экране согласия графа?**
