...
3. Проверьте **столбец Настраиваемый** список приложений и отсортировать их по настраиваемым приложениям.
   ...
   - Выберите рядом с приложением, которое вы хотите настроить, и выберите **Настроить**.
     ...
     ![Параметр выбора 1.](media/select-app-to-customize1.png)
...
> [!Note]
> - При настройке приложений и любых описаний, связанных с приложением, убедитесь, что вы придерживались каких-либо рекомендаций по настройке, если издатель приложения предоставляет их документацию или условия использования. Кроме того, вы несете ответственность за соблюдение прав других людей в отношении изображений сторонних сторон, которые вы можете использовать.
...
> - Мы рекомендуем протестировать изменения настройки приложений в тестовом клиенте Teams, прежде чем вносить эти изменения в вашей среде.
...
4. В **dropdown Actions (Действия) выберите** **восстановить** значение по умолчанию.
   ...
   ![Выберите выбрана кнопка Восстановить значение по умолчанию.](media/select-reset.png)

## <a name="frequently-asked-questions"></a>Вопросы и ответы

**Сколько времени займет мой пользователь, чтобы увидеть настроенную настройку приложения?**

Хотя администратор сразу же может увидеть изменения в Teams администрирования, пользователям может потребоваться до 24 часов.  
