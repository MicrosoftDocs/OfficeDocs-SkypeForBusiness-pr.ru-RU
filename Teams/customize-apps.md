...
5. Разорите **раздел Значок.**
   ...
   а) Upload значок. Используйте один полноцветный значок (192x192) в формате PNG.

   б) Выберите цвет контура значка. Используйте один прозрачный контур (32x32) пикселя в формате PNG.

   в. Выберите цвет со значком.
...
> - Мы рекомендуем протестировать изменения настроек приложений в Teams, прежде чем вносить эти изменения в вашей среде.
...
**Сколько времени займет мой пользователь, чтобы увидеть настроенную функцию?**
