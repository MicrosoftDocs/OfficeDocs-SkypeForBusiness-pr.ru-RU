--Заголовок: что такое группы live событий? Автор: TonySmith ms.author: диспетчер tonysmit: serdars ms.date: 7/11/2018 ms.topic: приведены в статье ms.service: msteams ms.reviwer: tonysmit Описание: Узнайте, как Live события позволяет пользователям вещание видео и содержимого для крупных online аудиторий в группах Microsoft Yammer и Microsoft потока.  
appliesTo: 
- Microsoft Teams
---

# <a name="what-are-teams-live-events"></a>Что такое группы live событий?
**Сводка**: Узнайте, как live события позволяет пользователям вещание видео и содержимого для крупных online аудиторий в группами Майкрософт, Yammer и Microsoft потока.  
Примечание:, Это preview или функций ранней версии.

## <a name="overview"></a>Обзор
Live событий в Microsoft 365 позволяют пользователям вещание видео и содержимого для крупных online аудиторий.  Событий в реальном времени Microsoft 365 перевести видео потоковой передачи на новый уровень, выходя за пределы что было ранее возможно с Скайп вещания собрания, стимулирования подключения на протяжении жизненного цикла всей сотрудничества человек до, во время и после событий в реальном времени. Можно создать live события везде, где аудитории, группы или сообщества находится, с помощью Microsoft потока, группами Майкрософт или Yammer.  
...
- [Live события в группами Майкрософт](https://support.office.com/en-us/article/microsoft-teams-live-event-overview-d077fec2-a058-483e-9ab5-1494afda578a?ui=en-US&rs=en-US&ad=US)
- [Live события в Yammer](https://support.officeppe.com/en-us/article/live-events-in-yammer-4ece0ee2-c268-4636-bf2a-16e454befe57?ui=en-US&rs=en-US&ad=US)
- [В потоке Microsoft Live событий](https://review.docs.microsoft.com/en-us/stream/live-event-overview)
