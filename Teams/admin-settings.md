...
Вы управляете приложениями для своей организации в **приложениях Teams** в центре администрирования Microsoft Teams. Например, вы можете разрешать или блокировать приложения на уровне Организации, устанавливать политики, чтобы управлять приложениями, доступными для пользователей Teams, и настраивать группы, закреплять наиболее важные для ваших пользователей приложения.
