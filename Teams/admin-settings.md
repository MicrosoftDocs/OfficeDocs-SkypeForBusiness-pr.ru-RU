...
На странице **Управление приложениями** можно просматривать и Teams приложения в каталоге приложений организации. Вы можете посмотреть состояние и свойства приложений на уровне организации, заблокировать или разрешить приложения на уровне организации, добавить новые пользовательские приложения в каталог клиента и управлять настройками приложений для всей организации.
