...
4. Выберите страну или регион, а затем введите адрес.
   ...
   > [!NOTE]
   > В бельгийском, Франции, Германии, Ирландии, Нидерланды и Испании очень важно понимать, что для успешной активации номера телефона в Office 365 Настройка адресов в месте, используемой для получения номера, должна совпадать с областью номера телефона. примере.
