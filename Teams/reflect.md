...
ms.locfileid: "67268384"
---
# <a name="it-admin-guide-to-reflect-in-microsoft-teams"></a>Руководство для ИТ-администраторов по Reflect в Microsoft Teams

Этот документ содержит сведения о [Microsoft Reflect](https://aka.ms/reflect) — неотъемлемой части [Insights для образования в Microsoft Teams](class-insights.md). Reflect помогает учащимся распознавать свои эмоции и управлять ими, предоставляя регулярные возможности поделиться ощущениями и быть услышанными. Reflect помогает расширить эмоциональный словарь учащихся и развить умение сочувствовать сверстникам, а также предоставляет педагогам ценную обратную связь для обеспечения здоровой атмосферы в школьном сообществе.

В этом бесплатном приложении для проверки используются эмодзи и символы, которые помогают учащимся лучше распознавать эмоции. Исследования показывают, что явное обучение социально-эмоциональным навыкам повышает эффективность обучения, улучшает поведение и оказывает положительное влияние на всю жизнь.
...
Приложение "Рефлексия" по умолчанию доступно в любой команде класса или персонала. Чтобы получить доступ к приложению, перейдите к нужной команде, а затем выберите вкладку "Рефлексия".
