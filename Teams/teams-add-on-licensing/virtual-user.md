...
Если в вашей организации используется доступная бесплатная Microsoft 365 телефонная система — лицензии виртуальных пользователей при создании узлов автозавода или очереди вызовов, вы по-прежнему можете использовать платные Телефон системные лицензии с учетной записью ресурса. В большинстве организаций достаточно лицензий виртуальных пользователей на основе плана масштабирования. 
