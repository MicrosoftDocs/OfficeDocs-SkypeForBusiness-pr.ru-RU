...
Организации, телефонная система лицензированными пользователями, могут назначить учетным Microsoft 365 телефонная система лицензию виртуального пользователя или платную телефонная система лицензию на ресурсы. План звонков не требуется. Для всех автоотчетов или очередей вызовов требуется связанная учетная запись ресурса. Учетным записям ресурсов, для работы с которые требуется номер телефона, требуется бесплатная Microsoft 365 телефонная система — лицензия виртуального пользователя или платная лицензия телефонная система пользователя, чтобы к учетной записи ресурса можно было применить номер телефона.

> [!TIP]
> Для учетных записей ресурсов, которые будут использоваться со вложенными автоотчетами или очередями звонков, не назначены номера телефонов, лицензия не требуется. См. следующую схему: 
...
> [!NOTE]
> телефонная система — это лицензия на надстройки, доступная для Microsoft 365, Office 365 E1 и E3. телефонная система также входит в состав Microsoft 365 E5, Office 365 E5 и Голосовая связь Microsoft 365 бизнес лицензий.
