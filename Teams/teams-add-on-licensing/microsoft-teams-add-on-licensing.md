...
Вот список функций, которые можно добавить с помощью Teams надстройки. Доступные варианты лицензирования надстройки зависят от Microsoft 365 или Office 365 плана.
...
<thead>
<tr class="header">
<th><strong>Enterprise (>300 человек)</strong></th>
<th>&nbsp;</th>
<th>&nbsp;</th>
</tr>
</thead>
...
<tr class="odd">
<td>Microsoft 365 E5 для некоммерческих организаций<br>Office 365 для некоммерческих организаций E5</td>
<td>План внутренних звонков<br>План внутренних и международных звонков (необязательно)<br>Кредиты на связь</td>
<td></td>
<td></td>
</tr>
...
<tr>
<td>Общая пробная Телефон области</td>
<td>Отображает функции общих телефонов с регионами.</td>
</tr>
</tbody>
</table>

 Базовый план не должен быть пробным предложением для использования этих пробных возможностей голосовой почты. Вы можете использовать план Microsoft 365 бизнеса или план Enterprise для государственных организаций, образовательных организаций или некоммерческих организаций с любым из предложений по пробной системе голосовой связи. Чтобы ознакомиться с доступными пробными предложениями и надстройкими, в области Центр администрирования Microsoft 365 перейдите в статью Приобретение услуг вы выставления счета , выберите Другие категории, которые могут вас заинтересовать, а затем выберите   >   **Надстройки**. 
