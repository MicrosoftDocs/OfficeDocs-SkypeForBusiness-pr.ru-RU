...
<sup>1</sup> Если у вас малый или средний бизнес с планом Microsoft 365 корпоративный, вы по-прежнему можете приобрести лицензии на надстройки [](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-products?&activetab=tab:primaryr2) для этих функций голосовой почты, однако мы рекомендуем учесть план Microsoft 365 бизнес и бизнес-голосовую голосовую Microsoft 365 бизнес [.](https://www.microsoft.com/microsoft-365/business/business-voice)
...
- Приобрети план Microsoft 365 бизнес и Голосовая связь Microsoft 365 бизнес.
...
Если у вас уже есть Microsoft 365 корпоративный или Office 365 корпоративный, вы все равно можете приобрести лицензии на надстройки для отдельных функций голосовой почты. Однако вы можете перейти на другой план Microsoft 365 бизнес [и](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-products?&activetab=tab:primaryr2) [Голосовая связь Microsoft 365 бизнес.](https://www.microsoft.com/microsoft-365/business/business-voice) В некоторых случаях в зависимости от нужных функций может быть более затратно получить план Microsoft 365 бизнес с Голосовая связь Microsoft 365 бизнес.
...
Дополнительные узнать см. [в](https://www.microsoft.com/education/buy-license/microsoft365) Microsoft 365 для образования и [Office 365 для образования планах.](https://www.microsoft.com/education/products/office)
...
<td>Отображает функции общих телефонов с регионами.</td>
 ...
 Базовый план не должен быть пробным предложением для использования этих пробных возможностей голосовой почты. Вы можете использовать план Microsoft 365 бизнес или план Enterprise, для государственных организаций, образовательных организаций или некоммерческих организаций с любым из пробных предложений для голосовых функций. Чтобы увидеть доступные пробные предложения и надстройки, в Центре администрирования Microsoft 365 перейдите в статью Выставление счета за покупки служб, выберите Другие категории, которые могут вас заинтересовать, а затем выберите Надстройки  >  .  

  Для каждого из этих параметров голосовой связи и услуг связи требуется кредиты на [связь,](../set-up-communications-credits-for-your-organization.md) если у вас есть бесплатные номера или вам нужно добавить дополнительные минуты для звонков с собраний или для звонков по ЗВОНКОВ по ННР.
