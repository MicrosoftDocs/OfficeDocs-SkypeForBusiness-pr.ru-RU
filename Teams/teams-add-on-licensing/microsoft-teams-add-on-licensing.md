...
|**Телефонная система** <br/> |[телефонная система](../what-is-phone-system-in-office-365.md) — это телефонная служба, которая обеспечивает управление звонками и возможности частных ветвей Exchange (УАЦ) с возможностью подключения к телефонной сети общего перейти на другой телефон ( PSTN). телефонная система к ним относятся облачная голосовая почта, ИД звониющего, парк вызовов, переадстройка вызовов, автоответчики, очереди зовов, переключение вызовов, ИД звониющего и другие. <br>Дополнительные информации [см.](../here-s-what-you-get-with-phone-system.md)в этой телефонная система. Сведения о ценах см. в [телефонная система.](https://go.microsoft.com/fwlink/?linkid=799763)  <br/> |&#x2713;<sup>1</sup>|&#x2713;|
...
Узнайте, какие лицензии на надстройки необходимы для Teams в зависимости от плана.
...
Если аудиоконференция не поддерживается в вашей стране или регионе, вы можете получить план Microsoft 365 корпоративный E5 без аудиоконференции или план Office 365 корпоративный E5 без аудиоконференции.

Если у вас уже есть Microsoft 365 корпоративный или Office 365 корпоративный, вы можете приобрести лицензии на надстройки для отдельных функций голосовой почты. Однако вы можете перейти на план Microsoft 365 [бизнеса](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-products?&activetab=tab:primaryr2) и [Голосовая связь Microsoft 365 бизнес.](https://www.microsoft.com/microsoft-365/business/business-voice) В некоторых случаях в зависимости от того, какие функции вам нужны, может быть эффективнее получить план Microsoft 365 бизнеса с Голосовая связь Microsoft 365 бизнес.
...
Подробнее см. в [Microsoft 365 для образования](https://www.microsoft.com/education/buy-license/microsoft365) и Office 365 для образования [планах.](https://www.microsoft.com/education/products/office)
...
- Приобретйте план GOV G1 или G3 и добавьте функции голосовой почты в облаке по отдельности.
...
<td>Отображает функции общих телефонов с регионами.</td>
 ...
 Базовый план не должен быть пробным предложением для использования этих пробных возможностей голосовой почты. Вы можете использовать план Microsoft 365 бизнеса или план Enterprise для государственных организаций, образовательных организаций или некоммерческих организаций с любым из предложений по пробной системе голосовой связи. Чтобы ознакомиться с доступными пробными предложениями и надстройкими, в Центр администрирования Microsoft 365 перейдите в статью Приобретение услуг по выставлению счета , выберите Другие категории, которые могут вас заинтересовать, а затем выберите   >   **Надстройки**. 
