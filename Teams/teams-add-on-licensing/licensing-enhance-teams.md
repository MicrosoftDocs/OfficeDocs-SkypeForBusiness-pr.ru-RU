...
\**eCDN можно приобрести как автономную лицензию, а дополнительные лицензии можно приобрести за пределами Teams премиум, если это необходимо. Сведения об автономном лицензировании eCDN см. в статье [Microsoft eCDN](https://www.microsoft.com/microsoft-teams/ecdn).*
...
\**Эта функция доступна только для Teams премиум пользователей с Microsoft 365 E5 подпиской или подпиской Microsoft E3, а также лицензией Advanced Compliance. Дополнительные сведения о требованиях к лицензированию см. [в разделе Каковы требования к приобретению Teams премиум?](#what-are-the-requirements-to-purchase-teams-premium)*
...
В общем выпуске Teams премиум некоторые функции Teams будут переходить с лицензий Teams на Teams премиум лицензии. Каждая из этих функций имеет льготный период в 30 или 60 дней после общей доступности. По истечении льготного периода пользователи потеряют доступ к этой функции.

Чтобы пользователи могли продолжать использовать эти функции, необходимо приобрести и назначить Teams премиум лицензии.

Функции, которые переходят на Teams премиум:

- Субтитры, переведенные в реальном времени.
  - Доступно для всех подписчиков Teams в течение 60-дневного льготного периода после Teams премиум общей доступности.
...
- Сцены настраиваемой организации в режиме "Вместе".
  - Доступно всем подписчикам Teams в течение 30-дневного льготного периода после Teams премиум общей доступности.
...
В следующем списке указаны Teams премиум функции, для которых требуется настройка администратора в [Центре администрирования Teams](https://go.microsoft.com/fwlink/p/?linkid=2066851), прежде чем пользователи смогут получить доступ к этой функции:

- Использование сквозного шифрования для собраний до 50 участников.
- Добавление водяных знаков для собраний.
- Добавление меток конфиденциальности.
- Запрет копирования и вставки в чатах собраний.
- Использование фона, настроенного организацией.
- Использование настраиваемых организацией сцен режима "Вместе".
  - Администратор необходимо создать настраиваемую сцену режима "Вместе".
- Назначается пользовательский пакет политики.
- Использование настраиваемых организацией шаблонов собраний.
- Просмотр настроенной организации фирменной символики.
- Использование eCDN для трансляций.
- Использование RTMP-in.
- Настройка залов ожидания для виртуальных встреч с фирменной символикой.
