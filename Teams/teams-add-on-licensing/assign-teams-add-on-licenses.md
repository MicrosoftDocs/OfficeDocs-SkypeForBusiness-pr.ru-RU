...
Лицензии на надстройки — это лицензии на определенные функции Teams, такие как аудиоконференция, телефонная система и планы звонков. В этой статье описано, как массово назначать лицензии на надстройки отдельным пользователям и большим наборам пользователей.

> [!NOTE]
> См. [Teams лицензирования надстройок](./microsoft-teams-add-on-licensing.md) для Teams, доступных с лицензиями на надстройки. Вы также найдете сведения о том, какие лицензии необходимо приобрести и как их приобрести (в зависимости от плана), чтобы пользователи могли получать такие функции, как аудиоконференцию, бесплатные номера и возможность звонить на номера телефонов за пределы организации. После того как вы решите, какие функции вам нужны, назначьте им лицензии.
...
| Оплата по минуте аудиоконференции (оплата по мере ее оплаты)</br>*Требуется настроить и включить кредиты на связь.* | MCOMEETACPEA |
