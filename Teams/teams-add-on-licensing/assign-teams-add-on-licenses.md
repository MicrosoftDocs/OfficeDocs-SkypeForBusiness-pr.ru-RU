...
- NOCSH
ms.reviewer: mikedav
description: Узнайте, как назначать пользователям Teams надстройки для таких функций, как аудиоконференция, телефонная система и планы звонков.
appliesto:
- Microsoft Teams
...
- Если вы используете для гибридных пользователей локальное подключение к телефонной телефонная система телефонной сети. Не назначать лицензию на план звонков.
