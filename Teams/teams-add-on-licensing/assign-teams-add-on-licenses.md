...
Прежде чем начать, просмотрите следующие требования:
...
- Если приобретено неправильное количество лицензий, вы получите сообщение об ошибке. Если вам нужно приобрести дополнительные лицензии на план звонков, выберите этот вариант.

- Даже если вашим пользователям назначены лицензии на корпоративный [](../what-are-communications-credits.md) E5, им необходимо назначить лицензии на кредиты на связь, чтобы они могли звонить или принимать звонки через ПС.
