...
> [!IMPORTANT]
> По умолчанию папка C:\Program Files\Teams Installer в 32-битной операционной системе и C:\Program Files (x86)\Teams Установщик в 64-битной операционной системе.
