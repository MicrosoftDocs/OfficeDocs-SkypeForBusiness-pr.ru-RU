...
> [!IMPORTANT]
> По умолчанию используется папка C:\Program Files (x86) \Teams в 64-разрядной операционной системе и C:\Program Files\Teams Installer в 32-разрядной операционной системе.
...
> [!TIP]
> Вы также можете использовать [сценарий очистки для развертывания в Teams](scripts/powershell-script-deployment-cleanup.md) , чтобы выполнить шаги 1 и 2.  
