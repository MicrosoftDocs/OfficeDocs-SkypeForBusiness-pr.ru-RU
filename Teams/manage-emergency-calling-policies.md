...
4. Настройка оповещать сотрудников организации (как правило, службу безопасности) о звонках в экстренные службы. Для этого в режиме **уведомлений** выберите один из следующих ок.
    ...
    - **Конференц-связь** с отключенным звуком и неудалась: пользователям и группам отправляется сообщение чата Teams, и они могут прослушивать беседу между звонив и оператором PSAP (но не участвовать в ней).
