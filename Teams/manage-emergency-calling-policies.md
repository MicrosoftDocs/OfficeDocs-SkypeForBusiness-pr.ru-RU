...
4. Настройка оповещать сотрудников организации (как правило, службу безопасности) о звонках в экстренные службы. Для этого в **режиме уведомлений** выберите один из следующих ок.
    ...
    - **Конференц-связь** отключена, но вы можете включать звук: пользователям и группам отправляется Teams чата, и они могут включать звук, чтобы прослушать беседу между звонив и оператором PSAP.
