...
4. Настройка оповещать сотрудников организации (обычно это служба безопасности) о звонках в экстренные службы. Для этого в режиме **уведомлений** выберите одно из следующих:
    ...
    - **Конференц-связь** отключена и не может быть отключена: сообщение чата Teams отправляется пользователям и группам, которые вы указываете, и они могут прослушивать (но не принимать участие) в беседе между звонив и оператором PSAP.
    - **Звук** конференции отключен, но вы можете его отключать: сообщение чата Teams отправляется пользователям и группам, которые вы указали, и они могут включать звук для прослушивания беседы между звонив и оператором PSAP.
