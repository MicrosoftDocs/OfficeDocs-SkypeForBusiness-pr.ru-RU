...
2. Чтобы отобразить список всех неявных Microsoft 365, которые по-прежнему находятся в течение 30-дневного периода хранения, запустите следующее: Используйте параметр -**-All $True**, если у вас много групп.
    ```PowerShell
