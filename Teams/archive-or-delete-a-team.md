...
description: В этой статье вы узнаете, как архивировать или окончательно удалять команду в Microsoft Teams.
...
4. Чтобы запретить пользователям изменять содержимое на SharePoint сайте и **вики-вкладке**, связанной с командой, выберите "Сделать сайт SharePoint доступен только для чтения для участников команды". (Teams владельцы по-прежнему смогут редактировать это содержимое.)
...
Выполните следующие действия, чтобы восстановить удаленную команду, восстановив Microsoft 365, связанную с командой. При восстановлении Microsoft 365 группы восстанавливается содержимое группы, включая вкладки, стандартные каналы, частные каналы и связанные с ними семейства веб-сайтов.

По умолчанию удаленная Microsoft 365 сохраняется в течение 30 дней. Этот 30-дневный период называется «мягким удалением», потому что вы можете восстановить группу. Дополнительные сведения см. [в разделе "Восстановление удаленной группы"](/microsoft-365/admin/create-groups/restore-deleted-group).
...
1. Выполните следующую команду, чтобы отобразить список всех обратимо удаленных Microsoft 365, которые по-прежнему находятся в течение 30-дневного периода хранения. Используйте параметр **-All $True** , если у вас много групп.
