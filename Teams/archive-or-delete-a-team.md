...
Выполните следующие шаги, чтобы заархивировать команду. Вы должны быть администратором службы Teams, чтобы внести эти изменения. Сведения о том, как получить роли администраторов и разрешения, можно найти [в статье Использование ролей администратора Teams для управления группами](https://docs.microsoft.com/microsoftteams/using-admin-roles) .

1. В центре администрирования выберите **команды Teams**.
