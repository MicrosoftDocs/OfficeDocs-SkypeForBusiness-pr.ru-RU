...
| Microsoft Teams Реализации | Общий <br/> Информирование и внедрение <br/> Взаимодействие с бизнесом <br/> Программа ранних принятия <br/> Отзывы и Аналитика <br/> Безопасность и соответствие требованиям <br/> Стратегия и планирование <br/> Состояние службы и инциденты <br/> Обучение <br/> Чат ватерполя |
| Teamwork Champions | Общий <br/> Лучшие методики, учебные курсы и действия <br/> Уголок с 100 м <br/> Отзывы и поддержка <br/> Программы: интересов <br/> Social Hub |
...
| Общий | Вкладка "Веб": [Teams документация](./index.yml) |
