...
Оптимальный способ внедрения команд в Teams — это использование продукта. Мы рекомендуем вам управлять развертыванием Microsoft 365 или Office 365 с помощью Teams. Вы также должны создать сообщество сотрудников, которые сосредоточены на совместной работе и продуктивности. (Эти начальные команды могут быть изменены с течением времени.) Вот некоторые из предложенных групп.
...
| Реализация Microsoft Teams | Общий <br/> Сведения о распознавании и внедрении <br/> Бизнес-задействование <br/> Программа, предпринимаемая раньше <br/> Отзывы и аналитики <br/> Безопасность и соответствие требованиям <br/> Стратегия и планирование <br/> Исправность и инциденты служб <br/> Обучение <br/> WaterCooler чата |
...
| Сведения о распознавании и внедрении | [Центр внедрения команд](https://aka.ms/DriveTeamsAdoption)<br/>[Комплект для успешной работы клиентов Microsoft Teams](https://aka.ms/TeamsCustomerSuccess)|
...
| Отзывы и отчеты | Зафиксированный отчет об использовании Microsoft 365 или Office 365 (только для администраторов Microsoft 365 или Office 365) |
