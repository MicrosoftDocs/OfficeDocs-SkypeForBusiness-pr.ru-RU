...
| Реализация Microsoft Teams | Общий <br/> Информирование и внедрение <br/> Бизнес-взаимодействие <br/> Программа ранних приемов <br/> Отзывы и идеи <br/> Безопасность и соответствие требованиям <br/> Стратегия и планирование <br/> Состояние службы и инциденты <br/> Обучение <br/> Чат с водяным ватерполом |
| Командные champions | Общий <br/> Методики, учебные курсы и действия <br/> Уголок Хи2 <br/> Отзывы и поддержка <br/> Программные руководства <br/> Social Hub |
...
![Значок, на котором изображен следующий шаг: насколько ваша организация готова к microsoft ](media/teams-adoption-next-icon.png) [Teams?](teams-adoption-assess-readiness.md)
