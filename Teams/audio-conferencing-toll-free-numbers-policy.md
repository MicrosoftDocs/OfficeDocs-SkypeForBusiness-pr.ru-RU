...
## <a name="teams-audio-conferencing-policy"></a>Teams аудиоконференций
...
- Параметр allowTollFreeDialin больше не может управляться для отдельного пользователя с помощью Teams центра администрирования или PowerShell. Администраторы клиента смогут управлять этим параметром только с помощью новой политики аудиоконференций.
- Глобальную политику нельзя изменить из Teams администрирования.

Если в Teams включена политика аудиоконференций, в клиенте будут автоматически созданы две политики. Две автоматически созданные политики и их параметры по умолчанию:
...
1. В левой области навигации центра администрирования Microsoft Teams выберите "Собрания > аудиоконференции".
1. Нажмите Добавить.
...
1. В левой области навигации центра Microsoft Teams перейдите к конференции **MeetingsAudio** > .
2. Нажмите **Добавить**.
...
Вы можете изменить любые настраиваемые политики, которые вы создаете. (Обратите внимание, что глобальная политика не может быть изменена из Teams центра администрирования)
