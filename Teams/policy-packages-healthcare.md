...
|---------|---------|---------|
|Медицинского медицинского работника  |Медицинские работники  |Создает набор политик и параметров политики, которые дают сотрудникам, работающим в медицинской области, например, медсестрам, врачам и социальным работникам полный доступ к чату, звонкам, управлению сменами и собраниям. |
...
Чтобы начать работу с пакетами политики здравоохранения, в центре платы Центра администрирования Майкрософт выберите "Здравоохранение", а затем выберите "Назначение параметров политики **по роли".** Когда вы будете готовы начать, решите, какие пакеты политики вы хотите назначить отдельным лицам в организации.
...
Выберите один или несколько пакетов для назначения и нажмите кнопку **"Далее".** Вы можете искать и добавлять людей в пакет политики, лучше всего подходящий для их роли. Отдельного человека нельзя на должно быть назначено несколько пакетов политики одновременно.

После того как вы добавите людей в пакет политики, **finish** завершит выбор. Вы можете продолжать настраивать пакеты политики и управлять ими в Центре администрирования Microsoft Teams.
...
При необходимости настройте параметры политики в пакете политик, чтобы они соответствовали потребностям вашей организации. Изменения, внесенные в параметры политики, автоматически применяются к пользователям, которым назначен пакет. Чтобы изменить параметры политики в пакете политики, в левой области навигации Центра администрирования Microsoft Teams перейдите к пакетам **политики,** выберите пакет политики, выберите имя политики, которое вы хотите изменить, и выберите команду "Изменить". 
