...
![Снимок экрана: политики в пакете медицинских работников.](media/policy-packages-healthcare-clinical-worker.png)
...
Пакет может содержать до 5 000 пользователей. Вы можете указать пользователей по идентификатору объекта, имени участника-пользователя, SIP-адресу или адресу электронной почты. Дополнительные сведения см. в статье [Назначение пакета политики множеству пользователей](assign-policy-packages.md#assign-a-policy-package-to-a-batch-of-users).
