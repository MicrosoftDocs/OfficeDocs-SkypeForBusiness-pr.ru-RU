...
|  ![Сплошной красный круг, обозначающий "занято"](media/Presence_Busy.png) Сильно |  ![Сильно](media/Presence_Busy.png) Сильно  |
...
| ![Желтый значок часов, обозначающий состояние "нет на месте"](media/Presence_Away.png) Уйти| ![уйти](media/Presence_Away.png) Уйти|
...
## <a name="teams-is-not-skype-for-business"></a>Teams не является Skype для бизнеса

Следующие параметры администратора в Skype для бизнеса отличаются в teams:
- Общий доступ к присутствию всегда включен в Teams для пользователей в Организации. Конфиденциальность (принятие решения о том, кто может видеть состояние присутствия) недоступен в Teams.
- Предоставление общего предоставления сведений о присутствии для всех пользователей (в том числе федеративных служб) всегда разрешено пользователям в Teams. Список контактов (если они в SfB) видны в разделе **чат _Гт_ Contacts (контакты** ) или в разделе **звонки _гт_ контакты**.
- Клиент не переносятся, а функции, появляющиеся неактивными, всегда включаются для пользователей в Teams.
- В приложении "Календарь" (включая _Амп_ другую информацию календаря) всегда включена интеграция для пользователей в Teams, если они интегрированы с Outlook.
