...
- **Состояние** — архив или состояние "Активен" для этой группы. Узнайте больше о архивовке команд в [архиве или восстановлении команды.](https://support.office.com/article/archive-or-restore-a-team-dc161cfd-b328-440f-974b-5da5bd98b5a7)
...
Вы можете архивировать команду. При архивации команда перенаставляется в режим только для чтения Teams. Как администратор вы можете архивировать и ото архивировать команды от имени своей организации в Центре администрирования. 
...
- Добавление и удаление каналов (обратите внимание, что удалить канал Общий нельзя).
