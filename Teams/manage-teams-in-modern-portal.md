...
В этой статье приводится обзор средств управления для Teams в Центре администрирования Microsoft Teams.
...
> [!NOTE]
> Если в сетке нет всех этих свойств, щелкните значок "Изменить **столбцы".** В области **"Изменение** столбцов" можно включить или отключить столбцы в сетке с помощью выключает выключать столбцы. Закончив, нажмите кнопку **"Применить".**

### <a name="add"></a>Добавить

Чтобы добавить новую команду, нажмите кнопку **"Добавить".** В области **"Добавление** новой команды" ввести имя и описание группы, у установить ее как частную или общенастройную, так и классификацию.
