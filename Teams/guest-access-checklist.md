...
Как минимум необходимо включить группами Майкрософт для всех пользователей тип лицензии **гостя**. Подробные инструкции в разделе [Включение и отключение гостевой доступ к группами Майкрософт](set-up-guests.md).
...
Убедитесь в том, что **позволить добавлять пользователей за пределами организации, чтобы группы владельцев группы** — это значение **на**. Если этот параметр отключен, владельцев группы не сможет для добавления нового Гости. (Тем не менее, если администратор добавленные Гость в Azure AD, затем владелец группы смогут для добавления пользователя в группу.) Как минимум этот параметр должен быть «на» для поддержки доступа.
...
4. В разделе **внешние пользователи**убедитесь, что **можно пригласить участников** задано значение **Да**. ![Снимке экрана показан пример AAD параметры переключателя. ](media/guest-access-checklist-AADSettings1.png)
