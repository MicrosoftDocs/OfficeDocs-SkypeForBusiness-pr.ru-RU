...
- seo-marvel-mar2020
description: 'Узнайте, как попробовать или приобрести лицензии на аудиоконференции для Microsoft 365 или Office 365, чтобы настроить конференц-вызовы, к которые могут звонить люди. '
ms.openlocfilehash: af031e26cceb920811c3b4f349fda44fd7e3a387
ms.sourcegitcommit: 556fffc96729150efcc04cd5d6069c402012421e
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/26/2021
ms.locfileid: "58611538"
---
...
В некоторых случаях пользователям в организации требуется телефон, чтобы присоединиться к собранию. Microsoft Teams включает функцию аудиоконференций именно для этой ситуации! Пользователи могут звонить на Microsoft Teams с помощью телефона, а не с помощью приложения Microsoft Teams на мобильном устройстве или компьютере.
...
Для выполнения этих [действий](https://support.office.com/article/da585eea-f576-4f55-a1e0-87090b6aaa9d) необходимо быть глобальным администратором или администратором вы выставления счета.
...
2. Получите свою лицензию на **Аудиконференции**. Если Вы хотите:
   ...
   - **Попробуйте** сделать это перед покупкой: вы можете зарегистрироваться для бесплатной пробной Office 365 корпоративный E5, которая включает аудиоконференцию. См. раздел [Пробная версия Office 365 корпоративный E5](https://portal.office.com/Signup?OfferId=101bde18-5ffb-4d79-a47b-f5b2c62525b3).

   - **Купить:** см. Microsoft Teams [лицензирования надстройки](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md).

3. [Назначайте лицензии пользователям](/microsoft-365/admin/manage/assign-licenses-to-users) в организации, которые будут планировать или вести собрания.

4. Дополнительно назначить приобретенные Вами лицензии на надстройку аудиоконференции и кредиты на связь. Инструкции см. в [Microsoft Teams надстройки](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md).
...
4. [Назначайте лицензии пользователям](/microsoft-365/admin/manage/assign-licenses-to-users) в организации, которые будут планировать или вести собрания.
...
При назначении  лицензии на аудиоконференцию людям в организации, которые не интегрируются Skype для бизнеса со сторонним поставщиком аудиоконференций, все они настроены и готовы к этому! (Нет необходимости в настройке их поставщика аудиоконференций.)

Если у вас есть пользователи, включенные сторонним поставщиком аудиоконференций, необходимо изменить поставщика этих пользователей на Майкрософт. Чтобы изменить поставщика для пользователя, см. назначение Майкрософт в качестве поставщика [аудиоконференций.](/skypeforbusiness/audio-conferencing-in-office-365/assign-microsoft-as-the-audio-conferencing-provider)
...
1. [Настройка приглашений на собрания](/skypeforbusiness/set-up-skype-for-business-online/customize-meeting-invitations). Номера для телефонного подбираемого номера автоматически добавляются в приглашения на собрания, отосланные участникам. Однако вы можете добавить собственные ссылки на справку и юридическое сообщение, текстовое сообщение и рисунок небольшой компании.
...
3. [Настройка языков](set-auto-attendant-languages-for-audio-conferencing-in-teams.md) автоответов для аудиоконференций, которые автоконференциер аудиоконференции использует для приветения вызывающего звоняющего на телефонный номер аудиоконференции. Этот шаг необходим только в том случае, если Microsoft назначен в качестве поставщика аудиоконференции.
