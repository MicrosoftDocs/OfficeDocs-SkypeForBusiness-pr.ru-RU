...
- Административные элементы управления и возможности поддержки, включая 24 x 7 телефонов и веб-поддержку, средства администрирования для управления пользователями и приложениями, отчеты об использовании для Microsoft 365 и служб Office 365, соглашения на уровне обслуживания, а также настраиваемые параметры и политики пользователей.
...
- Если вы приобретаете собственный домен, он не связан с Azure Active Directory (с помощью пробной версии или приобретенной подписки на Microsoft 365 или Office 365).

> [!NOTE]
> Чтобы обновить и перенести данные, вам нужно приобрести подписку с помощью процесса обновления в приложении Teams. Если вы приобрели Microsoft 365 или Office 365 с помощью Teams, не передавая процесс обновления, вы не сможете передавать данные, так как у вас уже есть отдельный клиент.
...
- Все пользователи должны находиться в одном домене. (Все пользователи получат вход в формате *имя пользователя* @ . *domain.com*.)
