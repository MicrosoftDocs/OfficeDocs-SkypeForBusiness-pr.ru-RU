...
Администратор может выбрать дополнительные источники обучающего контента (например, SharePoint или поддерживаемые сторонние источники) для пользователей приложения. Затем администратор настраивает эти источники, чтобы контент был доступен для поиска и обнаружения и был доступен сотрудникам, которые используют приложение.

> [!NOTE]
>  Пользователи могут в браузере или внедренном представлении в браузере войти в учебные процессы, не связанные с Microsoft и LinkedIn Learning Pro. На это настроенное обучение лагаются отдельные условия лицензии, конфиденциальности и обслуживания между вашей организацией и третьей стороной, а не условия обучения (предварительная версия). Прежде чем выбирать это обучение в режиме обучения (предварительная версия), убедитесь, что у вас есть соглашение для вашей организации и пользователей.
