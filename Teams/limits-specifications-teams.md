...
|Число элементов в [масштабе организации группы](create-an-org-wide-team.md) | 5 000       |
...
У вас нет SharePoint Online, включенных в клиент, группами Майкрософт пользователи всегда нельзя совместно использовать файлы в группах. Пользователи в частной беседы также не могут совместно использовать файлы из-за OneDrive для бизнеса (которая связана с лицензии SharePoint) является обязательным для этой функции.
