...
|Максимальное количество участников в группе Office 365, которую можно преобразовать в команду    |10 000|
...
<sup>2</sup> Это ограничение включает архивированные команды. Чтобы превысить максимальный предел, обратитесь в службу поддержки Майкрософт.
...
|Функция  | Максимальный предел  |
|---------|---------|
|Количество пользователей в закрытом чате<sup>1</sup>  | 250 |
...
> **Повышение предельных значений для трансляций Microsoft 365**
>
> Чтобы пользователи могли удовлетворять быстро меняющиеся потребности коммуникаций, мы временно повышаем стандартные предельные значения до 1 января 2021 г. для трансляций, проводимых в Teams, Stream и Yammer.
>
...
Команда класса — это тип шаблона с дополнительными приложениями и ограничениями по количеству участников команд.
...
Команда класса может поддерживать более 200 участников. Но если вы планируете использовать в своей команде приложение "Задания" или "Записная книжка для занятий", вам потребуется использовать количество участников, не превышающее максимальное ограничение, указанное выше.
