...
|Компонент     | Максимальный предел |
|------------|---------------|
|Количество людей на встрече (могут общаться и звонить)  | 1000, включает GCC, но пока не включает GCCH и DoD. Режим **только просмотр** позволяет 20 000 участников подключиться в режиме прослушивания к собранию, у организатора которого есть лицензия на SKU E3/E5/A3/A5, а также выпуск для государственных организаций (GCC, GCC High, DoD). Узнайте больше о [взаимодействии в режиме "Только просмотр"](view-only-meeting-experience.md).|
|Количество людей, подключившихся к видео- или аудиоконференции из чата | 20 |
...
> [!NOTE]
> URL-адрес собрания никогда не перестает работать. Срок действия относится только к номерам ТСОП для подключения и/или к базовым политикам и настройкам собраний.
