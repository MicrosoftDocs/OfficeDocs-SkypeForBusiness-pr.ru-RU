...
|Количество участников в команде | 10,000<sup>6</sup>     |
...
|Количество каналов на команду    | 200 (включая удаленные каналы)&sup4;         |
|Количество закрытых каналов на команду    |30| (включая удаленные каналы)&sup4;
...
<sup>6</sup> Команды в GCC могут иметь не более 5 000 участников, а в GCCH и DoD не более 2 500.
...
|Компонент     | Максимальный предел |
|------------|---------------|
|Количество людей на встрече (могут общаться и звонить)  | 300. Режим **только просмотр** позволяет 10 000 участников подключиться в режиме прослушивания к собранию, у организатора которого есть лицензия на SKU E3/E5/A3/A5.<br>**Примечание.** В Teams для государственных организаций (GCC, GCC High, DoD) лимит остается прежним — 250. Эта статья будет обновлена, когда лимит облака для государственных организаций повысится с 250 до 300 и будет поддерживать переполнение собраний. Узнайте больше о [взаимодействии в режиме "Только просмотр"](view-only-meeting-experience.md).|
|Количество людей, подключившихся к видео- или аудиоконференции из чата | 20 |
