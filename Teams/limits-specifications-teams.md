...
|Число участников в группы | 2500 долл. США       |
|Число элементов в [масштабе организации группы](create-an-org-wide-team.md) | 2500 долл. США       |
...
> [!IMPORTANT]
> Работники терминалов не будут иметь возможность планировать собрания групп, как по умолчанию, AllowChannelMeetingScheduling и AllowPrivateMeetingScheduling не включены в предоставление входящей пропускной способности в отношении TeamsMeetingPolicy. Применяется только к работники терминалов. 
