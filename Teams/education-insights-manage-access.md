...
Вы должны предоставить разрешения лидерам учреждений образования, руководителям округов, директорам школ, консультантам, руководителям учебных районов, руководителям программ, социальным работникам и психологам. Преподаватели *автоматически получают разрешение*, если они являются владельцами команды класса.
...
Если вы используете [формат файла SDS V2.1](/schooldatasync/sds-v2.1-csv-file-format) или[ формат файла SDS V2](/schooldatasync/sds-v2-csv-file-format), вы можете импортировать все роли и полную школьную иерархию в систему образования. Это комплексное соответствие позволяет назначать разрешения ролям. 
...
* Выберите уровень разрешений:
  * **Все** означает, что пользователь видит все подразделения организации на всех уровнях. Это очень редко используется.
