...
> [!NOTE]
> Когда вы предоставляете разрешение для уровня организации, пользователь может увидеть ниже все подразделения организации. Предоставлять разрешения только тем руководителям образовательных учреждений, которым они нужны.
> 
...
* Нажмите кнопку **Сохранить изменения**.
  ...
  Если в списке есть пользователь, которому требуется более детализированный уровень разрешений, настройте его в разделе "Отдельные разрешения".
