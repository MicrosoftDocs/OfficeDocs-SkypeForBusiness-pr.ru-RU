...
- Представитель службы поддержки отправляет в канале Teams объявление, чтобы специалисту было необходимо получить звонок и помочь клиенту. Эксперт вводит код в клиенты Teams для получения звонка
