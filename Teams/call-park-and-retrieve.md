...
- Представитель службы поддержки отправляет в канале Teams объявление о том, что специалист может получить звонок и помочь клиенту. Эксперт вводит код в клиенты Teams для получения звонка
...
Чтобы настроить диапазон настраиваемого парка и время и время времени его пользования, используйте командлеты New- и Set-CsTeamsCallParkPolicy, доступные в Teams PowerShell Module 2.6.0 или более поздней. (В Центре администрирования настраиваемого парка изменения времени и времени и времени Teams нельзя настроить. Обратите внимание, Teams центре администрирования по-прежнему будут по-прежнему показываться значения по умолчанию.)
