...
ms.locfileid: "48361759"
---
# <a name="phone-number-management-for-france"></a>Управление номерами телефонов во Франции

Эта таблица используется для поиска информации о получении номеров телефонов для Microsoft Teams во Франции и управлении им. 
...
|:-----|:-----|
|Получите новые номера телефонов пользователей или служб, которые не указаны в Центре администрирования Microsoft Teams.   <br/> | Скачайте одну из этих форм. <br/> [Запрос нового номера телефона для Франции (0,5.0) (fr-fr)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-france-(v.5.0)-(fr-fr).pdf?raw=true) <br/>  [Новый запрос на номер телефона для Франции (0,5.0) (en-us)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-france-(v.5.0)-(en-us).pdf?raw=true)<br/> <br/>   Заполните ее и [отправьте его нам](mailto:ptneu@microsoft.com).  <br/> 
|Перенаправь нам номера телефонов.  <br/> |Скачайте одну из этих форм. <br/><br/> Для номеров телефонов пользователей:<br/>[Досье для Франции (5.0) (5.0) (fr-fr)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-france-(geographic-numbers)-(v.5.0)-(fr-fr).pdf?raw=true) <br/><br/>Для бесплатных номеров телефонов: <br/>[Досье (LOA) для Франции (бесплатные номера) (5.0) (fr-fr)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-france-(freephone-numbers)-(v.5.0)-(fr-fr).pdf?raw=true) <br/> <br/> Заполните ее и [отправьте его нам](mailto:ptneu@microsoft.com).  <br/> |
