...
|Перенаправь нам номера телефонов.<br/> | Скачайте эту форму. <br/>[Док-досье (LOA) для Венгрии (все цифры) (1.0) (hu-hu)](https://download.microsoft.com/download/f/b/1/fb17b2df-b5cf-45b7-89f0-0cbf250df1f7/letter-of-authorization-(loa)-for-hungary-(all-numbers)-(v1.0)-(hu-hu)%20(1).pdf) <br/> <br/>Заполните ее и [отправьте его нам](mailto:ptneu@microsoft.com). <br/><br/>Перенос номеров на этом рынке может занять от двух до трех недель. <br/><br/>В настоящее время эти номера нельзя использовать для использования для связи.   |
