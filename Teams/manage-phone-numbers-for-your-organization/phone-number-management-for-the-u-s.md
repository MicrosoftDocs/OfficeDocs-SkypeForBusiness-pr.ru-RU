...
|Получайте новые номера телефонов служб, которые не указаны в центре администрирования Microsoft Teams. <br/> |Если вы хотите узнать номер Услуги в США, [Скачайте эту форму](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-numbers-inside-the-u.s.-(service-numbers)-(v.1.0)-(en-us).pdf?raw=true), заполните ее и [отправьте нам](mailto:ptn@microsoft.com).
