...
- Calling Plans
- seo-marvel-apr2020
description: Узнайте, как получить и управлять номерами пользователей (подписчиков) и служб (платных и бесплатных) номеров телефонов в Microsoft Teams для вашей организации.
ms.openlocfilehash: 7b7bbc7dae1aff2b582853c3deaf0d1861f20361
ms.sourcegitcommit: 01087be29daa3abce7d3b03a55ba5ef8db4ca161
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/23/2021
ms.locfileid: "51101175"
---
...
- [Получение номеров телефонов служб в Центре администрирования Microsoft Teams.](../getting-service-phone-numbers.md#get-new-service-numbers)
- [Перенос существующих _номеров_ телефонов с помощью нас.](../phone-number-calling-plans/transfer-phone-numbers-to-teams.md#create-a-port-order-and-transfer-your-phone-numbers-to-teams)
...
***
Если вы знаете, какие формы вам нужно найти, выберите страну или регион, в которые хотите получить номера, в конце.
...
Иногда (в зависимости от страны или региона) вы не сможете получить новые номера телефонов (абонентов) или услуг (платные  или бесплатные) с помощью  Центра администрирования Microsoft Teams или вам могут потребоваться определенные номера телефонов (иммерные запросы) или коды определенных областей.

В этом случае вам потребуется скачать правильную форму PDF-досье (для каждой страны или региона и тип телефонных номеров) и отправить ее нам. Служба обслуживания отслужит его и начнет обработку вашего запроса.

### <a name="letters-of-authorization-loas-to-transferport-existing-phone-numbers-from-another-service-provider-to-microsoft-teams"></a>Досье (LOAS) для переноса существующих номеров телефонов другого поставщика услуг в Microsoft Teams
...
Отправьте нам **досье,** если у вас есть следующие досье с другим оператором:

- Номера пользователей (подписчиков).
- Номера служб (платные) для моста аудиоконференций, автоотетаря или очередей вызовов.
...
Заполнив **заполняемую** и подписанную досье, свяжитесь со службой поддержки [STN,](./contact-pstn-service-desk.md) чтобы мы помогли вам.

## <a name="still-need-assistance"></a>Все еще нужна помощь?

[Обратитесь в службу поддержки ННР,](./contact-pstn-service-desk.md) и мы как можно скорее помогают вам.
...
- Чтобы получить помощь по настройке номеров телефонов для организации, прочитайте статью "Обратиться в службу поддержки продуктов для [бизнеса: справка для администраторов".](/microsoft-365/admin/contact-support-for-business-products?tabs=online&view=o365-worldwide)
