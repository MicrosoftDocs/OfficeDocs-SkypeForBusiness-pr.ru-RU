---
title: Обратитесь в службу номеров телефонов
author: CarolynRowe
ms.author: crowe
manager: serdars
...
description: Если вы получаете номера телефонов или номера переноса для своей организации, вам может потребоваться получить помощь и поддержку в службе TNS.
ms.openlocfilehash: b7ac8edd3c3c740f3b87feedc44535a193280a77
ms.sourcegitcommit: 4af3638637456f21bc97f510ed9d2f7ff2da07e2
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/19/2022
ms.locfileid: "63660694"
---
...
2. В области слева выберите Голосовая и Телефон **номера**.
...
Опишите, чего вы пытаетесь достичь, и перечислите свои вопросы о службе службЫ телефонных номеров (TNS) Корпорации Майкрософт.  
...
- **Общайтесь со службой TNS** относительно вашего дела, открыв существующее дело, прокручивая страницу вниз и выбрав **Добавить комментарий**. Появится новое окно. Введите сообщение в поле комментария. Приложите все подтверждающие документы (если они есть), которые могут помочь с вашим запросом, и выберите **Отправить**.  
