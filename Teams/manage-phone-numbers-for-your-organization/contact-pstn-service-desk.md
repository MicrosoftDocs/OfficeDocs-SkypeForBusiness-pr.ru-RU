---
title: Обращение в службу поддержки ТСОП
author: CarolynRowe
ms.author: crowe
manager: serdars
...
Существует новый процесс взаимодействия со службой поддержки ТСОП. Теперь вы можете открывать, просматривать запросы и отслеживать общение в едином месте, интегрированном с Центром администрирования Teams. В этой статье описывается все, что нужно знать, чтобы связаться со службой поддержки.
...
В Центре обслуживания номеров телефонов можно создавать новые запросы, просматривать существующие, взаимодействовать со службой поддержки и управлять профилем пользователя. Эти задачи более подробно описаны в следующих разделах.

- **Центр обслуживания номеров телефонов**  – перейдите на домашнюю страницу портала. 

- **[Создать обращение](#create-a-new-case)**  – отправить новый или общий запрос. 

- **[Просмотреть существующие обращения](#view-and-manage-existing-cases)** – отслеживать существующие обращения. 

- **[Просмотреть обращения компании](#view-and-manage-existing-cases)**  – отслеживать существующие обращения компании. Если ваши коллеги из вашей компании открыли какие-либо обращения, вы можете просмотреть их в этом представлении.  
...
Опишите, чего вы пытаетесь достичь, и перечислите свои вопросы для службы поддержки ТСОП Майкрософт.  
...
- **Свяжитесь со службой поддержки ТСОП** по поводу вашего обращения, открыв существующее обращение, прокрутив его вниз и выбрав **Добавить комментарий.**. Появится новое окно. Введите сообщение в поле комментария. Приложите все подтверждающие документы (если они есть), которые могут помочь с вашим запросом, и выберите **Отправить**.  

  Ответы от службы поддержки ТСОП будут отображаться на той же временной шкале. При обновлении вашего обращения вы получите автоматическое отправляемое по электронной почте уведомление об обновлении. 
...
- Для получения помощи, связанной с установкой и настройкой номеров, лицензиями, сборами или выставлением счета, см. в разделе [Контактное лицо службы поддержки для продуктов для бизнеса — Справка для администраторов](/microsoft-365/admin/contact-support-for-business-products?tabs=online&view=o365-worldwide).
