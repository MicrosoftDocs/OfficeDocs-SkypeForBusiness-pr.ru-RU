...
В этой таблице содержатся сведения о том, как получить и управлять номерами телефонов в Ирландии для Microsoft Teams. 
