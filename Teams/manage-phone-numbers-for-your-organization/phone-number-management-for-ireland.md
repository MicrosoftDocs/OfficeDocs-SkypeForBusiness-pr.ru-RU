...
ms.locfileid: "58365646"
---
# <a name="phone-number-management-for-ireland"></a>Управление номерами телефонов в Ирландии

В этой таблице вы найдете сведения о получении номеров телефонов в Ирландии и управлении Microsoft Teams.
...
|:-----|:-----|
|Получите новые номера пользователей или номеров телефонов служб, которые не указаны в Microsoft Teams центре администрирования. <br/> |В Ирландии вы не можете получить телефонные номера для своей организации с помощью Microsoft Teams администрирования. Необходимо отправить запрос на получение номеров телефонов. <br/><br/>Скачайте эту форму.<br/>[Новый запрос на номер телефона для Ирландии (v.5.0) (en-us)](https://download.microsoft.com/download/9/e/5/9e5634d7-ce23-489f-b867-6f5120645fb1/new-phone-number-request-for-ireland-(v.5.0)-(en-us).pdf). <br/><br/> Заполните его и за инструкциями обратитесь в службу [поддержки ТССК.](contact-pstn-service-desk.md)  <br/> |
|Перенаправь нам номера телефонов.  <br/> | Скачайте эту форму. <br/>[Док-досье (LOA) для Ирландии (все номера) (v.6.0) (en-us)](https://download.microsoft.com/download/d/a/f/daf4edb9-69c7-4d3d-a483-e0c4427abb50/letter-of-authorization-(loa)-for-ireland-(all-numbers)-(v.6.0)-(en-us).pdf) <br/> <br/>Заполните его и обратитесь за инструкциями в службу [поддержки ТССК.](contact-pstn-service-desk.md) <br/> |
