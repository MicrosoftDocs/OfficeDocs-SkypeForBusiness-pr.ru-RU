...
|:-----|:-----|
|Получите новые номера телефонов пользователей или служб, которые не указаны в Центре администрирования Microsoft Teams.   <br/> |Скачайте одну из этих форм. <br/>  [Новый запрос номера телефона для Швеции (5.0) (sv-se)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-sweden-(v.5.0)-(sv-se).pdf?raw=true) <br/>  [Новый запрос на номер телефона для Швеции (5.0) (en-us)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-sweden-(v.5.0)-(en-us).pdf?raw=true)<br/>  <br/>Заполните ее и [отправьте его нам](mailto:ptneu@microsoft.com).|
Перенаправь нам номера телефонов.  <br/> |Скачайте эту форму. <br/>[Досье (LOA) для Швеции (все номера) (v.5.0) (sv-se)](https://download.microsoft.com/download/b/d/0/bd030c0c-67c5-40fb-a148-d12a4675aa79/letter-of-authorization-(loa)-for-sweden-(all-numbers)-(v.5.0)-(sv-se).pdf)<br/><br/> Заполните ее и [отправьте его нам](mailto:ptneu@microsoft.com). <br/> |
