...
ms.custom:
- Calling Plans
description: Эта таблица содержит сведения о получении номеров телефонов в Чешской Microsoft Teams и управлении ими.
...
Эта таблица содержит сведения о получении номеров телефонов в Чешской Microsoft Teams и управлении ими.
...
|:-----|:-----|
|Получение новых номеров телефонов пользователей или служб, которые не указаны в Microsoft Teams центре администрирования. |В Чешской Республика вы можете получить номера телефонов для своей организации с помощью Microsoft Teams центра администрирования. Вы также можете отправить новый запрос на номер телефона, скачав форму и обратитесь к [Service Desk TNS](contact-tns-service-desk.md).<br/><br/>`[New phone number request for the Czech Republic (v.1.0) cs-CZ](https://download.microsoft.com/download/2/f/0/2f015d86-3136-4d81-b323-e5b8cac3c272/new-phone-number-request-for-the-czech-republic-(v1.0)-(cs-CZ).pdf )`. <br/><br/> Прежде чем назначать вам номера телефонов, необходимо скачать форму "Знать клиента", завершить ее полностью и отправить нам.<br/><br/>Для заполнения новых заказов на этот рынок может потребоваться от двух до трех недель.  |
|Получение номеров телефонов, переданных нам. | Скачайте эту форму. <br/><br/>[Доверенность (LOA) для Чешской Республика (все цифры) (версия 1.0) (веб-часть)](https://download.microsoft.com/download/6/f/6/6f66c134-5ad4-42d8-b7f9-f857fb5fd4ca/letter-of-authorization-(loa)-for-czech-republic-(all-numbers)-(v1.0)-(cz-cz).pdf)<br/><br/>Заполните его и [обратитесь к Service Desk TNS.](contact-tns-service-desk.md) Необходимо также включить счет за служебную программу с бизнес-адреса, для которого требуется перенести номера.<br/><br/>Перенос номеров на этом рынке может занять от двух до трех недель. <br/><br/>В данный момент эти номера нельзя использовать для конференц-связи. |
