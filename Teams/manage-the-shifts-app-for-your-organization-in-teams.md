...
2. Перейдите на страницу **Параметры** > **службы & надстроек** > **Группами Майкрософт**. 
...
Ознакомиться с политикой FirstLineWorker в левой области навигации группами Майкрософт и Скайп по центру администрирования бизнеса, перейдите к **приложения группы** > **политики в отношении установки приложений**.

![Снимок экрана политики программы установки приложения FirstLineWorker в группами Майкрософт & Скайп по центру администрирования бизнеса] (media/firstline-worker-app-setup-policy.png "Снимок экрана политики программы установки приложения FirstLineWorker в группами Майкрософт & Скайп по центру администрирования бизнеса")
...
1. В левой панели навигации группами Майкрософт & Скайп по центру администрирования бизнеса перейдите к **пользователям**и нажмите кнопку пользователя.
