...
- **Разрешения:** указывает, есть ли у стороного приложения или пользовательского приложения, зарегистрированного в Azure Active Directory (Azure AD), есть разрешения, которые требуют согласия. Вы увидите одно из следующих значений:
