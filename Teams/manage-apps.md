...
**Мини-приложение "Ожидающих** утверждения" на странице "Управление приложениями" сообщает о том, что разработчик сообщает о том, что приложение отправлено с помощью API Teams приложения. В списке вновь отправленное  приложение указано  состояние "Отправка" и **"Состояние** **заблокировано".** Перейдите на страницу сведений о приложении, чтобы увидеть дополнительные сведения о приложении, а затем, чтобы опубликовать его, установите для состояния публикации **состояние** **Опубликовать**.
...
Чтобы обновить приложение после его добавления, в списке приложений на странице Управление приложениями выберите имя приложения, а затем выберите **Обновить**. Это заменяет существующее приложение, а все политики разрешений приложений и политики настройки приложений остаются принудительно примененными для обновленного приложения.
