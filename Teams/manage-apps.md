...
description: Узнайте, как управлять приложениями Teams на странице Управление приложениями в Microsoft Teams администрирования.
appliesto:
- Microsoft Teams
...
- [Утверждение настраиваемого](#approve-a-custom-app)приложения. Используйте этот метод, если разработчик сообщает о приложении непосредственно на страницу Управление приложениями с Teams API отправки приложений. После этого вы можете просмотреть и опубликовать (или отклонить) приложение прямо на странице сведений о приложении.
