...
2. В разделе **Сторонние приложения**, отключите и включите эти параметры для управления доступом к сторонним программам:
    ...
    - **Разрешить приложениям сторонних разработчиков**: Определяет, могут ли пользователи использовать приложения сторонних разработчиков. Если вы отключите этот параметр, ваши пользователи не смогут устанавливать и использовать сторонние приложения, а  их состояние будет отображаться в таблице Как заблокировано для всей организации.
        ...
        > [!NOTE]
        > Если выключено разрешение сторонних [приложений,](/microsoftteams/platform/webhooks-and-connectors/what-are-webhooks-and-connectors) исходящая **веб-часть** отключается, то есть пользователи не могут создавать их. Если этот параметр включен, исходяющие веб-интерфейсы включены для всех пользователей, и вы можете управлять ими на уровне пользователей, разрешив или блокируя приложение Исходя из Webhook с помощью политик разрешений [приложений.](teams-app-permission-policies.md) <br><br>Обратите внимание, что [](teams-app-permission-policies.md) если у  вас есть существующие политики разрешений приложений для приложений Майкрософт, которые используют параметр Разрешить определенные приложения и блокировать все остальные приложения, и вы хотите включить исходяющие веб-функции для пользователей, добавьте в список исходятую веб-страницу Webhook. 

        > [!NOTE]
        > Teams пользователи могут добавлять приложения при организации собраний или чатов с пользователями из других организаций. Кроме того, они могут использовать приложения, к которых имеют доступ люди из других организаций, присоединяться к собраниям или чатам, которые они используют. Применяются политики данных организации, в которую размещен пользователь, а также правила обмена данными для сторонних приложений, совместно применяемых в организации этого пользователя.
