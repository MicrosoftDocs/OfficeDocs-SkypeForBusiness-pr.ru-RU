...
- **Реакции:** API экспорта поддерживают реакции, инициируемые пользователем в сообщении Teams. В настоящее время поддерживаются такие реакции, как "пульс", "как", "грусть", "уныние" и "грусть".
