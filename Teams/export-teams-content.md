...
- **Реакции:** API экспорта поддерживают реакции, инициированные пользователем в сообщении Teams. В настоящее время поддерживаются такие реакции, как "пульс", "как", "грусть", "уныние" и "грусть".
