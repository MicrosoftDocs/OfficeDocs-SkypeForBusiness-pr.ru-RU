...
|          **_Добавление закрытого канала_*          |    Да     |    Да<sup>2</sup>|
| **_Изменить имя и описание личного канала_* |    Нет     |    Н/Д|
|        **_Удаление закрытого канала_*         |    Да     |    Нет|
