...
<sup>1</sup> владельцы группы могут создавать группы, если это не было запрещено. Ознакомьтесь [с разрешениями для создания команд](#permissions-to-create-teams) ниже.<br>
<sup>2</sup> эти элементы могут быть отключены владельцем на уровне группы, в этом случае участники не смогут получить к ним доступ.<br>
