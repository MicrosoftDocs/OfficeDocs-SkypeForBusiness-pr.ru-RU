...
> [!NOTE]
> Необходимо настроить кредитов коммуникаций и назначьте лицензии кредитов коммуникаций для каждого пользователя в **центре администрирования Microsoft 365** > **пользователей** > **Активные пользователи**. 
  
Рекомендуется тщательно Оценка использования службы ТСОП в организации для понимания наиболее программы установки для коммуникаций кредитов. Дополнительные сведения о служб ТСОП можно видеть, прочитав статью [телефонной системой и вызов планы](calling-plan-landing-page.md) и [часто задаваемые вопросы аудио конференц-связи](Audio-Conferencing-common-questions.md).
...
Можно также просмотреть сведения о ценах, выполнив [Вход в центр администрирования Microsoft 365](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) и переход на **выставление счетов** > **подписки** > **Добавить подписки**.
