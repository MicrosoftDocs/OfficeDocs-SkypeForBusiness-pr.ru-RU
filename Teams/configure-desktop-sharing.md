...
5. Включите или выключите следующие параметры:
    ...
    - **Разрешить участнику предоставить или** запросить управление — позволяет участникам группы предоставить или запросить контроль над рабочим столом или приложением.
