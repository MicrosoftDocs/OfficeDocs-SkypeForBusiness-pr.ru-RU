...
2. На странице **политики собрания** нажмите кнопку **Добавить**.
...
4. В разделе **Общий доступ к контенту** выберите **режим совместного использования экрана** из раскрывающегося списка:
  ...
  > [!Note]
  > Для того чтобы пользователи могли использовать общий доступ к экрану из чата, вам не нужно включать политику вызова. Тем не менее, звук будет выключен, пока не будет включен микрофон. Кроме того, пользователь, которому предоставлен общий доступ к экрану, может нажать кнопку **добавить звук** , чтобы включить звук. Если политика вызовов отключена, пользователи не смогут добавить звук на экран с помощью сеанса чата.
