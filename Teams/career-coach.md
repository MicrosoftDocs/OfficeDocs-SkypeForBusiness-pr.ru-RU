...
Профконсультант — это Microsoft Teams для образования, которое работает на сайте LinkedIn, которое предоставляет учащимся высшего образования персонализированные рекомендации по переходу к карьере. Профконсультант учебных заведений — это единое решение для карьерной работы учащихся, которое позволяет им познать свой путь к карьере, развивать реальные навыки и создавать сеть в одном месте.
...
4. Выберите **Профконсультант**, а затем **выберите** Параметры .  
    ...
    ![показывает приложение Профконсультант, выбранное с Параметры параметром.](media/career-coach-app.png)
...
3. Администратор страницы LinkedIn использует уникальную ссылку проверки, чтобы Профконсультант со страницей вашего учебного заведения. Дополнительные сведения см. в дополнительных документах о проверке страницы [LinkedIn.](https://www.linkedin.com/help/linkedin/answer/102672)
...
1. Во sign in to the **[Teams admin center](https://admin.teams.microsoft.com)**.
1. Выберите **Teams приложений Управление** приложениями &gt; **[](https://admin.teams.microsoft.com/policies/manage-apps)** &gt; **Профконсультант** &gt; **Параметры** &gt; **полей исследования**.  
