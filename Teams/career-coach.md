...
Профконсультант **требуется,** чтобы пользователи учебного заведения были иметь возможность подключать свою учетную запись Microsoft 365 к своей учетной записи LinkedIn, которая упростилась в Профконсультант
...
4. Выберите **Профконсультант**, а затем выберите **Параметры.**  
    ...
    ![приложение Профконсультант, выбранное с параметром Параметры с отображением](media/career-coach-app.png)
...
3. Добавьте URL-адрес страницы LinkedIn учебного заведения. URL-адрес должен быть учебной страницей, а не страницей компании и обычно отформатирован как `https://www.linkedin.com/school/willow-university/` .
...
1. Выберите **Teams приложений Управление** &gt; **приложениями** &gt; **Профконсультант** &gt; **Параметры** &gt; **каталога курсов**.  
