...
> [!IMPORTANT]
> Для Профконсультант конфигурации ИТ-администратору должна быть назначена лицензия преподавателя.

**Данные и файлы из вашего учебного заведения**

- Логотип и графические ресурсы учебного заведения в требуемом формате.
...
4. **Для правильной настройки учетных** записей LinkedIn необходимо установить для подключений к учетной записи LinkedIn Профконсультант "Да" или "Выбранная группа".  
...
> [!IMPORTANT]
> Для доступа к странице необходимо быть глобальным администратором или администратором Teams службы.
...
4. Выберите **Профконсультант**, а затем **выберите** Параметры .  
    ...
    ![отображает Профконсультант, выбранное с параметром Параметры.](media/career-coach-app.png)
...
> [!IMPORTANT]
> Это необходимый раздел, поэтому Профконсультант включить его без фирменой и личных предпочтений.
...
1. В случае успешной отправки страница будет обновлена, и на странице покажутся ссылка Проверка и **срок** **действия ссылки Проверка.** Срок действия ссылки для проверки истекает через 30 дней.

   ![linkedin connections for the career coach app.](media/career-coach-linked-in.png)  

2. Скопируйте ссылку на проверку и поделитесь им со страницей LinkedIn своего учебного заведения, супер администратором. Узнайте больше о роли супер администратора на странице LinkedIn в [документации к администраторам страниц LinkedIn.](https://www.linkedin.com/help/linkedin/answer/102672)
...
1. Выберите **Teams приложений Управление** &gt; **[приложениями](https://admin.teams.microsoft.com/policies/manage-apps)** &gt; **Профконсультант** &gt; **Параметры** &gt; **каталога курса**.  
...
1. Во sign in to the **[Teams admin center](https://admin.teams.microsoft.com)**.
1. Выберите **Teams приложений** &gt; **[Управление](https://admin.teams.microsoft.com/policies/manage-apps)** &gt; **приложениями Профконсультант** &gt; **Параметры** &gt; **полей исследования**.  
...
1. Выберите **Teams приложений Управление** &gt; **[приложениями](https://admin.teams.microsoft.com/policies/manage-apps)** &gt; **Профконсультант**.
...
Если вы не знаете, какую политику использовать, обратитесь к документации [](/microsoftteams/easy-policy-setup-edu?tabs=students%2Cstudent-settings) по управлению политиками Microsoft Teams или воспользуйтесь мастером политики для образования для настройки политики Microsoft Teams. [](/microsoftteams/policy-packages-edu)

3. В области Установленные приложения выберите **Добавить приложения**.

4. В области Добавить установленные приложения найщите приложения, которые вы хотите автоматически установить для пользователей при запуске Teams. Вы также можете фильтровать приложения с помощью политики разрешений приложений. Выбрав список приложений, выберите **Добавить**.
...
- Если в приложении Профконсультант Профконсультант есть разделы, которые в настоящее время настроены для использования в ближайшее время, необходимые разделы не __выполнены.__ Перед __тем как__ использовать Профконсультант, необходимо выполнить следующие разделы: [](#brand-and-preferences)"Торговая марка и параметры", "Подключение [LinkedIn",](#linkedin-connection) [](#course-catalog)"Каталог курса" и "Поля [исследования".](#fields-of-study)

- CSV-форматы для каталога курса и поля исследования имеют требуемую форматирование и максимальный размер 18 МБ. Чтобы обеспечить [правильную](#course-catalog-document-format-and-schema) конфигурацию, Профконсультант схему [](#fields-of-study-document-format-and-schema) документов каталога Профконсультант и поля схемы документов исследования.
...
- Через неделю группа Профконсультант удаляет все данные, связанные с клиентом. Служба поддержки Майкрософт отслеживает этот вопрос и уведомляет вас о том, что процесс удаления завершится в течение **30 дней.**
