...
Тренер по карьерной карьере локализован на следующих языках:
...
4. Выберите **Тренер по карьерной** деятельности , а затем выберите **Параметры.**  
    ...
    ![Приложение "Тренер по карьерной деятельности", выбранное с параметром Параметры с отображением](media/career-coach-app.png)
...
## <a name="making-career-coach-available-to-your-organization"></a>Обеспечение работы с тренером по карьерной деятельности для организации
...
### <a name="add-career-coach-as-an-installed-app"></a>Добавление тренера в качестве установленного приложения
