...
Профконсультант — это Microsoft Teams для образования на сайте LinkedIn, которое предоставляет персонализированные рекомендации для учащихся высшего образования по переходу к карьере. Профконсультант предлагает учебным заведениям единое решение для карьерных целей, которое позволяет учащимся найти свой путь к карьере, развивать реальные навыки и создать свою сеть в одном месте.
...
Профконсультант **требуется,** чтобы у пользователей учебного заведения была возможность подключить свою учетную запись Microsoft 365 к учетной записи LinkedIn, которая упростилась в Профконсультант
...
Используя параметры администратора в Центре Microsoft Teams администрирования, вы можете настроить Профконсультант для своего учебного заведения и включить его для пользователей.
...
- Если в приложении Профконсультант в ближайшее время вы видите Профконсультант, необходимые разделы не выполнены.

- Если поля не заполнены, на страницах параметров с нужными полями страница не будет отправляться
...
4. Выберите **Профконсультант**, а затем выберите **Параметры.**  
    ...
    ![показывает приложение Профконсультант, выбранное с параметром Параметры с отображением](media/career-coach-app.png)
...
Значок учебного заведения используется во Профконсультант, чтобы идентифицировать содержимое, уникальное для вашего учебного заведения, ресурсы каталога курса во всем приложении и в разделе реальных функций панели мониторинга. Значок лучше всего отформатирован как:
...
2. Чтобы найти страницу LinkedIn, найдите ее в LinkedIn и выберите Учебный фильтр. Вы также можете связаться со сотрудником службы по карьерной карьере, чтобы определить правильную страницу LinkedIn для использования. [Определение страниц LinkedIn](https://www.linkedin.com/help/linkedin/answer/40133/differences-between-a-linkedin-page-for-a-school-and-company?lang=en)
    ...
    ![поиск linkedin для учебного заведения](media/career-coach-school-search.png)
...
7. Администратор страницы LinkedIn использует уникальную ссылку проверки, чтобы Профконсультант со страницей вашего учебного заведения. [Дополнительная документация по проверке страницы LinkedIn.](https://www.linkedin.com/help/linkedin/answer/102672)

> [!NOTE]
> Проверка со стороны суперадминистр страницы LinkedIn необходима для завершения подключения LinkedIn для Профконсультант.

   ![Проверка страницы Linkedin на портале разработчика Linkedin](media/career-coach-linkedin-verification.png)
