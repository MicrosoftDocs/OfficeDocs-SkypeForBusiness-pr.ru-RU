---
title: Управление интерфейсом присоединения для Teams виртуальных посещений в браузерах
author: lanachin
...
description: Узнайте о возможностях присоединения Teams виртуальных посещений в браузерах.
...
ms.locfileid: "64703752"
---
# <a name="manage-the-join-experience-for-teams-virtual-visits-on-browsers"></a>Управление интерфейсом присоединения для Teams виртуальных посещений в браузерах
...
**Интеграция с Epic EHR**: соединитель Teams EHR поддерживает присоединение пациентов к виртуальным встречам через Интернет и мобильные устройства MyChart. Во время встречи пациенты могут начать посещение из MyChart с помощью кнопки "Начать виртуальное посещение", Teams откроется в браузере.
...
Сотрудник, который проводит этот визит, может поделиться своим экраном с рабочего Teams, мобильного или веб-клиента с участником, который присоединяется к рабочему столу или мобильному браузеру. Однако участники не могут делиться своим экраном с рабочего стола или мобильного браузера.

## <a name="related-articles"></a>Статьи по теме

- [Виртуальные посещения с Teams и Bookings приложения](bookings-virtual-visits.md)
...
- [Виртуальные посещения с Teams — интеграция с Cerner EHR](healthcare/ehr-admin-cerner.md)
- [Виртуальные посещения с Teams — интеграция с EHR для ситуаций](healthcare/ehr-admin.md)
