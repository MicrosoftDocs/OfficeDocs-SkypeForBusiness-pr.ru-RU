...
| ----- | ----- | ----- | ----- |
| Bookings | Включите виртуальную модернизацию и консультации. | [Виртуальные визиты с помощью Microsoft Teams и приложения Bookings](bookings-virtual-visits.md) | [Использование Bookings](https://support.microsoft.com/en-us/office/what-is-bookings-42d4e852-8e99-4d8f-9b70-d7fc93973cb5) |
| Power Apps и Power Platform | Интеграция бизнес-процессов и возможность быстрого обновления данных, таких как перечень складских запасов, количество продаж, отчеты об инцидентах и многое другое. | [Интеграция Teams с Microsoft Power Platform](../teams-power-platfom-integration.md) и [управление приложениями Microsoft Power Platform в Центре администрирования Microsoft Teams](../manage-power-platform-apps.md) | -  |
