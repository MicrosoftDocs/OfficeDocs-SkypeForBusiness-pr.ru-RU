...
2. Включите параметр Опекун в центре Microsoft Teams, так как этот параметр отключен по умолчанию. Это позволит преподавателям отправлять еженедельный дайджест.
   ...
   > [!NOTE]
   > Преподаватели могут отказаться от дайджеста, отобрав этот параметр в группе своего личного класса (задания Параметры > сообщения электронной почты для родителей и **опекунов).**
