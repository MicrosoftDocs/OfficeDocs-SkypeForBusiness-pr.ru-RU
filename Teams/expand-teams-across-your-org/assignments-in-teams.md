...
Письма опекунов отправляются родителям или опекунам каждые выходные. Сообщение электронной почты содержит сведения о заданиях за предыдущую и предстоящую неделю. Синхронизацию для родителей и опекунов можно настроить с помощью [School Data Sync.](/schooldatasync/parent-contact-sync)
...
**TurnitinApiKey** будет предоставлен вам после того, как вы следуйте запросам. Скопируйте ключ API и вкопируйте его в Microsoft Teams центре администрирования.  Это единственный раз, когда можно просмотреть ключ.
