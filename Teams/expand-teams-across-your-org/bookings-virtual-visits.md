...
Если вы являетесь администратором, ознакомьтесь с разделом "Управление приложением [Bookings](../bookings-app-admin.md)" в Teams, чтобы узнать о предварительных требованиях для использования приложения Bookings в Teams, управлении доступом к Bookings в организации, а также рекомендуемых политиках и параметрах администратора.

Помните, что только планировщики в вашей организации должны устанавливать приложение Bookings в Teams. Сотрудникам, которые проводят или участвуют в виртуальных встречах, это приложение не требуется. Они присоединяются к встречам из Teams или Outlook календаря или по ссылке на собрание в сообщении электронной почты с подтверждением резервирования.
...
В Teams перейдите в **Bookings** >  **начало работы** а затем выберите "Создать **календарь резервирования"**. Заполните форму и обязательно выберите соответствующий тип бизнеса для вашей организации.
...
Приложение Bookings интегрируется с Outlook. После добавления персонала вы сможете просмотреть доступность календаря этого человека и запланировать для них резервирование. Дополнительные сведения см. в [статье "Добавление персонала и просмотр календаря Bookings"](https://support.microsoft.com/office/add-staff-and-view-a-bookings-calendar-6c579f61-8adb-4514-9458-021de2023fa0).  
...
В календаре резервирования перейдите к разделу "Дополнительные параметры **" (...)** **> Параметры**, выберите типы **встреч и нажмите** кнопку **"Добавить тип встречи"**. Введите имя&mdash;, например открытие учетной записи, продление срока действия подписки, консультацию по кредиту,&mdash;подготовку налогов и любые другие сведения и параметры.
...
Если вы являетесь администратором Bookings, вы можете связать до четырех форм для участников, чтобы заполнить каждый раз, когда этот тип встречи зарезементировать. Например, может потребоваться, чтобы участники заполняли форму регистрации перед присоединением к встрече. Чтобы связать форму, выберите " **Связать форму"**. Введите URL-адрес формы и нажмите кнопку **"Ссылка"**. (Если вы впервые создаете связь с формой, вам будет предложено создать группу Microsoft 365 для хранения форм. Выберите **"Создать группу** ", чтобы создать группу. Это необходимо сделать только один раз для календаря резервирования.)
...
> [!NOTE]
> Любые сведения, предоставляемые пациентами в Формах как часть служб Bookings или виртуальных встреч, необходимые для обеспечения непрерывности или хранения медицинских записей, должны быть скачаны, скопированы и /или заданы непосредственно в таких записях. Эта служба не является юридической медицинской записью или назначенным набором записей.
...
Дополнительные сведения см. в разделе ["Планирование резервирования" Teams Bookings](https://support.microsoft.com/office/schedule-a-booking-in-the-teams-bookings-app-e275049d-0d0f-4161-8526-461a9f29439f).

## <a name="conduct-an-appointment"></a>Проведение встречи

В календаре Teams или Outlook перейдите в резервирование, а затем выберите "Присоединиться" или ссылку Teams собрания. Проверьте параметры звука и видео и нажмите кнопку **"Присоединиться сейчас"**. Дополнительные сведения см. [в статье "Проведение встречи с Bookings"](https://support.microsoft.com/office/conduct-a-bookings-appointment-a86a4007-e26c-4909-9893-f7036e2747cd).
...
> [!NOTE]
> В настоящее время приложение Bookings поддерживает добавление до 100 сотрудников на календарь резервирования. Если вы использовали Graph API для настройки и добавления персонала в календарь резервирования, это ограничение может не применяться. В этом сценарии вкладка **"** Очередь" не сможет отобразить содержимое для календарей с более чем 100 сотрудниками. Для оптимального взаимодействия рекомендуется добавить не более 100 сотрудников в календарь резервирования. Мы работаем над устранением этого ограничения в будущих выпусках.
...
Отчет [об использовании](../teams-analytics-and-reports/virtual-visits-usage-report.md) виртуальных посещений в центре администрирования Microsoft Teams предоставляет администраторам общие сведения о Teams виртуальных встреч в вашей организации. В отчете показана подробная аналитика виртуальных встреч, включая встречи Bookings.
