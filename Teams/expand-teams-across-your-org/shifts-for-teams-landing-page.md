...
ms.locfileid: "58727238"
---
# <a name="shifts-for-teams"></a>"Смены" для Teams

Teams дает сотрудникам в вашей организации инструменты, необходимые для эффективного общения и совместной работы. В следующих ресурсах вы узнаете больше о том, как настроить и управлять сменами , средством управления расписанием в Teams.
