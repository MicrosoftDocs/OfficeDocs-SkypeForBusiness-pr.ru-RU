...
|&nbsp;|&nbsp;|
| ------------- | ------------- |
| <img src="/office/media/icons/api.png" alt="Three gears - API."> | **[Shift Graph API](/graph/api/resources/shift)** Shifts Graph API позволяют интегрировать данные Shifts с системами управления внешними трудовыми ресурсами (WFM). Вы сможете создавать пользовательские смены в задней части, предоставляя пользователям гибкий и передний Teams.             |
