...
- Microsoft Teams
ms.reviewer: anach
description: Сведения о приложении пациентов для администраторов Teams
...
Приложение пациентов — это приложение магазина Microsoft Teams, доступное всем пользователям Teams. Приложение включает команды работоспособности пациента, состоящие из Clinical работников (например, Nurses, врача и социальных сотрудников), могут проверять и просматривать списки пациентов для сценариев, начиная с округляя и interdisciplinary собраний команд в общем мониторинге пациента.
