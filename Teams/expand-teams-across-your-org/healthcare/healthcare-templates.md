...
В настоящее время мы предлагаем два шаблона, которые можно использовать в различных ситуациях. Подробнее о шаблонах команд см. в шаблонах [Teams.](../../get-started-with-teams-templates.md)
