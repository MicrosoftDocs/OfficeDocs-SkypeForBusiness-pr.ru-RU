...
## <a name="care-coordination-template"></a>Шаблон координирования

Шаблон координирования задолженности предназначен для упрощения общения в рамках группы здравоохранения пациента с помощью некоторых примеров, включая интердисЦиплинари и мултидисЦиплинари Teams. Наше приложение пациентов предварительно загружено в этот шаблон и располагается в канале "Общее". С помощью приложения пациентов вы можете использовать списки пациентов и связанные с ними значения и важные сведения, чтобы они были полезны при использовании сценариев управления скругленными и пациентами. 

|Тип базового шаблона |басетемплатеид |Каналы базового шаблона|
|:--- |:---|:---|
|Координация по карьерным здравоохранение | `https://graph.microsoft.com/beta/`<br>`teamsTemplates('healthcareCareCoordination')`   | Проверка после лечения\* <br> Планированию\* <br> Подготовку\* |
| | |  |
...
Чтобы использовать эти шаблоны, просто измените свойство "template@odata.bind" в теле запроса с "Standard" на Темплатеидс выше.  Дополнительные сведения о развертывании шаблонов групп можно найти в статье Microsoft Graph о том, как [создавать группы](https://docs.microsoft.com/graph/api/team-post?view=graph-rest-beta).
