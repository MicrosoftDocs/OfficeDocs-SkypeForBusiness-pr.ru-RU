...
В соответствии с правилами hipAA поставщики услуг здравоохранения должны хранить записи о всех правилах доступа к фи, чтобы можно было проводить аудит изменений. Корпорация Майкрософт стремится к корпоративным клиентам, использующим Microsoft Teams, и помогает им соответствовать требованиям и средствам контроля HIPAA. Доступ к фи через приложение "Пациенты" полностью отслеживается, а журналы доступны в Центре соответствия [](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance) требованиям Microsoft 365, как описано в статье "Поиск в журнале аудита".

> [!IMPORTANT]
> Законодательство сша наложена на поставщика медицинских услуг за счет обеспечения конфиденциальности пациентов. Закон дает пациенту право на конфиденциальность и требует, чтобы ИТ-администратор или контроллер HIPAA мог легко определять, к какой медсестре, клинике или социальной работнику был доступ к или измененным записям пациентов. Одним из наиболее распространенных примеров нарушения доступа фи является доступ к VIP-пациентам. Функции журнала аудита необходимы для исследования любого нарушения доступа фи и для удовлетворения требований HIPAA.
...
3. Администратору необходимо включить аудит действий так же, как и аудит журнала действий, как описано в описании перед началом и отключением поиска в журнале [аудита.](/office365/securitycompliance/turn-audit-log-search-on-or-off#turn-on-audit-log-search) [](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance#before-you-begin) Если ведение журнала аудита уже проводится, для приложения "Пациенты" ничего специального не требуется. Каждый раз, когда поставщик здравоохранения устанавливает и запускает приложение в составе команды, журналы аудита регистрирует их действия с фи.
4. Затем администратору нужно будет сообщить о доступности приложения "Пациенты", а работникам здравоохранения потребуется начать создавать действия, которые будут включены в аудит.
...
Зарегистрированные действия для Microsoft Teams в целом описаны в [действиях Microsoft Teams.](/office365/securitycompliance/search-the-audit-log-in-security-and-compliance#microsoft-teams-activities)
