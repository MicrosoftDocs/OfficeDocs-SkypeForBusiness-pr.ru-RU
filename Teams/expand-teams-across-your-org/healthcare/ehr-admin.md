...
- Разрешите пациенту присоединяться Teams виртуальных встреч на портале пациентов или с помощью SMS.
...
В этом видео представлен обзор управления виртуальными встречами на портале EHR.
...
1. Выберите **настройку SMS** рядом с каждым базовым URL-адресом FHIR, чтобы настроить типы SMS-уведомлений для отправки пациентов.
    ...
    - **SMS напоминания**: уведомления отправляются пациенту в соответствии с указанным интервалом времени и запланированным временем встречи.
...
Аналитик клиента Epic должен предоставить эти записи в Epic, чтобы завершить настройку виртуальных встреч в Epic. Дополнительные сведения см. в руководстве [по интеграции Epic-Microsoft Teams Telehealth](https://galaxy.epic.com/Search/GetFile?Url=1!68!100!100100357).
...
- Поставщики могут видеть обновления участников, подключающиеся и отключающиеся в режиме реального времени для данной встречи. Поставщики могут видеть, когда пациент подключен к встрече.
  ...
  ![Взаимодействие поставщика встречи с пациентом.](media/ehc-provider-experience-6.png)
...
Соединитель поддерживает присоединение пациентов к встречам через Интернет и мобильные устройства MyChart. Во время встречи пациенты могут начать встречу из MyChart с помощью кнопки **"Начать виртуальное посещение** ".
...
- Пациенты могут протестировать свои видео и микрофон в зале ожидания перед присоединением к встрече.
  ...
  ![Опыт пациентов встречи.](media/ehc-virtual-visit-5.png)
