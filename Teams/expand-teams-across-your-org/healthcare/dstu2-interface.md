...
Они являются полями, которые являются частью профиля важных знаков Argonaut:
...
При использовании наблюдений компонентов та же логика применяется для каждого наблюдения компонентов.
