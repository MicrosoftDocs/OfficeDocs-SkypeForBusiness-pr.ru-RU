...
* * *
    {"resourceType": "Капабилитистатемент";
        .
        .
        "оставшаяся: [{" Mode ":" сервер "," безопасность ": {" расширение ": [{" расширение ": [{" URL ":" token "," валуеури ":"https://login.contoso.com/145f4184-1b0b-41c7-ba24-b3c1291bfda1/oauth2/token"}, {" URL-адрес ":" Авторизация "," валуеуриhttps://login.contoso.com/145f4184-1b0b-41c7-ba24-b3c1291bfda1/oauth2/authorize":" "}]," URLhttp://fhir-registry.smarthealthit.org/StructureDefinition/oauth-uris-адрес ": [{" System ":"https://hl7.org/fhir/ValueSet/restful-security-service"," код ":" OAuth "}]}]},.
                .
                .
            } ] }
...
* * *
    ...
    Grant-Type = client_credentials &client_id = кскскскскскскскскскс &client_secret = кскскскскскскскскскс
