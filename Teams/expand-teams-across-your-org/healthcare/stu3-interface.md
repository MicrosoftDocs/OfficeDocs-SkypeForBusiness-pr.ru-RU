...
- [Покрытие](#coverage)
- [Выписка по](#medication-request) приему пациентов (заменяет "Order" в DSTU2-версии PatientsApp)
- Расположение (сведения, необходимые для этого ресурса, можно включить в encounter)
...
Это минимальные необходимые поля, которые являются частью профиля [Argonaut ТемныеИннолерации:](https://www.fhir.org/guides/argonaut/r2/StructureDefinition-argo-allergyintolerance.html)
 ...
 - Code.Text
 - Code.Coding[0]. Отображения
 - Кодификация и проверофикация (мы читаем обе эти части)
...
Помимо полей "Аргонаут", приложение "Пациенты" может прочитать следующее поле:
 ...
 - Реакции
    ...
    - Кепка (один элемент кодирования)
