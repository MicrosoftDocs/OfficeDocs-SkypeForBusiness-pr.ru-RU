...
Вот поля, которые требуются в качестве подмножество полей профиля пациентов в Аргонауте:
...
## <a name="medication-request"></a>Запрос на прием с просьбой о прием
