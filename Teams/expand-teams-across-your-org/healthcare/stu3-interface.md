...
- [Условие](#condition)
- [Встреча](#encounter)
- [Омывная хламя](#allergyintolerance)
- [Покрытие](#coverage)
- [Выписка о](#medication-request) приеме приеме (заменяет "Прием приемок" в DSTU2-версии PatientsApp)
...
Помимо полей [Argonaut,](http://www.fhir.org/guides/argonaut/r2/StructureDefinition-argo-patient.html)приложение Patients также может прочитать следующие поля:
...
Это минимальные необходимые поля, которые являются частью профиля [Argonaut ТемныеИннолерации:](https://www.fhir.org/guides/argonaut/r2/StructureDefinition-argo-allergyintolerance.html)
 ...
 - Code.Text
 - Code.Coding[0]. Отображения
 - Кодификация и проверофикация (мы читаем оба)

Помимо полей "Аргонаут", приложение "Пациенты" также может прочитать следующее поле:
...
Помимо полей "Ядро США", приложение "Пациенты" также может прочитать следующие поля:

 - ИстрацияУстрация[..]. Текст
 - Текст
