...
- Интеграция виртуальных встреч и электронной медицинской записи (EHR)
...
Просмотрите следующее видео, чтобы узнать больше об использовании коллекции здравоохранения для улучшения совместной работы группы здравоохранения в Teams.
...
| -------- | -------- | -------- |
| [Виртуальные встречи с интеграцией электронной медицинской записи (EHR)](#virtual-appointments-and-electronic-healthcare-record-ehr-integration) | Планирование, администрирование и проведение виртуальных встреч с пациентов. Этот сценарий подключает Teams и платформу Cerner или Epic для поддержки виртуальных встреч. | Активная подписка на Microsoft Cloud для здравоохранения или подписка на Microsoft Teams автономного предложения соединителя EHR. <br> Пользователи должны иметь соответствующую лицензию Microsoft 365 или Office 365, которая включает Teams собраний*. <br> Организации должны иметь версию Cerner за ноябрь 2018 г. или более позднюю или версию Epic за ноябрь 2018 г. или более позднюю. <br>Сведения о [требованиях к EHR Cerner](ehr-admin-cerner.md#before-you-begin) [и EHR для ситуаций](ehr-admin.md#before-you-begin) |
| [Виртуальные встречи с Microsoft Bookings и Bookings приложения](#virtual-appointments-and-electronic-healthcare-record-ehr-integration) | Планирование, администрирование и проведение виртуальных встреч с пациентов. Этот сценарий основан на Microsoft Bookings для поддержки виртуальных встреч. | Для организации должна быть включена служба Microsoft Bookings. <br> У всех пользователей приложения Bookings и всех сотрудников, участвующих в собраниях, должна быть лицензия, которая поддерживает планирование собраний Teams*. <br>[Подробные требования к Bookings](../../bookings-app-admin.md#prerequisites-to-use-the-bookings-app-in-teams)|
...
*Office 365 A3, A5, E3, E5, F1, F3, Microsoft 365 A3, A5, E3 и E5, Business Standard. Дополнительные общие сведения о лицензировании Teams см. в статье [Управление доступом пользователей к Teams](../../user-access.md).

## <a name="virtual-appointments-and-electronic-healthcare-record-ehr-integration"></a>Интеграция виртуальных встреч и электронной медицинской записи (EHR)

Используйте полную платформу собраний в Teams для планирования, администрирования и проведения виртуальных встреч с пациентов.

- Если ваша организация уже использует электронные записи о работоспособности или EHR, вы можете интегрировать Teams для более удобного взаимодействия. Teams электронной медицинской записи (EHR) упрощает запуск виртуальной встречи пациента или консультации с другим поставщиком в Teams непосредственно из системы EHR. Дополнительные сведения см. в статье о виртуальных встречах с [Teams интеграции в Cerner EHR](ehr-admin-cerner.md) и виртуальных встречах с [Teams — интеграции с Epic EHR](ehr-admin.md).
- Если вы не используете поддерживаемые электронные медицинские карты, можно воспользоваться Microsoft Bookings и приложением Bookings в Teams. Дополнительные сведения см. в статье о виртуальных встречах [Teams и Bookings приложения](../bookings-virtual-visits.md).

![Виртуальные встречи с Microsoft Teams.](../../media/virtual-visits-teams.png)
...
Объедиайте свою группу работоспособности для координации работы и совместной работы с Teams.

![Здравоохранение: совместная работа со своей группой здравоохранения в Teams.](../../media/teams-healthcare-collaborate-in-teams.png)

Teams позволяет преподавателям, врачам, медицинским специалистам и другим сотрудникам эффективно взаимодействовать с включенными функциями совместной работы в Teams, например:
...
:::image type="content" source="../../media/lists-patients-example.png" alt-text="Снимок экрана: пример списка для округления пациентов.":::
