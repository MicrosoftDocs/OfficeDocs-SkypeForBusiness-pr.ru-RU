...
Эти функции входят в Microsoft Cloud для здравоохранения Узнайте больше об использовании этого решения, совмещающего возможности Azure, Dynamics 365 и Microsoft 365, в разделе [Microsoft Cloud для здравоохранения](https://docs.microsoft.com/industry/healthcare).

Посмотрите следующее видео и узнайте о том, как использовать коллекцию здравоохранения, чтобы улучшить взаимодействие между командами в Microsoft Teams.

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE4Hqan]

> [!NOTE]
> В этом разделе предполагается, что вы уже развернули Teams в своей организации. Если вы еще не развернули Teams, см. статью [Развертывание Microsoft Teams](../../How-to-roll-out-teams.md).

Для организаций здравоохранения доступны следующие сценарии:

| Сценарий | Описание | Требования |
| -------- | -------- | -------- |
| [Интеграция виртуальных посещений и электронных медицинских карт](#virtual-visits-and-electronic-healthcare-record-ehr-integration) | Планирование и проведение виртуальных посещений пациентов и управление ими. В этом сценарии Microsoft Teams подключается к платформе Epic для проведения виртуальных посещений. | Активная подписка на Microsoft Cloud для здравоохранения или подписка на отдельное предложение соединителя электронной медицинской карты Microsoft Teams. <br> Пользователи должны иметь соответствующую лицензию на Microsoft 365 или Office 365, которая включает собрания Microsoft Teams*. <br> Организации должны иметь версию Epic с ноября 2018 г. или более позднюю. <br>[Подробные требования к электронным медицинским картам](ehr-admin.md#before-you-begin) |
| [Виртуальные посещения с помощью Microsoft Bookings и приложения Bookings](#virtual-visits-and-electronic-healthcare-record-ehr-integration) | Планирование и проведение виртуальных посещений пациентов и управление ими. В этом сценарии виртуальные посещения проводятся с помощью Microsoft Bookings. | Для организации должна быть включена служба Microsoft Bookings. <br> У всех пользователей приложения Bookings и всех сотрудников, участвующих в собраниях, должна быть лицензия, которая поддерживает планирование собраний Teams*. <br>[Подробные требования к Bookings](../../bookings-app-admin.md#prerequisites-for-using-the-bookings-app-in-teams)|
...
*Поддерживаются Office 365 A3, A5, E3 и E5, а также Microsoft 365 бизнес стандарт, A3, A5, E3 и E5. Дополнительные общие сведения о лицензировании Teams см. в статье [Управление доступом пользователей к Teams](../../user-access.md).

## <a name="virtual-visits-and-electronic-healthcare-record-ehr-integration"></a>Интеграция виртуальных посещений и электронных медицинских карт

Используйте полноценную платформу собраний в Microsoft Teams, чтобы планировать и проводить виртуальные посещения пациентов и управлять ими.

- Если в вашей организации уже используются электронные медицинские карты, вы можете интегрировать Microsoft Teams для большего удобства. Соединитель электронной медицинской карты Microsoft Teams упрощает для врачей возможность виртуального посещения пациента или консультации с другим поставщиком в Teams непосредственно из системы электронных медицинских карт. Чтобы узнать больше, см. статью [Виртуальные посещения с помощью Teams — интеграция с электронными медицинскими картами](ehr-admin.md).
- Если вы не используете поддерживаемые электронные медицинские карты, можно воспользоваться Microsoft Bookings и приложением Bookings в Teams. Чтобы узнать больше, см. статью [Приложение Bookings и виртуальные посещения в Microsoft Teams](../../bookings-app-admin.md).
...
Примените пакеты политик Teams, чтобы определить возможности разных ролей в Teams. Например, задайте политики для:
...
Разработаны новые шаблоны для создания команд Teams в больницах, и вскоре ожидаются дополнительные функции. Это облегчит создание команд для работников здравоохранения и поможет координировать усилия по уходу за пациентами в разных отделах и палатах. Чтобы узнать больше, см. статью [Начало работы с шаблонами Teams для организаций в сфере здравоохранения](healthcare-templates.md) Также Teams можно использовать во внутренних отделах, например в кабинетах кардиологии, а также в палатах ухода за пациентами. Вскоре вас ждут и другие шаблоны.

## <a name="care-coordination-and-collaboration"></a>Согласование и совместная работа по уходу

Объедините усилия ваших работников здравоохранения для лучшего ухода за пациентами с помощью Microsoft Teams.

![Здравоохранение: работайте со своей врачебной командой в Teams](../../media/teams-healthcare-collaborate-in-teams.png)

Microsoft Teams позволяет терапевтам, врачам, медсестрам и прочему персоналу сотрудничать эффективнее благодаря таким функциям совместной работы в Microsoft Teams, как:
...
- Чат, публикация сообщений и общение. Ваша команда может вести непрерывные обсуждения о разных пациентах, которым требуется дополнительный уход.
- Звоните участникам команды здравоохранения и организуйте совещания. Назначайте отдельные встречи или воспользуйтесь встречами на канале, чтобы проводить ежедневные собрания. Вам помогут такие функции, как аудио- и видеосвязь Teams, демонстрация экрана, запись и транскрибирование сообщений.
- Храните файлы и документы и делитесь ими с коллегами. Ваша команда здравоохранения — это единый цифровой организм, совместно работающий над документами Office.
...
Например, старшая сестра может создать список пациентов в команде, в которую входят все члены группы здравоохранения. Во время обходов работники здравоохранения заходят в Teams со своих мобильных устройств и обновляют сведения о пациентах в списке, доступном каждому члену команды. Когда команда собирается для обсуждения и оценки ключевых показателей состояния здоровья на совещаниях, чтобы убедиться, что пациенты находятся на пути к выздоровлению, информацию из Teams можно вывести на большой экран. члены групп здравоохранения, находящиеся вдали от больницы, могут присоединяться дистанционно.
