...
## <a name="teams-templates"></a>Шаблоны групп
...
## <a name="lists-app"></a>Приложение "списки"
...
Например, плата за медсестры создает список пациент в команде, включающий всех участников группы. В ходе цикла группа разработчиков Microsoft Access на мобильных устройствах и обновляет сведения о пациентах в списке, которые могут просматривать все участники группы, чтобы оставаться на синхронизации. В сеансах с большим объемом, с помощью которых Группа разработчиков собирается обсуждать и оценивать метрики показателей работоспособности, чтобы убедиться в том, что пациент находится на правильном Glide пути, он может предоставить общий доступ к этим данным, используя команды на большом экране монитора. Участники групп, которых нет на сайте, могут присоединиться удаленно.
