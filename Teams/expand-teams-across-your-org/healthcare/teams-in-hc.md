...
В Microsoft Teams теперь есть решение для координирования дел, относящееся к организациям здравоохранения, благодаря которым они помогут вам добиться наилучшего пациента. Крукс решения для координирования дел, приложения Microsoft Teams пациентов, — это приложение, которое интегрируется с электронными записями о работоспособности[(ехр](https://www.hl7.org/fhir/)) с помощью ресурсов быстрого и высокофункционального взаимодействия, в которых можно получить ценные медицинские сведения в Microsoft Teams в контексте для обеспечения совместной работы клиникал и общения.  
