...
В этой статье описано, как настроить соедините Teams EHR для интеграции с платформой Cerner. Здесь также представлен обзор Teams посещений в системе EHR Cerner.
...
Затем, чтобы настроить интеграцию, администратор службы Microsoft 365 добавляет базовый URL-адрес службы FHIR от Cerner и определяет среду. При необходимости настройте количество базовых URL-адресов FHIR в зависимости от потребностей организации и среды, которые вы хотите протестировать.
...
> [!NOTE]
> Администратор Microsoft 365 в любое время может войти на портал конфигурации, чтобы просмотреть записи интеграции и при необходимости изменить параметры конфигурации.
