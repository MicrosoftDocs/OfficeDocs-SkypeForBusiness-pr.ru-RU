...
В этой статье описано, как настроить соединители Teams EHR для интеграции с платформой Cerner. В ней также представлен обзор Teams виртуальных посещений в системе EHR Cerner.
...
Вам будут представлены записи интеграции для запуска пациентов и поставщика услуг. Эти записи необходимы для настройки виртуальных посещений в Cerner. Дополнительные сведения см. в руководстве Cerner-Microsoft Teams интеграции с телетайлами.
...
- Настройка интеграции между организацией Cerner и вашей организацией Microsoft 365.
...
После этого поставщик может просмотреть сведения о посещении, присоединиться к посещениям и отправить ссылку на собрание. После разового входе поставщик будет сразу перенаться на виртуальную встречу в Teams.
...
Соединит Teams EHR не хранит и не передает личные личные данные, а также медицинские записи пациентов и поставщиков услуг здравоохранения из системы EHR. Единственными данными, которые хранит соединитектор EHR, является уникальный ИД пользователя EHR, который используется Teams настройке собрания.
