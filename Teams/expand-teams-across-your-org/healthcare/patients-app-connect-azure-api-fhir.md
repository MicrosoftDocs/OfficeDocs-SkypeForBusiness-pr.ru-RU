...
4. Перейдите к экземпляру ресурса Azure API для ресурсов FHIR, к которому вы хотите подключить приложение "Пациенты" (путем поиска или просмотра ресурсов), а затем откройте параметры этого экземпляра.
