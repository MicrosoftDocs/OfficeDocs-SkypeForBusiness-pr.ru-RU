...
Действующий 30 июня 2020 г. StaffHub будет прекращена. Мы рекомендуем вам приступить к работе с Teams сегодня и начать переход с групп и пользователей вашей организации из StaffHub. Управление расписаниями является наиболее часто используемой функцией StaffHub, поэтому мы рекомендуем использовать приложение "смены" в Teams для перемещения вперед.
...
Каждой команде StaffHub нужна соответствующая группа Microsoft 365 или Microsoft 365. Если группа StaffHub связана с группой Microsoft 365, параметр конфиденциальности группы сохраняется при перемещении команды. Если у группы StaffHub нет группы Microsoft 365, связанной с ней, автоматически создается группа с параметром конфиденциальности Private, позволяющая вам поддерживать переход.  С учетом различий в именовании групп и групп между группами и StaffHub в Teams может быть указано другое имя группы. 
