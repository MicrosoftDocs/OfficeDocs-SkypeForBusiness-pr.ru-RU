...
Вы можете связать учетную запись Azure AD для этих пользователей.  Выполните описанные ниже действия.

#### <a name="get-a-list-of-all-users-on-staffhub-teams-that-have-team-members-that-arent-linked-to-an-azure-ad-account"></a>Получение списка всех пользователей для StaffHub Teams, у которых есть члены группы, не связанные с учетной записью Azure AD
...
- Удалите несвязанную учетную запись пользователя. Использовать этот параметр Учетная запись пользователя больше не нужна.
