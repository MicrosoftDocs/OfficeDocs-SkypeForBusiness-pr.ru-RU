...
|![Сплошной красный кружок означает "Занят(а)"](../../media/flw-presence-busy.png) Занят(а)      | ![Сплошной красный кружок означает "Занят(а)"](../../media/flw-presence-busy.png) Занят(а)         |За устанавливается автоматически. Их также можно настроить вручную, когда сотрудник, который находится в режиме смены, находится в режиме смены.|

## <a name="off-shift-access-to-teams"></a>Отключение сменного доступа к Teams

Эта функция позволяет управлять доступом к Teams, когда сотрудники, работающие с телефоном, не работают в данный момент. Вы можете настроить в Teams отображение сообщения для сотрудников, не работающих с телефоном, если они работают в Teams, когда они работают в нее во время смены. Сотрудники, работающие с frontline, должны нажать **кнопку "Я принимаю",** чтобы подтвердить сообщение, прежде чем они смогут использовать Teams.
...
В этом примере мы создали политику Off Shift Teams Access Message1. В этой политике включено присутствие с учетом смены, и следующее предопределеное сообщение отображается каждый раз, когда пользователь, которому назначена эта политика, получает доступ к Teams при смене.
  ...
  "Ваш работодателей не разрешает или не утверждает использование его сети, приложений, систем и инструментов нерабоочными или почасовой работой сотрудников в нерабочные часы. Принимая приглашение, вы признаете, что ваше использование Teams во время смены не разрешено и вы не можете быть возмещены". 
