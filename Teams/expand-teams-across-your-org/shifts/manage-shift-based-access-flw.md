...
description: Узнайте, как управлять доступом с учетом смены в Teams для сотрудников, работающих с frontline, в вашей организации.
...
Эта функция позволяет управлять доступом к Teams, когда сотрудники, работающие с телефоном, не работают в данный момент. Вы можете настроить в Teams отображение сообщения для сотрудников, не работающих с телефоном, если они будут получать доступ к Teams во время смены. Сотрудники, работающие с frontline, должны нажать **кнопку "Я принимаю",** чтобы подтвердить сообщение, прежде чем они смогут использовать Teams.
...
В этом примере мы создали политику Off Shift Teams Access Message1. В этой политике включено присутствие с учетом смены, и следующее предопределеное сообщение отображается каждый раз, когда пользователь, которому назначена эта политика, получает доступ к Teams при смене.
  ...
  "Ваш работодателей не разрешает или не утверждает использование его сети, приложений, систем или инструментов нерабоочными или почасовой работой сотрудников в нерабо рабочее время. Принимая приглашение, вы признаете, что ваше использование Teams во время смены не разрешено и вы не можете быть возмещены". 
