...
С начала сентября компоненты в прямом эфире будут доступны глобально. В конце сентября она будет доступна для облако сообщества для государственных организаций Mod (GCC).
...
Компоненты, созданные в Teams, сохраняются в файле, храняном в папке `.fluid` OneDrive для бизнеса. Если файл находится в OneDrive для бизнеса пользователи могут создавать, обнаруживать и управлять компонентами (файлами) в прямом эфире так же легко, как `.fluid` Office документом.
...
При открытии Teams чата в Office.com в верхней части окна есть функции общего доступа, аналогичные возможностям общего доступа для других Office документов.
