...
Гости в [частных каналах](private-channels.md) не могут создать или удалить список или начать новую беседу по элементу списка. Они могут добавлять элементы списка в существующие списки и отвечать на существующие беседы о элементах списка. Имейте в виду, что эти ограничения применимы только к частным каналам.
