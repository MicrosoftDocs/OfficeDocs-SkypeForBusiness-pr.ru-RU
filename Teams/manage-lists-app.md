...
![Выводит список приложений в коллекции вкладок.](media/lists-tab.png)
...
Прежде чем перейти в Teams, почтовые перевозчики должны были вернуться в почтовое отделение, чтобы заполнить форму в печатном виде, чтобы сообщить об инциденте, который затем был введен в электронную таблицу Excel. Teams дает почтальонам возможность в первую очередь использовать мобильные устройства и приложение Lists, чтобы сообщать об инцидентах по мере их возникновения, делиться деталями с членами команды, обсуждать их на канале и доводить инциденты до разрешения.
...
2. Выполните одно из следующих действий.
    ...
    - Чтобы отключить список для вашей организации, найдите приложение Списки, выберите его и выберите **Блокировать**.
...
Чтобы разрешить или запретить определенным пользователям в вашей организации использовать списки, убедитесь, что список включен для вашей организации на странице [Управление приложениями](manage-apps.md) , а затем создайте настраиваемую политику для разрешений приложений и назначьте ее этим пользователям. Дополнительные сведения см. в статье [Управление политиками и параметрами пользовательских приложений в Teams](teams-app-permission-policies.md).

## <a name="search-the-audit-log-for-list-events"></a>Поиск событий списка в журнале аудита

Списки включены с аудитом корпоративного уровня, поэтому вы можете искать списки и события элементов списка в журнале аудита в Центре соответствия требованиям безопасности &. Подробнее см. в статье [Поиск по журналу аудита в Центре безопасности и соответствия требованиям](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance).
...
Чтобы отправить нам отзыв или сообщить о проблеме, выберите **Справка** в нижней части левой области в Teams, а затем выберите **Сообщить о проблеме**. Выберите **Lists**, а затем введите свой отзыв или подробные сведения о возникшей неполадке.
