...
В Teams пользователи получают доступ к программе Lists в виде вкладки на канале. Выберите **+** , чтобы открыть галерею вкладок и добавить новый экземпляр вкладки приложения Списки в канал, чтобы начать работу.
...
2. Выполните одно из следующих действий.
    ...
    - Чтобы отключить списки для организации, найди приложение Списки, выберите его и **выберите Заблокировать.**
    - Чтобы включить списки для организации, найди приложение Списки, выберите его и выберите **Разрешить**.
...
Для списков включен аудит корпоративного уровня, так что вы можете искать списки и события элементов списков в журнале аудита в Центре & соответствия требованиям. Подробнее см. в статье [Поиск по журналу аудита в Центре безопасности и соответствия требованиям](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance).
