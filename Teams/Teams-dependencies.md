...
Параметры для приглашений применяются на уровне клиента и управляют взаимодействием с гостем на уровне каталога, клиента и приложения. Чтобы настроить эти параметры в Azure портала, перейдите к **Azure Active Directory** > **пользователей** > **пользовательские параметры**, а в разделе **внешние пользователи**, выберите **Управление параметрами внешней совместной работы**.
...
Дополнительные сведения об управлении, можно пригласить гости [приглашения делегат для совместной работы в Azure Active Directory B2B](https://docs.microsoft.com/en-us/azure/active-directory/b2b/delegate-invitations)см.
