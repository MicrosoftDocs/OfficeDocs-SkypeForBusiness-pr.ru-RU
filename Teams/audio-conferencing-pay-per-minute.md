...
В то время как предложение аудиоконференции на пользователя лицензия включает использование телефонного набора и некоторые функции исходят из телефонного набора, аудиоконференция с поминутной оплатой позволяет оплачивать все использование аудиоконференций поминутно без ежемесячной оплаты лицензии "на **пользователя".** В этом случае с каждой минуты будут взиматься плата за все звонки с телефонным и телефонным вызовами, включая следующие:
