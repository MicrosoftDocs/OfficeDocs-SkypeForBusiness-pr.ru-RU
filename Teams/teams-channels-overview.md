...
- **Команды** объединяют в себе людей, контент и средства, относящиеся к различным проектам или результатам в организации.
    ...
    - Команды также можно создавать как общедоступные и открытые, и к ним может присоединиться любой сотрудник организации (до 10 000 участников).
...
Владельцы команд также могут создавать команды на основе существующей группы Microsoft 365. Все изменения в группе будут автоматически синхронизированы с Microsoft Teams. Создание команды на основе существующей группы Microsoft 365 не только упрощает процесс приглашения участников и управление участниками, но и синхронизирует файлы группы в Microsoft Teams.
