...
- **Команды** объединяют в себе людей, контент и средства, относящиеся к различным проектам или результатам в организации.
    ...
    - Кроме того, можно создавать общедоступные и открытые группы, а также все пользователи в организации могут присоединяться к Skype (до 10 000 участников).
...
Владельцы групп также могут создать группу на основе существующей группы Microsoft 365. Все изменения в группе будут автоматически синхронизированы с Microsoft Teams. Создание группы на основе существующей группы Microsoft 365 не только упрощает процесс приглашения и управления пользователями, но также синхронизирует файлы группы в Microsoft Teams.
