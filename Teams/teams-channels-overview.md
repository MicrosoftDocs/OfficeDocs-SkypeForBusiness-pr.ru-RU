...
-   **Команды** представляют собой набор людей, материалы и средства соседних различных проектов и результатов в пределах организации.
    ...
    -   Также можно создавать группы быть общедоступными и открытыми и в рамках организации для присоединения к (до 5000 членов).
