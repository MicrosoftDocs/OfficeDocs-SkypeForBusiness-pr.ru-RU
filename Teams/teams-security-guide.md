...
***Шифрование трафика** _

|||
|:-----|:-----|
|_ *Тип трафика**|**Способ шифрования**|
|Сервер-сервер|MTLS|
...
- [Реализация раздельного VPN-туннелирования](https://docs.microsoft.com/Office365/Enterprise/office-365-vpn-implement-split-tunnel)
