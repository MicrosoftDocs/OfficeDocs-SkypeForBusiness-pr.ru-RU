...
- Кроме того, вы увидите трафик OAuth в своей трассировке, в частности, связанный с обменами токенов и согласованием разрешений при переключении между вкладками в Teams, например для перемещения из вкладки "Публикации" в "Файлы". Пример потока OAuth для вкладок см. [в этом документе](/microsoftteams/platform/tabs/how-to/authentication/auth-flow-tab).
