...
Teams использует алгоритмы FIPS (Federal Information Processing Standard) для обмена ключами шифрования. Дополнительные сведения о реализации FIPS см. в [Публикации 140-2 Федерального стандарта обработки безопасности (FIPS) ](/microsoft-365/compliance/offering-fips-140-2?view=o365-worldwide).
