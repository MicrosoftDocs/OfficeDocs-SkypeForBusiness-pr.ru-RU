...
- **Пользователи, принадлежащие к этому клиенту**. У этих пользователей есть учетные данные в Azure Active Directory для этого клиента.
...
- **Пользователи, не принадлежащие к этому клиенту**. У этих пользователей нет учебных данных в Azure AD для этого клиента.
...
- *Люди из моей организации, из доверенных организаций, а также гостевые пользователи*: авторизованные пользователи организации, включая гостевых пользователей и пользователей из доверенных организаций, присоединяются к собранию напрямую, без помещения в "зал ожидания". Анонимные пользователи помещаются в "зал ожидания".
