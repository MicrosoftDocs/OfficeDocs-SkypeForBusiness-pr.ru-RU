...
- **Современная проверка подлинности (MA)** является реализацией Майкрософт протокола OAUTH 2.0 для взаимодействия клиента с сервером. Она включает функции безопасности, такие как многофакторная проверка подлинности и условный доступ. Чтобы использовать MA, сетевой клиент и клиенты должны поддерживать MA. Клиенты Teams на компьютерах и мобильных устройствах, а также веб-клиент [поддерживают MA](https://docs.microsoft.com/microsoftteams/sign-in-teams).
