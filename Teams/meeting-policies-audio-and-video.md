...
Для этого можно использовать как Teams администрирования, так и PowerShell. Вы можете изменить существующую политику собраний Teams с помощью командлета [Set-CsTeamsMeetingPolicy](/powershell/module/skype/set-csteamsmeetingpolicy). Или создайте политику собраний Teams с помощью командлета [New-CsTeamsMeetingPolicy](/powershell/module/skype/new-csteamsmeetingpolicy) и назначьте ее пользователям.

Чтобы указать, могут ли пользователи настраивать фон видео во время собрания, задайте параметр **VideoFiltersMode** **(Выберите** параметры видеофильтров в Teams администрирования) следующим образом:

|Значение параметра в PowerShell|Настройка значения в Teams администрирования |Поведение  |
|---------|---------|---------|
