...
Чтобы указать, могут ли пользователи настраивать фон видео во время собрания, задайте параметр **VideoFiltersMode** **(Выберите** параметры видеофильтров в Центре администрирования Teams) следующим образом:
...
Вы можете добавлять собственные фоновые изображения для каждого клиента. Эта функция позволяет компаниям применять фирмевую фирменую Teams собраний.
