...
Обратите внимание, что транскрибация записанных собраний в настоящее время поддерживается только для пользователей, у которых в Teams установлен английский и когда на собрании говорится английский.
...
Собрания, организованные Илья, не записывают, а Аманда, у которого включен параметр политики, не может записывать собрания, организованные Илья. Собрания, организованные Пользователем Амандой, можно записать, но Светлана, у которого отключен параметр политики, и Иван , который является внешним пользователем, не могут записывать собрания, организованные Пользователем Аманда.
...
|:-------:|:-------:|
|![Снимок экрана: собрание с настройками звука и видео на рабочем столе.](media/meeting-policies-audio-video-settings.png)    |![Снимок экрана: экран присоединения к собранию с настройками звука и видео в мобильном клиенте](media/meeting-policies-mobile-join.png)          |
...
Вы можете добавлять собственные фоновые изображения для каждого клиента. Эта функция позволяет компаниям использовать фирменую фирменую Teams собраний.
