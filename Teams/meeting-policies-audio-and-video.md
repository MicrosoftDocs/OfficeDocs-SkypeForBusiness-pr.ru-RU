...
Вы можете добавить собственные фоновые изображения, которые будут использоваться в клиенте. Эта функция позволяет компаниям использовать фирменую Teams собраниях.

1. Войдите в Центр администрирования Teams.

2. Выберите **Политики**  >  **собраний**  >  **СобранияНастройка изображений собраний**.
