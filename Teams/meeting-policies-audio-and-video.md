...
Обратите внимание, что транскрибация записанных собраний в настоящее время поддерживается только для пользователей, у которых установлен Teams английский и когда на собрании говорится английский.
...
Собрания, организованные Алексеем, не записывают, а Аманда, у которых включен параметр политики, не может записывать собрания, организованные Илья. Собрания, организованные Пользователем Амандой, могут записываться, но Светлана, у которого отключен параметр политики, и Иван , который является внешним пользователем, не может записывать собрания, организованные Пользователем Аманда.
...
8. Просмотрите изображения и при необходимости добавьте их.
