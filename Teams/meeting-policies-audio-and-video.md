...
Обратите внимание на то, что транскрибация записанных собраний в настоящее время поддерживается только для пользователей, у которых в Teams установлен английский и когда на собрании говорится английский.

### <a name="allow-cloud-recording"></a>Разрешить запись в облаке

Это сочетание политики "на пользователя" и "на пользователя". Этот параметр управляет записью собраний этого пользователя. Запись может начать организатор собрания или другой участник собрания, если параметр политики включен для участника и если он проходит проверку подлинности в той же организации.
...
Собрания, организованные Алексеем, не записывают, а Аманда, у которого включен параметр политики, не может записывать собрания, организованные Илья. Собрания, организованные Пользователем Амандой, могут записываться, но Светлана, у которого отключен параметр политики, и Иван , который является внешним пользователем, не может записывать собрания, организованные Пользователем Аманда.
