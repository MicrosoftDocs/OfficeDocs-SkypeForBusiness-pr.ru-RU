...
Чтобы указать, могут ли пользователи настраивать фон видео во время собрания, задайте параметр **VideoFiltersMode** **(Выберите** параметр фильтров видео в Teams администрирования) следующим образом:
...
2. Выберите **Политики**  >  **собраний Настройка**  >  **изображений собраний**.
