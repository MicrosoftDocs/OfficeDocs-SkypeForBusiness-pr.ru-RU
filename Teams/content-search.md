...
> [!NOTE]
> Поиск контента в сообщениях и файлах в закрытых [каналах](private-channels.md) работает не так, как в стандартных каналах. Подробнее см. в [поиске контента в закрытых каналах.](#content-search-of-private-channels)

Поиск контента позволяет запрашивать данные в Microsoft Teams, охватывающих Exchange, SharePoint Online и OneDrive для бизнеса.
