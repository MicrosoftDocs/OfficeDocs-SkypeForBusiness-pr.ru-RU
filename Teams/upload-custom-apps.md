...
> [!NOTE]
> Если вы не можете отправить приложение в свой клиент для проверки (даже для себя или доверенных пользователей), пропустите [](#set-up-and-manage) этот шаг и следуйте шагам из раздела [Upload](#upload) и Настройка приложения и управление им для публикации неоцененного приложения в магазине приложений организации. Затем ограничив доступ к этому приложению только себе и пользователям, которые вам доверяете. Затем эти пользователи могут получить приложение из магазина приложений вашей организации для выполнения проверки. После проверки приложения используйте те же политики разрешений, чтобы открыть и разо свернуть приложение для использования в производственной сфере.
...
2. Отключите **параметры Upload приложений в** глобальной политике настройки приложений. Для этого выполните следующие действия:
    1. В левой области навигации Центра администрирования Microsoft Teams выберите Teams политики установки приложений и щелкните глобальную  >   **политику (по** умолчанию для всей организации).
...
Вы можете искать в журнале аудита Teams действия с приложениями в организации. Чтобы узнать больше о поиске в журнале аудита и увидеть список действий Teams, которые регистрируются в журнале аудита, см. в журнале аудита найдите события в <a href="/microsoftteams/audit-log-events" target="_blank">Teams.</a>
