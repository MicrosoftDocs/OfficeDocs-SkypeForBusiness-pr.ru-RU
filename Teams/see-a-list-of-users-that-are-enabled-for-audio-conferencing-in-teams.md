...
- При просмотре списка активированных пользователей вы можете выбрать пользователя, чтобы изменить его настройки аудиоконференций.
...
- Чтобы найти отдельного пользователя в списке, можно использовать кнопку поиска.
