...
Если владелец частного канала покидает организацию или удален из группы Microsoft 365, связанной с командой, уровень одного из участников частного канала автоматически повышается до владельца.
...
|---------|---------|---------|---------|---------|---------|---------|
|Создать частный канал|Управляется администратором|Управляется администратором и владельцем команды|Нет|Н/Д|Недоступно|Н/Д|
|Удалить частный канал|Да|Нет|Нет|Да|Нет|Нет|
|Покинуть частный канал|Недоступно|Недоступно|Н/Д|Да, если это не последний владелец|Да|Да|
|Изменить частный канал|Нет|Недоступно|Н/Д|Да|Нет|Нет|
|Восстановить удаленный частный канал|Да|Нет|Нет|Да|Нет|Нет|
|Добавить участников|Нет|Недоступно|Н/Д|Да|Нет|Нет|
|Изменение параметров|Нет|Недоступно|Н/Д|Да|Нет|Нет|
|Управление вкладками и приложениями|Нет|Недоступно|Н/Д|Да, для команды следует установить приложения|Управляется владельцем канала|Нет|
...
Teams управляет жизненным циклом сайта закрытого канала. Если сайт удален из Teams, фоновое задание восстанавливает его в течение четырех часов, пока частный канал еще активен.
