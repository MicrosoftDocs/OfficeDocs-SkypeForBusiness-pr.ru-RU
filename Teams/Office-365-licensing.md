...
|---------|---------|---------|---------|
|Microsoft 365 бизнес базовый     |Office 365 корпоративный E1  |Office 365 для образования |Разработчик Office 365     |
|Microsoft 365 бизнес стандарт     |Office 365 корпоративный E3         |Office 365 для образования плюс         |      |
...
> [!TIP]
> Сведения о том, как управлять лицензированием на уровне пользователей, можно найти в разделе [Управление доступом пользователей к Microsoft Teams](user-access.md).
