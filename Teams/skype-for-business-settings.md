...
> [!NOTE]
> Настройки Skype для бизнеса раньше находились на **портале** устаревшей службы в Центре администрирования Microsoft Teams. После выхода устаревшего портала мы перенаправлены в эти новые расположения в Центре администрирования Teams для управления Skype для бизнеса.
...
По умолчанию пользователи Skype для бизнеса в вашей организации могут видеть статус присутствия других пользователей Skype для бизнеса (например, "В сети", "Занят" или "Нет на работе"). Выберите один из следующих вариантов, чтобы выбрать пользователей Skype для бизнеса, которые могут видеть ваши пользователи.
...
- **Соответствие** требованиям: включите эту возможность, если требуется хранить в электронном виде информацию. 
