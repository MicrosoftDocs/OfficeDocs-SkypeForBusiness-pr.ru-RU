...
Чтобы управлять функциями Skype для бизнеса Microsoft Teams в Центре администрирования azure [AD,](/azure/active-directory/roles/permissions-reference) вам должна быть назначена роль глобального администратора или администратора Skype для бизнеса администратора azure AD.

## <a name="manage-skype-for-business-settings-for-your-organization"></a>Управление Skype для бизнеса параметров организации

В левой области навигации Центра Microsoft Teams администрирования перейдите в параметры для всей  >  **организации Skype для бизнеса.** Здесь вы можете настраивать и управлять Skype трансляцией собраний, конфиденциальностью присутствия и уведомлениями на мобильных устройствах для всех Skype для бизнеса пользователей в организации.
...
- **Запись Skype собраний:** включив эту возможность, организаторы и Skype могут записывать собрания.  
...
По умолчанию Skype для бизнеса могут видеть состояние присутствия (например, "В сети", "Занят" или "Нет на Skype для бизнеса"). Выберите один из следующих вариантов, чтобы у пользователей было установлено, кто может видеть Skype для бизнеса пользователей.
...
- **Внешние Skype для бизнеса:** включите эту возможность, если вы хотите разрешить пользователям Skype для бизнеса федератов.
