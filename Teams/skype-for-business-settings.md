...
- **Автоматическое отображение** сведений о присутствии: сведения о присутствии могут видеть все  Skype для бизнеса  в вашей организации, которые не были добавлены в список внешних или заблокированных пользователей.
...
- **Внешние Skype для бизнеса** пользователей: включим эту возможность, если вы хотите разрешить Skype для бизнеса пользователям федератированных доменов.
- **Внешние Skype** пользователей: включите эту возможность, если вы хотите разрешить пользователям общаться Skype пользователями. 
