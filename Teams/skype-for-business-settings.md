...
Чтобы управлять функциями Skype для бизнеса в Центре администрирования Microsoft Teams, вам должна быть назначена роль администратора [Azure AD](/azure/active-directory/roles/permissions-reference) глобального администратора или администратор Skype для бизнеса.
...
- **Трансляции собраний Skype:** включите эту возможность, чтобы включить трансляцию собраний Skype для вашей организации. После этого необходимо настроить в сети трансляцию собраний [Skype.](/skypeforbusiness/set-up-your-network-for-skype-meeting-broadcast/set-up-your-network-for-skype-meeting-broadcast)
...
По умолчанию пользователи Skype для бизнеса в вашей организации могут видеть состояние присутствия других пользователей Skype для бизнеса (например, "В сети", "Занят" или "Нет на работе"). Выберите один из следующих вариантов, чтобы выбрать пользователей Skype для бизнеса, которые могут видеть их.
...
- **Отображение сведений** о присутствии только для контактов пользователя. Сведения о присутствии могут видеть все  пользователи  Skype для бизнеса в списке контактов пользователя, которых нет в списке внешних или заблокированных пользователей. Пользователи могут переопределять этот параметр в Skype для бизнеса, используя параметры в меню   >  **"Параметры".**  >  
...
- По умолчанию push-уведомления включены. Отдельные пользователи могут отключать их в Skype для бизнеса на мобильных устройствах.
