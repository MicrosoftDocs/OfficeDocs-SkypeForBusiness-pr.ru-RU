...
Многофакторная проверка подлинности поддерживается для всех планов Office 365, включающих в себя Microsoft Teams. Планы подписки Office 365 с Microsoft Teams указаны ниже в разделе "Лицензирование".
