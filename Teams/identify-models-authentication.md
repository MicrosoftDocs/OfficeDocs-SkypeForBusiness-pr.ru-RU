...
Чтобы обеспечить дополнительный уровень безопасности при входе, используйте многофакторную проверку подлинности (MFA), которая требует как пароля, так и дополнительного способа проверки, например:
...
- Другие способы, доступные при гибридной проверке подлинности и федераированной проверке подлинности.
...
Кроме того, следует разо всех пользователей с многофаксной и многофаксной дв. После регистрации пользователей в многофаксной проверке данных при следующем входе они увидят сообщение с запросом на настройка дополнительного способа проверки. 
