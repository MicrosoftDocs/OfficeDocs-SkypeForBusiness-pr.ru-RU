...
|---------|---------|---------|
|**Только в облаке**     |MFA для Microsoft 365 и Office 365 <ul><li>Телефонный звонок</li><li>SMS</li><li>Уведомление в мобильном приложении</li><li>Код проверки в мобильном приложении</li></ul>        |[Планирование многофакторной проверки подлинности для развертывания Microsoft 365](https://support.office.com/article/Plan-for-multi-factor-authentication-for-Office-365-Deployments-043807b2-21db-4d5c-b430-c8a6dee0e6ba)         |
|**Гибридная установка (синхронизированная или федеративная модель удостоверений)**     |<ul><li>MFA для Microsoft 365 и Office 365</li><li>Модуль Azure MFA (интеграция с ADFS)</li><li>Физическая или виртуальная смарт-карта (интеграция с ADFS)</li></ul>         |Примечание. Дополнительные решения MFA доступны в [документах с совместимостью поставщика удостоверений Azure AD](https://www.microsoft.com/download/details.aspx?id=56843)         |
