...
Многофакторная проверка подлинности поддерживается в любом плане Office 365, в том числе в Microsoft Teams. Планы подписки Office 365 с Microsoft Teams указаны ниже в разделе "Лицензирование".
