...
Чтобы избежать недопустимых или ошибочных имен, а также предоставить более подробную структуру команд, вы можете использовать политику именования групп Microsoft 365 (в настоящее время в предварительной версии).
...
-   **Классификация** Вы можете создавать классификации, которые пользователи в вашей организации смогут настроить при создании группы Microsoft 365. 

> [!IMPORTANT]
> Использование политики именования групп Microsoft 365 требует наличия лицензий Azure Active Directory Premium P1 или лицензий Azure AD Basic для каждого уникального пользователя, который входит в одну или несколько групп Microsoft 365.
...
Если вы уверены, что хотите управлять тем, кто может создавать группы, ознакомьтесь со сведениями в разделе [Управление пользователями, которые могут создавать группы Microsoft 365](https://support.office.com/article/manage-who-can-create-office-365-groups-4c46c8cb-17d0-44b5-9776-005fced8e618).
...
-   School Data Sync может создавать группы Microsoft 365 для Exchange Online и SharePoint Online, классы Teams для Microsoft Teams и OneNote для занятий, учебные группы для Skype для образовательных учреждений, а также службы для интеграции с единым входом и единого входа (SSO) для многих других приложений сторонних разработчиков. Дополнительные сведения [о School Data Sync](https://docs.microsoft.com/schooldatasync/overview-of-school-data-sync).
...
> [!IMPORTANT]
> Для использования политики срока действия Microsoft 365 групп требуется лицензия Azure Active Directory Premium P1 для каждого уникального пользователя, который входит в одну или несколько групп Microsoft 365.
...
-   Включение и отключение гостевого доступа для определенных групп и команд Microsoft 365 для управления тем, какие команды могут приглашать гостей.
-   С помощью журнала аудита можно узнать, какие оповещения были отправлены приглашенным гостям.

Дополнительные сведения можно найти [в разделе гостевой доступ в группах Microsoft 365](https://support.office.com/article/Guest-access-in-Office-365-Groups-bfc7a840-868f-4fd6-a390-f347bf51aff6#PickTab=Manage).
