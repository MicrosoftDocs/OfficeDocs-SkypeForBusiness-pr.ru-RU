...
-   **Политика именования префиксных суффиксов** Вы можете использовать префиксы или суффиксы для определения соглашения об именовании групп (групп), например **Грп_ус_ми грауп_енгиниринг**. Префиксы и суффиксы могут быть фиксированными строками или атрибутами пользователя (например, **[подразделение]**), добавленными к имени на основе пользователя, который создает команду.
