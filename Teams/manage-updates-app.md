...
Обновления в приложении Microsoft Teams предоставляют участникам организации централизованное место для создания, проверки и отправки обновлений. Создавая шаблоны, вы можете использовать приложение "Обновления" для отслеживания всех потребностей организации. Обновления доступны как для настольных, так и для мобильных устройств.

В Teams пользователи могут получать обновления из магазина приложений Teams. Они будут видеть все обновления, которые необходимо отправить, на странице **отправки** .
...
Когда пользователю назначено обновление, оно будет отображаться в веб-канале действий Teams. Пользователи также могут просматривать все текущие запросы на обновление и предыдущие отправки в приложении "Обновления". Кроме того, любой пользователь может создавать шаблоны и отправлять запросы на обновление.
...
>[!Note]
>При удалении шаблона формы на сайте Microsoft Forms он накалит шаблон "Обновления", и пользователи не смогут отправить обновление. При попытке открыть шаблон, удаленный в Microsoft Forms, пользователи получают сообщение об ошибке "CDB TableNotFound".

## <a name="updates-teams-app-permissions"></a>Обновление разрешений приложения Teams
...
Приложение "Обновления" доступно по умолчанию. Вы можете отключить его в Центре администрирования Teams.
  ...
  3. Найдите приложение "Обновления".
     ...
     [![Снимок экрана: навигация в Центре администрирования с выделенным элементом "Приложения Teams > управление приложениями".](media/manage-updates-small.png)](media/manage-updates.png#lightbox)
...
## <a name="pin-updates-to-teams"></a>Закрепление обновлений в Teams
...
Данные, хранящиеся в Формах, не будут удалены, пока создатели шаблонов не  очистите их на вкладке "Удаленные формы" в веб-приложении Microsoft Forms.

## <a name="conditional-access-policies"></a>Политики условного доступа

В настоящее время приложение "Обновления" в Teams не поддерживает политики условного доступа, задаваемые для Microsoft Teams.
...
В приложении "Обновления Teams" пользователи имеют доступ для создания новых обновлений и просмотра отправленных и полученных обновлений. Пользователи не будут иметь доступ к обновлениям, созданным другими пользователями, если только они не являются средством просмотра запроса.
