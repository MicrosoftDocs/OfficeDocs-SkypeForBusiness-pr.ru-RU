...
> [!NOTE]
> Соединитель Power BI CQD поддерживает только DirectQuery в Power BI; Режим импорта не поддерживается. 
...
Если какие-либо из действий, описанных в этом процессе настройки, не были полностью очищены, более подробное описание процесса можно найти в [кратком руководстве: подключение к данным на рабочем столе Power BI](https://docs.microsoft.com/power-bi/desktop-quickstart-connect-to-data).
