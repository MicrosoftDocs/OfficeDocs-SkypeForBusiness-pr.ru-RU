...
### <a name="why-does-the-connector-seem-so-slow-compared-to-advanced-cqd-in-the-browser-what-can-i-do-to-improve-performance"></a>Почему соединительная линия кажется медленной по сравнению с расширенными CQD в браузере? Что можно сделать, чтобы улучшить производительность?
