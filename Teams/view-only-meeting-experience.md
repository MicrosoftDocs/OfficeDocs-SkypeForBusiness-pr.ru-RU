...
- Для участников, присоединившихся в режиме только для просмотра, поддерживаются следующие режимы вестибюля: "только вы", "Сотрудники моей организации и гости", "Сотрудники моей организации и доверенных организаций, а также гости" и "Все". Если вы используете политику вестибюля, которая не поддерживает режим только для просмотра, участники, присоединившиеся в режиме, не будут допускаться на собрание. 
