...
Участники, которые первыми присоединяются к собранию (до его основного), получают полный Teams собрания. Они могут делиться звуком и видео, просматривать демонстрируемые видео и участвовать в чате собрания.
...
Вы включаете только просмотр с помощью командлета из модуля [`Set-CsTeamsMeetingPolicy`](/powershell/module/skype/set-csteamsmeetingpolicy?view=skype-ps) [SkypeForBusiness PowerShell](/powershell/module/skype/?view=skype-ps) или по крайней мере версии 2.0.0 модуля [MicrosoftTeams.](https://www.powershellgallery.com/packages/MicrosoftTeams)
...
В будущем вы сможете включить или отключить интерфейс только для просмотра в Центре Teams администрирования.
...
- Присоединяйтесь к комнате, которая будет только Комнаты Microsoft Teams или используя службы Cloud Video Interop (CVI).
...
- См. PowerPoint файлов, доступ к которые используется с помощью PowerPoint Live или отдельных общих приложений (кроме общего доступа к рабочему столу или экрану).
