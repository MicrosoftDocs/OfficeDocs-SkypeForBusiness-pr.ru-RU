...
> [!Note]
> Если ваше собрание проходит в Teams масштаб будет полностью масштабироваться, чтобы вместить только 10 000 человек для просмотра в широковещательном режиме. Кроме того, сейчас, когда возрос объем удаленной работы, вы можете воспользоваться трансляциями для 20 000 человек до конца этого года. Вебинары в настоящее время не поддерживают широковещательный просмотр.
...
Участники, которые первыми присоединяются к собранию (в том объеме, что и основное собрание), получают полную Teams собрания. Они могут делиться звуком и видео, просматривать демонстрируемые видео и участвовать в чате собрания.

Участникам, присоединившимся после достижения предельной вместимости собрания, будет доступен режим только для просмотра.

Участники смогут присоединиться к представлению только через рабочий стол, интернет и мобильные Teams (Android и iOS).
