...
> [!Note]
> Если ваше собрание или вебинар достигает ограничения по вместимости, Teams легко масштабируется для поддержки режима трансляции только для просмотра на 10 000 пользователей. Кроме того, за это время увеличения удаленной работы воспользуйтесь еще большими 20 000 человек трансляций до 30 июня 2023 года. Вебинары в настоящее время не поддерживают трансляцию в режиме только для просмотра.

> [!Note]
> Собрание Teams не является трансляцией Teams (TLE) и не будет использовать eCDN Майкрософт. Дополнительные сведения см. в разделе [Контрольный список подключения eCDN Майкрософт](/ecdn/integration/onboarding-checklist-for-tle-customers).
...
Включить режим только для просмотра можно с помощью командлета [`Set-CsTeamsMeetingPolicy`](/powershell/module/skype/set-csteamsmeetingpolicy) из модуля [SkypeForBusiness PowerShell](/powershell/module/skype/) или модуля [MicrosoftTeams](https://www.powershellgallery.com/packages/MicrosoftTeams) версии не ниже 2.0.0.
...
- Участники, доступные только для просмотра, поддерживаются только следующими политиками лобби: "Люди в моей организации", "Люди в моей организации и гостями", "Люди в моей организации, доверенных организациях и гостях" и "Все". Если вы используете политику вестибюля, которая не поддерживает режим только для просмотра, участники, присоединившиеся в режиме, не будут допускаться на собрание. 
