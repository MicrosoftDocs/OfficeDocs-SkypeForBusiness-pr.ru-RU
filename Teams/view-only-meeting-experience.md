...
> [!Note]
> Собрание Teams не является трансляцией Teams (TLE) и не использует Майкрософт eCDN. Дополнительные сведения см[. в разделе Майкрософт контрольный список подключения eCDN](/ecdn/integration/onboarding-checklist-for-tle-customers).
