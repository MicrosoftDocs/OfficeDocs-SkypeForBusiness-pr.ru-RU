...
> [!Note]
> В настоящее время предельное количество полностью интерактивных пользователей —300 в WW и 250 в GCC, GCC High и DoD.
...
- Участники, которые будут использовать только просмотр, не могут минуть "вести". Например, если организатор собрания выбирает, что в  "вестибюле" будут участвовать только люди из моей организации, а участник за пределами организации пытается присоединиться в качестве участника, только для просмотра, он будет отклонен.

Когда будет достигнуто количество участников основного собрания, организатор и один из его участников увидят баннер, сообщающий о том, что новые участники будут присоединяться только для просмотра.
...
Если установлены роли одного из участников и он пытается присоединиться к собранию после того, как основное собрание достигло максимальной мощности, он присоединяется к собранию только для просмотра и имеет те же ограничения, что и другие участники, только для просмотра. Поддержка, при этом все ли они присоединятся к основному собранию, будет разорена позднее. Организатору всегда будет гарантировано место в главном собрании.
...
- См. файлы PowerPoint, к которые совместно используется функция PowerPoint Live или отдельные общие папки приложений (кроме общего доступа к рабочему столу или экрану).
