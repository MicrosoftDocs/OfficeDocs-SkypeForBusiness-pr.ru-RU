...
Microsoft Teams позволяет присоединить к собранию Teams до 10 000 участников. После того как будет достигнуто количество участников основного собрания (когда к собранию присоединяется 300 пользователей), к собранию будут присоединяться дополнительные участники с доступом только для просмотра.
...
Участники смогут присоединиться к представлению с помощью рабочего стола, браузера и Teams Mobile (Android и iOS).
...
Отключить только просмотр можно с помощью PowerShell.
