...
description: Узнайте о журналах отладки, мультимедиа и настольных компьютеров, которые были Microsoft Teams, где их можно найти и как они помогают мониторингу и устранению неполадок.
appliesto:
- Microsoft Teams
