...
description: Узнайте о журналах отладки, мультимедиа и рабочего стола, относяхся к Microsoft Teams, где их можно найти и как они могут помочь в мониторинге и устранении неполадок.
appliesto:
- Microsoft Teams
...
- Сочетания клавиш: <kbd>CTRLAltShift1</kbd> + <kbd></kbd> + <kbd></kbd> + <kbd></kbd>  
...
По умолчанию ведение журнала мультимедиа отключено. Чтобы журнал диагностических данных Teams собраниях, пользователи должны включить параметр в Teams клиента. Перейдите **в Параметры** >  **General**, выберите включить ведение журнала для диагностики собрания **(** требуется перезапуск Teams), перезапустите Teams и воспроизводите проблему. 
