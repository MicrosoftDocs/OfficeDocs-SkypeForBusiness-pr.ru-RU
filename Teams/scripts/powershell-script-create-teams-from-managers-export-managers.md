...
ms.service: msteams
audience: admin
description: Используйте этот сценарий PowerShell, чтобы экспортировать список руководителей и их руководителей для вашей организации, чтобы подготовиться к созданию команды для каждого руководителя со своими прямыми участниками.
f1.keywords:
- NOCSH
...
Используйте этот сценарий PowerShell, чтобы экспортировать список руководителей и их руководителей для организации при подготовке к созданию группы менеджеров людей для каждого руководителя с их прямыми участниками.
