...
> [!IMPORTANT]
> При назначении политик группам важно [](../assign-policies-users-and-groups.md#precedence-rules) понимать правила приоритета [](../assign-policies-users-and-groups.md#group-assignment-ranking) и ранжирование назначений групп. Убедитесь, что вы читаете и понимаете основные понятия, которые необходимо знать о назначении [политик группам](../assign-policies-users-and-groups.md#what-you-need-to-know-about-policy-assignment-to-groups).
