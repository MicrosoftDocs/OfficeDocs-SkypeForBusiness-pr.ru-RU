...
ms.service: msteams
audience: admin
description: Используйте этот сценарий PowerShell для создания групп безопасности, необходимых для управления политиками безопасности Teams для преподавателей и учащихся в вашем учебном за заведениях.
f1.keywords:
- NOCSH
