...
Вы можете управлять тем, кто может загружать пользовательские приложения Teams с помощью **настраиваемой политики приложений.** [Настраиваемые параметры и политики](teams-custom-app-policies-and-settings.md) приложений настраиваются через центр Microsoft Teams администрирования.
