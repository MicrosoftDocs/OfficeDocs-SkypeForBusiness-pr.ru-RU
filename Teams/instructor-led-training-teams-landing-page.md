...
layout: HubPage
hide_bc: true
title: Тренинг под руководством инструктора и видео для пользователей Microsoft Teams
ms.reviewer: ''
manager: serdars
description: Оформите регистрацию на занятия под руководством инструктора, чтобы узнать все подробности работы с Microsoft Teams.
...
<div id="main" class="v2">
    <div class="container">
        ...
        <ul class="pivots">
            <li>
                <a href="#tab1">Тренинг с инструктором</a>
                <ul id="tab1">
                    <li>
                        <a href="#tab1-all"></a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>#ThisIsTeams — Обзор Microsoft Teams</h3>
                                                    <p>Что такое Microsoft Teams? Ознакомьтесь с этим ознакомительным 30-минутным курсом, чтобы понять, что такое Teams, и как этот сервис может быть вам полезен. (Аудитория: все)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Начало работы с Teams</h3>
                                                    <p>Начиная с чатов и собраний и заканчивая группами и каналами, в ходе этого учебного занятия пользователи получат основные знания, необходимые для уверенной работы с Teams. (Аудитория: конечные пользователи)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>Получите представление о нетривиальных способах оптимизации и организации повседневной работы в Teams. (Аудитория: конечные пользователи)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Организация перехода со Skype для бизнеса на Teams</h3>
                                                <p>Планирование и реализация успешного перехода на Teams (Аудитория: ИТ-специалисты, менеджеры по внедрению изменений)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Переход со Skype для бизнеса на Teams: рекомендации для конечного пользователя</h3>
                                                    <p>Получите всю необходимую информацию для быстрого начала работы с Teams во время перехода со Skype для бизнеса на Teams. (Аудитория: конечные пользователи)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>Сведения об использовании Teams в высшем образовании. (Аудитория: преподаватели, учащиеся, исследовательские факультеты, ИТ-специалисты)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Оптимизация собраний в Teams</h3>
                                                <p>Узнайте, как эффективно использовать Teams до собраний, во время собраний и после собраний. (Аудитория: конечные пользователи)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>Сведения о новых возможности в Teams для сотрудников без компьютера. (Аудитория: конечные пользователи)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Обзор Teams для государственных организаций США (GCC)</h3>
                                                <p>Присоединяйтесь к интерактивному обзору Teams в Office 365 GCC, в котором демонстрируются рекомендации по совместной работе. (Аудитория: ИТ-специалисты, конечные пользователи)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
