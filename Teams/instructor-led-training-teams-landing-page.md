...
ms.locfileid: "43062678"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Тренинг под руководством инструктора по Microsoft Teams</h1>
Размещенные на серверах Майкрософт бесплатные, интерактивные учебные занятия предназначены для подготовки к работе с Teams.Если вы являетесь лицом, принимающим решения в бизнесе, администратором, ИТ-специалистом или конечным пользователем, вы найдете занятия, которые вам подойдут. Не знаете, с чего начать? Пройдите нашу <a href="https://aka.ms/TeamsKnowledgeCheck">проверку знаний по Teams</a>. Присоединяйтесь к нам, чтобы увидеть Teams в действии, получить ответы на вопросы и взаимодействовать с нашими преподавателями в режиме реального времени. Чтобы просматривать наши учебные занятия в своем ритме, ознакомьтесь с <a href="https://aka.ms/TeamsOnDemand">обучением конечных пользователей по запросу</a>.<br><br>Выберите учебное занятие, чтобы зарегистрироваться.
        <ul class="pivots">
            <li>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Что такое Microsoft Teams? Ознакомьтесь с этим 30-минутным обзорным курсом, чтобы открыть для себя приложение Teams и его возможности в действии.</p>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Начиная с чатов и собраний и заканчивая группами и каналами, в ходе этого учебного занятия пользователи получат основные знания, необходимые для уверенной работы с Teams.</p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Проведение эффективных собраний в Teams</h3>
                        <p>Узнайте, как эффективно использовать Teams до собраний, во время собраний и после собраний.</p>
                        <p><i>Аудитория: конечные пользователи</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Обзор команд и каналов в Teams</h3>
                        <p>Узнайте, как упростить совместную работу над проектами и в группах.</p>
                        <p><i>Аудитория: конечные пользователи</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Расширенные возможности Teams</h3>
                        <p>Получите представление о нетривиальных способах оптимизации и организации повседневной работы в Teams.</p>
                        <p><i>Аудитория: конечные пользователи</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Освойте работу с Teams из дома</h3>
                        <p><strong><font color="#4B53BC">НОВИНКА!</font></strong> Узнайте о том, как поддерживать связь с командой и сохранять производительность.</p>
                        <p><i>Аудитория: пользователи, руководители групп и подразделений</i></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Семинары по планированию перехода</h3>
                        <p>Планируйте и выполняйте успешный переход на Teams</p>
                        <p><i>Аудитория: ИТ-специалисты, руководители по внедрению изменений</i></p>
                    </div>
                </div>
            </div>
        </div>
