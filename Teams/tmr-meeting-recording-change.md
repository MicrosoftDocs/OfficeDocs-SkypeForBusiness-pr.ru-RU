...
|Групповой звонок                                 |Любой участник звонка |Пользователь, который прощелкаю учетной записи OneDrive для бизнеса в записи  |-Участник, который выбрал запись, обладает полными правами — у других участников этого клиента есть права на чтение — другие пользователи из другого клиента не имеют никаких прав на доступ к нему.|
