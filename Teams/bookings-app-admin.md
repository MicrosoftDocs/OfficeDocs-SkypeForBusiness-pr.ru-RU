---
title: Управление приложением Bookings в Майкрософт Teams
author: LanaChin
...
ms.locfileid: "69307524"
---
# <a name="manage-the-bookings-app-in-microsoft-teams"></a>Управление приложением Bookings в Майкрософт Teams

Приложение Bookings в Майкрософт Teams предлагает простой способ планировать очно и виртуальные встречи. Например, посещения здравоохранения, финансовые консультации, собеседования, поддержка клиентов и учебные часы. Дополнительные сведения см. в [разделе Виртуальные встречи с Teams и приложением Bookings](/microsoft-365/frontline/bookings-virtual-appointments).
...
Чтобы настроить этот параметр, перейдите в Центр администрирования Microsoft 365 \> **Параметры** \> **параметров организации**, а затем выберите **Bookings**. Установите или снимите **флажок Разрешить Майкрософт отправлять sms-уведомления**.
