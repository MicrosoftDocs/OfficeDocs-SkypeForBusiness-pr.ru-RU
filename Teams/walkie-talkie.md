...
## <a name="get-insight-into-walkie-talkie-usage-and-performance"></a>Получение аналитических сведений об использовании и производительности Walkie Talkie

[Отчет об использовании и производительности Walkie Talkie](teams-analytics-and-reports/walkie-talkie-usage-report.md) в Центре администрирования Teams содержит общие сведения о действиях и производительности Walkie Talkie в вашей организации. В отчете содержатся такие сведения, как количество выполненных и полученных передач PTT, активность канала, длительность передачи, а также сведения об устройстве и участниках.
