...
На панели **Добавить закрепленные приложения** справа поищите приложение "Рация" в текстовом поле **Поиск**. Если вы используете его в качестве результата поиска, нажмите кнопку **"Добавить** " справа от имени, чтобы добавить ее в список.
