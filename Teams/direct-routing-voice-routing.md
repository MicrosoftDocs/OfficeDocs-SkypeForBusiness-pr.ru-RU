...
1. В левой области навигации центра администрирования Microsoft Teams перейдите в раздел**переадресация** **голосовых сообщений** > , а затем в правом верхнем углу выберите **Управление записями использование PSTN**.
...
1. В левой области навигации центра администрирования Microsoft Teams перейдите в раздел**переадресация** **голосовых сообщений** > , а затем откройте вкладку **Голосовые маршруты** .
...
1. В левой области навигации центра администрирования Microsoft Teams перейдите в раздел политики маршрутизации **голосовой** > **голосовой связи**и нажмите кнопку **Добавить**.
...
В следующем примере показан результат выполнения команды `(Get-CSOnlinePSTNUsage).usage` PowerShell для отображения полных имен (не усеченных):
...
Убедитесь, что маршрут настроен правильно, выполнив команду `Get-CSOnlineVoiceRoute` PowerShell, используя указанные ниже параметры.
