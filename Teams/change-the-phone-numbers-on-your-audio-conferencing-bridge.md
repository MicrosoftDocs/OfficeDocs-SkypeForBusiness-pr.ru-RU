...
> [!NOTE]
> Чтобы можно было назначить или отозначить номер телефона для моста услуг, номер телефонадолжен быть номером службы. Чтобы узнать тип номера, переведите его в Телефон голосовой Microsoft Teams центре администрирования и в столбце  >   **Тип** номера. Microsoft 365 или Office 365 кредиты на связь необходимо сначала настроить, чтобы пользователи набирали мост по бесплатному номеру.
...
1. В области навигации слева перейдите к Телефон  >  **голосовой Телефон голосовой почты.**
...
1. В области навигации слева  перейдите в меню Пользователи и щелкните отображаемую именем нужного пользователя в списке.
...
```
 ...
 Дополнительные сведения см. в настройках номеров [телефонов,](set-the-phone-numbers-included-on-invites-in-teams.md) включенных в приглашения в Microsoft Teams или Настройка номеров телефонов, включенных в приглашения в [Skype для бизнеса Online.](/SkypeForBusiness/audio-conferencing-in-office-365/set-the-phone-numbers-included-on-invites)
...
**Например,** чтобы отобрять, defaultServiceNumber "8005551234"
```PowerShell
