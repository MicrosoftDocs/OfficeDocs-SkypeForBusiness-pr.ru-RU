---
title: Изменение номеров телефонов Аудиоконференции моста
ms.author: heidip
...
3. На странице **"Правка** " в **разделе "Назначено**" разверните раскрывающийся список и выберите " **Применить мост конференций** > **"**.
...
1. В области навигации слева перейдите к мостам **конференций собраний** > .
