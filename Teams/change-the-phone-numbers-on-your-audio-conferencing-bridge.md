...
> [!NOTE]
> Чтобы назначить или отменить назначение номера телефона для моста конференц-связи, номер телефона должен быть номером*услуги*. Тип номера можно узнать, перейдя на номера **голосовых** > **телефонов** на портале Legacy и просматривая столбец **тип номера** . Необходимо вначале настроить кредиты на связь Office 365, для того, чтобы пользователи, во время общения по мосту, могли звонить на бесплатный номер.
...
2. Перейдите в**Voice** > раздел**центры** > администрирования > центра >  **администрирования Microsoft 365****Teams &** > **номера телефонов**Skype**Legacy Portal**.
...
2. Перейдите в раздел**центры** >  > администрирования **центра администрирования Microsoft 365****Teams &** > мосты Skype для**собраний** > по**конференциям**.
...
4. Если номер телефона — платный номер fre, нажмите кнопку **Да** в окне подтверждения.
...
Если вы хотите получить дополнительные сведения о запуске Windows PowerShell, ознакомьтесь со статьей [подключение ко всем службам Office 365 в одном окне Windows PowerShell](https://technet.microsoft.com/library/dn568015.aspx) или [Подключение к Skype для бизнеса Online с помощью Windows PowerShell](https://technet.microsoft.com/library/dn362795%28v=ocs.15%29.aspx).
...
**Кнопка отмены назначения затенена**
...
С помощью Windows PowerShell вы можете управлять пользователями и тем, что им можно и что нельзя делать. Windows PowerShell помогает управлять набором Office 365 и Skype для бизнеса Online с помощью одной точки администрирования, которая упрощает повседневную работу, особенно если у вас есть несколько задач. Чтобы начать работу с Windows PowerShell, ознакомьтесь с приведенными ниже разделами.
