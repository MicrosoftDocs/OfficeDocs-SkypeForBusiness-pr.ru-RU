...
При покупке лицензий **Аудиоконференций** корпорации Майкрософт размещается вашей звукового конференц-канала для вашей организации. Мост аудиоконференций предоставляет телефонные номера телефонов в разных местах, чтобы Организаторы собраний и участники могут использовать их для присоединения к Скайп для бизнеса или группами Майкрософт собраний с помощью телефона.
  
В дополнение к телефонных номеров, назначенной конференц-канал, можно [получить дополнительные службы номеров](/SkypeForBusiness/what-is-phone-system-in-office-365/getting-service-phone-numbers) (международную и обслуживание бесплатных номеров, используемый для аудиоконференций) из других расположениях и затем их для конференц-связи мост так, чтобы присвоить Разверните узел покрытия для пользователей.
  
> [!NOTE]
> Должны иметь возможность отменить роли и назначить номер телефона для конференц-канал, номер телефона должен быть номер «*службы*». Можно просмотреть тип номера — по **голосовой связи** > **телефонных номеров** в устаревший портала и оформленные в столбце **Тип "число"** . Необходимо вначале настроить кредиты на связь Office 365, для того, чтобы пользователи, во время общения по мосту, могли звонить на бесплатный номер.
...
Only a service toll number can be set as the default number for your conferencing bridge; **service toll-free numbers can't be set as the default number of your conferencing bridge**. Если вы хотите назначить новый номер по умолчанию для звукового конференц-канала при назначении бесплатный номер службы, выполните следующие действия:

1. Войдите в Office 365 со своей рабочей учетной записью.

2. Перейдите в **Центр администрирования Office 365** > **центры администрирования** > **группами & Скайп** > **собраний** > **Мостов конференции**.

3. Выделите номер счета службы, который необходимо настроить значения по умолчанию.
...
После отмены назначения номера телефона мосту конференц-связи пользователи не смогут присоединяться к собраниям с его помощью. Так как изменение номера телефона, важно для обновления всех пользователей, которые могут иметь номер телефона как их номер по умолчанию (при его наличии) и обновить их существующие приглашения на собрания перед номером телефона неназначенных из моста аудиоконференций.

Если номер телефона удаляется без обновления пользователей и их собрания, их существующие приглашения на собрания может содержать номер телефона, который не работает для присоединения к собраниям их.
...
### <a name="step-1---update-users-who-have-the-phone-number-to-be-unassigned-as-one-of-their-default-numbers"></a>Шаг 1 — обновление пользователей, имеющих номер телефона для неназначенных как один из номеров их по умолчанию

Замените счета по умолчанию или телефоны для всех пользователей, имеющих номер неназначенных как номер по умолчанию и начать процесс изменения расписания свои собрания. Для этого выполните следующую команду:
