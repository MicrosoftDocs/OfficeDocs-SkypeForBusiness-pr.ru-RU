...
---
# <a name="get-started-on-your-upgrade-from-skype-for-business-to-microsoft-teams"></a>Начало обновления Skype для бизнеса до Microsoft Teams
...
| Значок | Описание |
| --- | --- |
|![Символ похотья](https://docs.microsoft.com/office/media/icons/walkthrough-map-teams.png) | **Центр обновления:** найдите обзор всех руководств, учебных и ресурсов, необходимых для успешного обновления Skype для бизнеса до Teams, на веб-сайте планирования обновления Skype для бизнеса до [Microsoft Teams.](upgrade-skype-teams.yml)|

Продолжайте читать часто задамые вопросы об обновлении.
...
Да. Телефонная система доступна всем пользователям Teams после того, как они перемещены в режим TeamsOnly.  Кроме того, корпорация Майкрософт предоставляет параметры подключения к телефонной сети общего звонков (ННР), чтобы пользователи могли звонить по всему миру. Дополнительные сведения см. в [сведениях о телефонной системе и подмносях "Телефонная система" и ОКП.](cloud-voice-landing-page.md)
...
Да. При прямой маршрутике телефонной системы вы можете использовать телефонную систему практически с любым оператором телефонии. При прямой маршрутике вы напрямую подключайте собственный пограничный контроллер сеанса (SBC) к телефонной системе. Дополнительные сведения см. в прямой [маршрутке телефонной системы.](direct-routing-landing-page.md)
 
## <a name="how-is-microsoft-helping-customers-with-their-migration-to-teams"></a>Как Майкрософт помогает клиентам с переходом на Teams? 
