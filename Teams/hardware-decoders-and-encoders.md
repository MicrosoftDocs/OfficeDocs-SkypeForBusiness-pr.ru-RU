...
## <a name="hardware-encoder-driver-recommendations---intel"></a>Рекомендации относительно драйвера кодира оборудования — Intel
...
## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Рекомендации по кододеревому оборудованию — Nvidia
...
## <a name="hardware-encoder-driver-recommendations---amd"></a>Рекомендации по драйверам кодиреа для оборудования — AMD
