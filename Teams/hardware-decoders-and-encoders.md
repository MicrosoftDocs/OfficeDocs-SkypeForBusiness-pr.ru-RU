...
## <a name="hardware-decoder-driver-recommendations---amd"></a>Рекомендации по оборудованию для драйвера декодирования оборудования — AMD
...
## <a name="hardware-encoder-driver-recommendations---intel"></a>Рекомендации по кододерему оборудованию — Intel
