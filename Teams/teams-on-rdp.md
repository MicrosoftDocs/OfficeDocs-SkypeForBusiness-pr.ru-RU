...
RDS обеспечивает гибкость развертывания, эффективность и разность. RDS можно развертывать различными средствами, включая Windows Server 2016 для локального развертывания, Microsoft Azure облачных развертывании и надежный набор партнерских решений.
