...
RDS обеспечивает гибкость развертывания, эффективность и разность. RDS можно развертывать различными средствами, включая Windows Server 2016 для локального развертывания, Microsoft Azure для облачных решений и надежный набор партнерских решений.
...
3. Сделайте следующее:
    ...
    а)  В **области Политика звонков** выберите **DisallowCalling (DisallowCalling**).
...
1. В левой области навигации центра администрирования Microsoft Teams перейдите к нужной политике. Например:
    ...
    - Перейдите к **политикам VoiceCalling** >  и выберите **DisallowCalling (DisallowCalling**).
    - Перейдите **к политике собраний** >  **и** выберите **AllOff**.
