...
<p>В следующей таблице содержатся ссылки на полное обучение с наборами PowerPoint (в формате PDF) на устройствах с Microsoft Teams Android, которые включают дисплеи Teams, Teams Телефоны, Комнаты Teams для Android и панели Teams.  
...
| Настройка Microsoft Teams для сотрудников без телефонии                           | Узнайте, как настроить и развернуть под себя Microsoft Teams среды для сотрудников без компьютеров.                                                                                                                  | [Руководство по Microsoft Teams для сотрудников без телефонии](https://aka.ms/ConfigFLWInteractiveGuide)              |
...
|Работа с Teams устройствами с Android|Узнайте, как управлять и обновлять Microsoft Teams телефоны, Microsoft Teams дисплеи, Комнаты Microsoft Teams и Microsoft Teams панели.|[Работа с Microsoft Teams устройствами Android](https://aka.ms/teamsandroiddeviceslab)|
