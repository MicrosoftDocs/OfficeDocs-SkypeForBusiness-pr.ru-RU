...
<p>В следующей таблице содержатся ссылки на полный учебный курс с наборами PowerPoint (в формате PDF) на устройствах с Microsoft Teams Android, которые включают дисплеи Teams, телефоны Teams, Комнаты Teams для Android и панели Teams.  
...
| Политики защиты от потери данных (DLP) для Microsoft Teams                     | Узнайте, как Microsoft Teams в существующую политику защиты от защиты от защите данных и как создать новую политику, основанную на шаблоне или полностью настраиваемой в зависимости от потребностей организации в защите данных.                        | [Teams Руководство по DLP](https://aka.ms/teamsdlpguide)         |
| Управление соответствием требованиям в Teams                                                | Используйте центры Microsoft 365 безопасности, Microsoft 365 соответствия требованиям и Microsoft Teams, а также Windows PowerShell для управления политиками и Office 365 политиками и настройками Microsoft Teams организации. | [Руководство по управлению соответствием требованиям Teams руководства](https://aka.ms/complianceinteamsinteractiveguide)      |
...
| Оптимизация Teams с помощью PowerShell и динамических групп        | Преобразуя Office 365 группу из статического в динамическое, используйте Windows PowerShell для назначения новой политики разрешений приложений всем участникам.                                                                         |  [Руководство по Teams администрирования](https://aka.ms/StreamliningTeamsadminInteractiveGuide) |
...
| Настройка Teams телефонная система: автоотвод & очереди вызовов                   | Пошаговая процедура создания и развертывания очереди звонков и автоответчивающего Microsoft Teams с помощью Microsoft Teams администрирования.                                                          |  [Настройка Teams телефонной системы](https://aka.ms/TeamsPhoneInteractiveGuide)             |
| Настройка прямой маршрутики: подключение КБК и маршруты голосовой связи                 | Используйте Microsoft Teams телефонная система Маршруты для интеграции с существующей инфраструктурой телефонии.                                                                                                              | [Настройка прямого руководства по маршрутике](https://aka.ms/DirectRoutingInteractiveGuide)          |
...
| Настройка аудиоконференции для Microsoft Teams                            | Узнайте о возможностях аудиоконференции в Teams, а также о назначении моста конференц-связи и номеров телефонов для телефонного звонка.                                                                                          |  [Настройка аудиоконференций для Microsoft Teams аудиоконференцию](https://aka.ms/AudioConferencingInteractiveGuide)      |
