...
|![кнопка воспроизведения видео.](/office/media/icons/video-play.png) |[Просмотр лучших методик и видео с поуча-висячай в кофе в канале Cloud на YouTube](https://www.youtube.com/channel/UCs2IXBqperxWVe2ozrr3Gdg/videos)     |![Человек с ключом](/office/media/icons/administrator.png) |[Teams Беседы с мелкими: изучите рекомендации и практические рекомендации по популярным Teams сценариям](./chalk-talks-landing-page.yml)         |
...
<p>В таблице ниже представлены ссылки на полное обучение: наборы PowerPoint (в формате PDF) на устройствах с Microsoft Teams Android, включающую дисплеи Teams, телефоны Teams, Комнаты Teams для Android и панели Teams.  
...
| Оптимизация Teams с помощью PowerShell и динамических групп        | Преобразуя Office 365 группу из статического в динамическое и используйте Windows PowerShell для назначения новой политики разрешений приложений всем участникам.                                                                         |  [Руководство по Teams администрирования](https://aka.ms/StreamliningTeamsadminInteractiveGuide) |
...
| Удостоверения для сотрудников, работающих на переднем телефоне: Уполномочь ИТ-специалистов, руководителей и сотрудников с frontline                    | Узнайте, как интегрировать Microsoft Teams с существующими системами управления персоналом, настроить упрощенное делегирование удостоверений, а также упростить вход и удобные переходы для пользователей общих устройств.                                                                                                                  | [Руководство по удостоверениям переднего сотрудника](https://aka.ms/FLWIdentityIG)              |
...
|Работа с Teams устройствами Android|Узнайте, как управлять и обновлять Microsoft Teams телефоны, Microsoft Teams дисплеи, Комнаты Microsoft Teams и Microsoft Teams панели.|[Работа с Microsoft Teams устройствами с Android](https://aka.ms/teamsandroiddeviceslab)|
