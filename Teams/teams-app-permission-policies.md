...
Если вы хотите управлять приложениями, доступными для разных групп пользователей в организации, создайте и назначьте одну или несколько настраиваемой политики разрешений для приложений. Вы можете создавать и назначать отдельные настраиваемые политики в зависимости от того, опубликованы ли приложения корпорацией Майкрософт, сторонними лицами или вашей организацией. Важно знать, что после создания настраиваемой политики ее нельзя изменить, если сторонние приложения отключены в параметрах приложения для всей организации.
...
4. В **приложениях Майкрософт,** **сторонних приложениях** **и** пользовательских приложениях выберите одно из следующих вариантов:
...
- Выполнение действий с кнопками, которые отправляют сведения обратно в приложение, например сообщения с действиями  
...
Для политик разрешений приложений, которые назначены определенным пользователям, если приложение с ботом или соединитетелем было разрешено, а затем заблокировано и если это разрешено только для некоторых пользователей в общем контексте, участники группового чата или канала, у кого нет разрешения на это приложение, могут видеть историю сообщений, опубликованную ботом или соединитетелем. , но не можете взаимодействовать с ним.
