...
При развертывании Teams в Microsoft 365 для государственных целей (GCC) важно знать о параметрах сторонних приложений, которые являются уникальными для GCC.
