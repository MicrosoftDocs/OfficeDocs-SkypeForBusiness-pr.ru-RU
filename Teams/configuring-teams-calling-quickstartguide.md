...
Чтобы управлять тем, будут ли входящие звонки (и чаты) в Teams или Skype для бизнеса перенаправлены, администраторы используют TeamsUpgradePolicy, используя центр администрирования [Microsoft Teams](https://aka.ms/teamsadmincenter) или удаленный Windows PowerShell с командлетами [Skype](https://docs.microsoft.com/powershell/module/skype) для бизнеса.
