...
> [!NOTE]
> Мы рекомендуем параллельно с этим кратким руководством [](calling-plan-landing-page.md) ознакомиться с телефонная система [](https://aka.ms/cloudvoice) с планами звонков и FastTrack, чтобы спланировать и успешно провести его.
...
> [!NOTE]
> В настоящее время голосовая почта недоступна на вкладке Звонки, если пользователь не включен для звонков по ЗВОНКОВ по ННР. 
