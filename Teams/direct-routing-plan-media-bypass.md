...
Обход мультимедиа поддерживается всеми автономными клиентами рабочих групп, клиентами Android и iOS и телефонными устройствами Teams. 

Для всех остальных конечных точек, в которых не поддерживается обход мультимедиа, вызов будет преобразован в необходный номер даже в том случае, если он был запущен как обходной вызов. Это происходит автоматически и не требует каких – либо действий от администратора. Сюда входят телефоны Skype для бизнеса 3PIP и веб-клиенты Teams, которые поддерживают прямую маршрутизацию (клиенты на основе WebRTC, работающие в Microsoft EDGE, Google Chrome, Mozilla Firefox). 
