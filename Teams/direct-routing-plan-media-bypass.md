...
Мультимедийные процессоры всегда находятся в пути для голосовых приложений и веб-клеинтс (для ексампе, Teams клеинт в EDGE или Google Chrome). Требования те же, что и для конфигурации без обхода.
...
Примечание для вебклеинтс (Teams Web App в Microsoft EDGE, Google Chrome или Mozilla Firefox) мы будем переадресовать звонок на не обойти, даже если он не был запущен как звонок для обхода. Это происходит автоматически и не требует каких – либо действий с администратором. 
