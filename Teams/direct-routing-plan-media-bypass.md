...
- Прокси-сервер SIP — это компонент, который преобразует сигнальную сигнальную Teams HTTP REST в SIP.    
...
### <a name="use-of-teams-media-processors-if-trunk-is-configured-for-media-bypass"></a>Использование процессоров Teams мультимедиа, если в канале настроен обход мультимедиа
...
Необходимо открыть порты для всех этих IP-адресов в брандмауэре, чтобы разрешить входящий и исходяющий трафик до и с адресов для сигнального трафика.  Если брандмауэр поддерживает имена DNS, имя FQDN sip.pstnhub.dod.teams.microsoft.us на все эти IP-адреса. 
...
Необходимо открыть порты для всех этих IP-адресов в брандмауэре, чтобы разрешить входящий и исходяющий трафик до и с адресов для сигнального трафика.  Если брандмауэр поддерживает имена DNS, имя FQDN sip.pstnhub.gov.teams.microsoft.us на все эти IP-адреса. 
