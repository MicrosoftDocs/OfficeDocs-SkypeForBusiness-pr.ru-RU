...
Обход мультимедиа поддерживается всеми конечными точками Teams.

Примечание для веб-клиентов (Teams Web App в Microsoft EDGE, Google Chrome или Mozilla Firefox) мы будем переключаться на вызов без обобщения даже в том случае, если он был запущен как обходной вызов. Это происходит автоматически и не требует каких – либо действий от администратора. 
