...
Чтобы разрешить входящий и исходяющий трафик с адресов для сигнального трафика, необходимо открыть в брандмауэре порты для всех этих диапазонов IP-адресов.  Если брандмауэр поддерживает имена DNS, имя FQDN sip.pstnhub.dod.teams.microsoft.us для всех этих IP-подсетей. 
...
Чтобы разрешить входящий и исходяющий трафик с адресов для сигнального трафика, необходимо открыть в брандмауэре порты для всех этих диапазонов IP-адресов.  Если брандмауэр поддерживает имена DNS, доменные имена sip.pstnhub.gov.teams.microsoft.us ко всем этим IP-подсетям. 
...
Процессоры мультимедиа всегда находятся в пути мультимедиа для голосовых приложений и веб-клиентов (например, Teams в Edge или Google Chrome). Требования одинаковы для настройки без обхода.
