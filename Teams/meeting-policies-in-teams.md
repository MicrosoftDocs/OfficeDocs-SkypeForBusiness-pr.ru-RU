...
|**BlurandDefaultBackgrounds**     |У пользователя есть возможность размытия фона видео или выбора изображений для использования в качестве фона. |
|**AllFilters**     |С помощью этого параметра можно размытие фона видео, выбор из набора изображений или Отправка настраиваемых изображений для использования в качестве фона. |
