...
Это политика для каждого пользователя, которая применяется до начала собрания. Этот параметр определяет, могут ли пользователи запланировать собрание в канале Teams.  Если вы отключите этот параметр, то при запуске собрания в канале Teams и выборе **канала** для пользователей в Teams команда " **запланировать собрание** " будет недоступна пользователю.
...
- [Включение субтитров Live (Предварительная версия)](#enable-live-captions-preview)
...
### <a name="enable-live-captions-preview"></a>Включение субтитров Live (Предварительная версия)
...
|---------|---------|
|**Отключено, и пользователь может переопределить**     | Субтитры Live не включаются автоматически во время собрания. Пользователь видит параметр **включить живые субтитры** в меню переполнения (**..**.), чтобы включить их. Это настройка по умолчанию. |
