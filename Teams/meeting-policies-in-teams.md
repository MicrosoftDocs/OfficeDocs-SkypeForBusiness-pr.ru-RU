...
> [!NOTE]
> Эта функция пока находится в процессе разработки. Политика демонстрации экрана настраивается для каждого участника, но на нее могут влиять параметры демонстрации экрана организатора, как описано в этом разделе.
...
|**Люди в моей организации, доверенные организации и гости**     |Пользователи организации, прошедшие проверку подлинности, включая гостевых пользователей и пользователей из доверенных организаций, присоединяются к собранию напрямую, без помещения в "зал ожидания".   |
|**Люди в моей организации и гости**    |Пользователи в пределах организации, прошедшие проверку подлинности, включая гостевых пользователей, присоединяются к собранию напрямую, без помещения в "зал ожидания". Пользователи из доверенных организаций, а также анонимные пользователи помещаются в "зал ожидания". Этот параметр установлен по умолчанию.           |
...
|**Люди в моей организации**  |Пользователи в пределах организации, прошедшие проверку подлинности, за исключением гостевых пользователей, присоединяются к собранию напрямую, без помещения в "зал ожидания". Гости и пользователи из доверенных организаций, а также анонимные пользователи помещаются в "зал ожидания".|
...
Этот параметр настраивается для каждого участника и определяет, разрешен ли чат собрания во время собрания этого пользователя.
