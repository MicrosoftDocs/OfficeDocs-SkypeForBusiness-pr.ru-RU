...
**Примечание** Если вы присоединяетесь к собранию и помещаете его в зал "ложь", пользователь организации должен присоединиться к собранию с клиентом Teams, чтобы присвоить ему имя из lobbby. У пользователей нет доступных для вас элементов управления "зал ожидания". 
 ...
 **Примечание** В параметрах собрания задана метка "кто может обходить" зал ожидания "
