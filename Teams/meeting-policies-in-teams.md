...
[![Снимок экрана: параметр "Календарь" для выбора канала, на который вы хотите запланировать собрание. ](media/meeting-policies-select-a-channel-to-meet-in.png)](media/meeting-policies-select-a-channel-to-meet-in.png#lightbox)
...
- Кнопка " **запланировать собрание** " в поле "создание ответа канала".
  ![Снимок экрана: параметр "Календарь" для выбора канала, на который вы хотите запланировать собрание.](media/schedule-meeting-disabled-in-chat2.png)
  
- Кнопка " **запланировать собрание** " в заголовке канала.
  ![Снимок экрана: параметр "Календарь" для выбора канала, на который вы хотите запланировать собрание.](media/schedule-now-in-header.png)

В календаре канала сделайте следующее:

- Кнопка **Добавить новое событие** в заголовке календаря канала будет отключена.
  ![Снимок экрана: параметр "Календарь" для выбора канала, на который вы хотите запланировать собрание.](media/add-new-event-disabled.png)

- Чтобы создать собрание по каналу, пользователи не смогут перетаскивать и выбирать блок времени в календаре каналов.
...
![Снимок экрана, на котором показана политика разрешений приложений в центре администрирования Teams.](media/manage-microsoft-apps-policy.png)
...
Это политика для каждого пользователя, которая применяется до начала собрания. Этот параметр определяет, может ли пользователь запустить прямое личное собрание.  По умолчанию этот параметр включен.
