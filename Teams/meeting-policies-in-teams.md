...
Это политика для пользователя. Этот параметр определяет, может ли пользователь демонстрировать доску на собрании. Внешние участники, включая анонимных, гостевых и внешних пользователей, наследуют политику организатора собрания.
...
|---------|---------|
|**Все**   |Все участники собрания присоединяются к собранию напрямую, без помещения в "зал ожидания". К ним относятся прошедшие проверку подлинности пользователи, пользователи внешнего доступа, гости и анонимные пользователи.     |
