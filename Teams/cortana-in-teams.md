...
В этом примере показано обновление существующей политики с использованием имен &#8220;EmployeeCortanaPolicy&#8221; и включение Кортана голосовой помощи в Microsoft Teams с помощью push-кнопки вызова. Пользователи смогут вызвать Кортана, нажатием кнопки Кортана микрофона в Teams. Выключить слово (&#8220;отключена Кортана&#8221; или &#8220;Кортана&#8221;)  
...
- касаясь микрофона, который называется Кортана _push-кнопкой для разговора_
