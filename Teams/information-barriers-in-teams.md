...
В Microsoft Teams информационные барьеры могут определять и предотвращать несанкционированные совместные работы следующих типов:
...
- **Владелец Модер (предварительная версия):** этот режим устанавливается для команды, если вы хотите разрешить совместную работу между пользователями несовместимых сегментов, которые модерировать владелец. Владелец группы может добавлять новых участников в свою политику IB.
