...
Кнопка "Собрание Teams" отображается на ленте Outlook для Mac при использовании Outlook производственной сборки 16.24.414.0 или более поздней.
...
Если ваш администратор настроил Microsoft Exchange для [управления доступом к Exchange Web Server (EWS)](https://docs.microsoft.com/ru-RU/exchange/client-developer/exchange-web-services/how-to-control-access-to-ews-in-exchange), представитель не сможет запланировать собрание Teams от имени руководителя. Решение для этой конфигурации находится в процессе разработки и будет выпущено в будущем. 
