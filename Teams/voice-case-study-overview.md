...
- Маршрутизация на основе расположения 
  ...
  Благодаря расположениям офисов в странах, где есть телефонная телефония, contoso требовалось воссоздать Location-Based маршруты, которые были Skype для бизнеса в телефонная система развертывания. Дополнительные сведения см. в примере [с contoso: Location-Based маршруты.](voice-case-study-location-based-routing.md)
