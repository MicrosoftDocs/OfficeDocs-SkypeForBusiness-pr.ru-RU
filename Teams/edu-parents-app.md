...
Приложение "Родители" по умолчанию отключено, поэтому владельцы команд класса не будут видеть его в своих командах класса, пока приложение не будет разрешено через Teams администрирования. Приложение можно разрешить через Центр администрирования Teams с помощью разрешить приложения[, заблокированные издателями](manage-apps.md#apps-blocked-by-publishers).

В любое время приложение можно отключить на уровне клиента, используя разрешение и блокировку [](manage-apps.md#allow-and-block-apps) приложений в Teams центре администрирования. Если приложение отключено на уровне клиента, оно будет заблокировано для всех пользователей, даже если включены разрешения на уровне пользователей.
