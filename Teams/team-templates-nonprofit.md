...
Teams включает шаблон "Управление группой добровольцев", предназначенный для оптимизации действий по управлению волонтерами. Этот готовый шаблон можно использовать с целью быстрого создания команд для общения и взаимодействия сотрудников для действий и задач по управлению волонтерами.

В этой статье вы узнаете о шаблоне "Управление группой добровольцев" и о том, как его использовать для создания команды. В этой статье также приводится обзор управления шаблонами команд в Центре администрирования Teams.

## <a name="manage-volunteers-team-template"></a>Шаблон группы "Управление добровольцами"
...
Ниже приведены каналы и приложения, которые поставляются с шаблоном "Управление добровольцами".

>[!div class="mx-tdBreakAll"]
>| Тип шаблона |TemplateId | Свойства этого шаблона |
>| ------------------|-- |----------------------------------------------------- |
>|Управление добровольцами| `com.microsoft.teams.template.ManageVolunteers` |Каналы: <ul><li>Общие<ul><li>Веб-сайт&sup1;</li></ul><li>Объявления</li><li>Отчётность<ul><li>Power BI&sup1;</li></ul></li><li>Управление волонтерами<ul><li>Power Apps&sup1;</li></ul></li><li>Возможности взаимодействия<ul><li>Задачи Планировщика и To Do&sup1;</li></ul></li><li>Подключение волонтеров<ul><li>SharePoint&sup1;</li><li>OneNote&sup1;</li></ul></li></ul>Приложения: <ul><li>OneNote</li><li>Power Apps</li><li>Power BI</li><li>SharePoint</li><li>Задачи планировщика и задачи</li><li>Веб-сайт</li><li>YouTube</li></ul>|
