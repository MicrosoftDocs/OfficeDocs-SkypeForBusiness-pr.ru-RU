...
Чтобы использовать эту функцию, Outlook для пользователя должна быть включена функция Outlook в Интернете. Если Outlook в Интернете отключен, параметр  Поделиться Outlook не отображается в Teams для пользователя. По шагам о том, как включить и отключить Outlook в Интернете, см. в Outlook в Интернете для [почтового ящика.](/exchange/recipients-in-exchange-online/manage-user-mailboxes/enable-or-disable-outlook-web-app)
...
См. также [сообщения с действиями в Outlook и Office 365 группах.](https://docs.microsoft.com/outlook/actionable-messages/)
