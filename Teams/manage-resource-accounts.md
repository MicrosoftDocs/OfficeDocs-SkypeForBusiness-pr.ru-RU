...
Когда вы создаете учетную запись ресурса, вход в нее заблокирован для учетной записи. В верхней части области появится баннер, в которой указано, что учетная запись ресурса не может быть загружена. Вы должны разблокировать вход в учетную запись ресурса в центре администрирования Microsoft 365, чтобы учетной записи ресурса было разрешено выполнять вход. Для этого в центре администрирования Microsoft 365 перейдите в раздел **Пользователи**, найдите и выберите учетную запись ресурса. В верхней части области под отображаемым именем щелкните **разблокировать этого пользователя?** снимите флажок **блокировать вход в учетную** запись, а затем нажмите кнопку **сохранить изменения**.

![Снимок экрана: параметр "разблокировать этого пользователя"](media/res-acct-unblock.png)

После этого вы увидите сообщение "вход разрешен" под отображаемым именем. 
