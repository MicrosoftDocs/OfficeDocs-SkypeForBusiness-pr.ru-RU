...
Если службе вашей телефонной системы потребуется номер службы, то различные зависимости могут быть выполнены в следующей последовательности:

1. Получить номер Услуги.
2. Создайте учетную запись ресурса. Для связи между автосекретарем и очередью звонков требуется соответствующая учетная запись ресурса.
3. Получение лицензии на телефонную систему или виртуальную систему для телефонной системы.
4. Купите план внутренних и международных звонков.
5. Назначьте телефонную систему или лицензию виртуального пользователя телефонной системы для учетной записи ресурса.
6. Назначение лицензии на план звонков для учетной записи ресурса.
7. Назначение лицензии на кредитовое соединение учетной записи ресурса.
8. Настройте кредиты на связь и настройте автоматическое пополнение счета для своей организации.
9. Назначьте номер телефона для учетной записи ресурса, на которую вы только что назначили лицензии.
10. Создайте службу телефонной системы (очередь звонков или автосекретарь).
11. Свяжите учетную запись ресурса со службой.
...
2. Создайте новую учетную запись ресурса. Дополнительные сведения о создании учетной [записи ресурса в центре администрирования Microsoft Teams](#create-a-resource-account-in-microsoft-teams-admin-center) или [создании учетной записи ресурса в PowerShell](#create-a-resource-account-in-powershell)
3. Получение лицензии на телефонную систему или виртуальную систему для телефонной системы. В центре администрирования Microsoft 365 перейдите к разделу**подписки** на надстройки**службы** >  **выставления счетов** > и прокрутите список до конца — вы увидите лицензию "телефонная система — виртуальный пользователь". Нажмите кнопку **Купить сейчас**.
4. Купите план внутренних и международных [звонков](calling-plans-for-office-365.md).
5. Назначьте лицензии на телефонную систему учетной записи ресурса. В разделе [Назначение лицензий Microsoft Teams](assign-teams-licenses.md) и [Назначение лицензий одному пользователю](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/assign-licenses-to-users?redirectSourcePath=%252farticle%252f997596b5-4173-4627-b915-36abac6786dc&view=o365-worldwide#assign-licenses-to-one-user).
6. Назначение лицензии на план звонков для учетной записи ресурса. Дополнительные сведения приведены в разделе [Назначение лицензий Microsoft Teams](assign-teams-licenses.md) .
7. Назначьте номер Услуги учетной записи ресурса. Ознакомьтесь с разназначением и отменой [назначения номеров телефонов и служб](#assignunassign-phone-numbers-and-services).
8. Настройте кредиты на связь и настройте автоматическое пополнение счета для своей организации. [Назначение лицензии](set-up-communications-credits-for-your-organization.md#step-3-assign-a-communications-credits-license-to-users) на кредитовое соединение учетной записи ресурса.
9. [Назначьте номер телефона](change-the-phone-numbers-on-your-audio-conferencing-bridge.md#steps-when-you-are-assigning-a-new-service-phone-number-to-your-conference-bridge) для учетной записи ресурса, на которую вы только что назначили лицензии. 
10. Настройте один из указанных ниже вариантов.
...
11. Свяжите учетную запись ресурса с автосекретарем или очередью звонков. Просмотр [назначения и отмены назначения номеров телефонов и служб](#assignunassign-phone-numbers-and-services)
...
> [!IMPORTANT]
> Если у клиента нет лицензии на телефонную систему, внутренняя проверка вызовет сбой при попытке назначить номер телефона учетной записи ресурса. Вы не сможете назначить номер или связать учетную запись ресурса со службой.
