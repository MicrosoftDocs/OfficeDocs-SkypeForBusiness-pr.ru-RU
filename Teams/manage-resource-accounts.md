...
Если в вашей организации уже используется по крайней мере одна лицензия на телефонную систему, чтобы назначить номер телефона очереди звонков телефонной системы или автосекретаря, процесс будет следующим:
...
1. Получайте или получайте платный или бесплатный номер Услуги. Номер не может быть назначен другим услугам голосовой почты или учетным записям ресурсов.
   ...
   Перед тем как назначить номер телефона учетной записи ресурса, вам нужно получить или перенести на него номера бесплатных или платных услуг. После получения платных и > **бесплатных телефонных номеров** > в **центре администрирования Microsoft Teams**они отображаются в виде**номеров телефонов**, а **тип номера** будет указан в **списке бесплатный.** Чтобы получить номера услуг, ознакомьтесь со статьей [получение телефонных номеров служб](getting-service-phone-numbers.md) или перенесите существующий номер Услуги в разделе [Перенос номеров телефонов в Office 365](transfer-phone-numbers-to-office-365.md).
...
> [!NOTE]
> Если вы хотите, чтобы очередь звонков или автосекретарь были доступны для поиска локальными пользователями, следует создать локальные учетные записи ресурсов, так как сетевые учетные записи ресурсов не синхронизируются с Active Directory.
...
3. Необязательно После того как правильная лицензия будет применена к учетной записи ресурсов, вы можете назначить номер телефона для учетной записи ресурсов, как показано ниже. Не все учетные записи ресурсов требуют номера телефона. Если вы не применяли лицензию для учетной записи ресурса, назначение номера телефона завершится сбоем.
   ...
   Чтобы назначить для учетной записи ресурсов прямой маршрутный номер, используйте следующий командлет для Skype для бизнеса Online PowerShell:
