...
2. Получите бесплатную [лицензию](teams-add-on-licensing/virtual-user.md) на виртуальную или платную телефонную систему для использования с учетной записью ресурса или лицензией на телефонную систему.
