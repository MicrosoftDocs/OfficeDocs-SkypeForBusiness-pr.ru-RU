...
После того как вы приобрели лицензию на телефонную систему, с помощью центра администрирования **Org-wide settings**Microsoft Teams перейдите в раздел  >  **учетные записи ресурсов**"Параметры организации".
