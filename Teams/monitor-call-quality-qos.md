...
- Панель мониторинга качества **звонка (CQD):** чтобы анализировать тенденции и проблемы в масштабе организации, повышение производительности
...
Лучше всего внедрить QoS во внутреннюю сеть, при этом готовясь к внедрению Teams, но это можно сделать в любое время. Если у вас маленький размер, возможно, QoS не нужен.

Когда будете готовы, прочитайте статью "Реализация качества обслуживания [(QoS) в Microsoft Teams".](QoS-in-Teams.md)

Чтобы использовать QoS для управления трафиком собраний, прочитайте статью "Настройка обработки трафика мультимедиа в режиме реального времени [для собраний Teams".](meeting-settings-in-teams.md#set-how-you-want-to-handle-real-time-media-traffic-for-teams-meetings)
