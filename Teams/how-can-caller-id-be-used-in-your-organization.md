...
### <a name="end-user-control-of-outbound-caller-id"></a>Управление конечным пользователем ид исходящие вызываемого звонка
...
## <a name="inbound-caller-id"></a>Inbound caller ID
