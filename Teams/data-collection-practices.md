...
- Заполните отдельно для каждого пользователя на вкладке Общие ![(щелкните значок](media/70f1b43f-16d6-4172-9139-71d845c4ed5c.png) шестеренки, а затем откроется диалоговое окно **Параметры** , в котором появится вкладка **Общие** ) в клиенте Skype для бизнеса.
