...
В этой статье объясняется, как использовать аналитику вызовов для устранения неполадок Microsoft Teams или качества собраний для отдельных пользователей, если вы администратор Teams или специалист по Teams связи.
...
1. Откройте Центр администрирования Teams () и войте вход с помощью службы Teams связи или Teams <https://admin.teams.microsoft.com> учетных данных администратора.
