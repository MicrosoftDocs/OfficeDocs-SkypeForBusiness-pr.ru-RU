...
1. Откройте Центр администрирования Teams () и войте в службу Teams или Teams учетные данные <https://admin.teams.microsoft.com> администратора.
...
Для аудио-сеансов с данными о качестве качества работы в таблице ниже описаны основные проблемы, которые квалифицировать сеанс как **неудовлетворительный.**
